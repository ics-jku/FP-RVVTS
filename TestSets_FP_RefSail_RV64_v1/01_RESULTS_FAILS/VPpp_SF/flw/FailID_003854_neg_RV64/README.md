# FailID_003854 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0x80000486           // a2
    li x13, 0x7ffff8f1           // a3
    li x14, 0x1                  // a4
    li x15, 0x8                  // a5
    li x16, 0x0                  // a6
    ...
    li x30, 0xb7                 // t5
    li x31, 0x80180088           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'x30', 'f2', 'x23'}})
...
f2                  0xffffffffcf310001(-2969567488.0_s)             0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f2                  0xffffffffcf310001(-2969567488.0_s)             0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, x499, x23
s7(x23)             0x000000008018014b(2149056843)                  0x000000008018014b(2149056843)
f2                  0xffffffffcf310001(-2969567488.0_s)             0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
ra(x1)              0x0000000000000008(8)                           0x0000000000000008(8)                           
...
a3(x13)             0x000000007ffff8f1(2147481841)                  0x000000007ffff8f1(2147481841)                  
...
t6(x31)             0x0000000080180088(2149056648)                  0x0000000080180088(2149056648)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            4e3687cd730730f21a63878f4c25bc927dfcf4d0        4e3687cd730730f21a63878f4c25bc927dfcf4d0        
