# FailID_000073 ARA neg RV64 fsqrt.s
...
_reg_f24:.byte 0x00,0x00,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f24'}})
    fsqrt.s f24, f19, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xffffffff4120cc4a(10.049875259399414_s)        0xffffffff4120cc4b(10.04987621307373_s)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f24, f19, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e114f55599b76a5e8d860e87fa9124ecee18d134        e114f55599b76a5e8d860e87fa9124ecee18d134        
