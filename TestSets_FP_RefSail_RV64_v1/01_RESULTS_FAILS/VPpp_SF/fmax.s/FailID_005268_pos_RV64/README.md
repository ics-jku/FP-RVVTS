# FailID_005268 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x01,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'f11', 'fcsr.rm'}, 'clob': {'f28'}})
    fmax.s f28, f11, f14
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff4f001801(2149056768.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f28, f11, f14
+========================================================================================================================+
...
f28                 0xffffffff4f001801(2149056768.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f11, f14
f11                 0xffffffff4f001801(2149056768.0_s)              0xffffffff4f001801(2149056768.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d69a28a9e917b223146d80db46b507d4cf10edb3        d69a28a9e917b223146d80db46b507d4cf10edb3        
