# FailID_000185 ARA pos RV64 fdiv.s
...
_reg_f30:.byte 0x06,0x09,0x20,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f8'}, 'clob': {'f8'}})
    fdiv.s f8, f8, f30, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f8, f8, f30, rtz
+========================================================================================================================+
...
Registers: f8, f8, f30
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f30                 0xffffffff80200906(-2.941972876508309e-39_s)    0xffffffff80200906(-2.941972876508309e-39_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e21e566c530745d7109945bb70e9c9b1b25cf2ad        e21e566c530745d7109945bb70e9c9b1b25cf2ad        
