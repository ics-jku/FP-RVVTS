# FailID_003793 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x0                  // s10
    li x27, 0x0                  // s11
    li x28, 0x800007a7           // t3
    li x29, 0x1                  // t4
    li x30, 0x80180782           // t5
    li x31, 0x800000f7           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x19', 'x9', 'f15'}})
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, x1, x19
ra(x1)              0x00000000802004a7(2149581991)                  0x00000000802004a7(2149581991)
s3(x19)             0x000000007ffffe34(2147483188)                  0x000000007ffffe34(2147483188)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ff84d7b5d79d7c798fa4cb3eb1aac4d36ef83d05        ff84d7b5d79d7c798fa4cb3eb1aac4d36ef83d05        
