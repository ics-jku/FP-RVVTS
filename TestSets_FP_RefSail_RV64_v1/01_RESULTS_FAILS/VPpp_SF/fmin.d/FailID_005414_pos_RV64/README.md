# FailID_005414 VP++ SF pos RV64 fmin.d
...
_reg_f24:.byte 0x00,0x00,0x88,0x42,0xff,0xff,0xff,0xff
_reg_f27:.byte 0x24,0x05,0x4b,0x38,0xbd,0xa2,0xe6,0xc0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f24'}})
    fmin.d f24, f27, f12
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xc0e6a2bd384b0524(-46357.91312170986_d)        0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f24, f27, f12
+========================================================================================================================+
...
f24                 0xc0e6a2bd384b0524(-46357.91312170986_d)        0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f27, f12
f12                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f24                 0xc0e6a2bd384b0524(-46357.91312170986_d)        0x7ff8000000000000(nan_d)                       X
f27                 0xc0e6a2bd384b0524(-46357.91312170986_d)        0xc0e6a2bd384b0524(-46357.91312170986_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            efadb14fc7391b76074dd0860cf41656eb67ab66        efadb14fc7391b76074dd0860cf41656eb67ab66        
