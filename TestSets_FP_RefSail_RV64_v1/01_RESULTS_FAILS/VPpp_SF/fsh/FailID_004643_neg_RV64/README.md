# FailID_004643 VP++ SF neg RV64 fsh
...
```
    ...
    j _float_data_end
    .align 4
_reg_f31:.byte 0x00,0x00,0xe0,0x4f,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f31
    fld  f31, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'fcsr.rm', 'x22', 'mstatus.fs/vs.fs'}, 'clob': {'x22', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fdc17bf5c2acab39e11bc049974ca936fa330e3f        X
STATES DIFFER: True
```
...
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fdc17bf5c2acab39e11bc049974ca936fa330e3f        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x1, x22
ra(x1)              0x0000000000000001(1)                           0x0000000000000001(1)
s6(x22)             0x0000000080180214(2149057044)                  0x0000000080180214(2149057044)
f31                 0x41e002ff4fe00000(2149055103.0_d)              0x41e002ff4fe00000(2149055103.0_d)
+========================================================================================================================+
```
...
a5(x15)             0x00000000801801fe(2149057022)                  0x00000000801801fe(2149057022)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4c5dd40b2903ad39883cbe0c82ebb6705a038e81        4c5dd40b2903ad39883cbe0c82ebb6705a038e81        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fdc17bf5c2acab39e11bc049974ca936fa330e3f        X
