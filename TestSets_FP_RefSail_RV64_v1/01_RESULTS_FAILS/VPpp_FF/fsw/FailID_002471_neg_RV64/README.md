# FailID_002471 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x9, 0x80200818            // s1
    li x10, 0x0                  // a0
    li x11, 0x8017fbf5           // a1
    li x12, 0x8017f97d           // a2
    li x13, 0x8017fe65           // a3
    li x14, 0x10                 // a4
    li x15, 0xffffffff7fd7fc2a   // a5
    li x16, 0x8017fb3a           // a6
    li x17, 0x7ffffc1e           // a7
    li x18, 0x0                  // s2
    li x19, 0x0                  // s3
    li x20, 0x81                 // s4
    li x21, 0x0                  // s5
    li x22, 0x8018097d00000      // s6
    li x23, 0x0                  // s7
    li x24, 0x8018049d           // s8
    li x25, 0x3706c000           // s9
    li x26, 0x6000               // s10
    li x27, 0xffffffffb9349000   // s11
    li x28, 0x8018007d           // t3
    li x29, 0xffffffffffffffff   // t4
    li x30, 0x7ffffcce           // t5
    li x31, 0x26200728           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f23', 'mstatus.fs/vs.fs', 'x7'}, 'clob': {'x4', 'x7'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        61a98a385a86ca95d7b374712edf8c2e7caeb7ae        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, x74, x7
t2(x7)              0x0000000080200958(2149583192)                  0x0000000080200958(2149583192)
...
ra(x1)              0x000000008018097d(2149058941)                  0x000000008018097d(2149058941)                  
...
tp(x4)              0x000000008018074c(2149058380)                  0x000000008018074c(2149058380)                  
...
s1(x9)              0x0000000080200818(2149582872)                  0x0000000080200818(2149582872)                  
a0(x10)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a1(x11)             0x000000008017fbf5(2149055477)                  0x000000008017fbf5(2149055477)                  
a2(x12)             0x000000008017f97d(2149054845)                  0x000000008017f97d(2149054845)                  
a3(x13)             0x000000008017fe65(2149056101)                  0x000000008017fe65(2149056101)                  
a4(x14)             0x0000000000000010(16)                          0x0000000000000010(16)                          
a5(x15)             0xffffffff7fd7fc2a(18446744071559445546)        0xffffffff7fd7fc2a(18446744071559445546)        
a6(x16)             0x000000008017fb3a(2149055290)                  0x000000008017fb3a(2149055290)                  
a7(x17)             0x000000007ffffc1e(2147482654)                  0x000000007ffffc1e(2147482654)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s4(x20)             0x0000000000000081(129)                         0x0000000000000081(129)                         
s5(x21)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s6(x22)             0x0008018097d00000(2253451628118016)            0x0008018097d00000(2253451628118016)            
...
s11(x27)            0xffffffffb9349000(18446744072521814016)        0xffffffffb9349000(18446744072521814016)        
t3(x28)             0x000000008018007d(2149056637)                  0x000000008018007d(2149056637)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4974607df76c62d45988c973d863fdeba3fe4e4b        4974607df76c62d45988c973d863fdeba3fe4e4b        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        61a98a385a86ca95d7b374712edf8c2e7caeb7ae        X
