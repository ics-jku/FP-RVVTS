# FailID_002177 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x28, 0x7ffffedc           // t3
    li x29, 0x7ffffde2           // t4
    li x30, 0x80180029           // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f27', 'x1'}, 'clob': {'x9', 'x1'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x751, x1
ra(x1)              0x00000000801fe759(2149574489)                  0x00000000801fe759(2149574489)
...
s4(x20)             0x00000000801859f4(2149079540)                  0x00000000801859f4(2149079540)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6119876fb56dab0e2af1a5d24aa4de95cf7bec13        6119876fb56dab0e2af1a5d24aa4de95cf7bec13        
