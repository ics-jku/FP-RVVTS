# FailID_001533 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x21, 0x800064ce           // s5
    li x22, 0x801807e8           // s6
    li x23, 0x7ffffdd1           // s7
    li x24, 0x8017fb2a           // s8
    li x25, 0x0                  // s9
    li x26, 0x6e                 // s10
    ...
    li x31, 0x2ffe750            // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x18'}, 'clob': {'f12', 'x18', 'x24'}})
...
f12                 0x40e6a2bdadfbb4cd(46357.92748818696_d)         0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
s5(x21)             0x00000000800064ce(2147509454)                  0x00000000800064ce(2147509454)                  
...
s8(x24)             0x000000007ffffd8f(2147483023)                  0x000000007ffffd8f(2147483023)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            838f15cc58a29add64b54c45c663853bd31f43f9        838f15cc58a29add64b54c45c663853bd31f43f9        
