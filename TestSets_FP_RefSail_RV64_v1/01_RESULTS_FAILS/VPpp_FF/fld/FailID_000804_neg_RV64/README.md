# FailID_000804 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x15, 0x801eadb3           // a5
    li x16, 0x8005d9ad           // a6
    li x17, 0x0                  // a7
    li x18, 0x2000003f           // s2
    li x19, 0x801c416d           // s3
    li x20, 0x0                  // s4
    li x21, 0x802006c1           // s5
    li x22, 0x18                 // s6
    li x23, 0x6000               // s7
    ...
    li x28, 0x0                  // t3
    li x29, 0x801a19ae           // t4
    li x30, 0xfffffffffffffbfb   // t5
    li x31, 0x801801ae           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x20'}, 'clob': {'x13', 'f30', 'x20'}})
...
f30                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
s1(x9)              0x00000000800000fd(2147483901)                  0x00000000800000fd(2147483901)                  
...
a5(x15)             0x00000000801eadb3(2149494195)                  0x00000000801eadb3(2149494195)                  
a6(x16)             0x000000008005d9ad(2147867053)                  0x000000008005d9ad(2147867053)                  
a7(x17)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s2(x18)             0x000000002000003f(536870975)                   0x000000002000003f(536870975)                   
...
t4(x29)             0x00000000801a19ae(2149194158)                  0x00000000801a19ae(2149194158)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0a0171443d8981d5489367e0cb6199e41b8ae476        0a0171443d8981d5489367e0cb6199e41b8ae476        
