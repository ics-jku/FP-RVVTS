# FailID_005539 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x04,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f4'}, 'clob': {'f30'}})
    fmin.s f30, f4, f23
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff4f001804(2149057536.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f30                 0xffffffff4f001804(2149057536.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f4, f23
f4                  0xffffffff4f001804(2149057536.0_s)              0xffffffff4f001804(2149057536.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6e5781f677c20834d8b2728adf8c4f933280c5a3        6e5781f677c20834d8b2728adf8c4f933280c5a3        
