# FailID_003180 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x05,0x28,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x26'}})
    fcvt.wu.s x26, f14
```
...
```
REG                 REF                                             DUT                                             DIFF
s10(x26)            0xffffffff80280500(18446744071564690688)        0x0000000080280500(2150106368)                  X
...
Registers: x26, f14
s10(x26)            0xffffffff80280500(18446744071564690688)        0x0000000080280500(2150106368)                  X
f14                 0xffffffff4f002805(2150106368.0_s)              0xffffffff4f002805(2150106368.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            afd4346c18b1458ad469f54c932870e4c1f68ed1        afd4346c18b1458ad469f54c932870e4c1f68ed1        
