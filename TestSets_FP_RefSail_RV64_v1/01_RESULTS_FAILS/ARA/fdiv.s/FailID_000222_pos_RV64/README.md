# FailID_000222 ARA pos RV64 fdiv.s
...
_reg_f20:.byte 0x00,0x00,0x12,0x43,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f24'}})
    fdiv.s f24, f11, f20, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f24, f11, f20, rup
+========================================================================================================================+
...
f20                 0xffffffff43120000(146.0_s)                     0xffffffff43120000(146.0_s)
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0203688bdc5a2e98ed0ad85270c398fee6d8fb85        0203688bdc5a2e98ed0ad85270c398fee6d8fb85        
