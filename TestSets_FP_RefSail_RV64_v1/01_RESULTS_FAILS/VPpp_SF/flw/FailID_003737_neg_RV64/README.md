# FailID_003737 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0xfffff3e000         // s10
    li x27, 0x802008a8           // s11
    li x28, 0x7ffff87d           // t3
    li x29, 0x1                  // t4
    li x30, 0x1                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x28'}, 'clob': {'x28', 'x29', 'f3'}})
...
f3                  0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f3                  0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, x21, x28
s5(x21)             0x000000008017f97c(2149054844)                  0x000000008017f97c(2149054844)
t3(x28)             0x00000000801ff65e(2149578334)                  0x00000000801ff65e(2149578334)
f3                  0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
s10(x26)            0x000000fffff3e000(1099510833152)               0x000000fffff3e000(1099510833152)               
...
STATE               REF                                             DUT                                             DIFF
xmemhash            139cca4e634673135b89f58245d3188acaca492a        139cca4e634673135b89f58245d3188acaca492a        
