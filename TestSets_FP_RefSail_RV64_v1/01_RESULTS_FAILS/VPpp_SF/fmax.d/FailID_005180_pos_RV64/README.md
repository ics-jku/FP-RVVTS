# FailID_005180 VP++ SF pos RV64 fmax.d
...
_reg_f17:.byte 0x0e,0xfe,0xff,0x7f,0x00,0x00,0x00,0x00
_reg_f31:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f31'}, 'clob': {'f9'}})
    fmax.d f9, f17, f31
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x000000007ffffe0e(1.0609976494e-314_d)         0xffffffff44000000(512.0_s)                     X
STATES DIFFER: True
```
...
f9                  0x000000007ffffe0e(1.0609976494e-314_d)         0xffffffff44000000(512.0_s)                     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f17, f31
f9                  0x000000007ffffe0e(1.0609976494e-314_d)         0xffffffff44000000(512.0_s)                     X
f17                 0x000000007ffffe0e(1.0609976494e-314_d)         0x000000007ffffe0e(1.0609976494e-314_d)
f31                 0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            96c75673e470d204c36c2d833b646a9f717b577b        96c75673e470d204c36c2d833b646a9f717b577b        
