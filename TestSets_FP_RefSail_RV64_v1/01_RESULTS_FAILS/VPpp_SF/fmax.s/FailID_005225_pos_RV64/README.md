# FailID_005225 VP++ SF pos RV64 fmax.s
...
_reg_f30:.byte 0xfd,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f31', 'f30'}, 'clob': {'f20'}})
    fmax.s f20, f30, f31
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f20, f30, f31
+========================================================================================================================+
...
f20                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f30, f31
f20                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff7fc00000(nan_s)                       X
f30                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff4f0017fd(2149055744.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7055f880e2197cf048892df4b874b0f07b466b02        7055f880e2197cf048892df4b874b0f07b466b02        
