# FailID_004176 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f5'}, 'clob': {'f30'}})
    fmin.s f30, f3, f5
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0015d11a093cb7aadeaa0b79c2c532cfd82fcedd        0015d11a093cb7aadeaa0b79c2c532cfd82fcedd        
