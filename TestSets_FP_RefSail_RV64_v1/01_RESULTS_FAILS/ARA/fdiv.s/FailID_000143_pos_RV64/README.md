# FailID_000143 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0xcf,0xff,0xff,0xff,0xff
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f7'}})
    fdiv.s f7, f4, f3, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f7, f4, f3, dyn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f4, f3
f3                  0xffffffffcf000000(-2147483648.0_s)             0xffffffffcf000000(-2147483648.0_s)
f4                  0xfff8000000000000(nan_d)                       0xfff8000000000000(nan_d)
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            262636a890a4c72c336ac10ad813eaba83155d45        262636a890a4c72c336ac10ad813eaba83155d45        
