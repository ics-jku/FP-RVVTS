# FailID_000236 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f28:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'f28', 'mstatus.fs/vs.fs'}, 'clob': {'f2'}})
    fdiv.s f2, f20, f28
```
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f20, f28
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f20                 0x0000000000000001(5e-324_d)                    0x0000000000000001(5e-324_d)
f28                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            678d701a1b47400e386418d560fc7cf4242ec32c        678d701a1b47400e386418d560fc7cf4242ec32c        
