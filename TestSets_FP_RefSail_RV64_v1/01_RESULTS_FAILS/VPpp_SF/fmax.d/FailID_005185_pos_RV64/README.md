# FailID_005185 VP++ SF pos RV64 fmax.d
...
_reg_f28:.byte 0xce,0x04,0x00,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f28'}, 'clob': {'f1'}})
    fmax.d f1, f28, f18
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0x00000000800004ce(1.060998503e-314_d)          0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f1                  0x00000000800004ce(1.060998503e-314_d)          0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f28, f18
f1                  0x00000000800004ce(1.060998503e-314_d)          0x7ff8000000000000(nan_d)                       X
f18                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f28                 0x00000000800004ce(1.060998503e-314_d)          0x00000000800004ce(1.060998503e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f2a4edbc3188b2a03fe86bbba0ae422c626ccab0        f2a4edbc3188b2a03fe86bbba0ae422c626ccab0        
