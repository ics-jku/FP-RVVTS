# FailID_003613 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x26, 0xa6                 // s10
    li x27, 0x800000f7           // s11
    li x28, 0x7fffffffffffffff   // t3
    li x29, 0x801ffa6a           // t4
    li x30, 0x8017fa8a           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'f20', 'x6', 'x4'}})
...
f20                 0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: flh f20, 0x296(x6)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'div-by-0'], special values ['zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f20                 0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, x296, x6
t1(x6)              0x00000000801ffa30(2149579312)                  0x00000000801ffa30(2149579312)
f20                 0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
gp(x3)              0x000000008017faf6(2149055222)                  0x000000008017faf6(2149055222)                  
tp(x4)              0x000000007ffffd6a(2147482986)                  0x000000007ffffd6a(2147482986)                  
...
a1(x11)             0x00000000800007eb(2147485675)                  0x00000000800007eb(2147485675)                  
...
a7(x17)             0x0000000000164000(1458176)                     0x0000000000164000(1458176)                     
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c252956e13091b4634bdea5271f492c5624604fa        c252956e13091b4634bdea5271f492c5624604fa        
