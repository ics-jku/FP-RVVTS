# FailID_000154 ARA pos RV64 fdiv.s
...
_reg_f23:.byte 0x01,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f12'}})
    fdiv.s f12, f25, f23, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f12, f25, f23, rmm
+========================================================================================================================+
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f25, f23
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f23                 0xffffffff4f001801(2149056768.0_s)              0xffffffff4f001801(2149056768.0_s)
f25                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d510d39e7254d7a794e087f86f386023b66e2f1b        d510d39e7254d7a794e087f86f386023b66e2f1b        
