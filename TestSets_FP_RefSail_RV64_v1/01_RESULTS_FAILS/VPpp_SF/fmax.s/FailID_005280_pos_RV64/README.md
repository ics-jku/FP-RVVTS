# FailID_005280 VP++ SF pos RV64 fmax.s
...
_reg_f18:.byte 0xa8,0x98,0x0d,0x2c,0xbe,0x3c,0x56,0x0c
_reg_f31:.byte 0xef,0xd0,0xd0,0x71,0x93,0xa3,0x21,0x6e
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'f18', 'fcsr.rm'}, 'clob': {'f31'}})
    fmax.s f31, f6, f18
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f31                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f6, f18
f6                  0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f18                 0x0c563cbe2c0d98a8(3.1058837808868255e-249_d)   0x0c563cbe2c0d98a8(3.1058837808868255e-249_d)
f31                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9666786f2e116143a7271b3f0d03dc32211381e5        9666786f2e116143a7271b3f0d03dc32211381e5        
