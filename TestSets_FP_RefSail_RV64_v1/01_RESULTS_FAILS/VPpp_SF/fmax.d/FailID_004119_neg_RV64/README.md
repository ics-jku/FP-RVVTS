# FailID_004119 VP++ SF neg RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f17:.byte 0x00,0x00,0xc0,0x67,0xfe,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm', 'f28'}, 'clob': {'f17'}})
    fmax.d f17, f21, f28
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f21, f28
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            77db2d27fa5f118eb7c044296d3ddef64e392d06        77db2d27fa5f118eb7c044296d3ddef64e392d06        
