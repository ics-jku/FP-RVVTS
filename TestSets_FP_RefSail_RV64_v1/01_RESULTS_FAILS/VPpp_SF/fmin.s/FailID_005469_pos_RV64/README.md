# FailID_005469 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x06,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f16', 'fcsr.rm'}, 'clob': {'f18'}})
    fmin.s f18, f10, f16
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f18, f10, f16
+========================================================================================================================+
...
f18                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f10, f16
f10                 0xffffffff4f000006(2147485184.0_s)              0xffffffff4f000006(2147485184.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            95acc07238ecb02a828147bf23c7ea3f3459f3bc        95acc07238ecb02a828147bf23c7ea3f3459f3bc        
