# FailID_000674 VP++ FF neg RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f25'}, 'clob': {'x5'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            028e18ff91ad47601628148eee049c1c9d9d4703        028e18ff91ad47601628148eee049c1c9d9d4703        
