# FailID_000737 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x14'}, 'clob': {'f0', 'x4', 'x14'}})
...
s5(x21)             0xfffffffffffff8a1(18446744073709549729)        0xfffffffffffff8a1(18446744073709549729)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bfd10b4cc7b9278ebeb49c341f92c78cea0797f0        bfd10b4cc7b9278ebeb49c341f92c78cea0797f0        
