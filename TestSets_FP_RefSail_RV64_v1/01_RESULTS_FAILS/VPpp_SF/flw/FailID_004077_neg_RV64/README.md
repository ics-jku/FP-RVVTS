# FailID_004077 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x11, 0x80200c73           // a1
    li x12, 0x802009a2           // a2
    li x13, 0x38                 // a3
    li x14, 0x7fffffff           // a4
    li x15, 0x8017fb0e           // a5
    li x16, 0x80180576           // a6
    li x17, 0x7ffffe63           // a7
    li x18, 0x0                  // s2
    li x19, 0x1                  // s3
    li x20, 0x80200626           // s4
    li x21, 0x8018054e           // s5
    li x22, 0x0                  // s6
    li x23, 0x8017fa33           // s7
    li x24, 0x0                  // s8
    li x25, 0x8027f808           // s9
    li x26, 0x0                  // s10
    li x27, 0x80200626           // s11
    li x28, 0x28                 // t3
    li x29, 0xfffe000000000000   // t4
    li x30, 0x6000               // t5
    li x31, 0x80180722           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x11', 'x24', 'f20'}})
...
f20                 0x7fffffff00000000(nan_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
ra(x1)              0x000000008000068a(2147485322)                  0x000000008000068a(2147485322)                  
...
a1(x11)             0x00000000800003ea(2147484650)                  0x00000000800003ea(2147484650)                  
...
a6(x16)             0x0000000080180576(2149057910)                  0x0000000080180576(2149057910)                  
...
s4(x20)             0x0000000080200626(2149582374)                  0x0000000080200626(2149582374)                  
...
s8(x24)             0x00000000800003ea(2147484650)                  0x00000000800003ea(2147484650)                  
s9(x25)             0x000000008027f808(2150103048)                  0x000000008027f808(2150103048)                  
s10(x26)            0x0000000000000000(0)                           0x0000000000000000(0)                           
s11(x27)            0x0000000080200626(2149582374)                  0x0000000080200626(2149582374)                  
...
t6(x31)             0x0000000080180722(2149058338)                  0x0000000080180722(2149058338)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            4d7eb1f38d808955f684018519379c8d7a49cf99        4d7eb1f38d808955f684018519379c8d7a49cf99        
