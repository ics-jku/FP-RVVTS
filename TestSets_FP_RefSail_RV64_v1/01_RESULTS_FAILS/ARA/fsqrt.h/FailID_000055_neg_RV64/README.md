# FailID_000055 ARA neg RV64 fsqrt.h
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f5'}})
    fsqrt.h f5, f6, dyn
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d913357e919db7b4efcc8c9d021eec995ab01458        d913357e919db7b4efcc8c9d021eec995ab01458        
