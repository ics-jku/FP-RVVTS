# FailID_005446 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f29'}, 'clob': {'f17'}})
    fmin.s f17, f26, f29
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f17, f26, f29
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            47a65473fd29580db0886daa73f75ea9ba8f8344        47a65473fd29580db0886daa73f75ea9ba8f8344        
