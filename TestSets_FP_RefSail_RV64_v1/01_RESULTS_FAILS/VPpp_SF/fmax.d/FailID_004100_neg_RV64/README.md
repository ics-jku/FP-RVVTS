# FailID_004100 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f24'}, 'clob': {'f5'}})
    fmax.d f5, f24, f14
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x000000132140006f(4.05935308646e-313_d)        0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            da349c6c0f46c7d0fdf1855f4e12628664e6657a        da349c6c0f46c7d0fdf1855f4e12628664e6657a        
