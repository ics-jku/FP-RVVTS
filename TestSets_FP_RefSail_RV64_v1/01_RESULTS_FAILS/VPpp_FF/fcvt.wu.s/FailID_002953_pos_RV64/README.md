# FailID_002953 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x5'}})
    fcvt.wu.s x5, f5, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x5, f5, rmm
+========================================================================================================================+
...
Registers: x5, f5
t0(x5)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f5                  0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a0f642da80cf4a358c1dd3ae60c058cc8c544212        a0f642da80cf4a358c1dd3ae60c058cc8c544212        
