# FailID_005241 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0x33,0xff,0xff,0x7f,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f29'}, 'clob': {'f23'}})
    fmax.s f23, f29, f18
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f23, f29, f18
+========================================================================================================================+
...
f23                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f29, f18
f18                 0x000000007fffff33(1.060997794e-314_d)          0x000000007fffff33(1.060997794e-314_d)
f23                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ecd26e4aa58fbe16468e3087669923966a08fa1c        ecd26e4aa58fbe16468e3087669923966a08fa1c        
