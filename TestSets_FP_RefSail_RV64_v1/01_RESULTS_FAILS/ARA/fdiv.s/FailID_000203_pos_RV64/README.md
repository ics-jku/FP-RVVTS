# FailID_000203 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x60,0xdf,0xff,0xff,0xef,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f29'}})
    fdiv.s f29, f22, f11, rne
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f22, f11, rne
+========================================================================================================================+
...
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f22, f11
f11                 0x41efffffdf600000(4294967035.0_d)              0x41efffffdf600000(4294967035.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4086a283ac42bf87108019fc4afda3493869438a        4086a283ac42bf87108019fc4afda3493869438a        
