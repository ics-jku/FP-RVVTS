# FailID_004805 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x21, 0x0                  // s5
    li x22, 0x6000               // s6
    li x23, 0x8017fc29           // s7
    li x24, 0xffffffff7fc00000   // s8
    li x25, 0xffffffff9dd0b000   // s9
    li x26, 0x30                 // s10
    li x27, 0x0                  // s11
    li x28, 0x0                  // t3
    li x29, 0x1                  // t4
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm', 'f9'}, 'clob': {'x21', 'x25'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, x496, x21
s5(x21)             0x0000000080180496(2149057686)                  0x0000000080180496(2149057686)
...
s7(x23)             0x000000008017fc29(2149055529)                  0x000000008017fc29(2149055529)                  
s8(x24)             0xffffffff7fc00000(18446744071557873664)        0xffffffff7fc00000(18446744071557873664)        
s9(x25)             0x0000000080180496(2149057686)                  0x0000000080180496(2149057686)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3da5e29b7b4512762bc94a19f4f02550261a8ca6        3da5e29b7b4512762bc94a19f4f02550261a8ca6        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3cfc50187a9febfe44b5c11e592e549b5119bd02        X
