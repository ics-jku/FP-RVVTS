# FailID_002017 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x31, 0x40                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f30', 'x25'}, 'clob': {'x10', 'x25'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e9803bfe3efcdeca1d7f2b6f142d839ab93d0bb4        e9803bfe3efcdeca1d7f2b6f142d839ab93d0bb4        
