# FailID_005224 VP++ SF pos RV64 fmax.s
...
_reg_f3: .byte 0x93,0x03,0x00,0x00,0x23,0xbc,0x51,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f3'}, 'clob': {'f0'}})
    fmax.s f0, f7, f3
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f0, f7, f3
f0                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
f3                  0x0051bc2300000393(3.946148252711382e-307_d)    0x0051bc2300000393(3.946148252711382e-307_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            df27304718cd90ba52dd22bf4315c7bae818b68d        df27304718cd90ba52dd22bf4315c7bae818b68d        
