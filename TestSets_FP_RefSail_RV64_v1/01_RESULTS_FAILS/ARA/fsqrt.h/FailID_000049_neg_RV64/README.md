# FailID_000049 ARA neg RV64 fsqrt.h
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f8'}})
    fsqrt.h f8, f9, rup
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1fda4219e43efc40803934f2834881f3025986b2        1fda4219e43efc40803934f2834881f3025986b2        
