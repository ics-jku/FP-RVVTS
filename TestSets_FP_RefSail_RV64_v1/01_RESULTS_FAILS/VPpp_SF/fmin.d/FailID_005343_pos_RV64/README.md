# FailID_005343 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f31'}})
    fmin.d f31, f4, f24
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0x0000000000000000(0.0_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            246d64aee6dd0b42936a8924104e86ec6ee40cfb        246d64aee6dd0b42936a8924104e86ec6ee40cfb        
