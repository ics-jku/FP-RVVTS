# FailID_005443 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xc7,0x02,0x00,0x80,0x00,0x00,0x00,0x00
_reg_f25:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f27:.byte 0xfc,0xcf,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f25'}, 'clob': {'f11'}})
    fmin.s f11, f27, f25
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffffceffcffc(-2145910272.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f27, f25
+========================================================================================================================+
...
f11                 0xffffffffceffcffc(-2145910272.0_s)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f27, f25
f11                 0xffffffffceffcffc(-2145910272.0_s)             0xffffffff7fc00000(nan_s)                       X
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f27                 0xffffffffceffcffc(-2145910272.0_s)             0xffffffffceffcffc(-2145910272.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dcea801bf81f2657ae28d432e091e89d3d5c3ab4        dcea801bf81f2657ae28d432e091e89d3d5c3ab4        
