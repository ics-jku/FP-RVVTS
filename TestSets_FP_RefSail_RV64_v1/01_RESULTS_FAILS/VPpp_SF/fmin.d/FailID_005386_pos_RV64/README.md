# FailID_005386 VP++ SF pos RV64 fmin.d
...
* FailID: 5386
* Isolated failing instruction: `fmin.d`
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x06,0xcb,0x66,0xb2,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x07,0x6d,0x62,0xdd,0x4d,0x81,0x3b,0x64
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'f25'}})
    fmin.d f25, f20, f1
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0x643b814ddd626d07(6.8028460336568025e+174_d)   0xffffffffb266cb06(-1.3433924195282998e-08_s)   X
STATES DIFFER: True
```
...
f25                 0x643b814ddd626d07(6.8028460336568025e+174_d)   0xffffffffb266cb06(-1.3433924195282998e-08_s)   X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f20, f1
f1                  0xffffffffb266cb06(-1.3433924195282998e-08_s)   0xffffffffb266cb06(-1.3433924195282998e-08_s)
f20                 0x643b814ddd626d07(6.8028460336568025e+174_d)   0x643b814ddd626d07(6.8028460336568025e+174_d)
f25                 0x643b814ddd626d07(6.8028460336568025e+174_d)   0xffffffffb266cb06(-1.3433924195282998e-08_s)   X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            add07ad8b6c836df0d94a1f0f6346d6f66224c0f        add07ad8b6c836df0d94a1f0f6346d6f66224c0f        
