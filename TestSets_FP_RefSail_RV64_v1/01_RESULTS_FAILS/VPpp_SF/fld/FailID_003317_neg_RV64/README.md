# FailID_003317 VP++ SF neg RV64 fld
...
_reg_f18:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    li x15, 0x0                  // a5
    li x16, 0x47ff27ac           // a6
    li x17, 0x8017ffa0           // a7
    li x18, 0x8027fff8           // s2
    li x19, 0x200                // s3
    li x20, 0x80180230           // s4
    li x21, 0x80218ed4           // s5
    li x22, 0x6000               // s6
    li x23, 0x7ffffdad           // s7
    li x24, 0x0                  // s8
    ...
    li x31, 0x801ff998           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'x19', 'x10', 'f7'}})
...
f7                  0x4068200000000000(193.0_d)                     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fld f7, 0x585(x10)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'inexact'], special values ['zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f7                  0x4068200000000000(193.0_d)                     0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x585, x10
a0(x10)             0x00000000801ddfd3(2149441491)                  0x00000000801ddfd3(2149441491)
f7                  0x4068200000000000(193.0_d)                     0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
gp(x3)              0x000000008017fd1f(2149055775)                  0x000000008017fd1f(2149055775)                  
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x00000000801fec22(2149575714)                  0x00000000801fec22(2149575714)                  
t1(x6)              0x000000008000079d(2147485597)                  0x000000008000079d(2147485597)                  
...
a6(x16)             0x0000000047ff27ac(1207904172)                  0x0000000047ff27ac(1207904172)                  
a7(x17)             0x000000008017ffa0(2149056416)                  0x000000008017ffa0(2149056416)                  
s2(x18)             0x000000008027fff8(2150105080)                  0x000000008027fff8(2150105080)                  
s3(x19)             0x000000007ffffa7b(2147482235)                  0x000000007ffffa7b(2147482235)                  
...
s7(x23)             0x000000007ffffdad(2147483053)                  0x000000007ffffdad(2147483053)                  
...
t6(x31)             0x00000000801ff998(2149579160)                  0x00000000801ff998(2149579160)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            8349d305b18248489ee075f6fbf985a52c1281e9        8349d305b18248489ee075f6fbf985a52c1281e9        
...
f18                 0x41dfffff80000000(2147483136.0_d)              0x41dfffff80000000(2147483136.0_d)              
