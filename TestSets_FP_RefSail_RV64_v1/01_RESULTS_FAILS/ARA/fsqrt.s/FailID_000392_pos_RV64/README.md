# FailID_000392 ARA pos RV64 fsqrt.s
...
_reg_f27:.byte 0x00,0x00,0x00,0x00,0x00,0x04,0x9a,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f26
    fld  f26, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fsqrt.s f26, f27, rmm
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f26, f27, rmm
+========================================================================================================================+
...
Registers: f26, f27
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f27                 0x409a040000000000(1665.0_d)                    0x409a040000000000(1665.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e3e9011ed66acb3d02f28c979c6b2a8e72d64224        e3e9011ed66acb3d02f28c979c6b2a8e72d64224        
