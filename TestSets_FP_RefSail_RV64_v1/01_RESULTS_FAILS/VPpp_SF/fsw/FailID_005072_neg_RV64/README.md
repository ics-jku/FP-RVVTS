# FailID_005072 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x13, 0xffffffffb7d2d000   // a3
    li x14, 0x60000000000        // a4
    li x15, 0x8017f9d7           // a5
    li x16, 0x10                 // a6
    li x17, 0x96                 // a7
    li x18, 0x8017ffc5           // s2
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x14', 'fcsr.rm', 'f28'}, 'clob': {'x14', 'x22'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        0a0365590c68c4ca3d0e729878409ba0b3047802        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x43, x14
a4(x14)             0x000000008017ffbd(2149056445)                  0x000000008017ffbd(2149056445)
...
a3(x13)             0xffffffffb7d2d000(18446744072498630656)        0xffffffffb7d2d000(18446744072498630656)        
a4(x14)             0x000000008017ffbd(2149056445)                  0x000000008017ffbd(2149056445)                  
...
s6(x22)             0x000000008017ffbd(2149056445)                  0x000000008017ffbd(2149056445)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            29506d6d3546498069826f3d64aa878cc8f1d58f        29506d6d3546498069826f3d64aa878cc8f1d58f        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        0a0365590c68c4ca3d0e729878409ba0b3047802        X
