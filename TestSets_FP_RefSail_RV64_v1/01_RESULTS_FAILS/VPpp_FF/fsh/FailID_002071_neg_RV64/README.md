# FailID_002071 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x8, 0x1b4                 // fp
    li x9, 0x80000789            // s1
    li x10, 0x802007b6           // a0
    li x11, 0x6000               // a1
    li x12, 0x0                  // a2
    li x13, 0xffffffffffffffff   // a3
    li x14, 0x80180896           // a4
    li x15, 0x200                // a5
    li x16, 0x6ca                // a6
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x10', 'f17'}, 'clob': {'x10', 'x30'}})
...
t1(x6)              0xffffffff00000000(18446744069414584320)        0xffffffff00000000(18446744069414584320)        
...
a4(x14)             0x0000000080180896(2149058710)                  0x0000000080180896(2149058710)                  
a5(x15)             0x0000000000000200(512)                         0x0000000000000200(512)                         
a6(x16)             0x00000000000006ca(1738)                        0x00000000000006ca(1738)                        
a7(x17)             0x000000008017fe53(2149056083)                  0x000000008017fe53(2149056083)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            310a6215ef4e7236f1b86bd5b99b58ae89f30fa3        310a6215ef4e7236f1b86bd5b99b58ae89f30fa3        
