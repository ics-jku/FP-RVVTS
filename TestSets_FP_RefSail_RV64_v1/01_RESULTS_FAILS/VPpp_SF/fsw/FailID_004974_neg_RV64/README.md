# FailID_004974 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    // restore registers
    li x1, 0xca7a14fb6d03ca7b    // ra
    li x2, 0x9e9c799529b1de51    // sp
    li x3, 0x801f0fef            // gp
    li x4, 0xf55c6f887b63fe7f    // tp
    li x5, 0xf927b674305332fc    // t0
    ...
    li x12, 0x296b0fc1342f4f1    // a2
    li x13, 0xb768e15d019fd202   // a3
    li x14, 0x5419d392405f4f57   // a4
    li x15, 0xd                  // a5
    li x16, 0x6af0caa786e0355b   // a6
    li x17, 0xc5ecb5ca0cb0c9ae   // a7
    li x18, 0xae37875d13035b8b   // s2
    ...
    li x25, 0x66e605c2534d04bd   // s9
    li x26, 0xb52be71d6bfcb994   // s10
    li x27, 0x800001bf           // s11
    li x28, 0xca42bae7eba8b805   // t3
    li x29, 0x6000               // t4
    li x30, 0xb39ffbe82deb3fd8   // t5
    li x31, 0x6af0caa786e0355    // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'x18'}, 'clob': {'x18', 'x17'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        1724982c2ad147684d5ea9b9d1801fa25ec01215        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, x716, x18
s2(x18)             0x00000000801b629e(2149278366)                  0x00000000801b629e(2149278366)
...
ra(x1)              0xca7a14fb6d03ca7b(14589997012918454907)        0xca7a14fb6d03ca7b(14589997012918454907)        
sp(x2)              0x9e9c799529b1de51(11429143635916086865)        0x9e9c799529b1de51(11429143635916086865)        
...
t0(x5)              0xf927b674305332fc(17953519049678992124)        0xf927b674305332fc(17953519049678992124)        
...
a2(x12)             0x0296b0fc1342f4f1(186531031283856625)          0x0296b0fc1342f4f1(186531031283856625)          
a3(x13)             0xb768e15d019fd202(13216060896094179842)        0xb768e15d019fd202(13216060896094179842)        
...
a7(x17)             0x0000000080180716(2149058326)                  0x0000000080180716(2149058326)                  
s2(x18)             0x00000000801b629e(2149278366)                  0x00000000801b629e(2149278366)                  
...
s7(x23)             0x154dd4bcb540c747(1535116954963068743)         0x154dd4bcb540c747(1535116954963068743)         
s8(x24)             0x18db16bcd44bb121(1791050277081297185)         0x18db16bcd44bb121(1791050277081297185)         
s9(x25)             0x66e605c2534d04bd(7414620168691451069)         0x66e605c2534d04bd(7414620168691451069)         
...
t6(x31)             0x06af0caa786e0355(481617611456381781)          0x06af0caa786e0355(481617611456381781)          

STATE               REF                                             DUT                                             DIFF
xmemhash            44c7edbd0ae2d7ea42b300f4736da63b4cb88afa        44c7edbd0ae2d7ea42b300f4736da63b4cb88afa        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        1724982c2ad147684d5ea9b9d1801fa25ec01215        X
