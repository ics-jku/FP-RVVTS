# FailID_005274 VP++ SF pos RV64 fmax.s
...
_reg_f15:.byte 0x00,0x00,0x04,0x43,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'fcsr.rm', 'f17'}, 'clob': {'f7'}})
    fmax.s f7, f15, f17
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff43040000(132.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f7                  0xffffffff43040000(132.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f15, f17
f7                  0xffffffff43040000(132.0_s)                     0xffffffff7fc00000(nan_s)                       X
f15                 0xffffffff43040000(132.0_s)                     0xffffffff43040000(132.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            48785f84a3a4bd5285754bafa63ea9cbd8be87e6        48785f84a3a4bd5285754bafa63ea9cbd8be87e6        
