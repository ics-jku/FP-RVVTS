# FailID_003275 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x7, 0x0                   // t2
    li x8, 0x7ffff8af            // fp
    li x9, 0xffffffff9c053000    // s1
    li x10, 0x86                 // a0
    li x11, 0x801ffd06           // a1
    li x12, 0x80000016           // a2
    li x13, 0x7ffffef1           // a3
    li x14, 0x8017feb2           // a4
    li x15, 0x80180710           // a5
    li x16, 0x7ffff8af           // a6
    li x17, 0x8017ff63           // a7
    li x18, 0x0                  // s2
    li x19, 0x801ffb92           // s3
    li x20, 0x7ffffef1           // s4
    li x21, 0x1                  // s5
    li x22, 0x1                  // s6
    li x23, 0x800005c2           // s7
    li x24, 0x80180428           // s8
    li x25, 0xff9e800000000000   // s9
    li x26, 0x80000379           // s10
    li x27, 0x6000               // s11
    li x28, 0x800005c2           // t3
    li x29, 0x0                  // t4
    li x30, 0x801ffa9b           // t5
    li x31, 0x8017fe9d           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x31'}, 'clob': {'f21', 'x18', 'x31'}})
...
f21                 0xb887d9f554cf733d(-2.24297484931534e-36_d)     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f21                 0xb887d9f554cf733d(-2.24297484931534e-36_d)     0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f21, x2, x31
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)
t6(x31)             0x000000008017fbd9(2149055449)                  0x000000008017fbd9(2149055449)
f21                 0xb887d9f554cf733d(-2.24297484931534e-36_d)     0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
ra(x1)              0x000000007ffffd03(2147482883)                  0x000000007ffffd03(2147482883)                  
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x000000008017f8aa(2149054634)                  0x000000008017f8aa(2149054634)                  
tp(x4)              0x00000000000000a3(163)                         0x00000000000000a3(163)                         
t0(x5)              0x0000000000000001(1)                           0x0000000000000001(1)                           
t1(x6)              0x000000008017fe1a(2149056026)                  0x000000008017fe1a(2149056026)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x000000007ffff8af(2147481775)                  0x000000007ffff8af(2147481775)                  
s1(x9)              0xffffffff9c053000(18446744072032169984)        0xffffffff9c053000(18446744072032169984)        
...
a3(x13)             0x000000007ffffef1(2147483377)                  0x000000007ffffef1(2147483377)                  
...
a7(x17)             0x000000008017ff63(2149056355)                  0x000000008017ff63(2149056355)                  
s2(x18)             0x000000007ffffd41(2147482945)                  0x000000007ffffd41(2147482945)                  
s3(x19)             0x00000000801ffb92(2149579666)                  0x00000000801ffb92(2149579666)                  
s4(x20)             0x000000007ffffef1(2147483377)                  0x000000007ffffef1(2147483377)                  
...
s10(x26)            0x0000000080000379(2147484537)                  0x0000000080000379(2147484537)                  
...
t5(x30)             0x00000000801ffa9b(2149579419)                  0x00000000801ffa9b(2149579419)                  
t6(x31)             0x000000008017fbd9(2149055449)                  0x000000008017fbd9(2149055449)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            67d08049a79f2a679aac2df5270c95dde8140df2        67d08049a79f2a679aac2df5270c95dde8140df2        
