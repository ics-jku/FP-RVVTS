# FailID_002173 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x26, 0x1                  // s10
    li x27, 0x80180ffe           // s11
    li x28, 0x7ffffab3           // t3
    li x29, 0x6000               // t4
    li x30, 0x0                  // t5
    li x31, 0x8000049e           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27', 'f4'}, 'clob': {'x27', 'x20'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4c5f888317e7b82b5a50f6c0c49febcd0f9b74b1        4c5f888317e7b82b5a50f6c0c49febcd0f9b74b1        
