# FailID_000156 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x59,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f14:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_reg_f17:.byte 0x16,0xa2,0xe8,0x61,0xbd,0xa2,0xe6,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f17'}})
    fdiv.s f17, f10, f14, rdn
```
...
STATE               REF                                             DUT                                             DIFF
fcsr                0x0000000000000000(0)                           0x0000000000000008(8)                           X
 fcsr.dz            False                                           True                                            X
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f17, f10, f14, rdn
+========================================================================================================================+
Attributes:  fcsr ['div-by-0'], special values ['nan', 'inf'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f10, f14
f10                 0xffffffff4f000059(2147506432.0_s)              0xffffffff4f000059(2147506432.0_s)
f14                 0xfff8000000000000(nan_d)                       0xfff8000000000000(nan_d)
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b91a086ef73a36d94e937e1ba9e8b485714df080        b91a086ef73a36d94e937e1ba9e8b485714df080        
