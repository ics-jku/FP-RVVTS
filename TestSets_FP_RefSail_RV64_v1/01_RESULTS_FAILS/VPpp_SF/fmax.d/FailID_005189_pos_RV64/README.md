# FailID_005189 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f31'}, 'clob': {'f17'}})
    fmax.d f17, f26, f31
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f26, f31
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8e0f59895226cb735fe1bc1054e8352c458b79b2        8e0f59895226cb735fe1bc1054e8352c458b79b2        
