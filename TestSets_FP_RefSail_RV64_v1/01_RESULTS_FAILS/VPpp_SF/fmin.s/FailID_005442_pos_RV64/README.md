# FailID_005442 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'f16', 'fcsr.rm'}, 'clob': {'f13'}})
    fmin.s f13, f16, f7
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a7e5fb2702ac851ed21d2e5759b15eeee4f80d3c        a7e5fb2702ac851ed21d2e5759b15eeee4f80d3c        
