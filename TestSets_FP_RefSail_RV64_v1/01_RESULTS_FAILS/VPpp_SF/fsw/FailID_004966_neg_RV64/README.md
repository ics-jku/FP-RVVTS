# FailID_004966 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x13, 0x0                  // a3
    li x14, 0x7ffffd1f           // a4
    li x15, 0x8017fbc7           // a5
    li x16, 0x1004               // a6
    li x17, 0x0                  // a7
    li x18, 0x8017faae           // s2
    li x19, 0x8027ffb4           // s3
    ...
    li x29, 0xfd                 // t4
    li x30, 0x8000048d           // t5
    li x31, 0x13                 // t6
    // INSTRUCTION ({'dep': {'f20', 'x6', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x6', 'x18'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ec70de733a1e1e6296197661c45b9adfde0f4610        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, x7, x6
t1(x6)              0x00000000801807ea(2149058538)                  0x00000000801807ea(2149058538)
...
gp(x3)              0x0000000000000083(131)                         0x0000000000000083(131)                         
...
a0(x10)             0xffffffffd73b7000(18446744073025581056)        0xffffffffd73b7000(18446744073025581056)        
...
a4(x14)             0x000000007ffffd1f(2147482911)                  0x000000007ffffd1f(2147482911)                  
...
s2(x18)             0x00000000801807ea(2149058538)                  0x00000000801807ea(2149058538)                  
...
t5(x30)             0x000000008000048d(2147484813)                  0x000000008000048d(2147484813)                  
t6(x31)             0x0000000000000013(19)                          0x0000000000000013(19)                          

STATE               REF                                             DUT                                             DIFF
xmemhash            c928fa704fc40f0b413701914c5e043fe1016e01        c928fa704fc40f0b413701914c5e043fe1016e01        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ec70de733a1e1e6296197661c45b9adfde0f4610        X
