# FailID_002259 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x27, 0x7ffff983           // s11
    li x28, 0x98                 // t3
    li x29, 0x7fffffffffffffff   // t4
    li x30, 0x6000               // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f7', 'x7'}, 'clob': {'x22', 'x7'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        482f27b1e43618be8c4852a905841da926bb4ee1        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x60, x7
t2(x7)              0x00000000801fffe4(2149580772)                  0x00000000801fffe4(2149580772)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            63ecf8b70b7cb911f526813986d6449505d42c79        63ecf8b70b7cb911f526813986d6449505d42c79        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        482f27b1e43618be8c4852a905841da926bb4ee1        X
