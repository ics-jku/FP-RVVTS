# FailID_005449 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f31'}, 'clob': {'f5'}})
    fmin.s f5, f31, f5
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffff4711f300(37363.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c717ddc0b2ff24990f5766dea135d0379933865a        c717ddc0b2ff24990f5766dea135d0379933865a        
