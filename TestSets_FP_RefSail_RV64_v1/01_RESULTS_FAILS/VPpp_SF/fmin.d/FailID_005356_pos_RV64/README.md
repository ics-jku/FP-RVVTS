# FailID_005356 VP++ SF pos RV64 fmin.d
...
_reg_f26:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f22'}, 'clob': {'f2'}})
    fmin.d f2, f26, f22
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xbff0000000000000(-1.0_d)                      0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f2                  0xbff0000000000000(-1.0_d)                      0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f26, f22
f2                  0xbff0000000000000(-1.0_d)                      0xffffffff00000000(0.0_s)                       X
f22                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f26                 0xbff0000000000000(-1.0_d)                      0xbff0000000000000(-1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ab97b8badc7789562a91eb9132f14f50cc482e3c        ab97b8badc7789562a91eb9132f14f50cc482e3c        
