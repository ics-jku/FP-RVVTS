# FailID_003849 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x6000               // t5
    li x31, 0x47                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x26'}, 'clob': {'f21', 'x25', 'x26'}})
...
s8(x24)             0x00000000801806cc(2149058252)                  0x00000000801806cc(2149058252)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3cc2e6485469afd4e14daa4860f73ed37fd98178        3cc2e6485469afd4e14daa4860f73ed37fd98178        
