# FailID_005197 VP++ SF pos RV64 fmax.d
...
_reg_f1: .byte 0xe7,0x0e,0xdf,0xb6,0x57,0x32,0xd9,0xd8
_reg_f11:.byte 0xca,0xa0,0x68,0xb8,0xd9,0x48,0x32,0x16
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f1'}, 'clob': {'f11'}})
    fmax.d f11, f1, f0
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xd8d93257b6df0ee7(-1.0166257617577817e+120_d)  0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f1                  0xd8d93257b6df0ee7(-1.0166257617577817e+120_d)  0xd8d93257b6df0ee7(-1.0166257617577817e+120_d)
f11                 0xd8d93257b6df0ee7(-1.0166257617577817e+120_d)  0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            05d1ebebe5992015eb89c57899b7b88cfe08ca29        05d1ebebe5992015eb89c57899b7b88cfe08ca29        
