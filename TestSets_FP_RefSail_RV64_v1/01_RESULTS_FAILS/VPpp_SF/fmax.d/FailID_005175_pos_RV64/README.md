# FailID_005175 VP++ SF pos RV64 fmax.d
...
_reg_f28:.byte 0x00,0x00,0x90,0x42,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f22'}, 'clob': {'f28'}})
    fmax.d f28, f0, f22
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d1ff72ed6669912f4f1018359fe8b77207a117b4        d1ff72ed6669912f4f1018359fe8b77207a117b4        
