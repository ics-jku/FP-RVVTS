# FailID_005492 VP++ SF pos RV64 fmin.s
...
_reg_f21:.byte 0x00,0x00,0x80,0x40,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f5'}})
    fmin.s f5, f21, f5
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffff40800000(4.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f5, f21, f5
f5                  0xffffffff40800000(4.0_s)                       0xffffffff7fc00000(nan_s)                       X
f21                 0xffffffff40800000(4.0_s)                       0xffffffff40800000(4.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4be6310a332d0635b312283a6f897bedad74e3e9        4be6310a332d0635b312283a6f897bedad74e3e9        
