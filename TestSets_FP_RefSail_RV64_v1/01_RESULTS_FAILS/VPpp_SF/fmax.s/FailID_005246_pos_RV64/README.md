# FailID_005246 VP++ SF pos RV64 fmax.s
...
_reg_f20:.byte 0x00,0x40,0x00,0xcf,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f12'}, 'clob': {'f20'}})
    fmax.s f20, f12, f6
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e44f1f5ed6c20c596b06b71d1267235a1bc6a1aa        e44f1f5ed6c20c596b06b71d1267235a1bc6a1aa        
