# FailID_005423 VP++ SF pos RV64 fmin.d
...
_reg_f13:.byte 0x4a,0x8d,0x7d,0x86,0xbf,0x6b,0xae,0x6a
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f8'}})
    fmin.d f8, f13, f14
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x6aae6bbf867d8d4a(7.630253883921419e+205_d)    0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
f8                  0x6aae6bbf867d8d4a(7.630253883921419e+205_d)    0xffffffffffc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, f13, f14
f8                  0x6aae6bbf867d8d4a(7.630253883921419e+205_d)    0xffffffffffc00000(nan_s)                       X
f13                 0x6aae6bbf867d8d4a(7.630253883921419e+205_d)    0x6aae6bbf867d8d4a(7.630253883921419e+205_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b633dc62447dc24d8b9c06784e9288eb34314c01        b633dc62447dc24d8b9c06784e9288eb34314c01        
