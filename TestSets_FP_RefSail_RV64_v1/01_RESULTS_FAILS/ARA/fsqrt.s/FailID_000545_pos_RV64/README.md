# FailID_000545 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f23'}})
    fsqrt.s f23, f2, rdn
```
...
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff1bc3f58d(3.2418727362729993e-22_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f23, f2, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0017efcea4183881a20a8f6bda6b4417c12c7e4c        0017efcea4183881a20a8f6bda6b4417c12c7e4c        
