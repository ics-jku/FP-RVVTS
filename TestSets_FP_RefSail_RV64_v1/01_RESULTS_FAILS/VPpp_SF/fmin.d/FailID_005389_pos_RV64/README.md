# FailID_005389 VP++ SF pos RV64 fmin.d
...
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x00,0x80,0x4c,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f22'}, 'clob': {'f15'}})
    fmin.d f15, f22, f18
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x404c800000000000(57.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f15, f22, f18
+========================================================================================================================+
...
f15                 0x404c800000000000(57.0_d)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f22, f18
f15                 0x404c800000000000(57.0_d)                      0xffffffff7fc00000(nan_s)                       X
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f22                 0x404c800000000000(57.0_d)                      0x404c800000000000(57.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            913d5e0e5320543ee31efeb507f145719408e30d        913d5e0e5320543ee31efeb507f145719408e30d        
