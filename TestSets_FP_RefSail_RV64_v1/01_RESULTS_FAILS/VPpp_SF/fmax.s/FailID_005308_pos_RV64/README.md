# FailID_005308 VP++ SF pos RV64 fmax.s
...
_reg_f5: .byte 0x00,0x00,0x20,0xe5,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f2'}, 'clob': {'f11'}})
    fmax.s f11, f2, f5
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f5                  0x41e002ffe5200000(2149056297.0_d)              0x41e002ffe5200000(2149056297.0_d)
f11                 0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f785c1a9c149dec65700c24a976436a24bcde7fc        f785c1a9c149dec65700c24a976436a24bcde7fc        
