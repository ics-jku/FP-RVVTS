# FailID_005519 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f29'}, 'clob': {'f2'}})
    fmin.s f2, f29, f10
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0a9a21d2690809d1340c817fd5bddd5feb2de30b        0a9a21d2690809d1340c817fd5bddd5feb2de30b        
