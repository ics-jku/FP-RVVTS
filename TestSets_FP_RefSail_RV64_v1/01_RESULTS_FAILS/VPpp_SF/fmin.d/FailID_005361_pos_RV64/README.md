# FailID_005361 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f17:.byte 0x00,0x00,0x00,0x00,0x40,0x83,0xdb,0xc0
_reg_f27:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f30:.byte 0xfd,0xbf,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f30'}})
    fmin.d f30, f17, f27
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xc0db834000000000(-28173.0_d)                  0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f30, f17, f27
+========================================================================================================================+
...
f30                 0xc0db834000000000(-28173.0_d)                  0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f17, f27
f17                 0xc0db834000000000(-28173.0_d)                  0xc0db834000000000(-28173.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            564e4ebbd65255ff8cb48ec97add58bcabca488a        564e4ebbd65255ff8cb48ec97add58bcabca488a        
