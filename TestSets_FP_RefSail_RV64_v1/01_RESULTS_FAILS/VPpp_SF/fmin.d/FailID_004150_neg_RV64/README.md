# FailID_004150 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f12', 'f19'}, 'clob': {'f24'}})
    fmin.d f24, f12, f19
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f24, f12, f19
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            541f303ac888928c7caba3b660bfd20fe35dbf0b        541f303ac888928c7caba3b660bfd20fe35dbf0b        
