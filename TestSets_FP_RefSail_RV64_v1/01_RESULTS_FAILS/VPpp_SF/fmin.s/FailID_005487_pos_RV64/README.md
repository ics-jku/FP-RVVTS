# FailID_005487 VP++ SF pos RV64 fmin.s
...
_reg_f24:.byte 0x91,0x01,0x18,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'f18'}})
    fmin.s f18, f10, f24
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f18, f10, f24
+========================================================================================================================+
...
f18                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f10, f24
f10                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f18                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
f24                 0x0000000080180191(1.0617751917e-314_d)         0x0000000080180191(1.0617751917e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8e8073ea1c8ab9f341267e78d7afdf68cdefc250        8e8073ea1c8ab9f341267e78d7afdf68cdefc250        
