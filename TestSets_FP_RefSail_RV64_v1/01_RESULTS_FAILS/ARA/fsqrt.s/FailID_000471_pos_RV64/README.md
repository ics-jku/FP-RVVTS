# FailID_000471 ARA pos RV64 fsqrt.s
...
_reg_f24:.byte 0x00,0x00,0x00,0x00,0x00,0xfe,0xdf,0x43
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f24'}})
    fsqrt.s f24, f1, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f24, f1, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            579f6a0158c7ad8a31af384624474614c233c0c8        579f6a0158c7ad8a31af384624474614c233c0c8        
