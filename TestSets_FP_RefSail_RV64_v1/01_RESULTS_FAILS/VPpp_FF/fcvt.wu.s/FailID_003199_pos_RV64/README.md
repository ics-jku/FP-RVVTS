# FailID_003199 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.s x3, f11, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x3, f11, dyn
+========================================================================================================================+
...
Registers: x3, f11
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f11                 0x41efffffffe00000(4294967295.0_d)              0x41efffffffe00000(4294967295.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            029fb6920709355dc1425910fa85ab5ec00f9d95        029fb6920709355dc1425910fa85ab5ec00f9d95        
