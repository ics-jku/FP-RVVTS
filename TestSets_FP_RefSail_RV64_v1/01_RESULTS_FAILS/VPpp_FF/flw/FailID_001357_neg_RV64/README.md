# FailID_001357 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x43550000            // fp
    li x9, 0x8006eef8            // s1
    li x10, 0x8017fb3e           // a0
    li x11, 0x8017f87c           // a1
    li x12, 0x8027f68e           // a2
    li x13, 0x800001ad           // a3
    ...
    li x28, 0x0                  // t3
    li x29, 0x0                  // t4
    li x30, 0x800001ad           // t5
    li x31, 0xee35472c           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x31'}, 'clob': {'x31', 'f19', 'x20'}})
...
f19                 0xffffffff4effffff(2147483520.0_s)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
sp(x2)              0x00000000000000f3(243)                         0x00000000000000f3(243)                         
...
t2(x7)              0x00000000801804ee(2149057774)                  0x00000000801804ee(2149057774)                  
...
a3(x13)             0x00000000800001ad(2147484077)                  0x00000000800001ad(2147484077)                  
...
s4(x20)             0x0000000080000385(2147484549)                  0x0000000080000385(2147484549)                  
...
t5(x30)             0x00000000800001ad(2147484077)                  0x00000000800001ad(2147484077)                  
t6(x31)             0x0000000080154ab1(2148879025)                  0x0000000080154ab1(2148879025)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            25f3db6b1c5f2e474e997544e408b3c7f95458e1        25f3db6b1c5f2e474e997544e408b3c7f95458e1        
