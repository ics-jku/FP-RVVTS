# FailID_005379 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f1'}, 'clob': {'f11'}})
    fmin.d f11, f1, f11
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x0000000000000000(0.0_d)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c683d95aeb0f8a79779e13612c70e55791fa7db0        c683d95aeb0f8a79779e13612c70e55791fa7db0        
