# FailID_002506 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x80124e63            // fp
    li x9, 0x801ff81c            // s1
    li x10, 0xfffffffffffffffd   // a0
    li x11, 0x8018054e           // a1
    li x12, 0x80180280           // a2
    li x13, 0x38                 // a3
    ...
    li x18, 0x0                  // s2
    li x19, 0x1                  // s3
    li x20, 0x801fff9c           // s4
    li x21, 0x8018054e           // s5
    li x22, 0x0                  // s6
    li x23, 0x8017fa33           // s7
    li x24, 0x0                  // s8
    li x25, 0x8017fdfc           // s9
    li x26, 0x0                  // s10
    li x27, 0x8017fdfc           // s11
    li x28, 0x28                 // t3
    li x29, 0xfffe000000000000   // t4
    li x30, 0x7fffff9e           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f27', 'x10'}, 'clob': {'x10', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        649b75a9b6f77978ef2224b5ba5598f4cdee1403        X
...
ra(x1)              0x000000008017fc17(2149055511)                  0x000000008017fc17(2149055511)                  
sp(x2)              0x0000000000000088(136)                         0x0000000000000088(136)                         
...
t2(x7)              0x000000008000036e(2147484526)                  0x000000008000036e(2147484526)                  
fp(x8)              0x0000000080124e63(2148683363)                  0x0000000080124e63(2148683363)                  
s1(x9)              0x00000000801ff81c(2149578780)                  0x00000000801ff81c(2149578780)                  
a0(x10)             0x000000008027fb0a(2150103818)                  0x000000008027fb0a(2150103818)                  
a1(x11)             0x000000008018054e(2149057870)                  0x000000008018054e(2149057870)                  
a2(x12)             0x0000000080180280(2149057152)                  0x0000000080180280(2149057152)                  
a3(x13)             0x0000000000000038(56)                          0x0000000000000038(56)                          
...
s4(x20)             0x00000000801fff9c(2149580700)                  0x00000000801fff9c(2149580700)                  
...
s9(x25)             0x000000008017fdfc(2149055996)                  0x000000008017fdfc(2149055996)                  
s10(x26)            0x0000000000000000(0)                           0x0000000000000000(0)                           
s11(x27)            0x000000008017fdfc(2149055996)                  0x000000008017fdfc(2149055996)                  
t3(x28)             0x0000000000000028(40)                          0x0000000000000028(40)                          
t4(x29)             0xfffe000000000000(18446181123756130304)        0xfffe000000000000(18446181123756130304)        
t5(x30)             0x000000007fffff9e(2147483550)                  0x000000007fffff9e(2147483550)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            96e469cc4afa2307e956762e3c12f4607db685de        96e469cc4afa2307e956762e3c12f4607db685de        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        649b75a9b6f77978ef2224b5ba5598f4cdee1403        X
