# FailID_005513 VP++ SF pos RV64 fmin.s
...
_reg_f10:.byte 0x00,0xf0,0xff,0x5e,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f6', 'fcsr.rm'}, 'clob': {'f25'}})
    fmin.s f25, f10, f6
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff5efff000(9.221120237041091e+18_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f25                 0xffffffff5efff000(9.221120237041091e+18_s)     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f10, f6
f6                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f10                 0xffffffff5efff000(9.221120237041091e+18_s)     0xffffffff5efff000(9.221120237041091e+18_s)
f25                 0xffffffff5efff000(9.221120237041091e+18_s)     0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f1618a8e4dac375c4928014cdb99a5ae3c575466        f1618a8e4dac375c4928014cdb99a5ae3c575466        
