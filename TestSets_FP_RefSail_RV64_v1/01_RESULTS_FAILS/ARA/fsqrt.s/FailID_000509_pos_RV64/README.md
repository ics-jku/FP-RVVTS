# FailID_000509 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_reg_f24:.byte 0x00,0x00,0x00,0x00,0x00,0x20,0x62,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f24'}})
    fsqrt.s f24, f19, dyn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f24, f19, dyn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f19
f19                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3fc1f6c47a91fddca9295f67a2d602b9652dab4b        3fc1f6c47a91fddca9295f67a2d602b9652dab4b        
