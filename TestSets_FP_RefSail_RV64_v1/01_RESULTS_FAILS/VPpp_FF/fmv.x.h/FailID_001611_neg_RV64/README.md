# FailID_001611 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'x19'}})
    fmv.x.h x19, f22
```
...
```
REG                 REF                                             DUT                                             DIFF
s3(x19)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4d324120f5886c9b2bd191b2d3f4171a1ff31d19        4d324120f5886c9b2bd191b2d3f4171a1ff31d19        
