# FailID_003580 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x30, 0x54                 // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x31'}, 'clob': {'f13', 'x26', 'x31'}})
...
f13                 0x7ff8000000000000(nan_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
s2(x18)             0x0000000000000040(64)                          0x0000000000000040(64)                          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2663a3eb758c3c07e0aa9bd2d54cdcc735ee4650        2663a3eb758c3c07e0aa9bd2d54cdcc735ee4650        
