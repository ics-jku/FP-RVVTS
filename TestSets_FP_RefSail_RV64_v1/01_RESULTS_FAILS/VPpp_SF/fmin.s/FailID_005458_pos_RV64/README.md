# FailID_005458 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x97,0x00,0x28,0x80,0xff,0xff,0xff,0xff
_reg_f18:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f24:.byte 0x5b,0x06,0x18,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f18'}, 'clob': {'f24'}})
    fmin.s f24, f11, f18
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xffffffff80280097(-3.6736314423877615e-39_s)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f24, f11, f18
+========================================================================================================================+
...
f24                 0xffffffff80280097(-3.6736314423877615e-39_s)   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f11, f18
f11                 0xffffffff80280097(-3.6736314423877615e-39_s)   0xffffffff80280097(-3.6736314423877615e-39_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cff40fc604d81be964e4d5f99697436c8c0b6b61        cff40fc604d81be964e4d5f99697436c8c0b6b61        
