# FailID_005342 VP++ SF pos RV64 fmin.d
...
_reg_f26:.byte 0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f26', 'fcsr.rm'}, 'clob': {'f18'}})
    fmin.d f18, f26, f20
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0x0000000000000200(2.53e-321_d)                 0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f18, f26, f20
+========================================================================================================================+
...
f18                 0x0000000000000200(2.53e-321_d)                 0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f26, f20
f18                 0x0000000000000200(2.53e-321_d)                 0xffffffff7fc00000(nan_s)                       X
f20                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f26                 0x0000000000000200(2.53e-321_d)                 0x0000000000000200(2.53e-321_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e7fa1f29819eda3673d67497248960bbced80c0a        e7fa1f29819eda3673d67497248960bbced80c0a        
