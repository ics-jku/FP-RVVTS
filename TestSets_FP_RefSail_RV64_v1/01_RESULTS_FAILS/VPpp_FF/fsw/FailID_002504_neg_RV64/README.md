# FailID_002504 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x18, 0x8017fbaf           // s2
    li x19, 0x1                  // s3
    li x20, 0x7ffffae7           // s4
    li x21, 0x7ffffa79           // s5
    li x22, 0x6000               // s6
    li x23, 0x8000060f           // s7
    li x24, 0x7ffffa79           // s8
    li x25, 0x16                 // s9
    li x26, 0x1                  // s10
    li x27, 0x1                  // s11
    li x28, 0x80000598           // t3
    li x29, 0x6000               // t4
    li x30, 0x8018041f           // t5
    li x31, 0x80000549           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f10', 'x18'}, 'clob': {'x18', 'x23'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ad69e778414164cb20a1f9dd6911883d18c2f70f        X
...
s8(x24)             0x000000007ffffa79(2147482233)                  0x000000007ffffa79(2147482233)                  
...
t3(x28)             0x0000000080000598(2147485080)                  0x0000000080000598(2147485080)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8102c446d76c254fad77f616c92a3bfa8f4674b6        8102c446d76c254fad77f616c92a3bfa8f4674b6        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ad69e778414164cb20a1f9dd6911883d18c2f70f        X
