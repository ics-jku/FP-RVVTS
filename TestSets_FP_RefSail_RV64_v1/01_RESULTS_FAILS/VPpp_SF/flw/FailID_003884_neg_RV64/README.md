# FailID_003884 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x10, 0x38                 // a0
    li x11, 0x1                  // a1
    li x12, 0x8017f906           // a2
    li x13, 0x800007e5           // a3
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'x6', 'f14', 'x7'}})
...
f14                 0x7ff8000000000000(nan_d)                       0xffffffff81be0e13(-6.981517259354117e-38_s)    X
STATES DIFFER: True
```
...
a2(x12)             0x000000008017f906(2149054726)                  0x000000008017f906(2149054726)                  
a3(x13)             0x00000000800007e5(2147485669)                  0x00000000800007e5(2147485669)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            819569c26957d1cb20e69e1366d6654c24556d65        819569c26957d1cb20e69e1366d6654c24556d65        
