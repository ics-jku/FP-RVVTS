# FailID_000352 ARA pos RV64 fsqrt.s
...
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fsqrt.s f10, f25, rmm
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f10, f25, rmm
+========================================================================================================================+
...
Registers: f10, f25
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f25                 0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9b6a9480bdb52b159df4e3339ff45fa32ae0d040        9b6a9480bdb52b159df4e3339ff45fa32ae0d040        
