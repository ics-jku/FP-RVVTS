# FailID_005235 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f31'}, 'clob': {'f12'}})
    fmax.s f12, f31, f27
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f12, f31, f27
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8df887c7a897607829c4e84825e36c4d1bcd63db        8df887c7a897607829c4e84825e36c4d1bcd63db        
