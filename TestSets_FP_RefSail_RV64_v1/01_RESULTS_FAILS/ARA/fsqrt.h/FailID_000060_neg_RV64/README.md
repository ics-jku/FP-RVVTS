# FailID_000060 ARA neg RV64 fsqrt.h
...
_reg_f30:.byte 0xf7,0xfd,0xff,0x7f,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f0'}, 'clob': {'f30'}})
    fsqrt.h f30, f0, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f30, f0, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1bd94aaaf816d5982e7c26e95629f0f763c19fa6        1bd94aaaf816d5982e7c26e95629f0f763c19fa6        
