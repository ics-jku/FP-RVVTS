# FailID_005387 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f14', 'fcsr.rm'}, 'clob': {'f5'}})
    fmin.d f5, f15, f14
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1938c78d2f06d9c836a4e9b5df95bea9707aa757        1938c78d2f06d9c836a4e9b5df95bea9707aa757        
