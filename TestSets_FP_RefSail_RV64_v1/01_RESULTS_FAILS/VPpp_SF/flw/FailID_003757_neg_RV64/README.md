# FailID_003757 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x200601             // s10
    li x27, 0x8017fcb7           // s11
    li x28, 0x801801c9           // t3
    li x29, 0x8017fd3c           // t4
    li x30, 0x0                  // t5
    li x31, 0xffffffffffffffff   // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm'}, 'clob': {'x5', 'x29', 'f25'}})
...
f25                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, x5, a3, x29
t0(x5)              0x000000007ffffa5d(2147482205)                  0x000000007ffffa5d(2147482205)
t4(x29)             0x000000008017f799(2149054361)                  0x000000008017f799(2149054361)
f25                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
s11(x27)            0x000000008017fcb7(2149055671)                  0x000000008017fcb7(2149055671)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b32fe7cf1ff54e23853a712c7d81c83db8520495        b32fe7cf1ff54e23853a712c7d81c83db8520495        
