# FailID_005148 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f17:.byte 0xc0,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f29:.byte 0x00,0x00,0xc0,0x66,0xfe,0xff,0xdf,0x41
_reg_f31:.byte 0x10,0xfd,0xff,0xcb,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f31'}, 'clob': {'f29'}})
    fmax.d f29, f17, f31
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x00000000000000c0(9.5e-322_d)                  0xffffffffcbfffd10(-33552928.0_s)               X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f29, f17, f31
+========================================================================================================================+
...
f29                 0x00000000000000c0(9.5e-322_d)                  0xffffffffcbfffd10(-33552928.0_s)               X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f17, f31
f17                 0x00000000000000c0(9.5e-322_d)                  0x00000000000000c0(9.5e-322_d)
f29                 0x00000000000000c0(9.5e-322_d)                  0xffffffffcbfffd10(-33552928.0_s)               X
f31                 0xffffffffcbfffd10(-33552928.0_s)               0xffffffffcbfffd10(-33552928.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d899fbb5726a35efb38ce3218c86d64f4c33615f        d899fbb5726a35efb38ce3218c86d64f4c33615f        
