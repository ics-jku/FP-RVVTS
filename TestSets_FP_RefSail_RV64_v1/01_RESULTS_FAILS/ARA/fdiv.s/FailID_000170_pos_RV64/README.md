# FailID_000170 ARA pos RV64 fdiv.s
...
_reg_f5: .byte 0x00,0x00,0x80,0x9b,0xfe,0xff,0xdf,0x41
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f22'}})
    fdiv.s f22, f5, f3, rup
```
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f22, f5, f3, rup
+========================================================================================================================+
Attributes:  fcsr ['div-by-0'], special values ['nan', 'inf', 'zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f5                  0x41dffffe9b800000(2147482222.0_d)              0x41dffffe9b800000(2147482222.0_d)
f22                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dbc3e210b0a34d7f3e684ffbe92e6abc0fccfa30        dbc3e210b0a34d7f3e684ffbe92e6abc0fccfa30        
