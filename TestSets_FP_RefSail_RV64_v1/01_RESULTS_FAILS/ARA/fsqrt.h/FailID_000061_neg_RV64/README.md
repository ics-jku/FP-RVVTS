# FailID_000061 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f26', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f3'}})
    fsqrt.h f3, f26, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f3, f26, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1457cac64c29fe5fba16be9c85c5bf8d7703846e        1457cac64c29fe5fba16be9c85c5bf8d7703846e        
