# FailID_005392 VP++ SF pos RV64 fmin.d
...
_reg_f27:.byte 0x17,0xfa,0x17,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f27'}})
    fmin.d f27, f9, f14
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            95062d46012765f9df7cac1e49bc9ab329711479        95062d46012765f9df7cac1e49bc9ab329711479        
