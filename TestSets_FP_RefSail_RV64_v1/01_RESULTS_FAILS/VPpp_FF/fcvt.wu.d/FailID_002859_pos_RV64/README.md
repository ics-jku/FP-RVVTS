# FailID_002859 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0xfe,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x20'}})
    fcvt.wu.d x20, f8, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x20, f8, rmm
+========================================================================================================================+
...
Registers: x20, f8
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f8                  0xffffffff4f0017fe(2149056000.0_s)              0xffffffff4f0017fe(2149056000.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6c9dfd79f5be731f9a6ade9b7126713408833e6b        6c9dfd79f5be731f9a6ade9b7126713408833e6b        
