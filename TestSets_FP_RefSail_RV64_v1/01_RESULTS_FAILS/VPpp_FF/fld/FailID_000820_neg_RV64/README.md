# FailID_000820 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x1                   // fp
    li x9, 0x1                   // s1
    li x10, 0x80180004           // a0
    li x11, 0x1                  // a1
    li x12, 0x80000814           // a2
    li x13, 0x7ffffce7           // a3
    li x14, 0xfe                 // a4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs'}, 'clob': {'x8', 'f21', 'x29'}})
...
f21                 0xffffffffffc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
a0(x10)             0x0000000080180004(2149056516)                  0x0000000080180004(2149056516)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            30243081b2711e4ebe43540e30111ff31c3bc0bf        30243081b2711e4ebe43540e30111ff31c3bc0bf        
