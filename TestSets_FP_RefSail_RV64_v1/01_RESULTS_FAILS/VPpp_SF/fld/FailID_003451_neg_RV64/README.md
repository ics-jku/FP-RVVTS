# FailID_003451 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'x10', 'f1'}})
...
f1                  0xffffffff7fc00000(nan_s)                       0x0002bd87e9428293(3.810932795965107e-309_d)    X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6a6f0f3f7779831f692dd82f48de0b18a366010a        6a6f0f3f7779831f692dd82f48de0b18a366010a        
