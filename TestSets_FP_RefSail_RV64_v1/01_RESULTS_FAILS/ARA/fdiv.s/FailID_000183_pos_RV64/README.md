# FailID_000183 ARA pos RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f8'}})
    fdiv.s f8, f21, f4, rne
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f8, f21, f4, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a48223379495da552d86d6d070a3255cb7b44c5f        a48223379495da552d86d6d070a3255cb7b44c5f        
