# FailID_004459 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x24, 0x2                  // s8
    li x25, 0x7                  // s9
    li x26, 0x801801c0           // s10
    li x27, 0x80200544           // s11
    li x28, 0x30                 // t3
    li x29, 0x8018010f           // t4
    li x30, 0x8000017a           // t5
    li x31, 0x8000020f           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'f18', 'fcsr.rm'}, 'clob': {'x29', 'x26'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        90d4e42a0bcf6ed49a7dcf88a3af1bfa60544fe3        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, x1, e1, x29
ra(x1)              0x0000000000006000(24576)                       0x0000000000006000(24576)
t4(x29)             0x00000000801fff27(2149580583)                  0x00000000801fff27(2149580583)
...
s11(x27)            0x0000000080200544(2149582148)                  0x0000000080200544(2149582148)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            10bb14f5b026ca3fc1f13eb5156680153e973b01        10bb14f5b026ca3fc1f13eb5156680153e973b01        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        90d4e42a0bcf6ed49a7dcf88a3af1bfa60544fe3        X
