# FailID_005323 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f5'}, 'clob': {'f26'}})
    fmax.s f26, f5, f3
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff4eba3460(1561997312.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dc9e1a7ddca1191b8507047b0f31d0cf34eae65c        dc9e1a7ddca1191b8507047b0f31d0cf34eae65c        
