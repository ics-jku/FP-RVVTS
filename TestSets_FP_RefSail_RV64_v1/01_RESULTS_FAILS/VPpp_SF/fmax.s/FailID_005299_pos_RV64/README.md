# FailID_005299 VP++ SF pos RV64 fmax.s
...
_reg_f26:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f3'}, 'clob': {'f26'}})
    fmax.s f26, f26, f3
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff80000000(-0.0_s)                      0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9745fed147d1ffdf5d4d9a263edbf08aeef20ea0        9745fed147d1ffdf5d4d9a263edbf08aeef20ea0        
