# FailID_005133 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f22'}, 'clob': {'f19'}})
    fmax.d f19, f30, f22
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x000000132140006f(4.05935308646e-313_d)        0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f19, f30, f22
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d62a10dbed7dbeadba1d2316ad46b86f2e295720        d62a10dbed7dbeadba1d2316ad46b86f2e295720        
