# FailID_001250 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x6000               // t5
    li x31, 0x801806ac           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x22', 'mstatus.fs/vs.fs'}, 'clob': {'x22', 'x6', 'f26'}})
...
f26                 0xffffffff4efffff9(2147482752.0_s)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f26                 0xffffffff4efffff9(2147482752.0_s)              0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, x6, x22
t1(x6)              0x00000000800006ae(2147485358)                  0x00000000800006ae(2147485358)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5a118c5222410825c217ec53dc69322360fd9ae8        5a118c5222410825c217ec53dc69322360fd9ae8        
