# FailID_005294 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f22'}, 'clob': {'f17'}})
    fmax.s f17, f16, f22
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f17, f16, f22
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            60579f62f15679af1ddf224e03902f02b77763da        60579f62f15679af1ddf224e03902f02b77763da        
