# FailID_005109 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x80000228            // fp
    li x9, 0x8005c55b            // s1
    li x10, 0x800007e2           // a0
    li x11, 0x1002ffe            // a1
    li x12, 0x23                 // a2
    li x13, 0x8027e1bb           // a3
    li x14, 0x8017f8a3           // a4
    li x15, 0x2005fe26           // a5
    ...
    li x26, 0x0                  // s10
    li x27, 0x7fffff5f           // s11
    li x28, 0x801ffbc7           // t3
    li x29, 0x8007e00b           // t4
    li x30, 0x8017fb29           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f12', 'fcsr.rm', 'x10'}, 'clob': {'x14', 'x10'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        74ca9dc801d29cdb994e01d5c4ce0f354e60a98d        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, xd3, x10
a0(x10)             0x00000000801808b3(2149058739)                  0x00000000801808b3(2149058739)
...
ra(x1)              0x000000008017f8c3(2149054659)                  0x000000008017f8c3(2149054659)                  
...
t2(x7)              0x00000000802005f2(2149582322)                  0x00000000802005f2(2149582322)                  
...
a0(x10)             0x00000000801808b3(2149058739)                  0x00000000801808b3(2149058739)                  
a1(x11)             0x0000000001002ffe(16789502)                    0x0000000001002ffe(16789502)                    
...
a5(x15)             0x000000002005fe26(537263654)                   0x000000002005fe26(537263654)                   
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e23add33b1e4b21b638de1de4b819052541c16d9        e23add33b1e4b21b638de1de4b819052541c16d9        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        74ca9dc801d29cdb994e01d5c4ce0f354e60a98d        X
