# FailID_001999 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x7, 0x80006121            // t2
    li x8, 0x80000121            // fp
    li x9, 0x801fffae00          // s1
    li x10, 0x801af455           // a0
    li x11, 0x8000058f           // a1
    li x12, 0xffffffffffff9a2b   // a2
    li x13, 0x80180603           // a3
    li x14, 0x0                  // a4
    li x15, 0x1                  // a5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f27', 'x21'}, 'clob': {'x8', 'x21'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x4, b9, x21
tp(x4)              0x0000000080000256(2147484246)                  0x0000000080000256(2147484246)
s5(x21)             0x0000000080200eb7(2149584567)                  0x0000000080200eb7(2149584567)
...
s1(x9)              0x000000801fffae00(550292663808)                0x000000801fffae00(550292663808)                
...
a2(x12)             0xffffffffffff9a2b(18446744073709525547)        0xffffffffffff9a2b(18446744073709525547)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            28c1f34735d5a83da7d682df6108f98d012e5bce        28c1f34735d5a83da7d682df6108f98d012e5bce        
