# FailID_005408 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x4b,0xfe,0xff,0xdf,0x41
_reg_f20:.byte 0x00,0x00,0x40,0x42,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f25'}})
    fmin.d f25, f2, f20
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0x41dffffe4b000000(2147481900.0_d)              0xffffffff42400000(48.0_s)                      X
STATES DIFFER: True
```
...
f25                 0x41dffffe4b000000(2147481900.0_d)              0xffffffff42400000(48.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f2, f20
f2                  0x41dffffe4b000000(2147481900.0_d)              0x41dffffe4b000000(2147481900.0_d)
f20                 0xffffffff42400000(48.0_s)                      0xffffffff42400000(48.0_s)
f25                 0x41dffffe4b000000(2147481900.0_d)              0xffffffff42400000(48.0_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            130eb97d73f7a84308667ba0ccd32f6e8e2b4ee6        130eb97d73f7a84308667ba0ccd32f6e8e2b4ee6        
