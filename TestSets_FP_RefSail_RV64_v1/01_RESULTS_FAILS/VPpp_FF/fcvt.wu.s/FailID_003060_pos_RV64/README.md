# FailID_003060 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0xcb,0xcb,0x81,0x8b,0x3c,0x62,0xb1,0x85
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x17'}})
    fcvt.wu.s x17, f18, rup
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x17, f18, rup
+========================================================================================================================+
...
Registers: x17, f18
a7(x17)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f18                 0x85b1623c8b81cbcb(-2.992727573127402e-281_d)   0x85b1623c8b81cbcb(-2.992727573127402e-281_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            81c494283f00381d397fd1604451d3e5ee91492d        81c494283f00381d397fd1604451d3e5ee91492d        
