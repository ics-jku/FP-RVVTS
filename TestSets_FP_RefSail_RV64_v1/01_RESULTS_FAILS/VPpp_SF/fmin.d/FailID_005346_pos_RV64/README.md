# FailID_005346 VP++ SF pos RV64 fmin.d
...
_reg_f14:.byte 0x00,0x00,0x80,0x3b,0x00,0xfe,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f14', 'fcsr.rm'}, 'clob': {'f4'}})
    fmin.d f4, f14, f10
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xc1dffe003b800000(-2146959598.0_d)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f4                  0xc1dffe003b800000(-2146959598.0_d)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, f14, f10
f4                  0xc1dffe003b800000(-2146959598.0_d)             0xffffffff7fc00000(nan_s)                       X
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f14                 0xc1dffe003b800000(-2146959598.0_d)             0xc1dffe003b800000(-2146959598.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            acbeb75ff58e735903081e1b09ab6e0913309457        acbeb75ff58e735903081e1b09ab6e0913309457        
