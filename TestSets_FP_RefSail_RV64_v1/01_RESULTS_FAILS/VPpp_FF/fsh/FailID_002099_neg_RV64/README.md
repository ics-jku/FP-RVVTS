# FailID_002099 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x28, 0x80180259           // t3
    li x29, 0x8017f9e3           // t4
    li x30, 0x1                  // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'x30', 'x20'}})
...
t0(x5)              0x0000000000000480(1152)                        0x0000000000000480(1152)                        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            934b96928e1b168645405f500f19f18e3d3affab        934b96928e1b168645405f500f19f18e3d3affab        
