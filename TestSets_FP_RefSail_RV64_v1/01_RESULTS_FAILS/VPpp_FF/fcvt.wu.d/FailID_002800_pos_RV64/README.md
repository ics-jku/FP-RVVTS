# FailID_002800 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x01,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x1'}})
    fcvt.wu.d x1, f23, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x1, f23, rne
+========================================================================================================================+
...
Registers: x1, f23
ra(x1)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f23                 0xffffffff00000001(1.401298464324817e-45_s)     0xffffffff00000001(1.401298464324817e-45_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6e3a6a027dbc93b1a6656c72170ac29828125f0b        6e3a6a027dbc93b1a6656c72170ac29828125f0b        
