# FailID_002085 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x9, 0x1                   // s1
    li x10, 0x85                 // a0
    li x11, 0x8018054d           // a1
    li x12, 0x8017fe95           // a2
    li x13, 0xffffffffac3bf000   // a3
    li x14, 0x11                 // a4
    li x15, 0x0                  // a5
    li x16, 0xe5f3a718           // a6
    li x17, 0x8017ff07           // a7
    li x18, 0x1                  // s2
    li x19, 0x0                  // s3
    ...
    li x28, 0x6000               // t3
    li x29, 0x80180f29           // t4
    li x30, 0x0                  // t5
    li x31, 0x8017f955           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f13', 'mstatus.fs/vs.fs', 'x14'}, 'clob': {'x2', 'x14'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x106, x14
a4(x14)             0x000000008017ff0a(2149056266)                  0x000000008017ff0a(2149056266)
...
sp(x2)              0x000000008017fefa(2149056250)                  0x000000008017fefa(2149056250)                  
gp(x3)              0x000000010017f6c9(4296537801)                  0x000000010017f6c9(4296537801)                  
...
fp(x8)              0x00000000801ffaa9(2149579433)                  0x00000000801ffaa9(2149579433)                  
s1(x9)              0x0000000000000001(1)                           0x0000000000000001(1)                           
a0(x10)             0x0000000000000085(133)                         0x0000000000000085(133)                         
a1(x11)             0x000000008018054d(2149057869)                  0x000000008018054d(2149057869)                  
a2(x12)             0x000000008017fe95(2149056149)                  0x000000008017fe95(2149056149)                  
...
t4(x29)             0x0000000080180f29(2149060393)                  0x0000000080180f29(2149060393)                  
t5(x30)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t6(x31)             0x000000008017f955(2149054805)                  0x000000008017f955(2149054805)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            b3e7550dfb92698349387c991a54beaf6aa489ff        b3e7550dfb92698349387c991a54beaf6aa489ff        
