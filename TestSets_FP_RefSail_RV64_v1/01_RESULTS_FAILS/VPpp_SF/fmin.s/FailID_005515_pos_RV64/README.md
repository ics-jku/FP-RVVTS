# FailID_005515 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'f0', 'fcsr.rm'}, 'clob': {'f22'}})
    fmin.s f22, f26, f0
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b5983b078802a65f954d0c580b693f19e3eef329        b5983b078802a65f954d0c580b693f19e3eef329        
