# FailID_001994 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f3', 'x16', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'x24'}})
...
fp(x8)              0x0000000080000362(2147484514)                  0x0000000080000362(2147484514)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ac08d72faad837171286d4e18b9344ff6e8c2a20        ac08d72faad837171286d4e18b9344ff6e8c2a20        
