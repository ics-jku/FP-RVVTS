# FailID_000360 ARA pos RV64 fsqrt.s
...
_reg_f22:.byte 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f2'}})
    fsqrt.s f2, f22, rne
```
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff1a3504f3(3.743392066509216e-23_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f2, f22, rne
+========================================================================================================================+
...
Registers: f2, f22
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff1a3504f3(3.743392066509216e-23_s)     X
f22                 0x0000000000000001(5e-324_d)                    0x0000000000000001(5e-324_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cd72f8a474845885dac6001fcb8969600930eb7a        cd72f8a474845885dac6001fcb8969600930eb7a        
