# FailID_003677 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'f20', 'x29', 'x10'}})
...
f20                 0x7fffffff00000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f20                 0x7fffffff00000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, x309, x10
a0(x10)             0x00000000801ffeb1(2149580465)                  0x00000000801ffeb1(2149580465)
f20                 0x7fffffff00000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
ra(x1)              0x000000007fffffb1(2147483569)                  0x000000007fffffb1(2147483569)                  
...
s1(x9)              0x0000000000000691(1681)                        0x0000000000000691(1681)                        
a0(x10)             0x00000000801ffeb1(2149580465)                  0x00000000801ffeb1(2149580465)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            61af7a1f6f09dba576407419d550924bae9a9fed        61af7a1f6f09dba576407419d550924bae9a9fed        
