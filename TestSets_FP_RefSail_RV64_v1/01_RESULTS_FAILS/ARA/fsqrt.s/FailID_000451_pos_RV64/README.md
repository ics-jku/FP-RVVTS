# FailID_000451 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0xc7,0xb4,0x20,0x7c,0x85,0x6e,0x17,0xa6
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f9', 'mstatus.fs/vs.fs'}, 'clob': {'f9'}})
    fsqrt.s f9, f9, dyn
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff5dcad4f7(1.8269472837620204e+18_s)    X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2f1a4b29dc54ea43a57bb054e3b2cb9ff3b99b82        2f1a4b29dc54ea43a57bb054e3b2cb9ff3b99b82        
