# FailID_005284 VP++ SF pos RV64 fmax.s
...
_reg_f23:.byte 0x15,0xc0,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f23', 'fcsr.rm'}, 'clob': {'f28'}})
    fmax.s f28, f23, f15
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff4effc015(2145389184.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f28, f23, f15
+========================================================================================================================+
...
f28                 0xffffffff4effc015(2145389184.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f23, f15
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f23                 0xffffffff4effc015(2145389184.0_s)              0xffffffff4effc015(2145389184.0_s)
f28                 0xffffffff4effc015(2145389184.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            91b2fcd746ebe678bb3928292ff3ee2619d4b0a4        91b2fcd746ebe678bb3928292ff3ee2619d4b0a4        
