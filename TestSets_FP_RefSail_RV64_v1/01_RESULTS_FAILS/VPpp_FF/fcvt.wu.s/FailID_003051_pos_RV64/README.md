# FailID_003051 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x00,0xc0,0x34,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x29'}})
    fcvt.wu.s x29, f12
```
...
Registers: x29, f12
t4(x29)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f12                 0x41e0000034c00000(2147484070.0_d)              0x41e0000034c00000(2147484070.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9e57a6ce07c54e98cd904f2792499b2fb2f7d72f        9e57a6ce07c54e98cd904f2792499b2fb2f7d72f        
