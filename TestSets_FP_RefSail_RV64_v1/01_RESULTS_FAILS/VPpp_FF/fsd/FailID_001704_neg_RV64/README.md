# FailID_001704 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x15, 0xf8d6b77c           // a5
    li x16, 0x8005d9ad           // a6
    li x17, 0x80                 // a7
    li x18, 0x59                 // s2
    li x19, 0x200600444000       // s3
    li x20, 0x1                  // s4
    li x21, 0x80180111           // s5
    li x22, 0x0                  // s6
    li x23, 0x6000               // s7
    li x24, 0x8027fc48           // s8
    li x25, 0x62f03000           // s9
    li x26, 0xffffffffaa7c3000   // s10
    li x27, 0x7ffff903000000     // s11
    li x28, 0x0                  // t3
    li x29, 0xd5                 // t4
    li x30, 0x7ffff903           // t5
    li x31, 0x40                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f6', 'x1'}, 'clob': {'x9', 'x1'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, x467, x1
ra(x1)              0x000000008017fb99(2149055385)                  0x000000008017fb99(2149055385)
...
s1(x9)              0x000000008017fb99(2149055385)                  0x000000008017fb99(2149055385)                  
...
a5(x15)             0x00000000f8d6b77c(4174821244)                  0x00000000f8d6b77c(4174821244)                  
...
s3(x19)             0x0000200600444000(35210146365440)              0x0000200600444000(35210146365440)              
s4(x20)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s5(x21)             0x0000000080180111(2149056785)                  0x0000000080180111(2149056785)                  
...
s9(x25)             0x0000000062f03000(1659908096)                  0x0000000062f03000(1659908096)                  
s10(x26)            0xffffffffaa7c3000(18446744072274849792)        0xffffffffaa7c3000(18446744072274849792)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6786353742fd5437808c9651c655c8437f974bf5        6786353742fd5437808c9651c655c8437f974bf5        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        62ca3486298f70a21f191cd85cef9af4c6a0ac08        X
