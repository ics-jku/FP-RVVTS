# FailID_000134 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0xf9,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f15:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f30:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f30'}, 'clob': {'f15'}})
    fdiv.s f15, f30, f12, rtz
```
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff11bfdc80(3.0270380196318614e-28_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f30, f12, rtz
+========================================================================================================================+
Attributes:  fcsr ['inexact'], special values ['nan', 'zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff11bfdc80(3.0270380196318614e-28_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f30, f12
f12                 0xffffffff4f0017f9(2149054720.0_s)              0xffffffff4f0017f9(2149054720.0_s)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff11bfdc80(3.0270380196318614e-28_s)    X
f30                 0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3298e48b0ead411d29d2b371e92e84b312a3059c        3298e48b0ead411d29d2b371e92e84b312a3059c        
