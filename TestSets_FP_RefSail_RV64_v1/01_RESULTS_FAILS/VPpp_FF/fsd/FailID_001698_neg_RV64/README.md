# FailID_001698 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x9, 0x0                   // s1
    li x10, 0x5                  // a0
    li x11, 0x8017fd0c           // a1
    li x12, 0x80180618           // a2
    li x13, 0x51                 // a3
    li x14, 0x801c96f2           // a4
    li x15, 0xc987f7c4           // a5
    li x16, 0x8017fca6           // a6
    li x17, 0x8018b44c           // a7
    li x18, 0x80000916           // s2
    li x19, 0x80200233           // s3
    li x20, 0x8000026a           // s4
    li x21, 0x801803ac           // s5
    li x22, 0xc8fa2768           // s6
    li x23, 0x62                 // s7
    li x24, 0x801801e1           // s8
    li x25, 0x1                  // s9
    li x26, 0x8020007c           // s10
    li x27, 0x800182c1           // s11
    li x28, 0x6000               // t3
    li x29, 0x7fffff720          // t4
    li x30, 0x6000               // t5
    li x31, 0xf061f76c           // t6
    // INSTRUCTION ({'dep': {'x4', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f18'}, 'clob': {'x4', 'x1'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, x649, x4
tp(x4)              0x00000000801ffd7f(2149580159)                  0x00000000801ffd7f(2149580159)
...
ra(x1)              0x000000008017f9b7(2149054903)                  0x000000008017f9b7(2149054903)                  
sp(x2)              0x0000000000000001(1)                           0x0000000000000001(1)                           
gp(x3)              0xfffffffffffffabb(18446744073709550267)        0xfffffffffffffabb(18446744073709550267)        
tp(x4)              0x00000000801ffd7f(2149580159)                  0x00000000801ffd7f(2149580159)                  
...
fp(x8)              0x00000000801803ac(2149057452)                  0x00000000801803ac(2149057452)                  
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x0000000000000005(5)                           0x0000000000000005(5)                           
a1(x11)             0x000000008017fd0c(2149055756)                  0x000000008017fd0c(2149055756)                  
a2(x12)             0x0000000080180618(2149058072)                  0x0000000080180618(2149058072)                  
a3(x13)             0x0000000000000051(81)                          0x0000000000000051(81)                          
a4(x14)             0x00000000801c96f2(2149357298)                  0x00000000801c96f2(2149357298)                  
a5(x15)             0x00000000c987f7c4(3381131204)                  0x00000000c987f7c4(3381131204)                  
a6(x16)             0x000000008017fca6(2149055654)                  0x000000008017fca6(2149055654)                  
a7(x17)             0x000000008018b44c(2149102668)                  0x000000008018b44c(2149102668)                  
s2(x18)             0x0000000080000916(2147485974)                  0x0000000080000916(2147485974)                  
s3(x19)             0x0000000080200233(2149581363)                  0x0000000080200233(2149581363)                  
s4(x20)             0x000000008000026a(2147484266)                  0x000000008000026a(2147484266)                  
s5(x21)             0x00000000801803ac(2149057452)                  0x00000000801803ac(2149057452)                  
s6(x22)             0x00000000c8fa2768(3371837288)                  0x00000000c8fa2768(3371837288)                  
s7(x23)             0x0000000000000062(98)                          0x0000000000000062(98)                          
s8(x24)             0x00000000801801e1(2149056993)                  0x00000000801801e1(2149056993)                  
s9(x25)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s10(x26)            0x000000008020007c(2149580924)                  0x000000008020007c(2149580924)                  
s11(x27)            0x00000000800182c1(2147582657)                  0x00000000800182c1(2147582657)                  
...
t6(x31)             0x00000000f061f76c(4032952172)                  0x00000000f061f76c(4032952172)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            d6b0119ca1073a470f6986f8ed5d60bf2d2de979        d6b0119ca1073a470f6986f8ed5d60bf2d2de979        
