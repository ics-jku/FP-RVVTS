# FailID_000324 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fsqrt.s f29, f11, rmm
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f29, f11, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            02135cb5cb2fd2087d52d73b3c762625589a0c9a        02135cb5cb2fd2087d52d73b3c762625589a0c9a        
