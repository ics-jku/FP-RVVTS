# FailID_004155 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f23'}, 'clob': {'f1'}})
    fmin.d f1, f14, f23
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0x41eacfecf1800000(3598673804.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            27d4641771167ea4c7d61749eae58059f78e053d        27d4641771167ea4c7d61749eae58059f78e053d        
