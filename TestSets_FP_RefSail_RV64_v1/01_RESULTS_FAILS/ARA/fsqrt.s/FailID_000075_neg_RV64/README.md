# FailID_000075 ARA neg RV64 fsqrt.s
...
_reg_f23:.byte 0x00,0x00,0x80,0x0b,0xff,0x04,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f23'}, 'clob': {'f17'}})
    fsqrt.s f17, f23, dyn
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff25800000(2.220446049250313e-16_s)     X
STATES DIFFER: True
```
...
Registers: f17, f23
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff25800000(2.220446049250313e-16_s)     X
f23                 0x41e004ff0b800000(2150103132.0_d)              0x41e004ff0b800000(2150103132.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3bd6e2f2aaa63ea17e431771b810deb5ac6feed9        3bd6e2f2aaa63ea17e431771b810deb5ac6feed9        
