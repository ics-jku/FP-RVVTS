# FailID_000205 ARA pos RV64 fdiv.s
...
_reg_f25:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
_reg_f27:.byte 0x73,0x00,0x20,0x30,0xb7,0x01,0x08,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fdiv.s f10, f25, f27, rup
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff30999984(1.117584691456841e-09_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f10, f25, f27, rup
+========================================================================================================================+
...
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff30999984(1.117584691456841e-09_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f25, f27
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff30999984(1.117584691456841e-09_s)     X
f25                 0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
f27                 0x000801b730200073(1.113468884316233e-308_d)    0x000801b730200073(1.113468884316233e-308_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            de0f7e25d773c7dc19323720e53096d1704d0d64        de0f7e25d773c7dc19323720e53096d1704d0d64        
