# FailID_004164 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f26'}, 'clob': {'f0'}})
    fmin.s f0, f18, f26
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aae225df42ace59471028d40fb990107fecf2c61        aae225df42ace59471028d40fb990107fecf2c61        
