# FailID_004127 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f23'}, 'clob': {'f2'}})
    fmax.s f2, f4, f23
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f7e3b8448b7e706076fe94862774b42ea088b8f3        f7e3b8448b7e706076fe94862774b42ea088b8f3        
