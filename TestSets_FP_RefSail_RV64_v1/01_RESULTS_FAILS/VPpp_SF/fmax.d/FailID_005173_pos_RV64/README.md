# FailID_005173 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f16', 'fcsr.rm'}, 'clob': {'f16'}})
    fmax.d f16, f0, f16
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x8000000000000000(-0.0_d)                      0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f16                 0x8000000000000000(-0.0_d)                      0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f0, f16
f0                  0x8000000000000000(-0.0_d)                      0x8000000000000000(-0.0_d)
f16                 0x8000000000000000(-0.0_d)                      0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fddb0e3a7867f982044250800da53933e6bf0fcf        fddb0e3a7867f982044250800da53933e6bf0fcf        
