# FailID_002979 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f31:.byte 0x73,0x90,0x01,0xb4,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f31
    fld  f31, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.s x3, f31, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x3, f31, dyn
+========================================================================================================================+
...
Registers: x3, f31
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f31                 0x7fffffffb4019073(nan_d)                       0x7fffffffb4019073(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1b2057fe97569024a00d17192674fc5ec282b0da        1b2057fe97569024a00d17192674fc5ec282b0da        
