# FailID_001904 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x21, 0x80186317           // s5
    li x22, 0x801807e8           // s6
    li x23, 0x7ffffdd1           // s7
    li x24, 0x8017fe4f           // s8
    li x25, 0x0                  // s9
    li x26, 0x6e                 // s10
    li x27, 0x802802f5           // s11
    li x28, 0xffff               // t3
    li x29, 0xffffffffd214e000   // t4
    li x30, 0x800d591d           // t5
    li x31, 0x2ffe750            // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x25', 'mstatus.fs/vs.fs', 'f12'}, 'clob': {'x12', 'x25'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        926e620a44b0ed903a0a15952d5702895be4a96b        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, x2, b6, x25
sp(x2)              0xfffffffffffffd7f(18446744073709550975)        0xfffffffffffffd7f(18446744073709550975)
...
t0(x5)              0x00000000801ffeb2(2149580466)                  0x00000000801ffeb2(2149580466)                  
t1(x6)              0x000000008017fa66(2149055078)                  0x000000008017fa66(2149055078)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x000000008027a3c8(2150081480)                  0x000000008027a3c8(2150081480)                  
...
s5(x21)             0x0000000080186317(2149081879)                  0x0000000080186317(2149081879)                  
s6(x22)             0x00000000801807e8(2149058536)                  0x00000000801807e8(2149058536)                  
s7(x23)             0x000000007ffffdd1(2147483089)                  0x000000007ffffdd1(2147483089)                  
s8(x24)             0x000000008017fe4f(2149056079)                  0x000000008017fe4f(2149056079)                  
s9(x25)             0x00000000801802b6(2149057206)                  0x00000000801802b6(2149057206)                  
...
t4(x29)             0xffffffffd214e000(18446744072939167744)        0xffffffffd214e000(18446744072939167744)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1d2da1f338709a87be165dd114e8f0c1624207d        a1d2da1f338709a87be165dd114e8f0c1624207d        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        926e620a44b0ed903a0a15952d5702895be4a96b        X
