# FailID_000273 ARA pos RV64 fdiv.s
...
_reg_f17:.byte 0xf6,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f27'}})
    fdiv.s f27, f17, f7, rup
```
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f27, f17, f7, rup
+========================================================================================================================+
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f17, f7
f7                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f17                 0xffffffff4efffff6(2147482368.0_s)              0xffffffff4efffff6(2147482368.0_s)
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0eadecfdd7510be11cd10d1cf4c01dfb3ab09a1e        0eadecfdd7510be11cd10d1cf4c01dfb3ab09a1e        
