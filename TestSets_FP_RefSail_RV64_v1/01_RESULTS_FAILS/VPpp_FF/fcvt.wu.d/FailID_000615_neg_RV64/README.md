# FailID_000615 VP++ FF neg RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f23', 'mstatus.fs/vs.fs'}, 'clob': {'x10'}})
    fcvt.wu.d x10, f23, rup
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a0(x10)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x10, f23, rup
+========================================================================================================================+
...
Registers: x10, f23
a0(x10)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f23                 0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            44bf2272947919b347fd3f57354986b571e2951e        44bf2272947919b347fd3f57354986b571e2951e        
