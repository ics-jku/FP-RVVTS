# FailID_000266 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x46,0x5c,0x5d,0x35,0x0f,0x82,0x34,0x90
_reg_f21:.byte 0xc4,0xfe,0x4b,0x75,0x00,0x71,0x80,0x9e
_reg_f22:.byte 0xfd,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f19'}})
    fdiv.s f19, f21, f22, rmm
```
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff65cbd890(1.2032940862950009e+23_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f19, f21, f22, rmm
+========================================================================================================================+
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff65cbd890(1.2032940862950009e+23_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f21, f22
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff65cbd890(1.2032940862950009e+23_s)    X
f21                 0x9e807100754bfec4(-9.136323784076222e-162_d)   0x9e807100754bfec4(-9.136323784076222e-162_d)
f22                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff4f0017fd(2149055744.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            98fd0159c85eff83f8b45cb539d4168901bd9d6b        98fd0159c85eff83f8b45cb539d4168901bd9d6b        
