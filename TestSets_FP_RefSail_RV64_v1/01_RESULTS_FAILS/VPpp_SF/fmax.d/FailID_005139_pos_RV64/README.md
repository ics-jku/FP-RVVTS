# FailID_005139 VP++ SF pos RV64 fmax.d
...
_reg_f31:.byte 0x00,0xf3,0x11,0x47,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f25', 'f31'}, 'clob': {'f17'}})
    fmax.d f17, f25, f31
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0xffffffff4711f300(37363.0_s)                   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f25, f31
+========================================================================================================================+
...
f17                 0x0000000000000000(0.0_d)                       0xffffffff4711f300(37363.0_s)                   X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f25, f31
f17                 0x0000000000000000(0.0_d)                       0xffffffff4711f300(37363.0_s)                   X
f25                 0x0000000000000000(0.0_d)                       0x0000000000000000(0.0_d)
f31                 0xffffffff4711f300(37363.0_s)                   0xffffffff4711f300(37363.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            43fc3fc6577dc00073520279dbb8db0408851a4d        43fc3fc6577dc00073520279dbb8db0408851a4d        
