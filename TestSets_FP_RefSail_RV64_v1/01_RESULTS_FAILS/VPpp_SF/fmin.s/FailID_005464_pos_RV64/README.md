# FailID_005464 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0xf4,0x1f,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f31'}, 'clob': {'f23'}})
    fmin.s f23, f13, f31
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff4f001ff4(2149577728.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f23, f13, f31
+========================================================================================================================+
...
f23                 0xffffffff4f001ff4(2149577728.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f13, f31
f13                 0xffffffff4f001ff4(2149577728.0_s)              0xffffffff4f001ff4(2149577728.0_s)
f23                 0xffffffff4f001ff4(2149577728.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a2674e18d15d489213dce53ce5ae517b6fcf0696        a2674e18d15d489213dce53ce5ae517b6fcf0696        
