# FailID_000232 ARA pos RV64 fdiv.s
...
_reg_f18:.byte 0x00,0x00,0x00,0xa0,0xff,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'f18', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f13'}})
    fdiv.s f13, f6, f18, rup
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f13, f6, f18, rup
+========================================================================================================================+
...
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, f6, f18
f6                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f18                 0x41e003ffa0000000(2149580032.0_d)              0x41e003ffa0000000(2149580032.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8238a754ae140acecc022c01cac97c91a3b22b9c        8238a754ae140acecc022c01cac97c91a3b22b9c        
