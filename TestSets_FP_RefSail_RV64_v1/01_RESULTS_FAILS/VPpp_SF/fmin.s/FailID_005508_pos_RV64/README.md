# FailID_005508 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xfd,0xbf,0xff,0xce,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'f24'}})
    fmin.s f24, f11, f20
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xffffffffceffbffd(-2145386112.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f24, f11, f20
+========================================================================================================================+
...
f24                 0xffffffffceffbffd(-2145386112.0_s)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f11, f20
f11                 0xffffffffceffbffd(-2145386112.0_s)             0xffffffffceffbffd(-2145386112.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            faf6938d0ac941a4239aab17d6911e4b4839e004        faf6938d0ac941a4239aab17d6911e4b4839e004        
