# FailID_002675 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f16:.byte 0x00,0x00,0xa0,0x1b,0xff,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x24'}})
    fcvt.wu.d x24, f16, rdn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s8(x24)             0xffffffff801ff8dd(18446744071564163293)        0x00000000801ff8dd(2149578973)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x24, f16, rdn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x24, f16
s8(x24)             0xffffffff801ff8dd(18446744071564163293)        0x00000000801ff8dd(2149578973)                  X
f16                 0x41e003ff1ba00000(2149578973.0_d)              0x41e003ff1ba00000(2149578973.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            80e13d0a139125aaef082b43effe0ee5015f14d9        80e13d0a139125aaef082b43effe0ee5015f14d9        
