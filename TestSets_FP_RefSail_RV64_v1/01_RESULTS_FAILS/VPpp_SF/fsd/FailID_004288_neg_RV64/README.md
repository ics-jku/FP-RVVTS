# FailID_004288 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x0                   // fp
    li x9, 0x1                   // s1
    li x10, 0x796ba738           // a0
    li x11, 0x7ffff997           // a1
    li x12, 0x8017f8ca           // a2
    li x13, 0x80000731           // a3
    li x14, 0x1                  // a4
    li x15, 0x801ffe61           // a5
    li x16, 0x80200415           // a6
    li x17, 0x8011c05a           // a7
    li x18, 0x8017fdd5           // s2
    li x19, 0x801ff902           // s3
    li x20, 0x8017f884           // s4
    li x21, 0x80000105           // s5
    li x22, 0x801ffb5b           // s6
    li x23, 0x80180353           // s7
    li x24, 0x7ffffe6b           // s8
    li x25, 0x801ff81d           // s9
    li x26, 0x8017f808           // s10
    li x27, 0x7ffffa42           // s11
    li x28, 0x0                  // t3
    li x29, 0x1                  // t4
    li x30, 0x0                  // t5
    li x31, 0x800000f7           // t6
    // INSTRUCTION ({'dep': {'x11', 'f18', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x11', 'x9'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b64edf245c0ef94816947ce98adae82a5ad2ad73        X
...
ra(x1)              0x0000000080180a93(2149059219)                  0x0000000080180a93(2149059219)                  
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x000000007ffffd8a(2147483018)                  0x000000007ffffd8a(2147483018)                  
tp(x4)              0x00000000801805bf(2149057983)                  0x00000000801805bf(2149057983)                  
t0(x5)              0x00000000801fef26(2149576486)                  0x00000000801fef26(2149576486)                  
...
s1(x9)              0x000000008017fa70(2149055088)                  0x000000008017fa70(2149055088)                  
a0(x10)             0x00000000796ba738(2037098296)                  0x00000000796ba738(2037098296)                  
a1(x11)             0x000000008027f400(2150102016)                  0x000000008027f400(2150102016)                  
a2(x12)             0x000000008017f8ca(2149054666)                  0x000000008017f8ca(2149054666)                  
a3(x13)             0x0000000080000731(2147485489)                  0x0000000080000731(2147485489)                  
a4(x14)             0x0000000000000001(1)                           0x0000000000000001(1)                           
a5(x15)             0x00000000801ffe61(2149580385)                  0x00000000801ffe61(2149580385)                  
...
s3(x19)             0x00000000801ff902(2149579010)                  0x00000000801ff902(2149579010)                  
s4(x20)             0x000000008017f884(2149054596)                  0x000000008017f884(2149054596)                  
s5(x21)             0x0000000080000105(2147483909)                  0x0000000080000105(2147483909)                  
s6(x22)             0x00000000801ffb5b(2149579611)                  0x00000000801ffb5b(2149579611)                  
s7(x23)             0x0000000080180353(2149057363)                  0x0000000080180353(2149057363)                  
s8(x24)             0x000000007ffffe6b(2147483243)                  0x000000007ffffe6b(2147483243)                  
s9(x25)             0x00000000801ff81d(2149578781)                  0x00000000801ff81d(2149578781)                  
s10(x26)            0x000000008017f808(2149054472)                  0x000000008017f808(2149054472)                  
s11(x27)            0x000000007ffffa42(2147482178)                  0x000000007ffffa42(2147482178)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            00f93c0688f6ab31abd4b10f0b6845e1030632b9        00f93c0688f6ab31abd4b10f0b6845e1030632b9        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b64edf245c0ef94816947ce98adae82a5ad2ad73        X
