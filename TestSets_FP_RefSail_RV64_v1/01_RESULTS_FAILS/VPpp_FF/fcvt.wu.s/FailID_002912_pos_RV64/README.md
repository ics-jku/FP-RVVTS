# FailID_002912 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x84,0x51,0xdc,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f4', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x7'}})
    fcvt.wu.s x7, f4, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x7, f4, rne
+========================================================================================================================+
...
Registers: x7, f4
t2(x7)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f4                  0x41dc518400000000(1900417024.0_d)              0x41dc518400000000(1900417024.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9af90fe4518e42753712e75ae0f712746287b6d8        9af90fe4518e42753712e75ae0f712746287b6d8        
