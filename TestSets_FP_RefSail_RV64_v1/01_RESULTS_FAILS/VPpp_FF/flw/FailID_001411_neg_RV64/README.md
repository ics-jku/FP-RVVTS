# FailID_001411 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x3'}, 'clob': {'x4', 'f9', 'x3'}})
...
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff41dffffe(27.999996185302734_s)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            22a340a7b2d2f74271cdd8e2ef557db6608c2bd3        22a340a7b2d2f74271cdd8e2ef557db6608c2bd3        
