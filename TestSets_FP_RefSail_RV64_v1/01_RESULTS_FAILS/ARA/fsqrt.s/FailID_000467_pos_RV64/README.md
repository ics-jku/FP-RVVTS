# FailID_000467 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0x00,0x00,0x00,0x18,0x83,0x40
_reg_f30:.byte 0x04,0xe9,0xd7,0xc8,0xc9,0x94,0x30,0x7e
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f30'}})
    fsqrt.s f30, f23
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f23
f23                 0x4083180000000000(611.0_d)                     0x4083180000000000(611.0_d)
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            41f1df95e1edf12dc7d3e3b3239d11311545063d        41f1df95e1edf12dc7d3e3b3239d11311545063d        
