# FailID_001117 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x16', 'mstatus.fs/vs.fs'}, 'clob': {'f0', 'x16', 'x27'}})
...
f0                  0xffffffff00000000(0.0_s)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f0                  0xffffffff00000000(0.0_s)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, x2, b5, x16
sp(x2)              0x0000000000000002(2)                           0x0000000000000002(2)
a6(x16)             0x000000007ffffd5b(2147482971)                  0x000000007ffffd5b(2147482971)
f0                  0xffffffff00000000(0.0_s)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            48b52a5e563983652a9df6f20a355c913394d47c        48b52a5e563983652a9df6f20a355c913394d47c        
