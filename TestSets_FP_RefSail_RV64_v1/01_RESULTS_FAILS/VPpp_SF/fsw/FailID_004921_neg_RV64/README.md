# FailID_004921 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x26, 0x8000044a           // s10
    li x27, 0x7ffffe57           // s11
    li x28, 0x6000               // t3
    li x29, 0x440                // t4
    li x30, 0x7ffffd75           // t5
    li x31, 0x7ffff91a           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'x28'}, 'clob': {'x28', 'x26'}})
...
a6(x16)             0x0000000000007fff(32767)                       0x0000000000007fff(32767)                       
...
STATE               REF                                             DUT                                             DIFF
xmemhash            43f8740eeba8a6be7802885fd32df0dde9a46730        43f8740eeba8a6be7802885fd32df0dde9a46730        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        18359b1cf6dbbdeb2bec464baa6fead9e50129bb        X
