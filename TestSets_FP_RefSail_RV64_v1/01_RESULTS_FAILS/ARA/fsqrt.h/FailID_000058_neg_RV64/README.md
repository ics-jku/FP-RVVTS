# FailID_000058 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f25'}})
    fsqrt.h f25, f20, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f25, f20, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3a1e18843d374686005f0c3bab336c216e2cc584        3a1e18843d374686005f0c3bab336c216e2cc584        
