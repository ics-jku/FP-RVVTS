# FailID_000934 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x6, 0x1                   // t1
    li x7, 0x7ffffb51            // t2
    li x8, 0x7ffffffffffff9c     // fp
    li x9, 0x8017fbe6            // s1
    li x10, 0x1                  // a0
    li x11, 0x8027f3ff           // a1
    li x12, 0x90                 // a2
    li x13, 0x0                  // a3
    li x14, 0x80180b6b           // a4
    li x15, 0x7ffff9b4           // a5
    li x16, 0x0                  // a6
    li x17, 0x7ffff9c4           // a7
    li x18, 0x80180455           // s2
    ...
    li x26, 0x200001cc400000     // s10
    li x27, 0x1000               // s11
    li x28, 0x80000731           // t3
    li x29, 0x80180d77           // t4
    li x30, 0x5cb44000           // t5
    li x31, 0x80000731           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x1'}, 'clob': {'x24', 'x1', 'f17'}})
...
f17                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f17                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x63, x1
ra(x1)              0x00000000801ff8d5(2149578965)                  0x00000000801ff8d5(2149578965)
f17                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
tp(x4)              0x000000007ffffc91(2147482769)                  0x000000007ffffc91(2147482769)                  
t0(x5)              0x0000000080180707(2149058311)                  0x0000000080180707(2149058311)                  
t1(x6)              0x0000000000000001(1)                           0x0000000000000001(1)                           
t2(x7)              0x000000007ffffb51(2147482449)                  0x000000007ffffb51(2147482449)                  
fp(x8)              0x07ffffffffffff9c(576460752303423388)          0x07ffffffffffff9c(576460752303423388)          
...
a2(x12)             0x0000000000000090(144)                         0x0000000000000090(144)                         
a3(x13)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a4(x14)             0x0000000080180b6b(2149059435)                  0x0000000080180b6b(2149059435)                  
a5(x15)             0x000000007ffff9b4(2147482036)                  0x000000007ffff9b4(2147482036)                  
a6(x16)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a7(x17)             0x000000007ffff9c4(2147482052)                  0x000000007ffff9c4(2147482052)                  
...
s8(x24)             0x000000007ffff9c5(2147482053)                  0x000000007ffff9c5(2147482053)                  
s9(x25)             0xffffffffe6380000(18446744073277014016)        0xffffffffe6380000(18446744073277014016)        
s10(x26)            0x00200001cc400000(9007206976454656)            0x00200001cc400000(9007206976454656)            
s11(x27)            0x0000000000001000(4096)                        0x0000000000001000(4096)                        
t3(x28)             0x0000000080000731(2147485489)                  0x0000000080000731(2147485489)                  
t4(x29)             0x0000000080180d77(2149059959)                  0x0000000080180d77(2149059959)                  
t5(x30)             0x000000005cb44000(1555316736)                  0x000000005cb44000(1555316736)                  
t6(x31)             0x0000000080000731(2147485489)                  0x0000000080000731(2147485489)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            d18e7b95a4c8b3f1e81bd02f3a4bf08a3c4ff18e        d18e7b95a4c8b3f1e81bd02f3a4bf08a3c4ff18e        
