# FailID_002129 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x19, 0x1                  // s3
    li x20, 0x0                  // s4
    li x21, 0x7ffffefd           // s5
    li x22, 0x0                  // s6
    li x23, 0x80180753           // s7
    li x24, 0x1                  // s8
    li x25, 0x95                 // s9
    li x26, 0x8000032c           // s10
    li x27, 0x80180150           // s11
    li x28, 0x7ffffefd           // t3
    li x29, 0x801fffa2           // t4
    li x30, 0x1ffff              // t5
    li x31, 0x7ffffde2           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x22', 'mstatus.fs/vs.fs', 'f24'}, 'clob': {'x10', 'x22'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3cb5f10b198ac84086aede403b88e8cc487d00ab        X
...
```
+========================================================================================================================+
Instruction: fsw f24, 0x266(x22)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'overflow', 'inexact'], special values ['inf']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, x266, x22
s6(x22)             0x000000008017fd9a(2149055898)                  0x000000008017fd9a(2149055898)
...
a3(x13)             0x000000002f99070c(798557964)                   0x000000002f99070c(798557964)                   
...
s5(x21)             0x000000007ffffefd(2147483389)                  0x000000007ffffefd(2147483389)                  
s6(x22)             0x000000008017fd9a(2149055898)                  0x000000008017fd9a(2149055898)                  
...
t3(x28)             0x000000007ffffefd(2147483389)                  0x000000007ffffefd(2147483389)                  
t4(x29)             0x00000000801fffa2(2149580706)                  0x00000000801fffa2(2149580706)                  
t5(x30)             0x000000000001ffff(131071)                      0x000000000001ffff(131071)                      
t6(x31)             0x000000007ffffde2(2147483106)                  0x000000007ffffde2(2147483106)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            08a504d93b37bb3ee5ae893aa7bebfb9925826e6        08a504d93b37bb3ee5ae893aa7bebfb9925826e6        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3cb5f10b198ac84086aede403b88e8cc487d00ab        X
