# FailID_004416 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x24, 0x8018073f           // s8
    li x25, 0x801802c4           // s9
    li x26, 0x800004cc           // s10
    li x27, 0x8027f98a           // s11
    li x28, 0x8017fe6a           // t3
    li x29, 0x80180d77           // t4
    li x30, 0x8000066e           // t5
    li x31, 0x10017f762          // t6
    // INSTRUCTION ({'dep': {'x1', 'f13', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'x18'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d85016d738eaa2556734b4ea62960ae9c32ecc51        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x455, x1
ra(x1)              0x00000000801fff15(2149580565)                  0x00000000801fff15(2149580565)
...
a0(x10)             0x0000000000008000(32768)                       0x0000000000008000(32768)                       
...
s2(x18)             0x0000000080180455(2149057621)                  0x0000000080180455(2149057621)                  
...
s8(x24)             0x000000008018073f(2149058367)                  0x000000008018073f(2149058367)                  
...
t4(x29)             0x0000000080180d77(2149059959)                  0x0000000080180d77(2149059959)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            26d90b296678ab864c12028d406cc5595b056d18        26d90b296678ab864c12028d406cc5595b056d18        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d85016d738eaa2556734b4ea62960ae9c32ecc51        X
