# FailID_005190 VP++ SF pos RV64 fmax.d
...
_reg_f17:.byte 0x93,0x82,0xc2,0xff,0xff,0xff,0xff,0xff
_reg_f24:.byte 0x00,0x00,0x40,0x05,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f14'}})
    fmax.d f14, f24, f17
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x41dffffe05400000(2147481621.0_d)              0xffffffffffc28293(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f14, f24, f17
+========================================================================================================================+
...
f14                 0x41dffffe05400000(2147481621.0_d)              0xffffffffffc28293(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f24, f17
f14                 0x41dffffe05400000(2147481621.0_d)              0xffffffffffc28293(nan_s)                       X
f17                 0xffffffffffc28293(nan_s)                       0xffffffffffc28293(nan_s)
f24                 0x41dffffe05400000(2147481621.0_d)              0x41dffffe05400000(2147481621.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            688f26d774ceab1ee20a477204f3a6bf955a0cf3        688f26d774ceab1ee20a477204f3a6bf955a0cf3        
