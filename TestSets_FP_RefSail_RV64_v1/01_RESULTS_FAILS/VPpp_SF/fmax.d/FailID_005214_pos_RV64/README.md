# FailID_005214 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f11'}})
    fmax.d f11, f9, f12
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x3ff0000000000000(1.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9e9c9555f16a407723889747240eb385934f9812        9e9c9555f16a407723889747240eb385934f9812        
