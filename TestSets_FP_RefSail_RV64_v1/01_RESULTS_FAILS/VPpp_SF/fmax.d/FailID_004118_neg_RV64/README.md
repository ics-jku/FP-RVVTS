# FailID_004118 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'fcsr.rm', 'f31'}, 'clob': {'f3'}})
    fmax.d f3, f15, f31
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x0000000000000200(2.53e-321_d)                 0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1e67b26b8d9e7a139ffbe0099ca7cf96ff4ec773        1e67b26b8d9e7a139ffbe0099ca7cf96ff4ec773        
