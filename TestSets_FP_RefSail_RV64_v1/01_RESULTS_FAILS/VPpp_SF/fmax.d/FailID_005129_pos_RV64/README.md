# FailID_005129 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f17'}})
    fmax.d f17, f15, f24
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f15, f24
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a0f4dbcfeebfe4a5abdbbb9a4808eaeff7f8ec9a        a0f4dbcfeebfe4a5abdbbb9a4808eaeff7f8ec9a        
