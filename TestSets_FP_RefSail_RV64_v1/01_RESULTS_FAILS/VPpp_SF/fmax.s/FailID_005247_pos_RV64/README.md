# FailID_005247 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f8', 'f30'}, 'clob': {'f21'}})
    fmax.s f21, f30, f8
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            89d982523be4130790f1003a4dd222790a6e96a7        89d982523be4130790f1003a4dd222790a6e96a7        
