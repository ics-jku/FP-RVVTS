# FailID_005520 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f23'}})
    fmin.s f23, f7, f27
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1d23e9dc5991a2cf35c7809fe00435ea88f0690d        1d23e9dc5991a2cf35c7809fe00435ea88f0690d        
