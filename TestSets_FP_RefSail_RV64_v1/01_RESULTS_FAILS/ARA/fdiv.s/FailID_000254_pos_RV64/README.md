# FailID_000254 ARA pos RV64 fdiv.s
...
_reg_f7: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
_reg_f9: .byte 0x00,0x02,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f9'}})
    fdiv.s f9, f7, f6, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f9, f7, f6, dyn
+========================================================================================================================+
...
f7                  0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1ef337cf89a56f47a58d8654f6ce0712187a908b        1ef337cf89a56f47a58d8654f6ce0712187a908b        
