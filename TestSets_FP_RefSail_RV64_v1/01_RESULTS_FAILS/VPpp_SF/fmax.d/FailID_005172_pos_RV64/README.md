# FailID_005172 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f5'}, 'clob': {'f21'}})
    fmax.d f21, f5, f0
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0x4008000000000000(3.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            32274f3ce485f1b1a932b7c9ee2efab128758937        32274f3ce485f1b1a932b7c9ee2efab128758937        
