# FailID_005507 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x80,0x37,0x00,0xa0,0xc0,0x41
_reg_f20:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xdf,0x43
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f20'}})
    fmin.s f20, f24, f5
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f20                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f24, f5
f5                  0x41c0a00037800000(557842543.0_d)               0x41c0a00037800000(557842543.0_d)
f20                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9790dc77e0da3ab03c2755c6c8d3f1d83d8770b6        9790dc77e0da3ab03c2755c6c8d3f1d83d8770b6        
