# FailID_000041 ARA neg RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xca,0x24,0xc8,0x93,0x2e,0xf9,0x3c,0x75
_reg_f21:.byte 0x50,0xe1,0xa5,0x0f,0x7b,0x1e,0xa7,0xbc
_reg_f27:.byte 0xfc,0xd3,0xaa,0xf8,0x11,0x42,0xd0,0x8f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f21', 'f27'}, 'clob': {'f11'}})
    fdiv.s f11, f27, f21, rtz
```
...
STATE               REF                                             DUT                                             DIFF
fcsr                0x0000000000000000(0)                           0x0000000000000004(4)                           X
 fcsr.of            False                                           True                                            X
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f11, f27, f21, rtz
+========================================================================================================================+
Attributes:  fcsr ['overflow'], special values ['nan', 'inf'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f27, f21
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f21                 0xbca71e7b0fa5e150(-1.604207410226428e-16_d)    0xbca71e7b0fa5e150(-1.604207410226428e-16_d)
f27                 0x8fd04211f8aad3fc(-1.636261801248035e-232_d)   0x8fd04211f8aad3fc(-1.636261801248035e-232_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1db89590aad87387d2620a384cb1bb186b1e64d8        1db89590aad87387d2620a384cb1bb186b1e64d8        
