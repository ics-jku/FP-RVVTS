# FailID_001608 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f30'}, 'clob': {'x11'}})
    fmv.x.h x11, f30
```
...
```
REG                 REF                                             DUT                                             DIFF
a1(x11)             0xfffffffffffffffb(18446744073709551611)        0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2c5dd8ed4a2a21d15f071f3cd74bdffbcf37114b        2c5dd8ed4a2a21d15f071f3cd74bdffbcf37114b        
