# FailID_005244 VP++ SF pos RV64 fmax.s
...
_reg_f12:.byte 0x59,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f9'}})
    fmax.s f9, f12, f13
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f9                  0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f12, f13
f9                  0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
f12                 0xffffffff4f000059(2147506432.0_s)              0xffffffff4f000059(2147506432.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            593644ad2c8491bd732fa1802a09ecab727804ab        593644ad2c8491bd732fa1802a09ecab727804ab        
