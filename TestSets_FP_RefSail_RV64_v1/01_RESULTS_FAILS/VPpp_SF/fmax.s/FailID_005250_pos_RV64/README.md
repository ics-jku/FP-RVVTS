# FailID_005250 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f3'}, 'clob': {'f19'}})
    fmax.s f19, f3, f10
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            46c0bab8c151809d95673d8fb4c6870567ee8a61        46c0bab8c151809d95673d8fb4c6870567ee8a61        
