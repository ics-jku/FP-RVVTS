# FailID_005420 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x00,0xc0,0xc5,0x89,0xb7
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f24'}})
    fmin.d f24, f5, f13
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xb789c5c000000000(-3.6981667771996247e-41_d)   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f24                 0xb789c5c000000000(-3.6981667771996247e-41_d)   0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f5, f13
f5                  0xb789c5c000000000(-3.6981667771996247e-41_d)   0xb789c5c000000000(-3.6981667771996247e-41_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e643a286932bb47239e1b9e46ecaf072d1a39516        e643a286932bb47239e1b9e46ecaf072d1a39516        
