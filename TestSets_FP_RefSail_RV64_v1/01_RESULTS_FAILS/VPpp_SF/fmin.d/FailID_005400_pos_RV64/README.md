# FailID_005400 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x80
_reg_f28:.byte 0x59,0x07,0x18,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f31'}, 'clob': {'f28'}})
    fmin.d f28, f19, f31
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0x8000000000000200(-2.53e-321_d)                0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f28, f19, f31
+========================================================================================================================+
...
f28                 0x8000000000000200(-2.53e-321_d)                0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f19, f31
f19                 0x8000000000000200(-2.53e-321_d)                0x8000000000000200(-2.53e-321_d)
f28                 0x8000000000000200(-2.53e-321_d)                0x7ff8000000000000(nan_d)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            866405966d0d7bfd30b176aa12bec515975c43cf        866405966d0d7bfd30b176aa12bec515975c43cf        
