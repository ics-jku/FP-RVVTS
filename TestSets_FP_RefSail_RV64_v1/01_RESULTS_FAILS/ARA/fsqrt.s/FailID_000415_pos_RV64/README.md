# FailID_000415 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x18,0x80,0x47,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'f9'}})
    fsqrt.s f9, f13, dyn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f9, f13, dyn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            88c4a5ccd972d8f18b0ebcab25fade3ac53efa6d        88c4a5ccd972d8f18b0ebcab25fade3ac53efa6d        
