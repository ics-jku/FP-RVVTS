# FailID_000658 VP++ FF neg RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0xf8,0x8b,0xc0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f5'}, 'clob': {'x12'}})
    fcvt.wu.s x12, f5, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a2(x12)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x12, f5, rne
+========================================================================================================================+
...
Registers: x12, f5
a2(x12)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f5                  0xc08bf80000000000(-895.0_d)                    0xc08bf80000000000(-895.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            239f812e4382b8bb8a8e862748837a0308c8cb51        239f812e4382b8bb8a8e862748837a0308c8cb51        
