# FailID_001356 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x43550000            // fp
    li x9, 0x8026f3a6            // s1
    li x10, 0x7ffffe69           // a0
    li x11, 0x8017fde3           // a1
    li x12, 0x28                 // a2
    li x13, 0x8017fd91           // a3
    li x14, 0x80080629           // a4
    li x15, 0xffffffffffffffc9   // a5
    li x16, 0x8017fe87           // a6
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x24'}, 'clob': {'f20', 'x12', 'x24'}})
...
f20                 0xffffffff4effffff(2147483520.0_s)              0xffffffff1f41b027(4.101504950862577e-20_s)     X
STATES DIFFER: True
```
...
f20                 0xffffffff4effffff(2147483520.0_s)              0xffffffff1f41b027(4.101504950862577e-20_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, xb7, x24
s8(x24)             0x0000000080000247(2147484231)                  0x0000000080000247(2147484231)
f20                 0xffffffff4effffff(2147483520.0_s)              0xffffffff1f41b027(4.101504950862577e-20_s)     X
+========================================================================================================================+
```
...
a0(x10)             0x000000007ffffe69(2147483241)                  0x000000007ffffe69(2147483241)                  
a1(x11)             0x000000008017fde3(2149055971)                  0x000000008017fde3(2149055971)                  
a2(x12)             0x00000000800000b7(2147483831)                  0x00000000800000b7(2147483831)                  
a3(x13)             0x000000008017fd91(2149055889)                  0x000000008017fd91(2149055889)                  
a4(x14)             0x0000000080080629(2148009513)                  0x0000000080080629(2148009513)                  
a5(x15)             0xffffffffffffffc9(18446744073709551561)        0xffffffffffffffc9(18446744073709551561)        
a6(x16)             0x000000008017fe87(2149056135)                  0x000000008017fe87(2149056135)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2cc5c1c4c63dea4d836548631d2dd23efca36b5e        2cc5c1c4c63dea4d836548631d2dd23efca36b5e        
