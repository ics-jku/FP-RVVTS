# FailID_000152 ARA pos RV64 fdiv.s
...
_reg_f9: .byte 0x00,0x00,0x00,0x2d,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f27'}})
    fdiv.s f27, f9, f4, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f27, f9, f4, dyn
+========================================================================================================================+
...
f9                  0x41e002ff2d000000(2149054824.0_d)              0x41e002ff2d000000(2149054824.0_d)
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            12ccf23090cfbc017b6d722c0d7ba8192370c992        12ccf23090cfbc017b6d722c0d7ba8192370c992        
