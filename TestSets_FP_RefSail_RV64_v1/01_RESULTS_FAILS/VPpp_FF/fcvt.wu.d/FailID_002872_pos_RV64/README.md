# FailID_002872 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'x16'}})
    fcvt.wu.d x16, f10, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x16, f10, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6a64699c778049741fb4a470ba21fb2f2dbdc06f        6a64699c778049741fb4a470ba21fb2f2dbdc06f        
