# FailID_003157 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0xe0,0xe2,0x0c,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4'}})
    fcvt.wu.s x4, f1
```
...
Registers: x4, f1
tp(x4)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f1                  0x41e0000ce2e00000(2147510039.0_d)              0x41e0000ce2e00000(2147510039.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            96f5b55863ce06b832b7c9665a52a0b4642ff1e8        96f5b55863ce06b832b7c9665a52a0b4642ff1e8        
