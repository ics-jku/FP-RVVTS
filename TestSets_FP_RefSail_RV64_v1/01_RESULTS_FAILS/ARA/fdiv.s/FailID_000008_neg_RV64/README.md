# FailID_000008 ARA neg RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x80,0x65,0x44,0xff,0xff,0xff,0xff
_reg_f16:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_reg_f20:.byte 0xa7,0x28,0x75,0x18,0x81,0xf2,0xbb,0x0b
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'f20', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f16'}})
    fdiv.s f16, f5, f20
```
...
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff6b6fa614(2.897175526589342e+26_s)     X
STATES DIFFER: True
```
...
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff6b6fa614(2.897175526589342e+26_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f5, f20
f5                  0xffffffff44658000(918.0_s)                     0xffffffff44658000(918.0_s)
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff6b6fa614(2.897175526589342e+26_s)     X
f20                 0x0bbbf281187528a7(3.8119151472262454e-252_d)   0x0bbbf281187528a7(3.8119151472262454e-252_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ae58cfc95462573f6154427fb40cc270ba38d67        0ae58cfc95462573f6154427fb40cc270ba38d67        
