# FailID_004933 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x6, 0x23                  // t1
    li x7, 0x801800df            // t2
    li x8, 0x2005ffdf40000       // fp
    li x9, 0x1                   // s1
    li x10, 0x80180424           // a0
    li x11, 0x1                  // a1
    ...
    li x19, 0x801fff3b           // s3
    li x20, 0x8017fd9f           // s4
    li x21, 0x80000088           // s5
    li x22, 0x8017f923           // s6
    li x23, 0x0                  // s7
    li x24, 0x7ffffb9d           // s8
    li x25, 0x80000167           // s9
    li x26, 0x1                  // s10
    li x27, 0xfffffffffffff7e1   // s11
    li x28, 0x599                // t3
    li x29, 0x0                  // t4
    li x30, 0x0                  // t5
    li x31, 0x99ef072c           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x13', 'f28'}, 'clob': {'x13', 'x27'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x17, x13
a3(x13)             0x000000008018017e(2149056894)                  0x000000008018017e(2149056894)
a7(x17)             0x000000000000004a(74)                          0x000000000000004a(74)
...
tp(x4)              0x0000000080000088(2147483784)                  0x0000000080000088(2147483784)                  
t0(x5)              0x0000000000000065(101)                         0x0000000000000065(101)                         
t1(x6)              0x0000000000000023(35)                          0x0000000000000023(35)                          
t2(x7)              0x00000000801800df(2149056735)                  0x00000000801800df(2149056735)                  
fp(x8)              0x0002005ffdf40000(563362235940864)             0x0002005ffdf40000(563362235940864)             
s1(x9)              0x0000000000000001(1)                           0x0000000000000001(1)                           
a0(x10)             0x0000000080180424(2149057572)                  0x0000000080180424(2149057572)                  
...
s3(x19)             0x00000000801fff3b(2149580603)                  0x00000000801fff3b(2149580603)                  
s4(x20)             0x000000008017fd9f(2149055903)                  0x000000008017fd9f(2149055903)                  
s5(x21)             0x0000000080000088(2147483784)                  0x0000000080000088(2147483784)                  
s6(x22)             0x000000008017f923(2149054755)                  0x000000008017f923(2149054755)                  
s7(x23)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s8(x24)             0x000000007ffffb9d(2147482525)                  0x000000007ffffb9d(2147482525)                  
s9(x25)             0x0000000080000167(2147484007)                  0x0000000080000167(2147484007)                  
...
t6(x31)             0x0000000099ef072c(2582578988)                  0x0000000099ef072c(2582578988)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            0137975e1825290cfede8f2db8ad9d80cbe46c23        0137975e1825290cfede8f2db8ad9d80cbe46c23        
