# FailID_001015 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x21, 0x800007f0           // s5
    li x22, 0x8018056a           // s6
    li x23, 0x1                  // s7
    li x24, 0x0                  // s8
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x21'}, 'clob': {'x22', 'f18', 'x21'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cffaa81c03eddc107477672aed600bac7a775ecc        cffaa81c03eddc107477672aed600bac7a775ecc        
