# FailID_000189 ARA pos RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fdiv.s f29, f2, f24, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f2, f24, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            160998e1335b033b647069bc8726b48f17f79199        160998e1335b033b647069bc8726b48f17f79199        
