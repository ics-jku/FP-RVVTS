# FailID_001696 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x7ffffa06            // fp
    li x9, 0x801802c2            // s1
    li x10, 0x801800000000       // a0
    li x11, 0x7ffff9b9           // a1
    li x12, 0x80180412           // a2
    li x13, 0x0                  // a3
    li x14, 0x7ffff96c           // a4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f8', 'x28'}, 'clob': {'x29', 'x28'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bd76e91f8b06b9e73485d5dc162d8cf79cbb720f        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x115, x28
t3(x28)             0x000000008020038d(2149581709)                  0x000000008020038d(2149581709)
...
tp(x4)              0x000000007fffff72(2147483506)                  0x000000007fffff72(2147483506)                  
...
a0(x10)             0x0000801800000000(140840567570432)             0x0000801800000000(140840567570432)             
...
a4(x14)             0x000000007ffff96c(2147481964)                  0x000000007ffff96c(2147481964)                  
...
s8(x24)             0x00000000801805ea(2149058026)                  0x00000000801805ea(2149058026)                  
...
t3(x28)             0x000000008020038d(2149581709)                  0x000000008020038d(2149581709)                  
t4(x29)             0x0000000080180115(2149056789)                  0x0000000080180115(2149056789)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            535968381f4ecbddc95cd258ec2d789eda866c31        535968381f4ecbddc95cd258ec2d789eda866c31        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bd76e91f8b06b9e73485d5dc162d8cf79cbb720f        X
