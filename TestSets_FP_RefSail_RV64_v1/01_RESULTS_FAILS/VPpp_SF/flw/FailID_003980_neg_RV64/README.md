# FailID_003980 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x11, 0x1ffffe9            // a1
    li x12, 0x1                  // a2
    li x13, 0x801807fb           // a3
    li x14, 0x8017fdff           // a4
    li x15, 0x200                // a5
    li x16, 0x6000               // a6
    li x17, 0x7ffffa62           // a7
    li x18, 0xfffffe200          // s2
    li x19, 0xeb                 // s3
    li x20, 0x71                 // s4
    li x21, 0x0                  // s5
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x13'}, 'clob': {'x13', 'f17', 'x16'}})
...
f17                 0xba285a6d847c7c5a(-1.5369051125236202e-28_d)   0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f17                 0xba285a6d847c7c5a(-1.5369051125236202e-28_d)   0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x3, x13
gp(x3)              0x0000000000000000(0)                           0x0000000000000000(0)
a3(x13)             0x000000008018044e(2149057614)                  0x000000008018044e(2149057614)
f17                 0xba285a6d847c7c5a(-1.5369051125236202e-28_d)   0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
fp(x8)              0x000000003e3e6738(1044277048)                  0x000000003e3e6738(1044277048)                  
...
a1(x11)             0x0000000001ffffe9(33554409)                    0x0000000001ffffe9(33554409)                    
...
s2(x18)             0x0000000fffffe200(68719469056)                 0x0000000fffffe200(68719469056)                 
s3(x19)             0x00000000000000eb(235)                         0x00000000000000eb(235)                         
s4(x20)             0x0000000000000071(113)                         0x0000000000000071(113)                         
...
t5(x30)             0x00000000000000a4(164)                         0x00000000000000a4(164)                         
t6(x31)             0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            c9aa80e60f4803665183a3a4a10cca5fc5b45cc3        c9aa80e60f4803665183a3a4a10cca5fc5b45cc3        
