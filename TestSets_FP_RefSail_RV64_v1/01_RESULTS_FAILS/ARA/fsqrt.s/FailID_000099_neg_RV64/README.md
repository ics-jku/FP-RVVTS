# FailID_000099 ARA neg RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f23'}})
    fsqrt.s f23, f18, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff1e6bd569(1.2484928598740514e-20_s)    0xffffffff1e6bd568(1.2484927790946947e-20_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f23, f18, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            60af09e4f331bd55c43c66c0aaf92f547713e168        60af09e4f331bd55c43c66c0aaf92f547713e168        
