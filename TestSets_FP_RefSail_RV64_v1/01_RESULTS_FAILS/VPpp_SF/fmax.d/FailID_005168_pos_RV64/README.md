# FailID_005168 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x10,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x40,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f4'}, 'clob': {'f7'}})
    fmax.d f7, f5, f4
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0x4040000000000000(32.0_d)                      0xffffffff00000010(2.2420775429197073e-44_s)    X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f5, f4
f4                  0xffffffff00000010(2.2420775429197073e-44_s)    0xffffffff00000010(2.2420775429197073e-44_s)
f5                  0x4040000000000000(32.0_d)                      0x4040000000000000(32.0_d)
f7                  0x4040000000000000(32.0_d)                      0xffffffff00000010(2.2420775429197073e-44_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1fed144559317beab4df385ee35642142cdf955c        1fed144559317beab4df385ee35642142cdf955c        
