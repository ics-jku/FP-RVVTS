# FailID_000139 ARA pos RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f28', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f9'}})
    fdiv.s f9, f28, f29, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff92445c67(-6.196058965141353e-28_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f9, f28, f29, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c271089d73a280b2d01f1d9289a4632ebca09960        c271089d73a280b2d01f1d9289a4632ebca09960        
