# FailID_005164 VP++ SF pos RV64 fmax.d
...
_reg_f19:.byte 0x00,0x00,0xa0,0x9b,0x00,0x00,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f19'}})
    fmax.d f19, f27, f3
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1ee273cb392a2d6a6d6df38754ad779b9df17fe1        1ee273cb392a2d6a6d6df38754ad779b9df17fe1        
