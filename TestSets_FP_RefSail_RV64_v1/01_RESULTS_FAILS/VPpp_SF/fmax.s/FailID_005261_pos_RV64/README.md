# FailID_005261 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x20,0x80,0xc4,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f4'}, 'clob': {'f27'}})
    fmax.s f27, f4, f18
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffffc4802000(-1025.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f27                 0xffffffffc4802000(-1025.0_s)                   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f4, f18
f4                  0xffffffffc4802000(-1025.0_s)                   0xffffffffc4802000(-1025.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4ccfd0c88745b9f5b3a01fd3fce4036967a22e8e        4ccfd0c88745b9f5b3a01fd3fce4036967a22e8e        
