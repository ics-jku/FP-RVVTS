# FailID_004528 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x11, 0x2005fe             // a1
    li x12, 0xa4d3b4097b7fff     // a2
    li x13, 0x8027e1bb           // a3
    li x14, 0x80006692           // a4
    li x15, 0x1004               // a5
    li x16, 0x0                  // a6
    li x17, 0x8018024c           // a7
    li x18, 0x8017f8b0           // s2
    li x19, 0x80000a68           // s3
    ...
    // INSTRUCTION ({'dep': {'x16', 'f0', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'x19'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        a8081a2998dd950477a8be1fb1cb8ec43af9f27e        X
...
a2(x12)             0x00a4d3b4097b7fff(46394666387210239)           0x00a4d3b4097b7fff(46394666387210239)           
a3(x13)             0x000000008027e1bb(2150097339)                  0x000000008027e1bb(2150097339)                  
a4(x14)             0x0000000080006692(2147509906)                  0x0000000080006692(2147509906)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4095398a40b91e24c3f16c151771e6e659e52f36        4095398a40b91e24c3f16c151771e6e659e52f36        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        a8081a2998dd950477a8be1fb1cb8ec43af9f27e        X
