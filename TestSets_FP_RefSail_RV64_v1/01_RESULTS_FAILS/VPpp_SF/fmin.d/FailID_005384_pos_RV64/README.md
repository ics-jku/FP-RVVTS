# FailID_005384 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f2'}, 'clob': {'f7'}})
    fmin.d f7, f2, f4
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1aa7eda5f796051e319aee0d244dbaa3ec873a4        c1aa7eda5f796051e319aee0d244dbaa3ec873a4        
