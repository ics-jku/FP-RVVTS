# FailID_001112 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x11, 0x80206a06           // a1
    li x12, 0x4010               // a2
    li x13, 0xffffffff7fe80bf1   // a3
    li x14, 0x105                // a4
    li x15, 0x7                  // a5
    li x16, 0x7fffffffffffffff   // a6
    li x17, 0x7ffffb76           // a7
    li x18, 0x1                  // s2
    li x19, 0x80005b71           // s3
    li x20, 0xfffffffffffffe7f   // s4
    li x21, 0x8018042c           // s5
    li x22, 0x8017f500           // s6
    li x23, 0x801ffe34           // s7
    li x24, 0x801805da           // s8
    li x25, 0x1                  // s9
    li x26, 0x0                  // s10
    li x27, 0x6000               // s11
    li x28, 0x7ffffd55           // t3
    li x29, 0x80005cd4           // t4
    li x30, 0x400c03             // t5
    li x31, 0x8018056c           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x12', 'mstatus.fs/vs.fs'}, 'clob': {'x12', 'x27', 'f31'}})
...
f31                 0xffffffff48000000(131072.0_s)                  0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f31                 0xffffffff48000000(131072.0_s)                  0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x757, x12
a2(x12)             0x00000000800038b9(2147498169)                  0x00000000800038b9(2147498169)
f31                 0xffffffff48000000(131072.0_s)                  0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
tp(x4)              0x000000007ffffb76(2147482486)                  0x000000007ffffb76(2147482486)                  
t0(x5)              0x00000000d6e6b750(3605444432)                  0x00000000d6e6b750(3605444432)                  
...
a1(x11)             0x0000000080206a06(2149607942)                  0x0000000080206a06(2149607942)                  
a2(x12)             0x00000000800038b9(2147498169)                  0x00000000800038b9(2147498169)                  
a3(x13)             0xffffffff7fe80bf1(18446744071560498161)        0xffffffff7fe80bf1(18446744071560498161)        
a4(x14)             0x0000000000000105(261)                         0x0000000000000105(261)                         
...
a7(x17)             0x000000007ffffb76(2147482486)                  0x000000007ffffb76(2147482486)                  
s2(x18)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s3(x19)             0x0000000080005b71(2147507057)                  0x0000000080005b71(2147507057)                  
...
s8(x24)             0x00000000801805da(2149058010)                  0x00000000801805da(2149058010)                  
...
t5(x30)             0x0000000000400c03(4197379)                     0x0000000000400c03(4197379)                     
t6(x31)             0x000000008018056c(2149057900)                  0x000000008018056c(2149057900)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            793b54549aa3c550f36828396a74c156c6f425d5        793b54549aa3c550f36828396a74c156c6f425d5        
