# FailID_003388 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x1', 'x19', 'f27'}})
...
f27                 0x40d8000000000000(24576.0_d)                   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ebe78823a5ebdf54f7545415cd09949027838153        ebe78823a5ebdf54f7545415cd09949027838153        
