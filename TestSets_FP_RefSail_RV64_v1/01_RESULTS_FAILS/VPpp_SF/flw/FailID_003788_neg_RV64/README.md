# FailID_003788 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x24, 0x1                  // s8
    li x25, 0x87                 // s9
    li x26, 0x80200024           // s10
    li x27, 0x80000366           // s11
    li x28, 0x5a                 // t3
    li x29, 0xba31c774           // t4
    li x30, 0x801ffee1           // t5
    li x31, 0x35                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'f21', 'x24', 'x15'}})
...
f21                 0xffffffffffc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
