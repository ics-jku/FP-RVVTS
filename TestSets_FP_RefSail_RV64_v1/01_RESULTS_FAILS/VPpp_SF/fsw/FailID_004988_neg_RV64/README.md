# FailID_004988 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x6000                // fp
    li x9, 0x1                   // s1
    li x10, 0x801867d9           // a0
    li x11, 0x6000               // a1
    li x12, 0x1                  // a2
    li x13, 0xd4                 // a3
    li x14, 0x80005f18           // a4
    li x15, 0x8028006a           // a5
    ...
    li x28, 0x6e0000000          // t3
    li x29, 0x200                // t4
    li x30, 0x801807d9           // t5
    li x31, 0x8017fec4           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f8', 'x10'}, 'clob': {'x8', 'x10'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        554ad2b65d214e6aefa11af5e6ae0b7c1989151e        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x3, f4, x10
gp(x3)              0xffffffff945e4000(18446744071903789056)        0xffffffff945e4000(18446744071903789056)
a0(x10)             0x0000000080206bcc(2149608396)                  0x0000000080206bcc(2149608396)
...
sp(x2)              0x000000000000008c(140)                         0x000000000000008c(140)                         
gp(x3)              0xffffffff945e4000(18446744071903789056)        0xffffffff945e4000(18446744071903789056)        
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x0000000080000809(2147485705)                  0x0000000080000809(2147485705)                  
t1(x6)              0x000000007d055718(2097501976)                  0x000000007d055718(2097501976)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x00000000801803f4(2149057524)                  0x00000000801803f4(2149057524)                  
...
a3(x13)             0x00000000000000d4(212)                         0x00000000000000d4(212)                         
a4(x14)             0x0000000080005f18(2147507992)                  0x0000000080005f18(2147507992)                  
a5(x15)             0x000000008028006a(2150105194)                  0x000000008028006a(2150105194)                  
...
s10(x26)            0x0000000000000083(131)                         0x0000000000000083(131)                         
s11(x27)            0x0000000080000320(2147484448)                  0x0000000080000320(2147484448)                  
t3(x28)             0x00000006e0000000(29527900160)                 0x00000006e0000000(29527900160)                 
...
STATE               REF                                             DUT                                             DIFF
xmemhash            55f64f924bb6277aa26f7f39f77cca0eb6e1f2d3        55f64f924bb6277aa26f7f39f77cca0eb6e1f2d3        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        554ad2b65d214e6aefa11af5e6ae0b7c1989151e        X
