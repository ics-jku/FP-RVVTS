# FailID_000308 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f2'}})
    fsqrt.s f2, f12, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f2, f12, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5609017b1e37c2dfc4dbb7ef6bb902e1859d4972        5609017b1e37c2dfc4dbb7ef6bb902e1859d4972        
