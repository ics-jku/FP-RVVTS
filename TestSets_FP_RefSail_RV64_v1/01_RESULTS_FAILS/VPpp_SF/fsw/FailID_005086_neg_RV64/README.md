# FailID_005086 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x25, 0x0                  // s9
    li x26, 0x0                  // s10
    li x27, 0x80180259           // s11
    li x28, 0xa9                 // t3
    li x29, 0x8017f9e3           // t4
    li x30, 0x80180b2b           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'f31', 'fcsr.rm', 'x17', 'mstatus.fs/vs.fs'}, 'clob': {'x22', 'x17'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b1603d87becc0baa6208c0d7434d1cf1b54d0314        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x565, x17
a7(x17)             0x00000000801ffe43(2149580355)                  0x00000000801ffe43(2149580355)
...
s1(x9)              0x000000007ffffed1(2147483345)                  0x000000007ffffed1(2147483345)                  
...
a6(x16)             0x000000008017fcd1(2149055697)                  0x000000008017fcd1(2149055697)                  
a7(x17)             0x00000000801ffe43(2149580355)                  0x00000000801ffe43(2149580355)                  
...
s11(x27)            0x0000000080180259(2149057113)                  0x0000000080180259(2149057113)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1389c8863dfc7f9d7c9dc53fa8855a785528e22        a1389c8863dfc7f9d7c9dc53fa8855a785528e22        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b1603d87becc0baa6208c0d7434d1cf1b54d0314        X
