# FailID_005251 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x68,0xd5,0x6b,0x1e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f27'}})
    fmax.s f27, f19, f24
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff1e6bd568(1.2484927790946947e-20_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f27, f19, f24
+========================================================================================================================+
...
f27                 0xffffffff1e6bd568(1.2484927790946947e-20_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f19, f24
f19                 0xffffffff1e6bd568(1.2484927790946947e-20_s)    0xffffffff1e6bd568(1.2484927790946947e-20_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8897303b9ac6b80891770875719cbc40fd8ce798        8897303b9ac6b80891770875719cbc40fd8ce798        
