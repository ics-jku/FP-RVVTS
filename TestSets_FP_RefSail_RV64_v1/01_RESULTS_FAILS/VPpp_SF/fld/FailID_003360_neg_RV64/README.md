# FailID_003360 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // restore registers
    li x1, 0xffffffffd0691000    // ra
    li x2, 0x800001fe            // sp
    li x3, 0x800061fe            // gp
    li x4, 0x8017f90e            // tp
    li x5, 0x0                   // t0
    li x6, 0x0                   // t1
    li x7, 0x200801fb4000000     // t2
    li x8, 0x0                   // fp
    li x9, 0x80000421            // s1
    li x10, 0x200                // a0
    li x11, 0x8018642c           // a1
    li x12, 0x18                 // a2
    li x13, 0x8018017a           // a3
    li x14, 0x802002fd           // a4
    li x15, 0x6000               // a5
    li x16, 0x7fffffffffffffff   // a6
    li x17, 0x0                  // a7
    li x18, 0x802007ed           // s2
    li x19, 0x80205c8b           // s3
    li x20, 0xfffffffffffffe7f   // s4
    li x21, 0x8018042c           // s5
    li x22, 0x8017f500           // s6
    li x23, 0x801ffe34           // s7
    li x24, 0x8017f863           // s8
    li x25, 0x1                  // s9
    li x26, 0x0                  // s10
    li x27, 0x801ffdee           // s11
    li x28, 0x801800b2           // t3
    li x29, 0x80005cd4           // t4
    li x30, 0x8018073f           // t5
    li x31, 0x8017fe6e           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'x28', 'x6', 'f23'}})
...
f23                 0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
t1(x6)              0x000000007ffffd55(2147482965)                  0x000000007ffffd55(2147482965)
f23                 0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
ra(x1)              0xffffffffd0691000(18446744072911130624)        0xffffffffd0691000(18446744072911130624)        
sp(x2)              0x00000000800001fe(2147484158)                  0x00000000800001fe(2147484158)                  
...
t1(x6)              0x000000007ffffd55(2147482965)                  0x000000007ffffd55(2147482965)                  
t2(x7)              0x0200801fb4000000(144256061728096256)          0x0200801fb4000000(144256061728096256)          
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0x0000000080000421(2147484705)                  0x0000000080000421(2147484705)                  
a0(x10)             0x0000000000000200(512)                         0x0000000000000200(512)                         
a1(x11)             0x000000008018642c(2149082156)                  0x000000008018642c(2149082156)                  
a2(x12)             0x0000000000000018(24)                          0x0000000000000018(24)                          
a3(x13)             0x000000008018017a(2149056890)                  0x000000008018017a(2149056890)                  
a4(x14)             0x00000000802002fd(2149581565)                  0x00000000802002fd(2149581565)                  
...
s3(x19)             0x0000000080205c8b(2149604491)                  0x0000000080205c8b(2149604491)                  
s4(x20)             0xfffffffffffffe7f(18446744073709551231)        0xfffffffffffffe7f(18446744073709551231)        
...
s7(x23)             0x00000000801ffe34(2149580340)                  0x00000000801ffe34(2149580340)                  
s8(x24)             0x000000008017f863(2149054563)                  0x000000008017f863(2149054563)                  
s9(x25)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s10(x26)            0x0000000000000000(0)                           0x0000000000000000(0)                           
s11(x27)            0x00000000801ffdee(2149580270)                  0x00000000801ffdee(2149580270)                  
t3(x28)             0x000000007ffffd55(2147482965)                  0x000000007ffffd55(2147482965)                  
...
t6(x31)             0x000000008017fe6e(2149056110)                  0x000000008017fe6e(2149056110)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            ab0fd932ed62fdf0bd69578446ced4287a4fa658        ab0fd932ed62fdf0bd69578446ced4287a4fa658        
