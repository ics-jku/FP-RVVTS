# FailID_001906 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x19, 0xe60ec92906ac3400   // s3
    li x20, 0x6ad975f97db72060   // s4
    li x21, 0x5a31726bf7a14b23   // s5
    li x22, 0x0                  // s6
    li x23, 0x1d37189c           // s7
    li x24, 0x80019543           // s8
    li x25, 0x801803eb           // s9
    li x26, 0x80000353           // s10
    li x27, 0x39                 // s11
    li x28, 0x51e785a49e7321b0   // t3
    li x29, 0xba453614e6ed675e   // t4
    li x30, 0x8016720a           // t5
    li x31, 0x7ffffa37           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x22', 'mstatus.fs/vs.fs', 'f16'}, 'clob': {'x22', 'x24'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        71365f6ea112069c65dd670506b1ad2c637181b6        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, x1, x22
ra(x1)              0x0000000000006000(24576)                       0x0000000000006000(24576)
s6(x22)             0x00000000801801eb(2149057003)                  0x00000000801801eb(2149057003)
...
s3(x19)             0xe60ec92906ac3400(16577408456440165376)        0xe60ec92906ac3400(16577408456440165376)        
...
s6(x22)             0x00000000801801eb(2149057003)                  0x00000000801801eb(2149057003)                  
s7(x23)             0x000000001d37189c(490150044)                   0x000000001d37189c(490150044)                   
s8(x24)             0x00000000801801eb(2149057003)                  0x00000000801801eb(2149057003)                  
s9(x25)             0x00000000801803eb(2149057515)                  0x00000000801803eb(2149057515)                  
s10(x26)            0x0000000080000353(2147484499)                  0x0000000080000353(2147484499)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6f1ab469202d470f3352efa3cb757c1ddeb33c33        6f1ab469202d470f3352efa3cb757c1ddeb33c33        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        71365f6ea112069c65dd670506b1ad2c637181b6        X
lastPC              0x0000000080000880(2147485824)                  0x0000000080000880(2147485824)                  
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
