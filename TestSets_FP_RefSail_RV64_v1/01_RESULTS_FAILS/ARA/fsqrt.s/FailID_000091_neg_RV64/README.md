# FailID_000091 ARA neg RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f27'}})
    fsqrt.s f27, f24
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff33800000(5.960464477539063e-08_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ebb5c6f9adbe84c4d4b1a92a25d68cef366358d2        ebb5c6f9adbe84c4d4b1a92a25d68cef366358d2        
