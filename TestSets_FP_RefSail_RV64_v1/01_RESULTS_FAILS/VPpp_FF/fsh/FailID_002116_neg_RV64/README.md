# FailID_002116 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x8, 0x8017fa44            // fp
    li x9, 0x7fffff03            // s1
    li x10, 0x8018009d           // a0
    li x11, 0x0                  // a1
    li x12, 0x0                  // a2
    li x13, 0x0                  // a3
    li x14, 0x801803d5           // a4
    li x15, 0x7fffff5b           // a5
    li x16, 0x0                  // a6
    li x17, 0x7ffff8fe           // a7
    li x18, 0x7fffffc3           // s2
    li x19, 0x0                  // s3
    li x20, 0x8018009d           // s4
    li x21, 0xb5d99748           // s5
    li x22, 0x1                  // s6
    li x23, 0x6000               // s7
    li x24, 0x0                  // s8
    li x25, 0x8017f311           // s9
    li x26, 0x801838d9           // s10
    li x27, 0x2                  // s11
    li x28, 0x200                // t3
    li x29, 0x802000ed           // t4
    li x30, 0x200                // t5
    li x31, 0x8017f8d9           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f31', 'x14'}, 'clob': {'x14', 'x20'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4d156266645b3d2fb726a56f78c4f4c17141acef        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x401, x14
a4(x14)             0x00000000801fffd3(2149580755)                  0x00000000801fffd3(2149580755)
...
gp(x3)              0x00000000801802e7(2149057255)                  0x00000000801802e7(2149057255)                  
tp(x4)              0x00000000801802a6(2149057190)                  0x00000000801802a6(2149057190)                  
...
t2(x7)              0x000000007ffff8c1(2147481793)                  0x000000007ffff8c1(2147481793)                  
...
a0(x10)             0x000000008018009d(2149056669)                  0x000000008018009d(2149056669)                  
...
a4(x14)             0x00000000801fffd3(2149580755)                  0x00000000801fffd3(2149580755)                  
a5(x15)             0x000000007fffff5b(2147483483)                  0x000000007fffff5b(2147483483)                  
...
s4(x20)             0x000000008017fbff(2149055487)                  0x000000008017fbff(2149055487)                  
...
s9(x25)             0x000000008017f311(2149053201)                  0x000000008017f311(2149053201)                  
s10(x26)            0x00000000801838d9(2149071065)                  0x00000000801838d9(2149071065)                  
s11(x27)            0x0000000000000002(2)                           0x0000000000000002(2)                           
t3(x28)             0x0000000000000200(512)                         0x0000000000000200(512)                         
t4(x29)             0x00000000802000ed(2149581037)                  0x00000000802000ed(2149581037)                  
t5(x30)             0x0000000000000200(512)                         0x0000000000000200(512)                         
t6(x31)             0x000000008017f8d9(2149054681)                  0x000000008017f8d9(2149054681)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            8fd975c17d42d3e65e474018ce205877dbcbc5be        8fd975c17d42d3e65e474018ce205877dbcbc5be        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4d156266645b3d2fb726a56f78c4f4c17141acef        X
