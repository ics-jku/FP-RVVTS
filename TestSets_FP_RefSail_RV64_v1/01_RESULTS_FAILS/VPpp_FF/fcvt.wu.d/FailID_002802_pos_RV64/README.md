# FailID_002802 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0xfa,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x1'}})
    fcvt.wu.d x1, f0, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x1, f0, rmm
+========================================================================================================================+
...
Registers: x1, f0
ra(x1)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f0                  0xffffffff4f0017fa(2149054976.0_s)              0xffffffff4f0017fa(2149054976.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8b3f2a7a6de68d5f83b8c39ddf554f9c0a7d90d0        8b3f2a7a6de68d5f83b8c39ddf554f9c0a7d90d0        
