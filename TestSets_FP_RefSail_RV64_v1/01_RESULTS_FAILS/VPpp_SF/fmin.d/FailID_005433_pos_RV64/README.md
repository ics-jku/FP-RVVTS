# FailID_005433 VP++ SF pos RV64 fmin.d
...
_reg_f14:.byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f5'}, 'clob': {'f17'}})
    fmin.d f17, f5, f14
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x40d8000000000000(24576.0_d)                   0xffffffff5f800000(1.8446744073709552e+19_s)    X
STATES DIFFER: True
```
...
f17                 0x40d8000000000000(24576.0_d)                   0xffffffff5f800000(1.8446744073709552e+19_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f5, f14
f5                  0x40d8000000000000(24576.0_d)                   0x40d8000000000000(24576.0_d)
f14                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff5f800000(1.8446744073709552e+19_s)
f17                 0x40d8000000000000(24576.0_d)                   0xffffffff5f800000(1.8446744073709552e+19_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            caba486b778751f266c3156ecf0e9f062b7c6530        caba486b778751f266c3156ecf0e9f062b7c6530        
