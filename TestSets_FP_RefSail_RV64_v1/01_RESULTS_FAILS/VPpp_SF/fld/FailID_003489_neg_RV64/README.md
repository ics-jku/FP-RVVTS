# FailID_003489 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x20'}, 'clob': {'x9', 'f4', 'x20'}})
...
f4                  0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            343a751aeb4bee98e3ee498c033d18d8f300def9        343a751aeb4bee98e3ee498c033d18d8f300def9        
