# FailID_005193 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f16', 'fcsr.rm'}, 'clob': {'f7'}})
    fmax.d f7, f20, f16
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6bec2c5da56bfbb4c091e498aef5a820a1a06e56        6bec2c5da56bfbb4c091e498aef5a820a1a06e56        
