# FailID_005237 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f2'}, 'clob': {'f16'}})
    fmax.s f16, f16, f2
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            137623a8eb1f504259cee997b22b7d8251d2bf3a        137623a8eb1f504259cee997b22b7d8251d2bf3a        
