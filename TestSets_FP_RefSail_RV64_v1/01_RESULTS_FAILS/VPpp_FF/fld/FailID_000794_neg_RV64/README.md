# FailID_000794 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x7ffffe49            // fp
    li x9, 0x801802c2            // s1
    li x10, 0x8017fb53           // a0
    li x11, 0x7ffffd8a           // a1
    li x12, 0x80180412           // a2
    li x13, 0x80180409           // a3
    li x14, 0x98                 // a4
    li x15, 0xffffffffff32e000   // a5
    li x16, 0x80000240           // a6
    li x17, 0xae                 // a7
    li x18, 0x6000               // s2
    li x19, 0x80000404           // s3
    li x20, 0xf79607a8           // s4
    li x21, 0xb0                 // s5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x19'}, 'clob': {'f12', 'x19', 'x21'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, x28, x19
s3(x19)             0x0000000080000171(2147484017)                  0x0000000080000171(2147484017)
...
ra(x1)              0x000000008000016d(2147484013)                  0x000000008000016d(2147484013)                  
...
t0(x5)              0x000000007ffffb16(2147482390)                  0x000000007ffffb16(2147482390)                  
...
fp(x8)              0x000000007ffffe49(2147483209)                  0x000000007ffffe49(2147483209)                  
s1(x9)              0x00000000801802c2(2149057218)                  0x00000000801802c2(2149057218)                  
a0(x10)             0x000000008017fb53(2149055315)                  0x000000008017fb53(2149055315)                  
a1(x11)             0x000000007ffffd8a(2147483018)                  0x000000007ffffd8a(2147483018)                  
...
a6(x16)             0x0000000080000240(2147484224)                  0x0000000080000240(2147484224)                  
a7(x17)             0x00000000000000ae(174)                         0x00000000000000ae(174)                         
s2(x18)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s3(x19)             0x0000000080000171(2147484017)                  0x0000000080000171(2147484017)                  
s4(x20)             0x00000000f79607a8(4153804712)                  0x00000000f79607a8(4153804712)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b7f88d34a8fce0b6786249aa01f946d12ac9491c        b7f88d34a8fce0b6786249aa01f946d12ac9491c        
