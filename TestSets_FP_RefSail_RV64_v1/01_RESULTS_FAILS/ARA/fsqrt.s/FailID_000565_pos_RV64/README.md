# FailID_000565 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f9'}})
    fsqrt.s f9, f4, rmm
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d70cbb6b25f56e7074b23e999c22cf0beaac380b        d70cbb6b25f56e7074b23e999c22cf0beaac380b        
