# FailID_000011 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'f7'}})
    fdiv.s f7, f5, f1, rdn
```
...
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff00000001(1.401298464324817e-45_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f7, f5, f1, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            00b11aaa5e9bfe537b2381183dc0c94827c70d1c        00b11aaa5e9bfe537b2381183dc0c94827c70d1c        
