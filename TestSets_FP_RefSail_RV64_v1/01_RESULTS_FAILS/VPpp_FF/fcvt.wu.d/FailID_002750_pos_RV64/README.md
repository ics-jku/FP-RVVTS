# FailID_002750 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x00,0x40,0x22,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    fcvt.wu.d x31, f12, rup
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t6(x31)             0xffffffff80000112(18446744071562068242)        0x0000000080000112(2147483922)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x31, f12, rup
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x31, f12
t6(x31)             0xffffffff80000112(18446744071562068242)        0x0000000080000112(2147483922)                  X
f12                 0x41e0000022400000(2147483922.0_d)              0x41e0000022400000(2147483922.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            de01469606cf9daabc01484faa808136c94765de        de01469606cf9daabc01484faa808136c94765de        
