# FailID_005198 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0xa9,0xb8,0xe3,0x7b,0x8e,0x9f,0xcc,0x82
_reg_f17:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x40
_reg_f27:.byte 0xfd,0xf9,0xff,0x7f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f7'}})
    fmax.d f7, f17, f27
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0x4030000000000000(16.0_d)                      0xffffffff7ffff9fd(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f7, f17, f27
+========================================================================================================================+
Attributes:  special values ['nan'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f7                  0x4030000000000000(16.0_d)                      0xffffffff7ffff9fd(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f17, f27
f7                  0x4030000000000000(16.0_d)                      0xffffffff7ffff9fd(nan_s)                       X
f17                 0x4030000000000000(16.0_d)                      0x4030000000000000(16.0_d)
f27                 0xffffffff7ffff9fd(nan_s)                       0xffffffff7ffff9fd(nan_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            17d49e0a87eeef567401b931b36a86ccf4cbc1d6        17d49e0a87eeef567401b931b36a86ccf4cbc1d6        
