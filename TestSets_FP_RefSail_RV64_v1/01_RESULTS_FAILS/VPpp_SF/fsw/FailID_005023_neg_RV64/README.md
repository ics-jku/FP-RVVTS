# FailID_005023 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x5, 0x8017fa55            // t0
    li x6, 0x0                   // t1
    li x7, 0x400c07118000000     // t2
    li x8, 0x4727a000            // fp
    li x9, 0xa                   // s1
    li x10, 0x80180032           // a0
    li x11, 0x800001b2           // a1
    li x12, 0x80000790           // a2
    li x13, 0x800067d0           // a3
    li x14, 0x800003e0           // a4
    li x15, 0x7ffffc95           // a5
    li x16, 0x761                // a6
    li x17, 0xffffffff7fe001be   // a7
    li x18, 0x0                  // s2
    li x19, 0x0                  // s3
    li x20, 0x0                  // s4
    li x21, 0x80180050           // s5
    li x22, 0x80180647           // s6
    li x23, 0x80200de7           // s7
    li x24, 0x80180474           // s8
    li x25, 0x80180e23           // s9
    li x26, 0xb0                 // s10
    li x27, 0x0                  // s11
    li x28, 0x800dae5f           // t3
    li x29, 0x80000662           // t4
    li x30, 0x0                  // t5
    li x31, 0x6e015764           // t6
    // INSTRUCTION ({'dep': {'x16', 'f4', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'x18'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9bcd32867c8b61345f53d53a3db8d230dedbdb31        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x33, x16
a6(x16)             0x0000000080180422(2149057570)                  0x0000000080180422(2149057570)
...
a5(x15)             0x000000007ffffc95(2147482773)                  0x000000007ffffc95(2147482773)                  
a6(x16)             0x0000000080180422(2149057570)                  0x0000000080180422(2149057570)                  
a7(x17)             0xffffffff7fe001be(18446744071559971262)        0xffffffff7fe001be(18446744071559971262)        
s2(x18)             0x000000008017fcc2(2149055682)                  0x000000008017fcc2(2149055682)                  
s3(x19)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s4(x20)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s5(x21)             0x0000000080180050(2149056592)                  0x0000000080180050(2149056592)                  
s6(x22)             0x0000000080180647(2149058119)                  0x0000000080180647(2149058119)                  
s7(x23)             0x0000000080200de7(2149584359)                  0x0000000080200de7(2149584359)                  
s8(x24)             0x0000000080180474(2149057652)                  0x0000000080180474(2149057652)                  
s9(x25)             0x0000000080180e23(2149060131)                  0x0000000080180e23(2149060131)                  
...
t6(x31)             0x000000006e015764(1845581668)                  0x000000006e015764(1845581668)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            9d9030d4f82d3dbf4d85bb57e54928a32ab2038b        9d9030d4f82d3dbf4d85bb57e54928a32ab2038b        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9bcd32867c8b61345f53d53a3db8d230dedbdb31        X
