# FailID_000495 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f28'}})
    fsqrt.s f28, f2
```
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffff305db417(8.065525469724832e-10_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5129edad210f65fbfe8b16208d33b44e510d0d33        5129edad210f65fbfe8b16208d33b44e510d0d33        
