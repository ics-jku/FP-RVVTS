# FailID_005376 VP++ SF pos RV64 fmin.d
...
_reg_f27:.byte 0xcd,0x3b,0x7f,0x66,0x9e,0xa0,0x36,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f24'}})
    fmin.d f24, f27, f14
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x4036a09e667f3bcd(22.627416997969522_d)        0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f24, f27, f14
+========================================================================================================================+
...
f24                 0x4036a09e667f3bcd(22.627416997969522_d)        0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f27, f14
f14                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f24                 0x4036a09e667f3bcd(22.627416997969522_d)        0x7ff8000000000000(nan_d)                       X
f27                 0x4036a09e667f3bcd(22.627416997969522_d)        0x4036a09e667f3bcd(22.627416997969522_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5ff8244c5e5c836be340b8a3f524ce40cb4ba1b7        5ff8244c5e5c836be340b8a3f524ce40cb4ba1b7        
