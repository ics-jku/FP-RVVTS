# FailID_005326 VP++ SF pos RV64 fmax.s
...
_reg_f4: .byte 0x00,0x00,0x80,0x4f,0xff,0xff,0xff,0xff
_reg_f30:.byte 0xfa,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f4'}, 'clob': {'f30'}})
    fmax.s f30, f4, f0
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f4                  0xffffffff4f800000(4294967296.0_s)              0xffffffff4f800000(4294967296.0_s)
f30                 0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9b324d46e3b37224a00c181e1289935153f35311        9b324d46e3b37224a00c181e1289935153f35311        
