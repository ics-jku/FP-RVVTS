# FailID_000889 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x29, 0x8000027b           // t4
    li x30, 0x5d90a7dc           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x16', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'x26', 'f24'}})
...
f24                 0x44aeebefb8665acb(7.301162650616101e+22_d)     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f24                 0x44aeebefb8665acb(7.301162650616101e+22_d)     0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, x4, a9, x16
tp(x4)              0x0000000000000001(1)                           0x0000000000000001(1)
a6(x16)             0x0000000080065f71(2147901297)                  0x0000000080065f71(2147901297)
f24                 0x44aeebefb8665acb(7.301162650616101e+22_d)     0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
s1(x9)              0x000000008017fe64(2149056100)                  0x000000008017fe64(2149056100)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4364dee8ab6d149582e441ffd661ee72a9ad5f97        4364dee8ab6d149582e441ffd661ee72a9ad5f97        
