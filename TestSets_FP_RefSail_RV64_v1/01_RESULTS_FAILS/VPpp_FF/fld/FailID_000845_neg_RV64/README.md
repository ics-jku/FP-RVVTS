# FailID_000845 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x14, 0x0                  // a4
    li x15, 0x80200ad1           // a5
    li x16, 0x7fffff3e           // a6
    li x17, 0x801860ff           // a7
    li x18, 0x80000159           // s2
    li x19, 0x801800c4000        // s3
    li x20, 0xadfcb754           // s4
    li x21, 0x8017ffa6           // s5
    li x22, 0x80000159           // s6
    li x23, 0x8017fb6b           // s7
    li x24, 0x158da000           // s8
    li x25, 0xffffffffdd2d7000   // s9
    li x26, 0x801ffeb6           // s10
    li x27, 0x8014f65c           // s11
    li x28, 0x6000               // t3
    li x29, 0x801800c4           // t4
    li x30, 0x158da000           // t5
    li x31, 0x57                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'f7', 'x23'}})
...
f7                  0x0000000000006000(1.2142e-319_d)               0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f7                  0x0000000000006000(1.2142e-319_d)               0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x5, f0, x2
sp(x2)              0x00000000802005e8(2149582312)                  0x00000000802005e8(2149582312)
...
a5(x15)             0x0000000080200ad1(2149583569)                  0x0000000080200ad1(2149583569)                  
a6(x16)             0x000000007fffff3e(2147483454)                  0x000000007fffff3e(2147483454)                  
a7(x17)             0x00000000801860ff(2149081343)                  0x00000000801860ff(2149081343)                  
...
s4(x20)             0x00000000adfcb754(2919020372)                  0x00000000adfcb754(2919020372)                  
s5(x21)             0x000000008017ffa6(2149056422)                  0x000000008017ffa6(2149056422)                  
s6(x22)             0x0000000080000159(2147483993)                  0x0000000080000159(2147483993)                  
s7(x23)             0x00000000800005f0(2147485168)                  0x00000000800005f0(2147485168)                  
s8(x24)             0x00000000158da000(361603072)                   0x00000000158da000(361603072)                   
...
t5(x30)             0x00000000158da000(361603072)                   0x00000000158da000(361603072)                   
t6(x31)             0x0000000000000057(87)                          0x0000000000000057(87)                          

STATE               REF                                             DUT                                             DIFF
xmemhash            cca5e677d4e3d6fab14cca9aecb3a2893b0dcbd4        cca5e677d4e3d6fab14cca9aecb3a2893b0dcbd4        
