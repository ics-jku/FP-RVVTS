# FailID_004097 VP++ SF neg RV64 fmax.d
...
_reg_f21:.byte 0xcb,0xe1,0xb6,0xbd,0xa6,0xa5,0x2d,0x9d
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'f18', 'fcsr.rm'}, 'clob': {'f15'}})
    fmax.d f15, f21, f18
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x9d2da5a6bdb6e1cb(-3.9278445542876183e-168_d)  0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f15, f21, f18
+========================================================================================================================+
...
f15                 0x9d2da5a6bdb6e1cb(-3.9278445542876183e-168_d)  0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f21, f18
f15                 0x9d2da5a6bdb6e1cb(-3.9278445542876183e-168_d)  0xffffffff7fc00000(nan_s)                       X
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f21                 0x9d2da5a6bdb6e1cb(-3.9278445542876183e-168_d)  0x9d2da5a6bdb6e1cb(-3.9278445542876183e-168_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e1866077ec1bef342b2f9f909cde9d7bd8ec57fa        e1866077ec1bef342b2f9f909cde9d7bd8ec57fa        
