# FailID_004154 VP++ SF neg RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x0c,0x13,0xd1,0x84,0xff,0xff,0xff,0xff
_reg_f7: .byte 0x23,0xb0,0xa1,0x11,0x23,0xb4,0xb1,0x11
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f7'}, 'clob': {'f6'}})
    fmin.d f6, f7, f30
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0x11b1b42311a1b023(1.9131379602245828e-223_d)   0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f6, f7, f30
+========================================================================================================================+
Attributes:  special values ['nan'], precision mismatch ('d', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: f6, f7, f30
f6                  0x11b1b42311a1b023(1.9131379602245828e-223_d)   0xffffffffffff7e00(nan_h)                       X
f7                  0x11b1b42311a1b023(1.9131379602245828e-223_d)   0x11b1b42311a1b023(1.9131379602245828e-223_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0071bf5b9af0243d01710fc661fcaf8e15939cd6        0071bf5b9af0243d01710fc661fcaf8e15939cd6        
