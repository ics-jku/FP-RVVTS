# FailID_002951 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f17:.byte 0x00,0x00,0xc0,0xb6,0xff,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'x13'}})
    fcvt.wu.s x13, f17, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a3(x13)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x13, f17, rmm
+========================================================================================================================+
...
Registers: x13, f17
a3(x13)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f17                 0x41dfffffb6c00000(2147483355.0_d)              0x41dfffffb6c00000(2147483355.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f4bd425da251fc1199f2fa408bbdac8d8fcaffac        f4bd425da251fc1199f2fa408bbdac8d8fcaffac        
