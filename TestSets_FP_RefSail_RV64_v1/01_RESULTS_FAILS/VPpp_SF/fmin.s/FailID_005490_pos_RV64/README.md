# FailID_005490 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x17,0x10,0x6a,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'f18', 'fcsr.rm'}, 'clob': {'f14'}})
    fmin.s f14, f6, f18
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff4e6a1017(981730752.0_s)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f14                 0xffffffff4e6a1017(981730752.0_s)               0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f6, f18
f6                  0xffffffff4e6a1017(981730752.0_s)               0xffffffff4e6a1017(981730752.0_s)
f14                 0xffffffff4e6a1017(981730752.0_s)               0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ca4f53bfc30fa7ef4bcb6cbdbe3fcbe988d664a0        ca4f53bfc30fa7ef4bcb6cbdbe3fcbe988d664a0        
