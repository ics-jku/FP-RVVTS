# FailID_002658 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f26:.byte 0x00,0x00,0x04,0x43,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f26
    fld  f26, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f26', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x20'}})
    fcvt.wu.d x20, f26, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x20, f26, rmm
+========================================================================================================================+
...
Registers: x20, f26
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f26                 0xffffffff43040000(132.0_s)                     0xffffffff43040000(132.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            21f595d2ee80587cb25a754702203e535bebdfb4        21f595d2ee80587cb25a754702203e535bebdfb4        
