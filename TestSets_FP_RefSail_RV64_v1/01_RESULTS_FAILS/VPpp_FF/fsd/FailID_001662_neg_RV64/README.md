# FailID_001662 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x22, 0x80180121           // s6
    li x23, 0x80180213           // s7
    li x24, 0x80180241           // s8
    li x25, 0x801ffc04           // s9
    li x26, 0x1                  // s10
    li x27, 0x7ffff966           // s11
    li x28, 0x8017fbb0           // t3
    li x29, 0x8027f883           // t4
    li x30, 0x801ff7d0           // t5
    li x31, 0x8017fba3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f19', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'x11', 'x29'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        39a8777749b014b86980a9401db7ebf61902fbb5        X
...
tp(x4)              0xfffffffffffffff3(18446744073709551603)        0xfffffffffffffff3(18446744073709551603)        
...
s1(x9)              0x0000000080185bb0(2149079984)                  0x0000000080185bb0(2149079984)                  
...
s6(x22)             0x0000000080180121(2149056801)                  0x0000000080180121(2149056801)                  
s7(x23)             0x0000000080180213(2149057043)                  0x0000000080180213(2149057043)                  
s8(x24)             0x0000000080180241(2149057089)                  0x0000000080180241(2149057089)                  
s9(x25)             0x00000000801ffc04(2149579780)                  0x00000000801ffc04(2149579780)                  
s10(x26)            0x0000000000000001(1)                           0x0000000000000001(1)                           
s11(x27)            0x000000007ffff966(2147481958)                  0x000000007ffff966(2147481958)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            71e3a860bfd90e92301f9d2eb976a0f543f86235        71e3a860bfd90e92301f9d2eb976a0f543f86235        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        39a8777749b014b86980a9401db7ebf61902fbb5        X
