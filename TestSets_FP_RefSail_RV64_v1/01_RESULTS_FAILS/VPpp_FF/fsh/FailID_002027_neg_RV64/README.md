# FailID_002027 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f14', 'x16', 'mstatus.fs/vs.fs'}, 'clob': {'x10', 'x16'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, x160, x16
a6(x16)             0x0000000080180160(2149056864)                  0x0000000080180160(2149056864)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a4f38d0af18f7ff35259fc4356bde7e6ae6c1ad0        a4f38d0af18f7ff35259fc4356bde7e6ae6c1ad0        
