# FailID_005279 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0x00,0x00,0xc0,0x0f,0xff,0x02,0xe0,0x41
_reg_f22:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_reg_f26:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'f26'}})
    fmax.s f26, f22, f21
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f26, f22, f21
+========================================================================================================================+
...
f26                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f22, f21
f21                 0x41e002ff0fc00000(2149054590.0_d)              0x41e002ff0fc00000(2149054590.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f51b2d2c88d9d0a86e873a663cc37da06f11fa13        f51b2d2c88d9d0a86e873a663cc37da06f11fa13        
