# FailID_003447 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x8000000000000000   // s11
    li x28, 0x1000002            // t3
    li x29, 0x200                // t4
    li x30, 0x6000               // t5
    li x31, 0x8000040b           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'x27', 'f19', 'x2'}})
...
f19                 0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
a1(x11)             0x000000008018055d(2149057885)                  0x000000008018055d(2149057885)                  
...
s4(x20)             0x000000008027fa48(2150103624)                  0x000000008027fa48(2150103624)                  
...
s9(x25)             0x000000000e8e5344(244208452)                   0x000000000e8e5344(244208452)                   
...
t6(x31)             0x000000008000040b(2147484683)                  0x000000008000040b(2147484683)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            398deb33b28c1edef494b021775593f548ab685c        398deb33b28c1edef494b021775593f548ab685c        
