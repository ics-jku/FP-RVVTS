# FailID_000728 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x28, 0x1                  // t3
    li x29, 0x8017fef5           // t4
    li x30, 0x3                  // t5
    li x31, 0x44                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'x4', 'f21', 'x29'}})
...
f21                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
tp(x4)              0x000000007ffffdb3(2147483059)                  0x000000007ffffdb3(2147483059)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4cfcf59ac3dcf8fc5f1909b937ef663e0ead45ae        4cfcf59ac3dcf8fc5f1909b937ef663e0ead45ae        
