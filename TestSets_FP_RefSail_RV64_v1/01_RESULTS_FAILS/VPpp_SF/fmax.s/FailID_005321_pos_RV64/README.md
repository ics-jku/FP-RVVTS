# FailID_005321 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f25', 'f2'}, 'clob': {'f15'}})
    fmax.s f15, f25, f2
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xffffffff00000000(0.0_s)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2a7d2926660a7f41a03c52f494aa075c59ce914a        2a7d2926660a7f41a03c52f494aa075c59ce914a        
