# FailID_005435 VP++ SF pos RV64 fmin.d
...
_reg_f5: .byte 0x93,0x05,0xb0,0x00,0x13,0x06,0xc0,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f29'}, 'clob': {'f5'}})
    fmin.d f5, f3, f29
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x41e0030025c00000(2149056814.0_d)              0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            89803370c709746ee5f9bfba186719f94398d73f        89803370c709746ee5f9bfba186719f94398d73f        
