# FailID_002024 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x25, 0x53                 // s9
    li x26, 0xffffffff7ffffc05   // s10
    li x27, 0x7ffffa42           // s11
    li x28, 0x0                  // t3
    li x29, 0x1                  // t4
    li x30, 0x0                  // t5
    li x31, 0x800000f7           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'x30', 'x24'}})
...
s8(x24)             0x0000000080180782(2149058434)                  0x0000000080180782(2149058434)                  
s9(x25)             0x0000000000000053(83)                          0x0000000000000053(83)                          
s10(x26)            0xffffffff7ffffc05(18446744071562066949)        0xffffffff7ffffc05(18446744071562066949)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb17ce2800fb376cadd5d8c3fe13389434534331        fb17ce2800fb376cadd5d8c3fe13389434534331        
