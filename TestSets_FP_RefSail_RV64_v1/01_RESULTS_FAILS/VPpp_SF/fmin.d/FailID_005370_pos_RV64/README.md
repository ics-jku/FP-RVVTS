# FailID_005370 VP++ SF pos RV64 fmin.d
...
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x20,0xc3
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f25'}, 'clob': {'f20'}})
    fmin.d f20, f25, f26
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xc320000000000000(-2251799813685248.0_d)       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f20, f25, f26
+========================================================================================================================+
...
f20                 0xc320000000000000(-2251799813685248.0_d)       0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f25, f26
f20                 0xc320000000000000(-2251799813685248.0_d)       0x7ff8000000000000(nan_d)                       X
f25                 0xc320000000000000(-2251799813685248.0_d)       0xc320000000000000(-2251799813685248.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c6b9780dd9f56ef662df021985c96a41683a0701        c6b9780dd9f56ef662df021985c96a41683a0701        
