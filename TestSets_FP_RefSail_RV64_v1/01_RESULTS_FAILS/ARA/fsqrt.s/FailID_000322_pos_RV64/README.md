# FailID_000322 ARA pos RV64 fsqrt.s
...
_reg_f26:.byte 0x82,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f15'}})
    fsqrt.s f15, f26
```
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff1c00ff02(4.26812372354487e-22_s)      X
STATES DIFFER: True
```
...
Registers: f15, f26
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff1c00ff02(4.26812372354487e-22_s)      X
f26                 0x0000000000000082(6.4e-322_d)                  0x0000000000000082(6.4e-322_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            63b3453b2dbaef16e1a49bf5c01cad54c7c07373        63b3453b2dbaef16e1a49bf5c01cad54c7c07373        
