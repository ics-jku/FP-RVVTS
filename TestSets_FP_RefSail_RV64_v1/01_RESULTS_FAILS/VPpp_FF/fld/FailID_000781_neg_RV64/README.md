# FailID_000781 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x0                   // fp
    li x9, 0x8017f73f            // s1
    li x10, 0x80000560           // a0
    li x11, 0x8017f95d           // a1
    li x12, 0x801fff92           // a2
    li x13, 0x80180773           // a3
    li x14, 0x809                // a4
    ...
    li x20, 0x800c4cd8           // s4
    li x21, 0xffffffffed969000   // s5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x23'}, 'clob': {'x12', 'f5', 'x23'}})
...
f5                  0xffffffffffff0000(0.0_h)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
sp(x2)              0x00000000400bfcae(1074527406)                  0x00000000400bfcae(1074527406)                  
...
a0(x10)             0x0000000080000560(2147485024)                  0x0000000080000560(2147485024)                  
a1(x11)             0x000000008017f95d(2149054813)                  0x000000008017f95d(2149054813)                  
a2(x12)             0x0000000080000369(2147484521)                  0x0000000080000369(2147484521)                  
a3(x13)             0x0000000080180773(2149058419)                  0x0000000080180773(2149058419)                  
...
s4(x20)             0x00000000800c4cd8(2148289752)                  0x00000000800c4cd8(2148289752)                  
s5(x21)             0xffffffffed969000(18446744073400651776)        0xffffffffed969000(18446744073400651776)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b20b57c3581e7401aef3aff1a7b9e18dc2dfdebc        b20b57c3581e7401aef3aff1a7b9e18dc2dfdebc        
