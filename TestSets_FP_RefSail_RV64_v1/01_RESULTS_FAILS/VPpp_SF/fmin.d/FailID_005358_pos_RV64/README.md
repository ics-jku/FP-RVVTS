# FailID_005358 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f28'}})
    fmin.d f28, f19, f28
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0x41efffffffe00000(4294967295.0_d)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f28, f19, f28
+========================================================================================================================+
...
f28                 0x41efffffffe00000(4294967295.0_d)              0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f19, f28
f19                 0x41efffffffe00000(4294967295.0_d)              0x41efffffffe00000(4294967295.0_d)
f28                 0x41efffffffe00000(4294967295.0_d)              0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            568a15cc58c14023f7e04ee4edb0e85326382ca7        568a15cc58c14023f7e04ee4edb0e85326382ca7        
