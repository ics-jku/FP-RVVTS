# FailID_005162 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x62,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f28:.byte 0xac,0x0e,0x18,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f31'}, 'clob': {'f9'}})
    fmax.d f9, f28, f31
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x0000000080180eac(1.0617768493e-314_d)         0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f9                  0x0000000080180eac(1.0617768493e-314_d)         0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f28, f31
f9                  0x0000000080180eac(1.0617768493e-314_d)         0xffffffff7fc00000(nan_s)                       X
f28                 0x0000000080180eac(1.0617768493e-314_d)         0x0000000080180eac(1.0617768493e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0338c8164fac18d2e2c7650f8d7a4550eba01922        0338c8164fac18d2e2c7650f8d7a4550eba01922        
