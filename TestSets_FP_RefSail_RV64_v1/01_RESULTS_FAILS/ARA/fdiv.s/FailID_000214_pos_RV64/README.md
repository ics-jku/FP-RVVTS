# FailID_000214 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_reg_f24:.byte 0x96,0x0d,0xe9,0xca,0x98,0x29,0xa5,0x85
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f5'}})
    fdiv.s f5, f24, f5, rup
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffff7fc00000(nan_s)                       0xffffffffcae90d96(-7636683.0_s)                X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f5, f24, f5, rup
+========================================================================================================================+
...
Registers: f5, f24, f5
f5                  0xffffffff7fc00000(nan_s)                       0xffffffffcae90d96(-7636683.0_s)                X
f24                 0x85a52998cae90d96(-1.8216325635840536e-281_d)  0x85a52998cae90d96(-1.8216325635840536e-281_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fea3961c6409c8ce4a3e351b27057c1170a50f3a        fea3961c6409c8ce4a3e351b27057c1170a50f3a        
