# FailID_004169 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'f12'}, 'clob': {'f29'}})
    fmin.s f29, f12, f29
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff0661b023(4.2447201453266725e-35_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f29, f12, f29
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7fcf014d1f09af8ee674e981f9eec6ae81f85297        7fcf014d1f09af8ee674e981f9eec6ae81f85297        
