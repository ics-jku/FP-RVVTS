# FailID_000155 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f28'}})
    fdiv.s f28, f27, f21, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f28, f27, f21, dyn
+========================================================================================================================+
...
fcsr                0x0000000000000000(0)                           0x0000000000000010(16)                          X
 fcsr.nv            False                                           True                                            X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f27, f21
f21                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c24511cc86b6a9fc64fd537c4640d41413e8544d        c24511cc86b6a9fc64fd537c4640d41413e8544d        
