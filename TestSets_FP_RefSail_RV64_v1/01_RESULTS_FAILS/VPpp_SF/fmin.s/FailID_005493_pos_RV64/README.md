# FailID_005493 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0x2a,0xff,0xff,0xaf,0x41
_reg_f22:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
_reg_f23:.byte 0x02,0x00,0x00,0x01,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f23', 'fcsr.rm'}, 'clob': {'f22'}})
    fmin.s f22, f23, f3
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f22                 0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f23, f3
f3                  0x41afffff2a000000(268435349.0_d)               0x41afffff2a000000(268435349.0_d)
f22                 0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff7fc00000(nan_s)                       X
f23                 0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff01000002(2.350989262163961e-38_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            59a09841b593f86e57230fed994daa636c56d206        59a09841b593f86e57230fed994daa636c56d206        
