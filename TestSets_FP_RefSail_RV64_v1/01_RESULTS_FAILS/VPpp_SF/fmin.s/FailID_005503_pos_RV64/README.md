# FailID_005503 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_reg_f11:.byte 0x00,0x00,0x00,0x89,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f29'}, 'clob': {'f11'}})
    fmin.s f11, f3, f29
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f11                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f3, f29
f3                  0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
f11                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9d0ee13cf1cc5b257f7139e36d378f4471114d54        9d0ee13cf1cc5b257f7139e36d378f4471114d54        
