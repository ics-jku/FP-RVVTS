# FailID_001503 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x16, 0x80180422           // a6
    li x17, 0xffffffff7fe001be   // a7
    li x18, 0x8017fcc2           // s2
    li x19, 0x0                  // s3
    li x20, 0x0                  // s4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x11'}, 'clob': {'f3', 'x11', 'x23'}})
...
f3                  0x40d8000000000000(24576.0_d)                   0xffffffff23c1b027(2.0999705348416393e-17_s)    X
STATES DIFFER: True
```
...
tp(x4)              0xfffffffff54ea000(18446744073530155008)        0xfffffffff54ea000(18446744073530155008)        
t0(x5)              0x000000008017fa55(2149055061)                  0x000000008017fa55(2149055061)                  
...
a5(x15)             0x000000008018037c(2149057404)                  0x000000008018037c(2149057404)                  
...
s8(x24)             0x000000000ab15b50(179395408)                   0x000000000ab15b50(179395408)                   
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c63a744841fe2d9de623bf0bc9829660d3c97981        c63a744841fe2d9de623bf0bc9829660d3c97981        
