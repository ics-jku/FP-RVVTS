# FailID_004545 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x5, 0x6000                // t0
    li x6, 0x80000720            // t1
    li x7, 0xffffffff7ffe4d3c    // t2
    li x8, 0xffffffffca345000    // fp
    li x9, 0x8000057d            // s1
    li x10, 0x0                  // a0
    li x11, 0x8                  // a1
    li x12, 0x0                  // a2
    ...
    li x25, 0x2                  // s9
    li x26, 0x6000               // s10
    li x27, 0x7fffff12           // s11
    li x28, 0x80005f12           // t3
    li x29, 0x80000309           // t4
    li x30, 0x8001b156           // t5
    li x31, 0x80280292           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'x15'}, 'clob': {'x15', 'x4'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        914e6ff9353c02a062845840f15d297ab0347d43        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x5, e4, x15
t0(x5)              0x0000000000006000(24576)                       0x0000000000006000(24576)
a5(x15)             0x00000000802088e4(2149615844)                  0x00000000802088e4(2149615844)
...
tp(x4)              0x000000008017fa1c(2149055004)                  0x000000008017fa1c(2149055004)                  
t0(x5)              0x0000000000006000(24576)                       0x0000000000006000(24576)                       
t1(x6)              0x0000000080000720(2147485472)                  0x0000000080000720(2147485472)                  
t2(x7)              0xffffffff7ffe4d3c(18446744071561956668)        0xffffffff7ffe4d3c(18446744071561956668)        
fp(x8)              0xffffffffca345000(18446744072807010304)        0xffffffffca345000(18446744072807010304)        
...
s11(x27)            0x000000007fffff12(2147483410)                  0x000000007fffff12(2147483410)                  
t3(x28)             0x0000000080005f12(2147507986)                  0x0000000080005f12(2147507986)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2ec4c0b62f2c517af4269070cbc3e11039ccfdf2        2ec4c0b62f2c517af4269070cbc3e11039ccfdf2        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        914e6ff9353c02a062845840f15d297ab0347d43        X
