# FailID_001259 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x80200411           // s10
    li x27, 0x6000               // s11
    li x28, 0x0                  // t3
    li x29, 0xa1                 // t4
    li x30, 0x7ffffd9f           // t5
    li x31, 0x8017fe9d           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'x4', 'f7', 'x14'}})
...
f7                  0x6dc46c3d1ad2e65c(5.767429313112931e+220_d)    0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x0000000080000484(2147484804)                  0x0000000080000484(2147484804)                  
tp(x4)              0x0000000080000cf0(2147486960)                  0x0000000080000cf0(2147486960)                  
...
a4(x14)             0x00000000800002cc(2147484364)                  0x00000000800002cc(2147484364)                  
...
s10(x26)            0x0000000080200411(2149581841)                  0x0000000080200411(2149581841)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            df5095bfce37ab8008cde1ff16d6f5b7fd651258        df5095bfce37ab8008cde1ff16d6f5b7fd651258        
