# FailID_001786 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x24, 0x7ffffaa8           // s8
    li x25, 0x224                // s9
    li x26, 0x0                  // s10
    li x27, 0x7ffffda0           // s11
    li x28, 0x8017fa25           // t3
    li x29, 0x6000               // t4
    li x30, 0x8018073f           // t5
    li x31, 0xfd                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f31', 'x19'}, 'clob': {'x19', 'x21'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7566a72ae6340b35a5f098175635c6dc22f446a7        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x42, x19
s3(x19)             0x000000008018642c(2149082156)                  0x000000008018642c(2149082156)
...
ra(x1)              0x0000000080079da0(2147982752)                  0x0000000080079da0(2147982752)                  
...
s11(x27)            0x000000007ffffda0(2147483040)                  0x000000007ffffda0(2147483040)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4ead09b6e5aab183c611cd262106a922b579dbe4        4ead09b6e5aab183c611cd262106a922b579dbe4        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7566a72ae6340b35a5f098175635c6dc22f446a7        X
