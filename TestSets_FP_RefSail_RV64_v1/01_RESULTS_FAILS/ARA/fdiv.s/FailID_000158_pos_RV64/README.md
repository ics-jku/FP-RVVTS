# FailID_000158 ARA pos RV64 fdiv.s
...
_reg_f15:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_reg_f22:.byte 0xff,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f15'}})
    fdiv.s f15, f8, f22, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f8, f22, rmm
+========================================================================================================================+
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f8, f22
f8                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f22                 0xffffffff4effffff(2147483520.0_s)              0xffffffff4effffff(2147483520.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            687cc9c75fcd8f10580d6b0892edd50785914770        687cc9c75fcd8f10580d6b0892edd50785914770        
