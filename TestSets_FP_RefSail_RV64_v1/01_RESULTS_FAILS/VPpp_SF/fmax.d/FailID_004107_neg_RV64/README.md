# FailID_004107 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'f17', 'fcsr.rm'}, 'clob': {'f14'}})
    fmax.d f14, f18, f17
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x0000000000000000(0.0_d)                       0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f14, f18, f17
+========================================================================================================================+
Attributes:  special values ['nan', 'zero'], precision mismatch ('d', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8db90361497f73e48bb65e8f8f253e336b8d9ac3        8db90361497f73e48bb65e8f8f253e336b8d9ac3        
