# FailID_000274 ARA pos RV64 fsqrt.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0x60,0x3b,0x00,0x05,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f31'}})
    fsqrt.d f31, f23, rup
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0x40e6a4276289d2dd(46369.23077861008_d)         0x40e6a4276289d2dc(46369.23077861007_d)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f31, f23, rup
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f23
f23                 0x41e005003b600000(2150105563.0_d)              0x41e005003b600000(2150105563.0_d)
f31                 0x40e6a4276289d2dd(46369.23077861008_d)         0x40e6a4276289d2dc(46369.23077861007_d)         X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            93580b154233438102b7efe4dc5ced7bb860fd6c        93580b154233438102b7efe4dc5ced7bb860fd6c        
