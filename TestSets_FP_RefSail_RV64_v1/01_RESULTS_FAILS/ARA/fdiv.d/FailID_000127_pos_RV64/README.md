# FailID_000127 ARA pos RV64 fdiv.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x79,0x07,0x18,0x80,0x00,0x00,0x00,0x00
_reg_f10:.byte 0x07,0x3c,0x43,0x4f,0xff,0xff,0xff,0xff
_reg_f14:.byte 0x00,0x00,0x00,0x00,0x00,0x08,0x9c,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'f14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fdiv.d f10, f8, f14, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x000000000012475a(5.91848e-318_d)              0x000000000012475b(5.918486e-318_d)             X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.d f10, f8, f14, rdn
+========================================================================================================================+
Attributes:  fcsr ['underflow', 'inexact']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f10                 0x000000000012475a(5.91848e-318_d)              0x000000000012475b(5.918486e-318_d)             X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f8, f14
f8                  0x0000000080180779(1.0617759387e-314_d)         0x0000000080180779(1.0617759387e-314_d)
f10                 0x000000000012475a(5.91848e-318_d)              0x000000000012475b(5.918486e-318_d)             X
f14                 0x409c080000000000(1794.0_d)                    0x409c080000000000(1794.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bffb03e33ef30459bdc4d968dad5549cf97d4e45        bffb03e33ef30459bdc4d968dad5549cf97d4e45        
...
fcsr                0x0000000000000003(3)                           0x0000000000000003(3)                           
 fcsr.nx            True                                            True                                            
 fcsr.uf            True                                            True                                            
 fcsr.of            False                                           False                                           
 fcsr.dz            False                                           False                                           
