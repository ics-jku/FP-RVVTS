# FailID_004419 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x8000028e            // fp
    li x9, 0x13                  // s1
    li x10, 0x7ffffd20           // a0
    li x11, 0x8027f3ff           // a1
    li x12, 0x80180b15           // a2
    li x13, 0x8017f916           // a3
    li x14, 0x8017f916           // a4
    li x15, 0x1                  // a5
    li x16, 0x0                  // a6
    ...
    li x28, 0x1                  // t3
    li x29, 0x801802d5           // t4
    li x30, 0x7                  // t5
    li x31, 0x8027ed08           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm', 'f13'}, 'clob': {'x11', 'x24'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        01c933794769d0aa594d939a889944a1b97e9613        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x2, e0, x24
sp(x2)              0x000000007ffff846(2147481670)                  0x000000007ffff846(2147481670)
s8(x24)             0x00000000802001f0(2149581296)                  0x00000000802001f0(2149581296)
...
t1(x6)              0x000000007ffffcf0(2147482864)                  0x000000007ffffcf0(2147482864)                  
t2(x7)              0x000000007fffface(2147482318)                  0x000000007fffface(2147482318)                  
fp(x8)              0x000000008000028e(2147484302)                  0x000000008000028e(2147484302)                  
s1(x9)              0x0000000000000013(19)                          0x0000000000000013(19)                          
a0(x10)             0x000000007ffffd20(2147482912)                  0x000000007ffffd20(2147482912)                  
a1(x11)             0x00000000801802e0(2149057248)                  0x00000000801802e0(2149057248)                  
a2(x12)             0x0000000080180b15(2149059349)                  0x0000000080180b15(2149059349)                  
a3(x13)             0x000000008017f916(2149054742)                  0x000000008017f916(2149054742)                  
a4(x14)             0x000000008017f916(2149054742)                  0x000000008017f916(2149054742)                  
...
s6(x22)             0x00000000800007b1(2147485617)                  0x00000000800007b1(2147485617)                  
...
t4(x29)             0x00000000801802d5(2149057237)                  0x00000000801802d5(2149057237)                  
t5(x30)             0x0000000000000007(7)                           0x0000000000000007(7)                           
t6(x31)             0x000000008027ed08(2150100232)                  0x000000008027ed08(2150100232)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            23c544e9d3a7453a3e72bf35976898f706b220f1        23c544e9d3a7453a3e72bf35976898f706b220f1        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        01c933794769d0aa594d939a889944a1b97e9613        X
