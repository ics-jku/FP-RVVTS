# FailID_002508 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f23', 'mstatus.fs/vs.fs', 'x10'}, 'clob': {'x10', 'x1'}})
...
ra(x1)              0x00000000801803f2(2149057522)                  0x00000000801803f2(2149057522)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f770b500680a13d369231db9a914a717b05ea858        f770b500680a13d369231db9a914a717b05ea858        
