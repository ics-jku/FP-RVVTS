# FailID_000176 ARA pos RV64 fdiv.s
...
_reg_f29:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f28'}})
    fdiv.s f28, f29, f15, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f28, f29, f15, rtz
+========================================================================================================================+
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f29, f15
f15                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f28                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f29                 0xffffffffbf800000(-1.0_s)                      0xffffffffbf800000(-1.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1854c7f786030e20246d7995fcfb3241491a878        c1854c7f786030e20246d7995fcfb3241491a878        
