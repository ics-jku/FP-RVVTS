# FailID_005257 VP++ SF pos RV64 fmax.s
...
_reg_f20:.byte 0xaa,0xc7,0x6e,0xae,0x4d,0xde,0x28,0x6b
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f20'}})
    fmax.s f20, f9, f4
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9e9442756cc167969efd4ada1d631e6d808c2687        9e9442756cc167969efd4ada1d631e6d808c2687        
