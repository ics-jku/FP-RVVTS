# FailID_002553 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x05,0xd0,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x16'}})
    fcvt.wu.d x16, f14, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a6(x16)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x16, f14, rne
+========================================================================================================================+
...
Registers: x16, f14
a6(x16)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f14                 0xffffffffceffd005(-2145911424.0_s)             0xffffffffceffd005(-2145911424.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            744fa4f7e608150676809760d1bec76e34c2c373        744fa4f7e608150676809760d1bec76e34c2c373        
