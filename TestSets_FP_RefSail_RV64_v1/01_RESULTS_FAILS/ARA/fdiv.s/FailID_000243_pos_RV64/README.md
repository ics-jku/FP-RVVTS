# FailID_000243 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x80,0xee,0x1d,0x4e,0xff,0xff,0xff,0xff
_reg_f18:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f22:.byte 0x00,0x00,0x40,0x4f,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f18'}})
    fdiv.s f18, f22, f12, rmm
```
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff409b9c93(4.862863063812256_s)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f18, f22, f12, rmm
+========================================================================================================================+
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff409b9c93(4.862863063812256_s)         X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f22, f12
f12                 0xffffffff4e1dee80(662413312.0_s)               0xffffffff4e1dee80(662413312.0_s)
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff409b9c93(4.862863063812256_s)         X
f22                 0x41e002ff4f400000(2149055098.0_d)              0x41e002ff4f400000(2149055098.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            836bef6d9e67e3a73efea5357876e6b6f7bd5cf7        836bef6d9e67e3a73efea5357876e6b6f7bd5cf7        
