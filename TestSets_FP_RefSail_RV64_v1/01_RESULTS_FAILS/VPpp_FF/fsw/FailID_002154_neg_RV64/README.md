# FailID_002154 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x14, 0x8027f215           // a4
    li x15, 0xffffffffffff91f3   // a5
    li x16, 0x0                  // a6
    li x17, 0x801e3a52           // a7
    li x18, 0x8017f941           // s2
    li x19, 0x0                  // s3
    li x20, 0x801aa689           // s4
    li x21, 0x0                  // s5
    li x22, 0x7f                 // s6
    li x23, 0x8017fb51           // s7
    li x24, 0xfffffffffffff945   // s8
    li x25, 0x8017fb51           // s9
    ...
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x21', 'f17'}, 'clob': {'x12', 'x21'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        f8552378ef24b66411a81f3ce269c6d01dbd3618        X
...
t1(x6)              0x000000008017fa05(2149054981)                  0x000000008017fa05(2149054981)                  
...
a2(x12)             0x000000008017fbea(2149055466)                  0x000000008017fbea(2149055466)                  
...
s4(x20)             0x00000000801aa689(2149230217)                  0x00000000801aa689(2149230217)                  
s5(x21)             0x000000008017fbea(2149055466)                  0x000000008017fbea(2149055466)                  
s6(x22)             0x000000000000007f(127)                         0x000000000000007f(127)                         
s7(x23)             0x000000008017fb51(2149055313)                  0x000000008017fb51(2149055313)                  
s8(x24)             0xfffffffffffff945(18446744073709549893)        0xfffffffffffff945(18446744073709549893)        
s9(x25)             0x000000008017fb51(2149055313)                  0x000000008017fb51(2149055313)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ff71dd414a07013714aeb46360a04e7ef9fbfed0        ff71dd414a07013714aeb46360a04e7ef9fbfed0        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        f8552378ef24b66411a81f3ce269c6d01dbd3618        X
