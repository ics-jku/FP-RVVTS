# FailID_000661 VP++ FF neg RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f5'}, 'clob': {'x16'}})
    fcvt.wu.s x16, f5, dyn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a6(x16)             0xffffffff80180200(18446744071563641344)        0x0000000080180200(2149057024)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x16, f5, dyn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c51f3861fcf9543c172dcb4c2de20e419df78f12        c51f3861fcf9543c172dcb4c2de20e419df78f12        
