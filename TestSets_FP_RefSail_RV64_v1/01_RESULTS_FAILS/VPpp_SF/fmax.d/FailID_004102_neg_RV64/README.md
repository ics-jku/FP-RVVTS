# FailID_004102 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f6', 'fcsr.rm'}, 'clob': {'f16'}})
    fmax.d f16, f10, f6
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x131ba7b8fdb2abbe(1.253485769659883e-216_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            051af15484c4e00c34f5187b9bf092272f8c5990        051af15484c4e00c34f5187b9bf092272f8c5990        
