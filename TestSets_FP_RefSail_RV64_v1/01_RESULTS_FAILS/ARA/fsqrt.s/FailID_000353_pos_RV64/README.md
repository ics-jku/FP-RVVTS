# FailID_000353 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x82,0x42,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x40,0x83,0xdb,0xc0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f7'}})
    fsqrt.s f7, f25, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f7, f25, rmm
+========================================================================================================================+
...
Registers: f7, f25
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f25                 0xc0db834000000000(-28173.0_d)                  0xc0db834000000000(-28173.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            25c1248c56c82717d9062d778c66f0188488f005        25c1248c56c82717d9062d778c66f0188488f005        
