# FailID_005336 VP++ SF pos RV64 fmin.d
...
_reg_f21:.byte 0x00,0x00,0x00,0x00,0x60,0x3e,0xe2,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f29'}})
    fmin.d f29, f21, f13
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x40e23e6000000000(37363.0_d)                   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f29, f21, f13
+========================================================================================================================+
...
f29                 0x40e23e6000000000(37363.0_d)                   0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f21, f13
f13                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f21                 0x40e23e6000000000(37363.0_d)                   0x40e23e6000000000(37363.0_d)
f29                 0x40e23e6000000000(37363.0_d)                   0x7ff8000000000000(nan_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            133eb0f4597cc65fad778efab99bb797a897d5c7        133eb0f4597cc65fad778efab99bb797a897d5c7        
