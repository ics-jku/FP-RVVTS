# FailID_000239 ARA pos RV64 fdiv.s
...
_reg_f10:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f19', 'f10'}, 'clob': {'f8'}})
    fdiv.s f8, f10, f19, rtz
```
...
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f8, f10, f19, rtz
+========================================================================================================================+
...
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, f10, f19
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f10                 0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            246e4ffdbb888c91e989ac32a8a88fa421f9fe9f        246e4ffdbb888c91e989ac32a8a88fa421f9fe9f        
