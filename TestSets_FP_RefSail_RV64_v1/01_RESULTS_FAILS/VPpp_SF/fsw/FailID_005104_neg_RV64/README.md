# FailID_005104 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x12, 0x8017fc92           // a2
    li x13, 0x801fde11           // a3
    li x14, 0x10                 // a4
    li x15, 0x8017fde8           // a5
    li x16, 0x5d778e34429e80e1   // a6
    li x17, 0x199c6ae39c         // a7
    li x18, 0x0                  // s2
    li x19, 0x6df1f91c5cfef423   // s3
    li x20, 0x802738f8           // s4
    li x21, 0xfc                 // s5
    li x22, 0x7ffffd68           // s6
    li x23, 0xa4d3b4097b7fff7    // s7
    li x24, 0xa4d3b4017a62f92    // s8
    li x25, 0x8021d0b7           // s9
    li x26, 0x80280218           // s10
    li x27, 0x80185c92           // s11
    li x28, 0x0                  // t3
    li x29, 0x8017ffdc           // t4
    li x30, 0x934ed005e98be480   // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'x3'}, 'clob': {'x11', 'x3'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        8f791def54a076882f14cb2f3ec19aadd926fa57        X
...
a2(x12)             0x000000008017fc92(2149055634)                  0x000000008017fc92(2149055634)                  
a3(x13)             0x00000000801fde11(2149572113)                  0x00000000801fde11(2149572113)                  
a4(x14)             0x0000000000000010(16)                          0x0000000000000010(16)                          
a5(x15)             0x000000008017fde8(2149055976)                  0x000000008017fde8(2149055976)                  
...
s3(x19)             0x6df1f91c5cfef423(7922387119736026147)         0x6df1f91c5cfef423(7922387119736026147)         
s4(x20)             0x00000000802738f8(2150054136)                  0x00000000802738f8(2150054136)                  
...
s10(x26)            0x0000000080280218(2150105624)                  0x0000000080280218(2150105624)                  
s11(x27)            0x0000000080185c92(2149080210)                  0x0000000080185c92(2149080210)                  
t3(x28)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t4(x29)             0x000000008017ffdc(2149056476)                  0x000000008017ffdc(2149056476)                  
t5(x30)             0x934ed005e98be480(10614650095570510976)        0x934ed005e98be480(10614650095570510976)        
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            5cef6f3f70756d045d849c0899027937ba276708        5cef6f3f70756d045d849c0899027937ba276708        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        8f791def54a076882f14cb2f3ec19aadd926fa57        X
