# FailID_000492 ARA pos RV64 fsqrt.s
...
_reg_f28:.byte 0x00,0x00,0xc0,0x43,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f20
    fld  f20, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f28', 'mstatus.fs/vs.fs'}, 'clob': {'f20'}})
    fsqrt.s f20, f28, dyn
```
...
f20                 0xffffffff7fc00000(nan_s)                       0xffffffff419cc471(19.595918655395508_s)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f20, f28, dyn
+========================================================================================================================+
...
Registers: f20, f28
f20                 0xffffffff7fc00000(nan_s)                       0xffffffff419cc471(19.595918655395508_s)        X
f28                 0x41e0000043c00000(2147484190.0_d)              0x41e0000043c00000(2147484190.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b41674b9ac024ffb73f74282abde7c331651c447        b41674b9ac024ffb73f74282abde7c331651c447        
