# FailID_000181 ARA pos RV64 fdiv.s
...
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f12'}})
    fdiv.s f12, f24, f22
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f12, f24, f22
+========================================================================================================================+
...
fcsr                0x0000000000000000(0)                           0x0000000000000010(16)                          X
 fcsr.nv            False                                           True                                            X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f24, f22
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f22                 0xfff8000000000000(nan_d)                       0xfff8000000000000(nan_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9124efce0c531d6d8209b1913c280e6a8745e84a        9124efce0c531d6d8209b1913c280e6a8745e84a        
