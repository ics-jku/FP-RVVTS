# FailID_005448 VP++ SF pos RV64 fmin.s
...
_reg_f12:.byte 0x06,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f21:.byte 0x06,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f12'}})
    fmin.s f12, f21, f6
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f12                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f21, f6
f6                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f12                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
f21                 0xffffffff4f000006(2147485184.0_s)              0xffffffff4f000006(2147485184.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            82685bc17c7f76738b6a946efd12273dbe4530d4        82685bc17c7f76738b6a946efd12273dbe4530d4        
