# FailID_001123 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x28, 0x8017fb87           // t3
    li x29, 0x4000035b           // t4
    li x30, 0x8017f8f6           // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x10'}, 'clob': {'x10', 'f30', 'x28'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dd3649b0253f70bb51a4f97f138245d56f005659        dd3649b0253f70bb51a4f97f138245d56f005659        
