# FailID_001063 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x80180d51           // s11
    li x28, 0x801809df           // t3
    li x29, 0x7ffffd1f           // t4
    li x30, 0x200                // t5
    li x31, 0x7ffffa37           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27'}, 'clob': {'x19', 'x27', 'f18'}})
...
f18                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            94bcd6af507150ab379dbb47e668d0e3dd4bd441        94bcd6af507150ab379dbb47e668d0e3dd4bd441        
