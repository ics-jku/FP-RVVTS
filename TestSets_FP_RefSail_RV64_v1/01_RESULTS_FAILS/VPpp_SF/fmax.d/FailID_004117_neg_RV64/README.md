# FailID_004117 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f12', 'fcsr.rm', 'f25'}, 'clob': {'f27'}})
    fmax.d f27, f12, f25
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0x40d8000000000000(24576.0_d)                   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f27, f12, f25
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8c44ff4f51a9dbbaf815fdfef5a7843c57802deb        8c44ff4f51a9dbbaf815fdfef5a7843c57802deb        
