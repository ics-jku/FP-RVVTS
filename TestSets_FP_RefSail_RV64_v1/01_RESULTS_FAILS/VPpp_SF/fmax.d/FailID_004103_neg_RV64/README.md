# FailID_004103 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f16', 'f11'}, 'clob': {'f19'}})
    fmax.d f19, f16, f11
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x131ba7b8fdb2abbe(1.253485769659883e-216_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f19, f16, f11
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1ef0cc3cc56a3ac23047daf967dac9630e8f060e        1ef0cc3cc56a3ac23047daf967dac9630e8f060e        
