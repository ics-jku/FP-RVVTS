# FailID_000486 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x04,0x05,0x00,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f2'}})
    fsqrt.s f2, f27, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f2, f27, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e4962605a6a26286b8b8660ccb269ff1d42d6cd6        e4962605a6a26286b8b8660ccb269ff1d42d6cd6        
