# FailID_005357 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f4'}, 'clob': {'f22'}})
    fmin.d f22, f4, f6
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x000000007fffff5a(1.0609978135e-314_d)         0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e759c7d3d4b6ba13475c8196a6f38b8e7897f276        e759c7d3d4b6ba13475c8196a6f38b8e7897f276        
