# FailID_005494 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x08,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f8'}, 'clob': {'f12'}})
    fmin.s f12, f8, f13
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff4f001808(2149058560.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f12                 0xffffffff4f001808(2149058560.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f8, f13
f8                  0xffffffff4f001808(2149058560.0_s)              0xffffffff4f001808(2149058560.0_s)
f12                 0xffffffff4f001808(2149058560.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            19e7803194069f36b41855ca0a755c9382cec2da        19e7803194069f36b41855ca0a755c9382cec2da        
