# FailID_004111 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'f0', 'fcsr.rm'}, 'clob': {'f3'}})
    fmax.d f3, f0, f6
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xe505ad8fe9e34748(-4.3922414005583935e+178_d)  0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dedb48174d3d1d91e49bc3c8151553ab0ead3fe9        dedb48174d3d1d91e49bc3c8151553ab0ead3fe9        
