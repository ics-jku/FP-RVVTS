# FailID_005341 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f29'}, 'clob': {'f11'}})
    fmin.d f11, f29, f18
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x000000008017fec7(1.061774839e-314_d)          0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f11, f29, f18
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            12d45b2f98f35bca34ccf2a06e43a3de8329b0ba        12d45b2f98f35bca34ccf2a06e43a3de8329b0ba        
