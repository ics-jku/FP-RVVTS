# FailID_002908 VP++ FF pos RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.s x9, f8, dyn
```
...
```
REG                 REF                                             DUT                                             DIFF
s1(x9)              0xffffffff80180400(18446744071563641856)        0x0000000080180400(2149057536)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x9, f8, dyn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cdd5786b8e313d4b14aae1338e5cd66fdca32e3c        cdd5786b8e313d4b14aae1338e5cd66fdca32e3c        
