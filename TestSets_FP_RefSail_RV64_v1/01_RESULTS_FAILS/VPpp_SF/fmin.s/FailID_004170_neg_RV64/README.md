# FailID_004170 VP++ SF neg RV64 fmin.s
...
_reg_f28:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f28'}, 'clob': {'f14'}})
    fmin.s f14, f28, f0
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            70b7a352131212be95e92f8bcb318caa80176b4f        70b7a352131212be95e92f8bcb318caa80176b4f        
