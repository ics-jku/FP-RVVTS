# FailID_003718 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x1                  // s10
    li x27, 0x6000               // s11
    li x28, 0x80000220           // t3
    li x29, 0x801ffb8e           // t4
    li x30, 0x8017fca3           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'f31', 'x27', 'x6'}})
...
f31                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            222e6fb2000b499f597c565dee3acec9e07b4323        222e6fb2000b499f597c565dee3acec9e07b4323        
