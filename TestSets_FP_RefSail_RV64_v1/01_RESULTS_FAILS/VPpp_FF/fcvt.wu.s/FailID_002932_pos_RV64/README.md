# FailID_002932 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f15:.byte 0x00,0x00,0x80,0xf9,0x0c,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'x30'}})
    fcvt.wu.s x30, f15, dyn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t5(x30)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x30, f15, dyn
+========================================================================================================================+
...
Registers: x30, f15
t5(x30)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f15                 0x41e0030cf9800000(2149083084.0_d)              0x41e0030cf9800000(2149083084.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            477a816f4646470df30f5425da8ad2f1616e389f        477a816f4646470df30f5425da8ad2f1616e389f        
