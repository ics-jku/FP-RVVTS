# FailID_001046 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x12, 0x800c99c9           // a2
    li x13, 0x8000038e           // a3
    li x14, 0x0                  // a4
    li x15, 0xfffffffffffffbff   // a5
    li x16, 0x6000               // a6
    li x17, 0x8019072a           // a7
    li x18, 0x8017f8aa           // s2
    li x19, 0x1                  // s3
    ...
    li x27, 0x1                  // s11
    li x28, 0x1                  // t3
    li x29, 0x1a00000000000000   // t4
    li x30, 0x8018041f           // t5
    li x31, 0x80000549           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x24'}, 'clob': {'x24', 'f31', 'x23'}})
...
f31                 0x0cd03364da5acaa7(5.792671351716269e-247_d)    0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fld f31, -0x60f(x24)
+========================================================================================================================+
Attributes:  fcsr ['overflow', 'div-by-0', 'inexact'], special values ['zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f31                 0x0cd03364da5acaa7(5.792671351716269e-247_d)    0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x60, x24
s8(x24)             0x00000000801806d7(2149058263)                  0x00000000801806d7(2149058263)
f31                 0x0cd03364da5acaa7(5.792671351716269e-247_d)    0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
ra(x1)              0x00000000801ff8f9(2149579001)                  0x00000000801ff8f9(2149579001)                  
sp(x2)              0x000000007ffffe5b(2147483227)                  0x000000007ffffe5b(2147483227)                  
...
t1(x6)              0x0000000080180574(2149057908)                  0x0000000080180574(2149057908)                  
t2(x7)              0x00000000801801ac(2149056940)                  0x00000000801801ac(2149056940)                  
fp(x8)              0x00000000802005ba(2149582266)                  0x00000000802005ba(2149582266)                  
...
a2(x12)             0x00000000800c99c9(2148309449)                  0x00000000800c99c9(2148309449)                  
...
a7(x17)             0x000000008019072a(2149123882)                  0x000000008019072a(2149123882)                  
s2(x18)             0x000000008017f8aa(2149054634)                  0x000000008017f8aa(2149054634)                  
...
s7(x23)             0x000000008000060f(2147485199)                  0x000000008000060f(2147485199)                  
s8(x24)             0x00000000801806d7(2149058263)                  0x00000000801806d7(2149058263)                  
...
t4(x29)             0x1a00000000000000(1873497444986126336)         0x1a00000000000000(1873497444986126336)         
t5(x30)             0x000000008018041f(2149057567)                  0x000000008018041f(2149057567)                  
t6(x31)             0x0000000080000549(2147485001)                  0x0000000080000549(2147485001)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            966735a09b16c52648b8cc276e9c56f332a6d63b        966735a09b16c52648b8cc276e9c56f332a6d63b        
