# FailID_000905 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x3'}, 'clob': {'x11', 'f26', 'x3'}})
...
```
+========================================================================================================================+
Instruction: fld f26, -0x7eb(x3)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'div-by-0'], special values ['nan', 'zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, x7, x3
gp(x3)              0x000000008018099b(2149058971)                  0x000000008018099b(2149058971)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            902ea58b367bd72d96f6912816bbfd21320e0452        902ea58b367bd72d96f6912816bbfd21320e0452        
