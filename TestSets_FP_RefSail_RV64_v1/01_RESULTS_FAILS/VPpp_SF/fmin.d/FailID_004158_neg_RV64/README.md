# FailID_004158 VP++ SF neg RV64 fmin.d
...
_reg_f12:.byte 0x00,0x00,0x00,0x00,0x00,0xf0,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'f12'}, 'clob': {'f3'}})
    fmin.d f3, f12, f29
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x41dff00000000000(2143289344.0_d)              0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
f3                  0x41dff00000000000(2143289344.0_d)              0xffffffffffff7e00(nan_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, f12, f29
f3                  0x41dff00000000000(2143289344.0_d)              0xffffffffffff7e00(nan_h)                       X
f12                 0x41dff00000000000(2143289344.0_d)              0x41dff00000000000(2143289344.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5b68de30c97f0218de59a39cfdc170a08ec11653        5b68de30c97f0218de59a39cfdc170a08ec11653        
