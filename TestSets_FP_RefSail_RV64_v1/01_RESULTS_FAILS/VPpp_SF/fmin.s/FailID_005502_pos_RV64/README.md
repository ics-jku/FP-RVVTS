# FailID_005502 VP++ SF pos RV64 fmin.s
...
_reg_f19:.byte 0xfa,0x04,0x18,0x80,0xff,0xff,0xff,0xff
_reg_f26:.byte 0x83,0xb2,0x01,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f26'}})
    fmin.s f26, f19, f7
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff801804fa(-2.205837162035339e-39_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f26                 0xffffffff801804fa(-2.205837162035339e-39_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f19, f7
f7                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f19                 0xffffffff801804fa(-2.205837162035339e-39_s)    0xffffffff801804fa(-2.205837162035339e-39_s)
f26                 0xffffffff801804fa(-2.205837162035339e-39_s)    0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            361700b637d8c42c1b021811448cc28fa08de866        361700b637d8c42c1b021811448cc28fa08de866        
