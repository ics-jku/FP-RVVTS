# FailID_005202 VP++ SF pos RV64 fmax.d
...
_reg_f23:.byte 0x3c,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f31:.byte 0x97,0x02,0x00,0x00,0x93,0x82,0x02,0xef
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f31'}, 'clob': {'f14'}})
    fmax.d f14, f31, f23
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xef02829300000297(-5.481185172736651e+226_d)   0xffffffff4f00003c(2147499008.0_s)              X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f14, f31, f23
+========================================================================================================================+
...
f14                 0xef02829300000297(-5.481185172736651e+226_d)   0xffffffff4f00003c(2147499008.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f31, f23
f14                 0xef02829300000297(-5.481185172736651e+226_d)   0xffffffff4f00003c(2147499008.0_s)              X
f23                 0xffffffff4f00003c(2147499008.0_s)              0xffffffff4f00003c(2147499008.0_s)
f31                 0xef02829300000297(-5.481185172736651e+226_d)   0xef02829300000297(-5.481185172736651e+226_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            efbc84a7533af2e20a0f6af0c92d480ce31a4004        efbc84a7533af2e20a0f6af0c92d480ce31a4004        
