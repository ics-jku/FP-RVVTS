# FailID_000372 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f8'}})
    fsqrt.s f8, f30
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff3a000000(0.00048828125_s)             X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            58850ef9e087c34fdcebdd173d3c3d248638fa74        58850ef9e087c34fdcebdd173d3c3d248638fa74        
