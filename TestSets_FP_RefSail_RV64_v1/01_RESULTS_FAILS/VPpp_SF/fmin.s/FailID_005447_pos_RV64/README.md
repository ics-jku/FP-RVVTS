# FailID_005447 VP++ SF pos RV64 fmin.s
...
_reg_f4: .byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f4'}, 'clob': {'f7'}})
    fmin.s f7, f4, f3
```
...
f4                  0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
f7                  0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            554fa35bd6bf0e66ad12cd5fc50b3d04008a5b6c        554fa35bd6bf0e66ad12cd5fc50b3d04008a5b6c        
