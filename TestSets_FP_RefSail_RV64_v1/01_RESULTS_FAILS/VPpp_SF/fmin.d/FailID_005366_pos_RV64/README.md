# FailID_005366 VP++ SF pos RV64 fmin.d
...
_reg_f27:.byte 0x00,0x00,0xc0,0xfc,0xfd,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f19'}})
    fmin.d f19, f27, f14
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xc1dffffdfcc00000(-2147481587.0_d)             0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f19, f27, f14
+========================================================================================================================+
...
f19                 0xc1dffffdfcc00000(-2147481587.0_d)             0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f27, f14
f14                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f19                 0xc1dffffdfcc00000(-2147481587.0_d)             0xffffffff00000000(0.0_s)                       X
f27                 0xc1dffffdfcc00000(-2147481587.0_d)             0xc1dffffdfcc00000(-2147481587.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b5cd538b76be819f621280d274ec51c8629757e0        b5cd538b76be819f621280d274ec51c8629757e0        
