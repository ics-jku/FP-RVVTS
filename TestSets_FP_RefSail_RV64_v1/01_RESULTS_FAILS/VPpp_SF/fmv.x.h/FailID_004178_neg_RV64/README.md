# FailID_004178 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f7'}, 'clob': {'x2'}})
    fmv.x.h x2, f7
```
...
```
REG                 REF                                             DUT                                             DIFF
sp(x2)              0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9d3824d6ee67fbf8d6581b8d3e4161c0123b3515        9d3824d6ee67fbf8d6581b8d3e4161c0123b3515        
