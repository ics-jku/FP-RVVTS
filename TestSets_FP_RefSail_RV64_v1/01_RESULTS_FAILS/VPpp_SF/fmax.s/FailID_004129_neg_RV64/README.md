# FailID_004129 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'f5'}, 'clob': {'f0'}})
    fmax.s f0, f5, f29
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff4f001802(2149057024.0_s)              0xffffffff7ffff9ac(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            954f5e7bc8c9ec4ae926229a5d22928cdb0ea9cd        954f5e7bc8c9ec4ae926229a5d22928cdb0ea9cd        
