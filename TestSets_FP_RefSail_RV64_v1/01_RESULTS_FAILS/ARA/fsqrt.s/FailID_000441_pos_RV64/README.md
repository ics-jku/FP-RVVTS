# FailID_000441 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x00,0x00,0x00,0x40,0xff,0xff,0xff,0xff
_reg_f15:.byte 0x00,0x00,0x00,0x00,0x00,0x80,0x4c,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f14'}})
    fsqrt.s f14, f15
```
...
Registers: f14, f15
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f15                 0x404c800000000000(57.0_d)                      0x404c800000000000(57.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5ac21d5ff64714216e831f50cbb3edaa9a99700d        5ac21d5ff64714216e831f50cbb3edaa9a99700d        
