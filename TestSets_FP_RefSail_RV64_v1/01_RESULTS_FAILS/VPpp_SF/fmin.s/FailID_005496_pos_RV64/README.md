# FailID_005496 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f6', 'fcsr.rm'}, 'clob': {'f22'}})
    fmin.s f22, f17, f6
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            66394b42db642caf461c8c9d0cd4a3ddee53658d        66394b42db642caf461c8c9d0cd4a3ddee53658d        
