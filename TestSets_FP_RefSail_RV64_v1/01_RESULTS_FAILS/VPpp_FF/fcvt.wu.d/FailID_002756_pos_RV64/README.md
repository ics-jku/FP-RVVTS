# FailID_002756 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f26', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x25'}})
    fcvt.wu.d x25, f26, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x25, f26, rne
+========================================================================================================================+
Attributes:  fcsr ['invalid'], special values ['nan'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4addab94b03c2cd4bd86fd14d0de1c701718c9d2        4addab94b03c2cd4bd86fd14d0de1c701718c9d2        
