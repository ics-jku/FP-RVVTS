# FailID_000178 ARA pos RV64 fdiv.s
...
_reg_f18:.byte 0x00,0x00,0xc0,0xfc,0xfd,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f18'}})
    fdiv.s f18, f10, f8, rdn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f18, f10, f8, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9319dbbb9e81abafe7958f1fb244bcd2027fbd65        9319dbbb9e81abafe7958f1fb244bcd2027fbd65        
