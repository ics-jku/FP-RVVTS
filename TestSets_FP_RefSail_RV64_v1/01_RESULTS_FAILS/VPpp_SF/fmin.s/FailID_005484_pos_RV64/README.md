# FailID_005484 VP++ SF pos RV64 fmin.s
...
_reg_f22:.byte 0x00,0x00,0x00,0x00,0xac,0xf7,0xd1,0x41
_reg_f31:.byte 0x97,0x02,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f31'}, 'clob': {'f22'}})
    fmin.s f22, f31, f10
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f22, f31, f10
+========================================================================================================================+
...
f22                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f31, f10
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f22                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffff7fc00000(nan_s)                       X
f31                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffff00000297(9.290608818473537e-43_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2febab605d1bc82fb5a3e9652ad44c9c5c491db6        2febab605d1bc82fb5a3e9652ad44c9c5c491db6        
