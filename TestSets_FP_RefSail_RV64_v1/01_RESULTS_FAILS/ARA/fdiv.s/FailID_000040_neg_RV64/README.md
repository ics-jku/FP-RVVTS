# FailID_000040 ARA neg RV64 fdiv.s
...
_reg_f15:.byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'f22', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f15'}})
    fdiv.s f15, f2, f22, rne
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f2, f22, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f019b4ce16451c2c3e443f877febd789ed9d27c9        f019b4ce16451c2c3e443f877febd789ed9d27c9        
