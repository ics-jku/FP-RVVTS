# FailID_004085 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x13, 0x8017fbfc           // a3
    li x14, 0x8017fc5d           // a4
    ...
    li x30, 0x8017fa03           // t5
    li x31, 0x8017fbed           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'x30', 'f25', 'x23'}})
...
ra(x1)              0x00000000800000cb(2147483851)                  0x00000000800000cb(2147483851)                  
...
a3(x13)             0x000000008017fbfc(2149055484)                  0x000000008017fbfc(2149055484)                  
a4(x14)             0x000000008017fc5d(2149055581)                  0x000000008017fc5d(2149055581)                  
...
t5(x30)             0x00000000800005ea(2147485162)                  0x00000000800005ea(2147485162)                  
t6(x31)             0x000000008017fbed(2149055469)                  0x000000008017fbed(2149055469)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            27bf07bf11fcdd205d5a3e20923c8f22c8e22f09        27bf07bf11fcdd205d5a3e20923c8f22c8e22f09        
