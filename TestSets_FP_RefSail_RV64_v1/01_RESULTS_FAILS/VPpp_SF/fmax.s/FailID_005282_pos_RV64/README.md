# FailID_005282 VP++ SF pos RV64 fmax.s
...
_reg_f15:.byte 0x00,0x00,0x9a,0x42,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f8'}, 'clob': {'f15'}})
    fmax.s f15, f8, f11
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            49f58e9576cbe938dc7575e5d84cd07c0d5940db        49f58e9576cbe938dc7575e5d84cd07c0d5940db        
