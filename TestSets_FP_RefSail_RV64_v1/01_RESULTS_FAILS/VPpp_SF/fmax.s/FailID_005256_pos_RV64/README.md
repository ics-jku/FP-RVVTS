# FailID_005256 VP++ SF pos RV64 fmax.s
...
_reg_f28:.byte 0xfc,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f11'}})
    fmax.s f11, f28, f13
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff4efffffc(2147483136.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f11, f28, f13
+========================================================================================================================+
...
f11                 0xffffffff4efffffc(2147483136.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f28, f13
f11                 0xffffffff4efffffc(2147483136.0_s)              0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f28                 0xffffffff4efffffc(2147483136.0_s)              0xffffffff4efffffc(2147483136.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1e19b493b165e3254d273ac42effd2f84213fc84        1e19b493b165e3254d273ac42effd2f84213fc84        
