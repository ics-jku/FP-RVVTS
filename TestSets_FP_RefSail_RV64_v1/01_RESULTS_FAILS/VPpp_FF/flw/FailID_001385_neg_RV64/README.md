# FailID_001385 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x21, 0xffffffffda675000   // s5
    li x22, 0x80000241           // s6
    li x23, 0x8000030d           // s7
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x17'}, 'clob': {'x4', 'f7', 'x17'}})
...
f7                  0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
s5(x21)             0xffffffffda675000(18446744073078788096)        0xffffffffda675000(18446744073078788096)        
s6(x22)             0x0000000080000241(2147484225)                  0x0000000080000241(2147484225)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            160477c8be7e305522623c155ca00d2912e514ea        160477c8be7e305522623c155ca00d2912e514ea        
