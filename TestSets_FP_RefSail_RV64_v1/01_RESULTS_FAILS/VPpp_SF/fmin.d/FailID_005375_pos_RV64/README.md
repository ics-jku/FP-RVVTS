# FailID_005375 VP++ SF pos RV64 fmin.d
...
_reg_f12:.byte 0xbf,0xfc,0x17,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f11'}})
    fmin.d f11, f20, f12
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x0000000000000000(0.0_d)                       0xffffffff8017fcbf(-2.2028846261710065e-39_s)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f11, f20, f12
+========================================================================================================================+
...
f11                 0x0000000000000000(0.0_d)                       0xffffffff8017fcbf(-2.2028846261710065e-39_s)   X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f20, f12
f11                 0x0000000000000000(0.0_d)                       0xffffffff8017fcbf(-2.2028846261710065e-39_s)   X
f12                 0xffffffff8017fcbf(-2.2028846261710065e-39_s)   0xffffffff8017fcbf(-2.2028846261710065e-39_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            576fca25870b5a27399cfdddd81c17506d8eb8fc        576fca25870b5a27399cfdddd81c17506d8eb8fc        
