# FailID_005521 VP++ SF pos RV64 fmin.s
...
_reg_f20:.byte 0x00,0x00,0x80,0xa1,0x00,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f23', 'fcsr.rm'}, 'clob': {'f20'}})
    fmin.s f20, f9, f23
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8eebe7b368ec60b62865a04200286fb76c56a1ce        8eebe7b368ec60b62865a04200286fb76c56a1ce        
