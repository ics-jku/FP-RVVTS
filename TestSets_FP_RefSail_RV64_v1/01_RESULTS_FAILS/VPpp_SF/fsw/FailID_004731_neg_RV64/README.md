# FailID_004731 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x11, 0x801b050d           // a1
    li x12, 0x64                 // a2
    li x13, 0x8017fe70           // a3
    li x14, 0x8017f8e0           // a4
    li x15, 0x8017fc62           // a5
    li x16, 0x80005bcd           // a6
    li x17, 0x80000884           // a7
    li x18, 0x0                  // s2
    li x19, 0x80000639           // s3
    li x20, 0x800a53d1           // s4
    li x21, 0x80008b99           // s5
    li x22, 0x48                 // s6
    li x23, 0x8027fb19           // s7
    li x24, 0x80000631           // s8
    li x25, 0xe                  // s9
    li x26, 0x7ffffbcd           // s10
    li x27, 0x8017fd51           // s11
    li x28, 0x8017fd55           // t3
    li x29, 0x166673e017d6f72c   // t4
    li x30, 0x40a0e980           // t5
    li x31, 0x8000062b           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'x25'}, 'clob': {'x27', 'x25'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, x76, x25
s9(x25)             0x000000008017f89e(2149054622)                  0x000000008017f89e(2149054622)
...
tp(x4)              0x0000000080180070(2149056624)                  0x0000000080180070(2149056624)                  
...
fp(x8)              0x0000000000000009(9)                           0x0000000000000009(9)                           
...
a1(x11)             0x00000000801b050d(2149254413)                  0x00000000801b050d(2149254413)                  
a2(x12)             0x0000000000000064(100)                         0x0000000000000064(100)                         
a3(x13)             0x000000008017fe70(2149056112)                  0x000000008017fe70(2149056112)                  
...
a6(x16)             0x0000000080005bcd(2147507149)                  0x0000000080005bcd(2147507149)                  
a7(x17)             0x0000000080000884(2147485828)                  0x0000000080000884(2147485828)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x0000000080000639(2147485241)                  0x0000000080000639(2147485241)                  
s4(x20)             0x00000000800a53d1(2148160465)                  0x00000000800a53d1(2148160465)                  
s5(x21)             0x0000000080008b99(2147519385)                  0x0000000080008b99(2147519385)                  
s6(x22)             0x0000000000000048(72)                          0x0000000000000048(72)                          
s7(x23)             0x000000008027fb19(2150103833)                  0x000000008027fb19(2150103833)                  
s8(x24)             0x0000000080000631(2147485233)                  0x0000000080000631(2147485233)                  
s9(x25)             0x000000008017f89e(2149054622)                  0x000000008017f89e(2149054622)                  
...
t3(x28)             0x000000008017fd55(2149055829)                  0x000000008017fd55(2149055829)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            234cb417f2714ca70f56a354aad35fbba1ae0298        234cb417f2714ca70f56a354aad35fbba1ae0298        
