# FailID_005186 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f20'}, 'clob': {'f2'}})
    fmax.d f2, f20, f21
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x0000000000000000(0.0_d)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9b8f03fbc51c0cb40bf9ea113ea4313b68951190        9b8f03fbc51c0cb40bf9ea113ea4313b68951190        
