# FailID_005191 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f25'}})
    fmax.d f25, f15, f21
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f25, f15, f21
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            79da8bf13f0130043fa6fa1f3276bf694ba5c4b0        79da8bf13f0130043fa6fa1f3276bf694ba5c4b0        
