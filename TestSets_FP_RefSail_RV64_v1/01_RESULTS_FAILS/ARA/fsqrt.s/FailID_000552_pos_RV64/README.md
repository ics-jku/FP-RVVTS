# FailID_000552 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xd8,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f5'}})
    fsqrt.s f5, f4, rdn
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f5, f4
f4                  0x40d8000000000000(24576.0_d)                   0x40d8000000000000(24576.0_d)
f5                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3d2837ff8583c915291a7bd6fc6351a8992812c2        3d2837ff8583c915291a7bd6fc6351a8992812c2        
