# FailID_005348 VP++ SF pos RV64 fmin.d
...
_reg_f13:.byte 0x00,0x00,0x80,0x83,0x01,0x04,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f26'}})
    fmin.d f26, f13, f12
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x41e0040183800000(2149583900.0_d)              0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f26, f13, f12
+========================================================================================================================+
...
f26                 0x41e0040183800000(2149583900.0_d)              0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f13, f12
f12                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f13                 0x41e0040183800000(2149583900.0_d)              0x41e0040183800000(2149583900.0_d)
f26                 0x41e0040183800000(2149583900.0_d)              0x7ff8000000000000(nan_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            097e07b43bf17f61f11ed04dd4f4c6f437163e95        097e07b43bf17f61f11ed04dd4f4c6f437163e95        
