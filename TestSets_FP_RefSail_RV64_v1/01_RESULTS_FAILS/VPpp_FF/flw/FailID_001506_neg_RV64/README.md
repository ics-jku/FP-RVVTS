# FailID_001506 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0xdf                 // s10
    li x27, 0xffffffff7fff9ca9   // s11
    li x28, 0xba                 // t3
    li x29, 0x80000662           // t4
    li x30, 0x8027fbaf           // t5
    li x31, 0x7ffffea9           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x19'}, 'clob': {'f20', 'x19', 'x27'}})
...
f20                 0x43f0000000000000(1.8446744073709552e+19_d)    0xffffffff0f71b423(1.1916910454963919e-29_s)    X
STATES DIFFER: True
```
...
a2(x12)             0x000000007ffffe21(2147483169)                  0x000000007ffffe21(2147483169)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a669a8529aa970dcbaf16b03f71773ccd6da6e78        a669a8529aa970dcbaf16b03f71773ccd6da6e78        
