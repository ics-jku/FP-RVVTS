# FailID_000427 ARA pos RV64 fsqrt.s
...
_reg_f31:.byte 0x00,0xa0,0x69,0xab,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f27
    fld  f27, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f31'}})
    fsqrt.s f31, f27, rtz
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f31, f27, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cfc8aa2dd2f8aa45feaff86fec6fded71a084c89        cfc8aa2dd2f8aa45feaff86fec6fded71a084c89        
