# FailID_001853 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x13, 0x801d913c           // a3
    li x14, 0xa1ea5744           // a4
    li x15, 0x800407d4           // a5
    li x16, 0x53                 // a6
    li x17, 0x8017fa0a           // a7
    li x18, 0x801ff8e7           // s2
    li x19, 0x80180a84           // s3
    li x20, 0x800706c1           // s4
    li x21, 0x0                  // s5
    li x22, 0x8027f99a           // s6
    li x23, 0x80180234           // s7
    li x24, 0x8020087e           // s8
    li x25, 0x80000549           // s9
    li x26, 0xff                 // s10
    li x27, 0x31                 // s11
    li x28, 0xffffffffbe24f000   // t3
    li x29, 0x801807d8           // t4
    li x30, 0x1cfeb8000000       // t5
    li x31, 0x80000529           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f28', 'x23'}, 'clob': {'x9', 'x23'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        caa3d65a6a4f08e77f42b44c1dcd18e2e22e03dc        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x2, x23
sp(x2)              0x000000008000013c(2147483964)                  0x000000008000013c(2147483964)
s7(x23)             0x000000008020051f(2149582111)                  0x000000008020051f(2149582111)
...
ra(x1)              0x000000008000041b(2147484699)                  0x000000008000041b(2147484699)                  
sp(x2)              0x000000008000013c(2147483964)                  0x000000008000013c(2147483964)                  
gp(x3)              0x000000008027deaa(2150096554)                  0x000000008027deaa(2150096554)                  
tp(x4)              0xfffffffbe24f0000(18446744056031543296)        0xfffffffbe24f0000(18446744056031543296)        
...
s1(x9)              0x00000000801802ef(2149057263)                  0x00000000801802ef(2149057263)                  
...
a3(x13)             0x00000000801d913c(2149421372)                  0x00000000801d913c(2149421372)                  
a4(x14)             0x00000000a1ea5744(2716489540)                  0x00000000a1ea5744(2716489540)                  
a5(x15)             0x00000000800407d4(2147747796)                  0x00000000800407d4(2147747796)                  
a6(x16)             0x0000000000000053(83)                          0x0000000000000053(83)                          
a7(x17)             0x000000008017fa0a(2149054986)                  0x000000008017fa0a(2149054986)                  
s2(x18)             0x00000000801ff8e7(2149578983)                  0x00000000801ff8e7(2149578983)                  
s3(x19)             0x0000000080180a84(2149059204)                  0x0000000080180a84(2149059204)                  
s4(x20)             0x00000000800706c1(2147944129)                  0x00000000800706c1(2147944129)                  
s5(x21)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s6(x22)             0x000000008027f99a(2150103450)                  0x000000008027f99a(2150103450)                  
s7(x23)             0x000000008020051f(2149582111)                  0x000000008020051f(2149582111)                  
...
s11(x27)            0x0000000000000031(49)                          0x0000000000000031(49)                          
t3(x28)             0xffffffffbe24f000(18446744072604676096)        0xffffffffbe24f000(18446744072604676096)        
t4(x29)             0x00000000801807d8(2149058520)                  0x00000000801807d8(2149058520)                  
t5(x30)             0x00001cfeb8000000(31880334278656)              0x00001cfeb8000000(31880334278656)              
t6(x31)             0x0000000080000529(2147484969)                  0x0000000080000529(2147484969)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            79d10e4b8114023f9d86c641325ceae3e44e2b76        79d10e4b8114023f9d86c641325ceae3e44e2b76        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        caa3d65a6a4f08e77f42b44c1dcd18e2e22e03dc        X
