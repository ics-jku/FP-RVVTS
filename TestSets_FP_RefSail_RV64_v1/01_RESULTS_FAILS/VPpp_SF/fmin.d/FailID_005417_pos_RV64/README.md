# FailID_005417 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x20,0x4b,0x01,0x03,0xe0,0x41
_reg_f19:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f25:.byte 0x00,0x00,0xc0,0x97,0x01,0xf6,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f25'}, 'clob': {'f2'}})
    fmin.d f2, f25, f19
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xc1dff60197c00000(-2144863839.0_d)             0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f2                  0xc1dff60197c00000(-2144863839.0_d)             0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f25, f19
f2                  0xc1dff60197c00000(-2144863839.0_d)             0x7ff8000000000000(nan_d)                       X
f19                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f25                 0xc1dff60197c00000(-2144863839.0_d)             0xc1dff60197c00000(-2144863839.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            96826be14a40e7c0b0a74edf63707c0394381a06        96826be14a40e7c0b0a74edf63707c0394381a06        
