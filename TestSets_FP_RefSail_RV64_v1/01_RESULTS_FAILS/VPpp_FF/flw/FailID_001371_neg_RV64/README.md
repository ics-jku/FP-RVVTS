# FailID_001371 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x2007f              // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x11'}, 'clob': {'f6', 'x6', 'x11'}})
...
f6                  0xffffffff5ed5a590(7.697434615455154e+18_s)     0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
a5(x15)             0xfffffffffffff9fa(18446744073709550074)        0xfffffffffffff9fa(18446744073709550074)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            53768ed3f1f31b2183571774642230669a08fa91        53768ed3f1f31b2183571774642230669a08fa91        
