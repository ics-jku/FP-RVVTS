# FailID_001612 VP++ FF neg RV64 fmv.x.h
...
* FailID: 1612
* Isolated failing instruction: `fmv.x.h`
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0x00,0x00,0xe0,0x2b,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f20
    fld  f20, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f20'}, 'clob': {'x29'}})
    fmv.x.h x29, f20
```
...
```
REG                 REF                                             DUT                                             DIFF
t4(x29)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
```
+========================================================================================================================+
Instruction: fmv.x.h x29, f20
+========================================================================================================================+
Attributes:  precision mismatch ('h', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x29, f20
t4(x29)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
f20                 0x41e002ff2be00000(2149054815.0_d)              0x41e002ff2be00000(2149054815.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            13053da8a6965b5e013d04cf4774ef4429289ccb        13053da8a6965b5e013d04cf4774ef4429289ccb        
