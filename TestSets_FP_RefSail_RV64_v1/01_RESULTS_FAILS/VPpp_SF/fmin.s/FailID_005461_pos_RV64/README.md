# FailID_005461 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f8'}, 'clob': {'f26'}})
    fmin.s f26, f8, f26
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b486e1518f0b50195c680ca0089ce00ce4cdb0f9        b486e1518f0b50195c680ca0089ce00ce4cdb0f9        
