# FailID_005231 VP++ SF pos RV64 fmax.s
...
_reg_f13:.byte 0x23,0xb4,0x11,0x04,0xf3,0x90,0x00,0xb4
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f13'}})
    fmax.s f13, f2, f13
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b16c94c6eaaa063672d6c5ee011c6c707caa5140        b16c94c6eaaa063672d6c5ee011c6c707caa5140        
