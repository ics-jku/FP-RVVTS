# FailID_001171 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x9, 0x0                   // s1
    li x10, 0x0                  // a0
    li x11, 0x8017fe40           // a1
    li x12, 0x800003e1           // a2
    li x13, 0x80200332           // a3
    li x14, 0x8c1                // a4
    li x15, 0x801801e6           // a5
    li x16, 0x8017ff32           // a6
    li x17, 0x2                  // a7
    li x18, 0x100                // s2
    li x19, 0x47                 // s3
    li x20, 0x800007b6           // s4
    li x21, 0x7ffffcef           // s5
    li x22, 0x0                  // s6
    li x23, 0x801806cd           // s7
    li x24, 0x6000               // s8
    li x25, 0x801801f3           // s9
    li x26, 0x80000732           // s10
    li x27, 0x802009db           // s11
    li x28, 0x7fffff11           // t3
    li x29, 0x802008f2           // t4
    li x30, 0x6000               // t5
    li x31, 0x75f1c000           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x11'}, 'clob': {'f2', 'x27', 'x11'}})
...
f2                  0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
a1(x11)             0x00000000801800ee(2149056750)                  0x00000000801800ee(2149056750)
f2                  0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
fp(x8)              0x0000000080200088(2149580936)                  0x0000000080200088(2149580936)                  
...
a3(x13)             0x0000000080200332(2149581618)                  0x0000000080200332(2149581618)                  
a4(x14)             0x00000000000008c1(2241)                        0x00000000000008c1(2241)                        
a5(x15)             0x00000000801801e6(2149056998)                  0x00000000801801e6(2149056998)                  
a6(x16)             0x000000008017ff32(2149056306)                  0x000000008017ff32(2149056306)                  
...
s5(x21)             0x000000007ffffcef(2147482863)                  0x000000007ffffcef(2147482863)                  
...
s9(x25)             0x00000000801801f3(2149057011)                  0x00000000801801f3(2149057011)                  
s10(x26)            0x0000000080000732(2147485490)                  0x0000000080000732(2147485490)                  
s11(x27)            0x00000000800002ae(2147484334)                  0x00000000800002ae(2147484334)                  
t3(x28)             0x000000007fffff11(2147483409)                  0x000000007fffff11(2147483409)                  
t4(x29)             0x00000000802008f2(2149583090)                  0x00000000802008f2(2149583090)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b24bc905b28fd0782722901da89e472fb73e28c7        b24bc905b28fd0782722901da89e472fb73e28c7        
