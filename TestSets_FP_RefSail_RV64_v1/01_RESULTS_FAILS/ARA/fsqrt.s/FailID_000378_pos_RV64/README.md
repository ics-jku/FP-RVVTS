# FailID_000378 ARA pos RV64 fsqrt.s
...
_reg_f24:.byte 0x00,0x00,0x40,0x06,0x00,0xfa,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f17'}})
    fsqrt.s f17, f24, dyn
```
...
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff22ddb3d7(6.0092582870930764e-18_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f17, f24, dyn
+========================================================================================================================+
...
Registers: f17, f24
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff22ddb3d7(6.0092582870930764e-18_s)    X
f24                 0xc1dffa0006400000(-2145910809.0_d)             0xc1dffa0006400000(-2145910809.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4b87f1f5cb2d333a6c79766fe61906419bf7c069        4b87f1f5cb2d333a6c79766fe61906419bf7c069        
