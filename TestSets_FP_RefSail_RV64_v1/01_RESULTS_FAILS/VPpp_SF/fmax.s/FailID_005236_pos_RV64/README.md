# FailID_005236 VP++ SF pos RV64 fmax.s
...
_reg_f29:.byte 0x01,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f4'}, 'clob': {'f29'}})
    fmax.s f29, f7, f4
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aec5c9aaaa212dd909867af171efd9569dd668d6        aec5c9aaaa212dd909867af171efd9569dd668d6        
