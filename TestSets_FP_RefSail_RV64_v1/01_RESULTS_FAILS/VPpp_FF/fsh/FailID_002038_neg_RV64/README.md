# FailID_002038 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs', 'x14'}, 'clob': {'x10', 'x14'}})
...
a0(x10)             0x0000000080180754(2149058388)                  0x0000000080180754(2149058388)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ad7566ea4869cbf0b41c8215a31722504634c7dd        ad7566ea4869cbf0b41c8215a31722504634c7dd        
