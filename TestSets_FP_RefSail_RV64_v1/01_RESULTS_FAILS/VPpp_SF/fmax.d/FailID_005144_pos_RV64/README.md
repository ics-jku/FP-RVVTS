# FailID_005144 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x23,0xb8,0x01,0x0b,0x23,0xbc,0x11,0x0b
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f12'}})
    fmax.d f12, f6, f24
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0x0b11bc230b01b823(2.3622870408526574e-255_d)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f12                 0x0b11bc230b01b823(2.3622870408526574e-255_d)   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f6, f24
f6                  0x0b11bc230b01b823(2.3622870408526574e-255_d)   0x0b11bc230b01b823(2.3622870408526574e-255_d)
f12                 0x0b11bc230b01b823(2.3622870408526574e-255_d)   0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a83654a7ef2470ecd07fcb8c5f6beac24a9251a7        a83654a7ef2470ecd07fcb8c5f6beac24a9251a7        
