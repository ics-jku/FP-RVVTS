# FailID_005210 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f16', 'fcsr.rm'}, 'clob': {'f27'}})
    fmax.d f27, f16, f0
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6c2333569883bf181329b39028543a437f6fd156        6c2333569883bf181329b39028543a437f6fd156        
