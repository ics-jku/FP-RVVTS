# FailID_000095 ARA neg RV64 fsqrt.s
...
_reg_f16:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f2'}})
    fsqrt.s f2, f16
```
...
Registers: f2, f16
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f16                 0x4050000000000000(64.0_d)                      0x4050000000000000(64.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            77b79700016d92ed22d8a39087896f0c4236be0b        77b79700016d92ed22d8a39087896f0c4236be0b        
