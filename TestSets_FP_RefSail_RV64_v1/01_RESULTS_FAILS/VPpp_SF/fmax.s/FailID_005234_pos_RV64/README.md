# FailID_005234 VP++ SF pos RV64 fmax.s
...
_reg_f17:.byte 0x00,0x28,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f16', 'fcsr.rm'}, 'clob': {'f25'}})
    fmax.s f25, f17, f16
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff4f002800(2150105088.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f25, f17, f16
+========================================================================================================================+
...
f25                 0xffffffff4f002800(2150105088.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f17, f16
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f17                 0xffffffff4f002800(2150105088.0_s)              0xffffffff4f002800(2150105088.0_s)
f25                 0xffffffff4f002800(2150105088.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f2eda75af3650c3f246433853cff547e6d794905        f2eda75af3650c3f246433853cff547e6d794905        
