# FailID_003105 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x8'}})
    fcvt.wu.s x8, f2, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x8, f2, rdn
+========================================================================================================================+
...
Registers: x8, f2
fp(x8)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f2                  0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4ee2e0ac9b50ad7ea97ca8af594adf11df430739        4ee2e0ac9b50ad7ea97ca8af594adf11df430739        
