# FailID_000772 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0x8b                 // t5
    li x31, 0xb4                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x12', 'mstatus.fs/vs.fs'}, 'clob': {'x12', 'x18', 'f22'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            96fd9379add73004a539f23ebc93403eeb8c2fd9        96fd9379add73004a539f23ebc93403eeb8c2fd9        
