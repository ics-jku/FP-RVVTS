# FailID_005288 VP++ SF pos RV64 fmax.s
...
_reg_f14:.byte 0xc9,0xfd,0x17,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f14', 'fcsr.rm'}, 'clob': {'f6'}})
    fmax.s f6, f14, f17
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0xffffffff8017fdc9(-2.203257371562517e-39_s)    0xffffffffffffffff(nan_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f6, f14, f17
+========================================================================================================================+
Attributes:  special values ['nan'], precision mismatch ('s', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f6                  0xffffffff8017fdc9(-2.203257371562517e-39_s)    0xffffffffffffffff(nan_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f14, f17
f6                  0xffffffff8017fdc9(-2.203257371562517e-39_s)    0xffffffffffffffff(nan_h)                       X
f14                 0xffffffff8017fdc9(-2.203257371562517e-39_s)    0xffffffff8017fdc9(-2.203257371562517e-39_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d51ec4f756607f4f2a39afe98eb84438cd9ba384        d51ec4f756607f4f2a39afe98eb84438cd9ba384        
