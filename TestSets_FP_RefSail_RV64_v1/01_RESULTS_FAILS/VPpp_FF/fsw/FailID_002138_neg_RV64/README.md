# FailID_002138 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x3, 0x1                   // gp
    li x4, 0x1b9560              // tp
    li x5, 0xffffffff903a5000    // t0
    li x6, 0x80180296            // t1
    li x7, 0x8018009f            // t2
    li x8, 0x6000                // fp
    li x9, 0x0                   // s1
    li x10, 0x411a3000           // a0
    li x11, 0xb70acb58           // a1
    li x12, 0x75af7784           // a2
    li x13, 0x80186629           // a3
    li x14, 0x7ffff83f           // a4
    li x15, 0x80080104           // a5
    li x16, 0x800001d5           // a6
    li x17, 0x8234600            // a7
    li x18, 0x6000               // s2
    li x19, 0x8000070c           // s3
    li x20, 0x1                  // s4
    li x21, 0x80180053           // s5
    li x22, 0x7ffff8fb           // s6
    li x23, 0x80200b58           // s7
    li x24, 0x8021141f           // s8
    li x25, 0x372ac000           // s9
    li x26, 0x8018009f           // s10
    li x27, 0x8007b5a7           // s11
    li x28, 0x0                  // t3
    li x29, 0x801806cf           // t4
    li x30, 0x11                 // t5
    li x31, 0x800002a4           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs', 'f17'}, 'clob': {'x13', 'x20'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        79a3d30ccd8f931ca68c66f284cbaa80b6332cc6        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x765, x13
a3(x13)             0x0000000080205ec3(2149605059)                  0x0000000080205ec3(2149605059)
...
ra(x1)              0x00000000000000b2(178)                         0x00000000000000b2(178)                         
sp(x2)              0x000000008000046e(2147484782)                  0x000000008000046e(2147484782)                  
gp(x3)              0x0000000000000001(1)                           0x0000000000000001(1)                           
tp(x4)              0x00000000001b9560(1807712)                     0x00000000001b9560(1807712)                     
t0(x5)              0xffffffff903a5000(18446744071834324992)        0xffffffff903a5000(18446744071834324992)        
t1(x6)              0x0000000080180296(2149057174)                  0x0000000080180296(2149057174)                  
t2(x7)              0x000000008018009f(2149056671)                  0x000000008018009f(2149056671)                  
fp(x8)              0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x00000000411a3000(1092235264)                  0x00000000411a3000(1092235264)                  
a1(x11)             0x00000000b70acb58(3070937944)                  0x00000000b70acb58(3070937944)                  
a2(x12)             0x0000000075af7784(1974433668)                  0x0000000075af7784(1974433668)                  
a3(x13)             0x0000000080205ec3(2149605059)                  0x0000000080205ec3(2149605059)                  
a4(x14)             0x000000007ffff83f(2147481663)                  0x000000007ffff83f(2147481663)                  
a5(x15)             0x0000000080080104(2148008196)                  0x0000000080080104(2148008196)                  
a6(x16)             0x00000000800001d5(2147484117)                  0x00000000800001d5(2147484117)                  
a7(x17)             0x0000000008234600(136529408)                   0x0000000008234600(136529408)                   
s2(x18)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s3(x19)             0x000000008000070c(2147485452)                  0x000000008000070c(2147485452)                  
s4(x20)             0x000000008017f89b(2149054619)                  0x000000008017f89b(2149054619)                  
s5(x21)             0x0000000080180053(2149056595)                  0x0000000080180053(2149056595)                  
s6(x22)             0x000000007ffff8fb(2147481851)                  0x000000007ffff8fb(2147481851)                  
...
s9(x25)             0x00000000372ac000(925548544)                   0x00000000372ac000(925548544)                   
s10(x26)            0x000000008018009f(2149056671)                  0x000000008018009f(2149056671)                  
s11(x27)            0x000000008007b5a7(2147988903)                  0x000000008007b5a7(2147988903)                  
t3(x28)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t4(x29)             0x00000000801806cf(2149058255)                  0x00000000801806cf(2149058255)                  
t5(x30)             0x0000000000000011(17)                          0x0000000000000011(17)                          
t6(x31)             0x00000000800002a4(2147484324)                  0x00000000800002a4(2147484324)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            442442b5fb361a5b7be935db3f679a9800c07364        442442b5fb361a5b7be935db3f679a9800c07364        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        79a3d30ccd8f931ca68c66f284cbaa80b6332cc6        X
