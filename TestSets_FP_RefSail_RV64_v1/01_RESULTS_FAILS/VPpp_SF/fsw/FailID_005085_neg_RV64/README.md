# FailID_005085 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x8017fcc9            // fp
    li x9, 0x7ffffe8a            // s1
    li x10, 0x801ffe1f           // a0
    li x11, 0x180000000          // a1
    li x12, 0x0                  // a2
    li x13, 0x8027ffcd           // a3
    li x14, 0x6000               // a4
    li x15, 0x8017ffe7           // a5
    li x16, 0x801805e3           // a6
    li x17, 0x801803a8           // a7
    li x18, 0x801fffab           // s2
    li x19, 0x8000068d           // s3
    li x20, 0x801ffddd           // s4
    li x21, 0x7fffffffffffffff   // s5
    li x22, 0x800107be           // s6
    li x23, 0x80180046           // s7
    li x24, 0x71b823             // s8
    li x25, 0x7fff9e8a           // s9
    li x26, 0x800007bf           // s10
    li x27, 0x80180388           // s11
    li x28, 0xa9                 // t3
    li x29, 0x801ff7da           // t4
    li x30, 0x80180b2b           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'x24', 'fcsr.rm'}, 'clob': {'x29', 'x24'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        63d8f72640b2e5b97ddf023a7b556de493df4ab7        X
...
t1(x6)              0x000000000001e07e(123006)                      0x000000000001e07e(123006)                      
...
a0(x10)             0x00000000801ffe1f(2149580319)                  0x00000000801ffe1f(2149580319)                  
...
a5(x15)             0x000000008017ffe7(2149056487)                  0x000000008017ffe7(2149056487)                  
a6(x16)             0x00000000801805e3(2149058019)                  0x00000000801805e3(2149058019)                  
a7(x17)             0x00000000801803a8(2149057448)                  0x00000000801803a8(2149057448)                  
s2(x18)             0x00000000801fffab(2149580715)                  0x00000000801fffab(2149580715)                  
s3(x19)             0x000000008000068d(2147485325)                  0x000000008000068d(2147485325)                  
s4(x20)             0x00000000801ffddd(2149580253)                  0x00000000801ffddd(2149580253)                  
s5(x21)             0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
s6(x22)             0x00000000800107be(2147551166)                  0x00000000800107be(2147551166)                  
s7(x23)             0x0000000080180046(2149056582)                  0x0000000080180046(2149056582)                  
s8(x24)             0x000000008019b203(2149167619)                  0x000000008019b203(2149167619)                  
s9(x25)             0x000000007fff9e8a(2147458698)                  0x000000007fff9e8a(2147458698)                  
s10(x26)            0x00000000800007bf(2147485631)                  0x00000000800007bf(2147485631)                  
s11(x27)            0x0000000080180388(2149057416)                  0x0000000080180388(2149057416)                  
t3(x28)             0x00000000000000a9(169)                         0x00000000000000a9(169)                         
t4(x29)             0x000000008017f9e3(2149054947)                  0x000000008017f9e3(2149054947)                  
t5(x30)             0x0000000080180b2b(2149059371)                  0x0000000080180b2b(2149059371)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            12e5dd4aaa4405b48b3c646b9351ad6216fcbcc0        12e5dd4aaa4405b48b3c646b9351ad6216fcbcc0        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        63d8f72640b2e5b97ddf023a7b556de493df4ab7        X
