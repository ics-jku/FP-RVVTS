# FailID_004171 VP++ SF neg RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0xd7,0xb3,0xdd,0x1d,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f7'}, 'clob': {'f31'}})
    fmin.s f31, f7, f14
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff1dddb3d7(5.8684162959893324e-21_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f31                 0xffffffff1dddb3d7(5.8684162959893324e-21_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f7, f14
f7                  0xffffffff1dddb3d7(5.8684162959893324e-21_s)    0xffffffff1dddb3d7(5.8684162959893324e-21_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9556e63ecee60573d3ddafe0ee4fbf1f17c78b01        9556e63ecee60573d3ddafe0ee4fbf1f17c78b01        
