# FailID_004145 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f4'}, 'clob': {'f7'}})
    fmin.d f7, f17, f4
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0x40d8000000000000(24576.0_d)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3f95e2885e319ec032572989b117e47641740630        3f95e2885e319ec032572989b117e47641740630        
