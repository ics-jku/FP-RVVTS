# FailID_005338 VP++ SF pos RV64 fmin.d
...
_reg_f14:.byte 0xb0,0x4c,0xd4,0x4d,0xb5,0x3a,0xda,0xc3
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f14', 'fcsr.rm'}, 'clob': {'f3'}})
    fmin.d f3, f14, f0
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xc3da3ab54dd44cb0(-7.560089358056997e+18_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f3                  0xc3da3ab54dd44cb0(-7.560089358056997e+18_d)    0xffffffff7fc00000(nan_s)                       X
f14                 0xc3da3ab54dd44cb0(-7.560089358056997e+18_d)    0xc3da3ab54dd44cb0(-7.560089358056997e+18_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5c3a64f3921eb8d27799633f801f5419b7bd8451        5c3a64f3921eb8d27799633f801f5419b7bd8451        
