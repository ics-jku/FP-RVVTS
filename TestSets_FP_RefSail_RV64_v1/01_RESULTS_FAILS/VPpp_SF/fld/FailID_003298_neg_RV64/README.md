# FailID_003298 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x8e                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'f6', 'x24', 'x10'}})
...
f6                  0x91315a800adc5f95(-7.325389945954006e-226_d)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d606379b75c970957f6c01609eeba8bd0a887647        d606379b75c970957f6c01609eeba8bd0a887647        
