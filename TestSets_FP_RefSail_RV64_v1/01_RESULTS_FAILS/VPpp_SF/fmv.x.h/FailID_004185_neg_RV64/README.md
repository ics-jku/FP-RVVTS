# FailID_004185 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'x1'}})
    fmv.x.h x1, f3
```
...
```
REG                 REF                                             DUT                                             DIFF
ra(x1)              0xfffffffffffff941(18446744073709549889)        0x0000000000007e00(32256)                       X
...
```
+========================================================================================================================+
Instruction: fmv.x.h x1, f3
+========================================================================================================================+
Attributes:  precision mismatch ('h', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cf7175225e372c93e5c6176ccc5a83bd61006de0        cf7175225e372c93e5c6176ccc5a83bd61006de0        
