# FailID_002769 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x18'}})
    fcvt.wu.d x18, f18
```
...
```
REG                 REF                                             DUT                                             DIFF
s2(x18)             0xffffffff801ffd00(18446744071564164352)        0x00000000801ffd00(2149580032)                  X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a80834be1942efeff12a46c9838ef4797044b357        a80834be1942efeff12a46c9838ef4797044b357        
