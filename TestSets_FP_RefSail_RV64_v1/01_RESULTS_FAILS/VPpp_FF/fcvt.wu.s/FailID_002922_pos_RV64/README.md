# FailID_002922 VP++ FF pos RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f5, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f5, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            88e88f5f76387fec60f2dae91c3a492b60938439        88e88f5f76387fec60f2dae91c3a492b60938439        
