# FailID_000269 ARA pos RV64 fdiv.s
...
_reg_f28:.byte 0x00,0x02,0xc0,0x46,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'f28', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fdiv.s f26, f28, f30, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f26, f28, f30, rup
+========================================================================================================================+
...
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f28, f30
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f28                 0xffffffff46c00200(24577.0_s)                   0xffffffff46c00200(24577.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3315ed4d379640b01b778f6e57a074e2de9543a1        3315ed4d379640b01b778f6e57a074e2de9543a1        
