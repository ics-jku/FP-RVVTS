# FailID_002807 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x0f,0x18,0x00,0xcf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x30'}})
    fcvt.wu.d x30, f3, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x30, f3, rdn
+========================================================================================================================+
...
Registers: x30, f3
t5(x30)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f3                  0xffffffffcf00180f(-2149060352.0_s)             0xffffffffcf00180f(-2149060352.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0af0bb176323df9d2b5215111e0ecd750c45f2d9        0af0bb176323df9d2b5215111e0ecd750c45f2d9        
