# FailID_001767 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x11, 0xb9                 // a1
    li x12, 0x5b                 // a2
    li x13, 0x801805df           // a3
    li x14, 0x0                  // a4
    li x15, 0x801805e8           // a5
    li x16, 0x7ffffdf0           // a6
    li x17, 0x7ffffc95           // a7
    li x18, 0x0                  // s2
    li x19, 0x801805e8           // s3
    li x20, 0x8027f6b4           // s4
    li x21, 0x8018089c           // s5
    li x22, 0x80180590           // s6
    li x23, 0x24                 // s7
    li x24, 0x0                  // s8
    li x25, 0x80198f2e           // s9
    li x26, 0x0                  // s10
    li x27, 0x0                  // s11
    li x28, 0x80180764           // t3
    li x29, 0x0                  // t4
    li x30, 0x0                  // t5
    li x31, 0x80000130           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x11', 'f28'}, 'clob': {'x11', 'x3'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d2d0ca6fdcbcf061f67ad4d5d032f315bb8218c1        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x7, e0, x11
t2(x7)              0x000000008017fa74(2149055092)                  0x000000008017fa74(2149055092)
a1(x11)             0x000000008017f8d8(2149054680)                  0x000000008017f8d8(2149054680)
...
ra(x1)              0x0000000080180964(2149058916)                  0x0000000080180964(2149058916)                  
sp(x2)              0x00000000800001f0(2147484144)                  0x00000000800001f0(2147484144)                  
gp(x3)              0x000000008017f820(2149054496)                  0x000000008017f820(2149054496)                  
tp(x4)              0x000000007ffffce8(2147482856)                  0x000000007ffffce8(2147482856)                  
...
a1(x11)             0x000000008017f8d8(2149054680)                  0x000000008017f8d8(2149054680)                  
a2(x12)             0x000000000000005b(91)                          0x000000000000005b(91)                          
a3(x13)             0x00000000801805df(2149058015)                  0x00000000801805df(2149058015)                  
a4(x14)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a5(x15)             0x00000000801805e8(2149058024)                  0x00000000801805e8(2149058024)                  
a6(x16)             0x000000007ffffdf0(2147483120)                  0x000000007ffffdf0(2147483120)                  
a7(x17)             0x000000007ffffc95(2147482773)                  0x000000007ffffc95(2147482773)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x00000000801805e8(2149058024)                  0x00000000801805e8(2149058024)                  
s4(x20)             0x000000008027f6b4(2150102708)                  0x000000008027f6b4(2150102708)                  
s5(x21)             0x000000008018089c(2149058716)                  0x000000008018089c(2149058716)                  
s6(x22)             0x0000000080180590(2149057936)                  0x0000000080180590(2149057936)                  
s7(x23)             0x0000000000000024(36)                          0x0000000000000024(36)                          
s8(x24)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s9(x25)             0x0000000080198f2e(2149158702)                  0x0000000080198f2e(2149158702)                  
s10(x26)            0x0000000000000000(0)                           0x0000000000000000(0)                           
s11(x27)            0x0000000000000000(0)                           0x0000000000000000(0)                           
t3(x28)             0x0000000080180764(2149058404)                  0x0000000080180764(2149058404)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            125c79fdf74d73a640b6fb8ffa47288409984f3b        125c79fdf74d73a640b6fb8ffa47288409984f3b        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d2d0ca6fdcbcf061f67ad4d5d032f315bb8218c1        X
