# FailID_003558 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x6', 'x24', 'f4'}})
...
f4                  0xffffffffffc00000(nan_s)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
t1(x6)              0x000000007ffffc69(2147482729)                  0x000000007ffffc69(2147482729)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7ac802cf5cffc2ada4f2844f14e223e309c0ad3c        7ac802cf5cffc2ada4f2844f14e223e309c0ad3c        
