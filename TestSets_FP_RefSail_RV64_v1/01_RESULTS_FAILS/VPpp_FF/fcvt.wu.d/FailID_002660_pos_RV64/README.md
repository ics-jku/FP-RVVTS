# FailID_002660 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x3c,0x8c,0x18,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.d x3, f6, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x3, f6, rmm
+========================================================================================================================+
...
Registers: x3, f6
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f6                  0xffffffff80188c3c(-2.25435852266105e-39_s)     0xffffffff80188c3c(-2.25435852266105e-39_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ea264c0c241a2adc1354054f49c2014c10493f35        ea264c0c241a2adc1354054f49c2014c10493f35        
