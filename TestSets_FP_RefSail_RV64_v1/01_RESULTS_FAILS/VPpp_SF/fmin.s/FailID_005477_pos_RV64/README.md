# FailID_005477 VP++ SF pos RV64 fmin.s
...
_reg_f28:.byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f8'}, 'clob': {'f28'}})
    fmin.s f28, f8, f14
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            95c2be0c53dc5894a57f6a0cc4e5b3a32b47bb01        95c2be0c53dc5894a57f6a0cc4e5b3a32b47bb01        
