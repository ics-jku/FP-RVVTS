# FailID_000157 ARA pos RV64 fdiv.s
...
_reg_f22:.byte 0x78,0x03,0x18,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f1'}})
    fdiv.s f1, f22, f13, rdn
```
...
f1                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f1, f22, f13, rdn
+========================================================================================================================+
...
f1                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f22, f13
f1                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f13                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f22                 0x0000000080180378(1.0617754323e-314_d)         0x0000000080180378(1.0617754323e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            687d72a1af099c980ef27c2cd156725ce2f02eee        687d72a1af099c980ef27c2cd156725ce2f02eee        
