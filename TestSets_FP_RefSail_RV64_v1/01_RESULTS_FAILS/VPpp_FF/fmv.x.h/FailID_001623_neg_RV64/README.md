# FailID_001623 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f6'}, 'clob': {'x31'}})
    fmv.x.h x31, f6
```
...
```
REG                 REF                                             DUT                                             DIFF
t6(x31)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d3d49c5c1faf7bf0a963089a19937c84994f76b2        d3d49c5c1faf7bf0a963089a19937c84994f76b2        
