# FailID_002338 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x24, 0x801804af           // s8
    li x25, 0x8028011b           // s9
    li x26, 0x80000566           // s10
    li x27, 0x6000               // s11
    li x28, 0x8017fefc           // t3
    li x29, 0x801803c2           // t4
    li x30, 0x2                  // t5
    li x31, 0x8017ffd2           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f13', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'x23'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        576d7a2829bc01f7b5ad69576b54dc3135f6685f        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x600, x2
sp(x2)              0x0000000080180c40(2149059648)                  0x0000000080180c40(2149059648)
...
s8(x24)             0x00000000801804af(2149057711)                  0x00000000801804af(2149057711)                  
...
t3(x28)             0x000000008017fefc(2149056252)                  0x000000008017fefc(2149056252)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9e5d0d2d70e61524f33e756de4aa639de854d807        9e5d0d2d70e61524f33e756de4aa639de854d807        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        576d7a2829bc01f7b5ad69576b54dc3135f6685f        X
