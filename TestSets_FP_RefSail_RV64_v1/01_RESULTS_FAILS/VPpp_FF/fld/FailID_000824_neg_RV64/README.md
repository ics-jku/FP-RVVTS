# FailID_000824 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x17, 0x7fffff67           // a7
    li x18, 0x8017fdd5           // s2
    li x19, 0x801ff867           // s3
    li x20, 0x8017f93e           // s4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x17'}, 'clob': {'f22', 'x17', 'x1'}})
...
f22                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
ra(x1)              0x000000007ffffd00(2147482880)                  0x000000007ffffd00(2147482880)                  
...
s11(x27)            0x00000000000000f3(243)                         0x00000000000000f3(243)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ebc9f36bc842b9b779be1817be5239eb06d3471a        ebc9f36bc842b9b779be1817be5239eb06d3471a        
