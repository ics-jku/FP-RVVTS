# FailID_000318 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x04,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f14'}})
    fsqrt.s f14, f5, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff473515ee(46357.9296875_s)             0xffffffff473515ed(46357.92578125_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f14, f5, rmm
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f5
f5                  0xffffffff4f001804(2149057536.0_s)              0xffffffff4f001804(2149057536.0_s)
f14                 0xffffffff473515ee(46357.9296875_s)             0xffffffff473515ed(46357.92578125_s)            X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            839293191cc89bca0ef1d08f703a062b9298fdca        839293191cc89bca0ef1d08f703a062b9298fdca        
