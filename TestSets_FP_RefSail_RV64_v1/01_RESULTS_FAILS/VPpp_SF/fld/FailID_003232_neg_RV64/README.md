# FailID_003232 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x29, 0x7ffffd36           // t4
    li x30, 0x8000013e           // t5
    li x31, 0x5de4c2c1ae235d30   // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x30'}, 'clob': {'x21', 'x30', 'f19'}})
...
f19                 0xffffffff7fc00000(nan_s)                       0x1251b823003022f3(1.960782188923977e-220_d)    X
STATES DIFFER: True
```
...
f19                 0xffffffff7fc00000(nan_s)                       0x1251b823003022f3(1.960782188923977e-220_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x673, x30
t5(x30)             0x00000000800007ab(2147485611)                  0x00000000800007ab(2147485611)
f19                 0xffffffff7fc00000(nan_s)                       0x1251b823003022f3(1.960782188923977e-220_d)    X
+========================================================================================================================+
```
...
s5(x21)             0x0000000080000673(2147485299)                  0x0000000080000673(2147485299)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8a89e9ed31dc3ecd67c7783888e1440a21a6a035        8a89e9ed31dc3ecd67c7783888e1440a21a6a035        
