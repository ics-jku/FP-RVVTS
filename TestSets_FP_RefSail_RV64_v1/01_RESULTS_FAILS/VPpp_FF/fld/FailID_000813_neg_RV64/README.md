# FailID_000813 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x9, 0x267fb788            // s1
    li x10, 0x5d6                // a0
    li x11, 0x8017f395           // a1
    li x12, 0x8017fff3           // a2
    ...
    li x28, 0xbdd798             // t3
    li x29, 0x8018029b           // t4
    li x30, 0xbc                 // t5
    li x31, 0xedaf8768           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs'}, 'clob': {'x30', 'f2', 'x29'}})
...
f2                  0x2f6dfba31192e4cc(3.1608626740755325e-80_d)    0x0d31b4230d21b023(4.051227151004288e-245_d)    X
STATES DIFFER: True
```
...
f2                  0x2f6dfba31192e4cc(3.1608626740755325e-80_d)    0x0d31b4230d21b023(4.051227151004288e-245_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, x6, a0, x30
t1(x6)              0x0000000000000000(0)                           0x0000000000000000(0)
t5(x30)             0x0000000080000758(2147485528)                  0x0000000080000758(2147485528)
f2                  0x2f6dfba31192e4cc(3.1608626740755325e-80_d)    0x0d31b4230d21b023(4.051227151004288e-245_d)    X
+========================================================================================================================+
```
...
ra(x1)              0x000000007ffff929(2147481897)                  0x000000007ffff929(2147481897)                  
sp(x2)              0x0000000000006000(24576)                       0x0000000000006000(24576)                       
gp(x3)              0x0000000001003ff8(16793592)                    0x0000000001003ff8(16793592)                    
...
a0(x10)             0x00000000000005d6(1494)                        0x00000000000005d6(1494)                        
a1(x11)             0x000000008017f395(2149053333)                  0x000000008017f395(2149053333)                  
a2(x12)             0x000000008017fff3(2149056499)                  0x000000008017fff3(2149056499)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f0bf15cf59b269590c73b8576737f7e44d60acde        f0bf15cf59b269590c73b8576737f7e44d60acde        
