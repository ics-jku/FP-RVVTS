# FailID_004406 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x25, 0x1                  // s9
    li x26, 0x51bc23             // s10
    li x27, 0x80180677           // s11
    li x28, 0x801ff67d           // t3
    li x29, 0xfd                 // t4
    li x30, 0x3ffff              // t5
    li x31, 0x801801c9           // t6
    // INSTRUCTION ({'dep': {'f30', 'x27', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x27', 'x26'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        f26504ff3fa2ad2676dc5650bea8179707891b5a        X
...
s10(x26)            0x000000008017fe7b(2149056123)                  0x000000008017fe7b(2149056123)                  
s11(x27)            0x00000000802004eb(2149582059)                  0x00000000802004eb(2149582059)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7cba1c3aca0e365e0ed1bd5d2b9416c41115be99        7cba1c3aca0e365e0ed1bd5d2b9416c41115be99        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        f26504ff3fa2ad2676dc5650bea8179707891b5a        X
