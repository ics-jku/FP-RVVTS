# FailID_005444 VP++ SF pos RV64 fmin.s
...
_reg_f22:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f22'}, 'clob': {'f17'}})
    fmin.s f17, f22, f3
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f17                 0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f22, f3
f3                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f17                 0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
f22                 0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d65c739f942dd861e2222ba547e82907681c47fd        d65c739f942dd861e2222ba547e82907681c47fd        
