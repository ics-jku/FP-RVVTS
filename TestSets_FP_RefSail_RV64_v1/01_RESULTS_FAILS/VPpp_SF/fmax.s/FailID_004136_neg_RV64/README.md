# FailID_004136 VP++ SF neg RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0xf0,0x04,0x35,0x47,0xff,0xff,0xff,0xff
_reg_f11:.byte 0x03,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f11'}, 'clob': {'f1'}})
    fmax.s f1, f11, f18
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff4f001803(2149057280.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f1                  0xffffffff4f001803(2149057280.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f11, f18
f1                  0xffffffff4f001803(2149057280.0_s)              0xffffffff7fc00000(nan_s)                       X
f11                 0xffffffff4f001803(2149057280.0_s)              0xffffffff4f001803(2149057280.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            728cf3f1d07181529608ddacfde12ad99f415393        728cf3f1d07181529608ddacfde12ad99f415393        
