# FailID_000004 ARA neg RV64 fdiv.h
...
* FailID: 4
* Isolated failing instruction: `fdiv.h`
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f15', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f27'}, 'clob': {'f27'}})
    fdiv.h f27, f27, f15, rtz
```
...
f27                 0xffffffffffff7e00(nan_h)                       0xffffffffffff9ee1(-0.006717681884765625_h)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.h f27, f27, f15, rtz
+========================================================================================================================+
Attributes:  fcsr ['inexact'], special values ['nan', 'zero'], precision mismatch ('h', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e8643816d4fad97810f8d4f77fc2e3ddd3dfb5d8        e8643816d4fad97810f8d4f77fc2e3ddd3dfb5d8        
