# FailID_004464 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x18, 0xfffffffffffffa56   // s2
    li x19, 0x80005fff           // s3
    li x20, 0x8017fe1a           // s4
    li x21, 0x80180587           // s5
    li x22, 0x0                  // s6
    li x23, 0x1                  // s7
    li x24, 0x6000               // s8
    li x25, 0x8017fe1a           // s9
    li x26, 0x80000507           // s10
    li x27, 0x100000             // s11
    li x28, 0x1                  // t3
    li x29, 0x6000               // t4
    li x30, 0x1                  // t5
    li x31, 0x801ff826           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x2', 'f28'}, 'clob': {'x14', 'x2'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4ea96e21ba36f3ac6aca42f4fa18de56ffd62fe0        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x66, x2
sp(x2)              0x00000000801fff2e(2149580590)                  0x00000000801fff2e(2149580590)
...
fp(x8)              0x000000008000050f(2147484943)                  0x000000008000050f(2147484943)                  
...
s2(x18)             0xfffffffffffffa56(18446744073709550166)        0xfffffffffffffa56(18446744073709550166)        
s3(x19)             0x0000000080005fff(2147508223)                  0x0000000080005fff(2147508223)                  
s4(x20)             0x000000008017fe1a(2149056026)                  0x000000008017fe1a(2149056026)                  
...
s10(x26)            0x0000000080000507(2147484935)                  0x0000000080000507(2147484935)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4dd966cd6f9a8ee700a08f73923cf706186c168a        4dd966cd6f9a8ee700a08f73923cf706186c168a        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4ea96e21ba36f3ac6aca42f4fa18de56ffd62fe0        X
