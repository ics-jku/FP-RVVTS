# FailID_000193 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x80,0x42,0xff,0xff,0xff,0xff
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f22:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs', 'f0'}, 'clob': {'f22'}})
    fdiv.s f22, f0, f2
```
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f0, f2
f0                  0xffffffff42800000(64.0_s)                      0xffffffff42800000(64.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9959213cc8b2d10afa64929998ddffa3828aab76        9959213cc8b2d10afa64929998ddffa3828aab76        
