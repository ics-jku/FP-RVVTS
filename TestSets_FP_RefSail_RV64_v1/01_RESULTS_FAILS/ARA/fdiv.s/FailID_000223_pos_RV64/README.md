# FailID_000223 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0xfa,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f28'}})
    fdiv.s f28, f17, f2, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f28, f17, f2, rtz
+========================================================================================================================+
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f17, f2
f2                  0xffffffff4efffffa(2147482880.0_s)              0xffffffff4efffffa(2147482880.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3e1b40a9cfcdf01637f4610522d49bfc6fecb72b        3e1b40a9cfcdf01637f4610522d49bfc6fecb72b        
