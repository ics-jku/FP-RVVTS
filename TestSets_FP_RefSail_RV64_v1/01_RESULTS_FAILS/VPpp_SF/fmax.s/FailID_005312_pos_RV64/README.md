# FailID_005312 VP++ SF pos RV64 fmax.s
...
_reg_f4: .byte 0x00,0x00,0x7b,0x43,0xff,0xff,0xff,0xff
_reg_f13:.byte 0xc0,0xd7,0x6d,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f4'}})
    fmax.s f4, f13, f2
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff4e6dd7c0(997584896.0_s)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f4                  0xffffffff4e6dd7c0(997584896.0_s)               0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffff4e6dd7c0(997584896.0_s)               0xffffffff4e6dd7c0(997584896.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c47006d5df490cc26b5fc21d4e4963de9097dc76        c47006d5df490cc26b5fc21d4e4963de9097dc76        
