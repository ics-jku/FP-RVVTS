# FailID_000462 ARA pos RV64 fsqrt.s
...
_reg_f24:.byte 0x7b,0xf9,0x17,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f24'}})
    fsqrt.s f24, f7, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f24, f7, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ef3fd20c04ed7a749bccb2c0f308473888821ef8        ef3fd20c04ed7a749bccb2c0f308473888821ef8        
