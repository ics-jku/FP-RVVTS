# FailID_000499 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0x00,0x00,0x40,0xe2,0x15,0x7c,0xdd,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f18'}})
    fsqrt.s f18, f20, rdn
```
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff4753c2fa(54210.9765625_s)             X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f18, f20, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            708c09ad8388cc57fa8bb49d6aea661a5a9e8314        708c09ad8388cc57fa8bb49d6aea661a5a9e8314        
