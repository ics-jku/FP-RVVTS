# FailID_002030 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x28, 0x0                  // t3
    li x29, 0x802001dd           // t4
    li x30, 0x8017fb60           // t5
    li x31, 0x7ffffe45           // t6
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm', 'x3'}, 'clob': {'x18', 'x3'}})
...
a3(x13)             0xffffffffffffff7d(18446744073709551485)        0xffffffffffffff7d(18446744073709551485)        
...
t4(x29)             0x00000000802001dd(2149581277)                  0x00000000802001dd(2149581277)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b8d4ac1536ee1842ec0e4f77ee23c69923763193        b8d4ac1536ee1842ec0e4f77ee23c69923763193        
