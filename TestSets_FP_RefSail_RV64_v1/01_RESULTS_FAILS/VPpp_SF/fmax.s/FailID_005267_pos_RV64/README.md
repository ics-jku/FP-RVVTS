# FailID_005267 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f25'}, 'clob': {'f3'}})
    fmax.s f3, f25, f7
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffff4e840000(1107296256.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f25                 0xffffffff4e840000(1107296256.0_s)              0xffffffff4e840000(1107296256.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3fda1b3a8ad83a8c8cf1e3d3ac4e7c9d5abb7a08        3fda1b3a8ad83a8c8cf1e3d3ac4e7c9d5abb7a08        
