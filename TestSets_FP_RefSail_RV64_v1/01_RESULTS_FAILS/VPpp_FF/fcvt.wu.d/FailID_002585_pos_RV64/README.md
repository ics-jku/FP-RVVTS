# FailID_002585 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f30:.byte 0x04,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f30
    fld  f30, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x26'}})
    fcvt.wu.d x26, f30, dyn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s10(x26)            0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x26, f30, dyn
+========================================================================================================================+
...
Registers: x26, f30
s10(x26)            0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f30                 0xffffffff4f001804(2149057536.0_s)              0xffffffff4f001804(2149057536.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            573aef95d680b3326f4e0150075f0fa28dd8d8bd        573aef95d680b3326f4e0150075f0fa28dd8d8bd        
