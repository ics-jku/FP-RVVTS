# FailID_003420 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x13, 0x8018004d           // a3
    li x14, 0x7ffffa99           // a4
    li x15, 0xffffffffdd6ad000   // a5
    ...
    li x25, 0x0                  // s9
    li x26, 0xe7                 // s10
    li x27, 0xa2b07740           // s11
    li x28, 0x8                  // t3
    li x29, 0x8018004d           // t4
    li x30, 0x10000              // t5
    li x31, 0xffffffffffffffff   // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x8'}, 'clob': {'f18', 'x8', 'x22'}})
...
f18                 0x3a8842ffd3ce09c9(9.799229100695556e-27_d)     0x08d1bc2308c1b823(3.437580050360946e-266_d)    X
STATES DIFFER: True
```
...
a3(x13)             0x000000008018004d(2149056589)                  0x000000008018004d(2149056589)                  
a4(x14)             0x000000007ffffa99(2147482265)                  0x000000007ffffa99(2147482265)                  
a5(x15)             0xffffffffdd6ad000(18446744073129349120)        0xffffffffdd6ad000(18446744073129349120)        
...
s6(x22)             0x000000007ffffce4(2147482852)                  0x000000007ffffce4(2147482852)                  
...
s11(x27)            0x00000000a2b07740(2729473856)                  0x00000000a2b07740(2729473856)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d13dea3f6af3e5c0c88c19585fdddb23ac90d11e        d13dea3f6af3e5c0c88c19585fdddb23ac90d11e        
