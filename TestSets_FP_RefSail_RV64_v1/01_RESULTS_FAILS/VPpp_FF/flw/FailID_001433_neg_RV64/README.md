# FailID_001433 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x13, 0x801806b0           // a3
    li x14, 0x8000613e           // a4
    li x15, 0x8018089d           // a5
    ...
    li x24, 0x801806f4           // s8
    li x25, 0x8000612b           // s9
    li x26, 0x801ffa01           // s10
    li x27, 0x7ffffe77           // s11
    li x28, 0x0                  // t3
    li x29, 0x800003b1           // t4
    li x30, 0x80280075           // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs'}, 'clob': {'x30', 'f22', 'x20'}})
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x38, x30
t5(x30)             0x000000008007fce5(2148007141)                  0x000000008007fce5(2148007141)
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
t0(x5)              0x0000000000010000(65536)                       0x0000000000010000(65536)                       
...
a5(x15)             0x000000008018089d(2149058717)                  0x000000008018089d(2149058717)                  
...
s4(x20)             0x000000007ffffc71(2147482737)                  0x000000007ffffc71(2147482737)                  
...
t4(x29)             0x00000000800003b1(2147484593)                  0x00000000800003b1(2147484593)                  
t5(x30)             0x000000008007fce5(2148007141)                  0x000000008007fce5(2148007141)                  
t6(x31)             0x0000000000000001(1)                           0x0000000000000001(1)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            20029eeaf56af5198dcf2dc71b75e4fb01068aa4        20029eeaf56af5198dcf2dc71b75e4fb01068aa4        
