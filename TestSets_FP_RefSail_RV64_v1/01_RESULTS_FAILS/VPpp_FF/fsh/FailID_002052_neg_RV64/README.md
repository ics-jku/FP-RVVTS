# FailID_002052 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x9, 0x8003fc1e            // s1
    li x10, 0x1e                 // a0
    li x11, 0x801806cb           // a1
    li x12, 0x3e24c000           // a2
    li x13, 0x801802db           // a3
    li x14, 0x6000               // a4
    li x15, 0x0                  // a5
    li x16, 0x8017fe20           // a6
    li x17, 0x802003cb           // a7
    li x18, 0x8000022a           // s2
    li x19, 0x5e                 // s3
    li x20, 0x3e35c000           // s4
    li x21, 0x80181906           // s5
    li x22, 0x801ffc36           // s6
    li x23, 0x7ffffb5e           // s7
    li x24, 0x17                 // s8
    li x25, 0x8000022a           // s9
    li x26, 0x80180131           // s10
    li x27, 0x8018017e           // s11
    li x28, 0x801ff6a0           // t3
    li x29, 0x0                  // t4
    li x30, 0x0                  // t5
    li x31, 0x72cf1754           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs', 'x17'}, 'clob': {'x17', 'x25'}})
...
t1(x6)              0x0000000080180104(2149056772)                  0x0000000080180104(2149056772)                  
...
a1(x11)             0x00000000801806cb(2149058251)                  0x00000000801806cb(2149058251)                  
a2(x12)             0x000000003e24c000(1042595840)                  0x000000003e24c000(1042595840)                  
...
a6(x16)             0x000000008017fe20(2149056032)                  0x000000008017fe20(2149056032)                  
a7(x17)             0x0000000080180a40(2149059136)                  0x0000000080180a40(2149059136)                  
...
s7(x23)             0x000000007ffffb5e(2147482462)                  0x000000007ffffb5e(2147482462)                  
s8(x24)             0x0000000000000017(23)                          0x0000000000000017(23)                          
...
t6(x31)             0x0000000072cf1754(1926174548)                  0x0000000072cf1754(1926174548)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            fb9b84c8eb72967f72f846d4c3465e9ea864c585        fb9b84c8eb72967f72f846d4c3465e9ea864c585        
