# FailID_003810 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x11, 0x6000               // a1
    li x12, 0xa3                 // a2
    li x13, 0x80280697           // a3
    li x14, 0x7ffffddc           // a4
    li x15, 0x0                  // a5
    ...
    li x21, 0xffffffff8c805000   // s5
    li x22, 0x800002b7           // s6
    li x23, 0x6000               // s7
    li x24, 0x8017faa1           // s8
    li x25, 0x80180761           // s9
    li x26, 0x0                  // s10
    li x27, 0xf0674fb3b36ad584   // s11
    li x28, 0x1                  // t3
    li x29, 0x6000               // t4
    li x30, 0x80180761           // t5
    li x31, 0x80180362           // t6
    // INSTRUCTION ({'dep': {'x12', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x12', 'f6', 'x19'}})
...
f6                  0x8db735633894b403(-1.3596008341984277e-242_d)  0xffffffff08c1b823(1.1659055311619432e-33_s)    X
STATES DIFFER: True
```
...
f6                  0x8db735633894b403(-1.3596008341984277e-242_d)  0xffffffff08c1b823(1.1659055311619432e-33_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, x61, x12
a2(x12)             0x000000007ffffa86(2147482246)                  0x000000007ffffa86(2147482246)
f6                  0x8db735633894b403(-1.3596008341984277e-242_d)  0xffffffff08c1b823(1.1659055311619432e-33_s)    X
+========================================================================================================================+
```
...
fp(x8)              0x00000000803807ed(2151155693)                  0x00000000803807ed(2151155693)                  
...
a4(x14)             0x000000007ffffddc(2147483100)                  0x000000007ffffddc(2147483100)                  
...
s5(x21)             0xffffffff8c805000(18446744071771803648)        0xffffffff8c805000(18446744071771803648)        
...
s9(x25)             0x0000000080180761(2149058401)                  0x0000000080180761(2149058401)                  
...
t5(x30)             0x0000000080180761(2149058401)                  0x0000000080180761(2149058401)                  
t6(x31)             0x0000000080180362(2149057378)                  0x0000000080180362(2149057378)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            e5ee81cddcd77d6af21d3366e5c53fdffa572deb        e5ee81cddcd77d6af21d3366e5c53fdffa572deb        
