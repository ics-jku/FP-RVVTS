# FailID_004095 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x14, 0x801ff756           // a4
    li x15, 0x800580f0           // a5
    li x16, 0x6000               // a6
    li x17, 0x7ffffba9           // a7
    ...
    li x29, 0x800000f0           // t4
    li x30, 0x8017fcd1           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'x11', 'x27', 'f2'}})
...
f2                  0x7ff8000000000000(nan_d)                       0xffffffff0411b423(1.7127382811636563e-36_s)    X
STATES DIFFER: True
```
...
s11(x27)            0x0000000080000542(2147484994)                  0x0000000080000542(2147484994)
f2                  0x7ff8000000000000(nan_d)                       0xffffffff0411b423(1.7127382811636563e-36_s)    X
+========================================================================================================================+
```
...
fp(x8)              0x000000007ffffba6(2147482534)                  0x000000007ffffba6(2147482534)                  
...
a1(x11)             0x00000000800004ca(2147484874)                  0x00000000800004ca(2147484874)                  
...
a4(x14)             0x00000000801ff756(2149578582)                  0x00000000801ff756(2149578582)                  
a5(x15)             0x00000000800580f0(2147844336)                  0x00000000800580f0(2147844336)                  
