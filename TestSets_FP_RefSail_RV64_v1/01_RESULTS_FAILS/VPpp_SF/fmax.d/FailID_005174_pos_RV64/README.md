# FailID_005174 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f23'}})
    fmax.d f23, f19, f15
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f23, f19, f15
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            76e0e56502c1006a2bcadf065c8a0eeee592dfc6        76e0e56502c1006a2bcadf065c8a0eeee592dfc6        
