# FailID_005150 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x00,0x40,0x70,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f22'}})
    fmax.d f22, f4, f21
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x4170400000000000(17039360.0_d)                0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f22                 0x4170400000000000(17039360.0_d)                0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f4, f21
f4                  0x4170400000000000(17039360.0_d)                0x4170400000000000(17039360.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5a329b05f7c78fb23385cbc981db55686e7ea9da        5a329b05f7c78fb23385cbc981db55686e7ea9da        
