# FailID_002040 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x30, 0x6000               // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27', 'f16'}, 'clob': {'x9', 'x27'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c3d16a0e417ff26c13d520891a6ea5034a3fde92        c3d16a0e417ff26c13d520891a6ea5034a3fde92        
