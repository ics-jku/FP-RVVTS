# FailID_005166 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f0', 'fcsr.rm'}, 'clob': {'f8'}})
    fmax.d f8, f15, f0
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x8000000000000000(-0.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            11b11b795bbd7ce14988fa691cfcc66b48f067e7        11b11b795bbd7ce14988fa691cfcc66b48f067e7        
