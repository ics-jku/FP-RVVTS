# FailID_001064 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x3, 0x8018045b            // gp
    li x4, 0x8018008d            // tp
    li x5, 0xfffffffffffffe5e    // t0
    li x6, 0x8027fd46            // t1
    li x7, 0x80200387            // t2
    li x8, 0x0                   // fp
    li x9, 0x185d03              // s1
    li x10, 0x80000248           // a0
    li x11, 0x800007fd           // a1
    li x12, 0x9caaa72c           // a2
    li x13, 0x8018085a           // a3
    li x14, 0x801802bf           // a4
    li x15, 0x8017f9ba           // a5
    li x16, 0x6000               // a6
    ...
    li x21, 0x53                 // s5
    li x22, 0x801801bc           // s6
    li x23, 0x64e3074c           // s7
    li x24, 0x40                 // s8
    li x25, 0x7fffff1a           // s9
    li x26, 0x8017fe4c           // s10
    li x27, 0x801802bf           // s11
    li x28, 0x80180b8b           // t3
    li x29, 0x801fff81           // t4
    li x30, 0x40                 // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x10'}, 'clob': {'x10', 'x19', 'f31'}})
...
f31                 0x000000132140006f(4.05935308646e-313_d)        0x0271b4230261b023(6.767485356171125e-297_d)    X
STATES DIFFER: True
```
...
f31                 0x000000132140006f(4.05935308646e-313_d)        0x0271b4230261b023(6.767485356171125e-297_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x246, x10
a0(x10)             0x0000000080000002(2147483650)                  0x0000000080000002(2147483650)
f31                 0x000000132140006f(4.05935308646e-313_d)        0x0271b4230261b023(6.767485356171125e-297_d)    X
+========================================================================================================================+
```
...
sp(x2)              0x0000000080000358(2147484504)                  0x0000000080000358(2147484504)                  
...
t0(x5)              0xfffffffffffffe5e(18446744073709551198)        0xfffffffffffffe5e(18446744073709551198)        
t1(x6)              0x000000008027fd46(2150104390)                  0x000000008027fd46(2150104390)                  
t2(x7)              0x0000000080200387(2149581703)                  0x0000000080200387(2149581703)                  
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0x0000000000185d03(1596675)                     0x0000000000185d03(1596675)                     
a0(x10)             0x0000000080000002(2147483650)                  0x0000000080000002(2147483650)                  
a1(x11)             0x00000000800007fd(2147485693)                  0x00000000800007fd(2147485693)                  
a2(x12)             0x000000009caaa72c(2628429612)                  0x000000009caaa72c(2628429612)                  
a3(x13)             0x000000008018085a(2149058650)                  0x000000008018085a(2149058650)                  
a4(x14)             0x00000000801802bf(2149057215)                  0x00000000801802bf(2149057215)                  
a5(x15)             0x000000008017f9ba(2149054906)                  0x000000008017f9ba(2149054906)                  
...
s3(x19)             0x000000007ffffdba(2147483066)                  0x000000007ffffdba(2147483066)                  
s4(x20)             0x00000000340191f3(872518131)                   0x00000000340191f3(872518131)                   
s5(x21)             0x0000000000000053(83)                          0x0000000000000053(83)                          
s6(x22)             0x00000000801801bc(2149056956)                  0x00000000801801bc(2149056956)                  
s7(x23)             0x0000000064e3074c(1692600140)                  0x0000000064e3074c(1692600140)                  
s8(x24)             0x0000000000000040(64)                          0x0000000000000040(64)                          
s9(x25)             0x000000007fffff1a(2147483418)                  0x000000007fffff1a(2147483418)                  
s10(x26)            0x000000008017fe4c(2149056076)                  0x000000008017fe4c(2149056076)                  
s11(x27)            0x00000000801802bf(2149057215)                  0x00000000801802bf(2149057215)                  
t3(x28)             0x0000000080180b8b(2149059467)                  0x0000000080180b8b(2149059467)                  
t4(x29)             0x00000000801fff81(2149580673)                  0x00000000801fff81(2149580673)                  
t5(x30)             0x0000000000000040(64)                          0x0000000000000040(64)                          
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            ce05ec411a32293e976a3c7a6816ab0f98d146c5        ce05ec411a32293e976a3c7a6816ab0f98d146c5        
