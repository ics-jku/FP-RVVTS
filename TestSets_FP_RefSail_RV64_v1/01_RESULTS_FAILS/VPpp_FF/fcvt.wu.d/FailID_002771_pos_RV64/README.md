# FailID_002771 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f26:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f26
    fld  f26, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f26', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.d x2, f26, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x2, f26, rdn
+========================================================================================================================+
...
Registers: x2, f26
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f26                 0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e8a56b5406e9eb635bde87808c1eccbd2bb974d9        e8a56b5406e9eb635bde87808c1eccbd2bb974d9        
