# FailID_000197 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x7f,0x0c,0x8a,0x5d,0xff,0xff,0xff,0xff
_reg_f13:.byte 0x00,0x00,0x40,0x9e,0xff,0xf9,0xdf,0xc1
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f28', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'f2'}})
    fdiv.s f2, f13, f28, rdn
```
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f2, f13, f28, rdn
+========================================================================================================================+
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f13, f28
f2                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f13                 0xc1dff9ff9e400000(-2145910393.0_d)             0xc1dff9ff9e400000(-2145910393.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            216674083784b9af5635a4d98d4735d152a063e6        216674083784b9af5635a4d98d4735d152a063e6        
