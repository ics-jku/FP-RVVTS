# FailID_001277 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x11, 0x6bdda000           // a1
    li x12, 0x0                  // a2
    li x13, 0x801802ff           // a3
    li x14, 0x7fffffff           // a4
    li x15, 0x80180370           // a5
    li x16, 0x0                  // a6
    li x17, 0x1                  // a7
    li x18, 0xffffffff80000001   // s2
    li x19, 0xffffffffbfe97000   // s3
    li x20, 0x801e0210           // s4
    li x21, 0x0                  // s5
    li x22, 0x80180270           // s6
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x15'}, 'clob': {'x6', 'f5', 'x15'}})
...
f5                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f5, x2, c2, x15
sp(x2)              0x00000000801807db(2149058523)                  0x00000000801807db(2149058523)
a5(x15)             0x0000000080180632(2149058098)                  0x0000000080180632(2149058098)
f5                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
fp(x8)              0x0000000000000400(1024)                        0x0000000000000400(1024)                        
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x000000008017fd28(2149055784)                  0x000000008017fd28(2149055784)                  
a1(x11)             0x000000006bdda000(1809686528)                  0x000000006bdda000(1809686528)                  
...
s3(x19)             0xffffffffbfe97000(18446744072634331136)        0xffffffffbfe97000(18446744072634331136)        
...
s11(x27)            0x00000000000000c5(197)                         0x00000000000000c5(197)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e50ed4b5f5f14ceae229f2d484b6ac685ad28968        e50ed4b5f5f14ceae229f2d484b6ac685ad28968        
