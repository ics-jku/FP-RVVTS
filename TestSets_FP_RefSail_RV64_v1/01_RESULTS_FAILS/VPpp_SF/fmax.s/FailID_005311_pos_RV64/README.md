# FailID_005311 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f2'}, 'clob': {'f22'}})
    fmax.s f22, f4, f2
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff437b0000(251.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3cf44d386598aa029b256f7a744219c56f9d6325        3cf44d386598aa029b256f7a744219c56f9d6325        
