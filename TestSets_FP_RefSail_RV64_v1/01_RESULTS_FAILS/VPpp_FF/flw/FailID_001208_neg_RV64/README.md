# FailID_001208 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x20, 0x80200f0c           // s4
    li x21, 0x801800bb           // s5
    li x22, 0x0                  // s6
    li x23, 0x8000042f           // s7
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x23'}, 'clob': {'f27', 'x16', 'x23'}})
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff40d80000(6.75_s)                      X
STATES DIFFER: True
```
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff40d80000(6.75_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x28, x23
s7(x23)             0x00000000800006b6(2147485366)                  0x00000000800006b6(2147485366)
...
tp(x4)              0x000000007ffffe8f(2147483279)                  0x000000007ffffe8f(2147483279)                  
...
s4(x20)             0x0000000080200f0c(2149584652)                  0x0000000080200f0c(2149584652)                  
...
s10(x26)            0x00000000000000ed(237)                         0x00000000000000ed(237)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            abfd1cdc66711ff441a17e1cdf94ef9bbf32e81d        abfd1cdc66711ff441a17e1cdf94ef9bbf32e81d        
