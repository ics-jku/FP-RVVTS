# FailID_004830 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x19, 0x8017fc81           // s3
    li x20, 0x2                  // s4
    li x21, 0x6000               // s5
    li x22, 0x8017fec8           // s6
    li x23, 0x800004cf           // s7
    li x24, 0x801ff585           // s8
    li x25, 0x8018050d           // s9
    li x26, 0x8007f77f           // s10
    li x27, 0x9                  // s11
    li x28, 0x0                  // t3
    li x29, 0x200001b            // t4
    li x30, 0x8017fd50           // t5
    li x31, 0xedaf8768           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f13', 'fcsr.rm', 'x26'}, 'clob': {'x21', 'x26'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4e56645bdaa9c22a8f12f828cb0365ec1fb929ba        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x129, x26
s10(x26)            0x00000000801ff8a5(2149578917)                  0x00000000801ff8a5(2149578917)
...
sp(x2)              0x0000000080000645(2147485253)                  0x0000000080000645(2147485253)                  
gp(x3)              0x000000008018076e(2149058414)                  0x000000008018076e(2149058414)                  
tp(x4)              0x00000000000000d6(214)                         0x00000000000000d6(214)                         
t0(x5)              0x000000007ffff907(2147481863)                  0x000000007ffff907(2147481863)                  
...
s5(x21)             0x0000000080180129(2149056809)                  0x0000000080180129(2149056809)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ad64abebbf438d714d5280fabcb2f516cd00479e        ad64abebbf438d714d5280fabcb2f516cd00479e        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4e56645bdaa9c22a8f12f828cb0365ec1fb929ba        X
