# FailID_002981 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0x00,0x00,0xc0,0xc7,0xff,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f20
    fld  f20, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f20, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f20, dyn
+========================================================================================================================+
...
Registers: x2, f20
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f20                 0x41dfffffc7c00000(2147483423.0_d)              0x41dfffffc7c00000(2147483423.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            81c1d822c1e3f6bc20844b3484f879db5f88261b        81c1d822c1e3f6bc20844b3484f879db5f88261b        
