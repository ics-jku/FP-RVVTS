# FailID_005201 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f6'}})
    fmax.d f6, f15, f20
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            45c0b58591e72df5c368a191568a667bc65386cd        45c0b58591e72df5c368a191568a667bc65386cd        
