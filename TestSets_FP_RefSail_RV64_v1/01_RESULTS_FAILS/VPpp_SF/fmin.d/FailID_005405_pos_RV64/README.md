# FailID_005405 VP++ SF pos RV64 fmin.d
...
_reg_f17:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f11', 'fcsr.rm'}, 'clob': {'f17'}})
    fmin.d f17, f11, f17
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0xfff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f17, f11, f17
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f2355f71a7b9ee64c4f91813c9679eba42d1d7f8        f2355f71a7b9ee64c4f91813c9679eba42d1d7f8        
