# FailID_000431 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x02,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f18'}})
    fsqrt.s f18, f2, rup
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff473515ed(46357.92578125_s)            0xffffffff473515ec(46357.921875_s)              X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f18, f2, rup
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f2
f2                  0xffffffff4f001802(2149057024.0_s)              0xffffffff4f001802(2149057024.0_s)
f18                 0xffffffff473515ed(46357.92578125_s)            0xffffffff473515ec(46357.921875_s)              X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            73d80cac6c0fde69b0c9af0214d7cbf38493a2f9        73d80cac6c0fde69b0c9af0214d7cbf38493a2f9        
