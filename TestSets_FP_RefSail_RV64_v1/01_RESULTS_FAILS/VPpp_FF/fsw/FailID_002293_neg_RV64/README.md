# FailID_002293 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x25, 0x1                  // s9
    li x26, 0x0                  // s10
    li x27, 0x8017ff80           // s11
    li x28, 0x8017fa25           // t3
    li x29, 0x80005cd4           // t4
    li x30, 0x8018073f           // t5
    li x31, 0xfd                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f6', 'x27'}, 'clob': {'x27', 'x31'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            edc7fe0e2a8e4d5d3107b84ff1d9d2f6f3198317        edc7fe0e2a8e4d5d3107b84ff1d9d2f6f3198317        
