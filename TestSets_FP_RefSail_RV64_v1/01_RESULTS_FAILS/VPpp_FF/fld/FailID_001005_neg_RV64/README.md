# FailID_001005 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x19, 0xc3                 // s3
    li x20, 0x1                  // s4
    li x21, 0x80180087           // s5
    li x22, 0x6864d70c           // s6
    li x23, 0x0                  // s7
    li x24, 0x153f1000           // s8
    ...
    li x30, 0x6000               // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'x13', 'x12', 'f16'}})
...
f16                 0x41e00300aa000000(2149057872.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
f16                 0x41e00300aa000000(2149057872.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, x349, x13
a3(x13)             0x0000000080000349(2147484489)                  0x0000000080000349(2147484489)
f16                 0x41e00300aa000000(2149057872.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
t2(x7)              0x00000000801804bb(2149057723)                  0x00000000801804bb(2149057723)                  
...
a2(x12)             0x0000000080000349(2147484489)                  0x0000000080000349(2147484489)                  
a3(x13)             0x0000000080000349(2147484489)                  0x0000000080000349(2147484489)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cf01d363ade74a889b7d71903aae22c8cb00ac15        cf01d363ade74a889b7d71903aae22c8cb00ac15        
