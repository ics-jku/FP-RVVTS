# FailID_004175 VP++ SF neg RV64 fmin.s
...
* FailID: 4175
* Isolated failing instruction: `fmin.s`
...
_reg_f22:.byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0x00,0xfd,0xff,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f22', 'f25'}, 'clob': {'f19'}})
    fmin.s f19, f22, f25
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f19, f22, f25
+========================================================================================================================+
...
f19                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f22, f25
f19                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff7fc00000(nan_s)                       X
f22                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff5f800000(1.8446744073709552e+19_s)
f25                 0xc1dffffffd000000(-2147483636.0_d)             0xc1dffffffd000000(-2147483636.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e702fc52895d73dc1a75ec19fe1adfa076fc947f        e702fc52895d73dc1a75ec19fe1adfa076fc947f        
