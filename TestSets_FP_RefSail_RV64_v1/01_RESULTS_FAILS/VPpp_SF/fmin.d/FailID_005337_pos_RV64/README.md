# FailID_005337 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x80,0x50,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f10'}})
    fmin.d f10, f5, f27
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x4050800000000000(66.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f10                 0x4050800000000000(66.0_d)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f5, f27
f5                  0x4050800000000000(66.0_d)                      0x4050800000000000(66.0_d)
f10                 0x4050800000000000(66.0_d)                      0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0969e4b60d94b9a79117566febadfba48dce064e        0969e4b60d94b9a79117566febadfba48dce064e        
