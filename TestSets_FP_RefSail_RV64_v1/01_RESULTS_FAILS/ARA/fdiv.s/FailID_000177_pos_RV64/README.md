# FailID_000177 ARA pos RV64 fdiv.s
...
_reg_f29:.byte 0x00,0x00,0x00,0x66,0x00,0xfa,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f25'}})
    fdiv.s f25, f8, f29, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f8, f29, dyn
+========================================================================================================================+
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f8, f29
f8                  0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f29                 0xc1dffa0066000000(-2145911192.0_d)             0xc1dffa0066000000(-2145911192.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1c42ce85f12c2c48aa1a422bfac82f387f8eeaca        1c42ce85f12c2c48aa1a422bfac82f387f8eeaca        
