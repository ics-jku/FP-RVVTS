# FailID_004152 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f5'}, 'clob': {'f29'}})
    fmin.d f29, f5, f6
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x2c6576226345495b(8.038049615433958e-95_d)     0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7e838fa0b44a11005a8b521257d223c6a85a772e        7e838fa0b44a11005a8b521257d223c6a85a772e        
