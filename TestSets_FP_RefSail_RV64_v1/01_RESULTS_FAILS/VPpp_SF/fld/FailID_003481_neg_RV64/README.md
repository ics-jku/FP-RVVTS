# FailID_003481 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x19, 0x0                  // s3
    li x20, 0x0                  // s4
    li x21, 0x801806b9           // s5
    li x22, 0x800007bc           // s6
    li x23, 0xa3                 // s7
    li x24, 0x801ff605           // s8
    li x25, 0x28d86000           // s9
    li x26, 0x8000006e           // s10
    li x27, 0x800004ab           // s11
    li x28, 0xffff               // t3
    li x29, 0x80005ace           // t4
    li x30, 0x800d591d           // t5
    li x31, 0xc1                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm'}, 'clob': {'x21', 'x18', 'f4'}})
...
f4                  0x41dfffffffc00000(2147483647.0_d)              0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f4                  0x41dfffffffc00000(2147483647.0_d)              0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x5, f4, x21
t0(x5)              0x0000000080180388(2149057416)                  0x0000000080180388(2149057416)
s5(x21)             0x00000000801800c4(2149056708)                  0x00000000801800c4(2149056708)
f4                  0x41dfffffffc00000(2147483647.0_d)              0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
gp(x3)              0x00000000000000e3(227)                         0x00000000000000e3(227)                         
tp(x4)              0x000000008018041a(2149057562)                  0x000000008018041a(2149057562)                  
t0(x5)              0x0000000080180388(2149057416)                  0x0000000080180388(2149057416)                  
...
s1(x9)              0x00000000801800a0(2149056672)                  0x00000000801800a0(2149056672)                  
...
a2(x12)             0x000000008018038e(2149057422)                  0x000000008018038e(2149057422)                  
...
s7(x23)             0x00000000000000a3(163)                         0x00000000000000a3(163)                         
s8(x24)             0x00000000801ff605(2149578245)                  0x00000000801ff605(2149578245)                  
s9(x25)             0x0000000028d86000(685268992)                   0x0000000028d86000(685268992)                   
s10(x26)            0x000000008000006e(2147483758)                  0x000000008000006e(2147483758)                  
s11(x27)            0x00000000800004ab(2147484843)                  0x00000000800004ab(2147484843)                  
t3(x28)             0x000000000000ffff(65535)                       0x000000000000ffff(65535)                       
t4(x29)             0x0000000080005ace(2147506894)                  0x0000000080005ace(2147506894)                  
t5(x30)             0x00000000800d591d(2148358429)                  0x00000000800d591d(2148358429)                  
t6(x31)             0x00000000000000c1(193)                         0x00000000000000c1(193)                         

STATE               REF                                             DUT                                             DIFF
xmemhash            5b53832e49bf07db7d02845e78c75da1baa58aca        5b53832e49bf07db7d02845e78c75da1baa58aca        
