# FailID_000048 ARA neg RV64 fsqrt.h
...
* FailID: 48
* Isolated failing instruction: `fsqrt.h`
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x00,0x50,0xfe,0xf9,0xdf,0xc1
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f7', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f18'}})
    fsqrt.h f18, f7
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f18, f7
+========================================================================================================================+
Attributes:  special values ['nan', 'zero'], precision mismatch ('h', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f7
f7                  0xc1dff9fe50000000(-2145909056.0_d)             0xc1dff9fe50000000(-2145909056.0_d)
f18                 0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5a6fb0aa5e7c774a1fded96096213de3133694c6        5a6fb0aa5e7c774a1fded96096213de3133694c6        
