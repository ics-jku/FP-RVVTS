# FailID_000184 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f26:.byte 0x00,0x00,0x00,0x00,0x00,0x80,0x56,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fdiv.s f26, f25, f2, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f26, f25, f2, rmm
+========================================================================================================================+
...
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f25, f2
f2                  0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f425542b2699722d52a0a608132e72ce45a5ac63        f425542b2699722d52a0a608132e72ce45a5ac63        
