# FailID_005537 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f4'}, 'clob': {'f21'}})
    fmin.s f21, f4, f17
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            68e424aa684b6ab3f939e400c608c363d7c78cb8        68e424aa684b6ab3f939e400c608c363d7c78cb8        
