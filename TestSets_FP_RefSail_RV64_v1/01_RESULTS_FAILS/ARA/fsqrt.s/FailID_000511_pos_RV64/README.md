# FailID_000511 ARA pos RV64 fsqrt.s
...
_reg_f30:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f19'}})
    fsqrt.s f19, f30, rtz
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f19, f30, rtz
+========================================================================================================================+
...
Registers: f19, f30
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f30                 0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5ce698abfcc188388a95680789059a9246c1781d        5ce698abfcc188388a95680789059a9246c1781d        
