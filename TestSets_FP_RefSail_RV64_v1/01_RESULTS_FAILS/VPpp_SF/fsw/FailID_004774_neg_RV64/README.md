# FailID_004774 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x14, 0x0                  // a4
    li x15, 0x80180d62           // a5
    li x16, 0x100000             // a6
    li x17, 0x80180556           // a7
    li x18, 0x400                // s2
    li x19, 0xffffffffe67cc000   // s3
    li x20, 0x7ffffabe           // s4
    li x21, 0x200                // s5
    li x22, 0x80000474           // s6
    li x23, 0x8017fced           // s7
    li x24, 0x693f0              // s8
    li x25, 0x62                 // s9
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm', 'x4'}, 'clob': {'x4', 'x7'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        c0d302290aca68fe98fc6a33d74cabb3bffc510d        X
...
sp(x2)              0xfffffffffffffef7(18446744073709551351)        0xfffffffffffffef7(18446744073709551351)        
gp(x3)              0x000000007ffffc80(2147482752)                  0x000000007ffffc80(2147482752)                  
tp(x4)              0x00000000802805f7(2150106615)                  0x00000000802805f7(2150106615)                  
t0(x5)              0x00000000ae3bb70c(2923149068)                  0x00000000ae3bb70c(2923149068)                  
...
a5(x15)             0x0000000080180d62(2149059938)                  0x0000000080180d62(2149059938)                  
...
s3(x19)             0xffffffffe67cc000(18446744073281519616)        0xffffffffe67cc000(18446744073281519616)        
...
s7(x23)             0x000000008017fced(2149055725)                  0x000000008017fced(2149055725)                  
s8(x24)             0x00000000000693f0(431088)                      0x00000000000693f0(431088)                      
s9(x25)             0x0000000000000062(98)                          0x0000000000000062(98)                          
s10(x26)            0x000000008017f836(2149054518)                  0x000000008017f836(2149054518)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a6b255f3f5920a3290bc2f6376f002c2817fd885        a6b255f3f5920a3290bc2f6376f002c2817fd885        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        c0d302290aca68fe98fc6a33d74cabb3bffc510d        X
