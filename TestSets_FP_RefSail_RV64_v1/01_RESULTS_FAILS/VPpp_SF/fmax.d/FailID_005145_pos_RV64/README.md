# FailID_005145 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f16'}})
    fmax.d f16, f28, f24
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x0000000000000000(0.0_d)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f16, f28, f24
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            868b9b363c7b4a64b758dc885a9d9750e790e161        868b9b363c7b4a64b758dc885a9d9750e790e161        
