# FailID_005229 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f2'}, 'clob': {'f27'}})
    fmax.s f27, f2, f23
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            78680916bc6494591d209ad81b68eab5b05be81a        78680916bc6494591d209ad81b68eab5b05be81a        
