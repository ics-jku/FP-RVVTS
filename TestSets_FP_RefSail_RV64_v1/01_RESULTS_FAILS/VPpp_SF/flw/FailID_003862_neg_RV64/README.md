# FailID_003862 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'x24', 'f5', 'x23'}})
...
f5                  0xce7b358e65ca21a3(-1.173693904724524e+70_d)    0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
s9(x25)             0x00000000000000c0(192)                         0x00000000000000c0(192)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            83b0a9ddab84ca3a6e591604e58cbae733bc06a9        83b0a9ddab84ca3a6e591604e58cbae733bc06a9        
