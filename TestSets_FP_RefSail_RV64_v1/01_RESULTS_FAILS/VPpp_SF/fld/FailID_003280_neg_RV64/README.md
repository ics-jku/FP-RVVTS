# FailID_003280 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x21, 0x80000804           // s5
    li x22, 0xc8fa2768           // s6
    li x23, 0x6000               // s7
    li x24, 0x7ffffe85           // s8
    li x25, 0x7ffffa6f           // s9
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x9', 'fcsr.rm'}, 'clob': {'x11', 'x9', 'f2'}})
...
f2                  0x7fffffff7fc00000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
s3(x19)             0x0000000080000404(2147484676)                  0x0000000080000404(2147484676)                  
s4(x20)             0x00000000f79607a8(4153804712)                  0x00000000f79607a8(4153804712)                  
s5(x21)             0x0000000080000804(2147485700)                  0x0000000080000804(2147485700)                  
...
s9(x25)             0x000000007ffffa6f(2147482223)                  0x000000007ffffa6f(2147482223)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d9e3ef071a3d95218b1e11196b00dfbe6597a2e6        d9e3ef071a3d95218b1e11196b00dfbe6597a2e6        
