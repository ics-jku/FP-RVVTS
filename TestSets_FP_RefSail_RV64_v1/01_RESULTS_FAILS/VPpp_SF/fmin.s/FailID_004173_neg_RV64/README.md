# FailID_004173 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f13', 'fcsr.rm', 'f29'}, 'clob': {'f11'}})
    fmin.s f11, f29, f13
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff80000383(-1.2597673194280105e-42_s)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f29, f13
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            de8389c43c32f47b84795ad8a412ad8d38b0ea2d        de8389c43c32f47b84795ad8a412ad8d38b0ea2d        
