# FailID_005184 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x80
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f30'}, 'clob': {'f2'}})
    fmax.d f2, f0, f30
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x800000132140006f(-4.05935308646e-313_d)       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f0, f30
f0                  0x800000132140006f(-4.05935308646e-313_d)       0x800000132140006f(-4.05935308646e-313_d)
f2                  0x800000132140006f(-4.05935308646e-313_d)       0x7ff8000000000000(nan_d)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5babfedd5de6b67e27c1b903cb4feb903b5688ec        5babfedd5de6b67e27c1b903cb4feb903b5688ec        
