# FailID_000142 ARA pos RV64 fdiv.s
...
_reg_f30:.byte 0x00,0x00,0xc0,0x06,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'f16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fdiv.s f29, f16, f30, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f16, f30, rup
+========================================================================================================================+
...
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f16, f30
f16                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f30                 0x41e0030006c00000(2149056566.0_d)              0x41e0030006c00000(2149056566.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            77ba93c5dac9d925f1453c180ba1bf5a6bfb1cda        77ba93c5dac9d925f1453c180ba1bf5a6bfb1cda        
