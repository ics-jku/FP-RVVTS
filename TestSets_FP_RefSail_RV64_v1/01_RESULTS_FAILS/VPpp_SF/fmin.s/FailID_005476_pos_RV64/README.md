# FailID_005476 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f0', 'fcsr.rm'}, 'clob': {'f0'}})
    fmin.s f0, f21, f0
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff00000000(0.0_s)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5b924d646d4cec65f7cc944325f812e080b084e8        5b924d646d4cec65f7cc944325f812e080b084e8        
