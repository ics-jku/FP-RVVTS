# FailID_000484 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0xfd,0x1f,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f26:.byte 0x63,0x3d,0xde,0xe1,0x61,0x12,0x2c,0x26
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f25'}})
    fsqrt.s f25, f26, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f25, f26, rup
+========================================================================================================================+
...
f26                 0x262c1261e1de3d63(8.293964325241753e-125_d)    0x262c1261e1de3d63(8.293964325241753e-125_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2a72b2fa21bf74180e58b737e9d8663a2548f785        2a72b2fa21bf74180e58b737e9d8663a2548f785        
