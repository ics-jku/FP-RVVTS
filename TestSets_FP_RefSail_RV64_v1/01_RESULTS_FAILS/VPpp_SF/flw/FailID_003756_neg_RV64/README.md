# FailID_003756 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'f22', 'x25'}})
...
f22                 0x0000000000000000(0.0_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f22                 0x0000000000000000(0.0_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x591, x5
t0(x5)              0x000000007ffffa6f(2147482223)                  0x000000007ffffa6f(2147482223)
f22                 0x0000000000000000(0.0_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            80f2e9cb6f915b946c466a75f12eb593ac04f164        80f2e9cb6f915b946c466a75f12eb593ac04f164        
