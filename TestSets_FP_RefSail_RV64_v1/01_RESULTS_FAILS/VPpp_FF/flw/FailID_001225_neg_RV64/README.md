# FailID_001225 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x25, 0x3ffffc980000       // s9
    li x26, 0x801802cf           // s10
    li x27, 0x39                 // s11
    li x28, 0x6000               // t3
    li x29, 0x0                  // t4
    li x30, 0x800066bf           // t5
    li x31, 0x8017fba3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'x30', 'f24', 'x25'}})
...
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            32fb5c8529ef05cd8a30d5d4466c479f70143a06        32fb5c8529ef05cd8a30d5d4466c479f70143a06        
