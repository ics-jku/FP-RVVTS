# FailID_000148 ARA pos RV64 fdiv.s
...
_reg_f7: .byte 0x00,0x00,0x80,0x4f,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f1'}})
    fdiv.s f1, f20, f7, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff7fc00000(nan_s)                       0xffffffff1140006f(1.5146262991633319e-28_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f1, f20, f7, rdn
+========================================================================================================================+
...
Registers: f1, f20, f7
f1                  0xffffffff7fc00000(nan_s)                       0xffffffff1140006f(1.5146262991633319e-28_s)    X
f7                  0xffffffff4f800000(4294967296.0_s)              0xffffffff4f800000(4294967296.0_s)
f20                 0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c53323747a172f28d856f58b7d25219ef110e5f7        c53323747a172f28d856f58b7d25219ef110e5f7        
