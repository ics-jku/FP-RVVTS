# FailID_002093 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x17, 0x0                  // a7
    li x18, 0x80191aa2           // s2
    li x19, 0x802002f1           // s3
    li x20, 0x222                // s4
    li x21, 0x0                  // s5
    li x22, 0xca                 // s6
    li x23, 0x300                // s7
    li x24, 0xffffffffbea55000   // s8
    li x25, 0x0                  // s9
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x15', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'x18', 'x15'}})
...
s2(x18)             0x0000000080180259(2149057113)                  0x0000000080180259(2149057113)                  
...
s8(x24)             0xffffffffbea55000(18446744072613089280)        0xffffffffbea55000(18446744072613089280)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0533c8bba30673f4825346a6f30b78d2c098b4b5        0533c8bba30673f4825346a6f30b78d2c098b4b5        
