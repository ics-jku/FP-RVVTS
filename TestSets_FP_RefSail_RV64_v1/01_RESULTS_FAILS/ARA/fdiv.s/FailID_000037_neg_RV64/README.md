# FailID_000037 ARA neg RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x06,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f15:.byte 0x06,0xad,0x4a,0xc6,0x9d,0x30,0xc2,0x6c
_reg_f30:.byte 0x98,0x11,0x1c,0xe3,0x74,0x2d,0x4b,0xf6
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'f15', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f12'}})
    fdiv.s f12, f15, f30, rdn
```
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff22a63995(4.5055357505196655e-18_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f12, f15, f30, rdn
+========================================================================================================================+
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff22a63995(4.5055357505196655e-18_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f15, f30
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff22a63995(4.5055357505196655e-18_s)    X
f15                 0x6cc2309dc64aad06(7.838219077080749e+215_d)    0x6cc2309dc64aad06(7.838219077080749e+215_d)
f30                 0xf64b2d74e31c1198(-6.685852472095025e+261_d)   0xf64b2d74e31c1198(-6.685852472095025e+261_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1e1c7d82e22b2b1fb3ebb1e594625c8926942a8        a1e1c7d82e22b2b1fb3ebb1e594625c8926942a8        
