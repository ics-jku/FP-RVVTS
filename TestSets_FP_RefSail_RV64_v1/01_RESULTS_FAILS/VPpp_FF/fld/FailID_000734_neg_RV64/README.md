# FailID_000734 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x18'}, 'clob': {'x18', 'f24', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            df0ee05e08a30bf8db7a7def56b89b6bfd5891d4        df0ee05e08a30bf8db7a7def56b89b6bfd5891d4        
