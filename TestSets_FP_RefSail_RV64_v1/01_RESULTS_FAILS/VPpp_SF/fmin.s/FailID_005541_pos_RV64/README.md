# FailID_005541 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f11', 'fcsr.rm'}, 'clob': {'f16'}})
    fmin.s f16, f15, f11
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f16, f15, f11
+========================================================================================================================+
...
f16                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f15, f11
f11                 0xfff8000000000000(nan_d)                       0xfff8000000000000(nan_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e15191f5cff1b48d5f9d4a2104749b99766524e2        e15191f5cff1b48d5f9d4a2104749b99766524e2        
