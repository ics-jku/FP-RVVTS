# FailID_003498 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x12, 0x0                  // a2
    li x13, 0x7ffffebc           // a3
    li x14, 0x0                  // a4
    li x15, 0x200                // a5
    li x16, 0x801806aa           // a6
    li x17, 0x0                  // a7
    li x18, 0xfffffffffffffc0c   // s2
    li x19, 0x0                  // s3
    li x20, 0x81                 // s4
    li x21, 0x1                  // s5
    li x22, 0x1                  // s6
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x2'}, 'clob': {'f16', 'x14', 'x2'}})
...
f16                 0x7ff8000000000000(nan_d)                       0x0001b2830271b423(2.36040222067735e-309_d)     X
STATES DIFFER: True
```
...
f16                 0x7ff8000000000000(nan_d)                       0x0001b2830271b423(2.36040222067735e-309_d)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, x16, x2
sp(x2)              0x00000000800001bb(2147484091)                  0x00000000800001bb(2147484091)
a6(x16)             0x00000000801806aa(2149058218)                  0x00000000801806aa(2149058218)
f16                 0x7ff8000000000000(nan_d)                       0x0001b2830271b423(2.36040222067735e-309_d)     X
+========================================================================================================================+
```
...
tp(x4)              0x000000007fffff6e(2147483502)                  0x000000007fffff6e(2147483502)                  
...
a3(x13)             0x000000007ffffebc(2147483324)                  0x000000007ffffebc(2147483324)                  
...
s2(x18)             0xfffffffffffffc0c(18446744073709550604)        0xfffffffffffffc0c(18446744073709550604)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c3e67c3d504bd79a4b9d2be15b4135112863330a        c3e67c3d504bd79a4b9d2be15b4135112863330a        
