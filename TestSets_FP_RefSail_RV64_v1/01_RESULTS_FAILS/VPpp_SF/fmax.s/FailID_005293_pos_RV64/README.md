# FailID_005293 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f4'}, 'clob': {'f6'}})
    fmax.s f6, f4, f26
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0xffffffff4efffffa(2147482880.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a181886d9b120a5666b3c9b9306ccd9b62c26b26        a181886d9b120a5666b3c9b9306ccd9b62c26b26        
