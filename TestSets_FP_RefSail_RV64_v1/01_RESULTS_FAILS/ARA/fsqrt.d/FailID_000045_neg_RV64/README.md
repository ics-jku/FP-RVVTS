# FailID_000045 ARA neg RV64 fsqrt.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f3'}, 'clob': {'f17'}})
    fsqrt.d f17, f3, rup
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x40e6a2bd27816249(46357.91107243725_d)         0x40e6a2bd27816248(46357.911072437244_d)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f17, f3, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            530199beffda3dc21f4206870db64eb185e155d0        530199beffda3dc21f4206870db64eb185e155d0        
