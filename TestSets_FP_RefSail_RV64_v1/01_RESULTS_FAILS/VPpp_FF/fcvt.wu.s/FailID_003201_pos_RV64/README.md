# FailID_003201 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0xc0,0x25,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x25'}})
    fcvt.wu.s x25, f3, rup
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x25, f3, rup
+========================================================================================================================+
...
Registers: x25, f3
s9(x25)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f3                  0x41e0030025c00000(2149056814.0_d)              0x41e0030025c00000(2149056814.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fcef0cb49bface83ea0b75582b081037862908a0        fcef0cb49bface83ea0b75582b081037862908a0        
