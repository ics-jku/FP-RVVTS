# FailID_005283 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0xfb,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f7: .byte 0x00,0x00,0x00,0x00,0x00,0xc0,0x5c,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'f6', 'fcsr.rm'}, 'clob': {'f12'}})
    fmax.s f12, f6, f7
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff4f0017fb(2149055232.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f6, f7
f6                  0xffffffff4f0017fb(2149055232.0_s)              0xffffffff4f0017fb(2149055232.0_s)
f7                  0x405cc00000000000(115.0_d)                     0x405cc00000000000(115.0_d)
f12                 0xffffffff4f0017fb(2149055232.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7d85a1ec79c45bd4a951053d7c36e55ee5f6b7e5        7d85a1ec79c45bd4a951053d7c36e55ee5f6b7e5        
