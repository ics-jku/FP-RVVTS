# FailID_005516 VP++ SF pos RV64 fmin.s
...
_reg_f28:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f28'}, 'clob': {'f25'}})
    fmin.s f25, f28, f14
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f25, f28, f14
+========================================================================================================================+
...
f25                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f28, f14
f14                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f25                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
f28                 0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9af4f5bfb97ac994859a283b10d8b54b5a21f4ed        9af4f5bfb97ac994859a283b10d8b54b5a21f4ed        
