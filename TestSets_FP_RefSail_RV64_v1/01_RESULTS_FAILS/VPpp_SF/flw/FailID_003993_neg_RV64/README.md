# FailID_003993 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0xb0                 // s10
    li x27, 0x801f3cc4           // s11
    li x28, 0x80180696           // t3
    li x29, 0x80000662           // t4
    li x30, 0x8027fbaf           // t5
    li x31, 0x8f                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x7'}, 'clob': {'x12', 'f4', 'x7'}})
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
a2(x12)             0x0000000080000576(2147485046)                  0x0000000080000576(2147485046)                  
...
s11(x27)            0x00000000801f3cc4(2149530820)                  0x00000000801f3cc4(2149530820)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d06f96d72832d487e1c85259f8778111d3436f3f        d06f96d72832d487e1c85259f8778111d3436f3f        
