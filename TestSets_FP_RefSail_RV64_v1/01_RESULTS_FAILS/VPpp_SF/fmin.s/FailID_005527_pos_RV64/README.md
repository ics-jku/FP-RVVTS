# FailID_005527 VP++ SF pos RV64 fmin.s
...
_reg_f27:.byte 0x13,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f17'}, 'clob': {'f27'}})
    fmin.s f27, f10, f17
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f27, f10, f17
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7d4be9ce96d904a4d86739ad7f406b1ff6aa3c99        7d4be9ce96d904a4d86739ad7f406b1ff6aa3c99        
