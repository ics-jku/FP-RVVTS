# FailID_000400 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x03,0x00,0x00,0x4f,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f27'}})
    fsqrt.s f27, f19, dyn
```
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff473504f5(46340.95703125_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f27, f19, dyn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f19
f19                 0x7fffffff4f000003(nan_d)                       0x7fffffff4f000003(nan_d)
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff473504f5(46340.95703125_s)            X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            beb05c3e64def64760d3ccc91f70803b986fe435        beb05c3e64def64760d3ccc91f70803b986fe435        
