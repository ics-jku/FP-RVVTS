# FailID_000741 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x2, 0x80200414            // sp
    li x3, 0x64                  // gp
    li x4, 0xffffffff7fe7fab6    // tp
    li x5, 0x801800b3            // t0
    li x6, 0x802002f3            // t1
    li x7, 0xffffffffffffffff    // t2
    li x8, 0x6000                // fp
    li x9, 0x801804ef            // s1
    li x10, 0x800005c9           // a0
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'x26', 'f27'}})
...
f27                 0xffffffff7fc00000(nan_s)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
tp(x4)              0xffffffff7fe7fab6(18446744071560493750)        0xffffffff7fe7fab6(18446744071560493750)        
t0(x5)              0x00000000801800b3(2149056691)                  0x00000000801800b3(2149056691)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6cc67ef0a42d6e16ab8372eb07e9e217ac958dd7        6cc67ef0a42d6e16ab8372eb07e9e217ac958dd7        
