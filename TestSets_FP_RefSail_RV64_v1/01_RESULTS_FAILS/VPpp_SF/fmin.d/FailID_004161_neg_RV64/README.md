# FailID_004161 VP++ SF neg RV64 fmin.d
...
_reg_f15:.byte 0x00,0x00,0x00,0x00,0xe0,0xff,0xef,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f31'}, 'clob': {'f15'}})
    fmin.d f15, f14, f31
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x41e00300aa000000(2149057872.0_d)              0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f15, f14, f31
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a020341ee976c03c919462cbcc789330354e9035        a020341ee976c03c919462cbcc789330354e9035        
