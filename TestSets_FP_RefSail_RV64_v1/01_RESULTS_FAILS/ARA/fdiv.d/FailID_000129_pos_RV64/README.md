# FailID_000129 ARA pos RV64 fdiv.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0xc6,0xfe,0x17,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f21'}})
    fdiv.d f21, f26, f21, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0x40431daa9f55e674(38.23176948255869_d)         0x40431daa9f55e673(38.23176948255868_d)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.d f21, f26, f21, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a8fcb0fd39211821bd1a2a05fe2fed17a1047e2b        a8fcb0fd39211821bd1a2a05fe2fed17a1047e2b        
