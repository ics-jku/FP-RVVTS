# FailID_004184 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f26'}, 'clob': {'x11'}})
    fmv.x.h x11, f26
```
...
```
REG                 REF                                             DUT                                             DIFF
a1(x11)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e046298e7257f981ef563312160ebf52c31adc6c        e046298e7257f981ef563312160ebf52c31adc6c        
