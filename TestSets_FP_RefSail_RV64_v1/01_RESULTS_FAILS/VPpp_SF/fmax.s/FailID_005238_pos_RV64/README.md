# FailID_005238 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'f29'}})
    fmax.s f29, f10, f9
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2d416af9c2351d8f164383a6825f75f19558e4fd        2d416af9c2351d8f164383a6825f75f19558e4fd        
