# FailID_002547 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f31:.byte 0xfa,0xff,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f31
    fld  f31, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x28'}})
    fcvt.wu.d x28, f31, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x28, f31, rdn
+========================================================================================================================+
...
Registers: x28, f31
t3(x28)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f31                 0xffffffffcefffffa(-2147482880.0_s)             0xffffffffcefffffa(-2147482880.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a5ea943977045b45e5257bb953a523c8b6a161b8        a5ea943977045b45e5257bb953a523c8b6a161b8        
