# FailID_004382 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x9, 0x2c                  // s1
    li x10, 0x801800bb           // a0
    li x11, 0x80180003           // a1
    li x12, 0x8                  // a2
    li x13, 0x8017fe49           // a3
    li x14, 0x800004ab           // a4
    li x15, 0x1                  // a5
    li x16, 0x802005b6           // a6
    li x17, 0x801ff2b3           // a7
    li x18, 0x8018000d           // s2
    li x19, 0x194b4000           // s3
    li x20, 0x4000000            // s4
    li x21, 0x800006b6           // s5
    li x22, 0x51b0233401931b     // s6
    li x23, 0x8017fbcb           // s7
    li x24, 0x1                  // s8
    li x25, 0x1                  // s9
    li x26, 0x8017fff5           // s10
    li x27, 0x8017fd72           // s11
    li x28, 0x801ff438           // t3
    li x29, 0x65130760           // t4
    li x30, 0xffffffffcd24c000   // t5
    li x31, 0x26                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm', 'x2'}, 'clob': {'x31', 'x2'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d2e237c2bcaf8dc4ba9739876a64d23388b6685a        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f21, x70, x2
sp(x2)              0x0000000080200512(2149582098)                  0x0000000080200512(2149582098)
...
ra(x1)              0x00000000800000b9(2147483833)                  0x00000000800000b9(2147483833)                  
sp(x2)              0x0000000080200512(2149582098)                  0x0000000080200512(2149582098)                  
...
s1(x9)              0x000000000000002c(44)                          0x000000000000002c(44)                          
a0(x10)             0x00000000801800bb(2149056699)                  0x00000000801800bb(2149056699)                  
...
a6(x16)             0x00000000802005b6(2149582262)                  0x00000000802005b6(2149582262)                  
a7(x17)             0x00000000801ff2b3(2149577395)                  0x00000000801ff2b3(2149577395)                  
s2(x18)             0x000000008018000d(2149056525)                  0x000000008018000d(2149056525)                  
s3(x19)             0x00000000194b4000(424361984)                   0x00000000194b4000(424361984)                   
...
s6(x22)             0x0051b0233401931b(22993138356425499)           0x0051b0233401931b(22993138356425499)           
s7(x23)             0x000000008017fbcb(2149055435)                  0x000000008017fbcb(2149055435)                  
s8(x24)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s9(x25)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s10(x26)            0x000000008017fff5(2149056501)                  0x000000008017fff5(2149056501)                  
s11(x27)            0x000000008017fd72(2149055858)                  0x000000008017fd72(2149055858)                  
t3(x28)             0x00000000801ff438(2149577784)                  0x00000000801ff438(2149577784)                  
...
t6(x31)             0x000000008018070a(2149058314)                  0x000000008018070a(2149058314)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            a10eae42a971607d97c11d88a0ec9e05084789a3        a10eae42a971607d97c11d88a0ec9e05084789a3        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        d2e237c2bcaf8dc4ba9739876a64d23388b6685a        X
