# FailID_000776 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x801800cf           // s11
    li x28, 0x7ffffcd4           // t3
    li x29, 0x1                  // t4
    li x30, 0x8017fa6b           // t5
    li x31, 0x7ffff99c           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'f21', 'x18'}})
...
f21                 0xffffffff8000000b(-1.5414283107572988e-44_s)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
a3(x13)             0x0000000080180137(2149056823)                  0x0000000080180137(2149056823)                  
...
s11(x27)            0x00000000801800cf(2149056719)                  0x00000000801800cf(2149056719)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9d369323e5964ea89c3d06c28e9fae20fbc7bfb4        9d369323e5964ea89c3d06c28e9fae20fbc7bfb4        
