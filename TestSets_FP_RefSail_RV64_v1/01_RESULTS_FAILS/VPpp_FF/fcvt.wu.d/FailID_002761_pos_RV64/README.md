# FailID_002761 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0xe0,0x8c,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x18'}})
    fcvt.wu.d x18, f23
```
...
```
REG                 REF                                             DUT                                             DIFF
s2(x18)             0xffffffff80000467(18446744071562069095)        0x0000000080000467(2147484775)                  X
...
Registers: x18, f23
s2(x18)             0xffffffff80000467(18446744071562069095)        0x0000000080000467(2147484775)                  X
f23                 0x41e000008ce00000(2147484775.0_d)              0x41e000008ce00000(2147484775.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dcfad80c2f2a3f1dc7d81af6211aac215bcd5975        dcfad80c2f2a3f1dc7d81af6211aac215bcd5975        
