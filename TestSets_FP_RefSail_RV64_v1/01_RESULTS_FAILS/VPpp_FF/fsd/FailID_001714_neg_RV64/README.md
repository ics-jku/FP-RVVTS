# FailID_001714 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x13, 0x0                  // a3
    li x14, 0x0                  // a4
    li x15, 0x80200409           // a5
    li x16, 0x80180715           // a6
    li x17, 0x80000814           // a7
    li x18, 0x8017fe1c           // s2
    li x19, 0x80180711           // s3
    li x20, 0x8018685c           // s4
    li x21, 0x8017f91e           // s5
    li x22, 0xfffffffffffffff3   // s6
    li x23, 0x80000631           // s7
    li x24, 0x801806df           // s8
    li x25, 0x801ffb76           // s9
    li x26, 0x8018041d           // s10
    li x27, 0x0                  // s11
    li x28, 0xb1                 // t3
    li x29, 0x800000c4           // t4
    li x30, 0x6000               // t5
    li x31, 0x802004c4           // t6
    // INSTRUCTION ({'dep': {'x4', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'x4', 'x1'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        16071d3239622ceaa3957c7c4d1ede29d264f7ef        X
...
ra(x1)              0x00000000801807a8(2149058472)                  0x00000000801807a8(2149058472)                  
...
tp(x4)              0x000000008027ce80(2150092416)                  0x000000008027ce80(2150092416)                  
t0(x5)              0x0800008140000000(576461307427946496)          0x0800008140000000(576461307427946496)          
t1(x6)              0x000000008027fd69(2150104425)                  0x000000008027fd69(2150104425)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x0000000000000010(16)                          0x0000000000000010(16)                          
s1(x9)              0x000000007ffffbda(2147482586)                  0x000000007ffffbda(2147482586)                  
...
a5(x15)             0x0000000080200409(2149581833)                  0x0000000080200409(2149581833)                  
a6(x16)             0x0000000080180715(2149058325)                  0x0000000080180715(2149058325)                  
a7(x17)             0x0000000080000814(2147485716)                  0x0000000080000814(2147485716)                  
s2(x18)             0x000000008017fe1c(2149056028)                  0x000000008017fe1c(2149056028)                  
s3(x19)             0x0000000080180711(2149058321)                  0x0000000080180711(2149058321)                  
s4(x20)             0x000000008018685c(2149083228)                  0x000000008018685c(2149083228)                  
s5(x21)             0x000000008017f91e(2149054750)                  0x000000008017f91e(2149054750)                  
s6(x22)             0xfffffffffffffff3(18446744073709551603)        0xfffffffffffffff3(18446744073709551603)        
s7(x23)             0x0000000080000631(2147485233)                  0x0000000080000631(2147485233)                  
s8(x24)             0x00000000801806df(2149058271)                  0x00000000801806df(2149058271)                  
s9(x25)             0x00000000801ffb76(2149579638)                  0x00000000801ffb76(2149579638)                  
...
t4(x29)             0x00000000800000c4(2147483844)                  0x00000000800000c4(2147483844)                  
t5(x30)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
t6(x31)             0x00000000802004c4(2149582020)                  0x00000000802004c4(2149582020)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            2e49cba8cd4af1573f56e10394b902b40ca26abf        2e49cba8cd4af1573f56e10394b902b40ca26abf        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        16071d3239622ceaa3957c7c4d1ede29d264f7ef        X
