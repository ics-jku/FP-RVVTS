# FailID_002536 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xfc,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'x17'}})
    fcvt.wu.d x17, f11, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x17, f11, dyn
+========================================================================================================================+
...
Registers: x17, f11
a7(x17)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f11                 0xffffffff4f0017fc(2149055488.0_s)              0xffffffff4f0017fc(2149055488.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bf087a79f0bdd1981483c5aaf27efa113feffd16        bf087a79f0bdd1981483c5aaf27efa113feffd16        
