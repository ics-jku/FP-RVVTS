# FailID_002886 VP++ FF pos RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x30'}})
    fcvt.wu.s x30, f27, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x30, f27, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            af9ecb8b26d70b846dc21bfb81ed41f6fe311a60        af9ecb8b26d70b846dc21bfb81ed41f6fe311a60        
