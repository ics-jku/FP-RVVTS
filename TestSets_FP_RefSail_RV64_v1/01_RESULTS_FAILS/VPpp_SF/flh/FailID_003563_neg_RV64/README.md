# FailID_003563 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x14, 0x801801cb           // a4
    li x15, 0x1                  // a5
    li x16, 0x3                  // a6
    li x17, 0x7ffff9ae           // a7
    li x18, 0x7ffff9ae           // s2
    li x19, 0x7ffffc66           // s3
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'x24', 'x10', 'f12'}})
...
f12                 0x41dfffff20000000(2147482752.0_d)              0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
a4(x14)             0x00000000801801cb(2149056971)                  0x00000000801801cb(2149056971)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2e9751a152d1259d52d867ad2530e00459888308        2e9751a152d1259d52d867ad2530e00459888308        
