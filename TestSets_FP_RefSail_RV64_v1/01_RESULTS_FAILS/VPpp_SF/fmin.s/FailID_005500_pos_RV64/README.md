# FailID_005500 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f4'}, 'clob': {'f13'}})
    fmin.s f13, f18, f4
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a821927b8d2eadbbabbc208bdaf7072dc4ffd214        a821927b8d2eadbbabbc208bdaf7072dc4ffd214        
