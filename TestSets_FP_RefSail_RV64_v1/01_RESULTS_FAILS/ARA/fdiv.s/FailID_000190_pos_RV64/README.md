# FailID_000190 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x64,0xfb,0x17,0x80,0x00,0x00,0x00,0x00
_reg_f24:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f30:.byte 0xb2,0xfd,0x17,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f0'}, 'clob': {'f30'}})
    fdiv.s f30, f24, f0, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f30, f24, f0, rtz
+========================================================================================================================+
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f24, f0
f0                  0x000000008017fb64(1.0617744106e-314_d)         0x000000008017fb64(1.0617744106e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9093e79437b8e482dddb373798417de01ebd7f3c        9093e79437b8e482dddb373798417de01ebd7f3c        
