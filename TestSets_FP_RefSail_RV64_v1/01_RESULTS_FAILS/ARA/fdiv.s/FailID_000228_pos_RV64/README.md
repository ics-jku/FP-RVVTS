# FailID_000228 ARA pos RV64 fdiv.s
...
_reg_f29:.byte 0x00,0x00,0xc0,0x35,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f25'}})
    fdiv.s f25, f29, f30, rmm
```
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f29, f30, rmm
+========================================================================================================================+
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f29, f30
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f29                 0x41e002ff35c00000(2149054894.0_d)              0x41e002ff35c00000(2149054894.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b545be5768ee7f0717f25d64a1663c5753c0ef7e        b545be5768ee7f0717f25d64a1663c5753c0ef7e        
