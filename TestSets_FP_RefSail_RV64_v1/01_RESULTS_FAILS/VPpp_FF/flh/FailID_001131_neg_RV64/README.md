# FailID_001131 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x6, 0x80180740            // t1
    li x7, 0x80180040            // t2
    li x8, 0xffffffff800002c8    // fp
    li x9, 0x8017ff07            // s1
    li x10, 0x7ffffcb5           // a0
    li x11, 0x800000da           // a1
    li x12, 0x0                  // a2
    li x13, 0x801804b7           // a3
    li x14, 0x38da73c            // a4
    li x15, 0x80006251           // a5
    li x16, 0x8017fee7           // a6
    li x17, 0x6000               // a7
    li x18, 0x7ffff992           // s2
    li x19, 0x8018040a           // s3
    li x20, 0xcb                 // s4
    li x21, 0x80180229           // s5
    li x22, 0x1ffffe13           // s6
    ...
    li x30, 0xffffffffffff91f3   // t5
    li x31, 0xffffffff7fe7fe87   // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'x9', 'f19'}})
...
f19                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
f19                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x267, x2
sp(x2)              0x000000007ffffd99(2147483033)                  0x000000007ffffd99(2147483033)
f19                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
+========================================================================================================================+
```
...
tp(x4)              0x000000007ffff992(2147482002)                  0x000000007ffff992(2147482002)                  
...
t2(x7)              0x0000000080180040(2149056576)                  0x0000000080180040(2149056576)                  
fp(x8)              0xffffffff800002c8(18446744071562068680)        0xffffffff800002c8(18446744071562068680)        
s1(x9)              0x000000007ffffd99(2147483033)                  0x000000007ffffd99(2147483033)                  
a0(x10)             0x000000007ffffcb5(2147482805)                  0x000000007ffffcb5(2147482805)                  
a1(x11)             0x00000000800000da(2147483866)                  0x00000000800000da(2147483866)                  
a2(x12)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a3(x13)             0x00000000801804b7(2149057719)                  0x00000000801804b7(2149057719)                  
a4(x14)             0x00000000038da73c(59615036)                    0x00000000038da73c(59615036)                    
a5(x15)             0x0000000080006251(2147508817)                  0x0000000080006251(2147508817)                  
a6(x16)             0x000000008017fee7(2149056231)                  0x000000008017fee7(2149056231)                  
a7(x17)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s2(x18)             0x000000007ffff992(2147482002)                  0x000000007ffff992(2147482002)                  
s3(x19)             0x000000008018040a(2149057546)                  0x000000008018040a(2149057546)                  
s4(x20)             0x00000000000000cb(203)                         0x00000000000000cb(203)                         
s5(x21)             0x0000000080180229(2149057065)                  0x0000000080180229(2149057065)                  
s6(x22)             0x000000001ffffe13(536870419)                   0x000000001ffffe13(536870419)                   
...
t5(x30)             0xffffffffffff91f3(18446744073709523443)        0xffffffffffff91f3(18446744073709523443)        
t6(x31)             0xffffffff7fe7fe87(18446744071560494727)        0xffffffff7fe7fe87(18446744071560494727)        

STATE               REF                                             DUT                                             DIFF
xmemhash            5a0f02241f9721734cbcd39e507ce06ad95ea5cb        5a0f02241f9721734cbcd39e507ce06ad95ea5cb        
