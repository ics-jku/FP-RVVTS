# FailID_002816 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x13'}})
    fcvt.wu.d x13, f12, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x13, f12, dyn
+========================================================================================================================+
...
Registers: x13, f12
a3(x13)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f12                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            90829493db6228abe6d75aa9fb9ab58b4b92585a        90829493db6228abe6d75aa9fb9ab58b4b92585a        
