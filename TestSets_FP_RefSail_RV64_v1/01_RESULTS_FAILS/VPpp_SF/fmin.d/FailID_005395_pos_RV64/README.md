# FailID_005395 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'f11', 'fcsr.rm'}, 'clob': {'f9'}})
    fmin.d f9, f11, f26
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d63e902c9a1fa0477e28570cea9b6478b76b032c        d63e902c9a1fa0477e28570cea9b6478b76b032c        
