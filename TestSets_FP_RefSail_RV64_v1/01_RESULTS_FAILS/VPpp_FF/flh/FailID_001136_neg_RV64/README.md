# FailID_001136 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x21, 0x4d                 // s5
    li x22, 0x1                  // s6
    li x23, 0x8018051e           // s7
    li x24, 0xfffffffffffffef7   // s8
    li x25, 0x0                  // s9
    li x26, 0x1                  // s10
    li x27, 0x801ff8d3           // s11
    li x28, 0x80101410           // t3
    li x29, 0x8018052a           // t4
    li x30, 0x8020065f           // t5
    li x31, 0x8017fa91           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x24'}, 'clob': {'f20', 'x24', 'x25'}})
...
f20                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
fp(x8)              0x0000000080180198(2149056920)                  0x0000000080180198(2149056920)                  
...
a2(x12)             0x0000000080180198(2149056920)                  0x0000000080180198(2149056920)                  
...
s8(x24)             0x00000000801ffe18(2149580312)                  0x00000000801ffe18(2149580312)                  
s9(x25)             0x000000007fffff22(2147483426)                  0x000000007fffff22(2147483426)                  
...
t5(x30)             0x000000008020065f(2149582431)                  0x000000008020065f(2149582431)                  
t6(x31)             0x000000008017fa91(2149055121)                  0x000000008017fa91(2149055121)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            bacb88148c2c9eface9553c36fa6d2156fee94bb        bacb88148c2c9eface9553c36fa6d2156fee94bb        
