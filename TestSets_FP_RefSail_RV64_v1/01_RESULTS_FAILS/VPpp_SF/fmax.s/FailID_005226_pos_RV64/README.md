# FailID_005226 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'f3'}})
    fmax.s f3, f22, f24
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffff4f0017fd(2149055744.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b910d28899527ebc02b2ab86d20354ed38be7ece        b910d28899527ebc02b2ab86d20354ed38be7ece        
