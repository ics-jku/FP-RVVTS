# FailID_000339 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f3'}})
    fsqrt.s f3, f4, rtz
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d937e1c587bbff5f32557faa87245737a7ba09c2        d937e1c587bbff5f32557faa87245737a7ba09c2        
