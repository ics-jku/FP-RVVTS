# FailID_001023 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x14'}, 'clob': {'x14', 'f11', 'x1'}})
...
f11                 0x7ff8000000000000(nan_d)                       0x0691bc230681b823(5.002337310530343e-277_d)    X
STATES DIFFER: True
```
...
ra(x1)              0x000000007ffffc58(2147482712)                  0x000000007ffffc58(2147482712)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            99b4617f640b3fe95accb19bb52c7ab34e2dfbb5        99b4617f640b3fe95accb19bb52c7ab34e2dfbb5        
