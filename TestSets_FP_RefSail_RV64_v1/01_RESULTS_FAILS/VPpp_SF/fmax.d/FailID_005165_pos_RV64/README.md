# FailID_005165 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f1'}, 'clob': {'f23'}})
    fmax.d f23, f10, f1
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0x8000000000000000(-0.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            adb393c4d061fb21d09f26bfdaed34af973474f6        adb393c4d061fb21d09f26bfdaed34af973474f6        
