# FailID_004153 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f9'}, 'clob': {'f15'}})
    fmin.d f15, f18, f9
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xb63c845a02a678bf(-1.9512122135603192e-47_d)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            55b621030a32bdff3dc281c85834f2087144820d        55b621030a32bdff3dc281c85834f2087144820d        
