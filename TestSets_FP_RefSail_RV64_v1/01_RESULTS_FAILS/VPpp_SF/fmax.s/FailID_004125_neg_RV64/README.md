# FailID_004125 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f2', 'f28'}, 'clob': {'f30'}})
    fmax.s f30, f2, f28
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff4efffffb(2147483008.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2956fbd0651f199f90f410c010eea4f010a9a93e        2956fbd0651f199f90f410c010eea4f010a9a93e        
