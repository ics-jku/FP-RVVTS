# FailID_002958 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0x00,0x00,0x20,0x8f,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x18'}})
    fcvt.wu.s x18, f21
```
...
```
REG                 REF                                             DUT                                             DIFF
s2(x18)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
Registers: x18, f21
s2(x18)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f21                 0x41e000008f200000(2147484793.0_d)              0x41e000008f200000(2147484793.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e245a566a17ae8bdbad08bae4827494bf17a6352        e245a566a17ae8bdbad08bae4827494bf17a6352        
