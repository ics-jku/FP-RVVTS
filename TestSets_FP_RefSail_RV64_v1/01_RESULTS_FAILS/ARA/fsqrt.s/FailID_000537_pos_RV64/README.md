# FailID_000537 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f8'}})
    fsqrt.s f8, f27, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f8, f27, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f270d9cc4a1cea05110ac29932061a3c0f43d943        f270d9cc4a1cea05110ac29932061a3c0f43d943        
