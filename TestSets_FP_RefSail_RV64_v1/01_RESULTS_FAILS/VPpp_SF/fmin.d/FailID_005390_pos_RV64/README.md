# FailID_005390 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f24'}})
    fmin.d f24, f7, f27
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x0000000000000000(0.0_d)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a825b3a371500d5731188a6d7bb5102576af0db0        a825b3a371500d5731188a6d7bb5102576af0db0        
