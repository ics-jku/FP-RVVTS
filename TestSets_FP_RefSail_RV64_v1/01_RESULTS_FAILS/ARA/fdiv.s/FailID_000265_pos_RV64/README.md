# FailID_000265 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x07,0xf6,0xa4,0x70,0xbc,0xd8,0x63,0x6c
_reg_f25:.byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xff,0xff
_reg_f26:.byte 0x07,0xf6,0xa4,0x70,0xbc,0xd8,0x63,0xec
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f25'}})
    fdiv.s f25, f5, f26, rup
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f5, f26, rup
+========================================================================================================================+
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f5, f26
f5                  0x6c63d8bc70a4f607(1.3362681166689249e+214_d)   0x6c63d8bc70a4f607(1.3362681166689249e+214_d)
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
f26                 0xec63d8bc70a4f607(-1.3362681166689249e+214_d)  0xec63d8bc70a4f607(-1.3362681166689249e+214_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            42c5280aaef02fe5e5db1a3b560f6a9251789275        42c5280aaef02fe5e5db1a3b560f6a9251789275        
