# FailID_000043 ARA neg RV64 fsqrt.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f22', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f29'}})
    fsqrt.d f29, f22, rup
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x4063988e1409212f(156.7673435381234_d)         0x4063988e1409212e(156.76734353812338_d)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f29, f22, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6731e27ce58d796a32a00ac5f6f6aabb89eb003d        6731e27ce58d796a32a00ac5f6f6aabb89eb003d        
