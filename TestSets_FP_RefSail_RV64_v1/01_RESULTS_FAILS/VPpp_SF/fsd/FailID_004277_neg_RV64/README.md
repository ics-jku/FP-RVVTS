# FailID_004277 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x42                  // fp
    li x9, 0x0                   // s1
    li x10, 0x7fffffd3           // a0
    li x11, 0x80237a08           // a1
    li x12, 0x2c14b000           // a2
    li x13, 0xffffffff00000042   // a3
    li x14, 0x801807e1           // a4
    li x15, 0x801802e4           // a5
    li x16, 0x80180200           // a6
    li x17, 0x8d28575c           // a7
    li x18, 0x7ffffe8e           // s2
    li x19, 0xfffffffffec00000   // s3
    li x20, 0x1                  // s4
    li x21, 0x8017fc91           // s5
    li x22, 0x7afc4000           // s6
    li x23, 0x802002c6           // s7
    li x24, 0x80200a5d           // s8
    li x25, 0x80000245           // s9
    li x26, 0x0                  // s10
    li x27, 0x80180815           // s11
    li x28, 0x0                  // t3
    li x29, 0x8017fabb           // t4
    li x30, 0xfffffffffffff9f6   // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f26', 'x31'}, 'clob': {'x31', 'x3'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, x19, x31
s3(x19)             0xfffffffffec00000(18446744073688580096)        0xfffffffffec00000(18446744073688580096)
t6(x31)             0x000000008018619e(2149081502)                  0x000000008018619e(2149081502)
...
ra(x1)              0x0000000080005fd3(2147508179)                  0x0000000080005fd3(2147508179)                  
sp(x2)              0x00400bfdb1800000(18027582742069248)           0x00400bfdb1800000(18027582742069248)           
gp(x3)              0x000000008018019e(2149056926)                  0x000000008018019e(2149056926)                  
...
t2(x7)              0x000000008027f5d9(2150102489)                  0x000000008027f5d9(2150102489)                  
fp(x8)              0x0000000000000042(66)                          0x0000000000000042(66)                          
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x000000007fffffd3(2147483603)                  0x000000007fffffd3(2147483603)                  
a1(x11)             0x0000000080237a08(2149808648)                  0x0000000080237a08(2149808648)                  
...
a4(x14)             0x00000000801807e1(2149058529)                  0x00000000801807e1(2149058529)                  
...
a7(x17)             0x000000008d28575c(2368231260)                  0x000000008d28575c(2368231260)                  
s2(x18)             0x000000007ffffe8e(2147483278)                  0x000000007ffffe8e(2147483278)                  
s3(x19)             0xfffffffffec00000(18446744073688580096)        0xfffffffffec00000(18446744073688580096)        
s4(x20)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s5(x21)             0x000000008017fc91(2149055633)                  0x000000008017fc91(2149055633)                  
s6(x22)             0x000000007afc4000(2063351808)                  0x000000007afc4000(2063351808)                  
s7(x23)             0x00000000802002c6(2149581510)                  0x00000000802002c6(2149581510)                  
s8(x24)             0x0000000080200a5d(2149583453)                  0x0000000080200a5d(2149583453)                  
s9(x25)             0x0000000080000245(2147484229)                  0x0000000080000245(2147484229)                  
...
t4(x29)             0x000000008017fabb(2149055163)                  0x000000008017fabb(2149055163)                  
t5(x30)             0xfffffffffffff9f6(18446744073709550070)        0xfffffffffffff9f6(18446744073709550070)        
t6(x31)             0x000000008018619e(2149081502)                  0x000000008018619e(2149081502)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            7c46650892022c83762fea23301f4fc6b589e405        7c46650892022c83762fea23301f4fc6b589e405        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        c706c43a694d240ba15ce28ae82a4ae5732875d2        X
