# FailID_005472 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f25'}, 'clob': {'f29'}})
    fmin.s f29, f25, f3
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff4f001800(2149056512.0_s)              0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a76e4d1254045d8d1f369aee7112cda71d70dba6        a76e4d1254045d8d1f369aee7112cda71d70dba6        
