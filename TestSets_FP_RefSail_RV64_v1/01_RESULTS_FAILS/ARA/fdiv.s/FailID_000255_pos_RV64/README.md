# FailID_000255 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x40,0x1f,0xfe,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f16'}})
    fdiv.s f16, f11, f11
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f16, f11, f11
+========================================================================================================================+
...
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f11, f11
f11                 0x41dffffe1f400000(2147481725.0_d)              0x41dffffe1f400000(2147481725.0_d)
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            be80e46670b2746495138fdb1f43d252b05de647        be80e46670b2746495138fdb1f43d252b05de647        
