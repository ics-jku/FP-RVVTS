# FailID_005544 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'f20'}})
    fmin.s f20, f11, f21
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f20, f11, f21
+========================================================================================================================+
...
f20                 0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f11, f21
f11                 0xffffffffbf800000(-1.0_s)                      0xffffffffbf800000(-1.0_s)
f20                 0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f1c15059f79242a916f9583774e13032298229dc        f1c15059f79242a916f9583774e13032298229dc        
