# FailID_000150 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f19'}})
    fdiv.s f19, f11, f24, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f19, f11, f24, rmm
+========================================================================================================================+
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f11, f24
f11                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff2140006f(6.505270420568022e-19_s)
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9b241b76453bae8a77985bb27ba26dae80a4f41b        9b241b76453bae8a77985bb27ba26dae80a4f41b        
