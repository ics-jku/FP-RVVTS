# FailID_000783 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x56d3f000            // fp
    li x9, 0x7ffffe24            // s1
    li x10, 0x8017ffc8           // a0
    li x11, 0x7ffffa5d           // a1
    li x12, 0x8016bfbd           // a2
    li x13, 0x7ffffec1           // a3
    li x14, 0x6000               // a4
    li x15, 0x80185b3a           // a5
    li x16, 0x1                  // a6
    li x17, 0x0                  // a7
    li x18, 0x8017f8f6           // s2
    li x19, 0x801cf881           // s3
    li x20, 0xffffffff96d3f000   // s4
    li x21, 0x75                 // s5
    li x22, 0xffffffff7fe03570   // s6
    li x23, 0x0                  // s7
    li x24, 0x802235a2           // s8
    li x25, 0x8015fdef           // s9
    li x26, 0x801b7121           // s10
    li x27, 0x800aeda0           // s11
    li x28, 0x7ffffe1c           // t3
    li x29, 0x400f8a3c00         // t4
    li x30, 0x7ffff924           // t5
    li x31, 0x80000104           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x18'}, 'clob': {'x18', 'f19', 'x1'}})
...
f19                 0x61b593058f664b03(4.853046601711578e+162_d)    0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f19                 0x61b593058f664b03(4.853046601711578e+162_d)    0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x723, x18
s2(x18)             0x000000008017f1cd(2149052877)                  0x000000008017f1cd(2149052877)
f19                 0x61b593058f664b03(4.853046601711578e+162_d)    0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
t2(x7)              0x0000000000006771(26481)                       0x0000000000006771(26481)                       
fp(x8)              0x0000000056d3f000(1456730112)                  0x0000000056d3f000(1456730112)                  
s1(x9)              0x000000007ffffe24(2147483172)                  0x000000007ffffe24(2147483172)                  
a0(x10)             0x000000008017ffc8(2149056456)                  0x000000008017ffc8(2149056456)                  
...
a3(x13)             0x000000007ffffec1(2147483329)                  0x000000007ffffec1(2147483329)                  
...
s2(x18)             0x000000008017f1cd(2149052877)                  0x000000008017f1cd(2149052877)                  
s3(x19)             0x00000000801cf881(2149382273)                  0x00000000801cf881(2149382273)                  
s4(x20)             0xffffffff96d3f000(18446744071945056256)        0xffffffff96d3f000(18446744071945056256)        
s5(x21)             0x0000000000000075(117)                         0x0000000000000075(117)                         
s6(x22)             0xffffffff7fe03570(18446744071559984496)        0xffffffff7fe03570(18446744071559984496)        
s7(x23)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s8(x24)             0x00000000802235a2(2149725602)                  0x00000000802235a2(2149725602)                  
...
t3(x28)             0x000000007ffffe1c(2147483164)                  0x000000007ffffe1c(2147483164)                  
t4(x29)             0x000000400f8a3c00(275138624512)                0x000000400f8a3c00(275138624512)                
...
STATE               REF                                             DUT                                             DIFF
xmemhash            33b60431157e092e224919b8c261aff74436b611        33b60431157e092e224919b8c261aff74436b611        
