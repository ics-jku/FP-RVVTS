# FailID_005322 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f23'}})
    fmax.s f23, f19, f28
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f23, f19, f28
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fbcf9c3fbd0ca6127ff96da4b9aaf037381fc8a6        fbcf9c3fbd0ca6127ff96da4b9aaf037381fc8a6        
