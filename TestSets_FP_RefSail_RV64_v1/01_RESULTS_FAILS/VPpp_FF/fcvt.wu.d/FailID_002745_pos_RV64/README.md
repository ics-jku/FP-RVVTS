# FailID_002745 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x4e,0x6a,0xf5,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.d x2, f3, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x2, f3, dyn
+========================================================================================================================+
...
Registers: x2, f3
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f3                  0xffffffff4ef56a4e(2058692352.0_s)              0xffffffff4ef56a4e(2058692352.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8a04ec6892011dbd9e8a87e7f34bc8f390dcb234        8a04ec6892011dbd9e8a87e7f34bc8f390dcb234        
