# FailID_005170 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0xc0,0x23,0x00,0x00,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f6', 'fcsr.rm'}, 'clob': {'f6'}})
    fmax.d f6, f0, f6
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0x41e0000023c00000(2147483934.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f0, f6
f0                  0x41e0000023c00000(2147483934.0_d)              0x41e0000023c00000(2147483934.0_d)
f6                  0x41e0000023c00000(2147483934.0_d)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e207289c3b5c37e0d73c60ed124b44f84fbebd4d        e207289c3b5c37e0d73c60ed124b44f84fbebd4d        
