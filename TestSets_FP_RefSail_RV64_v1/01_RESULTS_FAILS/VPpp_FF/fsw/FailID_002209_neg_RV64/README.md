# FailID_002209 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x14, 0x91f3               // a4
    li x15, 0x801c41ff           // a5
    li x16, 0x6000               // a6
    li x17, 0x0                  // a7
    li x18, 0x7ffffe8e           // s2
    li x19, 0x7ffffe0a           // s3
    li x20, 0x8                  // s4
    li x21, 0x6000               // s5
    ...
    // INSTRUCTION ({'dep': {'x10', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f19'}, 'clob': {'x10', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9670253f263be4ad141e8564b6a4f9506646b1ff        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x2, e4, x10
sp(x2)              0x0000000000006000(24576)                       0x0000000000006000(24576)
a0(x10)             0x000000008027f714(2150102804)                  0x000000008027f714(2150102804)
...
s3(x19)             0x000000007ffffe0a(2147483146)                  0x000000007ffffe0a(2147483146)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            537a9bee71cd7ceae5c53c6531aff1b386446a48        537a9bee71cd7ceae5c53c6531aff1b386446a48        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9670253f263be4ad141e8564b6a4f9506646b1ff        X
