# FailID_000250 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0xda,0x66,0x8a,0x2a,0x33,0x48,0xf6,0x30
_reg_f20:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'f20', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f23'}})
    fdiv.s f23, f3, f20, rmm
```
...
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f23, f3, f20, rmm
+========================================================================================================================+
...
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f3, f20
f3                  0x30f648332a8a66da(7.881989044937612e-73_d)     0x30f648332a8a66da(7.881989044937612e-73_d)
f20                 0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8d6b2407362910cede61859737b1446d442b3530        8d6b2407362910cede61859737b1446d442b3530        
