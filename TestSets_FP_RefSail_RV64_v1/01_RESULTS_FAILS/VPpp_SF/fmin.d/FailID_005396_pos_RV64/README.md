# FailID_005396 VP++ SF pos RV64 fmin.d
...
_reg_f22:.byte 0xff,0xff,0x7f,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f1', 'fcsr.rm', 'f22'}, 'clob': {'f15'}})
    fmin.d f15, f1, f22
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x0000000000000000(0.0_d)                       0xffffffff4f7fffff(4294967040.0_s)              X
STATES DIFFER: True
```
...
f15                 0x0000000000000000(0.0_d)                       0xffffffff4f7fffff(4294967040.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f1, f22
f1                  0x0000000000000000(0.0_d)                       0x0000000000000000(0.0_d)
f15                 0x0000000000000000(0.0_d)                       0xffffffff4f7fffff(4294967040.0_s)              X
f22                 0xffffffff4f7fffff(4294967040.0_s)              0xffffffff4f7fffff(4294967040.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b4ee31f7883dec54a3952885ec22586f83355acb        b4ee31f7883dec54a3952885ec22586f83355acb        
