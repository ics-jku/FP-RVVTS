# FailID_004124 VP++ SF neg RV64 fmax.s
...
_reg_f15:.byte 0x46,0x5d,0x18,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f19'}, 'clob': {'f15'}})
    fmax.s f15, f6, f19
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xffffffff80180212(-2.2047945959778812e-39_s)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5e9eeb6e51bdde2941eb8254dbcaa66895bb01ba        5e9eeb6e51bdde2941eb8254dbcaa66895bb01ba        
