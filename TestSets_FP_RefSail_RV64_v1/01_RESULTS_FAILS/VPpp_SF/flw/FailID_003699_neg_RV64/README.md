# FailID_003699 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x11                 // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x7'}, 'clob': {'x11', 'f27', 'x7'}})
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff70428293(2.407917857990553e+29_s)     X
STATES DIFFER: True
```
...
s11(x27)            0x000000008007bcad(2147990701)                  0x000000008007bcad(2147990701)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb8d2565a9b4ed4f1b6f31ebd434c1ef557dfebd        fb8d2565a9b4ed4f1b6f31ebd434c1ef557dfebd        
