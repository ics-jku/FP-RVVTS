# FailID_005345 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'f17'}})
    fmin.d f17, f9, f10
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x41e002ff2d000000(2149054824.0_d)              0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6b73a2dac9ef436e0f3404b7fa3880a3ac1acdb4        6b73a2dac9ef436e0f3404b7fa3880a3ac1acdb4        
