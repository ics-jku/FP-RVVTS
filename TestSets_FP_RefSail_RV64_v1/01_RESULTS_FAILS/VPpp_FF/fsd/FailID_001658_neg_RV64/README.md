# FailID_001658 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x15, 0xffffffffe3346000   // a5
    li x16, 0x801804c3           // a6
    li x17, 0x6000               // a7
    li x18, 0x8018076b           // s2
    li x19, 0x6000               // s3
    li x20, 0x80000755           // s4
    li x21, 0x80180634           // s5
    li x22, 0x801801f6           // s6
    li x23, 0x800000cf           // s7
    li x24, 0x80180cb5           // s8
    li x25, 0x0                  // s9
    li x26, 0x80180704           // s10
    li x27, 0x801801b2           // s11
    li x28, 0x801e292a           // t3
    li x29, 0x801802b0           // t4
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f27', 'x31'}, 'clob': {'x16', 'x31'}})
...
ra(x1)              0x000000000f989000(261656576)                   0x000000000f989000(261656576)                   
...
a0(x10)             0x00000000000000e9(233)                         0x00000000000000e9(233)                         
...
a5(x15)             0xffffffffe3346000(18446744073226444800)        0xffffffffe3346000(18446744073226444800)        
...
s6(x22)             0x00000000801801f6(2149057014)                  0x00000000801801f6(2149057014)                  
...
s10(x26)            0x0000000080180704(2149058308)                  0x0000000080180704(2149058308)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            009385adec0692458cee22f7faa281665c265897        009385adec0692458cee22f7faa281665c265897        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        62ca3486298f70a21f191cd85cef9af4c6a0ac08        X
