# FailID_005425 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f19'}})
    fmin.d f19, f15, f13
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x8000000000000000(-0.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f19, f15, f13
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b67351ff19cfa4f0e960ebe2b9577c868361151e        b67351ff19cfa4f0e960ebe2b9577c868361151e        
