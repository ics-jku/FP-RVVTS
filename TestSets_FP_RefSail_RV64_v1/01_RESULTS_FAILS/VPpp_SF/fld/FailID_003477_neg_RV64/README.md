# FailID_003477 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x14, 0xfffffffffffffeff   // a4
    li x15, 0xffffffffffffffff   // a5
    li x16, 0x7ffffc84           // a6
    li x17, 0x0                  // a7
    li x18, 0xfffffffff7b5d000   // s2
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x7'}, 'clob': {'x11', 'f28', 'x7'}})
...
f28                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f28                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x36, x7
t2(x7)              0x000000008006ac96(2147921046)                  0x000000008006ac96(2147921046)
f28                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
a4(x14)             0xfffffffffffffeff(18446744073709551359)        0xfffffffffffffeff(18446744073709551359)        
...
s2(x18)             0xfffffffff7b5d000(18446744073570471936)        0xfffffffff7b5d000(18446744073570471936)        
...
s5(x21)             0x000000007ffffd8e(2147483022)                  0x000000007ffffd8e(2147483022)                  
...
s11(x27)            0x00000000000000ac(172)                         0x00000000000000ac(172)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            46c71b8ae664ba898da0ab84dfec38f0f94ab13a        46c71b8ae664ba898da0ab84dfec38f0f94ab13a        
