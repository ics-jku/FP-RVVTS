# FailID_001516 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x9, 0x0                   // s1
    li x10, 0x6000               // a0
    li x11, 0x340191f3           // a1
    li x12, 0x8000000000000000   // a2
    li x13, 0x8018010f           // a3
    li x14, 0x8017fc99           // a4
    li x15, 0x8017fd94           // a5
    li x16, 0x7ffff82a           // a6
    li x17, 0x0                  // a7
    li x18, 0x0                  // s2
    li x19, 0x6000               // s3
    li x20, 0x6000               // s4
    ...
    li x24, 0x2                  // s8
    li x25, 0x7                  // s9
    li x26, 0x80000312           // s10
    li x27, 0x8018023d           // s11
    li x28, 0x30                 // t3
    li x29, 0x8018010f           // t4
    li x30, 0x8000017a           // t5
    li x31, 0x7fffffffffffffff   // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'x13', 'f18', 'x31'}})
...
f18                 0x41ca00c8f9800000(872518131.0_d)               0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
gp(x3)              0x000000009e2cb6f8(2653730552)                  0x000000009e2cb6f8(2653730552)                  
...
t2(x7)              0x000000008018023d(2149057085)                  0x000000008018023d(2149057085)                  
...
a1(x11)             0x00000000340191f3(872518131)                   0x00000000340191f3(872518131)                   
a2(x12)             0x8000000000000000(9223372036854775808)         0x8000000000000000(9223372036854775808)         
a3(x13)             0x000000008018031b(2149057307)                  0x000000008018031b(2149057307)                  
a4(x14)             0x000000008017fc99(2149055641)                  0x000000008017fc99(2149055641)                  
a5(x15)             0x000000008017fd94(2149055892)                  0x000000008017fd94(2149055892)                  
a6(x16)             0x000000007ffff82a(2147481642)                  0x000000007ffff82a(2147481642)                  
...
s10(x26)            0x0000000080000312(2147484434)                  0x0000000080000312(2147484434)                  
s11(x27)            0x000000008018023d(2149057085)                  0x000000008018023d(2149057085)                  
t3(x28)             0x0000000000000030(48)                          0x0000000000000030(48)                          
t4(x29)             0x000000008018010f(2149056783)                  0x000000008018010f(2149056783)                  
t5(x30)             0x000000008000017a(2147484026)                  0x000000008000017a(2147484026)                  
t6(x31)             0x000000008000020f(2147484175)                  0x000000008000020f(2147484175)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            736745550d682986a58f595ff6ee49f404afe33f        736745550d682986a58f595ff6ee49f404afe33f        
