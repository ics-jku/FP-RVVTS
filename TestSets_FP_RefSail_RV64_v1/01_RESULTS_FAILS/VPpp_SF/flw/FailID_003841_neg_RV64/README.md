# FailID_003841 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x9, 0x7ffffa8b            // s1
    li x10, 0x6000               // a0
    li x11, 0x3e567000           // a1
    li x12, 0x6000               // a2
    li x13, 0x7ffffa0c           // a3
    li x14, 0x8017fa7e           // a4
    li x15, 0x6000               // a5
    ...
    li x22, 0x0                  // s6
    li x23, 0x8017fdd6           // s7
    li x24, 0x1                  // s8
    li x25, 0x7ffffa88           // s9
    ...
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'x5', 'f9'}})
...
f9                  0xfd0a6e30a8cdaf1c(-2.1100367023637902e+294_d)  0xffffffffd2000f53(-137503227904.0_s)           X
STATES DIFFER: True
```
...
f9                  0xfd0a6e30a8cdaf1c(-2.1100367023637902e+294_d)  0xffffffffd2000f53(-137503227904.0_s)           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, x361, x1
ra(x1)              0x0000000080000631(2147485233)                  0x0000000080000631(2147485233)
f9                  0xfd0a6e30a8cdaf1c(-2.1100367023637902e+294_d)  0xffffffffd2000f53(-137503227904.0_s)           X
+========================================================================================================================+
```
...
t0(x5)              0x0000000080000361(2147484513)                  0x0000000080000361(2147484513)                  
t1(x6)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t2(x7)              0x0000000056b0571c(1454397212)                  0x0000000056b0571c(1454397212)                  
fp(x8)              0x0000000000000082(130)                         0x0000000000000082(130)                         
...
a1(x11)             0x000000003e567000(1045852160)                  0x000000003e567000(1045852160)                  
...
a4(x14)             0x000000008017fa7e(2149055102)                  0x000000008017fa7e(2149055102)                  
...
s7(x23)             0x000000008017fdd6(2149055958)                  0x000000008017fdd6(2149055958)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aff487611f0744ecc713673736d7502566a019c1        aff487611f0744ecc713673736d7502566a019c1        
