# FailID_005429 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f29'}, 'clob': {'f1'}})
    fmin.d f1, f17, f29
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0x4050000000000000(64.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5e8f9da4f67ca8b76b8a4d96abcb985659207ee0        5e8f9da4f67ca8b76b8a4d96abcb985659207ee0        
