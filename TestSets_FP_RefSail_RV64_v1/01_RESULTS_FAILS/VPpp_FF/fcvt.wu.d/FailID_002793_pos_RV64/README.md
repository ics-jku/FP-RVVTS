# FailID_002793 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x30'}})
    fcvt.wu.d x30, f2, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x30, f2, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            213b54f1820a34e6a0ffc8cb32bffe45f5b947f8        213b54f1820a34e6a0ffc8cb32bffe45f5b947f8        
