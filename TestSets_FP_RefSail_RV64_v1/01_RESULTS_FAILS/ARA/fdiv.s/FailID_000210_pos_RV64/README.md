# FailID_000210 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x80,0xea,0xfe,0x04,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f28'}})
    fdiv.s f28, f11, f25, rup
```
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f28, f11, f25, rup
+========================================================================================================================+
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f11, f25
f11                 0x41e004feea800000(2150102868.0_d)              0x41e004feea800000(2150102868.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3eb74fcf10405ba980ad277057430dc63f76e611        3eb74fcf10405ba980ad277057430dc63f76e611        
