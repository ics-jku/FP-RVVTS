# FailID_002096 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x30, 0x70                 // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f6', 'x9'}, 'clob': {'x9', 'x7'}})
...
t2(x7)              0x000000008018071d(2149058333)                  0x000000008018071d(2149058333)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d96264e90fcd96dda6b239ec1e65795cbd25222e        d96264e90fcd96dda6b239ec1e65795cbd25222e        
