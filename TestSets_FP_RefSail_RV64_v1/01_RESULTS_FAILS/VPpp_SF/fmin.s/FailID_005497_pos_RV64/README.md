# FailID_005497 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f23'}})
    fmin.s f23, f9, f13
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b72108da7d6b02db3d8a612d2e49e83e28550d64        b72108da7d6b02db3d8a612d2e49e83e28550d64        
