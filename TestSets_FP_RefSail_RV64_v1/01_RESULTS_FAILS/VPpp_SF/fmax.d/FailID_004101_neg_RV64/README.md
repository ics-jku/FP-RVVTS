# FailID_004101 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f19'}, 'clob': {'f9'}})
    fmax.d f9, f19, f3
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x4080000000000000(512.0_d)                     0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            17d43dbc5d38e26013e94a2e618ed076b1cd663f        17d43dbc5d38e26013e94a2e618ed076b1cd663f        
