# FailID_002534 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x27'}})
    fcvt.wu.d x27, f0, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x27, f0, rne
+========================================================================================================================+
...
Registers: x27, f0
s11(x27)            0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f0                  0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5d245a5bc143c4dfd65e6f758371dd1366e52795        5d245a5bc143c4dfd65e6f758371dd1366e52795        
