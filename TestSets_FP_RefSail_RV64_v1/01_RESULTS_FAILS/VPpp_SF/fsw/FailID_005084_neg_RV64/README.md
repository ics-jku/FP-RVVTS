# FailID_005084 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x8017fcc9            // fp
    li x9, 0x7ffffe8a            // s1
    li x10, 0x10017f829          // a0
    li x11, 0x3ea42768           // a1
    li x12, 0x0                  // a2
    li x13, 0x8027ffcd           // a3
    li x14, 0x4                  // a4
    li x15, 0x200                // a5
    li x16, 0x8017f99f           // a6
    li x17, 0x801803a8           // a7
    li x18, 0x8017ffc7           // s2
    ...
    li x30, 0x8020054d           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f12', 'x18'}, 'clob': {'x18', 'x15'}})
...
a0(x10)             0x000000010017f829(4296538153)                  0x000000010017f829(4296538153)                  
...
t5(x30)             0x000000008020054d(2149582157)                  0x000000008020054d(2149582157)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            0b3f171e6274393cc0a96c01e3f34a89d94a909d        0b3f171e6274393cc0a96c01e3f34a89d94a909d        
