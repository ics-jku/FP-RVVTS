# FailID_005330 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0xc0,0x18,0xe3,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'f14', 'fcsr.rm'}, 'clob': {'f15'}})
    fmax.s f15, f14, f26
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f15, f14, f26
+========================================================================================================================+
...
f15                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f14, f26
f14                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff4ee318c0(1905025024.0_s)
f15                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f169768aed5347500341baefe211b107c67832cb        f169768aed5347500341baefe211b107c67832cb        
