# FailID_000017 ARA neg RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0x7f
_reg_f18:.byte 0x00,0x00,0x40,0x2b,0x01,0x00,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'f28', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f18'}})
    fdiv.s f18, f13, f28, rdn
```
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f18, f13, f28, rdn
+========================================================================================================================+
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f13, f28
f13                 0x7fffffff3f800000(nan_d)                       0x7fffffff3f800000(nan_d)
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f7b3526770baeb2fc0af147a85bdba1ac2962fd8        f7b3526770baeb2fc0af147a85bdba1ac2962fd8        
