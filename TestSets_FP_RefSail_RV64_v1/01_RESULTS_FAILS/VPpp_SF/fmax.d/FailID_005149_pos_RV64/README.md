# FailID_005149 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f25'}, 'clob': {'f29'}})
    fmax.d f29, f0, f25
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x40d8000000000000(24576.0_d)                   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            91941e7c6c9a337e656826734a1a0840a6048f1f        91941e7c6c9a337e656826734a1a0840a6048f1f        
