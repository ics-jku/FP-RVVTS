# FailID_005213 VP++ SF pos RV64 fmax.d
...
_reg_f6: .byte 0xd8,0x07,0x00,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f1'}, 'clob': {'f9'}})
    fmax.d f9, f6, f1
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x00000000800007d8(1.0609988876e-314_d)         0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f6                  0x00000000800007d8(1.0609988876e-314_d)         0x00000000800007d8(1.0609988876e-314_d)
f9                  0x00000000800007d8(1.0609988876e-314_d)         0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            67f0e07103f4f3d10ae1799547750dbf5a51faa2        67f0e07103f4f3d10ae1799547750dbf5a51faa2        
