# FailID_000242 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f21:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f22'}})
    fdiv.s f22, f11, f21
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff6d2aaa48(3.3011443168343697e+27_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f22, f11, f21
+========================================================================================================================+
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff6d2aaa48(3.3011443168343697e+27_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f11, f21
f11                 0xffffffff4f000000(2147483648.0_s)              0xffffffff4f000000(2147483648.0_s)
f21                 0x7fffffff2140006f(nan_d)                       0x7fffffff2140006f(nan_d)
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff6d2aaa48(3.3011443168343697e+27_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7ec1b4e188f07c720e382753424807fc6d181c4c        7ec1b4e188f07c720e382753424807fc6d181c4c        
