# FailID_003243 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm'}, 'clob': {'x21', 'f12', 'x4'}})
...
f12                 0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
a4(x14)             0x00000000000000bf(191)                         0x00000000000000bf(191)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c7c7365446c200e8e05baa8f4e4e248dca93a354        c7c7365446c200e8e05baa8f4e4e248dca93a354        
