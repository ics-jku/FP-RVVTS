# FailID_002579 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f29:.byte 0xcf,0xa5,0xdd,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f29
    fld  f29, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f29', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x23'}})
    fcvt.wu.d x23, f29, rdn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s7(x23)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x23, f29, rdn
+========================================================================================================================+
...
Registers: x23, f29
s7(x23)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f29                 0xffffffffcedda5cf(-1859315584.0_s)             0xffffffffcedda5cf(-1859315584.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8168dae9f858d50f170340ef2a93e8c9e5991a76        8168dae9f858d50f170340ef2a93e8c9e5991a76        
