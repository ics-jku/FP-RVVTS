# FailID_000221 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xe6,0x1b,0xd2,0x94,0xf1,0xfd,0x1c,0x69
_reg_f18:.byte 0xd6,0x2c,0x98,0x4e,0x06,0x79,0xd1,0x29
_reg_f29:.byte 0x86,0xd3,0xb6,0x6a,0xe3,0xf3,0x13,0x3d
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fdiv.s f29, f18, f11, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff7fc00000(nan_s)                       0xfffffffff939699b(-6.016980326265727e+34_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f18, f11, rtz
+========================================================================================================================+
...
f29                 0xffffffff7fc00000(nan_s)                       0xfffffffff939699b(-6.016980326265727e+34_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f18, f11
f11                 0x691cfdf194d21be6(2.167179346815219e+198_d)    0x691cfdf194d21be6(2.167179346815219e+198_d)
f18                 0x29d179064e982cd6(2.9759311354177554e-107_d)   0x29d179064e982cd6(2.9759311354177554e-107_d)
f29                 0xffffffff7fc00000(nan_s)                       0xfffffffff939699b(-6.016980326265727e+34_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2c2a4b11be3a6fa598f6f3faea509cbf1663398c        2c2a4b11be3a6fa598f6f3faea509cbf1663398c        
