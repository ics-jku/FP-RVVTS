# FailID_005534 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0xc0,0x87,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f11'}})
    fmin.s f11, f25, f28
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f25, f28
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6cd9eafc9589b6e5fedea1bb63a5c4c71fece7a5        6cd9eafc9589b6e5fedea1bb63a5c4c71fece7a5        
