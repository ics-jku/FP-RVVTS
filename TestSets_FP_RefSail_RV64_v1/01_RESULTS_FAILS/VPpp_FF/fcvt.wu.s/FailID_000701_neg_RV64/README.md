# FailID_000701 VP++ FF neg RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f18'}, 'clob': {'x16'}})
    fcvt.wu.s x16, f18, rup
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a6(x16)             0xffffffff80180800(18446744071563642880)        0x0000000080180800(2149058560)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x16, f18, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            465450ad06044cd3a07da411b079bbf96dff9d29        465450ad06044cd3a07da411b079bbf96dff9d29        
