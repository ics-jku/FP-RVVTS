# FailID_000288 ARA pos RV64 fsqrt.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x01,0xb0,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f22:.byte 0x42,0xac,0xaf,0x2a,0xbd,0xa2,0xe6,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
...
STATE               REF                                             DUT                                             DIFF
f12                 0x406ae9e24ce24409(215.30887455170185_d)        0x406ae9e24ce24408(215.30887455170182_d)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f12, f22, rup
+========================================================================================================================+
...
Registers: f12, f22
f12                 0x406ae9e24ce24409(215.30887455170185_d)        0x406ae9e24ce24408(215.30887455170182_d)        X
f22                 0x40e6a2bd2aafac42(46357.91146072048_d)         0x40e6a2bd2aafac42(46357.91146072048_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cefe75b0e3bf4746b05e1b6f87182bc867f4fe40        cefe75b0e3bf4746b05e1b6f87182bc867f4fe40        
