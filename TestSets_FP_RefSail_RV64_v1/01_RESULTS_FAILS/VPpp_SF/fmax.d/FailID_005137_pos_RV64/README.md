# FailID_005137 VP++ SF pos RV64 fmax.d
...
_reg_f23:.byte 0x00,0x00,0x00,0x54,0x00,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f12', 'f29'}, 'clob': {'f23'}})
    fmax.d f23, f29, f12
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0x000000008017fec7(1.061774839e-314_d)          0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f23, f29, f12
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            24598a4adce4e6559035c2f34d54f78524f70352        24598a4adce4e6559035c2f34d54f78524f70352        
