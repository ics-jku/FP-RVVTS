# FailID_002902 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.s x9, f18, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x9, f18, rdn
+========================================================================================================================+
...
Registers: x9, f18
s1(x9)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f18                 0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9b3f67bc2b52f6d50ff87523beb4ddb7a4c5f9bc        9b3f67bc2b52f6d50ff87523beb4ddb7a4c5f9bc        
