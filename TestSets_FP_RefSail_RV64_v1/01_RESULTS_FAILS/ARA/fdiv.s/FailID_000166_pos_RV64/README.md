# FailID_000166 ARA pos RV64 fdiv.s
...
_reg_f9: .byte 0x9f,0x01,0x00,0x80,0xff,0xff,0xff,0xff
_reg_f21:.byte 0x00,0x00,0x40,0x65,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f9', 'mstatus.fs/vs.fs'}, 'clob': {'f2'}})
    fdiv.s f2, f9, f21
```
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
Registers: f2, f9, f21
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f9                  0xffffffff8000019f(-5.815388626947991e-43_s)    0xffffffff8000019f(-5.815388626947991e-43_s)
f21                 0x41dffffe65400000(2147482005.0_d)              0x41dffffe65400000(2147482005.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            761ae6615853c7d3ff17cb302cbe95a35a32d022        761ae6615853c7d3ff17cb302cbe95a35a32d022        
