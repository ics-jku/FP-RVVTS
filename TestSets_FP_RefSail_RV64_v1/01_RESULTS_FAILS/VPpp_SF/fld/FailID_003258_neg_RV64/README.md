# FailID_003258 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x28, 0x6000               // t3
    li x29, 0x801ffbcd           // t4
    li x30, 0x6000               // t5
    li x31, 0x7ffffdeb           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x8'}, 'clob': {'x29', 'f15', 'x8'}})
...
f15                 0xffffffff4f7ffff9(4294965504.0_s)              0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f15                 0xffffffff4f7ffff9(4294965504.0_s)              0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, x3, b6, x8
gp(x3)              0x00000000801804c0(2149057728)                  0x00000000801804c0(2149057728)
fp(x8)              0x00000000800ea3b6(2148443062)                  0x00000000800ea3b6(2148443062)
f15                 0xffffffff4f7ffff9(4294965504.0_s)              0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
s4(x20)             0x000000006367e000(1667751936)                  0x000000006367e000(1667751936)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aef1c1b3c3587c9ed7070f79bcc86a3871937394        aef1c1b3c3587c9ed7070f79bcc86a3871937394        
