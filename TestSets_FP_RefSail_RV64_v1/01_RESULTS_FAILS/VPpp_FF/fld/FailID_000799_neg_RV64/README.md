# FailID_000799 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x26', 'mstatus.fs/vs.fs'}, 'clob': {'f11', 'x26', 'x21'}})
...
f11                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, x6, d0, x26
t1(x6)              0x00000000801ffc30(2149579824)                  0x00000000801ffc30(2149579824)
...
sp(x2)              0x00000000800004dd(2147484893)                  0x00000000800004dd(2147484893)                  
...
s5(x21)             0x00000000800006d0(2147485392)                  0x00000000800006d0(2147485392)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ca5e19b562c929b14623207aa6da08a0818e030b        ca5e19b562c929b14623207aa6da08a0818e030b        
