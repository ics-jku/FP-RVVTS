# FailID_005434 VP++ SF pos RV64 fmin.d
...
_reg_f8: .byte 0x55,0xe7,0x8a,0x20,0x38,0x47,0xf4,0x20
_reg_f30:.byte 0xf8,0xa8,0xcc,0xa1,0x9c,0x2b,0x32,0xae
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f1', 'fcsr.rm', 'f8'}, 'clob': {'f30'}})
    fmin.d f30, f8, f1
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0x20f44738208ae755(6.194861112194082e-150_d)    0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
f8                  0x20f44738208ae755(6.194861112194082e-150_d)    0x20f44738208ae755(6.194861112194082e-150_d)
f30                 0x20f44738208ae755(6.194861112194082e-150_d)    0xffffffffffc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            47186b7af44e53fe8037cb149b2e2a4cd7a1887e        47186b7af44e53fe8037cb149b2e2a4cd7a1887e        
