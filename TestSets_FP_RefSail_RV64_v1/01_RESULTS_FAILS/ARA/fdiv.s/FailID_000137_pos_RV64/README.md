# FailID_000137 ARA pos RV64 fdiv.s
...
_reg_f24:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f24'}})
    fdiv.s f24, f15, f18, rmm
```
...
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f24, f15, f18, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            27d78e7aeb8cd7297895a390ede76b032f243ef8        27d78e7aeb8cd7297895a390ede76b032f243ef8        
