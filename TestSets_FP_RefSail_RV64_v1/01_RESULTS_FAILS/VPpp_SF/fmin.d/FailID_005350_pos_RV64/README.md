# FailID_005350 VP++ SF pos RV64 fmin.d
...
_reg_f23:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f25'}, 'clob': {'f23'}})
    fmin.d f23, f25, f14
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0x41dfffffffc00000(2147483647.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f23, f25, f14
+========================================================================================================================+
...
f23                 0x41dfffffffc00000(2147483647.0_d)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f25, f14
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f23                 0x41dfffffffc00000(2147483647.0_d)              0xffffffff7fc00000(nan_s)                       X
f25                 0x41dfffffffc00000(2147483647.0_d)              0x41dfffffffc00000(2147483647.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ea589c316e33483cfe2340a4b9af385499814684        ea589c316e33483cfe2340a4b9af385499814684        
