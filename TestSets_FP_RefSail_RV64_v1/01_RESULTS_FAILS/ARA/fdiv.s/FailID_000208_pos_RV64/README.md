# FailID_000208 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_reg_f6: .byte 0x07,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f6'}})
    fdiv.s f6, f1, f11, rne
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f6, f1, f11, rne
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f1, f11
f1                  0xffffffffbf800000(-1.0_s)                      0xffffffffbf800000(-1.0_s)
f6                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5747d7d7511c702f87efbc7058e9e2e8675b4eeb        5747d7d7511c702f87efbc7058e9e2e8675b4eeb        
