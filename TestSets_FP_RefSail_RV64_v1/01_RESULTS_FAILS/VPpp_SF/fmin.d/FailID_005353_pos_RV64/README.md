# FailID_005353 VP++ SF pos RV64 fmin.d
...
_reg_f8: .byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f8'}, 'clob': {'f8'}})
    fmin.d f8, f0, f8
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x3ff0000000000000(1.0_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            19092da78e07039f381a5222b18ec565745376c0        19092da78e07039f381a5222b18ec565745376c0        
