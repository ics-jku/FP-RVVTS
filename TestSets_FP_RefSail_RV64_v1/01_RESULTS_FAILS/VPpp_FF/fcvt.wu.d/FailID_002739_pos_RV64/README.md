# FailID_002739 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x00,0xe0,0x59,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.d x9, f9, dyn
```
...
```
REG                 REF                                             DUT                                             DIFF
s1(x9)              0xffffffff800002cf(18446744071562068687)        0x00000000800002cf(2147484367)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x9, f9, dyn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x9, f9
s1(x9)              0xffffffff800002cf(18446744071562068687)        0x00000000800002cf(2147484367)                  X
f9                  0x41e0000059e00000(2147484367.0_d)              0x41e0000059e00000(2147484367.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7f58ddd62a383bcd45bbce5e86c3571d5e96d3e2        7f58ddd62a383bcd45bbce5e86c3571d5e96d3e2        
