# FailID_005130 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f4'}, 'clob': {'f8'}})
    fmax.d f8, f6, f4
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            966b3338bcadb0bdf5797f8f13f4d7e51d0391c6        966b3338bcadb0bdf5797f8f13f4d7e51d0391c6        
