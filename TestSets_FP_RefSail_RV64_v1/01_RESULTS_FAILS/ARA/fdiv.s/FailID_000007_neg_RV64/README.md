# FailID_000007 ARA neg RV64 fdiv.s
...
_reg_f25:.byte 0x0b,0xd9,0x5d,0xa0,0xbf,0xbb,0xdb,0xd5
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'f15', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f25'}})
    fdiv.s f25, f5, f15, rup
```
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff6882ffe8(4.949026238989333e+24_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f5, f15, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5f02720d0f3931d66a61ffb938bfe3af551594dc        5f02720d0f3931d66a61ffb938bfe3af551594dc        
