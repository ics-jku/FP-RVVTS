# FailID_000146 ARA pos RV64 fdiv.s
...
_reg_f26:.byte 0x00,0x00,0xc0,0xc8,0xfd,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f14'}})
    fdiv.s f14, f26, f26, rne
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f14, f26, f26, rne
+========================================================================================================================+
...
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f26, f26
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
f26                 0xc1dffffdc8c00000(-2147481379.0_d)             0xc1dffffdc8c00000(-2147481379.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            30a01e872c153770ab335acb9617743d06c33492        30a01e872c153770ab335acb9617743d06c33492        
