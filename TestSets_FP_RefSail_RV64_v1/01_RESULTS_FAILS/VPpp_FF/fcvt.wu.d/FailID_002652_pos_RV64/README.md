# FailID_002652 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f15:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'x17'}})
    fcvt.wu.d x17, f15, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x17, f15, rtz
+========================================================================================================================+
...
Registers: x17, f15
a7(x17)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f15                 0xffffffffbf800000(-1.0_s)                      0xffffffffbf800000(-1.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d311d17497d94ddd2560f0a14c5b968540123f40        d311d17497d94ddd2560f0a14c5b968540123f40        
