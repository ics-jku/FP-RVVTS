# FailID_003141 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0x25,0x00,0x20,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x8'}})
...
```
REG                 REF                                             DUT                                             DIFF
fp(x8)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x8, f13, rmm
+========================================================================================================================+
...
Registers: x8, f13
fp(x8)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f13                 0x0000000080200025(1.0620340445e-314_d)         0x0000000080200025(1.0620340445e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            93a2215044db33ee918b5fec4047440ab997f19d        93a2215044db33ee918b5fec4047440ab997f19d        
