# FailID_001495 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x17, 0x0                  // a7
    li x18, 0x200                // s2
    li x19, 0x8027f9c2           // s3
    li x20, 0x0                  // s4
    li x21, 0x8017f9ca           // s5
    li x22, 0x0                  // s6
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x3'}, 'clob': {'x19', 'x3', 'f17'}})
...
f17                 0xba285a6d847c7c5a(-1.5369051125236202e-28_d)   0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4a778e0d90ce9984de10d576806ac7489f99dd07        4a778e0d90ce9984de10d576806ac7489f99dd07        
