# FailID_000218 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f30'}})
    fdiv.s f30, f20, f29, dyn
```
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f30, f20, f29, dyn
+========================================================================================================================+
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f20, f29
f20                 0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            80d15b08401bbcff4457c4e6cc4e8320a77bf9f5        80d15b08401bbcff4457c4e6cc4e8320a77bf9f5        
