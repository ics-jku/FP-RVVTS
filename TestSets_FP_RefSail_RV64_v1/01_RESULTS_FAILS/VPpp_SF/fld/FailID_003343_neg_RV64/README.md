# FailID_003343 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x17, 0x1                  // a7
    li x18, 0x0                  // s2
    li x19, 0xffffffffffff9e37   // s3
    li x20, 0x8027f6b4           // s4
    li x21, 0x80180271           // s5
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x19', 'f22', 'x2'}})
...
f22                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f22                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x1, f0, x19
ra(x1)              0x0000000080180964(2149058916)                  0x0000000080180964(2149058916)
s3(x19)             0x00000000801fa020(2149556256)                  0x00000000801fa020(2149556256)
...
s10(x26)            0x0000000000034019(213017)                      0x0000000000034019(213017)                      
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b7437e61293002642d1113ec8f960c6727fc6125        b7437e61293002642d1113ec8f960c6727fc6125        
