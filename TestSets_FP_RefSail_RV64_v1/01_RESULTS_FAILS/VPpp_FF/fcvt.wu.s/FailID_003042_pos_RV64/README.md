# FailID_003042 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x55,0xc0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.s x3, f14
```
...
Registers: x3, f14
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f14                 0xc055000000000000(-84.0_d)                     0xc055000000000000(-84.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1e0fb421ae54657a110d3cbda0c70afc0ebe11df        1e0fb421ae54657a110d3cbda0c70afc0ebe11df        
