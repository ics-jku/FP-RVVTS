# FailID_005523 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f16', 'fcsr.rm'}, 'clob': {'f14'}})
    fmin.s f14, f16, f3
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb644304e1bb3aa2481b095d439a9ebd644390d4        fb644304e1bb3aa2481b095d439a9ebd644390d4        
