# FailID_005528 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0xf8,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f5'}, 'clob': {'f4'}})
    fmin.s f4, f3, f5
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff4efffff8(2147482624.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, f3, f5
f3                  0xffffffff4efffff8(2147482624.0_s)              0xffffffff4efffff8(2147482624.0_s)
f4                  0xffffffff4efffff8(2147482624.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6ade562b4baf5158bceb0a8cb403f7af163e7db2        6ade562b4baf5158bceb0a8cb403f7af163e7db2        
