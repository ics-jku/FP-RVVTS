# FailID_005488 VP++ SF pos RV64 fmin.s
...
_reg_f27:.byte 0x00,0x00,0xe0,0x8c,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f27'}})
    fmin.s f27, f13, f17
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f27, f13, f17
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f75a9a2b9c21831b0d616d07abea6399560d3514        f75a9a2b9c21831b0d616d07abea6399560d3514        
