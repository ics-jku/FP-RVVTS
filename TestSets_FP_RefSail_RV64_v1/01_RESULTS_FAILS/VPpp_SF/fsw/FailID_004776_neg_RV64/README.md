# FailID_004776 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x26, 0x80200808           // s10
    li x27, 0xffffffffeffb0000   // s11
    li x28, 0x802008d8           // t3
    li x29, 0x8018065c           // t4
    li x30, 0x0                  // t5
    li x31, 0x400                // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm', 'f11'}, 'clob': {'x24', 'x26'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1584f697a58f09a96ba6b99b7f0204c389245570        1584f697a58f09a96ba6b99b7f0204c389245570        
