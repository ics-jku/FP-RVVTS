# FailID_005203 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f11'}})
    fmax.d f11, f12, f24
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x0000000000000000(0.0_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f11, f12, f24
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7e9c87522017d5d36f72d8e63579048f819a264c        7e9c87522017d5d36f72d8e63579048f819a264c        
