# FailID_005176 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f14', 'fcsr.rm'}, 'clob': {'f0'}})
    fmax.d f0, f10, f14
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            93bc439fa6e09f9aa255dfbf7e0c13c2139cd7ff        93bc439fa6e09f9aa255dfbf7e0c13c2139cd7ff        
