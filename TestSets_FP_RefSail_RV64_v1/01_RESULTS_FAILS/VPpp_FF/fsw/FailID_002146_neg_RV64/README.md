# FailID_002146 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f3', 'mstatus.fs/vs.fs', 'x9'}, 'clob': {'x9', 'x26'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            55d9284396d0319bb610f594589fa4116f694fb3        55d9284396d0319bb610f594589fa4116f694fb3        
