# FailID_000294 ARA pos RV64 fsqrt.d
...
_reg_f21:.byte 0xfe,0x05,0x20,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fsqrt.d f10, f21, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x1f06a2bca6f2883c(3.2200755488155585e-159_d)   0x1f06a2bca6f2883d(3.220075548815559e-159_d)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f10, f21, rdn
+========================================================================================================================+
...
Registers: f10, f21
f10                 0x1f06a2bca6f2883c(3.2200755488155585e-159_d)   0x1f06a2bca6f2883d(3.220075548815559e-159_d)    X
f21                 0x00000000002005fe(1.0368887e-317_d)            0x00000000002005fe(1.0368887e-317_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a04d052020d6f105a04fd7fcf33bad5a7cfac2dc        a04d052020d6f105a04fd7fcf33bad5a7cfac2dc        
