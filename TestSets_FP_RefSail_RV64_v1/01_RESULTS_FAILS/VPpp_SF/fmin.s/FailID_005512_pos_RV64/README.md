# FailID_005512 VP++ SF pos RV64 fmin.s
...
_reg_f24:.byte 0x00,0x00,0xc0,0x46,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f11'}})
    fmin.s f11, f24, f17
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f24, f17
+========================================================================================================================+
...
f11                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f24, f17
f11                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f24                 0xffffffff46c00000(24576.0_s)                   0xffffffff46c00000(24576.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5c420a7d668092af9fffceebfd47aee214613611        5c420a7d668092af9fffceebfd47aee214613611        
