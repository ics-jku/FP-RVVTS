# FailID_002664 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x1'}})
    fcvt.wu.d x1, f31, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x1, f31, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a58d6a5bb3788f4f8201f782339ed8c07fb6fea9        a58d6a5bb3788f4f8201f782339ed8c07fb6fea9        
