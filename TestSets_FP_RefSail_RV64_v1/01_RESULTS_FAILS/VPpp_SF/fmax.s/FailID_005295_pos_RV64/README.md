# FailID_005295 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f2'}, 'clob': {'f17'}})
    fmax.s f17, f2, f0
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bca763c1327ac7f3673e3f500984f0065ca045db        bca763c1327ac7f3673e3f500984f0065ca045db        
