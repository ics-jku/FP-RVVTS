# FailID_003120 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0x00,0x00,0x00,0x4b,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x28'}})
    fcvt.wu.s x28, f25, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x28, f25, dyn
+========================================================================================================================+
Attributes:  fcsr ['invalid'], special values ['zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x28, f25
t3(x28)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f25                 0x41dffffe4b000000(2147481900.0_d)              0x41dffffe4b000000(2147481900.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ace37201d9ded06cb7bac6fee44653d6779fe86        0ace37201d9ded06cb7bac6fee44653d6779fe86        
