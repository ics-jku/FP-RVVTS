# FailID_002755 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x00,0x60,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x29'}})
    fcvt.wu.d x29, f8, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t4(x29)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x29, f8, rne
+========================================================================================================================+
...
Registers: x29, f8
t4(x29)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f8                  0xffffffff00006000(3.4438311059246704e-41_s)    0xffffffff00006000(3.4438311059246704e-41_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            75b7414ff2a0c419bd19a6c67c7c3cec71eb4515        75b7414ff2a0c419bd19a6c67c7c3cec71eb4515        
