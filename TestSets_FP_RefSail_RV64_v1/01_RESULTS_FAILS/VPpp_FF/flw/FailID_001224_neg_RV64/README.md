# FailID_001224 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x16, 0x79                 // a6
    li x17, 0x6000               // a7
    li x18, 0x40000000           // s2
    li x19, 0x8002a96a           // s3
    li x20, 0x48e3f778           // s4
    li x21, 0x801ffe8d           // s5
    li x22, 0x801804c9           // s6
    li x23, 0x80000251           // s7
    li x24, 0xffffffffffffb023   // s8
    li x25, 0x8027f467           // s9
    li x26, 0x801802cf           // s10
    li x27, 0x39                 // s11
    li x28, 0x6000               // t3
    li x29, 0x0                  // t4
    li x30, 0x6000               // t5
    li x31, 0x8017fba3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x6'}, 'clob': {'x6', 'x7', 'f18'}})
...
f18                 0x7ff8000000000000(nan_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
tp(x4)              0x000000008017faa7(2149055143)                  0x000000008017faa7(2149055143)                  
t0(x5)              0x00000000000000ca(202)                         0x00000000000000ca(202)                         
t1(x6)              0x000000007ffff930(2147481904)                  0x000000007ffff930(2147481904)                  
t2(x7)              0x000000007ffff930(2147481904)                  0x000000007ffff930(2147481904)                  
...
s2(x18)             0x0000000040000000(1073741824)                  0x0000000040000000(1073741824)                  
s3(x19)             0x000000008002a96a(2147658090)                  0x000000008002a96a(2147658090)                  
...
s6(x22)             0x00000000801804c9(2149057737)                  0x00000000801804c9(2149057737)                  
...
s9(x25)             0x000000008027f467(2150102119)                  0x000000008027f467(2150102119)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6035ddce6d2759c60f24a888c3df0b79b3e0478e        6035ddce6d2759c60f24a888c3df0b79b3e0478e        
