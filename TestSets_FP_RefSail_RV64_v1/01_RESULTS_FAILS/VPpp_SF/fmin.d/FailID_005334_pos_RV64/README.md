# FailID_005334 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0xf2,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f19:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x00,0x00,0x40,0x27,0x01,0xfa,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f20'}, 'clob': {'f10'}})
    fmin.d f10, f20, f19
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xc1dffa0127400000(-2145911965.0_d)             0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f10, f20, f19
+========================================================================================================================+
...
f10                 0xc1dffa0127400000(-2145911965.0_d)             0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f20, f19
f10                 0xc1dffa0127400000(-2145911965.0_d)             0xffffffff00000000(0.0_s)                       X
f19                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f20                 0xc1dffa0127400000(-2145911965.0_d)             0xc1dffa0127400000(-2145911965.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5755f7a18535535659fd1a9e7f91231ddef56019        5755f7a18535535659fd1a9e7f91231ddef56019        
