# FailID_000263 ARA pos RV64 fdiv.s
...
_reg_f8: .byte 0x00,0x00,0x00,0x5a,0xff,0xff,0xdf,0xc1
_reg_f10:.byte 0xfb,0xff,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f4'}})
    fdiv.s f4, f10, f8, rne
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff7fc00000(nan_s)                       0xffffffffb47ffffb(-2.3841850804728892e-07_s)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f4, f10, f8, rne
+========================================================================================================================+
...
Registers: f4, f10, f8
f4                  0xffffffff7fc00000(nan_s)                       0xffffffffb47ffffb(-2.3841850804728892e-07_s)   X
f8                  0xc1dfffff5a000000(-2147482984.0_d)             0xc1dfffff5a000000(-2147482984.0_d)
f10                 0xffffffffcefffffb(-2147483008.0_s)             0xffffffffcefffffb(-2147483008.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7682b497eba94313c13936c24e66d21eb81dd75d        7682b497eba94313c13936c24e66d21eb81dd75d        
