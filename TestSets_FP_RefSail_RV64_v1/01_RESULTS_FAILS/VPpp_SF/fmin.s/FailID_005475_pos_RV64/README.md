# FailID_005475 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
_reg_f18:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f31:.byte 0x07,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f18', 'fcsr.rm'}, 'clob': {'f31'}})
    fmin.s f31, f0, f18
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f31                 0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f0, f18
f0                  0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            48fb9adffa7839b07b432969eb03d1ec7fb80f77        48fb9adffa7839b07b432969eb03d1ec7fb80f77        
