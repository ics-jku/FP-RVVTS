# FailID_005518 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f8'}, 'clob': {'f7'}})
    fmin.s f7, f8, f16
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            353e380212034fa4633c5433cd2db87c80a8c195        353e380212034fa4633c5433cd2db87c80a8c195        
