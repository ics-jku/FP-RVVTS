# FailID_000133 ARA pos RV64 fdiv.s
...
_reg_f6: .byte 0x00,0x00,0x00,0x41,0xff,0xff,0xff,0xff
_reg_f28:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f28'}})
    fdiv.s f28, f2, f6, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f28, f2, f6, rmm
+========================================================================================================================+
...
f6                  0xffffffff41000000(8.0_s)                       0xffffffff41000000(8.0_s)
f28                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1c8b73f4150a5eecfe350931994d575e4f6cdc08        1c8b73f4150a5eecfe350931994d575e4f6cdc08        
