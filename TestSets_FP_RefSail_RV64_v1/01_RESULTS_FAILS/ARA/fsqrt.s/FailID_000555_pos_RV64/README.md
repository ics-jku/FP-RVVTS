# FailID_000555 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x07,0xb9,0x02,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f19'}})
    fsqrt.s f19, f5, rup
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xffffffff1e955922(1.5812853109832506e-20_s)    0xffffffff1e955921(1.5812851494245372e-20_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f19, f5, rup
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f5
f5                  0xffffffff0002b907(2.5004629667565603e-40_s)    0xffffffff0002b907(2.5004629667565603e-40_s)
f19                 0xffffffff1e955922(1.5812853109832506e-20_s)    0xffffffff1e955921(1.5812851494245372e-20_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ea279b161db0aaad6512bfce453002611f3e8d0d        ea279b161db0aaad6512bfce453002611f3e8d0d        
