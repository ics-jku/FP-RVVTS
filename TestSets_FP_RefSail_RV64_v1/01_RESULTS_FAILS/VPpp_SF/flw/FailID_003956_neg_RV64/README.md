# FailID_003956 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0x90                 // a2
    li x13, 0x0                  // a3
    li x14, 0x8018066b           // a4
    li x15, 0x7ffff9b4           // a5
    li x16, 0x0                  // a6
    li x17, 0x8017fc90           // a7
    li x18, 0x6000               // s2
    li x19, 0x801a6d87           // s3
    ...
    li x26, 0xf38ce764           // s10
    li x27, 0x1000               // s11
    li x28, 0x80000731           // t3
    li x29, 0x80180d77           // t4
    li x30, 0x7                  // t5
    li x31, 0x80000731           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'f27', 'x6', 'x8'}})
...
f27                 0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f27                 0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x28, x6
t1(x6)              0x000000008017ff1e(2149056286)                  0x000000008017ff1e(2149056286)
...
fp(x8)              0x000000008000028e(2147484302)                  0x000000008000028e(2147484302)                  
...
s10(x26)            0x00000000f38ce764(4086097764)                  0x00000000f38ce764(4086097764)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e548ea331f99350cb9901a0d432d2a7b9e50dc7a        e548ea331f99350cb9901a0d432d2a7b9e50dc7a        
