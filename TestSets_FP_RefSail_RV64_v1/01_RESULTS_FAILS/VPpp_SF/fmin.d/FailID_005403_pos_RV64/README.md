# FailID_005403 VP++ SF pos RV64 fmin.d
...
_reg_f11:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f12'}, 'clob': {'f11'}})
    fmin.d f11, f12, f0
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0x000000132140006f(4.05935308646e-313_d)        0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            95f2ea65ab5f90a52691f716994bed9136591c49        95f2ea65ab5f90a52691f716994bed9136591c49        
