# FailID_003117 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0xcc,0xcd,0x47,0x3e,0xd2,0xe9,0x9d,0xd0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.s x9, f23, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s1(x9)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x9, f23, rmm
+========================================================================================================================+
...
Registers: x9, f23
s1(x9)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f23                 0xd09de9d23e47cdcc(-2.2167878075710572e+80_d)   0xd09de9d23e47cdcc(-2.2167878075710572e+80_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            79696f9987fbed0e49f4aab7c1b47f6df5626afa        79696f9987fbed0e49f4aab7c1b47f6df5626afa        
