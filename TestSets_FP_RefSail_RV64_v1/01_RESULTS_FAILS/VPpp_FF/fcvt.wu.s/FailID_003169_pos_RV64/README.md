# FailID_003169 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f20
    fld  f20, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x11'}})
    fcvt.wu.s x11, f20, rup
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x11, f20, rup
+========================================================================================================================+
...
Registers: x11, f20
a1(x11)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f20                 0x7fffffffffffffff(nan_d)                       0x7fffffffffffffff(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            895805bcf3dfc63684680ad3fc693a564559763d        895805bcf3dfc63684680ad3fc693a564559763d        
