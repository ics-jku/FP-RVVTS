# FailID_002225 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x801d5029            // fp
    li x9, 0x8018052e            // s1
    li x10, 0x8017ff40           // a0
    li x11, 0x801ff4fb           // a1
    li x12, 0x80203b1a           // a2
    li x13, 0x1                  // a3
    li x14, 0x80000029           // a4
    li x15, 0x8017fcf8           // a5
    li x16, 0x8000039a           // a6
    li x17, 0x8017fe88           // a7
    li x18, 0xffffffffc4fe2000   // s2
    li x19, 0x801ffdc1           // s3
    li x20, 0x6000               // s4
    li x21, 0x8005df4a           // s5
    li x22, 0x7fffffac           // s6
    li x23, 0x1000067            // s7
    li x24, 0x0                  // s8
    li x25, 0x80018b05           // s9
    li x26, 0x7ffff9f6           // s10
    li x27, 0x8018052e           // s11
    li x28, 0x8005df4a           // t3
    li x29, 0x0                  // t4
    li x30, 0x0                  // t5
    li x31, 0x801806aa           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x16', 'mstatus.fs/vs.fs', 'f24'}, 'clob': {'x16', 'x27'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7843fdc58aa79ae2daa2d4d274f11c7c110d2f7b        X
...
t2(x7)              0x000000008017ff40(2149056320)                  0x000000008017ff40(2149056320)                  
...
a0(x10)             0x000000008017ff40(2149056320)                  0x000000008017ff40(2149056320)                  
a1(x11)             0x00000000801ff4fb(2149577979)                  0x00000000801ff4fb(2149577979)                  
a2(x12)             0x0000000080203b1a(2149595930)                  0x0000000080203b1a(2149595930)                  
a3(x13)             0x0000000000000001(1)                           0x0000000000000001(1)                           
a4(x14)             0x0000000080000029(2147483689)                  0x0000000080000029(2147483689)                  
a5(x15)             0x000000008017fcf8(2149055736)                  0x000000008017fcf8(2149055736)                  
a6(x16)             0x0000000080180715(2149058325)                  0x0000000080180715(2149058325)                  
a7(x17)             0x000000008017fe88(2149056136)                  0x000000008017fe88(2149056136)                  
...
s5(x21)             0x000000008005df4a(2147868490)                  0x000000008005df4a(2147868490)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ee1e63425ff422b1fe2ef0ba2b75d31c7c21cc84        ee1e63425ff422b1fe2ef0ba2b75d31c7c21cc84        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7843fdc58aa79ae2daa2d4d274f11c7c110d2f7b        X
