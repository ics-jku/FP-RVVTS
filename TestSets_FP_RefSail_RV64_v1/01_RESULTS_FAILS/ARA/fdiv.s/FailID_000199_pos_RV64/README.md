# FailID_000199 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
_reg_f2: .byte 0x6f,0x02,0x18,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f7'}})
    fdiv.s f7, f2, f1, dyn
```
...
STATE               REF                                             DUT                                             DIFF
fcsr                0x0000000000000000(0)                           0x0000000000000002(2)                           X
 fcsr.uf            False                                           True                                            X
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f7, f2, f1, dyn
+========================================================================================================================+
Attributes:  fcsr ['underflow'], special values ['nan', 'zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f2, f1
f1                  0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff5f800000(1.8446744073709552e+19_s)
f2                  0x000000008018026f(1.0617753014e-314_d)         0x000000008018026f(1.0617753014e-314_d)
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dac507452f31198c234ec66ff03eb6734f6d9c46        dac507452f31198c234ec66ff03eb6734f6d9c46        
