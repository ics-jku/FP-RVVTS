# FailID_000032 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'f7', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f7'}})
    fdiv.s f7, f8, f7, rup
```
...
f7                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f7, f8, f7, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            be75defaba594144dbaa7ed389bb5312b27c786c        be75defaba594144dbaa7ed389bb5312b27c786c        
