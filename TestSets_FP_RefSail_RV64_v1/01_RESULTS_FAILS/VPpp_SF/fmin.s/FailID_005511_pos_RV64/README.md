# FailID_005511 VP++ SF pos RV64 fmin.s
...
_reg_f27:.byte 0x43,0x04,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f12'}})
    fmin.s f12, f27, f24
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff80000443(-1.5288166245783754e-42_s)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f12, f27, f24
+========================================================================================================================+
...
f12                 0xffffffff80000443(-1.5288166245783754e-42_s)   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f27, f24
f12                 0xffffffff80000443(-1.5288166245783754e-42_s)   0xffffffff7fc00000(nan_s)                       X
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f27                 0xffffffff80000443(-1.5288166245783754e-42_s)   0xffffffff80000443(-1.5288166245783754e-42_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b1457f7a75b3f9f6cde9f3c3de284955791b9c50        b1457f7a75b3f9f6cde9f3c3de284955791b9c50        
