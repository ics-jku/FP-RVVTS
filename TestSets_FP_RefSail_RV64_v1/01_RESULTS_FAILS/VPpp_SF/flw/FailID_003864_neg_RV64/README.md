# FailID_003864 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x24', 'f19', 'x4'}})
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff0201b303(9.528797047284384e-38_s)     X
STATES DIFFER: True
```
...
a0(x10)             0x00000000000000a9(169)                         0x00000000000000a9(169)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            633035ba42435134dc0146b91c8bfd91e119bcc1        633035ba42435134dc0146b91c8bfd91e119bcc1        
