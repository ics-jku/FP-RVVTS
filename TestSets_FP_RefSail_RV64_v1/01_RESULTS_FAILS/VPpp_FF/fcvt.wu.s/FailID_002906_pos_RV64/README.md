# FailID_002906 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x50,0xe1,0xc7,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f22
    fld  f22, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f22', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4'}})
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x4, f22, rmm
+========================================================================================================================+
...
Registers: x4, f22
tp(x4)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f22                 0x41c7e15000000000(801284096.0_d)               0x41c7e15000000000(801284096.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            51c4983b3a15c6a9b663450d2f673685c336f667        51c4983b3a15c6a9b663450d2f673685c336f667        
