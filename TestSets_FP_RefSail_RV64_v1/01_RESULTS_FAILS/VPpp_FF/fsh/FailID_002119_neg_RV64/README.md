# FailID_002119 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs', 'x7'}, 'clob': {'x7', 'x23'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, x144, x7
t2(x7)              0x00000000801d0144(2149384516)                  0x00000000801d0144(2149384516)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2d359771e513b52420881f7d6e828fb5af9d5fc8        2d359771e513b52420881f7d6e828fb5af9d5fc8        
