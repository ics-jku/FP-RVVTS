# FailID_005264 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x00,0x40,0x58,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'fcsr.rm', 'f22'}, 'clob': {'f2'}})
    fmax.s f2, f22, f15
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2bfd6bf43147e373f1324221bf1bf8ff7d576e69        2bfd6bf43147e373f1324221bf1bf8ff7d576e69        
