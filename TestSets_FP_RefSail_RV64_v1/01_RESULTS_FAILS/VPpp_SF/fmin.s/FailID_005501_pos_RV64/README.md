# FailID_005501 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0xf6,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f16', 'fcsr.rm'}, 'clob': {'f5'}})
    fmin.s f5, f16, f10
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6e8d63c565a21a2bd7569f2a1ced2a1d61b3927e        6e8d63c565a21a2bd7569f2a1ced2a1d61b3927e        
