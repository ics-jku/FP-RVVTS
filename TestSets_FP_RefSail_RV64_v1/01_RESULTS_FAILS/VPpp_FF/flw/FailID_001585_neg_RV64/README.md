# FailID_001585 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x13, 0x0                  // a3
    li x14, 0x8017f87d           // a4
    li x15, 0x800002cf00000      // a5
    li x16, 0x0                  // a6
    li x17, 0x801808a4           // a7
    li x18, 0x0                  // s2
    li x19, 0x801801fb           // s3
    li x20, 0xffffffff92cb9000   // s4
    li x21, 0x7ffffea1           // s5
    li x22, 0x1                  // s6
    li x23, 0x1fffffffc          // s7
    li x24, 0x7fffffff           // s8
    li x25, 0x10000059e00000     // s9
    li x26, 0x80000554           // s10
    li x27, 0x51b023340191f3     // s11
    li x28, 0x801d682c           // t3
    li x29, 0x7ffffea1           // t4
    li x30, 0x8017fca4           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x20'}, 'clob': {'f10', 'x7', 'x20'}})
...
f10                 0xa0916a366e050cfe(-8.312717186065277e-152_d)   0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f10                 0xa0916a366e050cfe(-8.312717186065277e-152_d)   0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, x307, x20
s4(x20)             0x00000000800b9307(2148242183)                  0x00000000800b9307(2148242183)
f10                 0xa0916a366e050cfe(-8.312717186065277e-152_d)   0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
gp(x3)              0x0000000080000262(2147484258)                  0x0000000080000262(2147484258)                  
...
t2(x7)              0x0000000080000307(2147484423)                  0x0000000080000307(2147484423)                  
...
a4(x14)             0x000000008017f87d(2149054589)                  0x000000008017f87d(2149054589)                  
a5(x15)             0x000800002cf00000(2251800567611392)            0x000800002cf00000(2251800567611392)            
a6(x16)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a7(x17)             0x00000000801808a4(2149058724)                  0x00000000801808a4(2149058724)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x00000000801801fb(2149057019)                  0x00000000801801fb(2149057019)                  
s4(x20)             0x00000000800b9307(2148242183)                  0x00000000800b9307(2148242183)                  
s5(x21)             0x000000007ffffea1(2147483297)                  0x000000007ffffea1(2147483297)                  
s6(x22)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s7(x23)             0x00000001fffffffc(8589934588)                  0x00000001fffffffc(8589934588)                  
...
s10(x26)            0x0000000080000554(2147485012)                  0x0000000080000554(2147485012)                  
s11(x27)            0x0051b023340191f3(22993138356425203)           0x0051b023340191f3(22993138356425203)           
t3(x28)             0x00000000801d682c(2149410860)                  0x00000000801d682c(2149410860)                  
t4(x29)             0x000000007ffffea1(2147483297)                  0x000000007ffffea1(2147483297)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            83cc93d72ddeefdf408075b51d25fd4a7f7010f6        83cc93d72ddeefdf408075b51d25fd4a7f7010f6        
