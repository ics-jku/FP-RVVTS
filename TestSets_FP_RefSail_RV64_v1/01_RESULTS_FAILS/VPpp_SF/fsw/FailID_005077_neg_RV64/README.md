# FailID_005077 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x27, 0x801cfc08           // s11
    li x28, 0x800000fc           // t3
    li x29, 0x80000504           // t4
    li x30, 0xb3                 // t5
    li x31, 0x200601d48          // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'x31'}, 'clob': {'x10', 'x31'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, x39, x31
t6(x31)             0x00000000801819ac(2149063084)                  0x00000000801819ac(2149063084)
...
a0(x10)             0x000000008017fc64(2149055588)                  0x000000008017fc64(2149055588)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            753618124acbf4deeb4185b16a0254d3a6b97c5d        753618124acbf4deeb4185b16a0254d3a6b97c5d        
