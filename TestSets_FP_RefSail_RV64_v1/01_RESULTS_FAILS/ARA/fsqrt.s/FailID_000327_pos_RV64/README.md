# FailID_000327 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f26'}})
    fsqrt.s f26, f10, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff473504f2(46340.9453125_s)             0xffffffff473504f3(46340.94921875_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f26, f10, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3ba9972db9acc1f76ae45c3f64d535d6a6ee51a4        3ba9972db9acc1f76ae45c3f64d535d6a6ee51a4        
