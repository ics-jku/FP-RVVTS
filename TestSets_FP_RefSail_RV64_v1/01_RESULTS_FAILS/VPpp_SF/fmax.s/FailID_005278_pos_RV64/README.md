# FailID_005278 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f22:.byte 0x97,0x02,0x00,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f22', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f29'}, 'clob': {'f29'}})
    fmax.s f29, f22, f29
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f29, f22, f29
+========================================================================================================================+
...
f29                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffffffc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f22, f29
f22                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffff00000297(9.290608818473537e-43_s)
f29                 0xffffffff00000297(9.290608818473537e-43_s)     0xffffffffffc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a36fb1b45fc3e96519811a108911ebba1ac50c61        a36fb1b45fc3e96519811a108911ebba1ac50c61        
