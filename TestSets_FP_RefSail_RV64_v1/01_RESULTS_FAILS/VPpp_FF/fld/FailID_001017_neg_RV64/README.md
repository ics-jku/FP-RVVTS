# FailID_001017 VP++ FF neg RV64 fld
...
_reg_f1: .byte 0x00,0x7e,0xff,0xff,0xff,0xff,0xff,0xff
_reg_f2: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f3: .byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x20,0x95,0xc0
_reg_f6: .byte 0x00,0xfe,0xff,0xff,0xff,0xff,0xff,0xff
_reg_f7: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0x7f
...
_reg_f15:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0x7f
...
_reg_f28:.byte 0x00,0x00,0x00,0x41,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore fcsr = {'nx': True, 'uf': False, 'of': False, 'dz': False, 'nv': True, 'rm': 'rtz(0b001)', 'res': 0}
    li t0, 0x31
    csrrw zero, fcsr, t0
    ...
    li x11, 0x8017f841           // a1
    li x12, 0x0                  // a2
    li x13, 0x1                  // a3
    li x14, 0x7fffffffffffffff   // a4
    li x15, 0x8017fc8a           // a5
    li x16, 0x0                  // a6
    li x17, 0x28                 // a7
    li x18, 0x800003ae           // s2
    li x19, 0x6000               // s3
    li x20, 0x1                  // s4
    li x21, 0x0                  // s5
    li x22, 0x8028014c           // s6
    li x23, 0x801806cd           // s7
    li x24, 0x0                  // s8
    li x25, 0x51b023340191f3     // s9
    li x26, 0x7ffff86e           // s10
    li x27, 0x7ff8000000000000   // s11
    li x28, 0x6000               // t3
    li x29, 0xffffffffffffffff   // t4
    li x30, 0x6000               // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'f11', 'x5', 'x29'}})
...
f11                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, x447, x29
t4(x29)             0x00000000801ffbb1(2149579697)                  0x00000000801ffbb1(2149579697)
f11                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
sp(x2)              0x000000007ffff809(2147481609)                  0x000000007ffff809(2147481609)                  
gp(x3)              0x000000007ffff86e(2147481710)                  0x000000007ffff86e(2147481710)                  
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x000000007ffffbb9(2147482553)                  0x000000007ffffbb9(2147482553)                  
...
s1(x9)              0x00000000800001d2(2147484114)                  0x00000000800001d2(2147484114)                  
a0(x10)             0x000000007ffff9e7(2147482087)                  0x000000007ffff9e7(2147482087)                  
a1(x11)             0x000000008017f841(2149054529)                  0x000000008017f841(2149054529)                  
...
a5(x15)             0x000000008017fc8a(2149055626)                  0x000000008017fc8a(2149055626)                  
a6(x16)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a7(x17)             0x0000000000000028(40)                          0x0000000000000028(40)                          
s2(x18)             0x00000000800003ae(2147484590)                  0x00000000800003ae(2147484590)                  
...
s6(x22)             0x000000008028014c(2150105420)                  0x000000008028014c(2150105420)                  
s7(x23)             0x00000000801806cd(2149058253)                  0x00000000801806cd(2149058253)                  
s8(x24)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s9(x25)             0x0051b023340191f3(22993138356425203)           0x0051b023340191f3(22993138356425203)           
s10(x26)            0x000000007ffff86e(2147481710)                  0x000000007ffff86e(2147481710)                  
s11(x27)            0x7ff8000000000000(9221120237041090560)         0x7ff8000000000000(9221120237041090560)         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6121912f45dd0cc786119ec57788659cf1b14569        6121912f45dd0cc786119ec57788659cf1b14569        
...
fcsr                0x0000000000000031(49)                          0x0000000000000031(49)                          
 fcsr.nx            True                                            True                                            
 fcsr.uf            False                                           False                                           
 fcsr.of            False                                           False                                           
 fcsr.dz            False                                           False                                           
...
f1                  0xffffffffffff7e00(nan_h)                       0xffffffffffff7e00(nan_h)                       
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)                       
f3                  0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)                       
f4                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)                       
f5                  0xc095200000000000(-1352.0_d)                   0xc095200000000000(-1352.0_d)                   
f6                  0xfffffffffffffe00(nan_h)                       0xfffffffffffffe00(nan_h)                       
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)                       
f8                  0x7fffffff7fc00000(nan_d)                       0x7fffffff7fc00000(nan_d)                       
...
f15                 0x7fffffff7fc00000(nan_d)                       0x7fffffff7fc00000(nan_d)                       
...
f28                 0xffffffff41000000(8.0_s)                       0xffffffff41000000(8.0_s)                       
