# FailID_000256 ARA pos RV64 fdiv.s
...
_reg_f19:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f6'}})
    fdiv.s f6, f19, f31, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f6, f19, f31, dyn
+========================================================================================================================+
...
fcsr                0x0000000000000000(0)                           0x0000000000000010(16)                          X
 fcsr.nv            False                                           True                                            X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f19, f31
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f19                 0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            53ee66c2fdfc6f7852b9bc66c511619a9b06a108        53ee66c2fdfc6f7852b9bc66c511619a9b06a108        
