# FailID_004257 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x9, 0x8015fc91            // s1
    li x10, 0x48                 // a0
    li x11, 0x7ffffcf0           // a1
    li x12, 0x8016bfbd           // a2
    li x13, 0x0                  // a3
    li x14, 0x0                  // a4
    li x15, 0x80180710           // a5
    li x16, 0x7ffffcf0           // a6
    li x17, 0x8017ffce           // a7
    li x18, 0x1                  // s2
    li x19, 0x8018029d           // s3
    ...
    li x27, 0x8022f3b8           // s11
    li x28, 0x80180334           // t3
    li x29, 0x80005d9f           // t4
    li x30, 0x7ffffd9f           // t5
    li x31, 0x8017fe9d           // t6
    // INSTRUCTION ({'dep': {'f20', 'x14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x14', 'x25'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b7b331b9a4fc8d5748df0ed8ee52c06a951eba69        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, xc3, x14
a4(x14)             0x000000008017ff3d(2149056317)                  0x000000008017ff3d(2149056317)
...
ra(x1)              0x000000007ffffff4(2147483636)                  0x000000007ffffff4(2147483636)                  
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x0000000080186516(2149082390)                  0x0000000080186516(2149082390)                  
...
t2(x7)              0x0000000080180af9(2149059321)                  0x0000000080180af9(2149059321)                  
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0x000000008015fc91(2148924561)                  0x000000008015fc91(2148924561)                  
a0(x10)             0x0000000000000048(72)                          0x0000000000000048(72)                          
a1(x11)             0x000000007ffffcf0(2147482864)                  0x000000007ffffcf0(2147482864)                  
...
a6(x16)             0x000000007ffffcf0(2147482864)                  0x000000007ffffcf0(2147482864)                  
a7(x17)             0x000000008017ffce(2149056462)                  0x000000008017ffce(2149056462)                  
s2(x18)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s3(x19)             0x000000008018029d(2149057181)                  0x000000008018029d(2149057181)                  
...
s9(x25)             0x000000008017ff3d(2149056317)                  0x000000008017ff3d(2149056317)                  
s10(x26)            0x00000000801b7121(2149282081)                  0x00000000801b7121(2149282081)                  
s11(x27)            0x000000008022f3b8(2149774264)                  0x000000008022f3b8(2149774264)                  
t3(x28)             0x0000000080180334(2149057332)                  0x0000000080180334(2149057332)                  
t4(x29)             0x0000000080005d9f(2147507615)                  0x0000000080005d9f(2147507615)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ff869ac72678a31f3d21fa3d2df5087545688e9        0ff869ac72678a31f3d21fa3d2df5087545688e9        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b7b331b9a4fc8d5748df0ed8ee52c06a951eba69        X
