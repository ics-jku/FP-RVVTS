# FailID_001031 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x26, 0x0                  // s10
    li x27, 0xffffffff7ffffe90   // s11
    li x28, 0x1                  // t3
    li x29, 0x8000058a           // t4
    li x30, 0xfffffffffff        // t5
    li x31, 0x7ffffbd5           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x21'}, 'clob': {'f20', 'x21', 'x29'}})
...
f20                 0xffffffff00006000(3.4438311059246704e-41_s)    0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
sp(x2)              0x0000000080180764(2149058404)                  0x0000000080180764(2149058404)                  
gp(x3)              0x0000000000000000(0)                           0x0000000000000000(0)                           
tp(x4)              0x7ff8000000000000(9221120237041090560)         0x7ff8000000000000(9221120237041090560)         
...
s1(x9)              0x000000007ffffd00(2147482880)                  0x000000007ffffd00(2147482880)                  
...
a4(x14)             0x000000008020013b(2149581115)                  0x000000008020013b(2149581115)                  
...
s11(x27)            0xffffffff7ffffe90(18446744071562067600)        0xffffffff7ffffe90(18446744071562067600)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4be7d25946ebaf9195c044ea49d32d27300d9b5c        4be7d25946ebaf9195c044ea49d32d27300d9b5c        
