# FailID_005399 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x01,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f10:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_reg_f23:.byte 0x00,0x00,0x00,0x3c,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f5'}, 'clob': {'f10'}})
    fmin.d f10, f23, f5
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x41e000003c000000(2147484128.0_d)              0xffffffff00000001(1.401298464324817e-45_s)     X
STATES DIFFER: True
```
...
f10                 0x41e000003c000000(2147484128.0_d)              0xffffffff00000001(1.401298464324817e-45_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f23, f5
f5                  0xffffffff00000001(1.401298464324817e-45_s)     0xffffffff00000001(1.401298464324817e-45_s)
f10                 0x41e000003c000000(2147484128.0_d)              0xffffffff00000001(1.401298464324817e-45_s)     X
f23                 0x41e000003c000000(2147484128.0_d)              0x41e000003c000000(2147484128.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bf700cb4ff8c77af9e5b4201d72ca4cb20588875        bf700cb4ff8c77af9e5b4201d72ca4cb20588875        
