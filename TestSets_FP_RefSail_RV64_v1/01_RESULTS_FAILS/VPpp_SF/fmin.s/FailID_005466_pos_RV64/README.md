# FailID_005466 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f12'}, 'clob': {'f2'}})
    fmin.s f2, f0, f12
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8c52dbba7431a058d164beec0b4f94acfa914dd8        8c52dbba7431a058d164beec0b4f94acfa914dd8        
