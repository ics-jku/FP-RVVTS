# FailID_000373 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x19,0x43,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f3'}})
    fsqrt.s f3, f7
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            81cd9b0b89dba30a060ce85c87e1fd2b7416bd6c        81cd9b0b89dba30a060ce85c87e1fd2b7416bd6c        
