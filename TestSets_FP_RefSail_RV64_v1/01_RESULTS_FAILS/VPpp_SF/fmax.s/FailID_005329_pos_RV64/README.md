# FailID_005329 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f12'}, 'clob': {'f18'}})
    fmax.s f18, f12, f23
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff80180a66(-2.2077821643038217e-39_s)   0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f18, f12, f23
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bd4e3c83833ffe42f5aedc1397eb7c38491c362d        bd4e3c83833ffe42f5aedc1397eb7c38491c362d        
