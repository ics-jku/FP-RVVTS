# FailID_002182 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x15, 0x86                 // a5
    li x16, 0x0                  // a6
    li x17, 0x436d96ec           // a7
    li x18, 0x7ffffc8e           // s2
    li x19, 0x0                  // s3
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27', 'f15'}, 'clob': {'x27', 'x14'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, xd6, x27
s11(x27)            0x00000000801ffb96(2149579670)                  0x00000000801ffb96(2149579670)
...
ra(x1)              0xffffffffffffb823(18446744073709533219)        0xffffffffffffb823(18446744073709533219)        
...
t2(x7)              0x00000000800006ef(2147485423)                  0x00000000800006ef(2147485423)                  
...
a7(x17)             0x00000000436d96ec(1131255532)                  0x00000000436d96ec(1131255532)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fbe91142165016af7aea42b5ee2b405e6ea6ead4        fbe91142165016af7aea42b5ee2b405e6ea6ead4        
