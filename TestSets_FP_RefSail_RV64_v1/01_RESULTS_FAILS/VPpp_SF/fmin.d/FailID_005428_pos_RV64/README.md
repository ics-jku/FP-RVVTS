# FailID_005428 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f31'}, 'clob': {'f22'}})
    fmin.d f22, f31, f4
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            15fef040563e0c5e182cc5c1090fb69d5870ab18        15fef040563e0c5e182cc5c1090fb69d5870ab18        
