# FailID_000054 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f11'}, 'clob': {'f3'}})
    fsqrt.h f3, f11, rtz
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f3, f11, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            170ffefcd875b0650b07541fae7f1a5b3f97a4ed        170ffefcd875b0650b07541fae7f1a5b3f97a4ed        
