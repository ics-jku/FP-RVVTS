# FailID_004146 VP++ SF neg RV64 fmin.d
...
_reg_f20:.byte 0x48,0x06,0x50,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f4'}, 'clob': {'f20'}})
    fmin.d f20, f14, f4
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x0000000000000000(0.0_d)                       0x7fffffff7fc00000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c2240cabff0f5ba7859ef44ab4c3884ca3909d16        c2240cabff0f5ba7859ef44ab4c3884ca3909d16        
