# FailID_005216 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f13'}})
    fmax.d f13, f19, f14
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f13, f19, f14
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ba949f1caec8b725475f73323cfa3413df283130        ba949f1caec8b725475f73323cfa3413df283130        
