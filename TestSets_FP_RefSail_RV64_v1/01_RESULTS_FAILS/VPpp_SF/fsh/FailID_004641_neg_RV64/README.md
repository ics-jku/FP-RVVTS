# FailID_004641 VP++ SF neg RV64 fsh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'x22'}, 'clob': {'x22', 'x26'}})
...
s6(x22)             0x000000008018032a(2149057322)                  0x000000008018032a(2149057322)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            34ea369a027ad195c25dd2e932c983c2000def3f        34ea369a027ad195c25dd2e932c983c2000def3f        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fdc17bf5c2acab39e11bc049974ca936fa330e3f        X
