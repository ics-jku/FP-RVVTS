# FailID_000864 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    // restore registers
    li x1, 0x80180626            // ra
    li x2, 0xffffffff4effffff    // sp
    li x3, 0x0                   // gp
    li x4, 0x0                   // tp
    li x5, 0x80186214            // t0
    li x6, 0x41e00300032000f5    // t1
    ...
    li x16, 0x1b                 // a6
    li x17, 0x80180214           // a7
    li x18, 0x8000018d           // s2
    li x19, 0x80180019           // s3
    li x20, 0x42                 // s4
    li x21, 0x0                  // s5
    li x22, 0xe003000320000000   // s6
    li x23, 0x6000               // s7
    li x24, 0x6000               // s8
    li x25, 0x20                 // s9
    ...
    li x30, 0x80180458           // t5
    li x31, 0x4da8c774           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x23'}, 'clob': {'f27', 'x3', 'x23'}})
...
f27                 0x41e0030003200000(2149056537.0_d)              0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
sp(x2)              0xffffffff4effffff(18446744070739984383)        0xffffffff4effffff(18446744070739984383)        
gp(x3)              0x000000007ffffd62(2147482978)                  0x000000007ffffd62(2147482978)                  
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x0000000080186214(2149081620)                  0x0000000080186214(2149081620)                  
t1(x6)              0x41e00300032000f5(4746797305835815157)         0x41e00300032000f5(4746797305835815157)         
t2(x7)              0x41e0030003200000(4746797305835814912)         0x41e0030003200000(4746797305835814912)         
fp(x8)              0x000000008020096d(2149583213)                  0x000000008020096d(2149583213)                  
...
a6(x16)             0x000000000000001b(27)                          0x000000000000001b(27)                          
a7(x17)             0x0000000080180214(2149057044)                  0x0000000080180214(2149057044)                  
...
s6(x22)             0xe003000320000000(16141745502847762432)        0xe003000320000000(16141745502847762432)        
s7(x23)             0x0000000080005d62(2147507554)                  0x0000000080005d62(2147507554)                  
...
t3(x28)             0x00000000000000f3(243)                         0x00000000000000f3(243)                         
t4(x29)             0x000000008020050c(2149582092)                  0x000000008020050c(2149582092)                  
t5(x30)             0x0000000080180458(2149057624)                  0x0000000080180458(2149057624)                  
t6(x31)             0x000000004da8c774(1302906740)                  0x000000004da8c774(1302906740)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            acebbf260c83e07a82470b19e87150ae602fe45e        acebbf260c83e07a82470b19e87150ae602fe45e        
