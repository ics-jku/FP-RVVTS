# FailID_005398 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f20'}})
    fmin.d f20, f3, f20
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x41dfffffffc00000(2147483647.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cae396fae829f6cabbbd48041339f88c5763eb57        cae396fae829f6cabbbd48041339f88c5763eb57        
