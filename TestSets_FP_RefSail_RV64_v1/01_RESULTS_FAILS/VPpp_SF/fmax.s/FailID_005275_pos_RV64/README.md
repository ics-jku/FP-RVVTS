# FailID_005275 VP++ SF pos RV64 fmax.s
...
_reg_f30:.byte 0x23,0xb8,0x41,0x04,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f30'}, 'clob': {'f12'}})
    fmax.s f12, f30, f27
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f12, f30, f27
+========================================================================================================================+
...
f12                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f30, f27
f12                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f30                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff0441b823(2.2771592405506703e-36_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            085cc3e2e25210faf45a90238ae16ce538736a6f        085cc3e2e25210faf45a90238ae16ce538736a6f        
