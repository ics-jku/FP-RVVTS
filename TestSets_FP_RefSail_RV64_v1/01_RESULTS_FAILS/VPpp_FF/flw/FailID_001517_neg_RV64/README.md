# FailID_001517 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x15, 0x4e                 // a5
    li x16, 0x6000               // a6
    li x17, 0x800004de           // a7
    li x18, 0x0                  // s2
    li x19, 0xffffffffffffffff   // s3
    li x20, 0x6000               // s4
    li x21, 0x800004de           // s5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'f20', 'x13', 'x26'}})
...
tp(x4)              0x00000000000003d1(977)                         0x00000000000003d1(977)                         
...
a5(x15)             0x000000000000004e(78)                          0x000000000000004e(78)                          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c9d96313756fc3a32f57eab85bf411edbd64869e        c9d96313756fc3a32f57eab85bf411edbd64869e        
