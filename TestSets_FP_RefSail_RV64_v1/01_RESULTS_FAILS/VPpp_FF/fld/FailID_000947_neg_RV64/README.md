# FailID_000947 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x161                // s11
    li x28, 0x1                  // t3
    li x29, 0x8017fc26           // t4
    li x30, 0x1                  // t5
    li x31, 0x802806a3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'f12', 'x25', 'x29'}})
...
f12                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
t0(x5)              0x00000000247b470c(612058892)                   0x00000000247b470c(612058892)                   
t1(x6)              0x0000000080180175(2149056885)                  0x0000000080180175(2149056885)                  
...
t4(x29)             0x000000007ffffb6c(2147482476)                  0x000000007ffffb6c(2147482476)                  
t5(x30)             0x0000000000000001(1)                           0x0000000000000001(1)                           
t6(x31)             0x00000000802806a3(2150106787)                  0x00000000802806a3(2150106787)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            6d0b642cca111c646f67390a385af0fbda930030        6d0b642cca111c646f67390a385af0fbda930030        
