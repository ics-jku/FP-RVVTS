# FailID_004548 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x27, 0x8000099c           // s11
    li x28, 0x584                // t3
    li x29, 0x7ffffd1f           // t4
    li x30, 0x200                // t5
    li x31, 0x7ffffa37           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm', 'f19'}, 'clob': {'x27', 'x24'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bb078872d737f5db1722762a172b721845ac0566        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x3, b9, x27
gp(x3)              0xffffffffffffffdb(18446744073709551579)        0xffffffffffffffdb(18446744073709551579)
s11(x27)            0x0000000080180d51(2149059921)                  0x0000000080180d51(2149059921)
...
a3(x13)             0x000000008017fb7e(2149055358)                  0x000000008017fb7e(2149055358)                  
...
s3(x19)             0x0000000000185d03(1596675)                     0x0000000000185d03(1596675)                     
...
STATE               REF                                             DUT                                             DIFF
xmemhash            28146164236ae8ceb4ee15ce34a9ae56976a289e        28146164236ae8ceb4ee15ce34a9ae56976a289e        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bb078872d737f5db1722762a172b721845ac0566        X
