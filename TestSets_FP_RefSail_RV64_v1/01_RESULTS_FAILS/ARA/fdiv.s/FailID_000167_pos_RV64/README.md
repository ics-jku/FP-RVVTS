# FailID_000167 ARA pos RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f9'}})
    fdiv.s f9, f5, f21, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f9, f5, f21, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f21b9dfa79f6365f6c2bf6f553c0bc9925a5ecc4        f21b9dfa79f6365f6c2bf6f553c0bc9925a5ecc4        
