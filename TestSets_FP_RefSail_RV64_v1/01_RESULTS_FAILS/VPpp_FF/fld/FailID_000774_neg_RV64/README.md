# FailID_000774 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x29, 0x7ffffeea           // t4
    li x30, 0x80000808           // t5
    li x31, 0x800002a8           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'x2', 'f9', 'x4'}})
...
f9                  0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
sp(x2)              0x000000007ffffa34(2147482164)                  0x000000007ffffa34(2147482164)                  
...
t4(x29)             0x000000007ffffeea(2147483370)                  0x000000007ffffeea(2147483370)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4f916e05b59c857640eaf5295f589b35fbe35358        4f916e05b59c857640eaf5295f589b35fbe35358        
