# FailID_005532 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f12'}, 'clob': {'f17'}})
    fmin.s f17, f12, f0
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            418392ad8cd2345e676a18b634979465ae21e0cb        418392ad8cd2345e676a18b634979465ae21e0cb        
