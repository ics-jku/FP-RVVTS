# FailID_002375 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x6000                // fp
    li x9, 0x1                   // s1
    li x10, 0x8017fc97           // a0
    li x11, 0x80000c88           // a1
    li x12, 0x801805a2           // a2
    li x13, 0x8000073a           // a3
    li x14, 0x8017fb02           // a4
    li x15, 0xfffffffffffffbf2   // a5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f1', 'x14'}, 'clob': {'x12', 'x14'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        806047572b558bb76862346b2f127b4bc7cceab8        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, x17, x14
a4(x14)             0x00000000801ff982(2149579138)                  0x00000000801ff982(2149579138)
...
t0(x5)              0x0000000080200422(2149581858)                  0x0000000080200422(2149581858)                  
...
a2(x12)             0x000000008017fe82(2149056130)                  0x000000008017fe82(2149056130)                  
a3(x13)             0x000000008000073a(2147485498)                  0x000000008000073a(2147485498)                  
a4(x14)             0x00000000801ff982(2149579138)                  0x00000000801ff982(2149579138)                  
a5(x15)             0xfffffffffffffbf2(18446744073709550578)        0xfffffffffffffbf2(18446744073709550578)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7ff82a5c44c7b4342172c591e0b40c559db86786        7ff82a5c44c7b4342172c591e0b40c559db86786        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        806047572b558bb76862346b2f127b4bc7cceab8        X
