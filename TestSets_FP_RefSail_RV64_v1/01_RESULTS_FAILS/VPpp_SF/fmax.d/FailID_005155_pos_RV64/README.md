# FailID_005155 VP++ SF pos RV64 fmax.d
...
_reg_f29:.byte 0x45,0xf5,0x7a,0xb8,0x57,0xd2,0xfe,0xf2
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f8'}, 'clob': {'f29'}})
    fmax.d f29, f8, f28
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9fb48b924930ca30d2ee7c6a118f07396a78a69d        9fb48b924930ca30d2ee7c6a118f07396a78a69d        
