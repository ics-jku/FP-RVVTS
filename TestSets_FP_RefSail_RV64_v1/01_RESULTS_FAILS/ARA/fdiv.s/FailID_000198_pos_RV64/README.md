# FailID_000198 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_reg_f24:.byte 0xe0,0x5e,0x68,0xcf,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'f28', 'mstatus.fs/vs.fs'}, 'clob': {'f6'}})
    fdiv.s f6, f24, f28
```
...
f6                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
f6                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f24, f28
f6                  0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f24                 0xffffffffcf685ee0(-3898531840.0_s)             0xffffffffcf685ee0(-3898531840.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e1bed889b074eef154696e3d5ff5dd742e117e3d        e1bed889b074eef154696e3d5ff5dd742e117e3d        
