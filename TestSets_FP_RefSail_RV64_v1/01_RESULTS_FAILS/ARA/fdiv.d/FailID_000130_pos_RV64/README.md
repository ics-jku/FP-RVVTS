# FailID_000130 ARA pos RV64 fdiv.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f16:.byte 0x00,0x00,0x00,0x66,0x00,0x00,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'f16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fdiv.d f26, f20, f16, rup
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x3e8fffff34000515(2.3841848850739813e-07_d)    0x3e8fffff34000514(2.384184885073981e-07_d)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.d f26, f20, f16, rup
+========================================================================================================================+
...
f26                 0x3e8fffff34000515(2.3841848850739813e-07_d)    0x3e8fffff34000514(2.384184885073981e-07_d)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f20, f16
f16                 0x41e0000066000000(2147484464.0_d)              0x41e0000066000000(2147484464.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e9d0a11f3491abf33917465536f24148f6547a8d        e9d0a11f3491abf33917465536f24148f6547a8d        
