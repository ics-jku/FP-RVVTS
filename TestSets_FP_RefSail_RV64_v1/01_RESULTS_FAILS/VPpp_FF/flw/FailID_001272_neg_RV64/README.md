# FailID_001272 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x27, 0x800001ae           // s11
    li x28, 0x801801c9           // t3
    li x29, 0x7fffffffbf         // t4
    li x30, 0xffffffff7fd7ff0c   // t5
    li x31, 0x800000d9           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27'}, 'clob': {'f3', 'x18', 'x27'}})
...
f3                  0xffffffff7fc00000(nan_s)                       0xffffffff21b1bc27(1.2043790043826945e-18_s)    X
STATES DIFFER: True
```
...
t0(x5)              0x000000007ffff8f1(2147481841)                  0x000000007ffff8f1(2147481841)                  
...
a1(x11)             0x0000000080000128(2147483944)                  0x0000000080000128(2147483944)                  
...
a4(x14)             0x0000000000000098(152)                         0x0000000000000098(152)                         
...
s3(x19)             0x00000000801807a2(2149058466)                  0x00000000801807a2(2149058466)                  
...
t4(x29)             0x0000007fffffffbf(549755813823)                0x0000007fffffffbf(549755813823)                
...
STATE               REF                                             DUT                                             DIFF
xmemhash            66a3eeb034f4d78da59afbd06c4efc83d7c8d71e        66a3eeb034f4d78da59afbd06c4efc83d7c8d71e        
