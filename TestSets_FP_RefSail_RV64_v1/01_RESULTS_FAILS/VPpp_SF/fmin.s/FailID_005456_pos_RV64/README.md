# FailID_005456 VP++ SF pos RV64 fmin.s
...
_reg_f13:.byte 0x07,0x20,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f30'}, 'clob': {'f11'}})
    fmin.s f11, f13, f30
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff4f002007(2149582592.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f13, f30
+========================================================================================================================+
...
f11                 0xffffffff4f002007(2149582592.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f13, f30
f11                 0xffffffff4f002007(2149582592.0_s)              0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffff4f002007(2149582592.0_s)              0xffffffff4f002007(2149582592.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            44b729e9b4990744a4d00d4e1f884bb7f680652c        44b729e9b4990744a4d00d4e1f884bb7f680652c        
