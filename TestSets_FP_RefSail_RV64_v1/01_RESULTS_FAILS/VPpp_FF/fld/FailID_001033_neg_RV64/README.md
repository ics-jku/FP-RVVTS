# FailID_001033 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x23, 0x80180702           // s7
    li x24, 0x7ffff99c           // s8
    li x25, 0x801c24ea           // s9
    li x26, 0x3ffffcce00000      // s10
    li x27, 0x24                 // s11
    li x28, 0x0                  // t3
    li x29, 0x30bce72c           // t4
    li x30, 0xfffffffffff        // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x1'}, 'clob': {'f14', 'x22', 'x1'}})
...
f14                 0xffffffff00000200(7.174648137343064e-43_s)     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
s7(x23)             0x0000000080180702(2149058306)                  0x0000000080180702(2149058306)                  
...
s10(x26)            0x0003ffffcce00000(1125899049107456)            0x0003ffffcce00000(1125899049107456)            
...
STATE               REF                                             DUT                                             DIFF
xmemhash            96cea9c2736239245528a5a3b5e945fd7c36726b        96cea9c2736239245528a5a3b5e945fd7c36726b        
