# FailID_003008 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f1, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f1, dyn
+========================================================================================================================+
...
Registers: x2, f1
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f1                  0x7fffffff7fc00000(nan_d)                       0x7fffffff7fc00000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f7769af1ac33592bb7fc6714cee4574f55ef1de0        f7769af1ac33592bb7fc6714cee4574f55ef1de0        
