# FailID_005542 VP++ SF pos RV64 fmin.s
...
_reg_f15:.byte 0xc0,0x18,0xe3,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f11'}})
    fmin.s f11, f15, f27
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f11, f15, f27
+========================================================================================================================+
...
f11                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f15, f27
f11                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff7fc00000(nan_s)                       X
f15                 0xffffffff4ee318c0(1905025024.0_s)              0xffffffff4ee318c0(1905025024.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3db20a88f995f68d1b193a2a79a8a98f7bb1318f        3db20a88f995f68d1b193a2a79a8a98f7bb1318f        
