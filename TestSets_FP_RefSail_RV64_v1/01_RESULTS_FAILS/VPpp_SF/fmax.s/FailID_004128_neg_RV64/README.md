# FailID_004128 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f31', 'f12'}, 'clob': {'f7'}})
    fmax.s f7, f31, f12
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            edb4239424c511be15ef26ca7cf8834a3abea396        edb4239424c511be15ef26ca7cf8834a3abea396        
