# FailID_000452 ARA pos RV64 fsqrt.s
...
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xe0,0xc3
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f4'}})
    fsqrt.s f4, f2, rne
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a539a662b73e6fce9b16c0fe09403090e9af0264        a539a662b73e6fce9b16c0fe09403090e9af0264        
