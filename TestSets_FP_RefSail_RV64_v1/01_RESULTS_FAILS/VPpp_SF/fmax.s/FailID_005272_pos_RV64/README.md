# FailID_005272 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x00,0x00,0x80,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f0'}})
    fmax.s f0, f20, f24
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f0                  0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, f20, f24
f0                  0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
f20                 0xffffffff4f800000(4294967296.0_s)              0xffffffff4f800000(4294967296.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            91ef7d67d2b192b7497051a6a62c8e843f9b8f07        91ef7d67d2b192b7497051a6a62c8e843f9b8f07        
