# FailID_001599 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x40                 // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'f24', 'x23', 'x28'}})
...
f24                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
s8(x24)             0x400c03bd80000000(4615067830579101696)         0x400c03bd80000000(4615067830579101696)         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bef29a39d02783820bd625565350a7ccf0163a7a        bef29a39d02783820bd625565350a7ccf0163a7a        
