# FailID_003773 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x18'}, 'clob': {'x19', 'f0', 'x18'}})
...
f0                  0xffffffff4f001802(2149057024.0_s)              0xffffffff0451bc23(2.4654220076745522e-36_s)    X
STATES DIFFER: True
```
...
a5(x15)             0x00000000801c41ff(2149335551)                  0x00000000801c41ff(2149335551)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6f76d9f045d7ca107aebeebb870de53aeea34d43        6f76d9f045d7ca107aebeebb870de53aeea34d43        
