# FailID_001144 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x9, 0x4                   // s1
    li x10, 0x1                  // a0
    li x11, 0x7ffff816           // a1
    li x12, 0x80200281           // a2
    li x13, 0x1                  // a3
    li x14, 0x33                 // a4
    li x15, 0x0                  // a5
    li x16, 0x0                  // a6
    li x17, 0x50a7c6f4           // a7
    li x18, 0xfffffffffffff8c7   // s2
    li x19, 0x1                  // s3
    li x20, 0xfffffffffffff848   // s4
    li x21, 0x0                  // s5
    li x22, 0x708fb000           // s6
    li x23, 0x0                  // s7
    li x24, 0x2f                 // s8
    li x25, 0x0                  // s9
    li x26, 0x801859b3           // s10
    li x27, 0x8000074f           // s11
    li x28, 0x0                  // t3
    li x29, 0x739fd700           // t4
    li x30, 0x8000054a           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'f29', 'x3', 'x28'}})
...
f29                 0x44158226eced72c7(9.919001733163082e+19_d)     0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
ra(x1)              0x00000000801807e3(2149058531)                  0x00000000801807e3(2149058531)                  
sp(x2)              0x00000000801ff406(2149577734)                  0x00000000801ff406(2149577734)                  
gp(x3)              0x000000007fffffe5(2147483621)                  0x000000007fffffe5(2147483621)                  
...
s4(x20)             0xfffffffffffff848(18446744073709549640)        0xfffffffffffff848(18446744073709549640)        
...
s8(x24)             0x000000000000002f(47)                          0x000000000000002f(47)                          
s9(x25)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s10(x26)            0x00000000801859b3(2149079475)                  0x00000000801859b3(2149079475)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a767714e96390ccf17f5fe4c5e1ad60d35252891        a767714e96390ccf17f5fe4c5e1ad60d35252891        
