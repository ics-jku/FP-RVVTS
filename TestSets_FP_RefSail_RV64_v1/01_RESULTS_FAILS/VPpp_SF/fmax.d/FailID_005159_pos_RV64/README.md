# FailID_005159 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x4a,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'f11', 'fcsr.rm'}, 'clob': {'f22'}})
    fmax.d f22, f11, f26
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x404a000000000000(52.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f22, f11, f26
+========================================================================================================================+
...
f22                 0x404a000000000000(52.0_d)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f11, f26
f11                 0x404a000000000000(52.0_d)                      0x404a000000000000(52.0_d)
f22                 0x404a000000000000(52.0_d)                      0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c788c3bc48dc107fae9864e3b56b6f81207ac74f        c788c3bc48dc107fae9864e3b56b6f81207ac74f        
