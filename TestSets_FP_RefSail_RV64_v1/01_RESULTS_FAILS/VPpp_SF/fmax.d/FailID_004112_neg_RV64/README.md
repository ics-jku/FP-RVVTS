# FailID_004112 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f22', 'f25'}, 'clob': {'f8'}})
    fmax.d f8, f25, f22
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x1b20e0fd2cc77545(5.206618571249988e-178_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            294afac997b341ed9414b7d67f16a075c2f2f3b7        294afac997b341ed9414b7d67f16a075c2f2f3b7        
