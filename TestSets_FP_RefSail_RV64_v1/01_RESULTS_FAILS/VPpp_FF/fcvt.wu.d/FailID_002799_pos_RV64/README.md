# FailID_002799 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0xff,0xff,0x7f,0x5f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x7'}})
    fcvt.wu.d x7, f25, rdn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t2(x7)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x7, f25, rdn
+========================================================================================================================+
...
Registers: x7, f25
t2(x7)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f25                 0xffffffff5f7fffff(1.8446742974197924e+19_s)    0xffffffff5f7fffff(1.8446742974197924e+19_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            21e515dacfd0e9ea4962d518b9cbbf974fe422b8        21e515dacfd0e9ea4962d518b9cbbf974fe422b8        
