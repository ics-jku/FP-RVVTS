# FailID_004026 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x14, 0x40                 // a4
    li x15, 0x6000               // a5
    li x16, 0x8027fd90           // a6
    li x17, 0x7fc00000           // a7
    li x18, 0x8027f86f           // s2
    li x19, 0x6000               // s3
    li x20, 0x8017fe39           // s4
    li x21, 0x0                  // s5
    li x22, 0x0                  // s6
    li x23, 0x8018010a           // s7
    li x24, 0x200                // s8
    li x25, 0x0                  // s9
    li x26, 0x0                  // s10
    li x27, 0x0                  // s11
    ...
    li x30, 0x6000               // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'f10', 'x19', 'x23'}})
...
f10                 0x2813836133322c49(1.238084287307389e-115_d)    0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
t1(x6)              0x000000009d3f1d9f(2638159263)                  0x000000009d3f1d9f(2638159263)                  
...
a5(x15)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
a6(x16)             0x000000008027fd90(2150104464)                  0x000000008027fd90(2150104464)                  
a7(x17)             0x000000007fc00000(2143289344)                  0x000000007fc00000(2143289344)                  
s2(x18)             0x000000008027f86f(2150103151)                  0x000000008027f86f(2150103151)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9163ac227d15b79debab2d381d7093d3e4d48362        9163ac227d15b79debab2d381d7093d3e4d48362        
