# FailID_002840 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x80,0x42,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f7', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x5'}})
    fcvt.wu.d x5, f7, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x5, f7, rmm
+========================================================================================================================+
...
Registers: x5, f7
t0(x5)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f7                  0xffffffff42800000(64.0_s)                      0xffffffff42800000(64.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3d9dcc404ff333609fdac6b898937461cfe8a9e7        3d9dcc404ff333609fdac6b898937461cfe8a9e7        
