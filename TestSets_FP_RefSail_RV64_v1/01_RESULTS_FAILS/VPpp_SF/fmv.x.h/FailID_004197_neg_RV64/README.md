# FailID_004197 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29'}, 'clob': {'x3'}})
    fmv.x.h x3, f29
```
...
```
REG                 REF                                             DUT                                             DIFF
gp(x3)              0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bd9da17c5f7e9298f4504389eb5d3dea82f9c321        bd9da17c5f7e9298f4504389eb5d3dea82f9c321        
