# FailID_005273 VP++ SF pos RV64 fmax.s
...
_reg_f3: .byte 0x00,0x00,0x80,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f16', 'fcsr.rm'}, 'clob': {'f2'}})
    fmax.s f2, f3, f16
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f2, f3, f16
f2                  0xffffffff4f800000(4294967296.0_s)              0xffffffff7fc00000(nan_s)                       X
f3                  0xffffffff4f800000(4294967296.0_s)              0xffffffff4f800000(4294967296.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6e4d99aa33ffa132d27c0ee2d3a38779b85a6798        6e4d99aa33ffa132d27c0ee2d3a38779b85a6798        
