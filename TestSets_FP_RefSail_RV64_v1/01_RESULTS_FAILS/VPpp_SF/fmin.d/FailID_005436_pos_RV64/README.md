# FailID_005436 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f12'}, 'clob': {'f2'}})
    fmin.d f2, f12, f23
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x3ff0000000000000(1.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6ba4c4398aca3787f4f923044faec98f342b1a31        6ba4c4398aca3787f4f923044faec98f342b1a31        
