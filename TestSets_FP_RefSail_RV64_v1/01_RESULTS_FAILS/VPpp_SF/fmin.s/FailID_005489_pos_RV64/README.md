# FailID_005489 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f31'}, 'clob': {'f7'}})
    fmin.s f7, f31, f19
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d82994dd8ac20fda31c2a66b69e67a81f3ec910f        d82994dd8ac20fda31c2a66b69e67a81f3ec910f        
