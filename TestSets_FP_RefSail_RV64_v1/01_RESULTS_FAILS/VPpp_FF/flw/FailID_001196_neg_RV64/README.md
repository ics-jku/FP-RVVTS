# FailID_001196 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x27, 0x7ffff8da           // s11
    li x28, 0x77028293           // t3
    li x29, 0x7ffffe4a           // t4
    li x30, 0x801ff3d8           // t5
    li x31, 0x802160ba           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'f11', 'x16', 'x25'}})
...
t2(x7)              0x000000008018057f(2149057919)                  0x000000008018057f(2149057919)                  
...
a6(x16)             0x000000007fffff14(2147483412)                  0x000000007fffff14(2147483412)                  
...
t3(x28)             0x0000000077028293(1996653203)                  0x0000000077028293(1996653203)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            edd11b3e86de530ca6a2d26b6455a381ecb13447        edd11b3e86de530ca6a2d26b6455a381ecb13447        
