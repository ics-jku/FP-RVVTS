# FailID_003140 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x00,0xf0,0xff,0xff,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x19'}})
    fcvt.wu.s x19, f0, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x19, f0, rdn
+========================================================================================================================+
...
Registers: x19, f0
s3(x19)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f0                  0x40fffff000000000(131071.0_d)                  0x40fffff000000000(131071.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0c6cad2df52685ee44ce2a7c83354f3a0c115a83        0c6cad2df52685ee44ce2a7c83354f3a0c115a83        
