# FailID_005504 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f29'}})
    fmin.s f29, f7, f21
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2eb58c8db2ad32997dea988107cab5904914bb47        2eb58c8db2ad32997dea988107cab5904914bb47        
