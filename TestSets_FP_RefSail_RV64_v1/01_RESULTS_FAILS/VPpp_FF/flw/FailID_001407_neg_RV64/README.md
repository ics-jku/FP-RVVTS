# FailID_001407 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'f14', 'x13', 'x21'}})
...
f14                 0xc1dffa0130c00000(-2145912003.0_d)             0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7a8bb369d182b107c0af689b96e3d4df5a60d773        7a8bb369d182b107c0af689b96e3d4df5a60d773        
