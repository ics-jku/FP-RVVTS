# FailID_001309 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x18, 0x7ffffc24           // s2
    li x19, 0xffffffffffffffff   // s3
    li x20, 0xffffffffffbffb99   // s4
    li x21, 0x80218ed4           // s5
    li x22, 0x8017faef           // s6
    li x23, 0x8000624c           // s7
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'x13', 'f26', 'x3'}})
...
f26                 0x7ff8000000000000(nan_d)                       0xffffffff0061b423(8.972664006007486e-39_s)     X
STATES DIFFER: True
```
...
f26                 0x7ff8000000000000(nan_d)                       0xffffffff0061b423(8.972664006007486e-39_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, x5, c7, x13
t0(x5)              0x00000000801fec22(2149575714)                  0x00000000801fec22(2149575714)
a3(x13)             0x000000007ffffc09(2147482633)                  0x000000007ffffc09(2147482633)
f26                 0x7ff8000000000000(nan_d)                       0xffffffff0061b423(8.972664006007486e-39_s)     X
+========================================================================================================================+
```
...
sp(x2)              0x000000008017f894(2149054612)                  0x000000008017f894(2149054612)                  
gp(x3)              0x000000007ffffa39(2147482169)                  0x000000007ffffa39(2147482169)                  
...
s1(x9)              0x000000008017fb6a(2149055338)                  0x000000008017fb6a(2149055338)                  
...
s4(x20)             0xffffffffffbffb99(18446744073705356185)        0xffffffffffbffb99(18446744073705356185)        
...
s7(x23)             0x000000008000624c(2147508812)                  0x000000008000624c(2147508812)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            87718afc35cbb71baaa44f0179a378f161397526        87718afc35cbb71baaa44f0179a378f161397526        
