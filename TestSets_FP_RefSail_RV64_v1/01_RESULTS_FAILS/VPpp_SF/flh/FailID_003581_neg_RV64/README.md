# FailID_003581 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x15, 0x0                  // a5
    li x16, 0x8018690f           // a6
    li x17, 0xffffffff8530e000   // a7
    li x18, 0x8027fff8           // s2
    li x19, 0x800004f6           // s3
    li x20, 0x80180230           // s4
    li x21, 0xa9                 // s5
    li x22, 0x801800b2           // s6
    li x23, 0x4                  // s7
    li x24, 0x800064f6           // s8
    li x25, 0x8026fdae           // s9
    li x26, 0x801801d0           // s10
    li x27, 0x7fffffb1           // s11
    li x28, 0x801ff3a1           // t3
    li x29, 0x80180419           // t4
    li x30, 0x801ff55b           // t5
    li x31, 0x8017f87d           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x24', 'x30', 'f19'}})
...
f19                 0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f19                 0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x4, x24
tp(x4)              0x0000000000000001(1)                           0x0000000000000001(1)
s8(x24)             0x0000000080006018(2147508248)                  0x0000000080006018(2147508248)
f19                 0xffffffffffff006f(6.616115570068359e-06_h)     0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
a6(x16)             0x000000008018690f(2149083407)                  0x000000008018690f(2149083407)                  
a7(x17)             0xffffffff8530e000(18446744071649157120)        0xffffffff8530e000(18446744071649157120)        
...
t3(x28)             0x00000000801ff3a1(2149577633)                  0x00000000801ff3a1(2149577633)                  
t4(x29)             0x0000000080180419(2149057561)                  0x0000000080180419(2149057561)                  
t5(x30)             0x000000007ffffb22(2147482402)                  0x000000007ffffb22(2147482402)                  
t6(x31)             0x000000008017f87d(2149054589)                  0x000000008017f87d(2149054589)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            f25875a665f3a3fb215646f88a111e07d0e9ad25        f25875a665f3a3fb215646f88a111e07d0e9ad25        
