# FailID_005380 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f29'}, 'clob': {'f28'}})
    fmin.d f28, f29, f18
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xbff0000000000000(-1.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f28, f29, f18
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6f5740de9dda5e42477108ecf7f3deb7ddce89d2        6f5740de9dda5e42477108ecf7f3deb7ddce89d2        
