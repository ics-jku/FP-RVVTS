# FailID_005460 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'f4'}})
    fmin.s f4, f1, f21
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            543e4d9b7316f43973676c1782d567fffe4bafa5        543e4d9b7316f43973676c1782d567fffe4bafa5        
