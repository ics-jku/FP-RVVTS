# FailID_005340 VP++ SF pos RV64 fmin.d
...
_reg_f23:.byte 0xc7,0xfe,0x17,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f23', 'fcsr.rm'}, 'clob': {'f2'}})
    fmin.d f2, f23, f10
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x000000008017fec7(1.061774839e-314_d)          0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f2                  0x000000008017fec7(1.061774839e-314_d)          0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f23, f10
f2                  0x000000008017fec7(1.061774839e-314_d)          0x7ff8000000000000(nan_d)                       X
f10                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f23                 0x000000008017fec7(1.061774839e-314_d)          0x000000008017fec7(1.061774839e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f1187df15acb23b343ee5111fe1b13ceaace0d7c        f1187df15acb23b343ee5111fe1b13ceaace0d7c        
