# FailID_003555 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x19, 0x8018059f           // s3
    li x20, 0x0                  // s4
    li x21, 0x6000               // s5
    li x22, 0x6000               // s6
    li x23, 0x801804e6           // s7
    ...
    li x30, 0xcc4c277c           // t5
    li x31, 0x801803d2           // t6
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'x5', 'f15'}})
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffffffff9793(-0.0018491744995117188_h)    X
STATES DIFFER: True
```
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffffffff9793(-0.0018491744995117188_h)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, x3, b3, x5
gp(x3)              0x000000008017fb0d(2149055245)                  0x000000008017fb0d(2149055245)
t0(x5)              0x0000000080000a37(2147486263)                  0x0000000080000a37(2147486263)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffffffff9793(-0.0018491744995117188_h)    X
+========================================================================================================================+
```
...
a2(x12)             0x000000000000b424(46116)                       0x000000000000b424(46116)                       
a3(x13)             0x000000000000003c(60)                          0x000000000000003c(60)                          
...
s3(x19)             0x000000008018059f(2149057951)                  0x000000008018059f(2149057951)                  
...
s7(x23)             0x00000000801804e6(2149057766)                  0x00000000801804e6(2149057766)                  
...
t5(x30)             0x00000000cc4c277c(3427542908)                  0x00000000cc4c277c(3427542908)                  
t6(x31)             0x00000000801803d2(2149057490)                  0x00000000801803d2(2149057490)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            00ebd3abbb13746cda69e300b0e34ac94ac0dfc6        00ebd3abbb13746cda69e300b0e34ac94ac0dfc6        
