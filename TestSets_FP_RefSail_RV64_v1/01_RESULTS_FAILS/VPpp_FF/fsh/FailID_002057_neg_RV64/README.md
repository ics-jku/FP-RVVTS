# FailID_002057 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x16', 'f30', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'x18'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3f94046da990c7536da85b4297ef982751f61bc7        3f94046da990c7536da85b4297ef982751f61bc7        
