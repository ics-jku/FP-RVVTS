# FailID_002626 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x00,0x0c,0xc2,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x13'}})
    fcvt.wu.d x13, f9, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x13, f9, rtz
+========================================================================================================================+
...
Registers: x13, f9
a3(x13)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f9                  0xffffffffc20c0000(-35.0_s)                     0xffffffffc20c0000(-35.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            57fc830d046a68c91a02dc072428af7719d90ef5        57fc830d046a68c91a02dc072428af7719d90ef5        
