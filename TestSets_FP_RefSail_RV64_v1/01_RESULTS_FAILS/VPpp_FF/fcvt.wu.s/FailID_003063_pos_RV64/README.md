# FailID_003063 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0x00,0x00,0xe0,0x7b,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x11'}})
    fcvt.wu.s x11, f25, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x11, f25, dyn
+========================================================================================================================+
...
Registers: x11, f25
a1(x11)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f25                 0x41e003007be00000(2149057503.0_d)              0x41e003007be00000(2149057503.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bbc9e02475132d733f699cbc9fdc58e47a40f20f        bbc9e02475132d733f699cbc9fdc58e47a40f20f        
