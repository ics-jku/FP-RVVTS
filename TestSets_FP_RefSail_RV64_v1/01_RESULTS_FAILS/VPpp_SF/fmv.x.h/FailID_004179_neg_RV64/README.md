# FailID_004179 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'x7'}})
    fmv.x.h x7, f14
```
...
```
REG                 REF                                             DUT                                             DIFF
t2(x7)              0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            00a52afe00294255b502efe62513d93182661965        00a52afe00294255b502efe62513d93182661965        
