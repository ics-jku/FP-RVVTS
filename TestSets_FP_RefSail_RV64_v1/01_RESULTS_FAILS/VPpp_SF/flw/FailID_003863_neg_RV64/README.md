# FailID_003863 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x43                  // fp
    li x9, 0x801803f4            // s1
    li x10, 0x7ffff83e           // a0
    li x11, 0x91f3               // a1
    li x12, 0x8017fa2d           // a2
    li x13, 0x7ffff97e           // a3
    li x14, 0x801800ee           // a4
    li x15, 0x801803f4           // a5
    li x16, 0x6000               // a6
    li x17, 0x400c01418000000    // a7
    li x18, 0xdb                 // s2
    li x19, 0x8017ffc6           // s3
    li x20, 0x4000               // s4
    li x21, 0x1                  // s5
    li x22, 0x802001ac           // s6
    li x23, 0x0                  // s7
    li x24, 0x8018039a           // s8
    li x25, 0x8017f969           // s9
    li x26, 0x80200d09           // s10
    li x27, 0xffffffffe5544000   // s11
    li x28, 0x66f5               // t3
    li x29, 0x80242edb           // t4
    li x30, 0x80180283           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x15'}, 'clob': {'x21', 'f18', 'x15'}})
...
f18                 0xffffffffffff7e00(nan_h)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f18                 0xffffffffffff7e00(nan_h)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, x14, x15
a4(x14)             0x00000000801800ee(2149056750)                  0x00000000801800ee(2149056750)
a5(x15)             0x00000000801802aa(2149057194)                  0x00000000801802aa(2149057194)
f18                 0xffffffffffff7e00(nan_h)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
ra(x1)              0x0000000080180000(2149056512)                  0x0000000080180000(2149056512)                  
sp(x2)              0x0000000080200681(2149582465)                  0x0000000080200681(2149582465)                  
gp(x3)              0x0000000080180585(2149057925)                  0x0000000080180585(2149057925)                  
tp(x4)              0x000000008017fedb(2149056219)                  0x000000008017fedb(2149056219)                  
...
t2(x7)              0x000000001234e734(305456948)                   0x000000001234e734(305456948)                   
fp(x8)              0x0000000000000043(67)                          0x0000000000000043(67)                          
s1(x9)              0x00000000801803f4(2149057524)                  0x00000000801803f4(2149057524)                  
a0(x10)             0x000000007ffff83e(2147481662)                  0x000000007ffff83e(2147481662)                  
...
a7(x17)             0x0400c01418000000(288441568686243840)          0x0400c01418000000(288441568686243840)          
s2(x18)             0x00000000000000db(219)                         0x00000000000000db(219)                         
...
s6(x22)             0x00000000802001ac(2149581228)                  0x00000000802001ac(2149581228)                  
s7(x23)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s8(x24)             0x000000008018039a(2149057434)                  0x000000008018039a(2149057434)                  
s9(x25)             0x000000008017f969(2149054825)                  0x000000008017f969(2149054825)                  
s10(x26)            0x0000000080200d09(2149584137)                  0x0000000080200d09(2149584137)                  
s11(x27)            0xffffffffe5544000(18446744073262088192)        0xffffffffe5544000(18446744073262088192)        
t3(x28)             0x00000000000066f5(26357)                       0x00000000000066f5(26357)                       
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1f8da61c84407e449f23358508d813a4b0b3a186        1f8da61c84407e449f23358508d813a4b0b3a186        
