# FailID_002968 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x98,0x07,0x14,0xba,0x7e,0xfe,0xcd,0xb7
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'x22'}})
    fcvt.wu.s x22, f11, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x22, f11, rdn
+========================================================================================================================+
...
Registers: x22, f11
s6(x22)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f11                 0xb7cdfe7eba140798(-6.886312505229248e-40_d)    0xb7cdfe7eba140798(-6.886312505229248e-40_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ef60bd157dc4112d08047e0b7793f52b6052ec2d        ef60bd157dc4112d08047e0b7793f52b6052ec2d        
