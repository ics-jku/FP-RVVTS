# FailID_005540 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f9'}, 'clob': {'f26'}})
    fmin.s f26, f21, f9
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2c731c2f519fcba27bb9fa98f3c9055f6af0f809        2c731c2f519fcba27bb9fa98f3c9055f6af0f809        
