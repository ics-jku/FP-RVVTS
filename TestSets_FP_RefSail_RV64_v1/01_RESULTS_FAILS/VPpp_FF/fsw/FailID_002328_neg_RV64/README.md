# FailID_002328 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'x8', 'x25'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bae60c11bd62991145870edc76c3e9b4cff868eb        bae60c11bd62991145870edc76c3e9b4cff868eb        
