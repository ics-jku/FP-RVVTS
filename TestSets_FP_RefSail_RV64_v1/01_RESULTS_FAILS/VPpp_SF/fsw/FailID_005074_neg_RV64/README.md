# FailID_005074 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x18fcd7              // fp
    li x9, 0x1f41                // s1
    li x10, 0x8027feca           // a0
    li x11, 0x8017f91c           // a1
    li x12, 0x7ffffe04           // a2
    ...
    li x29, 0x7ffffe6f           // t4
    li x30, 0x8017f8fc           // t5
    li x31, 0x80200380           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm', 'f8'}, 'clob': {'x11', 'x29'}})
...
a0(x10)             0x000000008027feca(2150104778)                  0x000000008027feca(2150104778)                  
...
s11(x27)            0x00000000000000d1(209)                         0x00000000000000d1(209)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9e7a6faa212489db0580ff5c9a818d8c91cfb3e7        9e7a6faa212489db0580ff5c9a818d8c91cfb3e7        
