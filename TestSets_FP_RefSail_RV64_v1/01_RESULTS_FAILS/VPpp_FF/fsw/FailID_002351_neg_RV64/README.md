# FailID_002351 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x7, 0x6000                // t2
    li x8, 0x7fc00000            // fp
    li x9, 0x801ffadc000000      // s1
    li x10, 0x801ffadc           // a0
    li x11, 0x21                 // a1
    li x12, 0x8017fc27           // a2
    li x13, 0x80185c27           // a3
    li x14, 0x200                // a4
    li x15, 0x801ffaf9           // a5
    li x16, 0x802805ea           // a6
    li x17, 0x0                  // a7
    li x18, 0x801802fd           // s2
    li x19, 0x8028069f           // s3
    li x20, 0x80200104           // s4
    li x21, 0x8017f959           // s5
    li x22, 0x6000               // s6
    li x23, 0x7432000            // s7
    li x24, 0x7ffffae0           // s8
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f14', 'x3'}, 'clob': {'x3', 'x1'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        2d0dcf526192e87a3be04501c2031a8dac21d353        X
...
sp(x2)              0x000000007ffffebd(2147483325)                  0x000000007ffffebd(2147483325)                  
gp(x3)              0x00000000801ffe78(2149580408)                  0x00000000801ffe78(2149580408)                  
...
s1(x9)              0x00801ffadc000000(36063959312236544)           0x00801ffadc000000(36063959312236544)           
...
a3(x13)             0x0000000080185c27(2149080103)                  0x0000000080185c27(2149080103)                  
...
s2(x18)             0x00000000801802fd(2149057277)                  0x00000000801802fd(2149057277)                  
s3(x19)             0x000000008028069f(2150106783)                  0x000000008028069f(2150106783)                  
s4(x20)             0x0000000080200104(2149581060)                  0x0000000080200104(2149581060)                  
s5(x21)             0x000000008017f959(2149054809)                  0x000000008017f959(2149054809)                  
s6(x22)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s7(x23)             0x0000000007432000(121839616)                   0x0000000007432000(121839616)                   
s8(x24)             0x000000007ffffae0(2147482336)                  0x000000007ffffae0(2147482336)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a0754dc3c3ed4343bfa17a7d423682c9c424ad01        a0754dc3c3ed4343bfa17a7d423682c9c424ad01        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        2d0dcf526192e87a3be04501c2031a8dac21d353        X
