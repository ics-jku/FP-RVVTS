# FailID_004134 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f13', 'fcsr.rm', 'f1'}, 'clob': {'f13'}})
    fmax.s f13, f13, f1
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            351522a8996219e82cf99526d1839cbd1252d730        351522a8996219e82cf99526d1839cbd1252d730        
