# FailID_000454 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f6'}})
    fsqrt.s f6, f3, dyn
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f3
f3                  0xbff0000000000000(-1.0_d)                      0xbff0000000000000(-1.0_d)
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            58deaadd759a83fc93563285fdc47451f59f83c5        58deaadd759a83fc93563285fdc47451f59f83c5        
