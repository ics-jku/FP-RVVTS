# FailID_000262 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x60,0x34,0xba,0x4e,0xff,0xff,0xff,0xff
_reg_f6: .byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f17:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f6'}})
    fdiv.s f6, f17, f5, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f6, f17, f5, rtz
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f17, f5
f5                  0xffffffff4eba3460(1561997312.0_s)              0xffffffff4eba3460(1561997312.0_s)
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f17                 0x4050000000000000(64.0_d)                      0x4050000000000000(64.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a831f0b3af0c265087e2070020c6c502f641f1a3        a831f0b3af0c265087e2070020c6c502f641f1a3        
