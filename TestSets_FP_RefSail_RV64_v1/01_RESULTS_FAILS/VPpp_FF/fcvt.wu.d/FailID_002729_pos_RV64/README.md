# FailID_002729 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0xa0,0xff,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x5'}})
    fcvt.wu.d x5, f3, rup
```
...
```
REG                 REF                                             DUT                                             DIFF
t0(x5)              0xffffffff801807fd(18446744071563642877)        0x00000000801807fd(2149058557)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x5, f3, rup
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x5, f3
t0(x5)              0xffffffff801807fd(18446744071563642877)        0x00000000801807fd(2149058557)                  X
f3                  0x41e00300ffa00000(2149058557.0_d)              0x41e00300ffa00000(2149058557.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2ed4691368ab0efacde2272d8fd057ad7d37d778        2ed4691368ab0efacde2272d8fd057ad7d37d778        
