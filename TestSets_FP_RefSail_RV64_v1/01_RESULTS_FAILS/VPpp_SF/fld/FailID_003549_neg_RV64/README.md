# FailID_003549 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x22, 0x8017fc0c           // s6
    li x23, 0x0                  // s7
    li x24, 0x0                  // s8
    li x25, 0xffff               // s9
    li x26, 0x3fffff81           // s10
    li x27, 0x2                  // s11
    li x28, 0x8017fd23           // t3
    li x29, 0x7ffffd1f           // t4
    li x30, 0x200                // t5
    li x31, 0x8017f8d9           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'f0', 'x24', 'x23'}})
...
f0                  0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
f0                  0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, x692, x23
s7(x23)             0x000000007ffff96e(2147481966)                  0x000000007ffff96e(2147481966)
f0                  0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
a2(x12)             0x0000000000000042(66)                          0x0000000000000042(66)                          
...
s6(x22)             0x000000008017fc0c(2149055500)                  0x000000008017fc0c(2149055500)                  
s7(x23)             0x000000007ffff96e(2147481966)                  0x000000007ffff96e(2147481966)                  
s8(x24)             0x000000007ffff96e(2147481966)                  0x000000007ffff96e(2147481966)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c65c898e12ea49e019fb26d91a285f07c98a1e66        c65c898e12ea49e019fb26d91a285f07c98a1e66        
