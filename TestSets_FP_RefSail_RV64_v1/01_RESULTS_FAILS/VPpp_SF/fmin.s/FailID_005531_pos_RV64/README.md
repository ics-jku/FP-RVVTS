# FailID_005531 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f22'}, 'clob': {'f6'}})
    fmin.s f6, f7, f22
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c4813fc571f5c34d60959f017265f17a3750242e        c4813fc571f5c34d60959f017265f17a3750242e        
