# FailID_000173 ARA pos RV64 fdiv.s
...
_reg_f16:.byte 0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f6'}})
    fdiv.s f6, f2, f16, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f6, f2, f16, rmm
+========================================================================================================================+
...
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f16                 0x0000000000006000(1.2142e-319_d)               0x0000000000006000(1.2142e-319_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d074b03766c43db00e7a6060124251f634d6b359        d074b03766c43db00e7a6060124251f634d6b359        
