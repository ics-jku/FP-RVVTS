# FailID_002743 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f5', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.d x9, f5, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x9, f5, rtz
+========================================================================================================================+
...
Registers: x9, f5
s1(x9)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f5                  0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            22efa40ac9d46a2d8b8a1baba5bcea2ff60ae2cc        22efa40ac9d46a2d8b8a1baba5bcea2ff60ae2cc        
