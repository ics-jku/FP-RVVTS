# FailID_000646 VP++ FF neg RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f16:.byte 0xbc,0x6d,0x47,0xe2,0xcd,0xd0,0x0c,0x74
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f16'}, 'clob': {'x22'}})
    fcvt.wu.s x22, f16, rup
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s6(x22)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x22, f16, rup
+========================================================================================================================+
Attributes:  fcsr ['invalid'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x22, f16
s6(x22)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f16                 0x740cd0cde2476dbc(1.0315604867321677e+251_d)   0x740cd0cde2476dbc(1.0315604867321677e+251_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e64eb43f70f948f8ef591178952ed5a62a5c9d49        e64eb43f70f948f8ef591178952ed5a62a5c9d49        
