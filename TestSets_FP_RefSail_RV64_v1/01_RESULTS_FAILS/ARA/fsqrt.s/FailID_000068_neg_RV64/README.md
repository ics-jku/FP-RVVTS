# FailID_000068 ARA neg RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0xfe,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f14'}, 'clob': {'f12'}})
    fsqrt.s f12, f14, rmm
```
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff1dddb3d7(5.8684162959893324e-21_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f12, f14, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e920053e1a57a7abb62412fc4d20c92999b42670        e920053e1a57a7abb62412fc4d20c92999b42670        
