# FailID_003791 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x7ffffb3c           // s10
    li x27, 0x7ffffa42           // s11
    li x28, 0x0                  // t3
    li x29, 0x71                 // t4
    li x30, 0x0                  // t5
    li x31, 0x800000f7           // t6
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'f21', 'x3'}})
...
f21                 0xffffffffffc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
a1(x11)             0x000000007ffff997(2147482007)                  0x000000007ffff997(2147482007)                  
...
s3(x19)             0x000000007ffff885(2147481733)                  0x000000007ffff885(2147481733)                  
...
t4(x29)             0x0000000000000071(113)                         0x0000000000000071(113)                         
t5(x30)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t6(x31)             0x00000000800000f7(2147483895)                  0x00000000800000f7(2147483895)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            fee3bd64ae58af860a507d75c8f747aa81369871        fee3bd64ae58af860a507d75c8f747aa81369871        
