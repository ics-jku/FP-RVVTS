# FailID_002509 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x11, 0x8027fc3e           // a1
    li x12, 0x0                  // a2
    li x13, 0x0                  // a3
    li x14, 0x80000073           // a4
    li x15, 0x0                  // a5
    li x16, 0x51aff760           // a6
    li x17, 0xfffffffffffffe10   // a7
    li x18, 0x8001f03f           // s2
    li x19, 0xffffffff0acb0000   // s3
    li x20, 0x0                  // s4
    li x21, 0x8028042a           // s5
    li x22, 0x0                  // s6
    li x23, 0x80000455           // s7
    li x24, 0x6000               // s8
    li x25, 0x8018057e           // s9
    li x26, 0x47b8c5d            // s10
    li x27, 0x8018049d           // s11
    li x28, 0x2f563734           // t3
    li x29, 0xffffffffc2b2c000   // t4
    li x30, 0x801ff5a0           // t5
    li x31, 0x801ffc67           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f3', 'mstatus.fs/vs.fs', 'x21'}, 'clob': {'x4', 'x21'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        0060e45b599bea523dc8531685668e599dc8cba7        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, x519, x21
s5(x21)             0x00000000801fff0f(2149580559)                  0x00000000801fff0f(2149580559)
...
ra(x1)              0x000000007ffffc1c(2147482652)                  0x000000007ffffc1c(2147482652)                  
...
tp(x4)              0x000000008017fae7(2149055207)                  0x000000008017fae7(2149055207)                  
...
t2(x7)              0x000000000000007d(125)                         0x000000000000007d(125)                         
fp(x8)              0x00000000494e6624(1229874724)                  0x00000000494e6624(1229874724)                  
s1(x9)              0x0000000080000073(2147483763)                  0x0000000080000073(2147483763)                  
a0(x10)             0x000000007ffffba8(2147482536)                  0x000000007ffffba8(2147482536)                  
a1(x11)             0x000000008027fc3e(2150104126)                  0x000000008027fc3e(2150104126)                  
...
a6(x16)             0x0000000051aff760(1370486624)                  0x0000000051aff760(1370486624)                  
a7(x17)             0xfffffffffffffe10(18446744073709551120)        0xfffffffffffffe10(18446744073709551120)        
s2(x18)             0x000000008001f03f(2147610687)                  0x000000008001f03f(2147610687)                  
s3(x19)             0xffffffff0acb0000(18446744069595660288)        0xffffffff0acb0000(18446744069595660288)        
...
s9(x25)             0x000000008018057e(2149057918)                  0x000000008018057e(2149057918)                  
s10(x26)            0x00000000047b8c5d(75205725)                    0x00000000047b8c5d(75205725)                    
s11(x27)            0x000000008018049d(2149057693)                  0x000000008018049d(2149057693)                  
t3(x28)             0x000000002f563734(794179380)                   0x000000002f563734(794179380)                   
t4(x29)             0xffffffffc2b2c000(18446744072681078784)        0xffffffffc2b2c000(18446744072681078784)        
t5(x30)             0x00000000801ff5a0(2149578144)                  0x00000000801ff5a0(2149578144)                  
t6(x31)             0x00000000801ffc67(2149579879)                  0x00000000801ffc67(2149579879)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            7aee9ff700ccffa9fe7881c753b306548aaad6b2        7aee9ff700ccffa9fe7881c753b306548aaad6b2        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        0060e45b599bea523dc8531685668e599dc8cba7        X
