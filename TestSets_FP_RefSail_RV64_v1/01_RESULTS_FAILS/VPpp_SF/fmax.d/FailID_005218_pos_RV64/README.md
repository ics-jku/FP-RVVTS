# FailID_005218 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f9'}, 'clob': {'f15'}})
    fmax.d f15, f21, f9
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x9e807100754bfec4(-9.136323784076222e-162_d)   0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1e4f2e305fd7e20ab08bbdc21566406180193bb3        1e4f2e305fd7e20ab08bbdc21566406180193bb3        
