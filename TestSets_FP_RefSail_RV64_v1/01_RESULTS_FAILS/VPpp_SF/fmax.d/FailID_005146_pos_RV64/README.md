# FailID_005146 VP++ SF pos RV64 fmax.d
...
_reg_f10:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
_reg_f24:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f8'}, 'clob': {'f24'}})
    fmax.d f24, f10, f8
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x8000000000000000(-0.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f10, f8
+========================================================================================================================+
Attributes:  special values ['nan', 'zero'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f24                 0x8000000000000000(-0.0_d)                      0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f10, f8
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f10                 0x8000000000000000(-0.0_d)                      0x8000000000000000(-0.0_d)
f24                 0x8000000000000000(-0.0_d)                      0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c36f1cc122e33e347da931fd52707e1f3e3dd97d        c36f1cc122e33e347da931fd52707e1f3e3dd97d        
