# FailID_005481 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x00,0x00,0x00,0x00,0x00,0xa8,0x84,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f6'}})
    fmin.s f6, f7, f13
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cbc7c4c6c7c15ffedb2e9968103187e1a2487c29        cbc7c4c6c7c15ffedb2e9968103187e1a2487c29        
