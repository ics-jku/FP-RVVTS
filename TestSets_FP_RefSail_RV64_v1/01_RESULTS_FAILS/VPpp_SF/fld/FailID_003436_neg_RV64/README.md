# FailID_003436 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x14, 0x7ffffdcc           // a4
    li x15, 0x0                  // a5
    li x16, 0x6000               // a6
    li x17, 0x0                  // a7
    li x18, 0x801807bb           // s2
    li x19, 0x0                  // s3
    li x20, 0x7ffffc44           // s4
    li x21, 0x7ff8000000000000   // s5
    li x22, 0x2006005            // s6
    li x23, 0x80180153           // s7
    li x24, 0x247b4284           // s8
    li x25, 0x7ffffb6c           // s9
    li x26, 0xff                 // s10
    li x27, 0x161                // s11
    li x28, 0x1                  // t3
    li x29, 0x801803a6           // t4
    li x30, 0x1                  // t5
    li x31, 0x80200a49           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x30'}, 'clob': {'f14', 'x8', 'x30'}})
...
f14                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
f14                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, x34, x30
t5(x30)             0x000000007fffffcc(2147483596)                  0x000000007fffffcc(2147483596)
f14                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
ra(x1)              0x000000007ffffc44(2147482692)                  0x000000007ffffc44(2147482692)                  
sp(x2)              0x00000000801ffb10(2149579536)                  0x00000000801ffb10(2149579536)                  
gp(x3)              0x0000000000000034(52)                          0x0000000000000034(52)                          
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x0000000080180340(2149057344)                  0x0000000080180340(2149057344)                  
t1(x6)              0x00000000802004b0(2149582000)                  0x00000000802004b0(2149582000)                  
t2(x7)              0x0000000000000200(512)                         0x0000000000000200(512)                         
fp(x8)              0x000000007fffffcc(2147483596)                  0x000000007fffffcc(2147483596)                  
s1(x9)              0x00000000800000f8(2147483896)                  0x00000000800000f8(2147483896)                  
...
a4(x14)             0x000000007ffffdcc(2147483084)                  0x000000007ffffdcc(2147483084)                  
...
s4(x20)             0x000000007ffffc44(2147482692)                  0x000000007ffffc44(2147482692)                  
s5(x21)             0x7ff8000000000000(9221120237041090560)         0x7ff8000000000000(9221120237041090560)         
s6(x22)             0x0000000002006005(33579013)                    0x0000000002006005(33579013)                    
...
s9(x25)             0x000000007ffffb6c(2147482476)                  0x000000007ffffb6c(2147482476)                  
s10(x26)            0x00000000000000ff(255)                         0x00000000000000ff(255)                         
s11(x27)            0x0000000000000161(353)                         0x0000000000000161(353)                         
t3(x28)             0x0000000000000001(1)                           0x0000000000000001(1)                           
t4(x29)             0x00000000801803a6(2149057446)                  0x00000000801803a6(2149057446)                  
t5(x30)             0x000000007fffffcc(2147483596)                  0x000000007fffffcc(2147483596)                  
t6(x31)             0x0000000080200a49(2149583433)                  0x0000000080200a49(2149583433)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            289a0e9702b9983678657bd9fac765840e1be363        289a0e9702b9983678657bd9fac765840e1be363        
