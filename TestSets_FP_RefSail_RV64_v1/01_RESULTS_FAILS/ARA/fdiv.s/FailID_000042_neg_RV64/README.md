# FailID_000042 ARA neg RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x93,0x82,0x02,0xa1,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f24', 'f14'}, 'clob': {'f15'}})
    fdiv.s f15, f24, f14, rmm
```
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f24, f14, rmm
+========================================================================================================================+
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f24, f14
f14                 0xffffffffa1028293(-4.421852679682243e-19_s)    0xffffffffa1028293(-4.421852679682243e-19_s)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ee2c1e6aa68c5feff699a724a096c4dae62b71cf        ee2c1e6aa68c5feff699a724a096c4dae62b71cf        
