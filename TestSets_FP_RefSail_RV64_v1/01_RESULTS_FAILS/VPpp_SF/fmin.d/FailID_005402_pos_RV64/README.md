# FailID_005402 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f25'}, 'clob': {'f19'}})
    fmin.d f19, f23, f25
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x0000000000000000(0.0_d)                       0xffffffff4f001ffd(2149580032.0_s)              X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f19, f23, f25
+========================================================================================================================+
...
f19                 0x0000000000000000(0.0_d)                       0xffffffff4f001ffd(2149580032.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f23, f25
f19                 0x0000000000000000(0.0_d)                       0xffffffff4f001ffd(2149580032.0_s)              X
f23                 0x0000000000000000(0.0_d)                       0x0000000000000000(0.0_d)
f25                 0xffffffff4f001ffd(2149580032.0_s)              0xffffffff4f001ffd(2149580032.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1eed8270a6351cb8ef32460df9d127c6234ab3a4        1eed8270a6351cb8ef32460df9d127c6234ab3a4        
