# FailID_000859 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x9, 0x8006eef8            // s1
    li x10, 0x6000               // a0
    li x11, 0x8017f87c           // a1
    li x12, 0x8027f68e           // a2
    li x13, 0x549                // a3
    li x14, 0x80200d7c           // a4
    li x15, 0x6000               // a5
    li x16, 0x7fffff75           // a6
    li x17, 0x801ff982           // a7
    li x18, 0x763                // s2
    li x19, 0x8017fad6           // s3
    li x20, 0x80280468           // s4
    li x21, 0x7ffffba7           // s5
    li x22, 0x1994e748           // s6
    li x23, 0x18                 // s7
    li x24, 0x802802d6           // s8
    li x25, 0x1                  // s9
    li x26, 0x801ffb2e           // s10
    li x27, 0x7fffff67           // s11
    li x28, 0x801800e5           // t3
    li x29, 0x0                  // t4
    li x30, 0x8017fad6           // t5
    li x31, 0x80154ab1           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'x9', 'x28', 'f22'}})
...
f22                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x427, x28
t3(x28)             0x000000008017fcb9(2149055673)                  0x000000008017fcb9(2149055673)
f22                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
s1(x9)              0x000000007ffffbd9(2147482585)                  0x000000007ffffbd9(2147482585)                  
a0(x10)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
a1(x11)             0x000000008017f87c(2149054588)                  0x000000008017f87c(2149054588)                  
a2(x12)             0x000000008027f68e(2150102670)                  0x000000008027f68e(2150102670)                  
a3(x13)             0x0000000000000549(1353)                        0x0000000000000549(1353)                        
...
a7(x17)             0x00000000801ff982(2149579138)                  0x00000000801ff982(2149579138)                  
s2(x18)             0x0000000000000763(1891)                        0x0000000000000763(1891)                        
s3(x19)             0x000000008017fad6(2149055190)                  0x000000008017fad6(2149055190)                  
...
s7(x23)             0x0000000000000018(24)                          0x0000000000000018(24)                          
s8(x24)             0x00000000802802d6(2150105814)                  0x00000000802802d6(2150105814)                  
...
t6(x31)             0x0000000080154ab1(2148879025)                  0x0000000080154ab1(2148879025)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            8c5c95403488009c9b2299f230277164c53ec04c        8c5c95403488009c9b2299f230277164c53ec04c        
