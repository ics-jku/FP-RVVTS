# FailID_004143 VP++ SF neg RV64 fmin.d
...
_reg_f18:.byte 0x00,0x00,0x40,0x3b,0x00,0x00,0xe0,0x41
_reg_f26:.byte 0x07,0xb3,0x02,0x00,0x97,0x02,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f18', 'fcsr.rm', 'f14'}, 'clob': {'f26'}})
    fmin.d f26, f18, f14
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x41e000003b400000(2147484122.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f26, f18, f14
+========================================================================================================================+
...
f26                 0x41e000003b400000(2147484122.0_d)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f18, f14
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f18                 0x41e000003b400000(2147484122.0_d)              0x41e000003b400000(2147484122.0_d)
f26                 0x41e000003b400000(2147484122.0_d)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8317ef5adad64bbf1b7122ff482396608ef5668e        8317ef5adad64bbf1b7122ff482396608ef5668e        
