# FailID_000890 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0xe0                 // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x15'}, 'clob': {'x15', 'f15', 'x20'}})
...
f15                 0xe6975f5fb8a2a476(-1.5889986046966891e+186_d)  0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1411c465f840c328b05e6de36dcabcbcb8ff8efa        1411c465f840c328b05e6de36dcabcbcb8ff8efa        
