# FailID_005479 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x06,0x09,0x20,0x80,0xff,0xff,0xff,0xff
_reg_f30:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f31:.byte 0x00,0x00,0xc0,0xda,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f31'}, 'clob': {'f30'}})
    fmin.s f30, f23, f31
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff80200906(-2.941972876508309e-39_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f30, f23, f31
+========================================================================================================================+
...
f30                 0xffffffff80200906(-2.941972876508309e-39_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f23, f31
f23                 0xffffffff80200906(-2.941972876508309e-39_s)    0xffffffff80200906(-2.941972876508309e-39_s)
f30                 0xffffffff80200906(-2.941972876508309e-39_s)    0xffffffff7fc00000(nan_s)                       X
f31                 0x41e00000dac00000(2147485398.0_d)              0x41e00000dac00000(2147485398.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7fab3fac945e535adde8634f160d6afcbaec9431        7fab3fac945e535adde8634f160d6afcbaec9431        
