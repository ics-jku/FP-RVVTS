# FailID_005367 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f22'}, 'clob': {'f27'}})
    fmin.d f27, f11, f22
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f27, f11, f22
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3ba7335c0fa94ad331399c12d13fc377ee9d9016        3ba7335c0fa94ad331399c12d13fc377ee9d9016        
