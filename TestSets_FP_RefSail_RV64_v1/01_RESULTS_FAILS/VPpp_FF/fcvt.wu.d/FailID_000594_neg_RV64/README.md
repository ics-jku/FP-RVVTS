# FailID_000594 VP++ FF neg RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x81,0x02,0x18,0x80,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f5'}, 'clob': {'x6'}})
    fcvt.wu.d x6, f5, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x6, f5, rtz
+========================================================================================================================+
...
Registers: x6, f5
t1(x6)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f5                  0x7fffffff80180281(nan_d)                       0x7fffffff80180281(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0e40ae5d2ada3c7d5d1ed927ab723bccebbf0ba1        0e40ae5d2ada3c7d5d1ed927ab723bccebbf0ba1        
