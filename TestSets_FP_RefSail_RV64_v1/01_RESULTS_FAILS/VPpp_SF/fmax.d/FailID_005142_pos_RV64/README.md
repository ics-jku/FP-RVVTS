# FailID_005142 VP++ SF pos RV64 fmax.d
...
_reg_f2: .byte 0x00,0x00,0xa0,0xa9,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f2', 'f1'}, 'clob': {'f30'}})
    fmax.d f30, f2, f1
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0x41e002ffa9a00000(2149055821.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f2                  0x41e002ffa9a00000(2149055821.0_d)              0x41e002ffa9a00000(2149055821.0_d)
f30                 0x41e002ffa9a00000(2149055821.0_d)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5e994362501e9f5de6a56a77db3d51cab280a8bb        5e994362501e9f5de6a56a77db3d51cab280a8bb        
