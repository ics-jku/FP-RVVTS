# FailID_001983 VP++ FF neg RV64 fsh
...
_reg_f27:.byte 0x74,0xea,0xbf,0x8e,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore fcsr = {'nx': True, 'uf': True, 'of': False, 'dz': False, 'nv': True, 'rm': 'rtz(0b001)', 'res': 0}
    li t0, 0x33
    csrrw zero, fcsr, t0
    ...
    li x18, 0x0                  // s2
    li x19, 0x1                  // s3
    li x20, 0x80180526           // s4
    li x21, 0x801802d3           // s5
    li x22, 0x801                // s6
    li x23, 0x8017f8e1           // s7
    li x24, 0x0                  // s8
    li x25, 0x0                  // s9
    li x26, 0x0                  // s10
    li x27, 0x33                 // s11
    li x28, 0x80                 // t3
    li x29, 0x80280610           // t4
    li x30, 0x80180426           // t5
    li x31, 0x7ffffde2           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f15', 'x23'}, 'clob': {'x7', 'x23'}})
...
```
+========================================================================================================================+
Instruction: fsh f15, -0x4d1(x23)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'underflow', 'inexact'], special values ['nan']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
ra(x1)              0x0000000080180555(2149057877)                  0x0000000080180555(2149057877)                  
...
a0(x10)             0x000000008017fd9a(2149055898)                  0x000000008017fd9a(2149055898)                  
...
s4(x20)             0x0000000080180526(2149057830)                  0x0000000080180526(2149057830)                  
s5(x21)             0x00000000801802d3(2149057235)                  0x00000000801802d3(2149057235)                  
s6(x22)             0x0000000000000801(2049)                        0x0000000000000801(2049)                        
s7(x23)             0x00000000801ffdb1(2149580209)                  0x00000000801ffdb1(2149580209)                  
...
s11(x27)            0x0000000000000033(51)                          0x0000000000000033(51)                          
t3(x28)             0x0000000000000080(128)                         0x0000000000000080(128)                         
t4(x29)             0x0000000080280610(2150106640)                  0x0000000080280610(2150106640)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c98ff815f4f838e428a7f423dcfaa409b2bc2c8b        c98ff815f4f838e428a7f423dcfaa409b2bc2c8b        
...
fcsr                0x0000000000000033(51)                          0x0000000000000033(51)                          
 fcsr.nx            True                                            True                                            
 fcsr.uf            True                                            True                                            
 fcsr.of            False                                           False                                           
 fcsr.dz            False                                           False                                           
...
f27                 0x7fffffff8ebfea74(nan_d)                       0x7fffffff8ebfea74(nan_d)                       
