# FailID_000291 ARA pos RV64 fsqrt.d
...
_reg_f29:.byte 0xd5,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fsqrt.d f10, f29, rup
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x1e9d3064dcc8ae68(3.244009595611356e-161_d)    0x1e9d3064dcc8ae67(3.2440095956113556e-161_d)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f10, f29, rup
+========================================================================================================================+
...
Registers: f10, f29
f10                 0x1e9d3064dcc8ae68(3.244009595611356e-161_d)    0x1e9d3064dcc8ae67(3.2440095956113556e-161_d)   X
f29                 0x00000000000000d5(1.05e-321_d)                 0x00000000000000d5(1.05e-321_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b39d299864633bde7f98791edbcce6351061350e        b39d299864633bde7f98791edbcce6351061350e        
