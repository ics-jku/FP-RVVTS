# FailID_004159 VP++ SF neg RV64 fmin.d
...
_reg_f23:.byte 0x00,0x00,0xc0,0x50,0x00,0xfa,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f8', 'f23'}, 'clob': {'f11'}})
    fmin.d f11, f23, f8
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xc1dffa0050c00000(-2145911107.0_d)             0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f11                 0xc1dffa0050c00000(-2145911107.0_d)             0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f23, f8
f8                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f11                 0xc1dffa0050c00000(-2145911107.0_d)             0x7ff8000000000000(nan_d)                       X
f23                 0xc1dffa0050c00000(-2145911107.0_d)             0xc1dffa0050c00000(-2145911107.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4beaf62504cde005f4ca713fd1d7b551a3bcc390        4beaf62504cde005f4ca713fd1d7b551a3bcc390        
