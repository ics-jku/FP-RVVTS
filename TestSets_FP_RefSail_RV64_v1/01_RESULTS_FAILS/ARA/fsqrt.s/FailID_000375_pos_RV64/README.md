# FailID_000375 ARA pos RV64 fsqrt.s
...
_reg_f25:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f22
    fld  f22, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f22'}})
    fsqrt.s f22, f25, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f22, f25, rdn
+========================================================================================================================+
...
Registers: f22, f25
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f25                 0xbff0000000000000(-1.0_d)                      0xbff0000000000000(-1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6b8d2951f83430016b5cf9867a66c46f3bbd8aaf        6b8d2951f83430016b5cf9867a66c46f3bbd8aaf        
