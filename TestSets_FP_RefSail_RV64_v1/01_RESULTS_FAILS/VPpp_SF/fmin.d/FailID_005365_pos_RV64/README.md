# FailID_005365 VP++ SF pos RV64 fmin.d
...
_reg_f2: .byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f2', 'f1'}, 'clob': {'f29'}})
    fmin.d f29, f2, f1
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x41efffffffe00000(4294967295.0_d)              0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
f2                  0x41efffffffe00000(4294967295.0_d)              0x41efffffffe00000(4294967295.0_d)
f29                 0x41efffffffe00000(4294967295.0_d)              0xffffffffffc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5f9ae4bf088697c67c21c4057fedf50fc41bb570        5f9ae4bf088697c67c21c4057fedf50fc41bb570        
