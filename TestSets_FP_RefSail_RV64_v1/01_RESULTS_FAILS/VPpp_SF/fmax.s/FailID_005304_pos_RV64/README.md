# FailID_005304 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x00,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f22'}, 'clob': {'f13'}})
    fmax.s f13, f10, f22
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f13, f10, f22
+========================================================================================================================+
...
f13                 0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, f10, f22
f10                 0xffffffff4f000000(2147483648.0_s)              0xffffffff4f000000(2147483648.0_s)
f13                 0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            87c78bd6225c29010c0013e7a87493203de67643        87c78bd6225c29010c0013e7a87493203de67643        
