# FailID_002056 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x8, 0x4c77a000            // fp
    li x9, 0x0                   // s1
    li x10, 0x80180512           // a0
    li x11, 0x0                  // a1
    li x12, 0x80200562           // a2
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f1', 'x23'}, 'clob': {'x12', 'x23'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, x270, x23
s7(x23)             0x00000000801aaf72(2149232498)                  0x00000000801aaf72(2149232498)
...
t1(x6)              0x000000007ffffaf5(2147482357)                  0x000000007ffffaf5(2147482357)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            17bd9aaa0e2ba93aec1c91e1e0f6e11542827335        17bd9aaa0e2ba93aec1c91e1e0f6e11542827335        
