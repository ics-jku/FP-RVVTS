# FailID_005426 VP++ SF pos RV64 fmin.d
...
_reg_f22:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f12', 'f22'}, 'clob': {'f13'}})
    fmin.d f13, f22, f12
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0x000000132140006f(4.05935308646e-313_d)        0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f13, f22, f12
+========================================================================================================================+
...
f13                 0x000000132140006f(4.05935308646e-313_d)        0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, f22, f12
f12                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f13                 0x000000132140006f(4.05935308646e-313_d)        0x7ff8000000000000(nan_d)                       X
f22                 0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c4bacaf27662cfc9ac65c79f3d3712207f52836e        c4bacaf27662cfc9ac65c79f3d3712207f52836e        
