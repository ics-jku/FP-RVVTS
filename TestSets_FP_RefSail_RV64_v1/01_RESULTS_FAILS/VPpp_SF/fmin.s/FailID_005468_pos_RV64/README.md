# FailID_005468 VP++ SF pos RV64 fmin.s
...
_reg_f28:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f28'}, 'clob': {'f7'}})
    fmin.s f7, f28, f4
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f7                  0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
f28                 0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            02a2e5116dd1b87b01fafc4a2da5f7e62e6fcb4b        02a2e5116dd1b87b01fafc4a2da5f7e62e6fcb4b        
