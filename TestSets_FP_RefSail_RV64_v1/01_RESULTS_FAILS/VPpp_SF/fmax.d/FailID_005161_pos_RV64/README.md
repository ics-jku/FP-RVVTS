# FailID_005161 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x00,0x00,0x40,0x33,0x00,0x00,0xe0,0x41
_reg_f23:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
_reg_f30:.byte 0xa8,0xfb,0xff,0x7f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f30'}, 'clob': {'f23'}})
    fmax.d f23, f14, f30
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0x41e0000033400000(2147484058.0_d)              0xffffffff7ffffba8(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f23, f14, f30
+========================================================================================================================+
...
f23                 0x41e0000033400000(2147484058.0_d)              0xffffffff7ffffba8(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f14, f30
f14                 0x41e0000033400000(2147484058.0_d)              0x41e0000033400000(2147484058.0_d)
f23                 0x41e0000033400000(2147484058.0_d)              0xffffffff7ffffba8(nan_s)                       X
f30                 0xffffffff7ffffba8(nan_s)                       0xffffffff7ffffba8(nan_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8b6a5e94a0d61e5dd4e43181dc2fe80ea800fe00        8b6a5e94a0d61e5dd4e43181dc2fe80ea800fe00        
