# FailID_003681 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x19, 0x8028041c           // s3
    li x20, 0x7fffff3b           // s4
    li x21, 0x0                  // s5
    li x22, 0x0                  // s6
    li x23, 0x22                 // s7
    li x24, 0x0                  // s8
    li x25, 0xcc847758           // s9
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x4'}, 'clob': {'f17', 'x22', 'x4'}})
...
f17                 0x40d8000000000000(24576.0_d)                   0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
ra(x1)              0x00000000801805fc(2149058044)                  0x00000000801805fc(2149058044)                  
...
s3(x19)             0x000000008028041c(2150106140)                  0x000000008028041c(2150106140)                  
...
s9(x25)             0x00000000cc847758(3431233368)                  0x00000000cc847758(3431233368)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            046e2e7b5c5508ef6c941f505d8f00c60ccf5870        046e2e7b5c5508ef6c941f505d8f00c60ccf5870        
