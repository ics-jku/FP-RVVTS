# FailID_000186 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x02,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f20:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f26:.byte 0x00,0x00,0x80,0x22,0x00,0x03,0xe0,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fdiv.s f26, f4, f20, rmm
```
...
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f26, f4, f20, rmm
+========================================================================================================================+
...
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f4, f20
f4                  0xffffffff4f001802(2149057024.0_s)              0xffffffff4f001802(2149057024.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            32c8d73bf03e85a2b04fff3cbdcd286f7d14fd68        32c8d73bf03e85a2b04fff3cbdcd286f7d14fd68        
