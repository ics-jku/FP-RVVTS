# FailID_000332 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f24'}})
    fsqrt.s f24, f5, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f24, f5, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6fd45875ad08cc9a2c25e727a531f876579ac53f        6fd45875ad08cc9a2c25e727a531f876579ac53f        
