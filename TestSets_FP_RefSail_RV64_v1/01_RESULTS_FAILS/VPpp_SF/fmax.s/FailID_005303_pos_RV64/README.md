# FailID_005303 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x80,0x47,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f23:.byte 0x00,0x00,0x80,0x1c,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f8'}, 'clob': {'f7'}})
    fmax.s f7, f23, f8
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff1c800000(8.470329472543003e-22_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f23                 0xffffffff1c800000(8.470329472543003e-22_s)     0xffffffff1c800000(8.470329472543003e-22_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9297413c23b06c02cf594f387df67b7173796881        9297413c23b06c02cf594f387df67b7173796881        
