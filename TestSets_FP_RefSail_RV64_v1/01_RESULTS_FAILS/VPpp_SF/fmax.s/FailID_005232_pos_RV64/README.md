# FailID_005232 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f10'}})
    fmax.s f10, f21, f13
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff4f000006(2147485184.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f10, f21, f13
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2edcb60c176dcddec4a021f4fe6d367a83d24bb2        2edcb60c176dcddec4a021f4fe6d367a83d24bb2        
