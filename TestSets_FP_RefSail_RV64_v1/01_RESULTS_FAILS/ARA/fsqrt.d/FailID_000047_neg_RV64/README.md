# FailID_000047 ARA neg RV64 fsqrt.d
...
_reg_f20:.byte 0x00,0x00,0x40,0xdd,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f20'}})
    fsqrt.d f20, f17, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x42028d0554de2acb(9959418523.770895_d)         0x42028d0554de2aca(9959418523.770893_d)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f20, f17, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            06d2bfe4a80e28feeed101ae2db99ff9e816db7a        06d2bfe4a80e28feeed101ae2db99ff9e816db7a        
