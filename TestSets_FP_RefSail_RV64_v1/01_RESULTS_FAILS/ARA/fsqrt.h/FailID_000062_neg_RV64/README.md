# FailID_000062 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f25'}, 'clob': {'f9'}})
    fsqrt.h f9, f25, rne
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0c00(0.000244140625_h)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f9, f25, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d5e95bcaa929644711fede041068dfb90d40e658        d5e95bcaa929644711fede041068dfb90d40e658        
