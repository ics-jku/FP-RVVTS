# FailID_005470 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0xfb,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'f11', 'fcsr.rm'}, 'clob': {'f7'}})
    fmin.s f7, f11, f14
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ba7179fac2d72147e46f08adae4acf8f8fb9660d        ba7179fac2d72147e46f08adae4acf8f8fb9660d        
