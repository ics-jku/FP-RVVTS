# FailID_005217 VP++ SF pos RV64 fmax.d
...
* FailID: 5217
* Isolated failing instruction: `fmax.d`
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0xb0,0x0b,0x62,0x4f,0xff,0xff,0xff,0xff
_reg_f17:.byte 0x7c,0x50,0x07,0x9c,0x37,0x33,0x06,0xf5
_reg_f31:.byte 0x90,0x61,0x0a,0xc2,0xef,0x1a,0x86,0x29
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f31'}, 'clob': {'f17'}})
    fmax.d f17, f31, f11
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x29861aefc20a6190(1.176539286451636e-108_d)    0xffffffff4f620bb0(3792416768.0_s)              X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f31, f11
+========================================================================================================================+
Attributes:  precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f17                 0x29861aefc20a6190(1.176539286451636e-108_d)    0xffffffff4f620bb0(3792416768.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f31, f11
f11                 0xffffffff4f620bb0(3792416768.0_s)              0xffffffff4f620bb0(3792416768.0_s)
f17                 0x29861aefc20a6190(1.176539286451636e-108_d)    0xffffffff4f620bb0(3792416768.0_s)              X
f31                 0x29861aefc20a6190(1.176539286451636e-108_d)    0x29861aefc20a6190(1.176539286451636e-108_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bb66c6e95d59123613aef2c24d28cd2607d5b734        bb66c6e95d59123613aef2c24d28cd2607d5b734        
