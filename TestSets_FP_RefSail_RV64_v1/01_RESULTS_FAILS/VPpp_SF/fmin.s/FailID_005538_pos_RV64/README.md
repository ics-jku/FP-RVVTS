# FailID_005538 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x60,0x00,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f1'}, 'clob': {'f9'}})
    fmin.s f9, f1, f14
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff00006000(3.4438311059246704e-41_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f1, f14
f1                  0xffffffff00006000(3.4438311059246704e-41_s)    0xffffffff00006000(3.4438311059246704e-41_s)
f9                  0xffffffff00006000(3.4438311059246704e-41_s)    0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aa28b98fbcee3c9586b18d452c0b04f422543de4        aa28b98fbcee3c9586b18d452c0b04f422543de4        
