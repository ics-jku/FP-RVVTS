# FailID_005510 VP++ SF pos RV64 fmin.s
...
_reg_f4: .byte 0x00,0xb0,0x81,0x5e,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f4'}})
    fmin.s f4, f2, f20
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, f2, f20
f2                  0xffffffff4f000000(2147483648.0_s)              0xffffffff4f000000(2147483648.0_s)
f4                  0xffffffff4f000000(2147483648.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            68ef1c3dae9a9569c7fbbe28420d1880a29b997e        68ef1c3dae9a9569c7fbbe28420d1880a29b997e        
