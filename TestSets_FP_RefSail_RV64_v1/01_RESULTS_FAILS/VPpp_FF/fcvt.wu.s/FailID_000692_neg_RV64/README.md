# FailID_000692 VP++ FF neg RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f13', 'mstatus.fs/vs.fs'}, 'clob': {'x29'}})
    fcvt.wu.s x29, f13, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x29, f13, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            774f9093b8f1fe2ba33b00f1f4e11dd6f5190a46        774f9093b8f1fe2ba33b00f1f4e11dd6f5190a46        
