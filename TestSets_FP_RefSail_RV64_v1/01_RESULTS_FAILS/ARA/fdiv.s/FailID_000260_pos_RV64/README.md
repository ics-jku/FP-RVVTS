# FailID_000260 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x4b,0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f13'}})
    fdiv.s f13, f2, f22, rup
```
...
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f13, f2, f22, rup
+========================================================================================================================+
...
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, f2, f22
f2                  0x000000000000004b(3.7e-322_d)                  0x000000000000004b(3.7e-322_d)
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2e72a71fc3997a504f618490ef5e07eecfaa89f0        2e72a71fc3997a504f618490ef5e07eecfaa89f0        
