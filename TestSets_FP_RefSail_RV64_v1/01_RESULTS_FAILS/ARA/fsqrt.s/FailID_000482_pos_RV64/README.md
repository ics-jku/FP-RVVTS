# FailID_000482 ARA pos RV64 fsqrt.s
...
_reg_f20:.byte 0x1a,0xf2,0x78,0x12,0x7a,0x78,0x72,0x8d
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f9'}})
    fsqrt.s f9, f20, rup
```
...
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff28fc72be(2.802738171213924e-14_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f9, f20, rup
+========================================================================================================================+
...
Registers: f9, f20
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff28fc72be(2.802738171213924e-14_s)     X
f20                 0x8d72787a1278f21a(-6.762773187710429e-244_d)   0x8d72787a1278f21a(-6.762773187710429e-244_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            feffae0d5195deca020d4eb39d0264dd81ff19f3        feffae0d5195deca020d4eb39d0264dd81ff19f3        
