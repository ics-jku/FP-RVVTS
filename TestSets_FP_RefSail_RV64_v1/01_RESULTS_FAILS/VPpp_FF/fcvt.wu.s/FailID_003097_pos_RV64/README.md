# FailID_003097 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x68,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f4', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x13'}})
    fcvt.wu.s x13, f4, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x13, f4, rdn
+========================================================================================================================+
...
Registers: x13, f4
a3(x13)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f4                  0x0000000000000068(5.14e-322_d)                 0x0000000000000068(5.14e-322_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            163e43ab20437a62934fdacd044cca907e9b8c86        163e43ab20437a62934fdacd044cca907e9b8c86        
