# FailID_005205 VP++ SF pos RV64 fmax.d
...
_reg_f25:.byte 0xfd,0xcf,0xff,0xce,0xff,0xff,0xff,0xff
_reg_f27:.byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x80
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f25'}})
    fmax.d f25, f27, f3
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0x800000132140006f(-4.05935308646e-313_d)       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f25                 0x800000132140006f(-4.05935308646e-313_d)       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f27, f3
f3                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f25                 0x800000132140006f(-4.05935308646e-313_d)       0xffffffff7fc00000(nan_s)                       X
f27                 0x800000132140006f(-4.05935308646e-313_d)       0x800000132140006f(-4.05935308646e-313_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5c42efa38dd9c1837e15583cbb426e817d3705e2        5c42efa38dd9c1837e15583cbb426e817d3705e2        
