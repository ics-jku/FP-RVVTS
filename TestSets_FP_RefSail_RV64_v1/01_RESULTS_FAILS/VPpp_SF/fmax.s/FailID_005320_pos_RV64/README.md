# FailID_005320 VP++ SF pos RV64 fmax.s
...
_reg_f12:.byte 0x00,0x02,0x00,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f12'}, 'clob': {'f3'}})
    fmax.s f3, f12, f16
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f3                  0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, f12, f16
f3                  0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff7fc00000(nan_s)                       X
f12                 0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff00000200(7.174648137343064e-43_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b5fbc657a6215dd6398d7cad4b08c078abfb4186        b5fbc657a6215dd6398d7cad4b08c078abfb4186        
