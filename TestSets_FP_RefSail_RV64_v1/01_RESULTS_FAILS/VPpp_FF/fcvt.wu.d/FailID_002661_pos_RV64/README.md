# FailID_002661 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x51,0x02,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'x6'}})
    fcvt.wu.d x6, f11, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x6, f11, rdn
+========================================================================================================================+
...
Registers: x6, f11
t1(x6)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f11                 0xffffffff00000251(8.309699893446165e-43_s)     0xffffffff00000251(8.309699893446165e-43_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            35d1f7202184ce2173c4af06914785bb028de84c        35d1f7202184ce2173c4af06914785bb028de84c        
