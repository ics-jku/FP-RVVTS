# FailID_002752 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4'}})
    fcvt.wu.d x4, f2, rtz
```
...
```
REG                 REF                                             DUT                                             DIFF
tp(x4)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x4, f2, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            20d3b769ac9fbf34d51d98a51adfc4ff45c5612e        20d3b769ac9fbf34d51d98a51adfc4ff45c5612e        
