# FailID_005219 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x6e,0xd9,0xa3,0x1a,0x35,0x03,0x72,0x30
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f12'}, 'clob': {'f31'}})
    fmax.d f31, f12, f14
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0x307203351aa3d96e(2.4889477921792735e-75_d)    0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f31, f12, f14
+========================================================================================================================+
...
f31                 0x307203351aa3d96e(2.4889477921792735e-75_d)    0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f12, f14
f12                 0x307203351aa3d96e(2.4889477921792735e-75_d)    0x307203351aa3d96e(2.4889477921792735e-75_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4ca20a302bb0d00b921ef14e668d22186e1ad57a        4ca20a302bb0d00b921ef14e668d22186e1ad57a        
