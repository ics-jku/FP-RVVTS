# FailID_004575 VP++ SF neg RV64 fsh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f13', 'fcsr.rm', 'x13'}, 'clob': {'x13', 'x30'}})
...
a3(x13)             0x0000000080180796(2149058454)                  0x0000000080180796(2149058454)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            da641bb30122b385938d02ecfe962d23c14a4ab9        da641bb30122b385938d02ecfe962d23c14a4ab9        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        f1f40b600070650e63fcf966df087923acc6d8ad        X
