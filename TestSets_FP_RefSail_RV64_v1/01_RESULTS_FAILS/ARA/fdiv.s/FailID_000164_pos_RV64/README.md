# FailID_000164 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x50,0x40
_reg_f23:.byte 0x40,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f0'}, 'clob': {'f11'}})
    fdiv.s f11, f0, f23, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f11, f0, f23, dyn
+========================================================================================================================+
Attributes:  special values ['nan', 'zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f11                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f0, f23
f0                  0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
f11                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f23                 0x0000000000000040(3.16e-322_d)                 0x0000000000000040(3.16e-322_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c6f513417be068634c6f80a99000b3e6ee9d792d        c6f513417be068634c6f80a99000b3e6ee9d792d        
