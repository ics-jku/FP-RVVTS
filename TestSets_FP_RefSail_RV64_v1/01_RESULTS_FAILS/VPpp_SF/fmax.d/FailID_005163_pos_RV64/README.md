# FailID_005163 VP++ SF pos RV64 fmax.d
...
_reg_f19:.byte 0xff,0xff,0x7f,0x4f,0xff,0xff,0xff,0xff
_reg_f30:.byte 0x00,0x00,0xa0,0x9b,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f12'}, 'clob': {'f19'}})
    fmax.d f19, f30, f12
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x41e000009ba00000(2147484893.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f19, f30, f12
+========================================================================================================================+
...
f19                 0x41e000009ba00000(2147484893.0_d)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f30, f12
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f19                 0x41e000009ba00000(2147484893.0_d)              0xffffffff7fc00000(nan_s)                       X
f30                 0x41e000009ba00000(2147484893.0_d)              0x41e000009ba00000(2147484893.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4a534730149106e27ea03fe367a0ce0f59a3b192        4a534730149106e27ea03fe367a0ce0f59a3b192        
