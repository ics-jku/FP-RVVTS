# FailID_002964 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f7', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f7, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f7, rdn
+========================================================================================================================+
...
Registers: x2, f7
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f7                  0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1bd1122d6be7d587b07464b5675ba2ecea7c68a        a1bd1122d6be7d587b07464b5675ba2ecea7c68a        
