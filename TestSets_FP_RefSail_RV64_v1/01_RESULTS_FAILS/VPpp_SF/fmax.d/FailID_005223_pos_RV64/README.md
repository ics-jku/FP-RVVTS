# FailID_005223 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x00,0x00,0x00,0x00,0x34,0x97,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f9'}})
    fmax.d f9, f9, f17
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0x4097340000000000(1485.0_d)                    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            12ab453d74e1a798c563212eda5795619056ce06        12ab453d74e1a798c563212eda5795619056ce06        
