# FailID_003626 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x24', 'f27', 'x14'}})
...
f27                 0xaf8db4449db81ade(-1.252589043789733e-79_d)    0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
a7(x17)             0x0000000000000008(8)                           0x0000000000000008(8)                           
...
STATE               REF                                             DUT                                             DIFF
xmemhash            61727dff9587e9324223848db93ca0e6a6a6c041        61727dff9587e9324223848db93ca0e6a6a6c041        
