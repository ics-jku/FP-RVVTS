# FailID_002672 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f28:.byte 0xbf,0xfc,0x17,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f28
    fld  f28, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f28', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x15'}})
    fcvt.wu.d x15, f28, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a5(x15)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x15, f28, rmm
+========================================================================================================================+
...
Registers: x15, f28
a5(x15)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f28                 0xffffffff8017fcbf(-2.2028846261710065e-39_s)   0xffffffff8017fcbf(-2.2028846261710065e-39_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            09047e3f71f341f761acbe053a1c6a2e105ef76b        09047e3f71f341f761acbe053a1c6a2e105ef76b        
