# FailID_003346 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'x16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x12', 'x16', 'f8'}})
...
f8                  0xffffffff00000000(0.0_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
a2(x12)             0x000000007ffffe82(2147483266)                  0x000000007ffffe82(2147483266)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9157983bfe9b1acce5d242dccec0c222f9a288cf        9157983bfe9b1acce5d242dccec0c222f9a288cf        
