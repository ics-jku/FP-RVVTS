# FailID_000748 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x83                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'f20', 'x4', 'x21'}})
...
f20                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            04a025c3754cb28b2951cece5ba7fdf708dae982        04a025c3754cb28b2951cece5ba7fdf708dae982        
