# FailID_001170 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x16', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'f6', 'x17'}})
...
f6                  0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f6                  0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, x2, a6, x16
sp(x2)              0x0000000000000002(2)                           0x0000000000000002(2)
a6(x16)             0x00000000800002b6(2147484342)                  0x00000000800002b6(2147484342)
f6                  0x0000000000000000(0.0_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            980205cf119a92e77a6c0ca914c42ce20c38feb1        980205cf119a92e77a6c0ca914c42ce20c38feb1        
