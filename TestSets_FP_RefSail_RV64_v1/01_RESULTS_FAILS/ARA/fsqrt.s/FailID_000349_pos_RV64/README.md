# FailID_000349 ARA pos RV64 fsqrt.s
...
_reg_f22:.byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f22'}})
    fsqrt.s f22, f6, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f22, f6, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7e88ec73c3bd99226a90bea850b528ec3c51dbda        7e88ec73c3bd99226a90bea850b528ec3c51dbda        
