# FailID_005301 VP++ SF pos RV64 fmax.s
...
_reg_f24:.byte 0xff,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f25:.byte 0x00,0x00,0xc0,0x4d,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f25'}})
    fmax.s f25, f24, f5
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff4effffff(2147483520.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f25                 0xffffffff4effffff(2147483520.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f24, f5
f5                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f24                 0xffffffff4effffff(2147483520.0_s)              0xffffffff4effffff(2147483520.0_s)
f25                 0xffffffff4effffff(2147483520.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            feab477e7980e72183b19bc5f18f4d7aa2685580        feab477e7980e72183b19bc5f18f4d7aa2685580        
