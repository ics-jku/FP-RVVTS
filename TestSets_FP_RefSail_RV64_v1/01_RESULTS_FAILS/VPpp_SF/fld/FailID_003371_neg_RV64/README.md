# FailID_003371 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x28, 0x200                // t3
    li x29, 0x440                // t4
    li x30, 0x801800cd           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x7'}, 'clob': {'x10', 'f25', 'x7'}})
...
f25                 0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            21e55978e801fa5c727e3744a26fad3388b037ed        21e55978e801fa5c727e3744a26fad3388b037ed        
