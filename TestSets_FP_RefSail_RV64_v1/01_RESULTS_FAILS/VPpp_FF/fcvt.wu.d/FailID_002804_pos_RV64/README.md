# FailID_002804 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x56,0x1c,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x27'}})
    fcvt.wu.d x27, f2, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x27, f2, rne
+========================================================================================================================+
...
Registers: x27, f2
s11(x27)            0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f2                  0xffffffff4f001c56(2149340672.0_s)              0xffffffff4f001c56(2149340672.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2dbef2c0a9d7ee9d00fc7b47860bb7d7af458d41        2dbef2c0a9d7ee9d00fc7b47860bb7d7af458d41        
