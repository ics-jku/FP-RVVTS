# FailID_003061 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x3d,0xcd,0x28,0x5e,0x80,0xfb,0x8b,0xda
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'x5'}})
    fcvt.wu.s x5, f10, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t0(x5)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x5, f10, rne
+========================================================================================================================+
...
Registers: x5, f10
t0(x5)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f10                 0xda8bfb805e28cd3d(-1.5153521223060775e+128_d)  0xda8bfb805e28cd3d(-1.5153521223060775e+128_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            114cd050a879808201a67dffddeba30c00dabd14        114cd050a879808201a67dffddeba30c00dabd14        
