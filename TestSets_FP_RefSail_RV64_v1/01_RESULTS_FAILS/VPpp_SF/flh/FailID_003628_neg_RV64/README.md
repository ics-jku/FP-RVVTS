# FailID_003628 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x30, 0x281b383            // t5
    li x31, 0x30                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x2'}, 'clob': {'x5', 'f22', 'x2'}})
...
f22                 0xffffffffffff0000(0.0_h)                       0xffffffffffffe943(-2694.0_h)                   X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            58d9502b8b138deeacc1ab5327ed44da75d79322        58d9502b8b138deeacc1ab5327ed44da75d79322        
