# FailID_000483 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f13'}})
    fsqrt.s f13, f5
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4fe2d8db785b206ea6bfea6ff4e5b136ed66cf4a        4fe2d8db785b206ea6bfea6ff4e5b136ed66cf4a        
