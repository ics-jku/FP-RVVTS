# FailID_005529 VP++ SF pos RV64 fmin.s
...
_reg_f5: .byte 0xc0,0x1a,0x03,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f1'}, 'clob': {'f27'}})
    fmin.s f27, f5, f1
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff4e031ac0(549892096.0_s)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f5                  0xffffffff4e031ac0(549892096.0_s)               0xffffffff4e031ac0(549892096.0_s)
f27                 0xffffffff4e031ac0(549892096.0_s)               0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            16f819a84fd24cdb51ef13a4644ff0598873d991        16f819a84fd24cdb51ef13a4644ff0598873d991        
