# FailID_005467 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'f28'}})
    fmin.s f28, f24, f11
```
...
```
+========================================================================================================================+
Instruction: fmin.s f28, f24, f11
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            eb05e084b4c74fa722cf07a17bbc143a360f819c        eb05e084b4c74fa722cf07a17bbc143a360f819c        
