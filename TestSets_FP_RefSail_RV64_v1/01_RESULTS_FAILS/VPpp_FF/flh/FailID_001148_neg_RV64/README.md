# FailID_001148 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27'}, 'clob': {'f25', 'x27', 'x15'}})
...
f25                 0x1dd6f7427def1365(6.231391913634826e-165_d)    0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5489eff58c6432fb52e3648078fd64980cb984b4        5489eff58c6432fb52e3648078fd64980cb984b4        
