# FailID_003652 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x31, 0xc1                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x9', 'fcsr.rm'}, 'clob': {'f30', 'x9', 'x20'}})
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, xd8, x9
s1(x9)              0x0000000080180628(2149058088)                  0x0000000080180628(2149058088)
f30                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0fb181554f09522f9f7b467ebbdece7484513d76        0fb181554f09522f9f7b467ebbdece7484513d76        
