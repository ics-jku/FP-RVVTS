# FailID_001621 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f25'}, 'clob': {'x22'}})
    fmv.x.h x22, f25
```
...
```
REG                 REF                                             DUT                                             DIFF
s6(x22)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
```
+========================================================================================================================+
Instruction: fmv.x.h x22, f25
+========================================================================================================================+
Attributes:  special values ['nan'], precision mismatch ('h', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bdd8e5d6ef674fa09f87c4e4c2e8ab1648c3f26c        bdd8e5d6ef674fa09f87c4e4c2e8ab1648c3f26c        
