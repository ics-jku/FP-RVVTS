# FailID_003909 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x2                  // t5
    li x31, 0x37                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm'}, 'clob': {'x21', 'f29', 'x26'}})
...
fp(x8)              0xfffffffffffffe6d(18446744073709551213)        0xfffffffffffffe6d(18446744073709551213)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4adc356482cc169dd28e709b00ac0af318de05d4        4adc356482cc169dd28e709b00ac0af318de05d4        
