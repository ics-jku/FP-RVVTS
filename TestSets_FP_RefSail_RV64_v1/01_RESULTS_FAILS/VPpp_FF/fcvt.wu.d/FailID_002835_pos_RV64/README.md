# FailID_002835 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f27:.byte 0x00,0x00,0x54,0x43,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f27
    fld  f27, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x19'}})
    fcvt.wu.d x19, f27, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x19, f27, rdn
+========================================================================================================================+
...
Registers: x19, f27
s3(x19)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f27                 0xffffffff43540000(212.0_s)                     0xffffffff43540000(212.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c5b6037a023363888b044bb28cbc8d0b5183d7ee        c5b6037a023363888b044bb28cbc8d0b5183d7ee        
