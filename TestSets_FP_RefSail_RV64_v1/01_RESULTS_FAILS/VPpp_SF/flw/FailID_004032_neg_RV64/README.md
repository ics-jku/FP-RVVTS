# FailID_004032 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x27, 0x8027fb49           // s11
    li x28, 0x801807cc           // t3
    li x29, 0x7ffffc5d           // t4
    li x30, 0x8017fd7e           // t5
    li x31, 0x7ffff661           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'x1', 'x27', 'f22'}})
...
f22                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x359, x27
s11(x27)            0x000000008007f7ef(2148005871)                  0x000000008007f7ef(2148005871)
f22                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
ra(x1)              0x000000007ffffca7(2147482791)                  0x000000007ffffca7(2147482791)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ca9d295c96ecef5a9f182b2ca9aa66a9902104b2        ca9d295c96ecef5a9f182b2ca9aa66a9902104b2        
