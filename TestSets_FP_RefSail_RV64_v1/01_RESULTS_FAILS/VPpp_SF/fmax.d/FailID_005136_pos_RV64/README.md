# FailID_005136 VP++ SF pos RV64 fmax.d
...
_reg_f21:.byte 0x00,0x00,0x40,0xa6,0xfe,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f25'}, 'clob': {'f12'}})
    fmax.d f12, f21, f25
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0x41dffffea6400000(2147482265.0_d)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f12, f21, f25
+========================================================================================================================+
...
f12                 0x41dffffea6400000(2147482265.0_d)              0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f21, f25
f12                 0x41dffffea6400000(2147482265.0_d)              0xffffffff00000000(0.0_s)                       X
f21                 0x41dffffea6400000(2147482265.0_d)              0x41dffffea6400000(2147482265.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5653a78d7cee5770d799b09b05eb3a43b9fc55a2        5653a78d7cee5770d799b09b05eb3a43b9fc55a2        
