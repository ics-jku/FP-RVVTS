# FailID_000013 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'f23'}})
    fdiv.s f23, f18, f22, rtz
```
...
STATE               REF                                             DUT                                             DIFF
fcsr                0x0000000000000000(0)                           0x0000000000000003(3)                           X
 fcsr.nx            False                                           True                                            X
 fcsr.uf            False                                           True                                            X
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff8005b087(-5.225035596912589e-40_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f23, f18, f22, rtz
+========================================================================================================================+
Attributes:  fcsr ['underflow', 'inexact'], special values ['nan'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e5671dcbdd9376b36c72d720dc49802b481f9254        e5671dcbdd9376b36c72d720dc49802b481f9254        
