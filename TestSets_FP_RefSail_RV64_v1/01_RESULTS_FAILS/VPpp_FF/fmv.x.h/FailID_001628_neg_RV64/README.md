# FailID_001628 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f12'}, 'clob': {'x10'}})
    fmv.x.h x10, f12
```
...
```
REG                 REF                                             DUT                                             DIFF
a0(x10)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            738a31924b71cb8a0df9b98911ee5e358206f75b        738a31924b71cb8a0df9b98911ee5e358206f75b        
