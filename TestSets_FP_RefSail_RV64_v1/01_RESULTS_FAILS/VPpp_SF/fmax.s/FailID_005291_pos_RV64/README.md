# FailID_005291 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f2'}, 'clob': {'f21'}})
    fmax.s f21, f2, f23
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            071bb8c7a7f44a5cbda61d23905ac8af15b53be2        071bb8c7a7f44a5cbda61d23905ac8af15b53be2        
