# FailID_005206 VP++ SF pos RV64 fmax.d
...
_reg_f28:.byte 0x00,0x00,0x7b,0xc3,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f1', 'fcsr.rm', 'f8'}, 'clob': {'f28'}})
    fmax.d f28, f8, f1
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0x8000000000000000(-0.0_d)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            00fa197123ae201afc6002134897837c154f4aea        00fa197123ae201afc6002134897837c154f4aea        
