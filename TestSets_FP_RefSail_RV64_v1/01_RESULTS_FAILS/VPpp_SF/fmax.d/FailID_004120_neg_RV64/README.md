# FailID_004120 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f16', 'f26'}, 'clob': {'f14'}})
    fmax.d f14, f16, f26
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x41e00300aa000000(2149057872.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f14, f16, f26
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b778f5016a61fdc83b67ecfa6402cd6576fefc4f        b778f5016a61fdc83b67ecfa6402cd6576fefc4f        
