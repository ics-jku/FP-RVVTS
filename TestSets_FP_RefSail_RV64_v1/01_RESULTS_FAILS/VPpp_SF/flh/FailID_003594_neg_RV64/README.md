# FailID_003594 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm'}, 'clob': {'x21', 'x24', 'f28'}})
...
f28                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x2, f9, x21
sp(x2)              0x0000000000000002(2)                           0x0000000000000002(2)
s5(x21)             0x000000008000030d(2147484429)                  0x000000008000030d(2147484429)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            113753993129e21eca380cde2deb6d1d75642abf        113753993129e21eca380cde2deb6d1d75642abf        
