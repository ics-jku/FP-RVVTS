# FailID_005199 VP++ SF pos RV64 fmax.d
...
_reg_f23:.byte 0x00,0x00,0x80,0x3b,0x01,0xf6,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f12'}, 'clob': {'f23'}})
    fmax.d f23, f23, f12
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xc1dff6013b800000(-2144863470.0_d)             0xfff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f23, f23, f12
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f5b8adc515942a90920e0bdece727470b42daf5c        f5b8adc515942a90920e0bdece727470b42daf5c        
