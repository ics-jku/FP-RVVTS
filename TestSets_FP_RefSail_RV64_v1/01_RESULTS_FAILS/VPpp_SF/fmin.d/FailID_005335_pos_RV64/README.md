# FailID_005335 VP++ SF pos RV64 fmin.d
...
_reg_f19:.byte 0x24,0x00,0x00,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f25'}, 'clob': {'f19'}})
    fmin.d f19, f6, f25
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x000000000400bffc(3.31804666e-316_d)           0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f19                 0x000000000400bffc(3.31804666e-316_d)           0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f6, f25
f6                  0x000000000400bffc(3.31804666e-316_d)           0x000000000400bffc(3.31804666e-316_d)
f19                 0x000000000400bffc(3.31804666e-316_d)           0x7ff8000000000000(nan_d)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8613b1a56f696e8939b89a35b53f55730fad4e69        8613b1a56f696e8939b89a35b53f55730fad4e69        
