# FailID_004108 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f19', 'f1'}, 'clob': {'f4'}})
    fmax.d f4, f1, f19
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0x0000000000000000(0.0_d)                       0xfff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4cb301a9e083417cfbafd9ae9bc5b0a39ce55852        4cb301a9e083417cfbafd9ae9bc5b0a39ce55852        
