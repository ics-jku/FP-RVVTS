# FailID_001643 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x13, 0x0                  // a3
    li x14, 0x8027ffee           // a4
    li x15, 0x8000008f           // a5
    li x16, 0x8000051c           // a6
    li x17, 0x0                  // a7
    li x18, 0x1                  // s2
    li x19, 0x0                  // s3
    li x20, 0xb423               // s4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x17', 'f16'}, 'clob': {'x17', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3a81dcf0fe33af039e0e7cc52106e7f4355d1b15        X
...
ra(x1)              0xffffffffffe7fa5f(18446744073707977311)        0xffffffffffe7fa5f(18446744073707977311)        
...
t0(x5)              0x00000000801ff25b(2149577307)                  0x00000000801ff25b(2149577307)                  
...
a4(x14)             0x000000008027ffee(2150105070)                  0x000000008027ffee(2150105070)                  
a5(x15)             0x000000008017f826(2149054502)                  0x000000008017f826(2149054502)                  
a6(x16)             0x000000008000051c(2147484956)                  0x000000008000051c(2147484956)                  
a7(x17)             0x000000008017f826(2149054502)                  0x000000008017f826(2149054502)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1898fe39015c74485211009ca740d6415096da14        1898fe39015c74485211009ca740d6415096da14        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3a81dcf0fe33af039e0e7cc52106e7f4355d1b15        X
