# FailID_004938 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'x16', 'x1'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x41, x1
ra(x1)              0x00000000801804d2(2149057746)                  0x00000000801804d2(2149057746)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a8f5fa25e85595b473fb5343d4b0e7859e478ff4        a8f5fa25e85595b473fb5343d4b0e7859e478ff4        
