# FailID_003249 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0x1                  // t5
    li x31, 0x7f                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x8'}, 'clob': {'f15', 'x8', 'x4'}})
...
f15                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4baf813935d54683b11bbc124fd2d66324c0b702        4baf813935d54683b11bbc124fd2d66324c0b702        
