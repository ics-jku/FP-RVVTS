# FailID_002102 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x29, 0x400c               // t4
    li x30, 0x801fffe8           // t5
    li x31, 0x4d                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs', 'f14'}, 'clob': {'x30', 'x22'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0b211569d943ea4f8448d27a7acc1b4f202d1954        0b211569d943ea4f8448d27a7acc1b4f202d1954        
