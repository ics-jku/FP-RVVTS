# FailID_000955 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x9, 0x0                   // s1
    li x10, 0x0                  // a0
    li x11, 0x800001e6           // a1
    li x12, 0xffffffffa4cb2000   // a2
    li x13, 0x801807a4           // a3
    li x14, 0x2                  // a4
    li x15, 0x801807d2           // a5
    li x16, 0x801801ad           // a6
    li x17, 0x40                 // a7
    li x18, 0xffffffff8d42a000   // s2
    li x19, 0xeb                 // s3
    li x20, 0x8000073a           // s4
    li x21, 0x0                  // s5
    li x22, 0x0                  // s6
    li x23, 0xffffffff8869c000   // s7
    li x24, 0x2dbf573c           // s8
    li x25, 0x80000524           // s9
    li x26, 0x7fffff10           // s10
    li x27, 0x0                  // s11
    li x28, 0x80181252           // t3
    li x29, 0x400000             // t4
    li x30, 0x80000355           // t5
    li x31, 0x801ff8dd           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2'}, 'clob': {'x2', 'f30', 'x17'}})
...
f30                 0xbb3638eae48f844c(-1.8381883999299958e-23_d)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
ra(x1)              0x000000007ffff8e1(2147481825)                  0x000000007ffff8e1(2147481825)                  
sp(x2)              0x000000008017f2b2(2149053106)                  0x000000008017f2b2(2149053106)                  
gp(x3)              0x0000000080000552(2147485010)                  0x0000000080000552(2147485010)                  
...
t2(x7)              0x0000000000005c00(23552)                       0x0000000000005c00(23552)                       
fp(x8)              0x0000000080000355(2147484501)                  0x0000000080000355(2147484501)                  
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a1(x11)             0x00000000800001e6(2147484134)                  0x00000000800001e6(2147484134)                  
a2(x12)             0xffffffffa4cb2000(18446744072179359744)        0xffffffffa4cb2000(18446744072179359744)        
a3(x13)             0x00000000801807a4(2149058468)                  0x00000000801807a4(2149058468)                  
a4(x14)             0x0000000000000002(2)                           0x0000000000000002(2)                           
a5(x15)             0x00000000801807d2(2149058514)                  0x00000000801807d2(2149058514)                  
a6(x16)             0x00000000801801ad(2149056941)                  0x00000000801801ad(2149056941)                  
a7(x17)             0x000000007ffffa62(2147482210)                  0x000000007ffffa62(2147482210)                  
s2(x18)             0xffffffff8d42a000(18446744071784538112)        0xffffffff8d42a000(18446744071784538112)        
s3(x19)             0x00000000000000eb(235)                         0x00000000000000eb(235)                         
s4(x20)             0x000000008000073a(2147485498)                  0x000000008000073a(2147485498)                  
s5(x21)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s6(x22)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s7(x23)             0xffffffff8869c000(18446744071703216128)        0xffffffff8869c000(18446744071703216128)        
s8(x24)             0x000000002dbf573c(767514428)                   0x000000002dbf573c(767514428)                   
s9(x25)             0x0000000080000524(2147484964)                  0x0000000080000524(2147484964)                  
s10(x26)            0x000000007fffff10(2147483408)                  0x000000007fffff10(2147483408)                  
s11(x27)            0x0000000000000000(0)                           0x0000000000000000(0)                           
t3(x28)             0x0000000080181252(2149061202)                  0x0000000080181252(2149061202)                  
t4(x29)             0x0000000000400000(4194304)                     0x0000000000400000(4194304)                     
t5(x30)             0x0000000080000355(2147484501)                  0x0000000080000355(2147484501)                  
t6(x31)             0x00000000801ff8dd(2149578973)                  0x00000000801ff8dd(2149578973)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            8564429430ce8771fb6214fd2190b2f6b7a1c42e        8564429430ce8771fb6214fd2190b2f6b7a1c42e        
