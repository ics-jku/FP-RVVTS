# FailID_003452 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x59                 // s11
    li x28, 0x100000daa00        // t3
    li x29, 0x7fffffff           // t4
    li x30, 0x200                // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'f21', 'x1'}})
...
tp(x4)              0x0000000000000028(40)                          0x0000000000000028(40)                          
...
a5(x15)             0x0000000000000059(89)                          0x0000000000000059(89)                          
...
t3(x28)             0x00000100000daa00(1099512523264)               0x00000100000daa00(1099512523264)               
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8d08edd2dac1c35d122877e689aee0217909432e        8d08edd2dac1c35d122877e689aee0217909432e        
