# FailID_005183 VP++ SF pos RV64 fmax.d
...
_reg_f20:.byte 0x07,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f28:.byte 0x00,0x00,0x00,0x00,0xc0,0x02,0xd0,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f8'}, 'clob': {'f20'}})
    fmax.d f20, f28, f8
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x40d002c000000000(16395.0_d)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f20                 0x40d002c000000000(16395.0_d)                   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f28, f8
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f20                 0x40d002c000000000(16395.0_d)                   0xffffffff7fc00000(nan_s)                       X
f28                 0x40d002c000000000(16395.0_d)                   0x40d002c000000000(16395.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9230513fbccdc9b2b5bb9b5f01d7d64c88bf46a7        9230513fbccdc9b2b5bb9b5f01d7d64c88bf46a7        
