# FailID_003043 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0x00,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f20
    fld  f20, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x14'}})
    fcvt.wu.s x14, f20, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x14, f20, rmm
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x14, f20
a4(x14)             0xffffffff80000000(18446744071562067968)        0x0000000080000000(2147483648)                  X
f20                 0xffffffff4f000000(2147483648.0_s)              0xffffffff4f000000(2147483648.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d20e430f8aae1d9ed1bc1c435bd8539fc04fd803        d20e430f8aae1d9ed1bc1c435bd8539fc04fd803        
