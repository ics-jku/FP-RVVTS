# FailID_004098 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29', 'f8'}, 'clob': {'f15'}})
    fmax.d f15, f29, f8
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x740cd0cde2476dbc(1.0315604867321677e+251_d)   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d1995ebfd0e24be6be8770d0334a29a67a32f97e        d1995ebfd0e24be6be8770d0334a29a67a32f97e        
