# FailID_000050 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f4'}})
    fsqrt.h f4, f16, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f4, f16, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1a252fec02c097bb195cb419f558791ad576409a        1a252fec02c097bb195cb419f558791ad576409a        
