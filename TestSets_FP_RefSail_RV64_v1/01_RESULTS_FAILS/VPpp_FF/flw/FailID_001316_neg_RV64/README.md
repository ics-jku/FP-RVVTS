# FailID_001316 VP++ FF neg RV64 flw
...
_reg_f28:.byte 0x70,0x3b,0x78,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    li x5, 0x7e00                // t0
    li x6, 0x0                   // t1
    li x7, 0xffffffff7fc00000    // t2
    li x8, 0x7fffffffffffffff    // fp
    li x9, 0xf5                  // s1
    li x10, 0x80185a76           // a0
    li x11, 0xffffffffffffffff   // a1
    li x12, 0x80180cce           // a2
    li x13, 0x6000               // a3
    li x14, 0x80180215           // a4
    li x15, 0x801e177c           // a5
    li x16, 0xffffffff7fc00000   // a6
    li x17, 0x2a                 // a7
    li x18, 0x1                  // s2
    li x19, 0x23                 // s3
    li x20, 0x0                  // s4
    ...
    li x23, 0x1                  // s7
    li x24, 0x800002e4           // s8
    li x25, 0x80000264           // s9
    li x26, 0x6000               // s10
    li x27, 0x0                  // s11
    li x28, 0x0                  // t3
    li x29, 0x80000142           // t4
    li x30, 0x80000042           // t5
    li x31, 0x80180215           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x22', 'mstatus.fs/vs.fs'}, 'clob': {'x22', 'f10', 'x6'}})
...
f10                 0xffffffff4f783b70(4164644864.0_s)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f10                 0xffffffff4f783b70(4164644864.0_s)              0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, x658, x22
s6(x22)             0x0000000080200654(2149582420)                  0x0000000080200654(2149582420)
f10                 0xffffffff4f783b70(4164644864.0_s)              0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
t0(x5)              0x0000000000007e00(32256)                       0x0000000000007e00(32256)                       
t1(x6)              0x0000000080000658(2147485272)                  0x0000000080000658(2147485272)                  
t2(x7)              0xffffffff7fc00000(18446744071557873664)        0xffffffff7fc00000(18446744071557873664)        
fp(x8)              0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
s1(x9)              0x00000000000000f5(245)                         0x00000000000000f5(245)                         
...
a2(x12)             0x0000000080180cce(2149059790)                  0x0000000080180cce(2149059790)                  
...
a5(x15)             0x00000000801e177c(2149455740)                  0x00000000801e177c(2149455740)                  
a6(x16)             0xffffffff7fc00000(18446744071557873664)        0xffffffff7fc00000(18446744071557873664)        
a7(x17)             0x000000000000002a(42)                          0x000000000000002a(42)                          
s2(x18)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s3(x19)             0x0000000000000023(35)                          0x0000000000000023(35)                          
...
s8(x24)             0x00000000800002e4(2147484388)                  0x00000000800002e4(2147484388)                  
s9(x25)             0x0000000080000264(2147484260)                  0x0000000080000264(2147484260)                  
...
t4(x29)             0x0000000080000142(2147483970)                  0x0000000080000142(2147483970)                  
t5(x30)             0x0000000080000042(2147483714)                  0x0000000080000042(2147483714)                  
t6(x31)             0x0000000080180215(2149057045)                  0x0000000080180215(2149057045)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            0dd75721ac19a0613d89e35ac1b947b2077aa8bd        0dd75721ac19a0613d89e35ac1b947b2077aa8bd        
...
f5                  0xffffffff00007e00(4.52002832652613e-41_s)      0xffffffff00007e00(4.52002832652613e-41_s)      
...
f28                 0xffffffff4f783b70(4164644864.0_s)              0xffffffff4f783b70(4164644864.0_s)              
