# FailID_002107 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs', 'f5'}, 'clob': {'x8', 'x22'}})
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f5, x8
fp(x8)              0x00000000801da102(2149425410)                  0x00000000801da102(2149425410)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7dbb0f2a78fcaf048f74b88274046be53884974d        7dbb0f2a78fcaf048f74b88274046be53884974d        
