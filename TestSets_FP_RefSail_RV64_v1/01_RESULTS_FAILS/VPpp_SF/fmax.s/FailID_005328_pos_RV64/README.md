# FailID_005328 VP++ SF pos RV64 fmax.s
...
_reg_f27:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f23'}})
    fmax.s f23, f27, f6
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f23                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f27, f6
f6                  0x0000000000000000(0.0_d)                       0x0000000000000000(0.0_d)
f23                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
f27                 0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            32f180bef4aab065d1aaa771e2fcf7c835e57f92        32f180bef4aab065d1aaa771e2fcf7c835e57f92        
