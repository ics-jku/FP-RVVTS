# FailID_005363 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f18', 'fcsr.rm'}, 'clob': {'f3'}})
    fmin.d f3, f3, f18
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0352bed684f2420b5c23d9ffebc8d397185ee19f        0352bed684f2420b5c23d9ffebc8d397185ee19f        
