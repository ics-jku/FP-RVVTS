# FailID_005260 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f7'}, 'clob': {'f18'}})
    fmax.s f18, f17, f7
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff00000000(0.0_s)                       0xffffffffffffffff(nan_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f18, f17, f7
+========================================================================================================================+
Attributes:  special values ['nan', 'zero'], precision mismatch ('s', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f18                 0xffffffff00000000(0.0_s)                       0xffffffffffffffff(nan_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f17, f7
f7                  0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            368bc97fb194db2d0aea473f5d12c661240dc966        368bc97fb194db2d0aea473f5d12c661240dc966        
