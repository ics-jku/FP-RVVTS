# FailID_003969 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x23, 0x0                  // s7
    li x24, 0x8027f7c5           // s8
    li x25, 0x6000               // s9
    li x26, 0x6000               // s10
    li x27, 0x400c02d2000        // s11
    li x28, 0x8017ff2b           // t3
    li x29, 0x62                 // t4
    li x30, 0x8017fb53           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x18'}, 'clob': {'f13', 'x18', 'x24'}})
...
f13                 0x7ff8000000000000(nan_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
STATES DIFFER: True
```
...
f13                 0x7ff8000000000000(nan_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x175, x18
s2(x18)             0x000000008000008b(2147483787)                  0x000000008000008b(2147483787)
f13                 0x7ff8000000000000(nan_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
+========================================================================================================================+
```
...
a4(x14)             0x000000008020032f(2149581615)                  0x000000008020032f(2149581615)                  
...
s8(x24)             0x000000007ffffe8b(2147483275)                  0x000000007ffffe8b(2147483275)                  
...
t5(x30)             0x000000008017fb53(2149055315)                  0x000000008017fb53(2149055315)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            dee7345e09535cdfa64b09dd9368ba61d23b2385        dee7345e09535cdfa64b09dd9368ba61d23b2385        
