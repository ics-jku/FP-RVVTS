# FailID_003539 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x1                   // fp
    li x9, 0xb98c9734            // s1
    li x10, 0x1bfd1000           // a0
    li x11, 0x21                 // a1
    li x12, 0x802495ad           // a2
    li x13, 0x8000000c           // a3
    ...
    li x20, 0x8017fb31           // s4
    li x21, 0x800004ac           // s5
    li x22, 0x2e6407b8           // s6
    li x23, 0x8017fe3f           // s7
    li x24, 0x7ffffa86           // s8
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm'}, 'clob': {'x16', 'x21', 'f27'}})
...
f27                 0x4f744cbe81c5f007(5.738657611920474e+74_d)     0xee82829300000297(-2.1410879581002543e+224_d)  X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fld f27, -0x5e0(x21)
+========================================================================================================================+
Attributes:  fcsr ['overflow', 'div-by-0', 'inexact']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f27                 0x4f744cbe81c5f007(5.738657611920474e+74_d)     0xee82829300000297(-2.1410879581002543e+224_d)  X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x5, e0, x21
t0(x5)              0x00000000bd8d97f7(3180173303)                  0x00000000bd8d97f7(3180173303)
s5(x21)             0x0000000080000a88(2147486344)                  0x0000000080000a88(2147486344)
f27                 0x4f744cbe81c5f007(5.738657611920474e+74_d)     0xee82829300000297(-2.1410879581002543e+224_d)  X
+========================================================================================================================+
```
...
a0(x10)             0x000000001bfd1000(469569536)                   0x000000001bfd1000(469569536)                   
a1(x11)             0x0000000000000021(33)                          0x0000000000000021(33)                          
a2(x12)             0x00000000802495ad(2149881261)                  0x00000000802495ad(2149881261)                  
a3(x13)             0x000000008000000c(2147483660)                  0x000000008000000c(2147483660)                  
...
a6(x16)             0x00000000800005e0(2147485152)                  0x00000000800005e0(2147485152)                  
...
s4(x20)             0x000000008017fb31(2149055281)                  0x000000008017fb31(2149055281)                  
s5(x21)             0x0000000080000a88(2147486344)                  0x0000000080000a88(2147486344)                  
s6(x22)             0x000000002e6407b8(778307512)                   0x000000002e6407b8(778307512)                   
...
s11(x27)            0x00000000000004d2(1234)                        0x00000000000004d2(1234)                        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            06c5418899a48b8c01a635ed5cb61f9f364f437a        06c5418899a48b8c01a635ed5cb61f9f364f437a        
