# FailID_000151 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0xa0,0x6d,0x00,0x03,0xe0,0x41
_reg_f16:.byte 0x00,0x00,0x40,0x3d,0xcc,0xfb,0xdf,0xc1
_reg_f29:.byte 0x4f,0x51,0x59,0x6b,0x58,0x7a,0x40,0x1c
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f4'}})
    fdiv.s f4, f29, f16, rmm
```
...
STATE               REF                                             DUT                                             DIFF
fcsr                0x0000000000000000(0)                           0x0000000000000001(1)                           X
 fcsr.nx            False                                           True                                            X
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff6d90e0df(5.604711735699131e+27_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f4, f29, f16, rmm
+========================================================================================================================+
Attributes:  fcsr ['inexact'], special values ['nan'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff6d90e0df(5.604711735699131e+27_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, f29, f16
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff6d90e0df(5.604711735699131e+27_s)     X
f16                 0xc1dffbcc3d400000(-2146382069.0_d)             0xc1dffbcc3d400000(-2146382069.0_d)
f29                 0x1c407a586b59514f(1.3324614825987922e-172_d)   0x1c407a586b59514f(1.3324614825987922e-172_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4ed058e159d01ac8230d58bbf6a6b18969f8d95a        4ed058e159d01ac8230d58bbf6a6b18969f8d95a        
