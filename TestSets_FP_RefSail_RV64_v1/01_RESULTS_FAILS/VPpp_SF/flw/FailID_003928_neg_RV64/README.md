# FailID_003928 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x19, 0x8017fa30           // s3
    li x20, 0xffffffff7fe7fd75   // s4
    li x21, 0x4d                 // s5
    li x22, 0x1                  // s6
    li x23, 0x8017fa2f           // s7
    li x24, 0x7ffffbf9           // s8
    li x25, 0x800002e0           // s9
    li x26, 0xd9                 // s10
    li x27, 0x801ff8d3           // s11
    li x28, 0x1                  // t3
    li x29, 0xffffffffd18ba000   // t4
    li x30, 0x7fffffd1           // t5
    li x31, 0x8017fa91           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x11'}, 'clob': {'x11', 'f29', 'x23'}})
...
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, xf6, x11
a1(x11)             0x00000000801ff1b2(2149577138)                  0x00000000801ff1b2(2149577138)
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
s1(x9)              0x00000000800007be(2147485630)                  0x00000000800007be(2147485630)                  
a0(x10)             0x000000008017fab0(2149055152)                  0x000000008017fab0(2149055152)                  
a1(x11)             0x00000000801ff1b2(2149577138)                  0x00000000801ff1b2(2149577138)                  
a2(x12)             0x000000008018026e(2149057134)                  0x000000008018026e(2149057134)                  
...
s3(x19)             0x000000008017fa30(2149055024)                  0x000000008017fa30(2149055024)                  
...
s7(x23)             0x00000000800000f6(2147483894)                  0x00000000800000f6(2147483894)                  
...
s10(x26)            0x00000000000000d9(217)                         0x00000000000000d9(217)                         
s11(x27)            0x00000000801ff8d3(2149578963)                  0x00000000801ff8d3(2149578963)                  
t3(x28)             0x0000000000000001(1)                           0x0000000000000001(1)                           
t4(x29)             0xffffffffd18ba000(18446744072930172928)        0xffffffffd18ba000(18446744072930172928)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            21d318485315cca7bd68ec0656868f21ba3f1330        21d318485315cca7bd68ec0656868f21ba3f1330        
