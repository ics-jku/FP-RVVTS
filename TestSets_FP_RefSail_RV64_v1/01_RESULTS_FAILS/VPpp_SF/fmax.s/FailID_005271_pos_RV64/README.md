# FailID_005271 VP++ SF pos RV64 fmax.s
...
_reg_f13:.byte 0xff,0xff,0x7f,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f1'}})
    fmax.s f1, f13, f21
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff4f7fffff(4294967040.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f1                  0xffffffff4f7fffff(4294967040.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f13, f21
f1                  0xffffffff4f7fffff(4294967040.0_s)              0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffff4f7fffff(4294967040.0_s)              0xffffffff4f7fffff(4294967040.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e65f12b35991f3a3cfb0b4ffb84f6922f4f187ac        e65f12b35991f3a3cfb0b4ffb84f6922f4f187ac        
