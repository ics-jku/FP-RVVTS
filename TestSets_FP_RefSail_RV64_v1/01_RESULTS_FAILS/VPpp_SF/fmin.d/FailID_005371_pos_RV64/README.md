# FailID_005371 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x64,0xfb,0x17,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f23', 'fcsr.rm'}, 'clob': {'f8'}})
    fmin.d f8, f3, f23
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x000000008017fb64(1.0617744106e-314_d)         0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, f3, f23
f3                  0x000000008017fb64(1.0617744106e-314_d)         0x000000008017fb64(1.0617744106e-314_d)
f8                  0x000000008017fb64(1.0617744106e-314_d)         0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            739293d2dbb69ccfc49902c5d7c261d0bdae4ab1        739293d2dbb69ccfc49902c5d7c261d0bdae4ab1        
