# FailID_005195 VP++ SF pos RV64 fmax.d
...
_reg_f8: .byte 0x00,0x00,0x80,0x1d,0xfe,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f8'}, 'clob': {'f0'}})
    fmax.d f0, f8, f10
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0x41dffffe1d800000(2147481718.0_d)              0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
Registers: f0, f8, f10
f0                  0x41dffffe1d800000(2147481718.0_d)              0x7ff8000000000000(nan_d)                       X
f8                  0x41dffffe1d800000(2147481718.0_d)              0x41dffffe1d800000(2147481718.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4761405debace0c613647cb3804c6e7a5f2ffb59        4761405debace0c613647cb3804c6e7a5f2ffb59        
