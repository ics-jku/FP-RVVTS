# FailID_001535 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x21, 0x7ffffaa7           // s5
    li x22, 0xc8c3d764           // s6
    li x23, 0x7ffffdd1           // s7
    li x24, 0x8017fd58           // s8
    li x25, 0x801802b6           // s9
    li x26, 0xffffffff7fc00000   // s10
    li x27, 0x802802f5           // s11
    li x28, 0x6000               // t3
    li x29, 0x7ffffb0b           // t4
    li x30, 0x800d591d           // t5
    li x31, 0x23                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x26', 'mstatus.fs/vs.fs'}, 'clob': {'x13', 'x26', 'f22'}})
...
f22                 0xffffffffffff0000(0.0_h)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f22                 0xffffffffffff0000(0.0_h)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x267, x26
s10(x26)            0x000000007ffffd99(2147483033)                  0x000000007ffffd99(2147483033)
f22                 0xffffffffffff0000(0.0_h)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
a3(x13)             0x000000007ffffd99(2147483033)                  0x000000007ffffd99(2147483033)                  
...
s5(x21)             0x000000007ffffaa7(2147482279)                  0x000000007ffffaa7(2147482279)                  
s6(x22)             0x00000000c8c3d764(3368277860)                  0x00000000c8c3d764(3368277860)                  
...
t4(x29)             0x000000007ffffb0b(2147482379)                  0x000000007ffffb0b(2147482379)                  
t5(x30)             0x00000000800d591d(2148358429)                  0x00000000800d591d(2148358429)                  
t6(x31)             0x0000000000000023(35)                          0x0000000000000023(35)                          

STATE               REF                                             DUT                                             DIFF
xmemhash            d292d038b55cfa9185aff5c7aa3234f1c7d4892c        d292d038b55cfa9185aff5c7aa3234f1c7d4892c        
