# FailID_005262 VP++ SF pos RV64 fmax.s
...
_reg_f31:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f31'}, 'clob': {'f28'}})
    fmax.s f28, f16, f31
```
...
```
+========================================================================================================================+
Instruction: fmax.s f28, f16, f31
+========================================================================================================================+
...
f28                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f16, f31
f16                 0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f28                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
f31                 0x7fffffff80000000(nan_d)                       0x7fffffff80000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            64455abd37ef8f8f25c2e18341bfeb61e0981dc0        64455abd37ef8f8f25c2e18341bfeb61e0981dc0        
