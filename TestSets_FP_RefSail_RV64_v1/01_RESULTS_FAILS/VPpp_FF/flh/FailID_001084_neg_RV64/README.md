# FailID_001084 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x8, 0x8018015a            // fp
    li x9, 0x801804e2            // s1
    li x10, 0x80199012           // a0
    li x11, 0x0                  // a1
    li x12, 0x801802c0           // a2
    li x13, 0x801e07e8           // a3
    li x14, 0x7ffffc9a           // a4
    li x15, 0x0                  // a5
    li x16, 0x0                  // a6
    li x17, 0x6000               // a7
    li x18, 0x801ffab2           // s2
    li x19, 0x8000012b           // s3
    li x20, 0x8017fa27           // s4
    li x21, 0x8018015a           // s5
    li x22, 0x80180320           // s6
    li x23, 0xfffffffffffffff3   // s7
    li x24, 0x8017ffb8           // s8
    li x25, 0x8017fa27           // s9
    li x26, 0x8017ff5e           // s10
    li x27, 0x8018042f           // s11
    li x28, 0x801801c9           // t3
    li x29, 0x8017fd3c           // t4
    li x30, 0x24550000           // t5
    li x31, 0x8017f8f2           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x7'}, 'clob': {'x24', 'x7', 'f22'}})
...
f22                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
f22                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x216, x7
t2(x7)              0x0000000080000216(2147484182)                  0x0000000080000216(2147484182)
f22                 0x0000000000000000(0.0_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
+========================================================================================================================+
```
...
sp(x2)              0x000000007fffffce(2147483598)                  0x000000007fffffce(2147483598)                  
...
t2(x7)              0x0000000080000216(2147484182)                  0x0000000080000216(2147484182)                  
fp(x8)              0x000000008018015a(2149056858)                  0x000000008018015a(2149056858)                  
s1(x9)              0x00000000801804e2(2149057762)                  0x00000000801804e2(2149057762)                  
a0(x10)             0x0000000080199012(2149158930)                  0x0000000080199012(2149158930)                  
a1(x11)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a2(x12)             0x00000000801802c0(2149057216)                  0x00000000801802c0(2149057216)                  
...
s2(x18)             0x00000000801ffab2(2149579442)                  0x00000000801ffab2(2149579442)                  
s3(x19)             0x000000008000012b(2147483947)                  0x000000008000012b(2147483947)                  
s4(x20)             0x000000008017fa27(2149055015)                  0x000000008017fa27(2149055015)                  
s5(x21)             0x000000008018015a(2149056858)                  0x000000008018015a(2149056858)                  
s6(x22)             0x0000000080180320(2149057312)                  0x0000000080180320(2149057312)                  
s7(x23)             0xfffffffffffffff3(18446744073709551603)        0xfffffffffffffff3(18446744073709551603)        
s8(x24)             0x0000000080000216(2147484182)                  0x0000000080000216(2147484182)                  
s9(x25)             0x000000008017fa27(2149055015)                  0x000000008017fa27(2149055015)                  
s10(x26)            0x000000008017ff5e(2149056350)                  0x000000008017ff5e(2149056350)                  
...
t5(x30)             0x0000000024550000(609550336)                   0x0000000024550000(609550336)                   
t6(x31)             0x000000008017f8f2(2149054706)                  0x000000008017f8f2(2149054706)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            68f12a1f1f20829166cf3283fee4899afafd6c60        68f12a1f1f20829166cf3283fee4899afafd6c60        
