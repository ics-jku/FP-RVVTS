# FailID_005362 VP++ SF pos RV64 fmin.d
...
_reg_f24:.byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f12'}, 'clob': {'f24'}})
    fmin.d f24, f3, f12
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x000000007ffffba4(1.060997344e-314_d)          0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            afdd6b1df38a35fe5e3f753edd01225dd1dd486b        afdd6b1df38a35fe5e3f753edd01225dd1dd486b        
