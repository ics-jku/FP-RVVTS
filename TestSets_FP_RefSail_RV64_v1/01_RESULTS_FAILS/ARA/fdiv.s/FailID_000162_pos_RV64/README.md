# FailID_000162 ARA pos RV64 fdiv.s
...
_reg_f15:.byte 0x00,0x00,0x40,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f4'}})
    fdiv.s f4, f15, f27, rmm
```
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f4, f15, f27, rmm
+========================================================================================================================+
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, f15, f27
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f15                 0xffffffff00400000(5.877471754111438e-39_s)     0xffffffff00400000(5.877471754111438e-39_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ac4219e8a1e5e7ac48224a2deaab76a459b93ec6        ac4219e8a1e5e7ac48224a2deaab76a459b93ec6        
