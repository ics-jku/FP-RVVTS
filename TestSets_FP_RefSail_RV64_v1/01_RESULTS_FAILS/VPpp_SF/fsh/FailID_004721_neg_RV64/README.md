# FailID_004721 VP++ SF neg RV64 fsh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f16', 'x10'}, 'clob': {'x14', 'x10'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            b643b298748c320dc58bdea97c2fac0edd6801c0        18fdc079f49e8e275fde19c95d82302250db5caf        X
STATES DIFFER: True
```
...
a0(x10)             0x000000008017f887(2149054599)                  0x000000008017f887(2149054599)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cc6946384c76157ea6d0e96c78453365a960241c        cc6946384c76157ea6d0e96c78453365a960241c        
dmemhash            b643b298748c320dc58bdea97c2fac0edd6801c0        18fdc079f49e8e275fde19c95d82302250db5caf        X
