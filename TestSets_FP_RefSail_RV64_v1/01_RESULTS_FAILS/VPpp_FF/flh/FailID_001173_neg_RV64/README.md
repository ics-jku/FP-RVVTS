# FailID_001173 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x18, 0x0                  // s2
    li x19, 0x8017fd50           // s3
    li x20, 0x8017f80d           // s4
    li x21, 0x8017fd6b           // s5
    li x22, 0x7ffffb7c           // s6
    li x23, 0xffffff             // s7
    li x24, 0x801feed3           // s8
    li x25, 0x802807b1           // s9
    li x26, 0x414f9000           // s10
    li x27, 0x801807c1           // s11
    li x28, 0x801802e5           // t3
    li x29, 0x13                 // t4
    li x30, 0x8017fb4d           // t5
    li x31, 0x8027f2c4           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'f13', 'x21', 'x28'}})
...
f13                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x539, x28
t3(x28)             0x000000008018081d(2149058589)                  0x000000008018081d(2149058589)
f13                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
s10(x26)            0x00000000414f9000(1095733248)                  0x00000000414f9000(1095733248)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            78d094c8974a625f1bdb9fcc36711ed42452728a        78d094c8974a625f1bdb9fcc36711ed42452728a        
