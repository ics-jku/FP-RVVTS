# FailID_000196 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f19:.byte 0x00,0x00,0x80,0x72,0xff,0xff,0xef,0xc1
_reg_f22:.byte 0x00,0x00,0x80,0x72,0xff,0xff,0xef,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f26'}})
    fdiv.s f26, f22, f19, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f26, f22, f19, rdn
+========================================================================================================================+
...
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f22, f19
f19                 0xc1efffff72800000(-4294966164.0_d)             0xc1efffff72800000(-4294966164.0_d)
f22                 0x41efffff72800000(4294966164.0_d)              0x41efffff72800000(4294966164.0_d)
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            283a8004b19769fb9aebaf91e7cb9c4e0c4aa771        283a8004b19769fb9aebaf91e7cb9c4e0c4aa771        
