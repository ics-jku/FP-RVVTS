# FailID_004051 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0x8000027a           // a2
    li x13, 0x0                  // a3
    li x14, 0x6000               // a4
    li x15, 0x400c00             // a5
    li x16, 0x801fff29           // a6
    li x17, 0x7ffffe2c           // a7
    li x18, 0x8000031d           // s2
    li x19, 0x43                 // s3
    li x20, 0x80180727           // s4
    li x21, 0x800000bb           // s5
    li x22, 0x413bb000           // s6
    li x23, 0x1                  // s7
    li x24, 0x0                  // s8
    li x25, 0x10c0               // s9
    li x26, 0x7ffffeec           // s10
    li x27, 0x77                 // s11
    li x28, 0x800000a4           // t3
    li x29, 0x8017fa10           // t4
    li x30, 0x80180727           // t5
    li x31, 0x80186589           // t6
    // INSTRUCTION ({'dep': {'x16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x12', 'x16', 'f7'}})
...
f7                  0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
s2(x18)             0x000000008000031d(2147484445)                  0x000000008000031d(2147484445)                  
s3(x19)             0x0000000000000043(67)                          0x0000000000000043(67)                          
s4(x20)             0x0000000080180727(2149058343)                  0x0000000080180727(2149058343)                  
s5(x21)             0x00000000800000bb(2147483835)                  0x00000000800000bb(2147483835)                  
s6(x22)             0x00000000413bb000(1094430720)                  0x00000000413bb000(1094430720)                  
s7(x23)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s8(x24)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s9(x25)             0x00000000000010c0(4288)                        0x00000000000010c0(4288)                        
s10(x26)            0x000000007ffffeec(2147483372)                  0x000000007ffffeec(2147483372)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            93b47eea6d9f19e46719abd78e577f015011498b        93b47eea6d9f19e46719abd78e577f015011498b        
