# FailID_002470 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x12, 0x800001d3           // a2
    li x13, 0x80000273           // a3
    li x14, 0x10                 // a4
    li x15, 0x0                  // a5
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x6', 'f20'}, 'clob': {'x17', 'x6'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, xe3, x6
t1(x6)              0x00000000802800df(2150105311)                  0x00000000802800df(2150105311)
...
a7(x17)             0x00000000801800e3(2149056739)                  0x00000000801800e3(2149056739)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1b9c0a0f83f4a0aec796008a259665dade933746        1b9c0a0f83f4a0aec796008a259665dade933746        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        505c0def96b1548689ad4d0018f7c4cd969c59fa        X
