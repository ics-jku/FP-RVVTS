# FailID_002604 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f24:.byte 0x00,0x30,0x71,0x35,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f24
    fld  f24, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.d x2, f24, rtz
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x2, f24, rtz
+========================================================================================================================+
...
Registers: x2, f24
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f24                 0xffffffff35713000(8.984934538602829e-07_s)     0xffffffff35713000(8.984934538602829e-07_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            30051bb60055de04027df6d2194c6fc6d75af016        30051bb60055de04027df6d2194c6fc6d75af016        
