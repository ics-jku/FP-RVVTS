# FailID_004163 VP++ SF neg RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x12,0x78,0x66,0x0d,0xb3,0x84,0xa2,0xc3
_reg_f14:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f16'}, 'clob': {'f1'}})
    fmin.s f1, f14, f16
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f1                  0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f14, f16
f1                  0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
f14                 0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            edc4910d139af9391db513f2ecb8fc39378c85d4        edc4910d139af9391db513f2ecb8fc39378c85d4        
