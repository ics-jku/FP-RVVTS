# FailID_005290 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x0f,0xd0,0xff,0xce,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f17'}, 'clob': {'f3'}})
    fmax.s f3, f0, f17
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffffceffd00f(-2145912704.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, f0, f17
f0                  0xffffffffceffd00f(-2145912704.0_s)             0xffffffffceffd00f(-2145912704.0_s)
f3                  0xffffffffceffd00f(-2145912704.0_s)             0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3b50959ee7ad2d1fc70815b9a19e32b6bcb5e88b        3b50959ee7ad2d1fc70815b9a19e32b6bcb5e88b        
