# FailID_005445 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x07,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f25'}, 'clob': {'f0'}})
    fmin.s f0, f25, f14
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e16e57be1d092bdcdcd87040b4385d16f6e1810f        e16e57be1d092bdcdcd87040b4385d16f6e1810f        
