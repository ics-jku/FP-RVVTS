# FailID_005339 VP++ SF pos RV64 fmin.d
...
_reg_f24:.byte 0x97,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f26:.byte 0x00,0x00,0x00,0x00,0x00,0x74,0x9f,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f26'}})
    fmin.d f26, f24, f4
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x0000000000000097(7.46e-322_d)                 0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
f26                 0x0000000000000097(7.46e-322_d)                 0xffffffffffc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f24, f4
f4                  0xffffffffffc00000(nan_s)                       0xffffffffffc00000(nan_s)
f24                 0x0000000000000097(7.46e-322_d)                 0x0000000000000097(7.46e-322_d)
f26                 0x0000000000000097(7.46e-322_d)                 0xffffffffffc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5dbc5fcc4c1a61c6cb5fdc840feeb41eda9fb4af        5dbc5fcc4c1a61c6cb5fdc840feeb41eda9fb4af        
