# FailID_004199 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm'}, 'clob': {'x13'}})
    fmv.x.h x13, f21
```
...
```
REG                 REF                                             DUT                                             DIFF
a3(x13)             0x00000000000016b0(5808)                        0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7aae48eee45b053813c9f77f6bb9dff9f56f8295        7aae48eee45b053813c9f77f6bb9dff9f56f8295        
