# FailID_002834 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f26:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f26
    fld  f26, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f26', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x6'}})
    fcvt.wu.d x6, f26, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
t1(x6)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x6, f26, rne
+========================================================================================================================+
...
Registers: x6, f26
t1(x6)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f26                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff2140006f(6.505270420568022e-19_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3b3e232a27dad67adc513917f115e0ae638e5e0a        3b3e232a27dad67adc513917f115e0ae638e5e0a        
