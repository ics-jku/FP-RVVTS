# FailID_005314 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0xc0,0x63,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f2'}})
    fmax.s f2, f19, f13
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            98e3f7c464c1d8f6f7869e989779b4ff970b55c2        98e3f7c464c1d8f6f7869e989779b4ff970b55c2        
