# FailID_002414 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x31, 0x8f                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs', 'f2'}, 'clob': {'x2', 'x30'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4eecebc793133335dca025bb043c802833655ddc        4eecebc793133335dca025bb043c802833655ddc        
