# FailID_002054 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x28, 0x8000064a           // t3
    li x29, 0x4000035b           // t4
    li x30, 0x8017f8f6           // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f24', 'x3'}, 'clob': {'x10', 'x3'}})
...
fp(x8)              0x000000008016d949(2148981065)                  0x000000008016d949(2148981065)                  
s1(x9)              0x0000000000000000(0)                           0x0000000000000000(0)                           
a0(x10)             0x000000008018028d(2149057165)                  0x000000008018028d(2149057165)                  
...
s9(x25)             0x000000007ffff949(2147481929)                  0x000000007ffff949(2147481929)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            524bdda4e4181ece01b9391170986055d4933471        524bdda4e4181ece01b9391170986055d4933471        
