# FailID_004142 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f2'}, 'clob': {'f1'}})
    fmax.s f1, f0, f2
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff4f0017fd(2149055744.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            157b82895e2c1f1989a2f4d1c8b9614460570535        157b82895e2c1f1989a2f4d1c8b9614460570535        
