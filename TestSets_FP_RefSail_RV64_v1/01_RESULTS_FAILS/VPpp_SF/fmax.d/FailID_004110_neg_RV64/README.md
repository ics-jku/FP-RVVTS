# FailID_004110 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f13', 'fcsr.rm'}, 'clob': {'f24'}})
    fmax.d f24, f17, f13
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x3ff0000000000000(1.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f17, f13
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            45ba26998b80e976f577478c5643c51b8bb76407        45ba26998b80e976f577478c5643c51b8bb76407        
