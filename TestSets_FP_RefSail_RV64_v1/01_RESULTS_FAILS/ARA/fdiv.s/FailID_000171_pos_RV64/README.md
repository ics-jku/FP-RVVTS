# FailID_000171 ARA pos RV64 fdiv.s
...
_reg_f15:.byte 0x00,0x00,0x40,0xb9,0xff,0x02,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f10'}})
    fdiv.s f10, f21, f15, rne
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f10, f21, f15, rne
+========================================================================================================================+
...
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f21, f15
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f15                 0x41e002ffb9400000(2149055946.0_d)              0x41e002ffb9400000(2149055946.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            227ba9c7cab61d87afb3c44f24a305c9e59707ef        227ba9c7cab61d87afb3c44f24a305c9e59707ef        
