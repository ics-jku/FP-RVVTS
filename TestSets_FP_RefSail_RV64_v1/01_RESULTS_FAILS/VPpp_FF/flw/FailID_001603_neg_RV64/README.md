# FailID_001603 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x18, 0x6000               // s2
    li x19, 0x8017fb1d           // s3
    li x20, 0x340191f3           // s4
    li x21, 0x1                  // s5
    li x22, 0x0                  // s6
    li x23, 0x7ffffe78           // s7
    li x24, 0x23                 // s8
    li x25, 0x8027fad1           // s9
    li x26, 0x8017fe4c           // s10
    li x27, 0x6000               // s11
    li x28, 0x7ffffd3a           // t3
    li x29, 0x801ffcba           // t4
    li x30, 0x8017fcd1           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x13', 'mstatus.fs/vs.fs'}, 'clob': {'x13', 'x5', 'f3'}})
...
f3                  0xffffffff4f0017fd(2149055744.0_s)              0xffffffff340191f3(1.2067157229012082e-07_s)    X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, x5, x13
t0(x5)              0x000000007fffffa5(2147483557)                  0x000000007fffffa5(2147483557)
...
a0(x10)             0x000000007ffffe10(2147483152)                  0x000000007ffffe10(2147483152)                  
...
s3(x19)             0x000000008017fb1d(2149055261)                  0x000000008017fb1d(2149055261)                  
...
s7(x23)             0x000000007ffffe78(2147483256)                  0x000000007ffffe78(2147483256)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            31c076352be540786902131094572adab23d51c6        31c076352be540786902131094572adab23d51c6        
