# FailID_002928 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0x1d,0x97,0xff,0x6d,0xe6,0xd7,0x20,0x07
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x1'}})
    fcvt.wu.s x1, f18, rdn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
ra(x1)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x1, f18, rdn
+========================================================================================================================+
...
Registers: x1, f18
ra(x1)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f18                 0x0720d7e66dff971d(2.432443074559401e-274_d)    0x0720d7e66dff971d(2.432443074559401e-274_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e10cfb88934ebda6d41f2d03499e202146f2131f        e10cfb88934ebda6d41f2d03499e202146f2131f        
