# FailID_000505 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
_reg_f30:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f30'}})
    fsqrt.s f30, f2
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f2
f2                  0x8000000000000000(-0.0_d)                      0x8000000000000000(-0.0_d)
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5ab05e40da004961080d5515f327f654d80e4505        5ab05e40da004961080d5515f327f654d80e4505        
