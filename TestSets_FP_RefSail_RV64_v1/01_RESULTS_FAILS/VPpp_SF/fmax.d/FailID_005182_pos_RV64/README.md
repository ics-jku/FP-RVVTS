# FailID_005182 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f31'}, 'clob': {'f31'}})
    fmax.d f31, f31, f5
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2fb8638431ca100dc200783f0c779ecccf5c9caa        2fb8638431ca100dc200783f0c779ecccf5c9caa        
