# FailID_005333 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f2'}, 'clob': {'f2'}})
    fmin.d f2, f26, f2
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x000000132140006f(4.05935308646e-313_d)        0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            88e51896f60e0db813ec4133034e4a4859177616        88e51896f60e0db813ec4133034e4a4859177616        
