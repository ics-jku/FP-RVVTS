# FailID_003814 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x22, 0x16                 // s6
    li x23, 0x98                 // s7
    li x24, 0xce1e1750           // s8
    li x25, 0x7dc5e748           // s9
    li x26, 0x6000               // s10
    li x27, 0x80000838           // s11
    li x28, 0x8000073c           // t3
    li x29, 0x8018019c           // t4
    li x30, 0x7fffff1e           // t5
    li x31, 0xfb8bce90000        // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x13', 'x19', 'f29'}})
...
f29                 0x41e0000046800000(2147484212.0_d)              0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f29                 0x41e0000046800000(2147484212.0_d)              0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, x675, x19
s3(x19)             0x0000000080000675(2147485301)                  0x0000000080000675(2147485301)
f29                 0x41e0000046800000(2147484212.0_d)              0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
a3(x13)             0x0000000080000675(2147485301)                  0x0000000080000675(2147485301)                  
...
s8(x24)             0x00000000ce1e1750(3458078544)                  0x00000000ce1e1750(3458078544)                  
s9(x25)             0x000000007dc5e748(2110121800)                  0x000000007dc5e748(2110121800)                  
...
t4(x29)             0x000000008018019c(2149056924)                  0x000000008018019c(2149056924)                  
t5(x30)             0x000000007fffff1e(2147483422)                  0x000000007fffff1e(2147483422)                  
t6(x31)             0x00000fb8bce90000(17286117785600)              0x00000fb8bce90000(17286117785600)              

STATE               REF                                             DUT                                             DIFF
xmemhash            98013b5f5dc2ae501f13134686818bb5a981b977        98013b5f5dc2ae501f13134686818bb5a981b977        
