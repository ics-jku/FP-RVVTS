# FailID_000270 ARA pos RV64 fdiv.s
...
_reg_f15:.byte 0x05,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f15'}})
    fdiv.s f15, f15, f5, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f15, f5, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7d4f804e62a4e2bb2cd162dbc439d137bfd527dd        7d4f804e62a4e2bb2cd162dbc439d137bfd527dd        
