# FailID_002936 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0xa0,0x27,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x23'}})
    fcvt.wu.s x23, f3
```
...
Registers: x23, f3
s7(x23)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f3                  0x41e0030027a00000(2149056829.0_d)              0x41e0030027a00000(2149056829.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            109005c52863865d6c5f161545ce30b5266ada42        109005c52863865d6c5f161545ce30b5266ada42        
