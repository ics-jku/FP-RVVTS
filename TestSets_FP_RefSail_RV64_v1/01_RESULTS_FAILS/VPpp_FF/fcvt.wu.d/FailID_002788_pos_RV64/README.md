# FailID_002788 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x80,0xff,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f7', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x22'}})
    fcvt.wu.d x22, f7, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x22, f7, rne
+========================================================================================================================+
...
Registers: x22, f7
s6(x22)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f7                  0xffffffff4eff8000(2143289344.0_s)              0xffffffff4eff8000(2143289344.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            24b97dc97d4c47bd3ae0d52b360a52a69cacc1af        24b97dc97d4c47bd3ae0d52b360a52a69cacc1af        
