# FailID_003164 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x00,0x00,0x00,0x00,0x00,0x08,0xe0,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.s x9, f6, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x9, f6, rmm
+========================================================================================================================+
...
Registers: x9, f6
s1(x9)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f6                  0xc1e0080000000000(-2151677952.0_d)             0xc1e0080000000000(-2151677952.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d10911bcadad432e265f379f43c0ff114e6ab3c9        d10911bcadad432e265f379f43c0ff114e6ab3c9        
