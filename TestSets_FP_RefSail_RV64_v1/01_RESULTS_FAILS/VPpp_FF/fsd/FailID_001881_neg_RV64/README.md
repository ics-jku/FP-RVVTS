# FailID_001881 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x6000                // fp
    li x9, 0x800007ed            // s1
    li x10, 0x7c449774           // a0
    li x11, 0x80000056           // a1
    li x12, 0x0                  // a2
    li x13, 0x7fc00000           // a3
    li x14, 0x80080334           // a4
    li x15, 0x8017fccf           // a5
    ...
    li x22, 0x0                  // s6
    li x23, 0x0                  // s7
    li x24, 0xffffffff7fe85630   // s8
    li x25, 0x800000bb           // s9
    li x26, 0x80000056           // s10
    li x27, 0x15800000000        // s11
    li x28, 0x8017fd28           // t3
    li x29, 0x8027f6bf           // t4
    li x30, 0x80180362           // t5
    li x31, 0x801800df           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x12', 'mstatus.fs/vs.fs', 'f1'}, 'clob': {'x12', 'x7'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, x297, x12
a2(x12)             0x0000000080180297(2149057175)                  0x0000000080180297(2149057175)
...
t2(x7)              0x0000000080180297(2149057175)                  0x0000000080180297(2149057175)                  
fp(x8)              0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s1(x9)              0x00000000800007ed(2147485677)                  0x00000000800007ed(2147485677)                  
a0(x10)             0x000000007c449774(2084870004)                  0x000000007c449774(2084870004)                  
...
a4(x14)             0x0000000080080334(2148008756)                  0x0000000080080334(2148008756)                  
...
s8(x24)             0xffffffff7fe85630(18446744071560517168)        0xffffffff7fe85630(18446744071560517168)        
s9(x25)             0x00000000800000bb(2147483835)                  0x00000000800000bb(2147483835)                  
s10(x26)            0x0000000080000056(2147483734)                  0x0000000080000056(2147483734)                  
s11(x27)            0x0000015800000000(1477468749824)               0x0000015800000000(1477468749824)               
...
STATE               REF                                             DUT                                             DIFF
xmemhash            368977d6be8d5142aad29d8d41e9f7018867f4a5        368977d6be8d5142aad29d8d41e9f7018867f4a5        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        62ca3486298f70a21f191cd85cef9af4c6a0ac08        X
