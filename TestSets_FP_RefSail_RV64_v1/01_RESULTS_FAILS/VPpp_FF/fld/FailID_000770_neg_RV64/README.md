# FailID_000770 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x11, 0x80180b27           // a1
    li x12, 0x7ffffc80           // a2
    li x13, 0x6000               // a3
    li x14, 0x801865ff           // a4
    li x15, 0x7fffffff           // a5
    li x16, 0x0                  // a6
    li x17, 0xfffffffffffff97a   // a7
    li x18, 0x1                  // s2
    li x19, 0x7ffffcfa           // s3
    li x20, 0x8020032a           // s4
    li x21, 0x7fffffffffffffff   // s5
    li x22, 0x80180329           // s6
    li x23, 0x7fc00000           // s7
    li x24, 0xffffffff7fd81f15   // s8
    li x25, 0x801800eb           // s9
    li x26, 0x0                  // s10
    li x27, 0x8018046e           // s11
    li x28, 0x400c01f3800000     // t3
    li x29, 0x7ffffde2           // t4
    li x30, 0x80180029           // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'f16', 'x20', 'x28'}})
...
f16                 0xc1a9000000000000(-209715200.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
f16                 0xc1a9000000000000(-209715200.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, x124, x28
t3(x28)             0x000000007ffffedc(2147483356)                  0x000000007ffffedc(2147483356)
f16                 0xc1a9000000000000(-209715200.0_d)              0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
ra(x1)              0x000000008027e00a(2150096906)                  0x000000008027e00a(2150096906)                  
sp(x2)              0xffffffff003fffff(18446744069418778623)        0xffffffff003fffff(18446744069418778623)        
gp(x3)              0x000000008018607a(2149081210)                  0x000000008018607a(2149081210)                  
tp(x4)              0x0000000000000001(1)                           0x0000000000000001(1)                           
t0(x5)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t1(x6)              0x0000000080000816(2147485718)                  0x0000000080000816(2147485718)                  
t2(x7)              0x00000000801803e7(2149057511)                  0x00000000801803e7(2149057511)                  
fp(x8)              0x000000007ffff87d(2147481725)                  0x000000007ffff87d(2147481725)                  
s1(x9)              0x0000000000000080(128)                         0x0000000000000080(128)                         
a0(x10)             0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
a1(x11)             0x0000000080180b27(2149059367)                  0x0000000080180b27(2149059367)                  
...
a5(x15)             0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
...
s4(x20)             0x000000007ffffedc(2147483356)                  0x000000007ffffedc(2147483356)                  
...
s8(x24)             0xffffffff7fd81f15(18446744071559454485)        0xffffffff7fd81f15(18446744071559454485)        
s9(x25)             0x00000000801800eb(2149056747)                  0x00000000801800eb(2149056747)                  
s10(x26)            0x0000000000000000(0)                           0x0000000000000000(0)                           
s11(x27)            0x000000008018046e(2149057646)                  0x000000008018046e(2149057646)                  
t3(x28)             0x000000007ffffedc(2147483356)                  0x000000007ffffedc(2147483356)                  
t4(x29)             0x000000007ffffde2(2147483106)                  0x000000007ffffde2(2147483106)                  
t5(x30)             0x0000000080180029(2149056553)                  0x0000000080180029(2149056553)                  
t6(x31)             0x0000000000000200(512)                         0x0000000000000200(512)                         

STATE               REF                                             DUT                                             DIFF
xmemhash            a06cd36dcfe0d816448b93d39125b8d10a97167e        a06cd36dcfe0d816448b93d39125b8d10a97167e        
