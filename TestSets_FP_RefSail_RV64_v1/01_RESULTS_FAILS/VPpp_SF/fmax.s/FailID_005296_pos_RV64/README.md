# FailID_005296 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f29'}, 'clob': {'f12'}})
    fmax.s f12, f23, f29
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff00000000(0.0_s)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f12, f23, f29
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            599ded8ea492a818eefc8a7346a6e4d7ca41c6fa        599ded8ea492a818eefc8a7346a6e4d7ca41c6fa        
