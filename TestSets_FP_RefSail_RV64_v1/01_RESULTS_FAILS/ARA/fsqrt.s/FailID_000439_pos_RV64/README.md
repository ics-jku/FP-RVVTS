# FailID_000439 ARA pos RV64 fsqrt.s
...
_reg_f25:.byte 0x00,0x00,0x00,0x45,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f17'}})
    fsqrt.s f17, f25, rne
```
...
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff423504f3(45.25483322143555_s)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f17, f25, rne
+========================================================================================================================+
...
Registers: f17, f25
f17                 0xffffffff7fc00000(nan_s)                       0xffffffff423504f3(45.25483322143555_s)         X
f25                 0x41e002ff45000000(2149055016.0_d)              0x41e002ff45000000(2149055016.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c860cc3c2dba1e4b2cdab2e7a54e98ad2ed1060a        c860cc3c2dba1e4b2cdab2e7a54e98ad2ed1060a        
