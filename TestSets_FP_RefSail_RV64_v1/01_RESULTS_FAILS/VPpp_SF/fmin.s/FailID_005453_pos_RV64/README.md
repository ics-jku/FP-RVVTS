# FailID_005453 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f22'}, 'clob': {'f12'}})
    fmin.s f12, f22, f28
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f12, f22, f28
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aedf764b1b79df5e7f2bc2c6d22b9b00a012a187        aedf764b1b79df5e7f2bc2c6d22b9b00a012a187        
