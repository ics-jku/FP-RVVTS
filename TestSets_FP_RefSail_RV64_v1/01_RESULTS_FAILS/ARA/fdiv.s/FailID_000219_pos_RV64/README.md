# FailID_000219 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_reg_f12:.byte 0xf6,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f16:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'f16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f11'}})
    fdiv.s f11, f16, f12, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff11c00076(3.029254283515365e-28_s)     0xffffffff11c00077(3.029254524256608e-28_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f11, f16, f12, rdn
+========================================================================================================================+
...
f11                 0xffffffff11c00076(3.029254283515365e-28_s)     0xffffffff11c00077(3.029254524256608e-28_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f16, f12
f11                 0xffffffff11c00076(3.029254283515365e-28_s)     0xffffffff11c00077(3.029254524256608e-28_s)     X
f12                 0xffffffff4efffff6(2147482368.0_s)              0xffffffff4efffff6(2147482368.0_s)
f16                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff2140006f(6.505270420568022e-19_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8452ebd640a3e56722c6edc7a3621d6fa34b77cf        8452ebd640a3e56722c6edc7a3621d6fa34b77cf        
