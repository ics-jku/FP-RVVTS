# FailID_004302 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'f31', 'fcsr.rm', 'x1', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'x29'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, x4, a1, x1
ra(x1)              0x00000000801806d1(2149058257)                  0x00000000801806d1(2149058257)
...
s2(x18)             0x000000007fffff86(2147483526)                  0x000000007fffff86(2147483526)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8b3bcab0450830da882cb5882ba11d6ccf845a5a        8b3bcab0450830da882cb5882ba11d6ccf845a5a        
