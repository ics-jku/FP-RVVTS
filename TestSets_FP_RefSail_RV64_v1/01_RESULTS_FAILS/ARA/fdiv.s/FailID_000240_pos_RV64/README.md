# FailID_000240 ARA pos RV64 fdiv.s
...
_reg_f30:.byte 0xb3,0xf9,0x17,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f30'}})
    fdiv.s f30, f23, f4, rdn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f30, f23, f4, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8568a0c6ef6e3eda0ec0a13badc12225d50b044e        8568a0c6ef6e3eda0ec0a13badc12225d50b044e        
