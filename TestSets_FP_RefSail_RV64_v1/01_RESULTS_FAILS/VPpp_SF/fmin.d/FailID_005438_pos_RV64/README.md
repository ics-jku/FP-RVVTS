# FailID_005438 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x36,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f5'}, 'clob': {'f26'}})
    fmin.d f26, f5, f11
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x4036000000000000(22.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f26                 0x4036000000000000(22.0_d)                      0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, f5, f11
f5                  0x4036000000000000(22.0_d)                      0x4036000000000000(22.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            98fe9f34514bf6898247300e26c6e501ed841b2e        98fe9f34514bf6898247300e26c6e501ed841b2e        
