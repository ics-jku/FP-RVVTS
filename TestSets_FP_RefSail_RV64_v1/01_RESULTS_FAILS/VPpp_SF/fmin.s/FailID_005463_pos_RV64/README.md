# FailID_005463 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'f6'}})
    fmin.s f6, f13, f22
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0xffffffff4f001ff4(2149577728.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d002282908f876d5313b8e778b3a4d683d7bf406        d002282908f876d5313b8e778b3a4d683d7bf406        
