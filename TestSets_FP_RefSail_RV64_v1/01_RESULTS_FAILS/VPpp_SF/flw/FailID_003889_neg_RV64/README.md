# FailID_003889 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x27, 0x93                 // s11
    li x28, 0x7ffff9ff           // t3
    li x29, 0x8000026a           // t4
    li x30, 0x6000               // t5
    li x31, 0x801808a3           // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'f13', 'x4'}})
...
f13                 0xde7c148023ae10ff(-1.4025431970955475e+147_d)  0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f13                 0xde7c148023ae10ff(-1.4025431970955475e+147_d)  0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x92, x1
ra(x1)              0x0000000080000c8e(2147486862)                  0x0000000080000c8e(2147486862)
f13                 0xde7c148023ae10ff(-1.4025431970955475e+147_d)  0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
t3(x28)             0x000000007ffff9ff(2147482111)                  0x000000007ffff9ff(2147482111)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            62cb7bd294dcceaea476de1caee58c869b5971b8        62cb7bd294dcceaea476de1caee58c869b5971b8        
