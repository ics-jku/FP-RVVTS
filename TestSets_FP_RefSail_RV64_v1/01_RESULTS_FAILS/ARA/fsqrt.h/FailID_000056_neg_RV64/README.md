# FailID_000056 ARA neg RV64 fsqrt.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f10'}, 'clob': {'f9'}})
    fsqrt.h f9, f10, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.h f9, f10, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            40b56bd13b5076eaffc33c67eabb54d373925de1        40b56bd13b5076eaffc33c67eabb54d373925de1        
