# FailID_005289 VP++ SF pos RV64 fmax.s
...
_reg_f8: .byte 0xd3,0xb2,0x05,0x0b,0x8a,0xf1,0xf6,0xf3
_reg_f24:.byte 0xf0,0x8b,0x3a,0xe2,0xeb,0x19,0x88,0x0b
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f8'}, 'clob': {'f24'}})
    fmax.s f24, f7, f8
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xffffffffcea20be9(-1359344768.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f8                  0xf3f6f18a0b05b2d3(-4.106731584204575e+250_d)   0xf3f6f18a0b05b2d3(-4.106731584204575e+250_d)
f24                 0xffffffffcea20be9(-1359344768.0_s)             0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d9f039a47bd0f404c03b15d701f0bb19bc085c9e        d9f039a47bd0f404c03b15d701f0bb19bc085c9e        
