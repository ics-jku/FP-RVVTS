# FailID_001009 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x20, 0x81                 // s4
    li x21, 0x1                  // s5
    li x22, 0x800fffeb           // s6
    li x23, 0x0                  // s7
    li x24, 0x80000623           // s8
    li x25, 0x3706c000           // s9
    li x26, 0x6000               // s10
    li x27, 0xffffffffb9349000   // s11
    li x28, 0x8018007d           // t3
    li x29, 0x7ffff9ca           // t4
    li x30, 0x7ffffcce           // t5
    li x31, 0x7ffff839           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'f20', 'x27', 'x29'}})
...
f20                 0x7fffffff7fc00000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f20                 0x7fffffff7fc00000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, x3, b8, x29
gp(x3)              0xffffffffffffffff(18446744073709551615)        0xffffffffffffffff(18446744073709551615)
t4(x29)             0x00000000801ff610(2149578256)                  0x00000000801ff610(2149578256)
f20                 0x7fffffff7fc00000(nan_d)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
ra(x1)              0x000000008017faf2(2149055218)                  0x000000008017faf2(2149055218)                  
...
a1(x11)             0x00000000801ffa99(2149579417)                  0x00000000801ffa99(2149579417)                  
...
s6(x22)             0x00000000800fffeb(2148532203)                  0x00000000800fffeb(2148532203)                  
s7(x23)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s8(x24)             0x0000000080000623(2147485219)                  0x0000000080000623(2147485219)                  
...
s11(x27)            0x000000007ffffc48(2147482696)                  0x000000007ffffc48(2147482696)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e95e4a71067c4d77b94588c7e83521b552602ae9        e95e4a71067c4d77b94588c7e83521b552602ae9        
