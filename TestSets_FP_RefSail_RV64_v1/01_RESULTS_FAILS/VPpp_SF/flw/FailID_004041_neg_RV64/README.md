# FailID_004041 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x26'}, 'clob': {'x27', 'f13', 'x26'}})
...
f13                 0x7ff8000000000000(nan_d)                       0xffffffff00600313(8.81731045305858e-39_s)      X
STATES DIFFER: True
```
...
ra(x1)              0xffffffffe6286000(18446744073275990016)        0xffffffffe6286000(18446744073275990016)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb4244ef78265aa0b72fad8aa248775e8be03f9f        fb4244ef78265aa0b72fad8aa248775e8be03f9f        
