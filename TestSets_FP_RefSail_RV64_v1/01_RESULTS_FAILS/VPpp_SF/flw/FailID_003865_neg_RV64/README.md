# FailID_003865 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x9, 0x1                   // s1
    li x10, 0x200                // a0
    li x11, 0x801803a7           // a1
    li x12, 0x8017fbf2           // a2
    li x13, 0x8017fc07           // a3
    li x14, 0x801800ee           // a4
    li x15, 0x80180583           // a5
    li x16, 0x8018010e           // a6
    li x17, 0x0                  // a7
    li x18, 0xbd                 // s2
    li x19, 0x1                  // s3
    ...
    li x25, 0x8018079d           // s9
    li x26, 0xd00647c            // s10
    li x27, 0x6000               // s11
    li x28, 0x80186088           // t3
    li x29, 0x6000               // t4
    li x30, 0xffd7f764           // t5
    li x31, 0x8017fc07           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x25'}, 'clob': {'f17', 'x25', 'x4'}})
...
f17                 0x00000000801800ee(1.061775111e-314_d)          0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f17                 0x00000000801800ee(1.061775111e-314_d)          0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x281, x25
s9(x25)             0x000000008018051b(2149057819)                  0x000000008018051b(2149057819)
f17                 0x00000000801800ee(1.061775111e-314_d)          0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
tp(x4)              0x000000007ffffd7f(2147483007)                  0x000000007ffffd7f(2147483007)                  
...
a1(x11)             0x00000000801803a7(2149057447)                  0x00000000801803a7(2149057447)                  
a2(x12)             0x000000008017fbf2(2149055474)                  0x000000008017fbf2(2149055474)                  
...
a6(x16)             0x000000008018010e(2149056782)                  0x000000008018010e(2149056782)                  
...
t5(x30)             0x00000000ffd7f764(4292343652)                  0x00000000ffd7f764(4292343652)                  
t6(x31)             0x000000008017fc07(2149055495)                  0x000000008017fc07(2149055495)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            7945e6162e2686af330f213fa9317b7746ddbfcc        7945e6162e2686af330f213fa9317b7746ddbfcc        
