# FailID_002515 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x7, 0x801802ee            // t2
    li x8, 0x0                   // fp
    li x9, 0xfffffffffffff93e    // s1
    li x10, 0x6000               // a0
    li x11, 0x0                  // a1
    li x12, 0x9caaa72c           // a2
    li x13, 0x7fffffc5           // a3
    li x14, 0x7ffffbb3           // a4
    li x15, 0x12                 // a5
    li x16, 0x6000               // a6
    li x17, 0x35                 // a7
    li x18, 0x8017f8ec           // s2
    li x19, 0x801ff404           // s3
    ...
    li x26, 0x71                 // s10
    li x27, 0xf4                 // s11
    li x28, 0xc2035748           // t3
    li x29, 0x801ffcba           // t4
    li x30, 0x8017fcd1           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'f0', 'x5', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4', 'x5'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fb278e873ad2074c9a90a3604fa9bf5aaea693c4        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, x654, x5
t0(x5)              0x00000000802805f8(2150106616)                  0x00000000802805f8(2150106616)
...
tp(x4)              0x0000000080180654(2149058132)                  0x0000000080180654(2149058132)                  
t0(x5)              0x00000000802805f8(2150106616)                  0x00000000802805f8(2150106616)                  
t1(x6)              0x000000007ffffcf1(2147482865)                  0x000000007ffffcf1(2147482865)                  
t2(x7)              0x00000000801802ee(2149057262)                  0x00000000801802ee(2149057262)                  
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0xfffffffffffff93e(18446744073709549886)        0xfffffffffffff93e(18446744073709549886)        
...
a3(x13)             0x000000007fffffc5(2147483589)                  0x000000007fffffc5(2147483589)                  
...
a7(x17)             0x0000000000000035(53)                          0x0000000000000035(53)                          
s2(x18)             0x000000008017f8ec(2149054700)                  0x000000008017f8ec(2149054700)                  
s3(x19)             0x00000000801ff404(2149577732)                  0x00000000801ff404(2149577732)                  
...
s8(x24)             0x0000000000000023(35)                          0x0000000000000023(35)                          
s9(x25)             0x000000008027fad1(2150103761)                  0x000000008027fad1(2150103761)                  
s10(x26)            0x0000000000000071(113)                         0x0000000000000071(113)                         
s11(x27)            0x00000000000000f4(244)                         0x00000000000000f4(244)                         
t3(x28)             0x00000000c2035748(3254998856)                  0x00000000c2035748(3254998856)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            052a04f658c11ff8c98d4ecf1452a6ea31336546        052a04f658c11ff8c98d4ecf1452a6ea31336546        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fb278e873ad2074c9a90a3604fa9bf5aaea693c4        X
