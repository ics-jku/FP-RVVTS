# FailID_000413 ARA pos RV64 fsqrt.s
...
_reg_f14:.byte 0xec,0x00,0x00,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f7'}})
    fsqrt.s f7, f14, rne
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f7, f14, rne
+========================================================================================================================+
...
f14                 0x00000000800000ec(1.060998012e-314_d)          0x00000000800000ec(1.060998012e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2cf8845f222d81a5e3f240d9a615f85b1ec90e82        2cf8845f222d81a5e3f240d9a615f85b1ec90e82        
