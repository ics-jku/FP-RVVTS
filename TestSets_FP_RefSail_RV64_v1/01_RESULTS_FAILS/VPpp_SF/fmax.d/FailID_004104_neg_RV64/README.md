# FailID_004104 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f29'}, 'clob': {'f24'}})
    fmax.d f24, f29, f10
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x14ae41177962cb34(4.601290157299096e-209_d)    0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f29, f10
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d02b936d1281dc20b9e6e89b97d7d39325023a20        d02b936d1281dc20b9e6e89b97d7d39325023a20        
