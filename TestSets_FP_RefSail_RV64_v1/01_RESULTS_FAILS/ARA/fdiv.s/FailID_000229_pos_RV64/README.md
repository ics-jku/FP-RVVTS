# FailID_000229 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x09,0x44,0xe2,0x4c,0xe2,0xe9,0x6a,0x40
_reg_f13:.byte 0x00,0x00,0x00,0x54,0xff,0x02,0x90,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'f30'}})
    fdiv.s f30, f12, f13, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff38624409(5.394596155383624e-05_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f30, f12, f13, rdn
+========================================================================================================================+
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff38624409(5.394596155383624e-05_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f12, f13
f12                 0x406ae9e24ce24409(215.30887455170185_d)        0x406ae9e24ce24409(215.30887455170185_d)
f13                 0x419002ff54000000(67157973.0_d)                0x419002ff54000000(67157973.0_d)
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff38624409(5.394596155383624e-05_s)     X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f9a9cbbd102a904209a1b3be5ea7f2ce05c15f53        f9a9cbbd102a904209a1b3be5ea7f2ce05c15f53        
