# FailID_000863 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x29, 0x261                // t4
    li x30, 0x8017ff01           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x20'}, 'clob': {'x12', 'f8', 'x20'}})
...
f8                  0xffffffff00000000(0.0_s)                       0x0071b8230061b423(1.577068631947372e-306_d)    X
STATES DIFFER: True
```
...
f8                  0xffffffff00000000(0.0_s)                       0x0071b8230061b423(1.577068631947372e-306_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x790, x20
s4(x20)             0x0000000080000890(2147485840)                  0x0000000080000890(2147485840)
f8                  0xffffffff00000000(0.0_s)                       0x0071b8230061b423(1.577068631947372e-306_d)    X
+========================================================================================================================+
```
...
s10(x26)            0x0000000080000025(2147483685)                  0x0000000080000025(2147483685)                  
...
t4(x29)             0x0000000000000261(609)                         0x0000000000000261(609)                         
t5(x30)             0x000000008017ff01(2149056257)                  0x000000008017ff01(2149056257)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            cf8aeb023c94d2e388e479ea3a893e972ff9d14e        cf8aeb023c94d2e388e479ea3a893e972ff9d14e        
