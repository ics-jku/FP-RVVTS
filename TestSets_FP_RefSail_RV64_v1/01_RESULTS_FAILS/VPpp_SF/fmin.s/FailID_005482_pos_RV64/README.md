# FailID_005482 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x98,0x41,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f25'}, 'clob': {'f0'}})
    fmin.s f0, f25, f16
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff801805e0(-2.2061594606821336e-39_s)   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            467b9bc703480ed8c86fc64abb8a5732e375d632        467b9bc703480ed8c86fc64abb8a5732e375d632        
