# FailID_005385 VP++ SF pos RV64 fmin.d
...
_reg_f16:.byte 0x00,0x00,0xe0,0x66,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f14', 'fcsr.rm'}, 'clob': {'f16'}})
    fmin.d f16, f3, f14
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x75c34497cd5be8e5(1.851576239328676e+259_d)    0xffffffff4eb266cc(1496540672.0_s)              X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            56854905f31c91bde2f55ad4ec5706dc100ec2bf        56854905f31c91bde2f55ad4ec5706dc100ec2bf        
