# FailID_004195 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'x29'}})
    fmv.x.h x29, f14
```
...
```
REG                 REF                                             DUT                                             DIFF
t4(x29)             0xffffffffffffb00b(18446744073709531147)        0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7d3a3be8366a7f45802000a83e36452301b800a2        7d3a3be8366a7f45802000a83e36452301b800a2        
