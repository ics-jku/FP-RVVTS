# FailID_005215 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f24:.byte 0xff,0xff,0xff,0x7f,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f29'}, 'clob': {'f24'}})
    fmax.d f24, f29, f30
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f29, f30
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fa209459c1182593411983dc25580acadadae00d        fa209459c1182593411983dc25580acadadae00d        
