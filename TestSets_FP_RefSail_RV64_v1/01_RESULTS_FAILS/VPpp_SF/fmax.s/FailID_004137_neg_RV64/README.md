# FailID_004137 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f8'}, 'clob': {'f24'}})
    fmax.s f24, f30, f8
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0a7a8bb4a69820dc97b59e25b3156d52a570a64b        0a7a8bb4a69820dc97b59e25b3156d52a570a64b        
