# FailID_000516 ARA pos RV64 fsqrt.s
...
_reg_f11:.byte 0x00,0x60,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f11'}})
    fsqrt.s f11, f1
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            187b2e28a9ba5c6416934e9e2433a2d0c06ea480        187b2e28a9ba5c6416934e9e2433a2d0c06ea480        
