# FailID_003588 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x15, 0x0                  // a5
    li x16, 0x7ffffe43           // a6
    li x17, 0x801fff27           // a7
    li x18, 0x0                  // s2
    li x19, 0x8020d288           // s3
    li x20, 0x80180230           // s4
    li x21, 0x8017fe9f           // s5
    li x22, 0x6000               // s6
    li x23, 0x80000612           // s7
    li x24, 0x80180288           // s8
    li x25, 0x801a0a46           // s9
    li x26, 0x80280431           // s10
    li x27, 0x80186869           // s11
    li x28, 0x8017fc52           // t3
    li x29, 0x80180432           // t4
    li x30, 0xe6                 // t5
    li x31, 0xffffffff003ffe43   // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm'}, 'clob': {'f16', 'x29', 'x20'}})
...
f16                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f16                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, x282, x29
t4(x29)             0x00000000801801b0(2149056944)                  0x00000000801801b0(2149056944)
f16                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
ra(x1)              0x000000000000001c(28)                          0x000000000000001c(28)                          
...
a6(x16)             0x000000007ffffe43(2147483203)                  0x000000007ffffe43(2147483203)                  
...
s4(x20)             0x000000007ffffd7e(2147483006)                  0x000000007ffffd7e(2147483006)                  
s5(x21)             0x000000008017fe9f(2149056159)                  0x000000008017fe9f(2149056159)                  
s6(x22)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s7(x23)             0x0000000080000612(2147485202)                  0x0000000080000612(2147485202)                  
s8(x24)             0x0000000080180288(2149057160)                  0x0000000080180288(2149057160)                  
...
t3(x28)             0x000000008017fc52(2149055570)                  0x000000008017fc52(2149055570)                  
t4(x29)             0x00000000801801b0(2149056944)                  0x00000000801801b0(2149056944)                  
t5(x30)             0x00000000000000e6(230)                         0x00000000000000e6(230)                         
t6(x31)             0xffffffff003ffe43(18446744069418778179)        0xffffffff003ffe43(18446744069418778179)        

STATE               REF                                             DUT                                             DIFF
xmemhash            bceeb62afe7e7751cdfba1836b099e02598b6477        bceeb62afe7e7751cdfba1836b099e02598b6477        
