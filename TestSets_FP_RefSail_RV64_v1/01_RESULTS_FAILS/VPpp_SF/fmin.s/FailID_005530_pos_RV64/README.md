# FailID_005530 VP++ SF pos RV64 fmin.s
...
_reg_f9: .byte 0x00,0x00,0x40,0x30,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f4'}, 'clob': {'f9'}})
    fmin.s f9, f4, f16
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            039174dfd2ce2e59aabde5965297546a108caae4        039174dfd2ce2e59aabde5965297546a108caae4        
