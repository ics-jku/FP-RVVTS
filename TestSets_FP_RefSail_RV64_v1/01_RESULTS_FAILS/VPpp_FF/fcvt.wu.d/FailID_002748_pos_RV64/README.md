# FailID_002748 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f16:.byte 0xcd,0x46,0x90,0x4c,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x21'}})
    fcvt.wu.d x21, f16, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x21, f16, rtz
+========================================================================================================================+
...
Registers: x21, f16
s5(x21)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f16                 0xffffffff4c9046cd(75642472.0_s)                0xffffffff4c9046cd(75642472.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c53be2ad24b855892294edaf481929f35dc1c22d        c53be2ad24b855892294edaf481929f35dc1c22d        
