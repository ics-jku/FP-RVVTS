# FailID_002708 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f30:.byte 0x00,0x00,0x00,0x45,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f30
    fld  f30, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x10'}})
    fcvt.wu.d x10, f30, rtz
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a0(x10)             0xffffffff8017fa28(18446744071563639336)        0x000000008017fa28(2149055016)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x10, f30, rtz
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x10, f30
a0(x10)             0xffffffff8017fa28(18446744071563639336)        0x000000008017fa28(2149055016)                  X
f30                 0x41e002ff45000000(2149055016.0_d)              0x41e002ff45000000(2149055016.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f343691bbf43688373436327c6c76abeced7878f        f343691bbf43688373436327c6c76abeced7878f        
