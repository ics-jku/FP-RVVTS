# FailID_004138 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f7', 'f28'}, 'clob': {'f31'}})
    fmax.s f31, f28, f7
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff49800000(1048576.0_s)                 0xffffffffffff7e00(nan_h)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ae691507a55a727969ecd85a9c811fcdcd735da        0ae691507a55a727969ecd85a9c811fcdcd735da        
