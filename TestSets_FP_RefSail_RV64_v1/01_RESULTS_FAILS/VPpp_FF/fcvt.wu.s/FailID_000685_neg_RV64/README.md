# FailID_000685 VP++ FF neg RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f23', 'mstatus.fs/vs.fs'}, 'clob': {'x29'}})
    fcvt.wu.s x29, f23
```
...
Registers: x29, f23
t4(x29)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f23                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6163d676f651ea85f2d0155fab1a2e21edcf2fe5        6163d676f651ea85f2d0155fab1a2e21edcf2fe5        
