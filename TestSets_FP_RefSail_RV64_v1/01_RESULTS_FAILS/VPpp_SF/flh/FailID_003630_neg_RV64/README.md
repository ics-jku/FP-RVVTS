# FailID_003630 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x20, 0x6000               // s4
    li x21, 0x85                 // s5
    li x22, 0x80003a5f           // s6
    li x23, 0x7ffff87f           // s7
    li x24, 0x80180701           // s8
    li x25, 0x14d                // s9
    li x26, 0x80000092           // s10
    li x27, 0x80000320           // s11
    li x28, 0x8018055a           // t3
    li x29, 0x200                // t4
    li x30, 0x1                  // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'f26', 'x24', 'x22'}})
...
f26                 0xc1e003005cc00000(-2149057254.0_d)             0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
sp(x2)              0x000000002c99d740(748279616)                   0x000000002c99d740(748279616)                   
gp(x3)              0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
tp(x4)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t0(x5)              0x000000008017fd4d(2149055821)                  0x000000008017fd4d(2149055821)                  
t1(x6)              0x0000000000800008(8388616)                     0x0000000000800008(8388616)                     
t2(x7)              0x0000000000000010(16)                          0x0000000000000010(16)                          
...
a1(x11)             0x0000000080005f9f(2147508127)                  0x0000000080005f9f(2147508127)                  
...
s6(x22)             0x0000000080000198(2147484056)                  0x0000000080000198(2147484056)                  
s7(x23)             0x000000007ffff87f(2147481727)                  0x000000007ffff87f(2147481727)                  
s8(x24)             0x0000000080180898(2149058712)                  0x0000000080180898(2149058712)                  
s9(x25)             0x000000000000014d(333)                         0x000000000000014d(333)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cbc7357928fba5875474c03a364c7ed9f0c5d1ec        cbc7357928fba5875474c03a364c7ed9f0c5d1ec        
