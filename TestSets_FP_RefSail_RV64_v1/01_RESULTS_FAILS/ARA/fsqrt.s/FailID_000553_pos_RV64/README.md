# FailID_000553 ARA pos RV64 fsqrt.s
...
_reg_f9: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xd8,0xc0
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f9', 'mstatus.fs/vs.fs'}, 'clob': {'f0'}})
    fsqrt.s f0, f9, rtz
```
...
Registers: f0, f9
f0                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f9                  0xc0d8000000000000(-24576.0_d)                  0xc0d8000000000000(-24576.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            56f7ca9544ac090356a0a673f50e6ac0123ce327        56f7ca9544ac090356a0a673f50e6ac0123ce327        
