# FailID_001049 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x26, 0x800004c7           // s10
    li x27, 0x8017fb11           // s11
    li x28, 0x80000047           // t3
    li x29, 0x801800c0           // t4
    li x30, 0x80200993           // t5
    li x31, 0x8017fb11           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x15'}, 'clob': {'x30', 'f16', 'x15'}})
...
f16                 0xc24c3cfc247529a5(-242564483306.32535_d)       0xfff0000000000000(-inf_d)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fld f16, -0x49c(x15)
+========================================================================================================================+
Attributes:  fcsr ['overflow', 'div-by-0', 'inexact'], special values ['inf']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
s6(x22)             0x00000000000000db(219)                         0x00000000000000db(219)                         
...
t6(x31)             0x000000008017fb11(2149055249)                  0x000000008017fb11(2149055249)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            0bf05fa835fe7cf1ea2fc1a0a1866e7b6b4ecc27        0bf05fa835fe7cf1ea2fc1a0a1866e7b6b4ecc27        
