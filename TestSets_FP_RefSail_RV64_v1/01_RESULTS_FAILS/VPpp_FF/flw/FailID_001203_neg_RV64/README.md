# FailID_001203 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x31, 0xdd                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x5', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'f6', 'x24'}})
...
f6                  0x0000000000000000(0.0_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            579447241c6c2ec55ff9b7628b5595866fec9dd9        579447241c6c2ec55ff9b7628b5595866fec9dd9        
