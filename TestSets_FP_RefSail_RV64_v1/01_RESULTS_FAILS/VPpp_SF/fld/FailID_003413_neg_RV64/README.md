# FailID_003413 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x13                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x11'}, 'clob': {'x11', 'f8', 'x2'}})
...
f8                  0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8e5fbdea1bb60ea91fd213c907ec20f48e5bc3ad        8e5fbdea1bb60ea91fd213c907ec20f48e5bc3ad        
