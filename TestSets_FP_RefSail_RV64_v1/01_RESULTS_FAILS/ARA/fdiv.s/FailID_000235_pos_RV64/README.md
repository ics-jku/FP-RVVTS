# FailID_000235 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x43,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f14'}})
    fdiv.s f14, f2, f14, rtz
```
...
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f14, f2, f14, rtz
+========================================================================================================================+
Attributes:  fcsr ['div-by-0'], special values ['nan', 'inf']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f2, f14
f2                  0xffffffff43000000(128.0_s)                     0xffffffff43000000(128.0_s)
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            49538a153a7978448163f2258268764f2787f1fe        49538a153a7978448163f2258268764f2787f1fe        
