# FailID_004157 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f20'}, 'clob': {'f26'}})
    fmin.d f26, f20, f6
```
...
STATE               REF                                             DUT                                             DIFF
f26                 0x0000000000000020(1.6e-322_d)                  0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5cf746d1de46cb1ad411a64ca34dc50cea5da65d        5cf746d1de46cb1ad411a64ca34dc50cea5da65d        
