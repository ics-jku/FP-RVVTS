# FailID_004182 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f16'}, 'clob': {'x3'}})
    fmv.x.h x3, f16
```
...
```
REG                 REF                                             DUT                                             DIFF
gp(x3)              0xffffffffffff9c84(18446744073709526148)        0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1fda3f15194b5a937fd6b0576706c57f07b2915b        1fda3f15194b5a937fd6b0576706c57f07b2915b        
