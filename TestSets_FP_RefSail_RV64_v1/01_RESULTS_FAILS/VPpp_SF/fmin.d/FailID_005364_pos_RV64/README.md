# FailID_005364 VP++ SF pos RV64 fmin.d
...
_reg_f8: .byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
_reg_f30:.byte 0x00,0x00,0x00,0x00,0x00,0xfe,0xdf,0x43
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f8', 'f30'}, 'clob': {'f3'}})
    fmin.d f3, f30, f8
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x43dffe0000000000(9.221120237041091e+18_d)     0xffffffff5f800000(1.8446744073709552e+19_s)    X
STATES DIFFER: True
```
...
Registers: f3, f30, f8
f3                  0x43dffe0000000000(9.221120237041091e+18_d)     0xffffffff5f800000(1.8446744073709552e+19_s)    X
f8                  0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff5f800000(1.8446744073709552e+19_s)
f30                 0x43dffe0000000000(9.221120237041091e+18_d)     0x43dffe0000000000(9.221120237041091e+18_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ed379e84a366326904539e2bd9dee5c85d31c6f8        ed379e84a366326904539e2bd9dee5c85d31c6f8        
