# FailID_002677 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'x18'}})
    fcvt.wu.d x18, f11
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            68d7ad165e65656e0241b0c96c9442407834f199        68d7ad165e65656e0241b0c96c9442407834f199        
