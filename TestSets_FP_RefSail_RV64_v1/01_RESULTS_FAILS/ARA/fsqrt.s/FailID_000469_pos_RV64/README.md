# FailID_000469 ARA pos RV64 fsqrt.s
...
_reg_f30:.byte 0x00,0x00,0x40,0x7d,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f4'}})
    fsqrt.s f4, f30, rtz
```
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff5e5db3d7(3.9938371745533133e+18_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f4, f30, rtz
+========================================================================================================================+
...
Registers: f4, f30
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff5e5db3d7(3.9938371745533133e+18_s)    X
f30                 0x41e002ff7d400000(2149055466.0_d)              0x41e002ff7d400000(2149055466.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            37779a53591caf004cfb59783ed948f2e3ebf93f        37779a53591caf004cfb59783ed948f2e3ebf93f        
