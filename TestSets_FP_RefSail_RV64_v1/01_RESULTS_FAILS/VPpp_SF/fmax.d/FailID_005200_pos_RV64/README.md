# FailID_005200 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f21:.byte 0x26,0xfc,0x1f,0x80,0xff,0xff,0xff,0xff
_reg_f27:.byte 0x00,0x02,0x00,0x00,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f21'}})
    fmax.d f21, f14, f27
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0x0000000000000001(5e-324_d)                    0xffffffff00000200(7.174648137343064e-43_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f21, f14, f27
+========================================================================================================================+
...
f21                 0x0000000000000001(5e-324_d)                    0xffffffff00000200(7.174648137343064e-43_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f21, f14, f27
f14                 0x0000000000000001(5e-324_d)                    0x0000000000000001(5e-324_d)
f21                 0x0000000000000001(5e-324_d)                    0xffffffff00000200(7.174648137343064e-43_s)     X
f27                 0xffffffff00000200(7.174648137343064e-43_s)     0xffffffff00000200(7.174648137343064e-43_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            19396649f6463b62ce4c4fb1442f11049e1bbc5e        19396649f6463b62ce4c4fb1442f11049e1bbc5e        
