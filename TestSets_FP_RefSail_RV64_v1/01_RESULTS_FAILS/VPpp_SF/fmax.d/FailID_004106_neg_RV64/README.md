# FailID_004106 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'f14', 'fcsr.rm'}, 'clob': {'f20'}})
    fmax.d f20, f21, f14
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x9045ca9370f68cbb(-2.807221684975501e-230_d)   0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f20, f21, f14
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c26828ddf33464a7bce7d9a1709722c4d9da71f5        c26828ddf33464a7bce7d9a1709722c4d9da71f5        
