# FailID_005307 VP++ SF pos RV64 fmax.s
...
_reg_f23:.byte 0x91,0x42,0xe3,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f4'}, 'clob': {'f3'}})
    fmax.s f3, f23, f4
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0xffffffffcee34291(-1906395264.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f23                 0xffffffffcee34291(-1906395264.0_s)             0xffffffffcee34291(-1906395264.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            79ac01ba25d3eb9653753e2a5276eb4dc925e46c        79ac01ba25d3eb9653753e2a5276eb4dc925e46c        
