# FailID_004490 VP++ SF neg RV64 fsd
...
_reg_f3: .byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    li x7, 0x80200436            // t2
    li x8, 0x801ff7b6            // fp
    li x9, 0xffffffff8885b000    // s1
    li x10, 0x1                  // a0
    li x11, 0x7ffffb16           // a1
    li x12, 0x200                // a2
    li x13, 0x8027f519           // a3
    li x14, 0x80180497           // a4
    li x15, 0x6000               // a5
    li x16, 0x10                 // a6
    li x17, 0x6000               // a7
    li x18, 0x800004ac           // s2
    li x19, 0xc3                 // s3
    li x20, 0x1                  // s4
    li x21, 0x6864d70c           // s5
    li x22, 0x6864d70c           // s6
    li x23, 0x0                  // s7
    li x24, 0x7fffffff           // s8
    li x25, 0x8017ffb1           // s9
    li x26, 0x200                // s10
    li x27, 0x0                  // s11
    li x28, 0x6000               // t3
    li x29, 0xffffffffaa000000   // t4
    li x30, 0x0                  // t5
    li x31, 0x800004ec           // t6
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'x18', 'mstatus.fs/vs.fs'}, 'clob': {'x18', 'x15'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        93e163d7efdc6992aed6def71edfdb177354611d        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, x629, x18
s2(x18)             0x000000008017fe7f(2149056127)                  0x000000008017fe7f(2149056127)
f3                  0x41dfffffffc00000(2147483647.0_d)              0x41dfffffffc00000(2147483647.0_d)
+========================================================================================================================+
```
...
ra(x1)              0x000000007ffffb8d(2147482509)                  0x000000007ffffb8d(2147482509)                  
...
t1(x6)              0x000000007ffff98d(2147481997)                  0x000000007ffff98d(2147481997)                  
t2(x7)              0x0000000080200436(2149581878)                  0x0000000080200436(2149581878)                  
fp(x8)              0x00000000801ff7b6(2149578678)                  0x00000000801ff7b6(2149578678)                  
s1(x9)              0xffffffff8885b000(18446744071705047040)        0xffffffff8885b000(18446744071705047040)        
...
a3(x13)             0x000000008027f519(2150102297)                  0x000000008027f519(2150102297)                  
a4(x14)             0x0000000080180497(2149057687)                  0x0000000080180497(2149057687)                  
...
s2(x18)             0x000000008017fe7f(2149056127)                  0x000000008017fe7f(2149056127)                  
s3(x19)             0x00000000000000c3(195)                         0x00000000000000c3(195)                         
s4(x20)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s5(x21)             0x000000006864d70c(1751439116)                  0x000000006864d70c(1751439116)                  
s6(x22)             0x000000006864d70c(1751439116)                  0x000000006864d70c(1751439116)                  
s7(x23)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s8(x24)             0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
s9(x25)             0x000000008017ffb1(2149056433)                  0x000000008017ffb1(2149056433)                  
...
t4(x29)             0xffffffffaa000000(18446744072266711040)        0xffffffffaa000000(18446744072266711040)        
t5(x30)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t6(x31)             0x00000000800004ec(2147484908)                  0x00000000800004ec(2147484908)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            10b7418fb82750382d01b4c8668e7c2ae2379658        10b7418fb82750382d01b4c8668e7c2ae2379658        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        93e163d7efdc6992aed6def71edfdb177354611d        X
