# FailID_000311 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xe0,0x43
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f0'}})
    fsqrt.s f0, f2
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            67f9f0336933312d116927c4e54d35f17cb4f809        67f9f0336933312d116927c4e54d35f17cb4f809        
