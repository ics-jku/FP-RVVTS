# FailID_005242 VP++ SF pos RV64 fmax.s
...
_reg_f15:.byte 0x59,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f6', 'fcsr.rm'}, 'clob': {'f10'}})
    fmax.s f10, f15, f6
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f10                 0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f15, f6
f6                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f10                 0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
f15                 0xffffffff4f000059(2147506432.0_s)              0xffffffff4f000059(2147506432.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d4f20e79f849f8e58337ebe558756458739da9a2        d4f20e79f849f8e58337ebe558756458739da9a2        
