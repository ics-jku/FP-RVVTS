# FailID_004151 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f26'}, 'clob': {'f19'}})
    fmin.d f19, f26, f10
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x0000000000000000(0.0_d)                       0x7fffffff7fc00000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f19, f26, f10
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            02e4f821d5a3fd62edf9e23371fcaceaa03086e3        02e4f821d5a3fd62edf9e23371fcaceaa03086e3        
