# FailID_003827 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0x8017fcb4           // a2
    li x13, 0x200                // a3
    li x14, 0x7fffffe2           // a4
    li x15, 0x40c58744           // a5
    li x16, 0xb4                 // a6
    li x17, 0x84                 // a7
    li x18, 0x0                  // s2
    li x19, 0x0                  // s3
    li x20, 0xffffffff9dbb2000   // s4
    li x21, 0x7ffffeb4           // s5
    li x22, 0x80180060           // s6
    li x23, 0x7fffffffffffffff   // s7
    li x24, 0xda212748           // s8
    li x25, 0x200                // s9
    li x26, 0x8017fcfe           // s10
    li x27, 0x7cb5f738           // s11
    li x28, 0x98                 // t3
    li x29, 0x7fffffffffffffff   // t4
    li x30, 0x6000               // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'x27', 'f13', 'x7'}})
...
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x57, x27
s11(x27)            0x000000008015f1ba(2148921786)                  0x000000008015f1ba(2148921786)
f13                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
gp(x3)              0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
...
t2(x7)              0x000000007ffffa82(2147482242)                  0x000000007ffffa82(2147482242)                  
...
a2(x12)             0x000000008017fcb4(2149055668)                  0x000000008017fcb4(2149055668)                  
a3(x13)             0x0000000000000200(512)                         0x0000000000000200(512)                         
a4(x14)             0x000000007fffffe2(2147483618)                  0x000000007fffffe2(2147483618)                  
a5(x15)             0x0000000040c58744(1086687044)                  0x0000000040c58744(1086687044)                  
a6(x16)             0x00000000000000b4(180)                         0x00000000000000b4(180)                         
a7(x17)             0x0000000000000084(132)                         0x0000000000000084(132)                         
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s4(x20)             0xffffffff9dbb2000(18446744072060870656)        0xffffffff9dbb2000(18446744072060870656)        
s5(x21)             0x000000007ffffeb4(2147483316)                  0x000000007ffffeb4(2147483316)                  
s6(x22)             0x0000000080180060(2149056608)                  0x0000000080180060(2149056608)                  
...
s11(x27)            0x000000008015f1ba(2148921786)                  0x000000008015f1ba(2148921786)                  
t3(x28)             0x0000000000000098(152)                         0x0000000000000098(152)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7c89358a45107505e840dd39fd51129f852ac797        7c89358a45107505e840dd39fd51129f852ac797        
