# FailID_000145 ARA pos RV64 fdiv.s
...
_reg_f17:.byte 0x00,0x00,0xc0,0xbe,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'f9', 'mstatus.fs/vs.fs'}, 'clob': {'f11'}})
    fdiv.s f11, f17, f9, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f11, f17, f9, rmm
+========================================================================================================================+
...
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f17, f9
f9                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f17                 0x41dffffebec00000(2147482363.0_d)              0x41dffffebec00000(2147482363.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6331f2a403dfafb64ebfc5c701ad470eb973627c        6331f2a403dfafb64ebfc5c701ad470eb973627c        
