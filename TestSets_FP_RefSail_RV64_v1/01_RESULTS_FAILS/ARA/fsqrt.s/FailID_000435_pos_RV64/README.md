# FailID_000435 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f21'}})
    fsqrt.s f21, f20, rup
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0xffffffff473504f4(46340.953125_s)              0xffffffff473504f3(46340.94921875_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f21, f20, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1b431abe13ebc6c162262989546acc382113148        a1b431abe13ebc6c162262989546acc382113148        
