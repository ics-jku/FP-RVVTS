# FailID_005316 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x07,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f29:.byte 0xe7,0x90,0x43,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f29', 'fcsr.rm', 'f22'}, 'clob': {'f7'}})
    fmax.s f7, f29, f22
```
...
STATE               REF                                             DUT                                             DIFF
f7                  0xffffffff4f4390e7(3281053440.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f7                  0xffffffff4f4390e7(3281053440.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, f29, f22
f7                  0xffffffff4f4390e7(3281053440.0_s)              0xffffffff7fc00000(nan_s)                       X
f22                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f29                 0xffffffff4f4390e7(3281053440.0_s)              0xffffffff4f4390e7(3281053440.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0fea47bdc87af89e3a3e6a4f055a4e1e08e206e2        0fea47bdc87af89e3a3e6a4f055a4e1e08e206e2        
