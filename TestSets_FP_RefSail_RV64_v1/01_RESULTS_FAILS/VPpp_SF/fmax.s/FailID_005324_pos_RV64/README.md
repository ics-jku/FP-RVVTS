# FailID_005324 VP++ SF pos RV64 fmax.s
...
_reg_f9: .byte 0xe2,0x09,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f6', 'fcsr.rm'}, 'clob': {'f9'}})
    fmax.s f9, f10, f6
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2cc657babc45bf40064985ccf0372921d4374a2f        2cc657babc45bf40064985ccf0372921d4374a2f        
