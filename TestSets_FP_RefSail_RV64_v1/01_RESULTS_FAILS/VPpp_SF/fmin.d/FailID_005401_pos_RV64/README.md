# FailID_005401 VP++ SF pos RV64 fmin.d
...
_reg_f18:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f2'}, 'clob': {'f18'}})
    fmin.d f18, f2, f0
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            002d109401e4626a5eacb4d5ccdb979866ca4765        002d109401e4626a5eacb4d5ccdb979866ca4765        
