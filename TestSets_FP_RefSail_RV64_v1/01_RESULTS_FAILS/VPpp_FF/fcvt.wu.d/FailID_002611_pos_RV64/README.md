# FailID_002611 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x25'}})
    fcvt.wu.d x25, f14, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x25, f14, dyn
+========================================================================================================================+
Attributes:  fcsr ['invalid'], special values ['nan'], precision mismatch ('d', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x25, f14
s9(x25)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f14                 0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8df182a52901785de9f0c600fa5cea3d1de58c93        8df182a52901785de9f0c600fa5cea3d1de58c93        
