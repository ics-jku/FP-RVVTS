# FailID_000272 ARA pos RV64 fdiv.s
...
_reg_f8: .byte 0x07,0x00,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f27:.byte 0x00,0x00,0xa0,0x0c,0xff,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f0'}})
    fdiv.s f0, f8, f27, rdn
```
...
f0                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f0, f8, f27, rdn
+========================================================================================================================+
Attributes:  fcsr ['overflow'], special values ['nan', 'inf', 'zero'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: f0, f8, f27
f0                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f8                  0xffffffff4f000007(2147485440.0_s)              0xffffffff4f000007(2147485440.0_s)
f27                 0x41e003ff0ca00000(2149578853.0_d)              0x41e003ff0ca00000(2149578853.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b0bec1b3476b120de43ade23e6c713d69386dbf0        b0bec1b3476b120de43ade23e6c713d69386dbf0        
