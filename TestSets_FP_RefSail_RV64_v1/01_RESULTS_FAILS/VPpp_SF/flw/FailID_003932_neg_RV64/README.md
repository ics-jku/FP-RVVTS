# FailID_003932 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x24, 0x0                  // s8
    li x25, 0xaaff744            // s9
    li x26, 0x800003ba           // s10
    li x27, 0x8027f468           // s11
    li x28, 0x542                // t3
    li x29, 0xf915b720           // t4
    li x30, 0x1002               // t5
    li x31, 0x800003ba           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x12', 'x19', 'f15'}})
...
a0(x10)             0x0000000080180643(2149058115)                  0x0000000080180643(2149058115)                  
...
s5(x21)             0x00000000000000c2(194)                         0x00000000000000c2(194)                         
...
s10(x26)            0x00000000800003ba(2147484602)                  0x00000000800003ba(2147484602)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            80dbfaf3ad759f62a386994ed5ad1457c4458468        80dbfaf3ad759f62a386994ed5ad1457c4458468        
