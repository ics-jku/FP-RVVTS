# FailID_000282 ARA pos RV64 fsqrt.d
...
_reg_f7: .byte 0x00,0x00,0xc0,0x04,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f5'}})
    fsqrt.d f5, f7, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x40e6a09e69db134f(46340.950421846115_d)        0x40e6a09e69db1350(46340.95042184612_d)         X
STATES DIFFER: True
```
...
Registers: f5, f7
f5                  0x40e6a09e69db134f(46340.950421846115_d)        0x40e6a09e69db1350(46340.95042184612_d)         X
f7                  0x41e0000004c00000(2147483686.0_d)              0x41e0000004c00000(2147483686.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4a5520ca7f4aef9a0d6a04ce93ad7a3ac253517b        4a5520ca7f4aef9a0d6a04ce93ad7a3ac253517b        
