# FailID_000785 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x23, 0x0                  // s7
    li x24, 0x0                  // s8
    li x25, 0x8017ff3d           // s9
    li x26, 0x801b7121           // s10
    li x27, 0x8022f3b8           // s11
    li x28, 0x80180334           // t3
    li x29, 0x3ffffffa000        // t4
    li x30, 0x7ffffd9f           // t5
    li x31, 0x8017fe9d           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x11'}, 'clob': {'f11', 'x11', 'x1'}})
...
f11                 0xc8084b6865ed41a3(-1.0333763714975547e+39_d)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f11                 0xc8084b6865ed41a3(-1.0333763714975547e+39_d)   0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, x16, x11
a1(x11)             0x00000000801ffd06(2149580038)                  0x00000000801ffd06(2149580038)
a6(x16)             0x0000000000000021(33)                          0x0000000000000021(33)
f11                 0xc8084b6865ed41a3(-1.0333763714975547e+39_d)   0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
t4(x29)             0x000003ffffffa000(4398046486528)               0x000003ffffffa000(4398046486528)               
...
STATE               REF                                             DUT                                             DIFF
xmemhash            362b2e6a3be9931d8e1f1f31202cfb67844d7c13        362b2e6a3be9931d8e1f1f31202cfb67844d7c13        
