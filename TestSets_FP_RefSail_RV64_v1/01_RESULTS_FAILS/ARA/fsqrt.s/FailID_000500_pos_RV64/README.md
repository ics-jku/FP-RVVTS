# FailID_000500 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0xdd,0x63,0xc2,0x2a,0x6a,0xff,0x69,0xd0
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f0'}})
    fsqrt.s f0, f22, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f0, f22, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3e0eca170dfa9111853472463ab89cbd4699a8c4        3e0eca170dfa9111853472463ab89cbd4699a8c4        
