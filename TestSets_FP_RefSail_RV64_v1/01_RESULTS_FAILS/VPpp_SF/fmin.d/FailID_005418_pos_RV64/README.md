# FailID_005418 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0xf0,0x02,0x18,0x80,0x00,0x00,0x00,0x00
_reg_f21:.byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f30:.byte 0x00,0x00,0xe0,0xd4,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f30'}})
    fmin.d f30, f6, f21
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0x00000000801802f0(1.061775365e-314_d)          0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f30                 0x00000000801802f0(1.061775365e-314_d)          0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f6, f21
f6                  0x00000000801802f0(1.061775365e-314_d)          0x00000000801802f0(1.061775365e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f01124586e92259e1dd03ab78c1be5054a5dc86c        f01124586e92259e1dd03ab78c1be5054a5dc86c        
