# FailID_004132 VP++ SF neg RV64 fmax.s
...
_reg_f27:.byte 0xf2,0x04,0x35,0x47,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f27'}, 'clob': {'f13'}})
    fmax.s f13, f27, f10
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffff473504f2(46340.9453125_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f13, f27, f10
+========================================================================================================================+
...
f13                 0xffffffff473504f2(46340.9453125_s)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, f27, f10
f10                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f13                 0xffffffff473504f2(46340.9453125_s)             0xffffffff7fc00000(nan_s)                       X
f27                 0xffffffff473504f2(46340.9453125_s)             0xffffffff473504f2(46340.9453125_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            57c8ebbc577214b802dd7286ce8234eddffca1a3        57c8ebbc577214b802dd7286ce8234eddffca1a3        
