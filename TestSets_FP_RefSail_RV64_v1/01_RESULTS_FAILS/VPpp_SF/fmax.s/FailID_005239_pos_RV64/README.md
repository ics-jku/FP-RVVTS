# FailID_005239 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0x01,0x00,0x00,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f16', 'fcsr.rm'}, 'clob': {'f13'}})
    fmax.s f13, f16, f20
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffffbf800000(-1.0_s)                      0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f13, f16, f20
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            61b46e2b9ca1ff74a58466c0b4342eb01150dcd9        61b46e2b9ca1ff74a58466c0b4342eb01150dcd9        
