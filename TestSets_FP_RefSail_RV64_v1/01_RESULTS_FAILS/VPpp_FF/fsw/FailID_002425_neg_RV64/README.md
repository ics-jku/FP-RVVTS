# FailID_002425 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x27, 0x8017fc99           // s11
    li x28, 0x30                 // t3
    li x29, 0x8018010f           // t4
    li x30, 0x8000017a           // t5
    li x31, 0x7fffffffffffffff   // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f11', 'mstatus.fs/vs.fs', 'x7'}, 'clob': {'x7', 'x27'}})
...
a3(x13)             0x000000008018010f(2149056783)                  0x000000008018010f(2149056783)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c8182fed1b9483ba850b8ae89a050f175591550f        c8182fed1b9483ba850b8ae89a050f175591550f        
