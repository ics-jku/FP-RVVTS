# FailID_001057 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x80200099            // fp
    li x9, 0x400                 // s1
    li x10, 0x802006ba           // a0
    li x11, 0x8027fc3e           // a1
    li x12, 0x0                  // a2
    li x13, 0x0                  // a3
    li x14, 0x0                  // a4
    li x15, 0x8028042a           // a5
    li x16, 0xc9599f6f           // a6
...
f30                 0xc1dff9ff38400000(-2145909985.0_d)             0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
fp(x8)              0x0000000080200099(2149580953)                  0x0000000080200099(2149580953)                  
s1(x9)              0x0000000000000400(1024)                        0x0000000000000400(1024)                        
a0(x10)             0x00000000802006ba(2149582522)                  0x00000000802006ba(2149582522)                  
...
a6(x16)             0x00000000c9599f6f(3378093935)                  0x00000000c9599f6f(3378093935)                  
...
s10(x26)            0x000000007fffff13(2147483411)                  0x000000007fffff13(2147483411)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ea6e617acda0ca3e874014131cd68735c783018        0ea6e617acda0ca3e874014131cd68735c783018        
