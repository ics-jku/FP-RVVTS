# FailID_004348 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x5, 0x7ffffff3            // t0
    li x6, 0x0                   // t1
    li x7, 0x41e0030003200000    // t2
    li x8, 0x80180490            // fp
    li x9, 0x7c                  // s1
    li x10, 0x7fffffffffffffff   // a0
    li x11, 0x6000               // a1
    li x12, 0x8018065e           // a2
    li x13, 0x80000723           // a3
    li x14, 0x7fffffffffffffff   // a4
    li x15, 0x8017fdf0           // a5
    li x16, 0x8017fb14           // a6
    li x17, 0x200                // a7
    li x18, 0x8018021a           // s2
    li x19, 0x5af                // s3
    li x20, 0x0                  // s4
    li x21, 0x80180138           // s5
    ...
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'f8', 'mstatus.fs/vs.fs'}, 'clob': {'x28', 'x5'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x543, x5
t0(x5)              0x0000000080280533(2150106419)                  0x0000000080280533(2150106419)
...
sp(x2)              0x00000000000000c2(194)                         0x00000000000000c2(194)                         
gp(x3)              0x0000000080000614(2147485204)                  0x0000000080000614(2147485204)                  
tp(x4)              0x00000000801ffd96(2149580182)                  0x00000000801ffd96(2149580182)                  
t0(x5)              0x0000000080280533(2150106419)                  0x0000000080280533(2150106419)                  
t1(x6)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t2(x7)              0x41e0030003200000(4746797305835814912)         0x41e0030003200000(4746797305835814912)         
fp(x8)              0x0000000080180490(2149057680)                  0x0000000080180490(2149057680)                  
s1(x9)              0x000000000000007c(124)                         0x000000000000007c(124)                         
...
a2(x12)             0x000000008018065e(2149058142)                  0x000000008018065e(2149058142)                  
a3(x13)             0x0000000080000723(2147485475)                  0x0000000080000723(2147485475)                  
a4(x14)             0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
a5(x15)             0x000000008017fdf0(2149055984)                  0x000000008017fdf0(2149055984)                  
a6(x16)             0x000000008017fb14(2149055252)                  0x000000008017fb14(2149055252)                  
a7(x17)             0x0000000000000200(512)                         0x0000000000000200(512)                         
s2(x18)             0x000000008018021a(2149057050)                  0x000000008018021a(2149057050)                  
s3(x19)             0x00000000000005af(1455)                        0x00000000000005af(1455)                        
s4(x20)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s5(x21)             0x0000000080180138(2149056824)                  0x0000000080180138(2149056824)                  
...
t3(x28)             0x0000000080180543(2149057859)                  0x0000000080180543(2149057859)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            323d4b32cb7196dafbe25a3fc3e96ea95b05bfc0        323d4b32cb7196dafbe25a3fc3e96ea95b05bfc0        
