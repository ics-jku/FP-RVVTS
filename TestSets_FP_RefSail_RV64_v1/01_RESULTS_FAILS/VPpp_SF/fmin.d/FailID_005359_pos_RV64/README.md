# FailID_005359 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f18', 'fcsr.rm'}, 'clob': {'f1'}})
    fmin.d f1, f18, f24
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c2a8a087398d4e6df51c7516b33b219ce16a9bea        c2a8a087398d4e6df51c7516b33b219ce16a9bea        
