# FailID_005546 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f8'}, 'clob': {'f8'}})
    fmin.s f8, f14, f8
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            552a3e3070aedd6610c599c86b846980fc57171c        552a3e3070aedd6610c599c86b846980fc57171c        
