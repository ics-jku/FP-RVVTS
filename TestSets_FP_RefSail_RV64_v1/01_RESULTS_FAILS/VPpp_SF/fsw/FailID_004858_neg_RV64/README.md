# FailID_004858 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x7, 0x7fffffed            // t2
    li x8, 0x80180376            // fp
    li x9, 0xffffffffa6131000    // s1
    li x10, 0x8017f917           // a0
    li x11, 0x8017f917           // a1
    li x12, 0x0                  // a2
    ...
    li x27, 0x8017fa31           // s11
    li x28, 0x4000               // t3
    li x29, 0x8000025f           // t4
    li x30, 0x7ffffce1           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f20'}, 'clob': {'x1', 'x9'}})
...
a1(x11)             0x000000008017f917(2149054743)                  0x000000008017f917(2149054743)                  
...
s7(x23)             0x0000000000000030(48)                          0x0000000000000030(48)                          
...
s11(x27)            0x000000008017fa31(2149055025)                  0x000000008017fa31(2149055025)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3f71113b720d3fb82753282bf834552702f9c1c6        3f71113b720d3fb82753282bf834552702f9c1c6        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        3cfc50187a9febfe44b5c11e592e549b5119bd02        X
