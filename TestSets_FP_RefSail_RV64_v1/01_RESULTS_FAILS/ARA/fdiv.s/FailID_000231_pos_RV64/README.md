# FailID_000231 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x30,0x56,0x6b,0xed,0x13,0x55,0xdf,0x81
_reg_f6: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f19:.byte 0xff,0xff,0x7f,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f6'}})
    fdiv.s f6, f5, f19, rne
```
...
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff2d6b5631(1.3377341769038598e-11_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f6, f5, f19, rne
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, f5, f19
f5                  0x81df5513ed6b5630(-1.1696531454119271e-299_d)  0x81df5513ed6b5630(-1.1696531454119271e-299_d)
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff2d6b5631(1.3377341769038598e-11_s)    X
f19                 0xffffffffff7fffff(-3.4028234663852886e+38_s)   0xffffffffff7fffff(-3.4028234663852886e+38_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1b00c59b1e89ceb29f49e38023d99bf2b266f3a        a1b00c59b1e89ceb29f49e38023d99bf2b266f3a        
