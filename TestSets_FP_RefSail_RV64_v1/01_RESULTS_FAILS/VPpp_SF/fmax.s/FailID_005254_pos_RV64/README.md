# FailID_005254 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x00,0x00,0x2c,0x79,0xd1,0x41
_reg_f9: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_reg_f19:.byte 0x60,0xc9,0x8b,0xca,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f9'}})
    fmax.s f9, f19, f4
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffffca8bc960(-4580528.0_s)                0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f19, f4
f4                  0x41d1792c00000000(1172615168.0_d)              0x41d1792c00000000(1172615168.0_d)
f9                  0xffffffffca8bc960(-4580528.0_s)                0xffffffff7fc00000(nan_s)                       X
f19                 0xffffffffca8bc960(-4580528.0_s)                0xffffffffca8bc960(-4580528.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            427559467438335ce3f500d8a43c65a014ff020b        427559467438335ce3f500d8a43c65a014ff020b        
