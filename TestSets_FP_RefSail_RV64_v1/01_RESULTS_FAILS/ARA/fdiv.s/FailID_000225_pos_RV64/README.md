# FailID_000225 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0x23,0xb4,0xb1,0x08,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'fcsr.rm', 'f5', 'mstatus.fs/vs.fs'}, 'clob': {'f19'}})
    fdiv.s f19, f5, f21, rup
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f19, f5, f21, rup
+========================================================================================================================+
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f5, f21
f5                  0xffffffff08b1b423(1.0695149943945156e-33_s)    0xffffffff08b1b423(1.0695149943945156e-33_s)
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ee7e3624cfdd81957f6b8779afe13523a2d758b7        ee7e3624cfdd81957f6b8779afe13523a2d758b7        
