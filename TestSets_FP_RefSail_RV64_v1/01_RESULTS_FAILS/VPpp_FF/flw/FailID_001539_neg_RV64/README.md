# FailID_001539 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x81                 // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'x4', 'f14', 'x23'}})
...
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff0671b423(4.5459405727248836e-35_s)    X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            82b939ccb86feaea0c51965f131380225c2037fb        82b939ccb86feaea0c51965f131380225c2037fb        
