# FailID_005327 VP++ SF pos RV64 fmax.s
...
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x40,0x5e,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f31'}, 'clob': {'f11'}})
    fmax.s f11, f31, f4
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cecaf141b9d330b2f17bb7d6891163aac64c3173        cecaf141b9d330b2f17bb7d6891163aac64c3173        
