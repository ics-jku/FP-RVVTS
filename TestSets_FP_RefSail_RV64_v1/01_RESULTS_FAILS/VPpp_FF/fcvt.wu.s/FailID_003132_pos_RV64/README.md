# FailID_003132 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x26,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x24'}})
    fcvt.wu.s x24, f0, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s8(x24)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x24, f0, rmm
+========================================================================================================================+
...
Registers: x24, f0
s8(x24)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f0                  0x0000000000000026(1.9e-322_d)                  0x0000000000000026(1.9e-322_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            99d5c4c10a3eb8b17a107034d4ac6ae112936ff5        99d5c4c10a3eb8b17a107034d4ac6ae112936ff5        
