# FailID_003629 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x30, 0x281b383            // t5
    li x31, 0x30                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x24', 'fcsr.rm'}, 'clob': {'x15', 'x24', 'f23'}})
...
f23                 0xffffffffffc00000(nan_s)                       0xffffffffffff8a93(-0.00020062923431396484_h)   X
STATES DIFFER: True
```
...
f23                 0xffffffffffc00000(nan_s)                       0xffffffffffff8a93(-0.00020062923431396484_h)   X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, x296, x24
s8(x24)             0x0000000080000966(2147486054)                  0x0000000080000966(2147486054)
f23                 0xffffffffffc00000(nan_s)                       0xffffffffffff8a93(-0.00020062923431396484_h)   X
+========================================================================================================================+
```
...
sp(x2)              0x000000008000005f(2147483743)                  0x000000008000005f(2147483743)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a2a73584975179d051218c2b7fabf195d767eeaf        a2a73584975179d051218c2b7fabf195d767eeaf        
