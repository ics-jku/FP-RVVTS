# FailID_004144 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f16', 'f1'}, 'clob': {'f8'}})
    fmin.d f8, f16, f1
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x41dffffe58000000(2147481952.0_d)              0xffffffff8017fd4f(-2.2030864131498693e-39_s)   X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b5c88be0d0b5e21a865e4adf198e6c07f0a6d7f4        b5c88be0d0b5e21a865e4adf198e6c07f0a6d7f4        
