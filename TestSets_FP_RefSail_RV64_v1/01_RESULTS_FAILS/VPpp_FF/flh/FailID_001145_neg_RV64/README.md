# FailID_001145 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x21'}, 'clob': {'f27', 'x21', 'x14'}})
...
f27                 0x40d8000000000000(24576.0_d)                   0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x486, x21
s5(x21)             0x000000007ffffb8e(2147482510)                  0x000000007ffffb8e(2147482510)
f27                 0x40d8000000000000(24576.0_d)                   0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bf375864f3b00b1522a8ed50eb221fa858a8058c        bf375864f3b00b1522a8ed50eb221fa858a8058c        
