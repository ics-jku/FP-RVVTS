# FailID_003000 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f29:.byte 0x00,0x00,0x80,0x42,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f29
    fld  f29, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f29', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f29, rdn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f29, rdn
+========================================================================================================================+
...
Registers: x2, f29
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f29                 0x7fffffff42800000(nan_d)                       0x7fffffff42800000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            39262a0ed1660e3b06b689bfd15c84994194112d        39262a0ed1660e3b06b689bfd15c84994194112d        
