# FailID_004139 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f13', 'fcsr.rm', 'f2'}, 'clob': {'f13'}})
    fmax.s f13, f13, f2
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffff46c00000(24576.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            610470295b5d1928430c7a10172437b8a42f3325        610470295b5d1928430c7a10172437b8a42f3325        
