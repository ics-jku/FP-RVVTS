# FailID_001465 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x7ffffd84            // fp
    li x9, 0x801ff28d            // s1
    li x10, 0x2005fe25000000     // a0
    li x11, 0x7ffff9c1           // a1
    li x12, 0x8017f92d           // a2
    li x13, 0x7ffff96b           // a3
    li x14, 0x7ffffa99           // a4
    li x15, 0x800005e9           // a5
    li x16, 0x8017fe75           // a6
    li x17, 0x0                  // a7
    ...
    li x24, 0x80039fd1           // s8
    li x25, 0x0                  // s9
    li x26, 0x8017f894           // s10
    li x27, 0x7ffffa9b           // s11
    li x28, 0x0                  // t3
    li x29, 0x8017fae7           // t4
    li x30, 0x8018fd15           // t5
    li x31, 0x10017f762          // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27'}, 'clob': {'x2', 'f3', 'x27'}})
...
f3                  0x41dffffe70400000(2147482049.0_d)              0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
ra(x1)              0x000000008017f8f1(2149054705)                  0x000000008017f8f1(2149054705)                  
sp(x2)              0x000000007fffffb6(2147483574)                  0x000000007fffffb6(2147483574)                  
gp(x3)              0x00000000801ffd5c(2149580124)                  0x00000000801ffd5c(2149580124)                  
tp(x4)              0x000000000000009f(159)                         0x000000000000009f(159)                         
t0(x5)              0x00000000801ff114(2149576980)                  0x00000000801ff114(2149576980)                  
t1(x6)              0x0000000080180583(2149057923)                  0x0000000080180583(2149057923)                  
t2(x7)              0x000000008020006c(2149580908)                  0x000000008020006c(2149580908)                  
...
a0(x10)             0x002005fe25000000(9013788355330048)            0x002005fe25000000(9013788355330048)            
...
a4(x14)             0x000000007ffffa99(2147482265)                  0x000000007ffffa99(2147482265)                  
a5(x15)             0x00000000800005e9(2147485161)                  0x00000000800005e9(2147485161)                  
...
s8(x24)             0x0000000080039fd1(2147721169)                  0x0000000080039fd1(2147721169)                  
s9(x25)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s10(x26)            0x000000008017f894(2149054612)                  0x000000008017f894(2149054612)                  
s11(x27)            0x00000000801ffa4e(2149579342)                  0x00000000801ffa4e(2149579342)                  
t3(x28)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t4(x29)             0x000000008017fae7(2149055207)                  0x000000008017fae7(2149055207)                  
t5(x30)             0x000000008018fd15(2149121301)                  0x000000008018fd15(2149121301)                  
t6(x31)             0x000000010017f762(4296537954)                  0x000000010017f762(4296537954)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            5584fc10c9f1b83c2bc951bdbb0a184dda5ef650        5584fc10c9f1b83c2bc951bdbb0a184dda5ef650        
