# FailID_005505 VP++ SF pos RV64 fmin.s
...
_reg_f17:.byte 0x00,0x00,0xf3,0x44,0xff,0xff,0xff,0xff
_reg_f30:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f2'}, 'clob': {'f30'}})
    fmin.s f30, f17, f2
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xffffffff44f30000(1944.0_s)                    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f30                 0xffffffff44f30000(1944.0_s)                    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f17, f2
f2                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f17                 0xffffffff44f30000(1944.0_s)                    0xffffffff44f30000(1944.0_s)
f30                 0xffffffff44f30000(1944.0_s)                    0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            13c9a209483f08e81e396315b11bd1ecc364855a        13c9a209483f08e81e396315b11bd1ecc364855a        
