# FailID_004141 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f1'}, 'clob': {'f10'}})
    fmax.s f10, f1, f6
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dfac42cc0f122620757baf611c27b60f4629a118        dfac42cc0f122620757baf611c27b60f4629a118        
