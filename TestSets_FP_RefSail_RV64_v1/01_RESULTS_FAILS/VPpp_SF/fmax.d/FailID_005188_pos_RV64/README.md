# FailID_005188 VP++ SF pos RV64 fmax.d
...
_reg_f4: .byte 0xfa,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f27:.byte 0x00,0x00,0x00,0x8d,0xff,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f3
    fld  f3, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f3'}})
    fmax.d f3, f27, f4
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x41dfffff8d000000(2147483188.0_d)              0xffffffff4efffffa(2147482880.0_s)              X
STATES DIFFER: True
```
...
Registers: f3, f27, f4
f3                  0x41dfffff8d000000(2147483188.0_d)              0xffffffff4efffffa(2147482880.0_s)              X
f4                  0xffffffff4efffffa(2147482880.0_s)              0xffffffff4efffffa(2147482880.0_s)
f27                 0x41dfffff8d000000(2147483188.0_d)              0x41dfffff8d000000(2147483188.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2eda35f94a5366849993b9d1ec15b43d7030136b        2eda35f94a5366849993b9d1ec15b43d7030136b        
