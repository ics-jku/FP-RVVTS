# FailID_003296 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x21, 0x7ffffbc5           // s5
    li x22, 0x8017fe12           // s6
    li x23, 0x0                  // s7
    li x24, 0x3b                 // s8
    li x25, 0x4f000              // s9
    li x26, 0x6000               // s10
    li x27, 0x8017f94d           // s11
    li x28, 0x801ff382           // t3
    li x29, 0x8017f4b9           // t4
    li x30, 0xd850f36f           // t5
    li x31, 0x8e                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x17'}, 'clob': {'f18', 'x17', 'x24'}})
...
f18                 0xf7c4840084a3d608(-8.467419271097752e+268_d)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f18                 0xf7c4840084a3d608(-8.467419271097752e+268_d)   0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, x499, x17
a7(x17)             0x0000000080119499(2148635801)                  0x0000000080119499(2148635801)
f18                 0xf7c4840084a3d608(-8.467419271097752e+268_d)   0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            00dd40020822cb650d63aa8780f95a11ec84a992        00dd40020822cb650d63aa8780f95a11ec84a992        
