# FailID_005455 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f28'}})
    fmin.s f28, f15, f13
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff4f000059(2147506432.0_s)              0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f28, f15, f13
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c885d887f98da3239432ea301861439da494861a        c885d887f98da3239432ea301861439da494861a        
