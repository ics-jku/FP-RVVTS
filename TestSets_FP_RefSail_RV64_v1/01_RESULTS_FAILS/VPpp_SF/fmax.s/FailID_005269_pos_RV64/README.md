# FailID_005269 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x84,0x4e,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xff,0xff
_reg_f31:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x7f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f8'}, 'clob': {'f31'}})
    fmax.s f31, f4, f8
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff4e840000(1107296256.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f4, f8
f4                  0xffffffff4e840000(1107296256.0_s)              0xffffffff4e840000(1107296256.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            db4ce08f03e41dba723b8da3933ac817789cd233        db4ce08f03e41dba723b8da3933ac817789cd233        
