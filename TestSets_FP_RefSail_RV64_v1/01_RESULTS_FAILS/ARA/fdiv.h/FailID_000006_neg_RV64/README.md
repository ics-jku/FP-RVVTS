# FailID_000006 ARA neg RV64 fdiv.h
...
_reg_f12:.byte 0x5d,0x69,0xd8,0x61,0x05,0xf4,0xa0,0xf7
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f4', 'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f12'}})
    fdiv.h f12, f18, f4, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffffffff7e00(nan_h)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.h f12, f18, f4, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            30e9e44ab26221dde1644d38aad6bfc891159637        30e9e44ab26221dde1644d38aad6bfc891159637        
