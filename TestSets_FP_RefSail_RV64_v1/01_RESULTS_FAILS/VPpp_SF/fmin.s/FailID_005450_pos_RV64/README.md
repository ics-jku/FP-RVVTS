# FailID_005450 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0xdd,0xff,0xff,0x7f,0x00,0x00,0x00,0x00
_reg_f17:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f28:.byte 0x00,0x70,0x71,0xd6,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'f14', 'fcsr.rm'}, 'clob': {'f28'}})
    fmin.s f28, f17, f14
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f28, f17, f14
+========================================================================================================================+
...
f28                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f17, f14
f14                 0x000000007fffffdd(1.060997878e-314_d)          0x000000007fffffdd(1.060997878e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            07cc28ceda6b06f982e72df34dcb6ba749bb7f80        07cc28ceda6b06f982e72df34dcb6ba749bb7f80        
