# FailID_005141 VP++ SF pos RV64 fmax.d
...
_reg_f24:.byte 0x00,0x00,0xc0,0x13,0xfd,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f17'}})
    fmax.d f17, f24, f19
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xc1dffffd13c00000(-2147480655.0_d)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f24, f19
+========================================================================================================================+
...
f17                 0xc1dffffd13c00000(-2147480655.0_d)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f24, f19
f17                 0xc1dffffd13c00000(-2147480655.0_d)             0xffffffff7fc00000(nan_s)                       X
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f24                 0xc1dffffd13c00000(-2147480655.0_d)             0xc1dffffd13c00000(-2147480655.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9675831a30a64735471cd636e30fc23414faef9d        9675831a30a64735471cd636e30fc23414faef9d        
