# FailID_000823 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x24, 0x1                  // s8
    li x25, 0x87                 // s9
    li x26, 0xfffffffffffff88b   // s10
    li x27, 0x80000366           // s11
    li x28, 0x5a                 // t3
    li x29, 0x7ffff8a3           // t4
    li x30, 0x801ffee1           // t5
    li x31, 0x35                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x3'}, 'clob': {'f12', 'x19', 'x3'}})
...
f12                 0x14ae41177962cb34(4.601290157299096e-209_d)    0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
sp(x2)              0x00000000801fb9a1(2149562785)                  0x00000000801fb9a1(2149562785)                  
gp(x3)              0x000000007ffff89d(2147481757)                  0x000000007ffff89d(2147481757)                  
...
a5(x15)             0x000000000000005a(90)                          0x000000000000005a(90)                          
...
s10(x26)            0xfffffffffffff88b(18446744073709549707)        0xfffffffffffff88b(18446744073709549707)        
s11(x27)            0x0000000080000366(2147484518)                  0x0000000080000366(2147484518)                  
t3(x28)             0x000000000000005a(90)                          0x000000000000005a(90)                          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c4884bd55a7fc9e616685ae7f21e2d163f56c3c9        c4884bd55a7fc9e616685ae7f21e2d163f56c3c9        
