# FailID_002607 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x17'}})
    fcvt.wu.d x17, f25, rup
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x17, f25, rup
+========================================================================================================================+
...
Registers: x17, f25
a7(x17)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f25                 0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ec5ae03d4ad7512f801ff71328b53a537bc9f325        ec5ae03d4ad7512f801ff71328b53a537bc9f325        
