# FailID_002707 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f27:.byte 0x00,0x00,0x73,0x43,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f27
    fld  f27, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.d x3, f27, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x3, f27, rne
+========================================================================================================================+
...
Registers: x3, f27
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f27                 0xffffffff43730000(243.0_s)                     0xffffffff43730000(243.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            17e72c03ba1a1bc14eb700bf9394b929aaf4ac83        17e72c03ba1a1bc14eb700bf9394b929aaf4ac83        
