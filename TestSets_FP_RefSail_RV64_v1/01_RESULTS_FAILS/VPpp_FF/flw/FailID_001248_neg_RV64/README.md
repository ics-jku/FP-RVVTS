# FailID_001248 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x1                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'x4', 'f15', 'x23'}})
...
f15                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            71fdd56ac5a50b800220051e61bff656295d237d        71fdd56ac5a50b800220051e61bff656295d237d        
