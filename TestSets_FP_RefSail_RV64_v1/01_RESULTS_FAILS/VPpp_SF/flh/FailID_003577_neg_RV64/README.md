# FailID_003577 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x6', 'fcsr.rm'}, 'clob': {'x6', 'x11', 'f8'}})
...
f8                  0x2f6dfba31192e4cd(3.160862674075533e-80_d)     0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x17, x6
t1(x6)              0x00000000801fffec(2149580780)                  0x00000000801fffec(2149580780)
...
a1(x11)             0x000000008000017c(2147484028)                  0x000000008000017c(2147484028)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            38fa6492397c8180b22f39bbc0caa05ec3e1ab3d        38fa6492397c8180b22f39bbc0caa05ec3e1ab3d        
