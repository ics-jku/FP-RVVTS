# FailID_001021 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0x86                 // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'x7', 'f16', 'x28'}})
...
f16                 0xffffffff7fc00000(nan_s)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
t0(x5)              0x00000000801fffa1(2149580705)                  0x00000000801fffa1(2149580705)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3dbd06d113bdc2aab23e874888982f02cb8ce05e        3dbd06d113bdc2aab23e874888982f02cb8ce05e        
