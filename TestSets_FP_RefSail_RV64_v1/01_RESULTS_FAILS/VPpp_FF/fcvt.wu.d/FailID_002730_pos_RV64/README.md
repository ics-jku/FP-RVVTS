# FailID_002730 VP++ FF pos RV64 fcvt.wu.d
...
* FailID: 2730
* Isolated failing instruction: `fcvt.wu.d`
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0xfd,0x07,0x18,0x80,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x25'}})
    fcvt.wu.d x25, f1, rtz
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s9(x25)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x25, f1, rtz
+========================================================================================================================+
Attributes:  fcsr ['invalid'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x25, f1
s9(x25)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f1                  0xffffffff801807fd(-2.2069175631513333e-39_s)   0xffffffff801807fd(-2.2069175631513333e-39_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cd5e872ffa057378f1056ee284e8f9ad8fb0c902        cd5e872ffa057378f1056ee284e8f9ad8fb0c902        
