# FailID_003499 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x18, 0x8017f8c8           // s2
    li x19, 0x204e5000           // s3
    ...
    li x30, 0x7ffffec4           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x30'}, 'clob': {'x19', 'f0', 'x30'}})
...
gp(x3)              0x000000000000000a(10)                          0x000000000000000a(10)                          
...
s2(x18)             0x000000008017f8c8(2149054664)                  0x000000008017f8c8(2149054664)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a69e828c2ac369ebabab622ae737fb1fd214c876        a69e828c2ac369ebabab622ae737fb1fd214c876        
