# FailID_004130 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f2', 'f28'}, 'clob': {'f10'}})
    fmax.s f10, f28, f2
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff4f783b70(4164644864.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8f9c11eb3eb51b659d6d43e4ecd8869b80b94377        8f9c11eb3eb51b659d6d43e4ecd8869b80b94377        
