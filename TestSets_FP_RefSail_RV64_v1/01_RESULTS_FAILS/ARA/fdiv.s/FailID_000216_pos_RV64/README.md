# FailID_000216 ARA pos RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'f4', 'mstatus.fs/vs.fs'}, 'clob': {'f15'}})
    fdiv.s f15, f3, f4, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f3, f4, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            eadf56520582b2d0919b6765c97fcfd0f0f226f9        eadf56520582b2d0919b6765c97fcfd0f0f226f9        
