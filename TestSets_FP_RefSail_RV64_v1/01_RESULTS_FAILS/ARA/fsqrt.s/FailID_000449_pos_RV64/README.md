# FailID_000449 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x00,0x00,0x40,0x0a,0x01,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f7'}})
    fsqrt.s f7, f24, rne
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f7, f24, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            71cbe559852d86bff55c29dc2e066a912edf0843        71cbe559852d86bff55c29dc2e066a912edf0843        
