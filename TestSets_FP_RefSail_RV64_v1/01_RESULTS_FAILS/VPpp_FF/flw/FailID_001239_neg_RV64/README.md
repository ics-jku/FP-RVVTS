# FailID_001239 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x400                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs'}, 'clob': {'x8', 'x30', 'f9'}})
...
f9                  0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0e0fdb3144121f470b6d362891420aea0b7e6281        0e0fdb3144121f470b6d362891420aea0b7e6281        
