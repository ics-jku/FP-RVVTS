# FailID_005372 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f2'}, 'clob': {'f9'}})
    fmin.d f9, f3, f2
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8779f738bce4305c02c944965e6be3881abc57b5        8779f738bce4305c02c944965e6be3881abc57b5        
