# FailID_002994 VP++ FF pos RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x29'}})
    fcvt.wu.s x29, f16, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x29, f16, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a71129f92b723733be2e6bf42950f38ba0083dee        a71129f92b723733be2e6bf42950f38ba0083dee        
