# FailID_002160 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x13, 0x80180544           // a3
    li x14, 0x801805ca           // a4
    li x15, 0x801ff4e5           // a5
    li x16, 0x6000               // a6
    li x17, 0x801ffeee           // a7
    li x18, 0x460000000          // s2
    li x19, 0x8017f9ec           // s3
    li x20, 0x8020093e           // s4
    li x21, 0x80212dce           // s5
    li x22, 0x0                  // s6
    ...
    li x30, 0x1                  // t5
    li x31, 0x7f                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2', 'f28'}, 'clob': {'x2', 'x8'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6e4dfd87fb9228a77d0f6fd47978167d7f0eda0b        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, x1, b1, x2
ra(x1)              0x000000007ffffdaa(2147483050)                  0x000000007ffffdaa(2147483050)
sp(x2)              0x0000000080180255(2149057109)                  0x0000000080180255(2149057109)
...
tp(x4)              0x0000000080180316(2149057302)                  0x0000000080180316(2149057302)                  
...
fp(x8)              0x00000000801801b1(2149056945)                  0x00000000801801b1(2149056945)                  
...
a3(x13)             0x0000000080180544(2149057860)                  0x0000000080180544(2149057860)                  
a4(x14)             0x00000000801805ca(2149057994)                  0x00000000801805ca(2149057994)                  
...
s4(x20)             0x000000008020093e(2149583166)                  0x000000008020093e(2149583166)                  
s5(x21)             0x0000000080212dce(2149658062)                  0x0000000080212dce(2149658062)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0b11dfda097c534975efdc3e3240ea130265a010        0b11dfda097c534975efdc3e3240ea130265a010        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6e4dfd87fb9228a77d0f6fd47978167d7f0eda0b        X
