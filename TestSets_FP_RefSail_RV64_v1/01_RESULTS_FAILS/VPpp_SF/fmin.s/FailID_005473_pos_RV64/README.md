# FailID_005473 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f22:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_reg_f25:.byte 0x00,0x00,0x84,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f22'}, 'clob': {'f25'}})
    fmin.s f25, f28, f22
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f25, f28, f22
+========================================================================================================================+
...
f25                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f28, f22
f22                 0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
f25                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8bf47ef9101d3f85643af2a84d5d9b5e85b08808        8bf47ef9101d3f85643af2a84d5d9b5e85b08808        
