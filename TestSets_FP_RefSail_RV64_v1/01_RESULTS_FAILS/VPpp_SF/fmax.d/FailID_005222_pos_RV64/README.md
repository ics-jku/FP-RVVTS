# FailID_005222 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x7a,0xcb,0x5b,0xca,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f2'}, 'clob': {'f14'}})
    fmax.d f14, f2, f6
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x41ca5bcb7a000000(884446964.0_d)               0x7fffffff7fc00000(nan_d)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f2, f6
f2                  0x41ca5bcb7a000000(884446964.0_d)               0x41ca5bcb7a000000(884446964.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            40320d382a44d37a46f9529c87c79b7a5f2c9473        40320d382a44d37a46f9529c87c79b7a5f2c9473        
