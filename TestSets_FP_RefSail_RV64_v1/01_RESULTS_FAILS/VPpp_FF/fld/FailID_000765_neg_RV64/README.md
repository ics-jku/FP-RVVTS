# FailID_000765 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x400                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x17'}, 'clob': {'f23', 'x18', 'x17'}})
...
f23                 0xffffffffffff7e00(nan_h)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            403e5c49b4f8582f0e6125f096752e420c0bc651        403e5c49b4f8582f0e6125f096752e420c0bc651        
