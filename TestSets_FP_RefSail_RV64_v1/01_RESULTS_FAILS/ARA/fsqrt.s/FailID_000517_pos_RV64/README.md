# FailID_000517 ARA pos RV64 fsqrt.s
...
_reg_f25:.byte 0x00,0x00,0xee,0x42,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f16'}})
    fsqrt.s f16, f25, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff412e8a16(10.908712387084961_s)        0xffffffff412e8a15(10.908711433410645_s)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f16, f25, rmm
+========================================================================================================================+
...
Registers: f16, f25
f16                 0xffffffff412e8a16(10.908712387084961_s)        0xffffffff412e8a15(10.908711433410645_s)        X
f25                 0xffffffff42ee0000(119.0_s)                     0xffffffff42ee0000(119.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0d44799f3c31a020e05f585bb915793b433e50c9        0d44799f3c31a020e05f585bb915793b433e50c9        
