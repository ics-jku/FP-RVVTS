# FailID_005113 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x9, 0x80180216            // s1
    li x10, 0x0                  // a0
    li x11, 0x8017f822           // a1
    li x12, 0x0                  // a2
    li x13, 0x800000b9           // a3
    li x14, 0x8017f9f3           // a4
    li x15, 0x0                  // a5
    li x16, 0x801807b2           // a6
    li x17, 0x1                  // a7
    li x18, 0x8017fab8           // s2
    li x19, 0x0                  // s3
    li x20, 0x8017f8a4           // s4
    li x21, 0xffffffffb5390000   // s5
    li x22, 0x71a                // s6
    li x23, 0x8017f8a4           // s7
    li x24, 0x2e                 // s8
    li x25, 0x96                 // s9
    li x26, 0x1                  // s10
    li x27, 0x1                  // s11
    li x28, 0x80180699           // t3
    li x29, 0xfffffffffffffffe   // t4
    li x30, 0xffffffffd944b000   // t5
    li x31, 0x8017ffb5           // t6
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'x11', 'mstatus.fs/vs.fs'}, 'clob': {'x11', 'x7'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4d764af268598e5732e2797226428ca83134326a        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x655, x11
a1(x11)             0x00000000801ff1cb(2149577163)                  0x00000000801ff1cb(2149577163)
...
sp(x2)              0x0000000000000054(84)                          0x0000000000000054(84)                          
gp(x3)              0x0000000000000001(1)                           0x0000000000000001(1)                           
tp(x4)              0x000000008017fab8(2149055160)                  0x000000008017fab8(2149055160)                  
t0(x5)              0x0000000000000059(89)                          0x0000000000000059(89)                          
t1(x6)              0x00000000800007c5(2147485637)                  0x00000000800007c5(2147485637)                  
t2(x7)              0x000000008017f9ab(2149054891)                  0x000000008017f9ab(2149054891)                  
fp(x8)              0x0000000000000044(68)                          0x0000000000000044(68)                          
s1(x9)              0x0000000080180216(2149057046)                  0x0000000080180216(2149057046)                  
a0(x10)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a1(x11)             0x00000000801ff1cb(2149577163)                  0x00000000801ff1cb(2149577163)                  
a2(x12)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a3(x13)             0x00000000800000b9(2147483833)                  0x00000000800000b9(2147483833)                  
a4(x14)             0x000000008017f9f3(2149054963)                  0x000000008017f9f3(2149054963)                  
...
s4(x20)             0x000000008017f8a4(2149054628)                  0x000000008017f8a4(2149054628)                  
s5(x21)             0xffffffffb5390000(18446744072454995968)        0xffffffffb5390000(18446744072454995968)        
s6(x22)             0x000000000000071a(1818)                        0x000000000000071a(1818)                        
s7(x23)             0x000000008017f8a4(2149054628)                  0x000000008017f8a4(2149054628)                  
s8(x24)             0x000000000000002e(46)                          0x000000000000002e(46)                          
s9(x25)             0x0000000000000096(150)                         0x0000000000000096(150)                         
s10(x26)            0x0000000000000001(1)                           0x0000000000000001(1)                           
s11(x27)            0x0000000000000001(1)                           0x0000000000000001(1)                           
t3(x28)             0x0000000080180699(2149058201)                  0x0000000080180699(2149058201)                  
...
t6(x31)             0x000000008017ffb5(2149056437)                  0x000000008017ffb5(2149056437)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            bda3a3b9630308896d642538cce893d0d3b7fdc3        bda3a3b9630308896d642538cce893d0d3b7fdc3        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4d764af268598e5732e2797226428ca83134326a        X
