# FailID_004126 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f4'}, 'clob': {'f10'}})
    fmax.s f10, f4, f10
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb91c65b93937ca92ee674ab7ce69366e651ef02        fb91c65b93937ca92ee674ab7ce69366e651ef02        
