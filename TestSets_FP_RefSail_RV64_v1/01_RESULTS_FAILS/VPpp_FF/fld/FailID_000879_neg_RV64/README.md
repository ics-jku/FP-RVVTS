# FailID_000879 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x80139ec5            // fp
    li x9, 0x80000333            // s1
    li x10, 0x8018060a           // a0
    li x11, 0x8027fee6           // a1
    li x12, 0x801802fa           // a2
    li x13, 0x7ffff814           // a3
    li x14, 0x1                  // a4
    li x15, 0x3e                 // a5
    li x16, 0x8017fae2           // a6
    li x17, 0x7ffffe3d           // a7
    li x18, 0x4012741980         // s2
    li x19, 0x801866fe           // s3
    li x20, 0x801862fa           // s4
    li x21, 0x8017ff63           // s5
    li x22, 0x0                  // s6
    li x23, 0x7ffffc3b           // s7
    li x24, 0x7ffffccd           // s8
    li x25, 0x7fffffff           // s9
    li x26, 0x80180773           // s10
    li x27, 0x0                  // s11
    li x28, 0x7ffffa25           // t3
    li x29, 0x7ffffe3d           // t4
    li x30, 0x80200182           // t5
    li x31, 0xfffff028           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x28'}, 'clob': {'x11', 'f15', 'x28'}})
...
f15                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f15                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, x439, x28
t3(x28)             0x00000000801ffe59(2149580377)                  0x00000000801ffe59(2149580377)
f15                 0xffffffffffff7e00(nan_h)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
sp(x2)              0x00000000000465bd(288189)                      0x00000000000465bd(288189)                      
gp(x3)              0x00000000800001ad(2147484077)                  0x00000000800001ad(2147484077)                  
tp(x4)              0x00000000801ff965(2149579109)                  0x00000000801ff965(2149579109)                  
t0(x5)              0x000000008004e9dd(2147805661)                  0x000000008004e9dd(2147805661)                  
t1(x6)              0x0000000000000001(1)                           0x0000000000000001(1)                           
t2(x7)              0x00000000801804e1(2149057761)                  0x00000000801804e1(2149057761)                  
fp(x8)              0x0000000080139ec5(2148769477)                  0x0000000080139ec5(2148769477)                  
s1(x9)              0x0000000080000333(2147484467)                  0x0000000080000333(2147484467)                  
a0(x10)             0x000000008018060a(2149058058)                  0x000000008018060a(2149058058)                  
a1(x11)             0x0000000080000439(2147484729)                  0x0000000080000439(2147484729)                  
a2(x12)             0x00000000801802fa(2149057274)                  0x00000000801802fa(2149057274)                  
a3(x13)             0x000000007ffff814(2147481620)                  0x000000007ffff814(2147481620)                  
a4(x14)             0x0000000000000001(1)                           0x0000000000000001(1)                           
a5(x15)             0x000000000000003e(62)                          0x000000000000003e(62)                          
a6(x16)             0x000000008017fae2(2149055202)                  0x000000008017fae2(2149055202)                  
a7(x17)             0x000000007ffffe3d(2147483197)                  0x000000007ffffe3d(2147483197)                  
s2(x18)             0x0000004012741980(275187505536)                0x0000004012741980(275187505536)                
s3(x19)             0x00000000801866fe(2149082878)                  0x00000000801866fe(2149082878)                  
s4(x20)             0x00000000801862fa(2149081850)                  0x00000000801862fa(2149081850)                  
...
s8(x24)             0x000000007ffffccd(2147482829)                  0x000000007ffffccd(2147482829)                  
...
t5(x30)             0x0000000080200182(2149581186)                  0x0000000080200182(2149581186)                  
t6(x31)             0x00000000fffff028(4294963240)                  0x00000000fffff028(4294963240)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            a79b86f6bc4a4eede56c0ce2ea721faf69e0f292        a79b86f6bc4a4eede56c0ce2ea721faf69e0f292        
