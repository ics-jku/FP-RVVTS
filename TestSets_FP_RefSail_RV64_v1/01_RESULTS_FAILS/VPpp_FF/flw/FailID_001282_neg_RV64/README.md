# FailID_001282 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x21'}, 'clob': {'f19', 'x24', 'x21'}})
...
f19                 0xffffffffffc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
s8(x24)             0x000000007fffffbe(2147483582)                  0x000000007fffffbe(2147483582)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            77ff13429be2ca5891f8c4e9e2e8fd00d04d253b        77ff13429be2ca5891f8c4e9e2e8fd00d04d253b        
