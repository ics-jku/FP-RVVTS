# FailID_004105 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f12'}, 'clob': {'f15'}})
    fmax.d f15, f12, f10
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x14ae41177962cb34(4.601290157299096e-209_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f15, f12, f10
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            22c65207e16f6a74a6b9020800d8adb96405bce1        22c65207e16f6a74a6b9020800d8adb96405bce1        
