# FailID_005194 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f1'}})
    fmax.d f1, f25, f28
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b4cee9a3d090fe00f99b9cbda1e5b4344c8fb715        b4cee9a3d090fe00f99b9cbda1e5b4344c8fb715        
