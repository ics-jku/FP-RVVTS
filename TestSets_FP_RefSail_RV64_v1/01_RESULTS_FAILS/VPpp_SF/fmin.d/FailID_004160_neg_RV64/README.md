# FailID_004160 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f12'}, 'clob': {'f5'}})
    fmin.d f5, f30, f12
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x41dfffff50000000(2147482944.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            65d93afd75dd2d8dd4ec6fdd1acde221ac3a925c        65d93afd75dd2d8dd4ec6fdd1acde221ac3a925c        
