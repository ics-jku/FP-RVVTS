# FailID_005298 VP++ SF pos RV64 fmax.s
...
_reg_f27:.byte 0x00,0x60,0xee,0xc4,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f9
    fld  f9, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f27'}, 'clob': {'f9'}})
    fmax.s f9, f27, f21
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffffc4ee6000(-1907.0_s)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f9                  0xffffffffc4ee6000(-1907.0_s)                   0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f9, f27, f21
f9                  0xffffffffc4ee6000(-1907.0_s)                   0xffffffff7fc00000(nan_s)                       X
f21                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f27                 0xffffffffc4ee6000(-1907.0_s)                   0xffffffffc4ee6000(-1907.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            296732cd3af77f3e186912645ab4d97e29cfe2fc        296732cd3af77f3e186912645ab4d97e29cfe2fc        
