# FailID_000172 ARA pos RV64 fdiv.s
...
_reg_f26:.byte 0x00,0x00,0xc0,0x46,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f18'}})
    fdiv.s f18, f26, f29, rdn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f18, f26, f29, rdn
+========================================================================================================================+
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f26, f29
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f26                 0xffffffff46c00000(24576.0_s)                   0xffffffff46c00000(24576.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c923a3b8a420c4dd4c3f58a33de1e197e757ac5e        c923a3b8a420c4dd4c3f58a33de1e197e757ac5e        
