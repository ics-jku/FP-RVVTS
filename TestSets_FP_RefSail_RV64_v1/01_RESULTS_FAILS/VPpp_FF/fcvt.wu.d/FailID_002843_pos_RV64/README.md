# FailID_002843 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f17:.byte 0x00,0x80,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f17
    fld  f17, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'x1'}})
    fcvt.wu.d x1, f17, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x1, f17, rne
+========================================================================================================================+
...
Registers: x1, f17
ra(x1)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f17                 0xffffffffceff8000(-2143289344.0_s)             0xffffffffceff8000(-2143289344.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7809617dc085221e2f258951a52dba53ac5bc0f6        7809617dc085221e2f258951a52dba53ac5bc0f6        
