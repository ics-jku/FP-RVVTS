# FailID_003197 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x08,0xfa,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f4', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x8'}})
    fcvt.wu.s x8, f4, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x8, f4, rtz
+========================================================================================================================+
...
Registers: x8, f4
fp(x8)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f4                  0xfffffffffffffa08(-49408.0_h)                  0xfffffffffffffa08(-49408.0_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5e8102890b280a5f8706bf5da39a9e817ebe7486        5e8102890b280a5f8706bf5da39a9e817ebe7486        
