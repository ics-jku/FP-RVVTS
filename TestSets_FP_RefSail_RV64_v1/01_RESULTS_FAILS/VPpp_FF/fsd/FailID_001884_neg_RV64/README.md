# FailID_001884 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x10, 0x80180263           // a0
    li x11, 0x0                  // a1
    li x12, 0x800066c6           // a2
    li x13, 0x8018040f           // a3
    li x14, 0x140                // a4
    li x15, 0x400                // a5
    li x16, 0x0                  // a6
    li x17, 0x80180033           // a7
    li x18, 0x6000               // s2
    li x19, 0x8018600d           // s3
    li x20, 0x800007fd           // s4
    li x21, 0xffffffffffffffff   // s5
    li x22, 0x0                  // s6
    li x23, 0x80229283           // s7
    li x24, 0x8017f941           // s8
    li x25, 0xffffffffffffffff   // s9
    li x26, 0x7fffff3e           // s10
    li x27, 0x2                  // s11
    li x28, 0x0                  // t3
    li x29, 0xffffffffffffffff   // t4
    li x30, 0x8001912e           // t5
    li x31, 0x8017fcc6           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f13', 'mstatus.fs/vs.fs', 'x13'}, 'clob': {'x8', 'x13'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        2ff7183859ed9ce48d5870183f868daba8f4b3ce        X
...
t0(x5)              0x00000000736bc000(1936441344)                  0x00000000736bc000(1936441344)                  
t1(x6)              0x00000000800006c6(2147485382)                  0x00000000800006c6(2147485382)                  
t2(x7)              0x00000000801ffd1c(2149580060)                  0x00000000801ffd1c(2149580060)                  
fp(x8)              0x000000008017fc28(2149055528)                  0x000000008017fc28(2149055528)                  
s1(x9)              0xffffffffe68fc000(18446744073282764800)        0xffffffffe68fc000(18446744073282764800)        
a0(x10)             0x0000000080180263(2149057123)                  0x0000000080180263(2149057123)                  
...
a5(x15)             0x0000000000000400(1024)                        0x0000000000000400(1024)                        
...
s3(x19)             0x000000008018600d(2149081101)                  0x000000008018600d(2149081101)                  
...
s7(x23)             0x0000000080229283(2149749379)                  0x0000000080229283(2149749379)                  
...
s10(x26)            0x000000007fffff3e(2147483454)                  0x000000007fffff3e(2147483454)                  
...
t5(x30)             0x000000008001912e(2147586350)                  0x000000008001912e(2147586350)                  
t6(x31)             0x000000008017fcc6(2149055686)                  0x000000008017fcc6(2149055686)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            0bd3a52537232552c7a3105c7b10c98073d2c5cf        0bd3a52537232552c7a3105c7b10c98073d2c5cf        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        2ff7183859ed9ce48d5870183f868daba8f4b3ce        X
