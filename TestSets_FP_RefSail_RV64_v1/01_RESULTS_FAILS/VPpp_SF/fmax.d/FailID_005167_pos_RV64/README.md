# FailID_005167 VP++ SF pos RV64 fmax.d
...
_reg_f19:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x5c,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'f10'}})
    fmax.d f10, f19, f1
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x405c000000000000(112.0_d)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f10                 0x405c000000000000(112.0_d)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f19, f1
f1                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f10                 0x405c000000000000(112.0_d)                     0xffffffff7fc00000(nan_s)                       X
f19                 0x405c000000000000(112.0_d)                     0x405c000000000000(112.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3dcd0a250e89190f4200b3aa933c7c0afec0c3d6        3dcd0a250e89190f4200b3aa933c7c0afec0c3d6        
