# FailID_004196 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'x26'}})
    fmv.x.h x26, f5
```
...
```
REG                 REF                                             DUT                                             DIFF
s10(x26)            0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            33804e4ba40c82a42de88cb8831fec62d01363d0        33804e4ba40c82a42de88cb8831fec62d01363d0        
