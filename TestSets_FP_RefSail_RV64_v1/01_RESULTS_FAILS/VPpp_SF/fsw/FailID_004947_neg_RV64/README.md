# FailID_004947 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x8, 0x80200760            // fp
    li x9, 0x801ffcb8            // s1
    li x10, 0x8017fa44           // a0
    li x11, 0xffffffff96f25000   // a1
    li x12, 0x0                  // a2
    li x13, 0x4                  // a3
    ...
    li x17, 0x0                  // a7
    li x18, 0x802703cb           // s2
    li x19, 0x8017fb20           // s3
    li x20, 0x6000               // s4
    li x21, 0x802000c8           // s5
    li x22, 0x801ff806           // s6
    li x23, 0x39                 // s7
    li x24, 0x8017f938           // s8
    li x25, 0x8017fffb           // s9
    li x26, 0x80180527           // s10
    li x27, 0x802002a9           // s11
    li x28, 0x7fffffe0           // t3
    li x29, 0x80180358           // t4
    li x30, 0x801806c8           // t5
    li x31, 0x8017fddc           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x22', 'f8'}, 'clob': {'x22', 'x25'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        1776316273d785f09dabcee25180cc000472c084        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, x5, c8, x22
t0(x5)              0x0000000056a7b000(1453830144)                  0x0000000056a7b000(1453830144)
s6(x22)             0x000000008027fdcc(2150104524)                  0x000000008027fdcc(2150104524)
...
gp(x3)              0x0000000080200142(2149581122)                  0x0000000080200142(2149581122)                  
tp(x4)              0x00000000802001ef(2149581295)                  0x00000000802001ef(2149581295)                  
t0(x5)              0x0000000056a7b000(1453830144)                  0x0000000056a7b000(1453830144)                  
t1(x6)              0x000000008017f96c(2149054828)                  0x000000008017f96c(2149054828)                  
...
a0(x10)             0x000000008017fa44(2149055044)                  0x000000008017fa44(2149055044)                  
a1(x11)             0xffffffff96f25000(18446744071947046912)        0xffffffff96f25000(18446744071947046912)        
a2(x12)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a3(x13)             0x0000000000000004(4)                           0x0000000000000004(4)                           
...
s2(x18)             0x00000000802703cb(2150040523)                  0x00000000802703cb(2150040523)                  
s3(x19)             0x000000008017fb20(2149055264)                  0x000000008017fb20(2149055264)                  
...
s6(x22)             0x000000008027fdcc(2150104524)                  0x000000008027fdcc(2150104524)                  
s7(x23)             0x0000000000000039(57)                          0x0000000000000039(57)                          
s8(x24)             0x000000008017f938(2149054776)                  0x000000008017f938(2149054776)                  
...
t3(x28)             0x000000007fffffe0(2147483616)                  0x000000007fffffe0(2147483616)                  
t4(x29)             0x0000000080180358(2149057368)                  0x0000000080180358(2149057368)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            584048dbd4c105ed1a2f2bac34fb7509703f5134        584048dbd4c105ed1a2f2bac34fb7509703f5134        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        1776316273d785f09dabcee25180cc000472c084        X
