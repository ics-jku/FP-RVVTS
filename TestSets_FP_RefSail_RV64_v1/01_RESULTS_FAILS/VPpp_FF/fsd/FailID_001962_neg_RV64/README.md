# FailID_001962 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x10, 0x40                 // a0
    li x11, 0xe2                 // a1
    li x12, 0x8018582a           // a2
    li x13, 0x16b0               // a3
    li x14, 0x8027f268           // a4
    li x15, 0x801ff568           // a5
    li x16, 0x8007f999           // a6
    li x17, 0x8017f82a           // a7
    li x18, 0x1                  // s2
    li x19, 0x8017fa20           // s3
    ...
    li x29, 0x8017fca4           // t4
    li x30, 0x8017fca4           // t5
    li x31, 0x801807e3000        // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f4', 'x20'}, 'clob': {'x11', 'x20'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        c34ae13b296a71b099f7cddaf5a29aa6e5b17c34        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x20
s4(x20)             0x00000000801803db(2149057499)                  0x00000000801803db(2149057499)
...
t2(x7)              0x0000000000000160(352)                         0x0000000000000160(352)                         
...
a0(x10)             0x0000000000000040(64)                          0x0000000000000040(64)                          
a1(x11)             0x000000008017fff3(2149056499)                  0x000000008017fff3(2149056499)                  
a2(x12)             0x000000008018582a(2149079082)                  0x000000008018582a(2149079082)                  
a3(x13)             0x00000000000016b0(5808)                        0x00000000000016b0(5808)                        
a4(x14)             0x000000008027f268(2150101608)                  0x000000008027f268(2150101608)                  
...
a7(x17)             0x000000008017f82a(2149054506)                  0x000000008017f82a(2149054506)                  
s2(x18)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s3(x19)             0x000000008017fa20(2149055008)                  0x000000008017fa20(2149055008)                  
s4(x20)             0x00000000801803db(2149057499)                  0x00000000801803db(2149057499)                  
...
t4(x29)             0x000000008017fca4(2149055652)                  0x000000008017fca4(2149055652)                  
t5(x30)             0x000000008017fca4(2149055652)                  0x000000008017fca4(2149055652)                  
t6(x31)             0x00000801807e3000(8802543742976)               0x00000801807e3000(8802543742976)               

STATE               REF                                             DUT                                             DIFF
xmemhash            fbf3ef7e1a9740c99b9444fe04094dbdaa44b38a        fbf3ef7e1a9740c99b9444fe04094dbdaa44b38a        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        c34ae13b296a71b099f7cddaf5a29aa6e5b17c34        X
