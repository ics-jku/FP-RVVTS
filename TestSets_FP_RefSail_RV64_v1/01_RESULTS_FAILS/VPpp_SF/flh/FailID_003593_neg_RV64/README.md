# FailID_003593 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x26, 0x800005c1           // s10
    li x27, 0xfffffffffffffd3b   // s11
    li x28, 0x91f3               // t3
    li x29, 0x7ffffc8d           // t4
    li x30, 0x0                  // t5
    li x31, 0x80000130           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'f26', 'x10', 'x1'}})
...
f26                 0x7ff8000000000000(nan_d)                       0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
ra(x1)              0x000000008000021a(2147484186)                  0x000000008000021a(2147484186)                  
...
s10(x26)            0x00000000800005c1(2147485121)                  0x00000000800005c1(2147485121)                  
s11(x27)            0xfffffffffffffd3b(18446744073709550907)        0xfffffffffffffd3b(18446744073709550907)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ed8a88dc84b6e1aacd22fe9e158e0e572612fa0e        ed8a88dc84b6e1aacd22fe9e158e0e572612fa0e        
