# FailID_005397 VP++ SF pos RV64 fmin.d
...
_reg_f26:.byte 0x7b,0x23,0x17,0x67,0xb7,0x6b,0xd1,0x13
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'fcsr.rm', 'f4'}, 'clob': {'f8'}})
    fmin.d f8, f26, f4
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0x13d16bb76717237b(3.234225947577275e-213_d)    0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f8                  0x13d16bb76717237b(3.234225947577275e-213_d)    0x7ff8000000000000(nan_d)                       X
f26                 0x13d16bb76717237b(3.234225947577275e-213_d)    0x13d16bb76717237b(3.234225947577275e-213_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4a4afc4035467e09dde8f5b0a407d1181404f490        4a4afc4035467e09dde8f5b0a407d1181404f490        
