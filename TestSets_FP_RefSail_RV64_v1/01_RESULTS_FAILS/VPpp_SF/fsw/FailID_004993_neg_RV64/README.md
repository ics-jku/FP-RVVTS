# FailID_004993 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x26, 0xff                 // s10
    li x27, 0xffffffff7fe807fa   // s11
    li x28, 0xffffffffbe24f000   // t3
    li x29, 0x1                  // t4
    li x30, 0x80200eed           // t5
    li x31, 0x80000529           // t6
    // INSTRUCTION ({'dep': {'f3', 'x21', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x29', 'x21'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bd3dd7b313ecdb369e7f780fa96fcd31fa71f1d1        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, x7, d8, x21
t2(x7)              0x0000000080000436(2147484726)                  0x0000000080000436(2147484726)
s5(x21)             0x0000000080200c0c(2149583884)                  0x0000000080200c0c(2149583884)
...
a0(x10)             0x000000002810c000(672186368)                   0x000000002810c000(672186368)                   
...
s3(x19)             0x0000000080000852(2147485778)                  0x0000000080000852(2147485778)                  
...
s11(x27)            0xffffffff7fe807fa(18446744071560497146)        0xffffffff7fe807fa(18446744071560497146)        
...
t5(x30)             0x0000000080200eed(2149584621)                  0x0000000080200eed(2149584621)                  
t6(x31)             0x0000000080000529(2147484969)                  0x0000000080000529(2147484969)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            69aa5719f79f9b09538500fcae5f3258cbda4cd1        69aa5719f79f9b09538500fcae5f3258cbda4cd1        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        bd3dd7b313ecdb369e7f780fa96fcd31fa71f1d1        X
