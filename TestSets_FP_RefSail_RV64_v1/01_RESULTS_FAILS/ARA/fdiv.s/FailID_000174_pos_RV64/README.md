# FailID_000174 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x73,0x90,0x01,0x34,0xff,0xff,0xff,0xff
_reg_f16:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f16'}})
    fdiv.s f16, f6, f26, rup
```
...
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f16, f6, f26, rup
+========================================================================================================================+
...
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f6, f26
f6                  0xffffffff34019073(1.2066611532191018e-07_s)    0xffffffff34019073(1.2066611532191018e-07_s)
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            73fd5ae8147ceea479dfaada6a83c4cf0d6c1ef4        73fd5ae8147ceea479dfaada6a83c4cf0d6c1ef4        
