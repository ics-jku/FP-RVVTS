# FailID_005533 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x00,0x00,0x25,0x43,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f29'}, 'clob': {'f20'}})
    fmin.s f20, f10, f29
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff43250000(165.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f20, f10, f29
+========================================================================================================================+
...
f20                 0xffffffff43250000(165.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f10, f29
f10                 0xffffffff43250000(165.0_s)                     0xffffffff43250000(165.0_s)
f20                 0xffffffff43250000(165.0_s)                     0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            066ff8c7c9b30f5429eb1f41df71cfb4f6cbf086        066ff8c7c9b30f5429eb1f41df71cfb4f6cbf086        
