# FailID_005416 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f20:.byte 0x00,0x00,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f20'}, 'clob': {'f29'}})
    fmin.d f29, f21, f20
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x0000000000000000(0.0_d)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f29, f21, f20
+========================================================================================================================+
...
f29                 0x0000000000000000(0.0_d)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f21, f20
f20                 0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3ab7cb6bc31c6a0d829233e9383e9917d035cb40        3ab7cb6bc31c6a0d829233e9383e9917d035cb40        
