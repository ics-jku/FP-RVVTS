# FailID_005181 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f30'}})
    fmax.d f30, f3, f19
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0x75c34497cd5be8e5(1.851576239328676e+259_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e62554e559b16e7edb22dec86a6560abaa7f1832        e62554e559b16e7edb22dec86a6560abaa7f1832        
