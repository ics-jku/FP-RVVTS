# FailID_001199 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x28, 0x80000098           // t3
    li x29, 0x801fffa2           // t4
    li x30, 0xffffffffe4ad4000   // t5
    li x31, 0x800004fc           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x1'}, 'clob': {'x12', 'f17', 'x1'}})
...
```
+========================================================================================================================+
Instruction: flw f17, 0x4ba(x1)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'overflow', 'inexact'], special values ['zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
t1(x6)              0x000000008028005d(2150105181)                  0x000000008028005d(2150105181)                  
...
t3(x28)             0x0000000080000098(2147483800)                  0x0000000080000098(2147483800)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5bf29af5cfeafb3b8a9c2c824d705696b55ee72c        5bf29af5cfeafb3b8a9c2c824d705696b55ee72c        
