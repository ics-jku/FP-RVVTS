# FailID_005140 VP++ SF pos RV64 fmax.d
...
_reg_f22:.byte 0x00,0xf3,0x11,0x47,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f2', 'f31'}, 'clob': {'f22'}})
    fmax.d f22, f31, f2
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x40d8000000000000(24576.0_d)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e64b511dc673c0eee83d351c9a9970ca84a0dd73        e64b511dc673c0eee83d351c9a9970ca84a0dd73        
