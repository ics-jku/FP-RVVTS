# FailID_005152 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x5a,0xff,0xff,0x7f,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f31'}, 'clob': {'f14'}})
    fmax.d f14, f4, f31
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x000000007fffff5a(1.0609978135e-314_d)         0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f14                 0x000000007fffff5a(1.0609978135e-314_d)         0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f4, f31
f4                  0x000000007fffff5a(1.0609978135e-314_d)         0x000000007fffff5a(1.0609978135e-314_d)
f14                 0x000000007fffff5a(1.0609978135e-314_d)         0x7ff8000000000000(nan_d)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bf9924758d1b926d1e9629957cde4f1c1df2cbfc        bf9924758d1b926d1e9629957cde4f1c1df2cbfc        
