# FailID_005227 VP++ SF pos RV64 fmax.s
...
_reg_f26:.byte 0xf9,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f26', 'fcsr.rm'}, 'clob': {'f12'}})
    fmax.s f12, f26, f24
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff4f0017f9(2149054720.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f12, f26, f24
+========================================================================================================================+
...
f12                 0xffffffff4f0017f9(2149054720.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f26, f24
f12                 0xffffffff4f0017f9(2149054720.0_s)              0xffffffff7fc00000(nan_s)                       X
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f26                 0xffffffff4f0017f9(2149054720.0_s)              0xffffffff4f0017f9(2149054720.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e0c6e7c504979174c8ae6f964c0302c0fe866309        e0c6e7c504979174c8ae6f964c0302c0fe866309        
