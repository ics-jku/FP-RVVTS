# FailID_003649 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x7'}, 'clob': {'f28', 'x25', 'x7'}})
...
f28                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
s4(x20)             0x00000000000000e0(224)                         0x00000000000000e0(224)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            90902857233baa967502045753c87850325b392c        90902857233baa967502045753c87850325b392c        
