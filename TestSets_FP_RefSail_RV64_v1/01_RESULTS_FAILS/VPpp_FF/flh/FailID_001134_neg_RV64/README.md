# FailID_001134 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x15, 0x0                  // a5
    li x16, 0x5b9f538a           // a6
    li x17, 0x800305cf           // a7
    ...
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'x9', 'x25', 'f18'}})
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
s1(x9)              0x000000008000012b(2147483947)                  0x000000008000012b(2147483947)                  
...
a6(x16)             0x000000005b9f538a(1537168266)                  0x000000005b9f538a(1537168266)                  
a7(x17)             0x00000000800305cf(2147681743)                  0x00000000800305cf(2147681743)                  
...
t3(x28)             0x00000000000000a2(162)                         0x00000000000000a2(162)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            598b8be44da3a40ee37418bfba61b0a980466b1e        598b8be44da3a40ee37418bfba61b0a980466b1e        
