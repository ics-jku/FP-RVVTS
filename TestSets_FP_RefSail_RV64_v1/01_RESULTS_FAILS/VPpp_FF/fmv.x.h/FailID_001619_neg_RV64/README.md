# FailID_001619 VP++ FF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f2'}, 'clob': {'x27'}})
    fmv.x.h x27, f2
```
...
```
REG                 REF                                             DUT                                             DIFF
s11(x27)            0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
```
+========================================================================================================================+
Instruction: fmv.x.h x27, f2
+========================================================================================================================+
Attributes:  special values ['zero'], precision mismatch ('h', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c3ba3e9a75a596d30bd4e148bfbecbb868492c25        c3ba3e9a75a596d30bd4e148bfbecbb868492c25        
