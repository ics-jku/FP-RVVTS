# FailID_005252 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f31'}})
    fmax.s f31, f7, f19
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff4f000007(2147485440.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f31                 0xffffffff4f000007(2147485440.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f7, f19
f7                  0xffffffff4f000007(2147485440.0_s)              0xffffffff4f000007(2147485440.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a1c781d2c492143d731713b23e7793e023335cd9        a1c781d2c492143d731713b23e7793e023335cd9        
