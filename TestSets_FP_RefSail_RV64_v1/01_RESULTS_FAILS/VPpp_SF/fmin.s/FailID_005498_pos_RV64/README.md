# FailID_005498 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0xff,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f27:.byte 0xd0,0x1c,0xb4,0xdf,0x74,0x28,0x3d,0x08
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'f11', 'fcsr.rm'}, 'clob': {'f27'}})
    fmin.s f27, f10, f11
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff4effffff(2147483520.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f27, f10, f11
+========================================================================================================================+
...
f27                 0xffffffff4effffff(2147483520.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f10, f11
f10                 0xffffffff4effffff(2147483520.0_s)              0xffffffff4effffff(2147483520.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dc187514d9439c32a2fae7a1e1fa08844c97ad35        dc187514d9439c32a2fae7a1e1fa08844c97ad35        
