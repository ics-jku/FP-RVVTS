# FailID_000296 ARA pos RV64 fsqrt.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f12'}})
    fsqrt.d f12, f30, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0x307203351aa3d96e(2.4889477921792735e-75_d)    0x307203351aa3d96f(2.488947792179274e-75_d)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f12, f30, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bb380792dd8f6ad68abd847447a693d94749adab        bb380792dd8f6ad68abd847447a693d94749adab        
