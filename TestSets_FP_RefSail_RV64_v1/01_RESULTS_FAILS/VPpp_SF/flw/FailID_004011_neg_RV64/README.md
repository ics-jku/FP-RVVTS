# FailID_004011 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x25, 0x6000               // s9
    li x26, 0x800042d3           // s10
    li x27, 0x80000345           // s11
    li x28, 0x80000345           // t3
    li x29, 0xec91e778           // t4
    li x30, 0x80180400           // t5
    li x31, 0x8007f1a6           // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x1', 'x29', 'f2'}})
...
a4(x14)             0x000000007ffffcac(2147482796)                  0x000000007ffffcac(2147482796)                  
...
t4(x29)             0x0000000080000274(2147484276)                  0x0000000080000274(2147484276)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c76c6e5eac4fe542632804e0a951281bbbbeab77        c76c6e5eac4fe542632804e0a951281bbbbeab77        
