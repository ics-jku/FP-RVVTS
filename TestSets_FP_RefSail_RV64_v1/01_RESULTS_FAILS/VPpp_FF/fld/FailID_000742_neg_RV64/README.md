# FailID_000742 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs'}, 'clob': {'x10', 'x30', 'f25'}})
...
f25                 0x40d8000000000000(24576.0_d)                   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ebf906b4827642c5bf92c52aca34acbbf3b82de1        ebf906b4827642c5bf92c52aca34acbbf3b82de1        
