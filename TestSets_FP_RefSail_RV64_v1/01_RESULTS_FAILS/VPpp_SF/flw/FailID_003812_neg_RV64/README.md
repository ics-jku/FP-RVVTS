# FailID_003812 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x22, 0x800007ff           // s6
    li x23, 0x98                 // s7
    li x24, 0x1                  // s8
    li x25, 0x800006ac           // s9
    li x26, 0xffffffffd17f7000   // s10
    li x27, 0xfffffffffffffd4c   // s11
    li x28, 0x8000073c           // t3
    li x29, 0x801804a1           // t4
    li x30, 0x0                  // t5
    li x31, 0xd7                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x26'}, 'clob': {'x4', 'x26', 'f19'}})
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x28, x26
s10(x26)            0x00000000801f6d75(2149543285)                  0x00000000801f6d75(2149543285)
...
a1(x11)             0x000000008020007b(2149580923)                  0x000000008020007b(2149580923)                  
...
s6(x22)             0x00000000800007ff(2147485695)                  0x00000000800007ff(2147485695)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b8c123432186e602da82c69f8844bbe96aca6768        b8c123432186e602da82c69f8844bbe96aca6768        
