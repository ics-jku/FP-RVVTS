# FailID_003242 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x17, 0x6000               // a7
    li x18, 0x6000               // s2
    li x19, 0x8017fd11           // s3
    li x20, 0xfffffffffffffedd   // s4
    li x21, 0x80180634           // s5
    li x22, 0x8018063400000      // s6
    li x23, 0x16                 // s7
    li x24, 0x7ffffc69           // s8
    li x25, 0x0                  // s9
    li x26, 0x800001db           // s10
    li x27, 0x800062e4           // s11
    li x28, 0x0                  // t3
    li x29, 0x1805e5             // t4
    li x30, 0x8017fe48           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x23'}, 'clob': {'x14', 'f7', 'x23'}})
...
f7                  0xffffffff00000000(0.0_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f7                  0xffffffff00000000(0.0_s)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x69, x23
s7(x23)             0x0000000080000079(2147483769)                  0x0000000080000079(2147483769)
f7                  0xffffffff00000000(0.0_s)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
s3(x19)             0x000000008017fd11(2149055761)                  0x000000008017fd11(2149055761)                  
s4(x20)             0xfffffffffffffedd(18446744073709551325)        0xfffffffffffffedd(18446744073709551325)        
...
s7(x23)             0x0000000080000079(2147483769)                  0x0000000080000079(2147483769)                  
s8(x24)             0x000000007ffffc69(2147482729)                  0x000000007ffffc69(2147482729)                  
s9(x25)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s10(x26)            0x00000000800001db(2147484123)                  0x00000000800001db(2147484123)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            46d9c68d268234bee1107b7e76f80a2f4e9f1a44        46d9c68d268234bee1107b7e76f80a2f4e9f1a44        
