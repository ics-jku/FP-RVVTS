# FailID_000251 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0xe1,0xfb,0x17,0x80,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f19', 'f10'}, 'clob': {'f12'}})
    fdiv.s f12, f10, f19, rdn
```
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f12, f10, f19, rdn
+========================================================================================================================+
...
f12                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f10, f19
f10                 0x000000008017fbe1(1.0617744723e-314_d)         0x000000008017fbe1(1.0617744723e-314_d)
f12                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7c18f60a9c25b31f429e1130b0110bc6b3325c2f        7c18f60a9c25b31f429e1130b0110bc6b3325c2f        
