# FailID_005391 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x60,0x3e,0xe2,0x40
_reg_f27:.byte 0x6f,0x00,0x40,0x21,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f29'}})
    fmin.d f29, f2, f27
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x40e23e6000000000(37363.0_d)                   0x7fffffff2140006f(nan_d)                       X
STATES DIFFER: True
```
...
f29                 0x40e23e6000000000(37363.0_d)                   0x7fffffff2140006f(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f2, f27
f2                  0x40e23e6000000000(37363.0_d)                   0x40e23e6000000000(37363.0_d)
f27                 0x7fffffff2140006f(nan_d)                       0x7fffffff2140006f(nan_d)
f29                 0x40e23e6000000000(37363.0_d)                   0x7fffffff2140006f(nan_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7f2fbfcf42374bf0f233f6e338afa1636cba1054        7f2fbfcf42374bf0f233f6e338afa1636cba1054        
