# FailID_001097 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x8, 0x801ff632            // fp
    li x9, 0x8017f849            // s1
    li x10, 0x8025d1c4           // a0
    li x11, 0x8017fa92           // a1
    li x12, 0x6000               // a2
    li x13, 0xc9bfc734           // a3
    li x14, 0x800007b8           // a4
    li x15, 0x81                 // a5
    li x16, 0x0                  // a6
    li x17, 0x8016bb8e           // a7
    li x18, 0x6000               // s2
    li x19, 0x8017fa7c           // s3
    li x20, 0xff                 // s4
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x1'}, 'clob': {'f14', 'x17', 'x1'}})
...
f14                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
f14                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, x32, x1
ra(x1)              0x000000008018058f(2149057935)                  0x000000008018058f(2149057935)
f14                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
+========================================================================================================================+
```
...
a4(x14)             0x00000000800007b8(2147485624)                  0x00000000800007b8(2147485624)                  
a5(x15)             0x0000000000000081(129)                         0x0000000000000081(129)                         
a6(x16)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a7(x17)             0x000000008000032b(2147484459)                  0x000000008000032b(2147484459)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            35e6e6442b94f928fc8c5470c96b29c7f659c711        35e6e6442b94f928fc8c5470c96b29c7f659c711        
