# FailID_002655 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x00,0x00,0x80,0xde,0x62,0x6f,0xee,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f4', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x18'}})
    fcvt.wu.d x18, f4, dyn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
s2(x18)             0xfffffffff37b16f4(18446744073499514612)        0x00000000f37b16f4(4084930292)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x18, f4, dyn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x18, f4
s2(x18)             0xfffffffff37b16f4(18446744073499514612)        0x00000000f37b16f4(4084930292)                  X
f4                  0x41ee6f62de800000(4084930292.0_d)              0x41ee6f62de800000(4084930292.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            04b19fb97e47edc444bdee319a71bd737980a9e4        04b19fb97e47edc444bdee319a71bd737980a9e4        
