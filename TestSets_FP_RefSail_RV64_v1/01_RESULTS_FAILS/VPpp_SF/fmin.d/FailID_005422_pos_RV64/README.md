# FailID_005422 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x6f,0x00,0x40,0x21,0x13,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f7'}, 'clob': {'f24'}})
    fmin.d f24, f3, f7
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x000000132140006f(4.05935308646e-313_d)        0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f3, f7
f3                  0x000000132140006f(4.05935308646e-313_d)        0x000000132140006f(4.05935308646e-313_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            22bb4851d0df22aa74ea68f6aa7a2acf54322a48        22bb4851d0df22aa74ea68f6aa7a2acf54322a48        
