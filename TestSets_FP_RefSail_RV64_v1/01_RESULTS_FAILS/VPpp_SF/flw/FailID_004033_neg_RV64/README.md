# FailID_004033 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x10, 0x10                 // a0
    li x11, 0xb8                 // a1
    li x12, 0x80180301           // a2
    li x13, 0x80180550           // a3
    li x14, 0x800002db           // a4
    li x15, 0x80205fd7           // a5
    li x16, 0x38                 // a6
    li x17, 0x8000011d           // a7
    li x18, 0x30                 // s2
    li x19, 0x0                  // s3
    li x20, 0x8017fc4c           // s4
    li x21, 0x7ffff86e           // s5
    li x22, 0xca                 // s6
    ...
    li x27, 0x0                  // s11
    li x28, 0x80180157           // t3
    li x29, 0x800004e4           // t4
    li x30, 0x6000               // t5
    li x31, 0x7ffff661           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x14', 'fcsr.rm'}, 'clob': {'x5', 'x14', 'f4'}})
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff00100093(1.469573929402115e-39_s)     X
STATES DIFFER: True
```
...
tp(x4)              0x0000000080180501(2149057793)                  0x0000000080180501(2149057793)                  
...
a2(x12)             0x0000000080180301(2149057281)                  0x0000000080180301(2149057281)                  
...
a7(x17)             0x000000008000011d(2147483933)                  0x000000008000011d(2147483933)                  
s2(x18)             0x0000000000000030(48)                          0x0000000000000030(48)                          
s3(x19)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s4(x20)             0x000000008017fc4c(2149055564)                  0x000000008017fc4c(2149055564)                  
s5(x21)             0x000000007ffff86e(2147481710)                  0x000000007ffff86e(2147481710)                  
...
t3(x28)             0x0000000080180157(2149056855)                  0x0000000080180157(2149056855)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0b836afe5437d2defebb5403303c1b26a2eaaeb3        0b836afe5437d2defebb5403303c1b26a2eaaeb3        
