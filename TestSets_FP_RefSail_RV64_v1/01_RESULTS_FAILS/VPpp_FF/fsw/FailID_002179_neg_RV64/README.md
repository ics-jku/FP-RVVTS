# FailID_002179 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x11, 0x801ff830           // a1
    li x12, 0x801ffdb5           // a2
    li x13, 0x8017fcc7           // a3
    li x14, 0x801865ff           // a4
    li x15, 0x7ffff8c9           // a5
    li x16, 0x801805a3           // a6
    li x17, 0x8027f34b           // a7
    li x18, 0x80000135           // s2
    li x19, 0x7ffffcfa           // s3
    li x20, 0x0                  // s4
    li x21, 0x801ffc6a           // s5
    li x22, 0x801809d6           // s6
    li x23, 0x6000               // s7
    li x24, 0x19e83000           // s8
    li x25, 0xffffffff803ffa56   // s9
    li x26, 0x0                  // s10
    li x27, 0x8017f9d3           // s11
    li x28, 0x801805a3           // t3
    li x29, 0x800003b6           // t4
    li x30, 0x8b                 // t5
    li x31, 0xb4                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs', 'f17'}, 'clob': {'x8', 'x6'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6de83acda39155a8cf8d6c38591c29c0f23c8adb        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x40, x8
fp(x8)              0x0000000080180040(2149056576)                  0x0000000080180040(2149056576)
...
ra(x1)              0x000000001748c000(390643712)                   0x000000001748c000(390643712)                   
...
t1(x6)              0x0000000080180040(2149056576)                  0x0000000080180040(2149056576)                  
...
a1(x11)             0x00000000801ff830(2149578800)                  0x00000000801ff830(2149578800)                  
a2(x12)             0x00000000801ffdb5(2149580213)                  0x00000000801ffdb5(2149580213)                  
a3(x13)             0x000000008017fcc7(2149055687)                  0x000000008017fcc7(2149055687)                  
...
a6(x16)             0x00000000801805a3(2149057955)                  0x00000000801805a3(2149057955)                  
a7(x17)             0x000000008027f34b(2150101835)                  0x000000008027f34b(2150101835)                  
s2(x18)             0x0000000080000135(2147483957)                  0x0000000080000135(2147483957)                  
...
s6(x22)             0x00000000801809d6(2149059030)                  0x00000000801809d6(2149059030)                  
...
s11(x27)            0x000000008017f9d3(2149054931)                  0x000000008017f9d3(2149054931)                  
t3(x28)             0x00000000801805a3(2149057955)                  0x00000000801805a3(2149057955)                  
t4(x29)             0x00000000800003b6(2147484598)                  0x00000000800003b6(2147484598)                  
t5(x30)             0x000000000000008b(139)                         0x000000000000008b(139)                         
t6(x31)             0x00000000000000b4(180)                         0x00000000000000b4(180)                         

STATE               REF                                             DUT                                             DIFF
xmemhash            7988201777da2cbb43a116bcb7fdd58a9fb2f780        7988201777da2cbb43a116bcb7fdd58a9fb2f780        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6de83acda39155a8cf8d6c38591c29c0f23c8adb        X
