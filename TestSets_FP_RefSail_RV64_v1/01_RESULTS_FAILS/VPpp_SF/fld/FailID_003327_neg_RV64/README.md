# FailID_003327 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x8, 0x6b                  // fp
    li x9, 0x800002d3            // s1
    li x10, 0x801800cc           // a0
    li x11, 0x80186701           // a1
    li x12, 0xd000000000000000   // a2
    li x13, 0x6000               // a3
    li x14, 0x1856b738           // a4
    li x15, 0x80000625           // a5
    li x16, 0x3454e768           // a6
    li x17, 0x0                  // a7
    li x18, 0x8017fba6           // s2
    li x19, 0x801809fa           // s3
    li x20, 0xff                 // s4
    li x21, 0x801806ec           // s5
    li x22, 0x801803a2           // s6
    li x23, 0x98                 // s7
    li x24, 0x1                  // s8
    li x25, 0x80000236           // s9
    li x26, 0x7ffffb8e           // s10
    li x27, 0xfffffffffffffd4c   // s11
    li x28, 0x8000073c           // t3
    li x29, 0x801804a1           // t4
    li x30, 0x0                  // t5
    li x31, 0xd7                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x19', 'fcsr.rm'}, 'clob': {'x12', 'f21', 'x19'}})
...
f21                 0xffffffff4f0017fa(2149054976.0_s)              0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
f21                 0xffffffff4f0017fa(2149054976.0_s)              0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f21, x1, e2, x19
ra(x1)              0x0000000080180264(2149057124)                  0x0000000080180264(2149057124)
s3(x19)             0x0000000080180bda(2149059546)                  0x0000000080180bda(2149059546)
f21                 0xffffffff4f0017fa(2149054976.0_s)              0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
t0(x5)              0x0000000071efb000(1911533568)                  0x0000000071efb000(1911533568)                  
...
fp(x8)              0x000000000000006b(107)                         0x000000000000006b(107)                         
s1(x9)              0x00000000800002d3(2147484371)                  0x00000000800002d3(2147484371)                  
a0(x10)             0x00000000801800cc(2149056716)                  0x00000000801800cc(2149056716)                  
a1(x11)             0x0000000080186701(2149082881)                  0x0000000080186701(2149082881)                  
a2(x12)             0x00000000800001e2(2147484130)                  0x00000000800001e2(2147484130)                  
a3(x13)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
a4(x14)             0x000000001856b738(408336184)                   0x000000001856b738(408336184)                   
a5(x15)             0x0000000080000625(2147485221)                  0x0000000080000625(2147485221)                  
a6(x16)             0x000000003454e768(877979496)                   0x000000003454e768(877979496)                   
...
s5(x21)             0x00000000801806ec(2149058284)                  0x00000000801806ec(2149058284)                  
s6(x22)             0x00000000801803a2(2149057442)                  0x00000000801803a2(2149057442)                  
s7(x23)             0x0000000000000098(152)                         0x0000000000000098(152)                         
s8(x24)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s9(x25)             0x0000000080000236(2147484214)                  0x0000000080000236(2147484214)                  
s10(x26)            0x000000007ffffb8e(2147482510)                  0x000000007ffffb8e(2147482510)                  
...
t6(x31)             0x00000000000000d7(215)                         0x00000000000000d7(215)                         

STATE               REF                                             DUT                                             DIFF
xmemhash            a31f6af5ec759de82bb1344c683139ebdc427e4a        a31f6af5ec759de82bb1344c683139ebdc427e4a        
