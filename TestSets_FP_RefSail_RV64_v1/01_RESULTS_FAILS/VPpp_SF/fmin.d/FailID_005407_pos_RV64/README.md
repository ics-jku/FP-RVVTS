# FailID_005407 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x13,0x02,0x00,0x80,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xd8,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f8'}, 'clob': {'f0'}})
    fmin.d f0, f8, f9
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0x40d8000000000000(24576.0_d)                   0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f0, f8, f9
f0                  0x40d8000000000000(24576.0_d)                   0xffffffff7fc00000(nan_s)                       X
f8                  0x40d8000000000000(24576.0_d)                   0x40d8000000000000(24576.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            107da6300f1111bebb3fa6dc1194583fde172519        107da6300f1111bebb3fa6dc1194583fde172519        
