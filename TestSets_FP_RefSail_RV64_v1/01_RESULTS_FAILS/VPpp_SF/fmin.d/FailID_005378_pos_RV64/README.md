# FailID_005378 VP++ SF pos RV64 fmin.d
...
_reg_f21:.byte 0xff,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f22:.byte 0x4d,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'f15'}})
    fmin.d f15, f22, f21
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x000000000000004d(3.8e-322_d)                  0xffffffff4effffff(2147483520.0_s)              X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f15, f22, f21
+========================================================================================================================+
Attributes:  special values ['zero'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
f15                 0x000000000000004d(3.8e-322_d)                  0xffffffff4effffff(2147483520.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f22, f21
f15                 0x000000000000004d(3.8e-322_d)                  0xffffffff4effffff(2147483520.0_s)              X
f21                 0xffffffff4effffff(2147483520.0_s)              0xffffffff4effffff(2147483520.0_s)
f22                 0x000000000000004d(3.8e-322_d)                  0x000000000000004d(3.8e-322_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9c6acbb0bcb6700fd23a180042b444a4ac60bb37        9c6acbb0bcb6700fd23a180042b444a4ac60bb37        
