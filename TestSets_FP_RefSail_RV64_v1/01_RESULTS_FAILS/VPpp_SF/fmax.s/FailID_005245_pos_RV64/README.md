# FailID_005245 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f14'}})
    fmax.s f14, f13, f5
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7b03f30526d60b0faa7fe04ac582479ed4387586        7b03f30526d60b0faa7fe04ac582479ed4387586        
