# FailID_005187 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x00,0x00,0xc0,0xff,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x00,0x00,0xc0,0x7f,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f8'}, 'clob': {'f6'}})
    fmax.d f6, f8, f23
```
...
STATE               REF                                             DUT                                             DIFF
f6                  0x41dfffff7fc00000(2147483135.0_d)              0xffffffff0002b587(2.48790733251621e-40_s)      X
STATES DIFFER: True
```
...
Registers: f6, f8, f23
f6                  0x41dfffff7fc00000(2147483135.0_d)              0xffffffff0002b587(2.48790733251621e-40_s)      X
f8                  0x41dfffff7fc00000(2147483135.0_d)              0x41dfffff7fc00000(2147483135.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b2928211cde8ca658f33b8f8987bfc0daf184984        b2928211cde8ca658f33b8f8987bfc0daf184984        
