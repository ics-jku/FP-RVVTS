# FailID_000401 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fsqrt.s f10, f24, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff7fc00000(nan_s)                       0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f10, f24, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1aaafdfdd6d0d321a080d2f2bf7a8d71435bfe3        c1aaafdfdd6d0d321a080d2f2bf7a8d71435bfe3        
