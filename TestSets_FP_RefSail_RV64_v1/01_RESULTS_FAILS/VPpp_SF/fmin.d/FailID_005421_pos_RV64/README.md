# FailID_005421 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_reg_f10:.byte 0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff
_reg_f28:.byte 0x00,0x00,0x00,0xd2,0x4d,0x77,0xd0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f28', 'f8'}, 'clob': {'f10'}})
    fmin.d f10, f28, f8
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0x41d0774dd2000000(1105016648.0_d)              0xffffffff3f800000(1.0_s)                       X
STATES DIFFER: True
```
...
f10                 0x41d0774dd2000000(1105016648.0_d)              0xffffffff3f800000(1.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f28, f8
f8                  0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
f10                 0x41d0774dd2000000(1105016648.0_d)              0xffffffff3f800000(1.0_s)                       X
f28                 0x41d0774dd2000000(1105016648.0_d)              0x41d0774dd2000000(1105016648.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c7397032b007c95e4fb92581a1d452ecdb27f420        c7397032b007c95e4fb92581a1d452ecdb27f420        
