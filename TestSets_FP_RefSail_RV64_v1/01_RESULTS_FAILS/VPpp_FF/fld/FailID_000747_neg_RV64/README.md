# FailID_000747 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x11, 0x8000044e           // a1
    li x12, 0x8025cc5c           // a2
    li x13, 0x1                  // a3
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x24'}, 'clob': {'f20', 'x19', 'x24'}})
...
a2(x12)             0x000000008025cc5c(2149960796)                  0x000000008025cc5c(2149960796)                  
...
s5(x21)             0x0000000000000044(68)                          0x0000000000000044(68)                          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            de1756ae6945f0881db14c362f2aafd054351f1a        de1756ae6945f0881db14c362f2aafd054351f1a        
