# FailID_004131 VP++ SF neg RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f9'}, 'clob': {'f14'}})
    fmax.s f14, f6, f9
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0xffffffff4eff8000(2143289344.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            780366e2c0e6127124b420e367a843d5526c0e46        780366e2c0e6127124b420e367a843d5526c0e46        
