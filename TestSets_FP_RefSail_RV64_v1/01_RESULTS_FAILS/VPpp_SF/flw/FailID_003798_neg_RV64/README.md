# FailID_003798 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x27, 0xfffffffffffffff7   // s11
    li x28, 0x7ceda000           // t3
    li x29, 0x7ffff90b           // t4
    li x30, 0x0                  // t5
    li x31, 0x7ffffb99           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'f17', 'x27', 'x23'}})
...
t1(x6)              0x00000000000011d1(4561)                        0x00000000000011d1(4561)                        
...
a1(x11)             0x000000007ffff845(2147481669)                  0x000000007ffff845(2147481669)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ebe118d4cde0d17430a8790ca00d58cb2fe9aad0        ebe118d4cde0d17430a8790ca00d58cb2fe9aad0        
