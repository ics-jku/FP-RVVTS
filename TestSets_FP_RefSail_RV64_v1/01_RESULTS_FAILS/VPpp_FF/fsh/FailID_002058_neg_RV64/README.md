# FailID_002058 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x25, 0x1                  // s9
    li x26, 0x8017fe7b           // s10
    li x27, 0x802004eb           // s11
    li x28, 0x801ff67d           // t3
    li x29, 0xfd                 // t4
    li x30, 0x3ffff              // t5
    li x31, 0x801801c9           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f1', 'x29'}, 'clob': {'x31', 'x29'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, x230, x29
t4(x29)             0x000000008017fecc(2149056204)                  0x000000008017fecc(2149056204)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cc6fed8d2eb2c6bbae7f49389a25c46a2ecb303a        cc6fed8d2eb2c6bbae7f49389a25c46a2ecb303a        
