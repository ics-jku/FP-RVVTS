# FailID_005147 VP++ SF pos RV64 fmax.d
...
_reg_f25:.byte 0x00,0x00,0x00,0x00,0xc8,0x34,0xdb,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f16', 'fcsr.rm', 'f25'}, 'clob': {'f24'}})
    fmax.d f24, f25, f16
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x41db34c800000000(1825775616.0_d)              0xffffffffbf800000(-1.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f25, f16
+========================================================================================================================+
...
f24                 0x41db34c800000000(1825775616.0_d)              0xffffffffbf800000(-1.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f25, f16
f16                 0xffffffffbf800000(-1.0_s)                      0xffffffffbf800000(-1.0_s)
f24                 0x41db34c800000000(1825775616.0_d)              0xffffffffbf800000(-1.0_s)                      X
f25                 0x41db34c800000000(1825775616.0_d)              0x41db34c800000000(1825775616.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            28b2bc2dc2ca247af2892984181ca339a899e77e        28b2bc2dc2ca247af2892984181ca339a899e77e        
