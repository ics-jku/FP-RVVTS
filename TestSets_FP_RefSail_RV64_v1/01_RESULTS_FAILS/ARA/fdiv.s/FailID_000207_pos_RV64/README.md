# FailID_000207 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0xe5,0x15,0x35,0x47,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f25'}})
    fdiv.s f25, f3, f27, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f3, f27, rtz
+========================================================================================================================+
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f3, f27
f3                  0x7fffffff473515e5(nan_d)                       0x7fffffff473515e5(nan_d)
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            05187a8ec05331992c35a53b506717d8ef476411        05187a8ec05331992c35a53b506717d8ef476411        
