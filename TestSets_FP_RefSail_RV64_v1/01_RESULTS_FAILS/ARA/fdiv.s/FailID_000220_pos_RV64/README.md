# FailID_000220 ARA pos RV64 fdiv.s
...
_reg_f29:.byte 0xfd,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f22'}})
    fdiv.s f22, f6, f29, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f22, f6, f29, rtz
+========================================================================================================================+
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f6, f29
f6                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f29                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff4f0017fd(2149055744.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a537b9c3631902dc30c0f069b2a5aba3eff14daf        a537b9c3631902dc30c0f069b2a5aba3eff14daf        
