# FailID_000328 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0xff,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f9', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fsqrt.s f10, f9, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff473504f2(46340.9453125_s)             0xffffffff473504f3(46340.94921875_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f10, f9, rdn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f9
f9                  0xffffffff4effffff(2147483520.0_s)              0xffffffff4effffff(2147483520.0_s)
f10                 0xffffffff473504f2(46340.9453125_s)             0xffffffff473504f3(46340.94921875_s)            X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c266ab7800d69a6161555a3774c9b46942874300        c266ab7800d69a6161555a3774c9b46942874300        
