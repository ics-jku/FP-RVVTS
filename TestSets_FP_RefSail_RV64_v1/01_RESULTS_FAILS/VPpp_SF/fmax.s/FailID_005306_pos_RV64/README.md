# FailID_005306 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f15:.byte 0x9d,0x00,0x00,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f16', 'fcsr.rm'}, 'clob': {'f27'}})
    fmax.s f27, f15, f16
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff8000009d(-2.200038588989963e-43_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f27, f15, f16
+========================================================================================================================+
...
f27                 0xffffffff8000009d(-2.200038588989963e-43_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f15, f16
f15                 0xffffffff8000009d(-2.200038588989963e-43_s)    0xffffffff8000009d(-2.200038588989963e-43_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e93587b9003b257791d0eeb220ccdb0ed84e2cfb        e93587b9003b257791d0eeb220ccdb0ed84e2cfb        
