# FailID_004166 VP++ SF neg RV64 fmin.s
...
_reg_f28:.byte 0xe2,0xff,0x17,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm', 'f25'}, 'clob': {'f28'}})
    fmin.s f28, f21, f25
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff1421b827(8.164740413544605e-27_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f28, f21, f25
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b5c991d2aa47e34cf8a896d6ae9eb62c3b4c0548        b5c991d2aa47e34cf8a896d6ae9eb62c3b4c0548        
