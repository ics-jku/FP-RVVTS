# FailID_000168 ARA pos RV64 fdiv.s
...
_reg_f27:.byte 0x6d,0xff,0x7f,0x1a,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs', 'f4'}, 'clob': {'f19'}})
    fdiv.s f19, f27, f4, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f19, f27, f4, rtz
+========================================================================================================================+
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f27, f4
f4                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f27                 0xffffffff1a7fff6d(5.29390953531815e-23_s)      0xffffffff1a7fff6d(5.29390953531815e-23_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e9d362ba16854b6f04f2a0946b7f4728027f2cf2        e9d362ba16854b6f04f2a0946b7f4728027f2cf2        
