# FailID_002041 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x8, 0x0                   // fp
    li x9, 0x1002                // s1
    li x10, 0x8000004b           // a0
    li x11, 0x800007f5           // a1
    li x12, 0x8017ffe6           // a2
    li x13, 0x7ffff83a           // a3
    li x14, 0x80180557           // a4
    li x15, 0x800d4bf1           // a5
    li x16, 0x801803ec           // a6
    li x17, 0x0                  // a7
    li x18, 0x8000018d           // s2
    li x19, 0x6000               // s3
    li x20, 0x8027ffdd           // s4
    li x21, 0x1                  // s5
    li x22, 0x0                  // s6
    li x23, 0x80000607           // s7
    li x24, 0x18                 // s8
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x6', 'f19'}, 'clob': {'x16', 'x6'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fd1eb7978ab4a3bbda99a41e4791043b4858384d        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x2, x6
sp(x2)              0x000000007ffffdad(2147483053)                  0x000000007ffffdad(2147483053)
...
t1(x6)              0x00000000802004dd(2149582045)                  0x00000000802004dd(2149582045)                  
t2(x7)              0x000000008017fee6(2149056230)                  0x000000008017fee6(2149056230)                  
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0x0000000000001002(4098)                        0x0000000000001002(4098)                        
a0(x10)             0x000000008000004b(2147483723)                  0x000000008000004b(2147483723)                  
...
a3(x13)             0x000000007ffff83a(2147481658)                  0x000000007ffff83a(2147481658)                  
a4(x14)             0x0000000080180557(2149057879)                  0x0000000080180557(2149057879)                  
a5(x15)             0x00000000800d4bf1(2148355057)                  0x00000000800d4bf1(2148355057)                  
a6(x16)             0x000000008017fd31(2149055793)                  0x000000008017fd31(2149055793)                  
...
s4(x20)             0x000000008027ffdd(2150105053)                  0x000000008027ffdd(2150105053)                  
s5(x21)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s6(x22)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s7(x23)             0x0000000080000607(2147485191)                  0x0000000080000607(2147485191)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dfc4c47791d2c27608f58cf750beed76363af92d        dfc4c47791d2c27608f58cf750beed76363af92d        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fd1eb7978ab4a3bbda99a41e4791043b4858384d        X
