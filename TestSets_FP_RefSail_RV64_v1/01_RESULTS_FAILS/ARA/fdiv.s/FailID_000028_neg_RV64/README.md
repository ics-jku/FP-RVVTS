# FailID_000028 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f0', 'f25'}, 'clob': {'f29'}})
    fdiv.s f29, f25, f0, rmm
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f25, f0, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            78feb2a1684ea185c1687ea4127b6a12db2f0bd8        78feb2a1684ea185c1687ea4127b6a12db2f0bd8        
