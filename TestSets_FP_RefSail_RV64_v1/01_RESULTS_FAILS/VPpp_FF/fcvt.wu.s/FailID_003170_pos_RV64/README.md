# FailID_003170 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0x00,0x00,0x00,0x00,0x00,0x40,0x58,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x20, f13, rmm
+========================================================================================================================+
...
Registers: x20, f13
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f13                 0x4058400000000000(97.0_d)                      0x4058400000000000(97.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            21ba86e034a518ef0c5022f48750e914de8c99ad        21ba86e034a518ef0c5022f48750e914de8c99ad        
