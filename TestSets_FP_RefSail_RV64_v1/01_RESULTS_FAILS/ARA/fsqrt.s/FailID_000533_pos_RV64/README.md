# FailID_000533 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x90,0xf7,0x1e,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f12'}})
    fsqrt.s f12, f17, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f12, f17, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6846962a41872a543a72b989dcf06592711865f3        6846962a41872a543a72b989dcf06592711865f3        
