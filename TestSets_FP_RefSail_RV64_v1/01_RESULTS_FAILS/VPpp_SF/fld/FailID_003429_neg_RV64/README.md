# FailID_003429 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x30                 // t6
    // INSTRUCTION ({'dep': {'x16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x16', 'f16', 'x30'}})
...
f16                 0x7354639b9bc5611e(3.5639726539380704e+247_d)   0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e98f19cee3b453fb7958fddd7b15b4946cb24f47        e98f19cee3b453fb7958fddd7b15b4946cb24f47        
