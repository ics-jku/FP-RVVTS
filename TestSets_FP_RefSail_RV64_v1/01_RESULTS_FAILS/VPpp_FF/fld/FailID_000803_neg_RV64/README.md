# FailID_000803 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x13, 0x8017fe97           // a3
    li x14, 0x80005805           // a4
    li x15, 0x8027f2f3           // a5
    li x16, 0x8025d4c9           // a6
    li x17, 0x80                 // a7
    li x18, 0xb7                 // s2
    li x19, 0x8017f843           // s3
    li x20, 0x400bff6            // s4
    li x21, 0xffffffffdf297000   // s5
    li x22, 0x8017fed3           // s6
    li x23, 0x80005c45           // s7
    li x24, 0x0                  // s8
    li x25, 0x8017f842           // s9
    li x26, 0x92e2275c           // s10
    li x27, 0x7ffff9ac           // s11
    li x28, 0x801ff423           // t3
    li x29, 0x42                 // t4
    li x30, 0x8017fed7           // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'f25', 'x25', 'x20'}})
...
f25                 0x43dfffffffffffff(9.223372036854775e+18_d)     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, x25
s9(x25)             0x000000008017f93a(2149054778)                  0x000000008017f93a(2149054778)
f25                 0x43dfffffffffffff(9.223372036854775e+18_d)     0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
t1(x6)              0x000000008027fe0b(2150104587)                  0x000000008027fe0b(2150104587)                  
...
a3(x13)             0x000000008017fe97(2149056151)                  0x000000008017fe97(2149056151)                  
a4(x14)             0x0000000080005805(2147506181)                  0x0000000080005805(2147506181)                  
a5(x15)             0x000000008027f2f3(2150101747)                  0x000000008027f2f3(2150101747)                  
a6(x16)             0x000000008025d4c9(2149962953)                  0x000000008025d4c9(2149962953)                  
a7(x17)             0x0000000000000080(128)                         0x0000000000000080(128)                         
s2(x18)             0x00000000000000b7(183)                         0x00000000000000b7(183)                         
...
s5(x21)             0xffffffffdf297000(18446744073158619136)        0xffffffffdf297000(18446744073158619136)        
s6(x22)             0x000000008017fed3(2149056211)                  0x000000008017fed3(2149056211)                  
s7(x23)             0x0000000080005c45(2147507269)                  0x0000000080005c45(2147507269)                  
s8(x24)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s9(x25)             0x000000008017f93a(2149054778)                  0x000000008017f93a(2149054778)                  
s10(x26)            0x0000000092e2275c(2464294748)                  0x0000000092e2275c(2464294748)                  
...
t4(x29)             0x0000000000000042(66)                          0x0000000000000042(66)                          
t5(x30)             0x000000008017fed7(2149056215)                  0x000000008017fed7(2149056215)                  
t6(x31)             0x0000000000000001(1)                           0x0000000000000001(1)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            74183fd209539f7e65a12569efe18ebab82dda98        74183fd209539f7e65a12569efe18ebab82dda98        
