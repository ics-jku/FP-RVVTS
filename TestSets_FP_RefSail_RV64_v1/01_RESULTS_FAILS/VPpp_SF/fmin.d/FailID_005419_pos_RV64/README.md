# FailID_005419 VP++ SF pos RV64 fmin.d
...
_reg_f5: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f12'}, 'clob': {'f5'}})
    fmin.d f5, f12, f4
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            15189a15029a192f1237e1c899991f3ac836268b        15189a15029a192f1237e1c899991f3ac836268b        
