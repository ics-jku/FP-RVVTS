# FailID_002630 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f31:.byte 0x00,0x00,0x20,0x42,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f31
    fld  f31, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x25'}})
    fcvt.wu.d x25, f31, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x25, f31, rmm
+========================================================================================================================+
Attributes:  fcsr ['invalid'], special values ['zero'], precision mismatch ('d', 's')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x25, f31
s9(x25)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f31                 0xffffffff42200000(40.0_s)                      0xffffffff42200000(40.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fc719430ad18ca1c4879f3b8f2b152c34b69091b        fc719430ad18ca1c4879f3b8f2b152c34b69091b        
