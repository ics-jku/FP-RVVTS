# FailID_000005 ARA neg RV64 fdiv.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f17', 'f13', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f16'}})
    fdiv.h f16, f17, f13, rne
```
...
f16                 0xffffffffffff7e00(nan_h)                       0xfffffffffffffc00(-inf_h)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.h f16, f17, f13, rne
+========================================================================================================================+
Attributes:  fcsr ['div-by-0'], special values ['nan', 'inf'], precision mismatch ('h', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0ccabda2d70d5f25f4e128223960ac9d6738a494        0ccabda2d70d5f25f4e128223960ac9d6738a494        
