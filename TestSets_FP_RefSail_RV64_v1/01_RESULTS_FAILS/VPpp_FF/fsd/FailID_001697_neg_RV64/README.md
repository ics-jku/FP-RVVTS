# FailID_001697 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x9, 0x801802c2            // s1
    li x10, 0x5                  // a0
    li x11, 0x80000302           // a1
    li x12, 0x8017fdf4           // a2
    li x13, 0x51                 // a3
    ...
    li x21, 0x8017f9b9           // s5
    li x22, 0xc8fa2768           // s6
    li x23, 0x62                 // s7
    li x24, 0x801801e1           // s8
    li x25, 0x1                  // s9
    li x26, 0x8020007c           // s10
    li x27, 0xffffffff92818000   // s11
    li x28, 0x6000               // t3
    li x29, 0x7fffff720          // t4
    li x30, 0x80236151           // t5
    li x31, 0xf061f76c           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x2', 'f20'}, 'clob': {'x2', 'x12'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9bbe3216cbf08f138768ba2aa3a57285ed015553        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, x618, x2
sp(x2)              0x000000008027ff08(2150104840)                  0x000000008027ff08(2150104840)
...
sp(x2)              0x000000008027ff08(2150104840)                  0x000000008027ff08(2150104840)                  
gp(x3)              0x000000004c9a3000(1285173248)                  0x000000004c9a3000(1285173248)                  
...
a1(x11)             0x0000000080000302(2147484418)                  0x0000000080000302(2147484418)                  
...
a7(x17)             0x000000000000b741(46913)                       0x000000000000b741(46913)                       
...
s5(x21)             0x000000008017f9b9(2149054905)                  0x000000008017f9b9(2149054905)                  
...
s11(x27)            0xffffffff92818000(18446744071872544768)        0xffffffff92818000(18446744071872544768)        
...
t5(x30)             0x0000000080236151(2149802321)                  0x0000000080236151(2149802321)                  
t6(x31)             0x00000000f061f76c(4032952172)                  0x00000000f061f76c(4032952172)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            15196d9f763e546afc4ae1debc25ace735224d5b        15196d9f763e546afc4ae1debc25ace735224d5b        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        9bbe3216cbf08f138768ba2aa3a57285ed015553        X
