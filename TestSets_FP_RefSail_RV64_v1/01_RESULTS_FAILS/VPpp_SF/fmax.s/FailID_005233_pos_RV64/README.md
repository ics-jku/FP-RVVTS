# FailID_005233 VP++ SF pos RV64 fmax.s
...
_reg_f15:.byte 0xfb,0xff,0xff,0xce,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f15', 'f14', 'fcsr.rm'}, 'clob': {'f22'}})
    fmax.s f22, f15, f14
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffffcefffffb(-2147483008.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f22, f15, f14
+========================================================================================================================+
...
f22                 0xffffffffcefffffb(-2147483008.0_s)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f15, f14
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f15                 0xffffffffcefffffb(-2147483008.0_s)             0xffffffffcefffffb(-2147483008.0_s)
f22                 0xffffffffcefffffb(-2147483008.0_s)             0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4c6e7ce631b36142cb7fe6e5dea1f2733b13d2d7        4c6e7ce631b36142cb7fe6e5dea1f2733b13d2d7        
