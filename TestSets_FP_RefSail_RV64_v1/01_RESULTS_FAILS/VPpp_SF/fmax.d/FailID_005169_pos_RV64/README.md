# FailID_005169 VP++ SF pos RV64 fmax.d
...
_reg_f31:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x40
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f31'}, 'clob': {'f29'}})
    fmax.d f29, f31, f5
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0x4080000000000000(512.0_d)                     0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f29                 0x4080000000000000(512.0_d)                     0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f31, f5
f5                  0xffffffff00000000(0.0_s)                       0xffffffff00000000(0.0_s)
f29                 0x4080000000000000(512.0_d)                     0xffffffff00000000(0.0_s)                       X
f31                 0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d3362a4e6756b846b6947906ec953d82848e8e99        d3362a4e6756b846b6947906ec953d82848e8e99        
