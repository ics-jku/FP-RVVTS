# FailID_004148 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f25'}, 'clob': {'f13'}})
    fmin.d f13, f6, f25
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0x4063000000000000(152.0_d)                     0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8337492aab4e4369a3d3b00a4726934b774e1951        8337492aab4e4369a3d3b00a4726934b774e1951        
