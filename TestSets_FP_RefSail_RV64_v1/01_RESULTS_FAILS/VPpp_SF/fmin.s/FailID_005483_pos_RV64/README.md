# FailID_005483 VP++ SF pos RV64 fmin.s
...
_reg_f9: .byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f5'}})
    fmin.s f5, f9, f2
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f5                  0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
f9                  0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5c2f09d3688140fcb91eb581a1a2f6c39857a050        5c2f09d3688140fcb91eb581a1a2f6c39857a050        
