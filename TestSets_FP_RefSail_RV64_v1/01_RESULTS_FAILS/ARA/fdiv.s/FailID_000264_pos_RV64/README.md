# FailID_000264 ARA pos RV64 fdiv.s
...
_reg_f14:.byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'f14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f31'}})
    fdiv.s f31, f14, f3, rtz
```
...
f31                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f31, f14, f3, rtz
+========================================================================================================================+
...
f31                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f14, f3
f3                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f14                 0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
f31                 0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            263637eed9e4ea8542fffe767acc0ae66c948d99        263637eed9e4ea8542fffe767acc0ae66c948d99        
