# FailID_005377 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x41,0x91,0x19,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f15', 'fcsr.rm'}, 'clob': {'f2'}})
    fmin.d f2, f15, f20
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4fe6ded3b66c3360f8730ad016750a29a413339a        4fe6ded3b66c3360f8730ad016750a29a413339a        
