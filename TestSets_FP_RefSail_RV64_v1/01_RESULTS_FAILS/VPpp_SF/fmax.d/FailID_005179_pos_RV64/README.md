# FailID_005179 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x80
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'f11', 'fcsr.rm'}, 'clob': {'f20'}})
    fmax.d f20, f3, f11
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x8000000000000000(-0.0_d)                      0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f20                 0x8000000000000000(-0.0_d)                      0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f3, f11
f3                  0x8000000000000000(-0.0_d)                      0x8000000000000000(-0.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f8b258fb0ca46dd31b1a5bf8533edfaf821e7556        f8b258fb0ca46dd31b1a5bf8533edfaf821e7556        
