# FailID_005524 VP++ SF pos RV64 fmin.s
...
_reg_f20:.byte 0x00,0x00,0x00,0x00,0x00,0x20,0x60,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f26'}, 'clob': {'f20'}})
    fmin.s f20, f10, f26
```
...
```
+========================================================================================================================+
Instruction: fmin.s f20, f10, f26
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7021f6b031019248f13c024d50385fdf6f03cd34        7021f6b031019248f13c024d50385fdf6f03cd34        
