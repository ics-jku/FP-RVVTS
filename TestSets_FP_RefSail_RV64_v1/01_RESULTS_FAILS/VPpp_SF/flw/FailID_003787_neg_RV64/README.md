# FailID_003787 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x8027fecb            // fp
    li x9, 0x1                   // s1
    li x10, 0x8018021c           // a0
    li x11, 0x801802c6           // a1
    li x12, 0x8017f8ca           // a2
    li x13, 0x400c20b9800        // a3
    li x14, 0x4a6                // a4
    li x15, 0x8017fa71           // a5
    li x16, 0x801801a3           // a6
    li x17, 0x4611c000           // a7
    li x18, 0x8017f8             // s2
    li x19, 0x80180a29           // s3
    li x20, 0x8018685c           // s4
    li x21, 0x7fffffd9           // s5
    li x22, 0x80184173           // s6
    li x23, 0x80000630           // s7
    li x24, 0x801ff81c           // s8
    li x25, 0x87                 // s9
    li x26, 0x7fffffd1           // s10
    li x27, 0x801918ca           // s11
    li x28, 0xb1                 // t3
    li x29, 0x7ffff8a3           // t4
    li x30, 0x801ffee1           // t5
    li x31, 0x35                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'x27', 'x10', 'f19'}})
...
f19                 0xffffffff80246cda(-3.345126444694559e-39_s)    0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f19                 0xffffffff80246cda(-3.345126444694559e-39_s)    0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x366, x10
a0(x10)             0x0000000080180582(2149057922)                  0x0000000080180582(2149057922)
f19                 0xffffffff80246cda(-3.345126444694559e-39_s)    0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
ra(x1)              0x0000000000000023(35)                          0x0000000000000023(35)                          
...
tp(x4)              0x00000000801fd09c(2149568668)                  0x00000000801fd09c(2149568668)                  
t0(x5)              0x00000000801ffa36(2149579318)                  0x00000000801ffa36(2149579318)                  
t1(x6)              0x000000008017fa2c(2149055020)                  0x000000008017fa2c(2149055020)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x000000008027fecb(2150104779)                  0x000000008027fecb(2150104779)                  
...
a3(x13)             0x00000400c20b9800(4401302050816)               0x00000400c20b9800(4401302050816)               
a4(x14)             0x00000000000004a6(1190)                        0x00000000000004a6(1190)                        
a5(x15)             0x000000008017fa71(2149055089)                  0x000000008017fa71(2149055089)                  
...
s2(x18)             0x00000000008017f8(8394744)                     0x00000000008017f8(8394744)                     
...
s5(x21)             0x000000007fffffd9(2147483609)                  0x000000007fffffd9(2147483609)                  
...
s8(x24)             0x00000000801ff81c(2149578780)                  0x00000000801ff81c(2149578780)                  
s9(x25)             0x0000000000000087(135)                         0x0000000000000087(135)                         
s10(x26)            0x000000007fffffd1(2147483601)                  0x000000007fffffd1(2147483601)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            10d8c924b5dd6d57cb13e3b111bdbe6c23865a9e        10d8c924b5dd6d57cb13e3b111bdbe6c23865a9e        
