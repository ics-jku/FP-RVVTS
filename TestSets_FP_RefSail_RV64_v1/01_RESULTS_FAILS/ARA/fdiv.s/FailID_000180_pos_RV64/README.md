# FailID_000180 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x00,0x00,0xa0,0x92,0xff,0x02,0xe0,0x41
_reg_f19:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f19'}})
    fdiv.s f19, f19, f8
```
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffffec4ccccd(-9.903520461856995e+26_s)    X
STATES DIFFER: True
```
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffffec4ccccd(-9.903520461856995e+26_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f19, f8
f8                  0x41e002ff92a00000(2149055637.0_d)              0x41e002ff92a00000(2149055637.0_d)
f19                 0xffffffff7fc00000(nan_s)                       0xffffffffec4ccccd(-9.903520461856995e+26_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9d06f33b407bdb55ea9148835eaac08160195a2d        9d06f33b407bdb55ea9148835eaac08160195a2d        
