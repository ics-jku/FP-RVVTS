# FailID_000087 ARA neg RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f29'}, 'clob': {'f19'}})
    fsqrt.s f19, f29, rup
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff43000000(128.0_s)                     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f19, f29, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            57a599f8077b78ebdb347901ca758e8feb5df9b5        57a599f8077b78ebdb347901ca758e8feb5df9b5        
