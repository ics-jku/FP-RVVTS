# FailID_004192 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'x12'}})
    fmv.x.h x12, f3
```
...
```
REG                 REF                                             DUT                                             DIFF
a2(x12)             0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2ee346d59a6f7225b23310145dc351ecddb00e48        2ee346d59a6f7225b23310145dc351ecddb00e48        
