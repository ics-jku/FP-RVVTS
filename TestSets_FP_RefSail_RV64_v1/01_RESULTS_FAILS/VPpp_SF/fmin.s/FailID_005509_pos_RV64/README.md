# FailID_005509 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f0', 'fcsr.rm'}, 'clob': {'f22'}})
    fmin.s f22, f0, f20
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f22                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f0, f20
f0                  0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5f406a3ab9a70ebbcb2c7c6b9cb195c4a2bd35c2        5f406a3ab9a70ebbcb2c7c6b9cb195c4a2bd35c2        
