# FailID_005300 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x63,0x53,0x94,0x5e,0xa2,0xaa,0xe6,0xf5
_reg_f19:.byte 0x81,0x32,0xac,0x9c,0x70,0x31,0x5a,0x1b
_reg_f26:.byte 0xa3,0x8e,0x9c,0xcb,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f26', 'fcsr.rm'}, 'clob': {'f1'}})
    fmax.s f1, f26, f19
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffffcb9c8ea3(-20520262.0_s)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f1                  0xffffffffcb9c8ea3(-20520262.0_s)               0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f26, f19
f1                  0xffffffffcb9c8ea3(-20520262.0_s)               0xffffffff7fc00000(nan_s)                       X
f19                 0x1b5a31709cac3281(6.463829118677696e-177_d)    0x1b5a31709cac3281(6.463829118677696e-177_d)
f26                 0xffffffffcb9c8ea3(-20520262.0_s)               0xffffffffcb9c8ea3(-20520262.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            afc141508f714bcae23df21e49b4cd93475f4c9b        afc141508f714bcae23df21e49b4cd93475f4c9b        
