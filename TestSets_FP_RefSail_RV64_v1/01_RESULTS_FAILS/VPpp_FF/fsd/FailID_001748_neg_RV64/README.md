# FailID_001748 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x24, 0x0                  // s8
    li x25, 0x800000f1           // s9
    li x26, 0x7fffff97           // s10
    li x27, 0x8017ff83           // s11
    li x28, 0x80000009           // t3
    li x29, 0x3d                 // t4
    li x30, 0x8017fe04           // t5
    li x31, 0x57                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x7', 'f12'}, 'clob': {'x17', 'x7'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        220b6ad0385e60ed2d68f79df34ff0f0ef36e3f8        X
...
```
+========================================================================================================================+
Instruction: fsd f12, 0x781(x7)
+========================================================================================================================+
Attributes:  fcsr ['div-by-0'], special values ['inf']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
t2(x7)              0x00000000801ff67f(2149578367)                  0x00000000801ff67f(2149578367)                  
fp(x8)              0x000000008017fcfc(2149055740)                  0x000000008017fcfc(2149055740)                  
...
a4(x14)             0x00000000801803ec(2149057516)                  0x00000000801803ec(2149057516)                  
...
a7(x17)             0x000000008017f87f(2149054591)                  0x000000008017f87f(2149054591)                  
...
s11(x27)            0x000000008017ff83(2149056387)                  0x000000008017ff83(2149056387)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1419057de0f9d69751157cf2d6d982d0fd22d8ee        1419057de0f9d69751157cf2d6d982d0fd22d8ee        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        220b6ad0385e60ed2d68f79df34ff0f0ef36e3f8        X
