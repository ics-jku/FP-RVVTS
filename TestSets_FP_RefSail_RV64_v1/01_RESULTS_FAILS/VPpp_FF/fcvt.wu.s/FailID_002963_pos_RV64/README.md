# FailID_002963 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0x00,0xc0,0x7f,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4'}})
    fcvt.wu.s x4, f25
```
...
```
REG                 REF                                             DUT                                             DIFF
tp(x4)              0xffffffffffc00000(18446744073705357312)        0x00000000ffc00000(4290772992)                  X
...
Registers: x4, f25
tp(x4)              0xffffffffffc00000(18446744073705357312)        0x00000000ffc00000(4290772992)                  X
f25                 0xffffffff4f7fc000(4290772992.0_s)              0xffffffff4f7fc000(4290772992.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            609cd76eea2fc05308b29776a65cf2a852eeb640        609cd76eea2fc05308b29776a65cf2a852eeb640        
