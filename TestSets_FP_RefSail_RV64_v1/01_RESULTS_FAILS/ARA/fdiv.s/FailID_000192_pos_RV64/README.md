# FailID_000192 ARA pos RV64 fdiv.s
...
_reg_f16:.byte 0xf8,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'fcsr.rm', 'f2', 'mstatus.fs/vs.fs'}, 'clob': {'f4'}})
    fdiv.s f4, f16, f2, rne
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f4, f16, f2, rne
+========================================================================================================================+
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff7f800000(inf_s)                       X
f16                 0xffffffff4f0017f8(2149054464.0_s)              0xffffffff4f0017f8(2149054464.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ecf09235ff37bb05f99ce2d25b264725cd3abcca        ecf09235ff37bb05f99ce2d25b264725cd3abcca        
