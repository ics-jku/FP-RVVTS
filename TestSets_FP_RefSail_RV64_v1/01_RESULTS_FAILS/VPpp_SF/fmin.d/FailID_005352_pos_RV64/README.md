# FailID_005352 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f8'}, 'clob': {'f15'}})
    fmin.d f15, f8, f19
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            490804c1b08d9483f2a732fd41d17a89e46adbba        490804c1b08d9483f2a732fd41d17a89e46adbba        
