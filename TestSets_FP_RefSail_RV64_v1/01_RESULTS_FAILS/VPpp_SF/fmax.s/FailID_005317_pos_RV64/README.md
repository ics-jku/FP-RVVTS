# FailID_005317 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f25'}})
    fmax.s f25, f6, f9
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            15254e66fd75bf1a87fd9ece335e1b59bba96a02        15254e66fd75bf1a87fd9ece335e1b59bba96a02        
