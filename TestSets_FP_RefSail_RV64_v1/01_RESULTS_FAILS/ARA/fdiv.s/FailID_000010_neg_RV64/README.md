# FailID_000010 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f7', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f10'}, 'clob': {'f12'}})
    fdiv.s f12, f10, f7, rtz
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff7fc00000(nan_s)                       0xffffffff96a00000(-2.5849394142282115e-25_s)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f12, f10, f7, rtz
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6be5ff9ca99ac0d84663a6ca699ca147b979dbc3        6be5ff9ca99ac0d84663a6ca699ca147b979dbc3        
