# FailID_000098 ARA neg RV64 fsqrt.s
...
_reg_f29:.byte 0x93,0x82,0xc2,0xea,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f21'}, 'clob': {'f29'}})
    fsqrt.s f29, f21, rne
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff4065077d(3.5785820484161377_s)        0xffffffff4065077c(3.5785818099975586_s)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f29, f21, rne
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            47dc02ec949bec21be0cdc9e08cadd737529bea9        47dc02ec949bec21be0cdc9e08cadd737529bea9        
