# FailID_004206 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x6, 0x8017fa6f            // t1
    li x7, 0x0                   // t2
    li x8, 0xffffffffb63b3000    // fp
    li x9, 0x1                   // s1
    li x10, 0x1                  // a0
    li x11, 0x7ffffea6           // a1
    li x12, 0x1                  // a2
    li x13, 0x801807aa           // a3
    li x14, 0x80180e59           // a4
    li x15, 0x6000               // a5
    ...
    li x22, 0x6000               // s6
    li x23, 0x44                 // s7
    li x24, 0x2005fee5800000     // s8
    li x25, 0x20a31000           // s9
    li x26, 0x80180e9a           // s10
    li x27, 0x801807d2           // s11
    li x28, 0x1                  // t3
    li x29, 0x8017fca3           // t4
    li x30, 0x3                  // t5
    li x31, 0x44                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x31', 'f7'}, 'clob': {'x31', 'x4'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        05508cdaf326e1435acb15d620396bd8aa9fa821        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x331, x31
t6(x31)             0x000000008017fd0f(2149055759)                  0x000000008017fd0f(2149055759)
...
t1(x6)              0x000000008017fa6f(2149055087)                  0x000000008017fa6f(2149055087)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0xffffffffb63b3000(18446744072471916544)        0xffffffffb63b3000(18446744072471916544)        
...
a4(x14)             0x0000000080180e59(2149060185)                  0x0000000080180e59(2149060185)                  
...
s8(x24)             0x002005fee5800000(9013791584944128)            0x002005fee5800000(9013791584944128)            
s9(x25)             0x0000000020a31000(547557376)                   0x0000000020a31000(547557376)                   
s10(x26)            0x0000000080180e9a(2149060250)                  0x0000000080180e9a(2149060250)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3bd4807d715a9965b8c69fbef03f3b986bdb15a3        3bd4807d715a9965b8c69fbef03f3b986bdb15a3        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        05508cdaf326e1435acb15d620396bd8aa9fa821        X
