# FailID_000258 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f4: .byte 0x70,0x84,0x9d,0xe3,0xbd,0xa2,0xe6,0x40
_reg_f19:.byte 0x00,0x00,0x00,0x54,0xfe,0xf9,0xdf,0xc1
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f4', 'mstatus.fs/vs.fs', 'f19'}, 'clob': {'f31'}})
    fdiv.s f31, f4, f19, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0xffffffff7fc00000(nan_s)                       0xffffffffcf1d8470(-2642702336.0_s)             X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f31, f4, f19, rdn
+========================================================================================================================+
...
f31                 0xffffffff7fc00000(nan_s)                       0xffffffffcf1d8470(-2642702336.0_s)             X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f4, f19
f4                  0x40e6a2bde39d8470(46357.934035071055_d)        0x40e6a2bde39d8470(46357.934035071055_d)
f19                 0xc1dff9fe54000000(-2145909072.0_d)             0xc1dff9fe54000000(-2145909072.0_d)
f31                 0xffffffff7fc00000(nan_s)                       0xffffffffcf1d8470(-2642702336.0_s)             X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b62ac8d2a8d2e840585aea9c2e9372eac14a8690        b62ac8d2a8d2e840585aea9c2e9372eac14a8690        
