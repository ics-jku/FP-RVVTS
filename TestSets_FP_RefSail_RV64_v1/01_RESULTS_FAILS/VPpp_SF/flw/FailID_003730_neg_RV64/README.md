# FailID_003730 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x800004f6           // s10
    li x27, 0x5ddaf790           // s11
    li x28, 0x801802a6           // t3
    li x29, 0x80000337           // t4
    li x30, 0x7ffff964           // t5
    li x31, 0xfffffffffffffe1f   // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x27', 'fcsr.rm'}, 'clob': {'x27', 'x24', 'f28'}})
...
f28                 0x0000000000000000(0.0_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
s10(x26)            0x00000000800004f6(2147484918)                  0x00000000800004f6(2147484918)                  
s11(x27)            0x00000000801af283(2149249667)                  0x00000000801af283(2149249667)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            918a12cd8a7bfeaf77880b4aa983ec9cc56104b1        918a12cd8a7bfeaf77880b4aa983ec9cc56104b1        
