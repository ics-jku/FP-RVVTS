# FailID_004909 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x28, 0x8017f9ff           // t3
    li x29, 0x80005cd4           // t4
    li x30, 0x7ffffd44           // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x28', 'f23'}, 'clob': {'x28', 'x26'}})
...
t2(x7)              0x00000000801806ef(2149058287)                  0x00000000801806ef(2149058287)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            be81081c39e35fc32a2ddc8662c27fd5ce700dd6        be81081c39e35fc32a2ddc8662c27fd5ce700dd6        
