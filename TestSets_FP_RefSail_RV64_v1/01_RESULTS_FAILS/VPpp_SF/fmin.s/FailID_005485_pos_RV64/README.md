# FailID_005485 VP++ SF pos RV64 fmin.s
...
_reg_f13:.byte 0x78,0x11,0x4c,0x4f,0xff,0xff,0xff,0xff
_reg_f17:.byte 0x00,0x00,0x00,0x00,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f17', 'fcsr.rm'}, 'clob': {'f2'}})
    fmin.s f2, f13, f17
```
...
STATE               REF                                             DUT                                             DIFF
f2                  0xffffffff4f4c1178(3423696896.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f2                  0xffffffff4f4c1178(3423696896.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, f13, f17
f2                  0xffffffff4f4c1178(3423696896.0_s)              0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffff4f4c1178(3423696896.0_s)              0xffffffff4f4c1178(3423696896.0_s)
f17                 0x41e002ff00000000(2149054464.0_d)              0x41e002ff00000000(2149054464.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d70e3f1f6b20a9690912989a0d30e5b8da3d6449        d70e3f1f6b20a9690912989a0d30e5b8da3d6449        
