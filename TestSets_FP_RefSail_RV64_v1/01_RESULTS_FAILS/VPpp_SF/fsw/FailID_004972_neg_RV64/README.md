# FailID_004972 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x27, 0x6000               // s11
    li x28, 0x7ffffac1           // t3
    li x29, 0x7fffffa3           // t4
    li x30, 0x40                 // t5
    li x31, 0xd3                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm', 'f27'}, 'clob': {'x29', 'x4'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        8760c7b610e81573972a9c02382feadf41bc3bee        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x7, x29
t2(x7)              0x000000008001107b(2147553403)                  0x000000008001107b(2147553403)
t4(x29)             0x000000008028001f(2150105119)                  0x000000008028001f(2150105119)
...
gp(x3)              0x000000007ffffc85(2147482757)                  0x000000007ffffc85(2147482757)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f3c40536538d18939b5580ae8ef14cf2cffccd7a        f3c40536538d18939b5580ae8ef14cf2cffccd7a        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        8760c7b610e81573972a9c02382feadf41bc3bee        X
