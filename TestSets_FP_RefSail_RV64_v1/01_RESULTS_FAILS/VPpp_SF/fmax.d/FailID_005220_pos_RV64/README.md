# FailID_005220 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f5'}, 'clob': {'f18'}})
    fmax.d f18, f23, f5
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aa2384b8fce9957420911d7f88df57f4370ed187        aa2384b8fce9957420911d7f88df57f4370ed187        
