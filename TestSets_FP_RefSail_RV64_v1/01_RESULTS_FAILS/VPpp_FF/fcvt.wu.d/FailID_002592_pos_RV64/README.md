# FailID_002592 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f22', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x5'}})
    fcvt.wu.d x5, f22, rmm
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x5, f22, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f86237c08fc78d259f0fc062fa570bdcf5dd596f        f86237c08fc78d259f0fc062fa570bdcf5dd596f        
