# FailID_005491 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x64,0x42,0xff,0xff,0xff,0xff
_reg_f1: .byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'f6', 'fcsr.rm'}, 'clob': {'f1'}})
    fmin.s f1, f0, f6
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff42640000(57.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f1, f0, f6
f0                  0xffffffff42640000(57.0_s)                      0xffffffff42640000(57.0_s)
f1                  0xffffffff42640000(57.0_s)                      0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c27c397ebdf9fb1c897523eafbba020039f58a62        c27c397ebdf9fb1c897523eafbba020039f58a62        
