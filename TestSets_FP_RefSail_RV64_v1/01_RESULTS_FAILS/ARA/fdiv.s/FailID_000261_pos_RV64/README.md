# FailID_000261 ARA pos RV64 fdiv.s
...
_reg_f30:.byte 0xd8,0x07,0x00,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f30', 'fcsr.rm', 'f11', 'mstatus.fs/vs.fs'}, 'clob': {'f15'}})
    fdiv.s f15, f11, f30
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f15, f11, f30
+========================================================================================================================+
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, f11, f30
f11                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f30                 0x00000000800007d8(1.0609988876e-314_d)         0x00000000800007d8(1.0609988876e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f06e743151577158fb88fcd616e3ebfcf013ce44        f06e743151577158fb88fcd616e3ebfcf013ce44        
