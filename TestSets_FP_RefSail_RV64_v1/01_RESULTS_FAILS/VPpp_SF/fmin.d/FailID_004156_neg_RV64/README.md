# FailID_004156 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f3', 'fcsr.rm', 'f1'}, 'clob': {'f19'}})
    fmin.d f19, f1, f3
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0x41eacfecf1800000(3598673804.0_d)              0x7fffffff7fc00000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fcbcc1e3998b233cb0a9ec5011658e66c5f2792d        fcbcc1e3998b233cb0a9ec5011658e66c5f2792d        
