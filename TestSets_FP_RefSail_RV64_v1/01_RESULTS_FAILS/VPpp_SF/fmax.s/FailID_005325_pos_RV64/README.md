# FailID_005325 VP++ SF pos RV64 fmax.s
...
_reg_f16:.byte 0xfa,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'f16', 'fcsr.rm'}, 'clob': {'f17'}})
    fmax.s f17, f16, f7
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f17                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, f16, f7
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f16                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff4f0017fa(2149054976.0_s)
f17                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff7fc00000(nan_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dcd4f4f48974cd40f040010371be5f60cc429bb5        dcd4f4f48974cd40f040010371be5f60cc429bb5        
