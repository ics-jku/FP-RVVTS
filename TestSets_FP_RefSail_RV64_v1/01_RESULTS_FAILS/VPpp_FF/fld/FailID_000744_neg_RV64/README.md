# FailID_000744 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'f11', 'x29', 'x20'}})
...
f11                 0xc69040ee908d9fb9(-8.24157470614488e+31_d)     0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
f11                 0xc69040ee908d9fb9(-8.24157470614488e+31_d)     0x000000132140006f(4.05935308646e-313_d)        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, x2, x29
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)
t4(x29)             0x000000007ffffd11(2147482897)                  0x000000007ffffd11(2147482897)
f11                 0xc69040ee908d9fb9(-8.24157470614488e+31_d)     0x000000132140006f(4.05935308646e-313_d)        X
+========================================================================================================================+
```
...
t4(x29)             0x000000007ffffd11(2147482897)                  0x000000007ffffd11(2147482897)                  
t5(x30)             0x000000008000040a(2147484682)                  0x000000008000040a(2147484682)                  
t6(x31)             0x5de4c2c1ae235d30(6765746677323357488)         0x5de4c2c1ae235d30(6765746677323357488)         

STATE               REF                                             DUT                                             DIFF
xmemhash            6ce1b5e5ebe34a04ce9a0f55e9a86ad8b370c4c3        6ce1b5e5ebe34a04ce9a0f55e9a86ad8b370c4c3        
