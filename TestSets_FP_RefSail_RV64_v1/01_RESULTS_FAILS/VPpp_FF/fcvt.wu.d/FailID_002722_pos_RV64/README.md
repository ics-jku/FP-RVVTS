# FailID_002722 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x02,0x00,0x00,0x01,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f1
    fld  f1, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x20'}})
    fcvt.wu.d x20, f1, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x20, f1, rne
+========================================================================================================================+
...
Registers: x20, f1
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f1                  0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff01000002(2.350989262163961e-38_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8451b24139d79e4fe9700c3e7a3e8845ca85af95        8451b24139d79e4fe9700c3e7a3e8845ca85af95        
