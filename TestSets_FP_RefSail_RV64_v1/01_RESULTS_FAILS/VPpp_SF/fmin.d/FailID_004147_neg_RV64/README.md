# FailID_004147 VP++ SF neg RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f26'}, 'clob': {'f24'}})
    fmin.d f24, f26, f0
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            826b64007ccfdd3b61e4a296598072ca52a12b1c        826b64007ccfdd3b61e4a296598072ca52a12b1c        
