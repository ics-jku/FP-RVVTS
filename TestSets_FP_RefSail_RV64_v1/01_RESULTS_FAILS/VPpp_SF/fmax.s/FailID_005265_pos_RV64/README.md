# FailID_005265 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x01,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f28'}, 'clob': {'f11'}})
    fmax.s f11, f9, f28
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffff4f001801(2149056768.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f11                 0xffffffff4f001801(2149056768.0_s)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f9, f28
f9                  0xffffffff4f001801(2149056768.0_s)              0xffffffff4f001801(2149056768.0_s)
f11                 0xffffffff4f001801(2149056768.0_s)              0xffffffff7fc00000(nan_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0f2503e06eaca0e16026e19ba70fde760e53617e        0f2503e06eaca0e16026e19ba70fde760e53617e        
