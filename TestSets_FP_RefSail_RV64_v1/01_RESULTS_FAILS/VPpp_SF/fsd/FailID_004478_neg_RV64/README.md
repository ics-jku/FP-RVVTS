# FailID_004478 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x14, 0x1ab65d7e5f6dc      // a4
    li x15, 0x6000               // a5
    li x16, 0x801805ff           // a6
    li x17, 0x0                  // a7
    li x18, 0x1441a000           // s2
    li x19, 0x80180733           // s3
    li x20, 0x8017fe39           // s4
    li x21, 0x0                  // s5
    li x22, 0xfffffffffbef3000   // s6
    ...
    li x30, 0x81                 // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f12', 'x4'}, 'clob': {'x21', 'x4'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        df80c4c50466575bf32418f1abd43238b652b518        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, x11, x4
tp(x4)              0x0000000080238f11(2149814033)                  0x0000000080238f11(2149814033)
...
a0(x10)             0x00000000802000e3(2149581027)                  0x00000000802000e3(2149581027)                  
a1(x11)             0x7ff8000000000000(9221120237041090560)         0x7ff8000000000000(9221120237041090560)         
...
a4(x14)             0x0001ab65d7e5f6dc(469928878929628)             0x0001ab65d7e5f6dc(469928878929628)             
...
s3(x19)             0x0000000080180733(2149058355)                  0x0000000080180733(2149058355)                  
s4(x20)             0x000000008017fe39(2149056057)                  0x000000008017fe39(2149056057)                  
s5(x21)             0x000000008017fee1(2149056225)                  0x000000008017fee1(2149056225)                  
s6(x22)             0xfffffffffbef3000(18446744073641340928)        0xfffffffffbef3000(18446744073641340928)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fcf3e6e1257721b5c04ff1db5a7bfe2ab08489d4        fcf3e6e1257721b5c04ff1db5a7bfe2ab08489d4        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        df80c4c50466575bf32418f1abd43238b652b518        X
