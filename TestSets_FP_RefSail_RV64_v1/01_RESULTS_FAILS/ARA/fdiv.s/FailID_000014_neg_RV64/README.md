# FailID_000014 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'f19', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'f1'}})
    fdiv.s f1, f2, f19, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff7fc00000(nan_s)                       0xffffffffd1810c4a(-69282119680.0_s)            X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f1, f2, f19, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1166535e52cef0e0c8c4280fecd3cd915bb0c33e        1166535e52cef0e0c8c4280fecd3cd915bb0c33e        
