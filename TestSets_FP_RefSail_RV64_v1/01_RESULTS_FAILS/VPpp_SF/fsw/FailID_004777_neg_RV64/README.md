# FailID_004777 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x9, 0x80000180            // s1
    li x10, 0x1                  // a0
    li x11, 0x80180654           // a1
    li x12, 0x8017f836           // a2
    li x13, 0x80000627           // a3
    li x14, 0x0                  // a4
    li x15, 0x1                  // a5
    li x16, 0x8018018c           // a6
    li x17, 0x0                  // a7
    li x18, 0x9f                 // s2
    ...
    li x30, 0x0                  // t5
    li x31, 0x400                // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'x19', 'fcsr.rm'}, 'clob': {'x19', 'x2'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7e84b90e8fabf2b8181c10c34843b2e8a10b5ef4        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f6, x177, x19
s3(x19)             0x0000000080200505(2149582085)                  0x0000000080200505(2149582085)
...
sp(x2)              0x000000008017fe89(2149056137)                  0x000000008017fe89(2149056137)                  
...
a1(x11)             0x0000000080180654(2149058132)                  0x0000000080180654(2149058132)                  
a2(x12)             0x000000008017f836(2149054518)                  0x000000008017f836(2149054518)                  
a3(x13)             0x0000000080000627(2147485223)                  0x0000000080000627(2147485223)                  
...
s5(x21)             0x0000000000000099(153)                         0x0000000000000099(153)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1d4411ad8f4a4e8199e1c42d90ecfb6f3de720d        c1d4411ad8f4a4e8199e1c42d90ecfb6f3de720d        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        7e84b90e8fabf2b8181c10c34843b2e8a10b5ef4        X
