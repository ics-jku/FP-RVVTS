# FailID_002921 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x00,0x00,0x80,0x37,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x15'}})
    fcvt.wu.s x15, f12, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x15, f12, rtz
+========================================================================================================================+
...
Registers: x15, f12
a5(x15)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f12                 0x41dffffe37800000(2147481822.0_d)              0x41dffffe37800000(2147481822.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4e86f4efa54ba763074384a14af5d2954b4f8884        4e86f4efa54ba763074384a14af5d2954b4f8884        
