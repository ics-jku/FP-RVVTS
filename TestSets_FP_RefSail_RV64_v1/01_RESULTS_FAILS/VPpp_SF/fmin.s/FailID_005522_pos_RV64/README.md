# FailID_005522 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f9'}})
    fmin.s f9, f14, f20
```
...
STATE               REF                                             DUT                                             DIFF
f9                  0xffffffff2140006f(6.505270420568022e-19_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            92f9f2219784a2c14662fd1f2d57610d9b958708        92f9f2219784a2c14662fd1f2d57610d9b958708        
