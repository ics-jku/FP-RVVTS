# FailID_005287 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f23', 'fcsr.rm', 'f29'}, 'clob': {'f1'}})
    fmax.s f1, f23, f29
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff01000002(2.350989262163961e-38_s)     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            50cc103ae97e600600098fd8c163434aa8c41d18        50cc103ae97e600600098fd8c163434aa8c41d18        
