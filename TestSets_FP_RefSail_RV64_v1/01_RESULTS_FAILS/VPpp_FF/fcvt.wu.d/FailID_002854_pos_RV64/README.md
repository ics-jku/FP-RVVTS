# FailID_002854 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0x00,0x00,0xe0,0xff,0xff,0xff,0xef,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x30'}})
    fcvt.wu.d x30, f6, dyn
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x30, f6, dyn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x30, f6
t5(x30)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f6                  0x41efffffffe00000(4294967295.0_d)              0x41efffffffe00000(4294967295.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            89f04d54458b1dc240faad123320cba04fa31760        89f04d54458b1dc240faad123320cba04fa31760        
