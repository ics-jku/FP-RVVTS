# FailID_001648 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x10, 0x8018542b           // a0
    li x11, 0x6000               // a1
    li x12, 0x200                // a2
    li x13, 0x7fffffff           // a3
    li x14, 0xffffffffd7eea000   // a4
    li x15, 0x22                 // a5
    li x16, 0x48b896e4           // a6
    li x17, 0x6000               // a7
    li x18, 0x800063b4           // s2
    li x19, 0x6000               // s3
    li x20, 0x68                 // s4
    li x21, 0x4                  // s5
    li x22, 0x801ffca4           // s6
    ...
    li x27, 0x7e                 // s11
    li x28, 0xb7                 // t3
    li x29, 0x801fff38           // t4
    li x30, 0x11                 // t5
    li x31, 0x800002a4           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f4', 'x29'}, 'clob': {'x29', 'x14'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4cf1070e700be69dd9a940195dbcc275fe26b419        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x29
t4(x29)             0x000000008027fe3c(2150104636)                  0x000000008027fe3c(2150104636)
...
a0(x10)             0x000000008018542b(2149078059)                  0x000000008018542b(2149078059)                  
...
a6(x16)             0x0000000048b896e4(1220056804)                  0x0000000048b896e4(1220056804)                  
a7(x17)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s2(x18)             0x00000000800063b4(2147509172)                  0x00000000800063b4(2147509172)                  
s3(x19)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s4(x20)             0x0000000000000068(104)                         0x0000000000000068(104)                         
s5(x21)             0x0000000000000004(4)                           0x0000000000000004(4)                           
s6(x22)             0x00000000801ffca4(2149579940)                  0x00000000801ffca4(2149579940)                  
s7(x23)             0x0000000080200b58(2149583704)                  0x0000000080200b58(2149583704)                  
s8(x24)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s9(x25)             0x00000000000000e1(225)                         0x00000000000000e1(225)                         
...
t3(x28)             0x00000000000000b7(183)                         0x00000000000000b7(183)                         
t4(x29)             0x000000008027fe3c(2150104636)                  0x000000008027fe3c(2150104636)                  
t5(x30)             0x0000000000000011(17)                          0x0000000000000011(17)                          
t6(x31)             0x00000000800002a4(2147484324)                  0x00000000800002a4(2147484324)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            07049ecd267f8989b0e1597f086e0c4c6e9653ea        07049ecd267f8989b0e1597f086e0c4c6e9653ea        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4cf1070e700be69dd9a940195dbcc275fe26b419        X
