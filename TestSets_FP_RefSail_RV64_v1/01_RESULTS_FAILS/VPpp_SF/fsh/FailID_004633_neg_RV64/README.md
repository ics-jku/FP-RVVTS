# FailID_004633 VP++ SF neg RV64 fsh
...
```
    ...
    j _float_data_end
    .align 4
_reg_f23:.byte 0x00,0x00,0x00,0x86,0x01,0xfa,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f23
    fld  f23, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x18', 'f23'}, 'clob': {'x18', 'x2'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        613c9e77ee2c70143f0ceeb7d991df85a78b1380        X
STATES DIFFER: True
```
...
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        613c9e77ee2c70143f0ceeb7d991df85a78b1380        X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, x53, x18
s2(x18)             0x0000000080180065(2149056613)                  0x0000000080180065(2149056613)
f23                 0xc1dffa0186000000(-2145912344.0_d)             0xc1dffa0186000000(-2145912344.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b16b04972fd6e75efa4ef968896dbb309fe22cb3        b16b04972fd6e75efa4ef968896dbb309fe22cb3        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        613c9e77ee2c70143f0ceeb7d991df85a78b1380        X
