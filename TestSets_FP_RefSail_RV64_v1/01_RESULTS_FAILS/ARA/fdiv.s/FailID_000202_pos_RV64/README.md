# FailID_000202 ARA pos RV64 fdiv.s
...
_reg_f15:.byte 0x00,0x00,0xc0,0xfc,0xfd,0xff,0xdf,0xc1
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f9', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f30'}})
    fdiv.s f30, f9, f15, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f30, f9, f15, rtz
+========================================================================================================================+
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, f9, f15
f9                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f15                 0xc1dffffdfcc00000(-2147481587.0_d)             0xc1dffffdfcc00000(-2147481587.0_d)
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            dab22a03b935e1738879e926dfb8b5d7e734b5e5        dab22a03b935e1738879e926dfb8b5d7e734b5e5        
