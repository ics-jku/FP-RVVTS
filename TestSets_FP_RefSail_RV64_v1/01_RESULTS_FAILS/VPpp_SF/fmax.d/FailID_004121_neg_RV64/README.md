# FailID_004121 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f0', 'fcsr.rm', 'f29'}, 'clob': {'f16'}})
    fmax.d f16, f0, f29
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x0000000000000000(0.0_d)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fb62abd9c8effa7baacd823dc4a750398eda8ba0        fb62abd9c8effa7baacd823dc4a750398eda8ba0        
