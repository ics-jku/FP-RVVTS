# FailID_003472 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x29, 0x802003aa           // t4
    li x30, 0x801807b1           // t5
    li x31, 0x8007f1a6           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x11'}, 'clob': {'x11', 'x6', 'f24'}})
...
f24                 0x7fffffff42140000(nan_d)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
t1(x6)              0x0000000080000491(2147484817)                  0x0000000080000491(2147484817)                  
...
t4(x29)             0x00000000802003aa(2149581738)                  0x00000000802003aa(2149581738)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ff72f0bb9d45294e61ef1df7dc82e7a240826d90        ff72f0bb9d45294e61ef1df7dc82e7a240826d90        
