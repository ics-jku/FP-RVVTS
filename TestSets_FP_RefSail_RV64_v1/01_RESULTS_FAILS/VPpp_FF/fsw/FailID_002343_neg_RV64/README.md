# FailID_002343 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x16, 0x6000               // a6
    li x17, 0x1                  // a7
    li x18, 0x80180475           // s2
    li x19, 0x8018070f           // s3
    li x20, 0xcb                 // s4
    li x21, 0x29                 // s5
    li x22, 0x0                  // s6
    li x23, 0x800009ee           // s7
    li x24, 0x1                  // s8
    li x25, 0xffffffffa03e8000   // s9
    li x26, 0x802802             // s10
    li x27, 0x800007ee           // s11
    li x28, 0x80000305           // t3
    li x29, 0x8028059d           // t4
    li x30, 0x80180621           // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x22', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'x5', 'x22'}})
...
s1(x9)              0x0000000000000088(136)                         0x0000000000000088(136)                         
...
a4(x14)             0x0000000001ffffe1(33554401)                    0x0000000001ffffe1(33554401)                    
...
s2(x18)             0x0000000080180475(2149057653)                  0x0000000080180475(2149057653)                  
s3(x19)             0x000000008018070f(2149058319)                  0x000000008018070f(2149058319)                  
s4(x20)             0x00000000000000cb(203)                         0x00000000000000cb(203)                         
s5(x21)             0x0000000000000029(41)                          0x0000000000000029(41)                          
s6(x22)             0x00000000801804e5(2149057765)                  0x00000000801804e5(2149057765)                  
s7(x23)             0x00000000800009ee(2147486190)                  0x00000000800009ee(2147486190)                  
s8(x24)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s9(x25)             0xffffffffa03e8000(18446744072103034880)        0xffffffffa03e8000(18446744072103034880)        
...
t3(x28)             0x0000000080000305(2147484421)                  0x0000000080000305(2147484421)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8c58c0559016ee6c6f51c2b3ba8508d4e579ab50        8c58c0559016ee6c6f51c2b3ba8508d4e579ab50        
