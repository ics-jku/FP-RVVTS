# FailID_004122 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f31', 'f28'}, 'clob': {'f17'}})
    fmax.d f17, f31, f28
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0x0000000000000000(0.0_d)                       0xffffffffd2000ed3(-137501130752.0_s)           X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f17, f31, f28
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e57a4c21f3e0108c1676d5707f8cc899ef5b57d4        e57a4c21f3e0108c1676d5707f8cc899ef5b57d4        
