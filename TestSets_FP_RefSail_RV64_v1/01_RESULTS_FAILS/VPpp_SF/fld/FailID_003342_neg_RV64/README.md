# FailID_003342 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'x5', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'f25', 'x30'}})
...
f25                 0xffffffffffff7c00(inf_h)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fld f25, 0x18a(x5)
+========================================================================================================================+
Attributes:  fcsr ['overflow'], special values ['inf', 'zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
STATE               REF                                             DUT                                             DIFF
xmemhash            fe7849809146ee074e15396311e497eac243bb06        fe7849809146ee074e15396311e497eac243bb06        
