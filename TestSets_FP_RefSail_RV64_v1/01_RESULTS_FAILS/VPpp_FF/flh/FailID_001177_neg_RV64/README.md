# FailID_001177 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x30, 0xffff               // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs'}, 'clob': {'x8', 'f24', 'x29'}})
...
f24                 0x7ffffffffffffe00(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
t4(x29)             0x00000000800003ca(2147484618)                  0x00000000800003ca(2147484618)                  
t5(x30)             0x000000000000ffff(65535)                       0x000000000000ffff(65535)                       
t6(x31)             0x0000000000000001(1)                           0x0000000000000001(1)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            42440585c3e8a0ffe40e21b2c8e8852642ab568f        42440585c3e8a0ffe40e21b2c8e8852642ab568f        
