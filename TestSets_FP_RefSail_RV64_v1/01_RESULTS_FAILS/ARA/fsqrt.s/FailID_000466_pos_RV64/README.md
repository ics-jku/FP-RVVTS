# FailID_000466 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x4e,0x6a,0xf5,0x4e,0xff,0xff,0xff,0xff
_reg_f29:.byte 0xf3,0xff,0xff,0xce,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fsqrt.s f29, f14, rup
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffff47313cd1(45372.81640625_s)            0xffffffff47313cd0(45372.8125_s)                X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f29, f14, rup
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f14
f14                 0xffffffff4ef56a4e(2058692352.0_s)              0xffffffff4ef56a4e(2058692352.0_s)
f29                 0xffffffff47313cd1(45372.81640625_s)            0xffffffff47313cd0(45372.8125_s)                X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            df3eedcc24a95d2e03f534502022ee14bb9e64bc        df3eedcc24a95d2e03f534502022ee14bb9e64bc        
