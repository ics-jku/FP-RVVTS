# FailID_001809 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    // restore registers
    li x1, 0x10017fcb2           // ra
    li x2, 0x0                   // sp
    li x3, 0x80000402            // gp
    li x4, 0x80000076            // tp
    li x5, 0x8000076a            // t0
    li x6, 0x83                  // t1
    li x7, 0x801730c9000000      // t2
    li x8, 0x6000                // fp
    li x9, 0x0                   // s1
    li x10, 0x1e                 // a0
    li x11, 0x6000               // a1
    li x12, 0x165                // a2
    li x13, 0x6000               // a3
    li x14, 0x80000276           // a4
    li x15, 0x6000               // a5
    li x16, 0x8000076a           // a6
    li x17, 0xfffffffeffe8039b   // a7
    li x18, 0x801730c9           // s2
    li x19, 0xf4                 // s3
    li x20, 0x3e35c000           // s4
    li x21, 0x80181906           // s5
    li x22, 0x801ffc36           // s6
    li x23, 0xbfa7b7d8           // s7
    li x24, 0x8000041a           // s8
    li x25, 0x80180676           // s9
    li x26, 0x80180131           // s10
    li x27, 0x400ffb500000000    // s11
    li x28, 0x801ff6a0           // t3
    li x29, 0xffffffff9c11a000   // t4
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'f0', 'x13', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x13', 'x30'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fe6ad8d29c58b4b8d9ff7e2b91ef78d4e45893cd        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, x581, x13
a3(x13)             0x0000000080185a7f(2149079679)                  0x0000000080185a7f(2149079679)
...
ra(x1)              0x000000010017fcb2(4296539314)                  0x000000010017fcb2(4296539314)                  
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x0000000080000402(2147484674)                  0x0000000080000402(2147484674)                  
tp(x4)              0x0000000080000076(2147483766)                  0x0000000080000076(2147483766)                  
t0(x5)              0x000000008000076a(2147485546)                  0x000000008000076a(2147485546)                  
t1(x6)              0x0000000000000083(131)                         0x0000000000000083(131)                         
t2(x7)              0x00801730c9000000(36054295317053440)           0x00801730c9000000(36054295317053440)           
...
a2(x12)             0x0000000000000165(357)                         0x0000000000000165(357)                         
a3(x13)             0x0000000080185a7f(2149079679)                  0x0000000080185a7f(2149079679)                  
a4(x14)             0x0000000080000276(2147484278)                  0x0000000080000276(2147484278)                  
a5(x15)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
a6(x16)             0x000000008000076a(2147485546)                  0x000000008000076a(2147485546)                  
a7(x17)             0xfffffffeffe8039b(18446744069413012379)        0xfffffffeffe8039b(18446744069413012379)        
s2(x18)             0x00000000801730c9(2149003465)                  0x00000000801730c9(2149003465)                  
s3(x19)             0x00000000000000f4(244)                         0x00000000000000f4(244)                         
s4(x20)             0x000000003e35c000(1043709952)                  0x000000003e35c000(1043709952)                  
s5(x21)             0x0000000080181906(2149062918)                  0x0000000080181906(2149062918)                  
s6(x22)             0x00000000801ffc36(2149579830)                  0x00000000801ffc36(2149579830)                  
s7(x23)             0x00000000bfa7b7d8(3215439832)                  0x00000000bfa7b7d8(3215439832)                  
s8(x24)             0x000000008000041a(2147484698)                  0x000000008000041a(2147484698)                  
s9(x25)             0x0000000080180676(2149058166)                  0x0000000080180676(2149058166)                  
s10(x26)            0x0000000080180131(2149056817)                  0x0000000080180131(2149056817)                  
s11(x27)            0x0400ffb500000000(288511529005875200)          0x0400ffb500000000(288511529005875200)          
t3(x28)             0x00000000801ff6a0(2149578400)                  0x00000000801ff6a0(2149578400)                  
t4(x29)             0xffffffff9c11a000(18446744072032985088)        0xffffffff9c11a000(18446744072032985088)        
t5(x30)             0x000000008017fa7f(2149055103)                  0x000000008017fa7f(2149055103)                  
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            c29b36f17c213bdf8bf53a920f9df2f6f17a4975        c29b36f17c213bdf8bf53a920f9df2f6f17a4975        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        fe6ad8d29c58b4b8d9ff7e2b91ef78d4e45893cd        X
