# FailID_000544 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x00,0x00,0x00,0x00,0x00,0x00,0xd8,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f2'}})
    fsqrt.s f2, f25, rmm
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f2, f25, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8a36f66efdba5b9771e9b44056cf9472160d9a67        8a36f66efdba5b9771e9b44056cf9472160d9a67        
