# FailID_003091 VP++ FF pos RV64 fcvt.wu.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'x14'}})
    fcvt.wu.s x14, f10, rmm
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a4(x14)             0xffffffff80000000(18446744071562067968)        0x0000000080000000(2147483648)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x14, f10, rmm
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1d20d243102c33c0524fa76dc7cc7591166cf524        1d20d243102c33c0524fa76dc7cc7591166cf524        
