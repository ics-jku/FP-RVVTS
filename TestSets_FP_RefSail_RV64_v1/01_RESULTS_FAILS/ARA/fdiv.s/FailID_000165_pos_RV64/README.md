# FailID_000165 ARA pos RV64 fdiv.s
...
_reg_f22:.byte 0x00,0x00,0xc0,0x58,0xff,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f22'}, 'clob': {'f18'}})
    fdiv.s f18, f13, f22, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f18, f13, f22, rmm
+========================================================================================================================+
...
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, f13, f22
f13                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f18                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f22                 0xc1dfffff58c00000(-2147482979.0_d)             0xc1dfffff58c00000(-2147482979.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            813e82988c684c5f20a1bcc339147d4256dccb49        813e82988c684c5f20a1bcc339147d4256dccb49        
