# FailID_003448 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x8017f814           // s11
    li x28, 0x8027f867           // t3
    li x29, 0x7ffffeba           // t4
    li x30, 0x6000               // t5
    li x31, 0x80185f0c           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x25'}, 'clob': {'x12', 'x25', 'f19'}})
...
```
+========================================================================================================================+
Instruction: fld f19, 0x68e(x25)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'underflow', 'inexact'], special values ['nan', 'zero']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
f19                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, x68, x25
s9(x25)             0x00000000800651aa(2147897770)                  0x00000000800651aa(2147897770)
f19                 0x7ff8000000000000(nan_d)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
a2(x12)             0x000000007ffff972(2147481970)                  0x000000007ffff972(2147481970)                  
...
s2(x18)             0x00000000d799f718(3617191704)                  0x00000000d799f718(3617191704)                  
s3(x19)             0x00000000800006e7(2147485415)                  0x00000000800006e7(2147485415)                  
s4(x20)             0x000000008017fa57(2149055063)                  0x000000008017fa57(2149055063)                  
...
s11(x27)            0x000000008017f814(2149054484)                  0x000000008017f814(2149054484)                  
t3(x28)             0x000000008027f867(2150103143)                  0x000000008027f867(2150103143)                  
t4(x29)             0x000000007ffffeba(2147483322)                  0x000000007ffffeba(2147483322)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            570fb59c3d16efcf0c218dccab81596a9044da15        570fb59c3d16efcf0c218dccab81596a9044da15        
