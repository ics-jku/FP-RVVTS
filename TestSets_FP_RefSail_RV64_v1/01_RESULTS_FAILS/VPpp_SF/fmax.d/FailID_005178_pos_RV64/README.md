# FailID_005178 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f17', 'fcsr.rm', 'f8'}, 'clob': {'f22'}})
    fmax.d f22, f17, f8
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0x0000000000000000(0.0_d)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5188d663d5a1d9eef4a3d887265ce5b69ba2ec04        5188d663d5a1d9eef4a3d887265ce5b69ba2ec04        
