# FailID_005394 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x00,0x00,0x00,0x00,0x00,0x40,0x58,0x40
_reg_f21:.byte 0x00,0x00,0x80,0x5f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f26', 'fcsr.rm'}, 'clob': {'f14'}})
    fmin.d f14, f26, f21
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x0000000000000000(0.0_d)                       0xffffffff5f800000(1.8446744073709552e+19_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f14, f26, f21
+========================================================================================================================+
...
f14                 0x0000000000000000(0.0_d)                       0xffffffff5f800000(1.8446744073709552e+19_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f26, f21
f14                 0x0000000000000000(0.0_d)                       0xffffffff5f800000(1.8446744073709552e+19_s)    X
f21                 0xffffffff5f800000(1.8446744073709552e+19_s)    0xffffffff5f800000(1.8446744073709552e+19_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            aef458c4d8418cdda18a60f2424d0d56b20a1dbc        aef458c4d8418cdda18a60f2424d0d56b20a1dbc        
