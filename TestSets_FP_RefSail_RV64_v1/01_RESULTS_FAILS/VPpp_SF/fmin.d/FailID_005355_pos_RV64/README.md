# FailID_005355 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f11', 'fcsr.rm'}, 'clob': {'f25'}})
    fmin.d f25, f9, f11
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            eee5239d39bab55e51730b8dc34e50f72c7bf98a        eee5239d39bab55e51730b8dc34e50f72c7bf98a        
