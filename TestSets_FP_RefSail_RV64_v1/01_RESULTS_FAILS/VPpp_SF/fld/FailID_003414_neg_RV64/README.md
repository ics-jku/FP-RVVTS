# FailID_003414 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x16, 0x1004               // a6
    li x17, 0x801804a5           // a7
    li x18, 0x801807ea           // s2
    ...
    li x31, 0x13                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x18'}, 'clob': {'x18', 'x17', 'f12'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            59ba769fdd660b6c86bf35afae5d3e6b535a9e71        59ba769fdd660b6c86bf35afae5d3e6b535a9e71        
