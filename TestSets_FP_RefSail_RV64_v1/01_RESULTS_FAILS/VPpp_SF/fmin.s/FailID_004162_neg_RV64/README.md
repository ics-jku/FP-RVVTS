# FailID_004162 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f8', 'f27'}, 'clob': {'f10'}})
    fmin.s f10, f8, f27
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff00000000(0.0_s)                       0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ac3ac7c59361e2b7ec61e5a9ca2a0c14cba60904        ac3ac7c59361e2b7ec61e5a9ca2a0c14cba60904        
