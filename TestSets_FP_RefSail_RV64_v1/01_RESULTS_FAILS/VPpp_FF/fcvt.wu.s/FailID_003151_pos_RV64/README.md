# FailID_003151 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f10:.byte 0x00,0x00,0x00,0xad,0xfe,0x04,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'x2'}})
    fcvt.wu.s x2, f10, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x2, f10, rtz
+========================================================================================================================+
...
Registers: x2, f10
sp(x2)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f10                 0x41e004fead000000(2150102376.0_d)              0x41e004fead000000(2150102376.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b180a6dacc8a95deaedd297f501f4aec6e0f1d8a        b180a6dacc8a95deaedd297f501f4aec6e0f1d8a        
