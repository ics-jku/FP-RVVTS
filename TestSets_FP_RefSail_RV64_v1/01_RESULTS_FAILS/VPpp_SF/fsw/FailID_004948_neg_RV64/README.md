# FailID_004948 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x9, 0x801ffcb8            // s1
    li x10, 0x0                  // a0
    li x11, 0x7ffffe3b           // a1
    li x12, 0x0                  // a2
    li x13, 0x1                  // a3
    li x14, 0x80185a44           // a4
    li x15, 0x76d                // a5
    li x16, 0x8017fdf9           // a6
    li x17, 0x7ffff879           // a7
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'x17'}, 'clob': {'x6', 'x17'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b434187d5f334e4d294b34931bcc4aab77ad1a1d        X
...
t0(x5)              0x000000008017f950(2149054800)                  0x000000008017f950(2149054800)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            140ce84770e60d2ce3c76c38c0ccfa9c0d05295e        140ce84770e60d2ce3c76c38c0ccfa9c0d05295e        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        b434187d5f334e4d294b34931bcc4aab77ad1a1d        X
