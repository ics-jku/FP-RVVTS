# FailID_003680 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x7ffffa06           // t5
    li x31, 0x80015a06           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm'}, 'clob': {'x29', 'x19', 'f15'}})
...
f15                 0xffffffff00000000(0.0_s)                       0xffffffff0061b423(8.972664006007486e-39_s)     X
STATES DIFFER: True
```
...
s3(x19)             0x000000007ffffe22(2147483170)                  0x000000007ffffe22(2147483170)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            08ded6f113fed961f9385afd1c86d863c0419a14        08ded6f113fed961f9385afd1c86d863c0419a14        
