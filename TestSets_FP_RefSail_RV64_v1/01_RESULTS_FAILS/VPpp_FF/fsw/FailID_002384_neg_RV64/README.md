# FailID_002384 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x30, 0x68589000           // t5
    li x31, 0x802806a3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x30', 'mstatus.fs/vs.fs', 'f4'}, 'clob': {'x30', 'x23'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x153, x30
t5(x30)             0x0000000080209153(2149618003)                  0x0000000080209153(2149618003)
...
a5(x15)             0x00000000800006d2(2147485394)                  0x00000000800006d2(2147485394)                  
...
s8(x24)             0x0000000000000588(1416)                        0x0000000000000588(1416)                        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4e18af48a16a28f541b1e53e02e70ec090a26bba        4e18af48a16a28f541b1e53e02e70ec090a26bba        
