# FailID_000227 ARA pos RV64 fdiv.s
...
_reg_f23:.byte 0x00,0x00,0x80,0xed,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f23', 'f16', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f25'}})
    fdiv.s f25, f16, f23
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f25, f16, f23
+========================================================================================================================+
...
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f16, f23
f16                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f23                 0x41dfffffed800000(2147483574.0_d)              0x41dfffffed800000(2147483574.0_d)
f25                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            4acde4355a55c925b462183f2ffa09166cd8bb40        4acde4355a55c925b462183f2ffa09166cd8bb40        
