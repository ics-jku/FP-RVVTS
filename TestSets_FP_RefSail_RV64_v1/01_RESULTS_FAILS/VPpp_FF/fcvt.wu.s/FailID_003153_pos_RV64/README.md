# FailID_003153 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x22'}})
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x22, f21, rup
+========================================================================================================================+
...
Registers: x22, f21
s6(x22)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f21                 0xbff0000000000000(-1.0_d)                      0xbff0000000000000(-1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5ba7597fa445a86aced3853ad97c6a9647743fb7        5ba7597fa445a86aced3853ad97c6a9647743fb7        
