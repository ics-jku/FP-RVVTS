# FailID_005431 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0xff,0xff,0xff,0x7f,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f24'}})
    fmin.d f24, f13, f19
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x000000007fffffff(1.060997895e-314_d)          0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f24, f13, f19
+========================================================================================================================+
...
f24                 0x000000007fffffff(1.060997895e-314_d)          0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f13, f19
f13                 0x000000007fffffff(1.060997895e-314_d)          0x000000007fffffff(1.060997895e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            db25716ded524ff28f0bd66287ec95e5e1e7e4e4        db25716ded524ff28f0bd66287ec95e5e1e7e4e4        
