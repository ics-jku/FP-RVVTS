# FailID_002927 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x20'}})
    fcvt.wu.s x20, f13, rup
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x20, f13, rup
+========================================================================================================================+
Attributes:  fcsr ['invalid'], special values ['nan'], precision mismatch ('s', 'h')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
Registers: x20, f13
s4(x20)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f13                 0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3a7b7cca5a1dc766a741c675e32f13bd89a6dde8        3a7b7cca5a1dc766a741c675e32f13bd89a6dde8        
