# FailID_005270 VP++ SF pos RV64 fmax.s
...
_reg_f6: .byte 0x00,0x00,0x00,0x44,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'f23', 'fcsr.rm'}, 'clob': {'f1'}})
    fmax.s f1, f6, f23
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f1, f6, f23
f1                  0xffffffff44000000(512.0_s)                     0xffffffff7fc00000(nan_s)                       X
f6                  0xffffffff44000000(512.0_s)                     0xffffffff44000000(512.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            07317bd41043b496eebab548e1b4ac6cffd4e4d7        07317bd41043b496eebab548e1b4ac6cffd4e4d7        
