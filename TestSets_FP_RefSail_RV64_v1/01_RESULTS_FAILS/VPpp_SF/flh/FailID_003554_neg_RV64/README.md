# FailID_003554 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x29, 0x408                // t4
    li x30, 0x0                  // t5
    li x31, 0x7ffffee7           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x31'}, 'clob': {'x22', 'f22', 'x31'}})
...
f22                 0x7ff8000000000000(nan_d)                       0xffffffffffff0000(0.0_h)                       X
STATES DIFFER: True
```
...
t0(x5)              0x00000000801ff3f9(2149577721)                  0x00000000801ff3f9(2149577721)                  
...
s1(x9)              0x000000008017fb48(2149055304)                  0x000000008017fb48(2149055304)                  
...
a6(x16)             0x00000000000000cd(205)                         0x00000000000000cd(205)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            74c773ac204baf94adffc1f8e13cdba9047eb030        74c773ac204baf94adffc1f8e13cdba9047eb030        
