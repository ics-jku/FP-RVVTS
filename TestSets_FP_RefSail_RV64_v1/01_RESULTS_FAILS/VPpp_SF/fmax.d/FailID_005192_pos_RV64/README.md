# FailID_005192 VP++ SF pos RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f2'}, 'clob': {'f6'}})
    fmax.d f6, f2, f6
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            952395391db4dc7dc737d6ea0035a330e484f17e        952395391db4dc7dc737d6ea0035a330e484f17e        
