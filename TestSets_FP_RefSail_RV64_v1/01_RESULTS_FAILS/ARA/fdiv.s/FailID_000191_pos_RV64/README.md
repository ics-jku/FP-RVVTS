# FailID_000191 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f3: .byte 0xfa,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f29'}})
    fdiv.s f29, f29, f3, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f29, f29, f3, rtz
+========================================================================================================================+
...
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f29, f29, f3
f3                  0xffffffff4f0017fa(2149054976.0_s)              0xffffffff4f0017fa(2149054976.0_s)
f29                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c7b2b97cca88a42bd55481d4a83cd8e9ec6b7634        c7b2b97cca88a42bd55481d4a83cd8e9ec6b7634        
