# FailID_005281 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f6', 'fcsr.rm'}, 'clob': {'f4'}})
    fmax.s f4, f6, f24
```
...
STATE               REF                                             DUT                                             DIFF
f4                  0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f4, f6, f24
f4                  0xffffffff80000000(-0.0_s)                      0xffffffff7fc00000(nan_s)                       X
f6                  0xffffffff80000000(-0.0_s)                      0xffffffff80000000(-0.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2c38077315f913d58f15192cbd63ca0d72058e67        2c38077315f913d58f15192cbd63ca0d72058e67        
