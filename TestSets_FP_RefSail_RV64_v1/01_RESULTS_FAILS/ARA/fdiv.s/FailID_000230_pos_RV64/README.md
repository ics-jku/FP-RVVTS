# FailID_000230 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x23,0xb8,0x41,0x04,0x23,0xbc,0x51,0x04
_reg_f24:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f31:.byte 0xfe,0xff,0xff,0xff,0xff,0xff,0x2f,0x43
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f0'}, 'clob': {'f31'}})
    fdiv.s f31, f24, f0, rtz
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f31, f24, f0, rtz
+========================================================================================================================+
...
f31                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f24, f0
f0                  0x0451bc230441b823(7.27935879360729e-288_d)     0x0451bc230441b823(7.27935879360729e-288_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            261bd47c249bfc6205e2e7213ae3c7cc2167d221        261bd47c249bfc6205e2e7213ae3c7cc2167d221        
