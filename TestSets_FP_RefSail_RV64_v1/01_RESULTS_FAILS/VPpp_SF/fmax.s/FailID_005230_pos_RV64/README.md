# FailID_005230 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f6: .byte 0xf4,0xff,0xff,0x4e,0xff,0xff,0xff,0xff
_reg_f8: .byte 0x04,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_reg_f18:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0xbf
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f6', 'mstatus.fs/vs.fs', 'f18', 'fcsr.rm'}, 'clob': {'f8'}})
    fmax.s f8, f6, f18
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffff4efffff4(2147482112.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f8, f6, f18
f6                  0xffffffff4efffff4(2147482112.0_s)              0xffffffff4efffff4(2147482112.0_s)
f8                  0xffffffff4efffff4(2147482112.0_s)              0xffffffff7fc00000(nan_s)                       X
f18                 0xbff0000000000000(-1.0_d)                      0xbff0000000000000(-1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5f6dfaae1eb509b526907e0ef8c4e350251e1478        5f6dfaae1eb509b526907e0ef8c4e350251e1478        
