# FailID_003697 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x17, 0x9800000000000000   // a7
    li x18, 0x80774              // s2
    li x19, 0x100180a2c          // s3
    li x20, 0x80180fbf           // s4
    li x21, 0x801800bb           // s5
    li x22, 0x0                  // s6
    li x23, 0x80180ba3           // s7
    ...
    li x31, 0x8000041c           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'x11', 'f21', 'x10'}})
...
f21                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f21                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f21, x5, c9, x10
t0(x5)              0x00000000801800b3(2149056691)                  0x00000000801800b3(2149056691)
a0(x10)             0x00000000800005c9(2147485129)                  0x00000000800005c9(2147485129)
f21                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
sp(x2)              0x0000000080200414(2149581844)                  0x0000000080200414(2149581844)                  
gp(x3)              0x0000000000000064(100)                         0x0000000000000064(100)                         
tp(x4)              0x000000008017fd07(2149055751)                  0x000000008017fd07(2149055751)                  
t0(x5)              0x00000000801800b3(2149056691)                  0x00000000801800b3(2149056691)                  
...
a7(x17)             0x9800000000000000(10952754293765046272)        0x9800000000000000(10952754293765046272)        
s2(x18)             0x0000000000080774(526196)                      0x0000000000080774(526196)                      
s3(x19)             0x0000000100180a2c(4296542764)                  0x0000000100180a2c(4296542764)                  
s4(x20)             0x0000000080180fbf(2149060543)                  0x0000000080180fbf(2149060543)                  
s5(x21)             0x00000000801800bb(2149056699)                  0x00000000801800bb(2149056699)                  
s6(x22)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s7(x23)             0x0000000080180ba3(2149059491)                  0x0000000080180ba3(2149059491)                  
...
t3(x28)             0x000000007ffffe89(2147483273)                  0x000000007ffffe89(2147483273)                  
...
t6(x31)             0x000000008000041c(2147484700)                  0x000000008000041c(2147484700)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            460fa91073a8541c8acb6fc6fc3d886eb13245d4        460fa91073a8541c8acb6fc6fc3d886eb13245d4        
