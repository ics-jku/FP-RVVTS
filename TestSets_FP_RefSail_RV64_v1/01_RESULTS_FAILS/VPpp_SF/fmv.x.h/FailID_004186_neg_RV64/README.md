# FailID_004186 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f22'}, 'clob': {'x5'}})
    fmv.x.h x5, f22
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d2751c0d9ae44aa0d69fcbfa42b17f4dc2016829        d2751c0d9ae44aa0d69fcbfa42b17f4dc2016829        
