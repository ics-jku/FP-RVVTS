# FailID_000281 ARA pos RV64 fsqrt.d
...
_reg_f29:.byte 0xff,0x02,0x00,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f27
    fld  f27, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f27'}})
    fsqrt.d f27, f29, rup
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0x1f56a09eaa4a75fd(1.0300477049297216e-157_d)   0x1f56a09eaa4a75fc(1.0300477049297214e-157_d)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f27, f29, rup
+========================================================================================================================+
...
Registers: f27, f29
f27                 0x1f56a09eaa4a75fd(1.0300477049297216e-157_d)   0x1f56a09eaa4a75fc(1.0300477049297214e-157_d)   X
f29                 0x00000000800002ff(1.0609982744e-314_d)         0x00000000800002ff(1.0609982744e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7c958d1fa57ac97a7846af79110728d037a6c187        7c958d1fa57ac97a7846af79110728d037a6c187        
