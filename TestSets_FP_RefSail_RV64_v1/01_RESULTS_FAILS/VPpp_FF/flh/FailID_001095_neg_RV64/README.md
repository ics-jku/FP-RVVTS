# FailID_001095 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs'}, 'clob': {'x8', 'f2', 'x5'}})
...
f2                  0xffffffff7fc00000(nan_s)                       0xffffffffffffbc23(-1.0341796875_h)             X
STATES DIFFER: True
```
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f2, x13, x8
fp(x8)              0x00000000800001f1(2147484145)                  0x00000000800001f1(2147484145)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3006f6986ea3407ead6d9bb47db8bb5338dec3ea        3006f6986ea3407ead6d9bb47db8bb5338dec3ea        
