# FailID_004172 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f21', 'fcsr.rm', 'f7'}, 'clob': {'f17'}})
    fmin.s f17, f7, f21
```
...
STATE               REF                                             DUT                                             DIFF
f17                 0xffffffff42140000(37.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            31830fde75c0fb7344bb741ff51522a0164ba632        31830fde75c0fb7344bb741ff51522a0164ba632        
