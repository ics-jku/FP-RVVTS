# FailID_003829 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0xffffffff7ffffec4   // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x30'}, 'clob': {'x12', 'f29', 'x30'}})
...
a2(x12)             0x000000007ffffe3f(2147483199)                  0x000000007ffffe3f(2147483199)                  
a3(x13)             0x0000000000000200(512)                         0x0000000000000200(512)                         
a4(x14)             0x0000001fffffffef(137438953455)                0x0000001fffffffef(137438953455)                
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3473890549ecf663ff774fb407d8fde267f8c2bb        3473890549ecf663ff774fb407d8fde267f8c2bb        
