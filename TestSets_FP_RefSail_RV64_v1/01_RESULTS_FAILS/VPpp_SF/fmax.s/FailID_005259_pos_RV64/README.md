# FailID_005259 VP++ SF pos RV64 fmax.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x20,0xfe,0xff,0xdf,0xc1
_reg_f20:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f21:.byte 0x23,0xb8,0x41,0x04,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'f0', 'fcsr.rm'}, 'clob': {'f20'}})
    fmax.s f20, f21, f0
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f20                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f21, f0
f0                  0xc1dffffe20000000(-2147481728.0_d)             0xc1dffffe20000000(-2147481728.0_d)
f20                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff7fc00000(nan_s)                       X
f21                 0xffffffff0441b823(2.2771592405506703e-36_s)    0xffffffff0441b823(2.2771592405506703e-36_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b9688c1dd53b86345ebb20e6a3f6d13e54af79d9        b9688c1dd53b86345ebb20e6a3f6d13e54af79d9        
