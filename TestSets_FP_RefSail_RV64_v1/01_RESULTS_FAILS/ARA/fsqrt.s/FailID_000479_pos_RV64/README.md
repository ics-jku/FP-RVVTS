# FailID_000479 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs'}, 'clob': {'f0'}})
    fsqrt.s f0, f27, rup
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff305db418(8.065526024836345e-10_s)     0xffffffff305db417(8.065525469724832e-10_s)     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f0, f27, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ecdded2577815ba60ec01a44a20c53dc448cb368        ecdded2577815ba60ec01a44a20c53dc448cb368        
