# FailID_001047 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x21, 0x0                  // s5
    li x22, 0x6000               // s6
    li x23, 0x8000060f           // s7
    li x24, 0x801806d7           // s8
    li x25, 0x16                 // s9
    li x26, 0x1                  // s10
    li x27, 0x1                  // s11
    li x28, 0x1                  // t3
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x18'}, 'clob': {'x5', 'x18', 'f7'}})
...
f7                  0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f7, x307, x18
s2(x18)             0x000000008017fbaf(2149055407)                  0x000000008017fbaf(2149055407)
f7                  0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
+========================================================================================================================+
```
...
t0(x5)              0x0000000080000307(2147484423)                  0x0000000080000307(2147484423)                  
...
a1(x11)             0x0000000000060000(393216)                      0x0000000000060000(393216)                      
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8322733d974d478fb66b5b6e15cf07af9f97c031        8322733d974d478fb66b5b6e15cf07af9f97c031        
