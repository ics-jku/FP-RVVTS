# FailID_003101 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x80,0xb3,0xfe,0xff,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x11'}})
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x11, f0, rtz
+========================================================================================================================+
...
Registers: x11, f0
a1(x11)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f0                  0x41dffffeb3800000(2147482318.0_d)              0x41dffffeb3800000(2147482318.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1bc1d3a8d1ba4385a85f6c3070d0ce8334c816a8        1bc1d3a8d1ba4385a85f6c3070d0ce8334c816a8        
