# FailID_000175 ARA pos RV64 fdiv.s
...
_reg_f27:.byte 0x00,0x00,0x00,0xe0,0xff,0xff,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f27', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f23'}})
    fdiv.s f23, f10, f27, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f23, f10, f27, rmm
+========================================================================================================================+
...
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, f10, f27
f10                 0x4080000000000000(512.0_d)                     0x4080000000000000(512.0_d)
f23                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f27                 0xc1dfffffe0000000(-2147483520.0_d)             0xc1dfffffe0000000(-2147483520.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            86a26d84a3dcc71b7a0f496250ad33b0c8a127db        86a26d84a3dcc71b7a0f496250ad33b0c8a127db        
