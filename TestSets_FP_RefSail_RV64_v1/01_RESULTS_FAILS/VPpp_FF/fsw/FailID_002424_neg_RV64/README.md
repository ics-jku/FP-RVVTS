# FailID_002424 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f30', 'x14'}, 'clob': {'x14', 'x15'}})
...
```
+========================================================================================================================+
Instruction: fsw f30, 0x3e6(x14)
+========================================================================================================================+
Attributes:  fcsr ['invalid', 'underflow', 'overflow', 'div-by-0', 'inexact'], special values ['nan']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, x3, e6, x14
gp(x3)              0x000000000000006b(107)                         0x000000000000006b(107)
a4(x14)             0x000000008017fc1a(2149055514)                  0x000000008017fc1a(2149055514)
...
a4(x14)             0x000000008017fc1a(2149055514)                  0x000000008017fc1a(2149055514)                  
a5(x15)             0x000000008017fc1a(2149055514)                  0x000000008017fc1a(2149055514)                  
...
s7(x23)             0x00000000dbeca718(3689719576)                  0x00000000dbeca718(3689719576)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2fbebf1aef8ea6b9bc42dd953c925bebbe02348c        2fbebf1aef8ea6b9bc42dd953c925bebbe02348c        
