# FailID_005383 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f14', 'fcsr.rm'}, 'clob': {'f14'}})
    fmin.d f14, f19, f14
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x0000000000000000(0.0_d)                       0xffffffff44000000(512.0_s)                     X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f14, f19, f14
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f1c3ad7f1c3b09cb9abc22a1d84aa1cb94289278        f1c3ad7f1c3b09cb9abc22a1d84aa1cb94289278        
