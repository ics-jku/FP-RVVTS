# FailID_003835 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x801e597a            // fp
    li x9, 0x0                   // s1
    li x10, 0x80180679           // a0
    li x11, 0x7ffffccc           // a1
    li x12, 0x8000023f           // a2
    li x13, 0x8027fe26           // a3
    ...
    li x19, 0xe2                 // s3
    li x20, 0x0                  // s4
    li x21, 0x800007fe           // s5
    li x22, 0x80000738           // s6
    li x23, 0x8017fa32           // s7
    li x24, 0xffff801eac770000   // s8
    li x25, 0x8020017e           // s9
    li x26, 0x6000               // s10
    li x27, 0x7ffffaba           // s11
    li x28, 0x0                  // t3
    li x29, 0x0                  // t4
    li x30, 0x1                  // t5
    li x31, 0x800003f5           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm'}, 'clob': {'x29', 'x17', 'f12'}})
...
f12                 0xb94ab763561952e7(-1.0290767353988184e-32_d)   0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f12                 0xb94ab763561952e7(-1.0290767353988184e-32_d)   0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, xe6, x29
t4(x29)             0x000000007fffff1a(2147483418)                  0x000000007fffff1a(2147483418)
f12                 0xb94ab763561952e7(-1.0290767353988184e-32_d)   0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
t1(x6)              0x000000008018043e(2149057598)                  0x000000008018043e(2149057598)                  
...
a0(x10)             0x0000000080180679(2149058169)                  0x0000000080180679(2149058169)                  
...
a3(x13)             0x000000008027fe26(2150104614)                  0x000000008027fe26(2150104614)                  
...
s5(x21)             0x00000000800007fe(2147485694)                  0x00000000800007fe(2147485694)                  
s6(x22)             0x0000000080000738(2147485496)                  0x0000000080000738(2147485496)                  
s7(x23)             0x000000008017fa32(2149055026)                  0x000000008017fa32(2149055026)                  
s8(x24)             0xffff801eac770000(18446603467963695104)        0xffff801eac770000(18446603467963695104)        
...
s11(x27)            0x000000007ffffaba(2147482298)                  0x000000007ffffaba(2147482298)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bf93e1063e71559166a75274eebb2ba46dbec6f7        bf93e1063e71559166a75274eebb2ba46dbec6f7        
