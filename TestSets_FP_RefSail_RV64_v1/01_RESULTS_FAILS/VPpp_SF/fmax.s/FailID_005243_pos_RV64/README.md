# FailID_005243 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm', 'f3'}, 'clob': {'f12'}})
    fmax.s f12, f10, f3
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff4f000059(2147506432.0_s)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            25f50822d9258e28eba06a3fb6c89ce9a6dfb70c        25f50822d9258e28eba06a3fb6c89ce9a6dfb70c        
