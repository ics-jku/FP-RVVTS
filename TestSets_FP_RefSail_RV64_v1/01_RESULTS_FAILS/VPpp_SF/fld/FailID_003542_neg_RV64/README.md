# FailID_003542 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x25, 0x19                 // s9
    li x26, 0x0                  // s10
    li x27, 0x801ffedc           // s11
    li x28, 0x28                 // t3
    li x29, 0x1                  // t4
    li x30, 0x7ffffe49           // t5
    li x31, 0x801ffc67           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x13'}, 'clob': {'x13', 'f13', 'x30'}})
...
f13                 0xffffffff2140006f(6.505270420568022e-19_s)     0x0271b4230261b023(6.767485356171125e-297_d)    X
STATES DIFFER: True
```
...
f13                 0xffffffff2140006f(6.505270420568022e-19_s)     0x0271b4230261b023(6.767485356171125e-297_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f13, x67, x13
a3(x13)             0x000000007ffffaad(2147482285)                  0x000000007ffffaad(2147482285)
f13                 0xffffffff2140006f(6.505270420568022e-19_s)     0x0271b4230261b023(6.767485356171125e-297_d)    X
+========================================================================================================================+
```
...
s1(x9)              0x000000000000006c(108)                         0x000000000000006c(108)                         
...
s4(x20)             0x000000008017f9a0(2149054880)                  0x000000008017f9a0(2149054880)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            66c9d208a7d3fc5b5855bffe39fb7f9335af0c4a        66c9d208a7d3fc5b5855bffe39fb7f9335af0c4a        
