# FailID_003432 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x23, 0x0                  // s7
    li x24, 0x5a826000           // s8
    li x25, 0x0                  // s9
    li x26, 0x8000579c           // s10
    li x27, 0x8000074f           // s11
    li x28, 0x0                  // t3
    li x29, 0x739fd700           // t4
    li x30, 0x8000054a           // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x2'}, 'clob': {'f30', 'x11', 'x2'}})
...
f30                 0xffffffff7fc00000(nan_s)                       0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
s8(x24)             0x000000005a826000(1518493696)                  0x000000005a826000(1518493696)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f4d508d905a01dd1cc69827057f8b5f5d03b70c4        f4d508d905a01dd1cc69827057f8b5f5d03b70c4        
