# FailID_003576 VP++ SF neg RV64 flh
...
_float_data_end:
    ...
    li x9, 0x80185e43            // s1
    li x10, 0x7ffffd70           // a0
    li x11, 0x800007ba           // a1
    li x12, 0x7ffffcf3           // a2
    li x13, 0x7ffffafc           // a3
    li x14, 0x8017faef           // a4
    li x15, 0x8ba6788e5ef42c4d   // a5
    li x16, 0x1                  // a6
    li x17, 0x79571000           // a7
    li x18, 0x8017fcc3           // s2
    li x19, 0x4a                 // s3
    li x20, 0x8026d4e7           // s4
    li x21, 0x0                  // s5
    li x22, 0x80185e43           // s6
    li x23, 0xa9fff7a8           // s7
    li x24, 0x8017fea8           // s8
    li x25, 0x4f000              // s9
    li x26, 0x20                 // s10
    li x27, 0x80180113           // s11
    li x28, 0x6000               // t3
    li x29, 0x8017f4b9           // t4
    li x30, 0xd850f36f           // t5
    li x31, 0x8e                 // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x26'}, 'clob': {'f9', 'x26', 'x15'}})
...
f9                  0xfbf313a324a72b8c(-1.1619281931686081e+289_d)  0xffffffffffff91f3(-0.0007262229919433594_h)    X
STATES DIFFER: True
```
...
tp(x4)              0x000000000000004a(74)                          0x000000000000004a(74)                          
t0(x5)              0x0000000000000000(0)                           0x0000000000000000(0)                           
t1(x6)              0x000000008005390c(2147825932)                  0x000000008005390c(2147825932)                  
...
a0(x10)             0x000000007ffffd70(2147482992)                  0x000000007ffffd70(2147482992)                  
...
a3(x13)             0x000000007ffffafc(2147482364)                  0x000000007ffffafc(2147482364)                  
a4(x14)             0x000000008017faef(2149055215)                  0x000000008017faef(2149055215)                  
a5(x15)             0x000000007ffffb72(2147482482)                  0x000000007ffffb72(2147482482)                  
a6(x16)             0x0000000000000001(1)                           0x0000000000000001(1)                           
a7(x17)             0x0000000079571000(2035748864)                  0x0000000079571000(2035748864)                  
s2(x18)             0x000000008017fcc3(2149055683)                  0x000000008017fcc3(2149055683)                  
s3(x19)             0x000000000000004a(74)                          0x000000000000004a(74)                          
s4(x20)             0x000000008026d4e7(2150028519)                  0x000000008026d4e7(2150028519)                  
s5(x21)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s6(x22)             0x0000000080185e43(2149080643)                  0x0000000080185e43(2149080643)                  
...
s9(x25)             0x000000000004f000(323584)                      0x000000000004f000(323584)                      
s10(x26)            0x000000007ffffb92(2147482514)                  0x000000007ffffb92(2147482514)                  
s11(x27)            0x0000000080180113(2149056787)                  0x0000000080180113(2149056787)                  
...
t5(x30)             0x00000000d850f36f(3629183855)                  0x00000000d850f36f(3629183855)                  
t6(x31)             0x000000000000008e(142)                         0x000000000000008e(142)                         

STATE               REF                                             DUT                                             DIFF
xmemhash            f9c4934dc6d01c5079b4e2c76f6858f474ae122e        f9c4934dc6d01c5079b4e2c76f6858f474ae122e        
