# FailID_004115 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f27'}, 'clob': {'f15'}})
    fmax.d f15, f6, f27
```
...
STATE               REF                                             DUT                                             DIFF
f15                 0xe6975f5fb8a2a476(-1.5889986046966891e+186_d)  0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6a6994d10f58fcfd0b48d4131caf84213be4c2ee        6a6994d10f58fcfd0b48d4131caf84213be4c2ee        
