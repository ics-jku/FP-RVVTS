# FailID_005228 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f4'}, 'clob': {'f13'}})
    fmax.s f13, f4, f13
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0xffffffffbf800000(-1.0_s)                      0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9041b3c9c41644c53252be8d6f724b133930613d        9041b3c9c41644c53252be8d6f724b133930613d        
