# FailID_002000 VP++ FF neg RV64 fsh
...
_float_data_end:
    ...
    li x28, 0x7a                 // t3
    li x29, 0x3713876c           // t4
    li x30, 0x0                  // t5
    li x31, 0x8017ff2f           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f8', 'x20'}, 'clob': {'x29', 'x20'}})
...
a0(x10)             0x000000008017fe72(2149056114)                  0x000000008017fe72(2149056114)                  
...
t4(x29)             0x000000008017fa60(2149055072)                  0x000000008017fa60(2149055072)                  
t5(x30)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t6(x31)             0x000000008017ff2f(2149056303)                  0x000000008017ff2f(2149056303)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            66d5b6f4afa9e04cda8a57dea8f681397e26dbe2        66d5b6f4afa9e04cda8a57dea8f681397e26dbe2        
