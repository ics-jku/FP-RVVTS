# FailID_005411 VP++ SF pos RV64 fmin.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f5', 'f2'}, 'clob': {'f0'}})
    fmin.d f0, f2, f5
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0x0000000000000000(0.0_d)                       0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            cd8e7beed6223fd688963b233509e7bf6ff8ad5f        cd8e7beed6223fd688963b233509e7bf6ff8ad5f        
