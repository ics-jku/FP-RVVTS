# FailID_005437 VP++ SF pos RV64 fmin.d
...
_reg_f18:.byte 0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'f18', 'fcsr.rm'}, 'clob': {'f16'}})
    fmin.d f16, f18, f7
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x0000000000006000(1.2142e-319_d)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f16                 0x0000000000006000(1.2142e-319_d)               0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f18, f7
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f16                 0x0000000000006000(1.2142e-319_d)               0xffffffff7fc00000(nan_s)                       X
f18                 0x0000000000006000(1.2142e-319_d)               0x0000000000006000(1.2142e-319_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            191858571967a3612c4776aa6d57057bff627ef0        191858571967a3612c4776aa6d57057bff627ef0        
