# FailID_005204 VP++ SF pos RV64 fmax.d
...
_reg_f20:.byte 0x00,0x00,0x00,0x00,0x00,0x20,0x62,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f24'}})
    fmax.d f24, f20, f13
```
...
STATE               REF                                             DUT                                             DIFF
f24                 0x4062200000000000(145.0_d)                     0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f24, f20, f13
+========================================================================================================================+
...
f24                 0x4062200000000000(145.0_d)                     0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f20, f13
f13                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f20                 0x4062200000000000(145.0_d)                     0x4062200000000000(145.0_d)
f24                 0x4062200000000000(145.0_d)                     0x7ff8000000000000(nan_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            e1dbe110c5c1108466415001ea1cbfd25c05f1cd        e1dbe110c5c1108466415001ea1cbfd25c05f1cd        
