# FailID_002967 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f25:.byte 0xe3,0xc7,0x09,0xe9,0xcb,0x27,0xf0,0x7b
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f25
    fld  f25, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f25', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x3'}})
    fcvt.wu.s x3, f25
```
...
Registers: x3, f25
gp(x3)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f25                 0x7bf027cbe909c7e3(9.839998979439521e+288_d)    0x7bf027cbe909c7e3(9.839998979439521e+288_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b2ec2ac87dbf93f2b5953b588f2eea348172fa8b        b2ec2ac87dbf93f2b5953b588f2eea348172fa8b        
