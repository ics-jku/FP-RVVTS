# FailID_000234 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f5: .byte 0xf8,0x07,0x00,0x80,0x00,0x00,0x00,0x00
_reg_f11:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f27:.byte 0x00,0x00,0xe0,0x14,0xff,0x02,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f5', 'mstatus.fs/vs.fs', 'f11'}, 'clob': {'f27'}})
    fdiv.s f27, f11, f5, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f27, f11, f5, rmm
+========================================================================================================================+
...
f27                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, f11, f5
f5                  0x00000000800007f8(1.0609989034e-314_d)         0x00000000800007f8(1.0609989034e-314_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7dbf58cee74027741424137034cb4b3d2196632c        7dbf58cee74027741424137034cb4b3d2196632c        
