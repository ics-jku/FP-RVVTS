# FailID_004935 VP++ SF neg RV64 fsw
...
_float_data_end:
    ...
    li x12, 0x8017fd84           // a2
    li x13, 0x0                  // a3
    li x14, 0x800000e2           // a4
    li x15, 0xeb                 // a5
    ...
    li x25, 0x8000068d           // s9
    li x26, 0x0                  // s10
    li x27, 0x80000634           // s11
    li x28, 0x1                  // t3
    li x29, 0x8017f9a4           // t4
    li x30, 0x8017f842           // t5
    li x31, 0x8027f620           // t6
    // INSTRUCTION ({'dep': {'f17', 'x14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x14', 'x8'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6aaedd33f38b6ef175208640c42271accaeb4b17        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f17, x626, x14
a4(x14)             0x0000000080180706(2149058310)                  0x0000000080180706(2149058310)
...
tp(x4)              0x0000000000000ff8(4088)                        0x0000000000000ff8(4088)                        
...
fp(x8)              0x0000000080180626(2149058086)                  0x0000000080180626(2149058086)                  
...
a2(x12)             0x000000008017fd84(2149055876)                  0x000000008017fd84(2149055876)                  
...
s9(x25)             0x000000008000068d(2147485325)                  0x000000008000068d(2147485325)                  
...
t5(x30)             0x000000008017f842(2149054530)                  0x000000008017f842(2149054530)                  
t6(x31)             0x000000008027f620(2150102560)                  0x000000008027f620(2150102560)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            c871921381ea8e41931bef5b3770504580165017        c871921381ea8e41931bef5b3770504580165017        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        6aaedd33f38b6ef175208640c42271accaeb4b17        X
