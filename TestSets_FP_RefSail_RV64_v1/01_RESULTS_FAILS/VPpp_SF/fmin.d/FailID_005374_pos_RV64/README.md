# FailID_005374 VP++ SF pos RV64 fmin.d
...
_reg_f22:.byte 0x83,0xb2,0x01,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f30', 'fcsr.rm', 'f22'}, 'clob': {'f3'}})
    fmin.d f3, f30, f22
```
...
STATE               REF                                             DUT                                             DIFF
f3                  0x0000000000000000(0.0_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
STATES DIFFER: True
```
...
f3                  0x0000000000000000(0.0_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f3, f30, f22
f3                  0x0000000000000000(0.0_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
f22                 0xffffffff0001b283(1.5587343467917103e-40_s)    0xffffffff0001b283(1.5587343467917103e-40_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8d33df4a113bd2f605029519a017ea610ea3a386        8d33df4a113bd2f605029519a017ea610ea3a386        
