# FailID_004335 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x7, 0xd5                  // t2
    li x8, 0x0                   // fp
    li x9, 0xd2000ad3d2000a53    // s1
    li x10, 0x0                  // a0
    li x11, 0x0                  // a1
    li x12, 0x8017f91c           // a2
    li x13, 0x7fffffff           // a3
    li x14, 0x8017ffe6           // a4
    li x15, 0xe8                 // a5
    li x16, 0x7fffffffffffffff   // a6
    li x17, 0x7fffffff           // a7
    li x18, 0x0                  // s2
    li x19, 0x228c1000           // s3
    li x20, 0x7ffffd72           // s4
    li x21, 0x80280422           // s5
    ...
    li x27, 0x0                  // s11
    li x28, 0x0                  // t3
    li x29, 0x7ffffffa           // t4
    li x30, 0x80180216           // t5
    li x31, 0x8025299e           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm', 'f4'}, 'clob': {'x21', 'x30'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ccdf505933aa67d1337131b0e46b844e79cd245a        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f4, x3, x21
gp(x3)              0x000000008017f393(2149053331)                  0x000000008017f393(2149053331)
s5(x21)             0x00000000802007ca(2149582794)                  0x00000000802007ca(2149582794)
...
t2(x7)              0x00000000000000d5(213)                         0x00000000000000d5(213)                         
fp(x8)              0x0000000000000000(0)                           0x0000000000000000(0)                           
s1(x9)              0xd2000ad3d2000a53(15132106652842461779)        0xd2000ad3d2000a53(15132106652842461779)        
a0(x10)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a1(x11)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a2(x12)             0x000000008017f91c(2149054748)                  0x000000008017f91c(2149054748)                  
a3(x13)             0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
a4(x14)             0x000000008017ffe6(2149056486)                  0x000000008017ffe6(2149056486)                  
a5(x15)             0x00000000000000e8(232)                         0x00000000000000e8(232)                         
a6(x16)             0x7fffffffffffffff(9223372036854775807)         0x7fffffffffffffff(9223372036854775807)         
a7(x17)             0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x00000000228c1000(579604480)                   0x00000000228c1000(579604480)                   
s4(x20)             0x000000007ffffd72(2147482994)                  0x000000007ffffd72(2147482994)                  
s5(x21)             0x00000000802007ca(2149582794)                  0x00000000802007ca(2149582794)                  
...
t4(x29)             0x000000007ffffffa(2147483642)                  0x000000007ffffffa(2147483642)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a5af2ddbc5d6e93b0001c782520956ba661538e0        a5af2ddbc5d6e93b0001c782520956ba661538e0        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ccdf505933aa67d1337131b0e46b844e79cd245a        X
