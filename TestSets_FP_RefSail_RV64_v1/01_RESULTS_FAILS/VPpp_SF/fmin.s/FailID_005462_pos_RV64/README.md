# FailID_005462 VP++ SF pos RV64 fmin.s
...
_reg_f12:.byte 0x07,0xbb,0x02,0x00,0x97,0x02,0x00,0x00
_reg_f31:.byte 0x0c,0x47,0x35,0x0c,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f6
    fld  f6, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f31'}, 'clob': {'f12'}})
    fmin.s f12, f31, f6
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0xffffffff0c35470c(1.3965112688616343e-31_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f12                 0xffffffff0c35470c(1.3965112688616343e-31_s)    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f31, f6
f6                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f12                 0xffffffff0c35470c(1.3965112688616343e-31_s)    0xffffffff7fc00000(nan_s)                       X
f31                 0xffffffff0c35470c(1.3965112688616343e-31_s)    0xffffffff0c35470c(1.3965112688616343e-31_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d218a44d411253bcd3f02e36a062c1f141f8af79        d218a44d411253bcd3f02e36a062c1f141f8af79        
