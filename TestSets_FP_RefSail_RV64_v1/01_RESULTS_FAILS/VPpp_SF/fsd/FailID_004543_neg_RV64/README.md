# FailID_004543 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x11, 0xfffffffffffffd6e   // a1
    li x12, 0x7ffff85d           // a2
    li x13, 0x1                  // a3
    li x14, 0x1                  // a4
    li x15, 0x7ffff89b           // a5
    li x16, 0x5ddff74c           // a6
    ...
    li x22, 0xe3                 // s6
    li x23, 0x8018043e           // s7
    li x24, 0xf1                 // s8
    li x25, 0x2                  // s9
    li x26, 0x6000               // s10
    li x27, 0x8000028a           // s11
    li x28, 0x0                  // t3
    li x29, 0x80000282           // t4
    li x30, 0x13e1b023           // t5
    li x31, 0x80180080           // t6
    // INSTRUCTION ({'dep': {'x5', 'f18', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'x19'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ef524c352d372d12596a7d4ef049478110a99f64        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f18, x178, x5
t0(x5)              0x0000000080218058(2149679192)                  0x0000000080218058(2149679192)
...
tp(x4)              0xfffffffffffff9e8(18446744073709550056)        0xfffffffffffff9e8(18446744073709550056)        
t0(x5)              0x0000000080218058(2149679192)                  0x0000000080218058(2149679192)                  
t1(x6)              0x000000008017a0cb(2149032139)                  0x000000008017a0cb(2149032139)                  
...
a1(x11)             0xfffffffffffffd6e(18446744073709550958)        0xfffffffffffffd6e(18446744073709550958)        
...
a6(x16)             0x000000005ddff74c(1574958924)                  0x000000005ddff74c(1574958924)                  
...
s7(x23)             0x000000008018043e(2149057598)                  0x000000008018043e(2149057598)                  
s8(x24)             0x00000000000000f1(241)                         0x00000000000000f1(241)                         
s9(x25)             0x0000000000000002(2)                           0x0000000000000002(2)                           
s10(x26)            0x0000000000006000(24576)                       0x0000000000006000(24576)                       
s11(x27)            0x000000008000028a(2147484298)                  0x000000008000028a(2147484298)                  
t3(x28)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t4(x29)             0x0000000080000282(2147484290)                  0x0000000080000282(2147484290)                  
t5(x30)             0x0000000013e1b023(333557795)                   0x0000000013e1b023(333557795)                   
t6(x31)             0x0000000080180080(2149056640)                  0x0000000080180080(2149056640)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            37f29396a595b0fde1e05a46c5f5762f46d71de9        37f29396a595b0fde1e05a46c5f5762f46d71de9        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        ef524c352d372d12596a7d4ef049478110a99f64        X
