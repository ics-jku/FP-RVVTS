# FailID_002798 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f18:.byte 0x00,0x00,0xa0,0x72,0x00,0x03,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x8'}})
    fcvt.wu.d x8, f18, rdn
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
fp(x8)              0xffffffff80180395(18446744071563641749)        0x0000000080180395(2149057429)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x8, f18, rdn
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x8, f18
fp(x8)              0xffffffff80180395(18446744071563641749)        0x0000000080180395(2149057429)                  X
f18                 0x41e0030072a00000(2149057429.0_d)              0x41e0030072a00000(2149057429.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            b309f3174cab05c502295b95f24c8db88e5d0a6b        b309f3174cab05c502295b95f24c8db88e5d0a6b        
