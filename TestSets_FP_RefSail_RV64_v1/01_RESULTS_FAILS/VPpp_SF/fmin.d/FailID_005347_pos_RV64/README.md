# FailID_005347 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f9: .byte 0x00,0x00,0x00,0x9e,0x6b,0x0d,0xcb,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f9', 'mstatus.fs/vs.fs', 'f13', 'fcsr.rm'}, 'clob': {'f14'}})
    fmin.d f14, f9, f13
```
...
STATE               REF                                             DUT                                             DIFF
f14                 0x41cb0d6b9e000000(907728700.0_d)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f14                 0x41cb0d6b9e000000(907728700.0_d)               0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f14, f9, f13
f9                  0x41cb0d6b9e000000(907728700.0_d)               0x41cb0d6b9e000000(907728700.0_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            483a1e3cd1bd936c242402b10a2e4f6808de2ad4        483a1e3cd1bd936c242402b10a2e4f6808de2ad4        
