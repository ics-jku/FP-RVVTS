# FailID_004275 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x8017fbbe            // fp
    li x9, 0x800000fd            // s1
    li x10, 0x7ffffa78           // a0
    li x11, 0x1                  // a1
    li x12, 0x7ffff94f           // a2
    li x13, 0x80000397           // a3
    li x14, 0x91f3               // a4
    li x15, 0x7ffffa78           // a5
    li x16, 0x8005d9ad           // a6
    li x17, 0x0                  // a7
    li x18, 0x80000229           // s2
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'x18'}, 'clob': {'x12', 'x18'}})
...
t2(x7)              0x00000000000000f3(243)                         0x00000000000000f3(243)                         
...
a0(x10)             0x000000007ffffa78(2147482232)                  0x000000007ffffa78(2147482232)                  
...
a5(x15)             0x000000007ffffa78(2147482232)                  0x000000007ffffa78(2147482232)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a439f183f46b4247828c6e0778ca9067a71c3e28        a439f183f46b4247828c6e0778ca9067a71c3e28        
