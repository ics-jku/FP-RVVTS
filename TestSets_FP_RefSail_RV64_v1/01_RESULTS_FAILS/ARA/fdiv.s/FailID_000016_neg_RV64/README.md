# FailID_000016 ARA neg RV64 fdiv.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f11', 'f25'}, 'clob': {'f1'}})
    fdiv.s f1, f25, f11, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f1                  0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f1, f25, f11, rmm
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0f7cccf6f12e93928faeadf8431f98992ab32b46        0f7cccf6f12e93928faeadf8431f98992ab32b46        
