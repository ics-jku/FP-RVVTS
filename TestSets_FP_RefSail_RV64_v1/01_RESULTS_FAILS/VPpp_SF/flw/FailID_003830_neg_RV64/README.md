# FailID_003830 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x30, 0x1                  // t5
    li x31, 0x200                // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x31'}, 'clob': {'f10', 'x19', 'x31'}})
...
f10                 0x7ff8000000000000(nan_d)                       0xffffffff0001b283(1.5587343467917103e-40_s)    X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            23ac893024b62684c14350927cdc409dffac0dfe        23ac893024b62684c14350927cdc409dffac0dfe        
