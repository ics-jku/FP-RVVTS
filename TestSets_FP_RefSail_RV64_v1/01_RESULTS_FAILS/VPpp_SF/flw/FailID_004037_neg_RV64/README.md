# FailID_004037 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0x8017fb0c           // a2
    li x13, 0x8017fdcc           // a3
    li x14, 0x7ffffa92           // a4
    li x15, 0x0                  // a5
    li x16, 0x80005fa7           // a6
    li x17, 0x8000017b           // a7
    li x18, 0x8017ff20           // s2
    ...
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'f18', 'x10', 'x7'}})
...
f18                 0xffffffffffc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
t0(x5)              0x0000000080278fbc(2150076348)                  0x0000000080278fbc(2150076348)                  
...
a2(x12)             0x000000008017fb0c(2149055244)                  0x000000008017fb0c(2149055244)                  
...
a7(x17)             0x000000008000017b(2147484027)                  0x000000008000017b(2147484027)                  
s2(x18)             0x000000008017ff20(2149056288)                  0x000000008017ff20(2149056288)                  
s3(x19)             0xffffffffe49d2000(18446744073250086912)        0xffffffffe49d2000(18446744073250086912)        
s4(x20)             0x000000007fffffa7(2147483559)                  0x000000007fffffa7(2147483559)                  
...
t6(x31)             0x41db081800000000(4745395531537186816)         0x41db081800000000(4745395531537186816)         

STATE               REF                                             DUT                                             DIFF
xmemhash            1dad54ac1bec93a8ba7a59f89b0f326dd7d23bd9        1dad54ac1bec93a8ba7a59f89b0f326dd7d23bd9        
