# FailID_004167 VP++ SF neg RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f9', 'f1'}, 'clob': {'f28'}})
    fmin.s f28, f9, f1
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xffffffff00006000(3.4438311059246704e-41_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            32eeb01c01b248e81d1c43138abc9f024d2c0c2e        32eeb01c01b248e81d1c43138abc9f024d2c0c2e        
