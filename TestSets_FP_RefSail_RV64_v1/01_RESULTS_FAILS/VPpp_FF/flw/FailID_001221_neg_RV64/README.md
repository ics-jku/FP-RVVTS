# FailID_001221 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x26, 0x0                  // s10
    li x27, 0x6000               // s11
    li x28, 0x1d4d0744           // t3
    li x29, 0x62                 // t4
    li x30, 0x8017f9b5           // t5
    li x31, 0x800006f4           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29'}, 'clob': {'x30', 'x29', 'f22'}})
...
f22                 0xffffffffffc00000(nan_s)                       0xffffffff340191f3(1.2067157229012082e-07_s)    X
STATES DIFFER: True
```
...
f22                 0xffffffffffc00000(nan_s)                       0xffffffff340191f3(1.2067157229012082e-07_s)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x4, x29
tp(x4)              0x0000000000000032(50)                          0x0000000000000032(50)
t4(x29)             0x000000008000050b(2147484939)                  0x000000008000050b(2147484939)
f22                 0xffffffffffc00000(nan_s)                       0xffffffff340191f3(1.2067157229012082e-07_s)    X
+========================================================================================================================+
```
...
t3(x28)             0x000000001d4d0744(491587396)                   0x000000001d4d0744(491587396)                   
t4(x29)             0x000000008000050b(2147484939)                  0x000000008000050b(2147484939)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1bc8fb5f5bf55787b746b25fe6f2e2bb6dbdee7        c1bc8fb5f5bf55787b746b25fe6f2e2bb6dbdee7        
