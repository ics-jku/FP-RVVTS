# FailID_005286 VP++ SF pos RV64 fmax.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f0', 'fcsr.rm'}, 'clob': {'f20'}})
    fmax.s f20, f0, f27
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff42640000(57.0_s)                      0xffffffffffc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            979d86d171d5112c4a6a0ec60768b053d9fcdca1        979d86d171d5112c4a6a0ec60768b053d9fcdca1        
