# FailID_005536 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f11:.byte 0x00,0x00,0x00,0x00,0xf8,0xff,0x0f,0x41
_reg_f16:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0xff
_reg_f28:.byte 0x00,0x18,0x80,0x45,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f11
    fld  f11, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f11', 'fcsr.rm', 'f28'}, 'clob': {'f16'}})
    fmin.s f16, f28, f11
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff45801800(4099.0_s)                    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.s f16, f28, f11
+========================================================================================================================+
...
f16                 0xffffffff45801800(4099.0_s)                    0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f28, f11
f11                 0x410ffff800000000(262143.0_d)                  0x410ffff800000000(262143.0_d)
f16                 0xffffffff45801800(4099.0_s)                    0xffffffff7fc00000(nan_s)                       X
f28                 0xffffffff45801800(4099.0_s)                    0xffffffff45801800(4099.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6c556cdcf5a16bdf09b25c120b6bfb6a12fb260a        6c556cdcf5a16bdf09b25c120b6bfb6a12fb260a        
