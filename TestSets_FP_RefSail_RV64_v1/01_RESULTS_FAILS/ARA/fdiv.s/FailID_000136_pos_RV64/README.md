# FailID_000136 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00
_reg_f7: .byte 0x00,0x00,0x80,0xb4,0x00,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f7'}, 'clob': {'f24'}})
    fdiv.s f24, f1, f7, rup
```
...
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff80400000(-5.877471754111438e-39_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f24, f1, f7, rup
+========================================================================================================================+
Attributes:  fcsr ['underflow'], special values ['nan'], precision mismatch ('s', 'd')
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f24, f1, f7
f1                  0x0000000000000001(5e-324_d)                    0x0000000000000001(5e-324_d)
f7                  0x41e00300b4800000(2149057956.0_d)              0x41e00300b4800000(2149057956.0_d)
f24                 0xffffffff7fc00000(nan_s)                       0xffffffff80400000(-5.877471754111438e-39_s)    X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a09cc721f71ba967c982b8c58f22650d4a2561cd        a09cc721f71ba967c982b8c58f22650d4a2561cd        
