# FailID_005526 VP++ SF pos RV64 fmin.s
...
_reg_f13:.byte 0x03,0x28,0x00,0x4f,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f13'}})
    fmin.s f13, f3, f20
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            408f3b3f129b61daca82087dddf5f9e047e25048        408f3b3f129b61daca82087dddf5f9e047e25048        
