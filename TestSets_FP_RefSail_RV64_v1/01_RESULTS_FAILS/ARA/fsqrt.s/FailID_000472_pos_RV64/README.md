# FailID_000472 ARA pos RV64 fsqrt.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f3', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f16'}})
    fsqrt.s f16, f3, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0xffffffff41b504f3(22.627416610717773_s)        0xffffffff41b504f4(22.627418518066406_s)        X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f16, f3, rdn
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            1015c0c07f77805201560adfeca9d65db247caae        1015c0c07f77805201560adfeca9d65db247caae        
