# FailID_002866 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f31:.byte 0xfa,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f31
    fld  f31, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f31', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x14'}})
    fcvt.wu.d x14, f31, rne
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a4(x14)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x14, f31, rne
+========================================================================================================================+
...
Registers: x14, f31
a4(x14)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f31                 0xffffffff4f0017fa(2149054976.0_s)              0xffffffff4f0017fa(2149054976.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            662f3ec4476016f13139a6be4977eb19862378d8        662f3ec4476016f13139a6be4977eb19862378d8        
