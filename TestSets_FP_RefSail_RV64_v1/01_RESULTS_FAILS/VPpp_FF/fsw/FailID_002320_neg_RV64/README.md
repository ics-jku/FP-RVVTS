# FailID_002320 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x7, 0x0                   // t2
    li x8, 0x80200803            // fp
    li x9, 0xfffffffffffffb01    // s1
    li x10, 0x80                 // a0
    li x11, 0xffffffffaf3ad000   // a1
    li x12, 0x8017fb3d           // a2
    li x13, 0xffffffffffffffd8   // a3
    li x14, 0x0                  // a4
    li x15, 0x7e80000000         // a5
    li x16, 0x1                  // a6
    ...
    li x21, 0x1                  // s5
    li x22, 0xffffffff7fe7f8a6   // s6
    li x23, 0x31                 // s7
    li x24, 0x7ffffb9d           // s8
    li x25, 0x1                  // s9
    li x26, 0x801806a5           // s10
    li x27, 0x80000406           // s11
    li x28, 0x7ffff95f           // t3
    li x29, 0xffffffff99cf1000   // t4
    li x30, 0x8027f7c8           // t5
    li x31, 0x801808a3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x27', 'f27'}, 'clob': {'x27', 'x1'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        5b9852bd62f67e28cde687a2d8b333979d39cbb2        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f27, x76, x27
s11(x27)            0x000000008018038e(2149057422)                  0x000000008018038e(2149057422)
...
ra(x1)              0x000000008017ff8a(2149056394)                  0x000000008017ff8a(2149056394)                  
sp(x2)              0x0000000000000000(0)                           0x0000000000000000(0)                           
gp(x3)              0x0000000080000376(2147484534)                  0x0000000080000376(2147484534)                  
tp(x4)              0x0000000000006000(24576)                       0x0000000000006000(24576)                       
t0(x5)              0x00000000802002c3(2149581507)                  0x00000000802002c3(2149581507)                  
...
s1(x9)              0xfffffffffffffb01(18446744073709550337)        0xfffffffffffffb01(18446744073709550337)        
...
a3(x13)             0xffffffffffffffd8(18446744073709551576)        0xffffffffffffffd8(18446744073709551576)        
a4(x14)             0x0000000000000000(0)                           0x0000000000000000(0)                           
a5(x15)             0x0000007e80000000(543313362944)                0x0000007e80000000(543313362944)                
...
s6(x22)             0xffffffff7fe7f8a6(18446744071560493222)        0xffffffff7fe7f8a6(18446744071560493222)        
s7(x23)             0x0000000000000031(49)                          0x0000000000000031(49)                          
s8(x24)             0x000000007ffffb9d(2147482525)                  0x000000007ffffb9d(2147482525)                  
s9(x25)             0x0000000000000001(1)                           0x0000000000000001(1)                           
s10(x26)            0x00000000801806a5(2149058213)                  0x00000000801806a5(2149058213)                  
s11(x27)            0x000000008018038e(2149057422)                  0x000000008018038e(2149057422)                  
t3(x28)             0x000000007ffff95f(2147481951)                  0x000000007ffff95f(2147481951)                  
t4(x29)             0xffffffff99cf1000(18446744071995068416)        0xffffffff99cf1000(18446744071995068416)        
t5(x30)             0x000000008027f7c8(2150102984)                  0x000000008027f7c8(2150102984)                  
t6(x31)             0x00000000801808a3(2149058723)                  0x00000000801808a3(2149058723)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            6bb1f9c4f4af6ff06851abf3e8223f721f536b3e        6bb1f9c4f4af6ff06851abf3e8223f721f536b3e        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        5b9852bd62f67e28cde687a2d8b333979d39cbb2        X
