# FailID_002527 VP++ FF pos RV64 fcvt.wu.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f10', 'fcsr.rm'}, 'clob': {'x27'}})
    fcvt.wu.d x27, f10
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            6dc50fddd9a0b5ad1d3b4d616c022884c846ed7e        6dc50fddd9a0b5ad1d3b4d616c022884c846ed7e        
