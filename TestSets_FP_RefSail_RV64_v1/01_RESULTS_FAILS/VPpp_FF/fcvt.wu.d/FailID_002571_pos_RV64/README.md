# FailID_002571 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f16:.byte 0x03,0xd0,0xff,0x4e,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f16
    fld  f16, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f16', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x11'}})
    fcvt.wu.d x11, f16, rne
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x11, f16, rne
+========================================================================================================================+
...
Registers: x11, f16
a1(x11)             0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f16                 0xffffffff4effd003(2145911168.0_s)              0xffffffff4effd003(2145911168.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            63bdc00923b5ae86eab0db7d1e30e449d872928e        63bdc00923b5ae86eab0db7d1e30e449d872928e        
