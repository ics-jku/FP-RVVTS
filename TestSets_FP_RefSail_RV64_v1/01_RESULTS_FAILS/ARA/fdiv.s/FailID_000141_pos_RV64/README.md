# FailID_000141 ARA pos RV64 fdiv.s
...
_reg_f29:.byte 0xc7,0xfe,0x17,0x80,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f10
    fld  f10, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f10'}})
    fdiv.s f10, f29, f24, rne
```
...
f10                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f10, f29, f24, rne
+========================================================================================================================+
...
f10                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f29, f24
f10                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
f24                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f29                 0x000000008017fec7(1.061774839e-314_d)          0x000000008017fec7(1.061774839e-314_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0d36139f3f7961e89eaad9eccc35763afee08c50        0d36139f3f7961e89eaad9eccc35763afee08c50        
