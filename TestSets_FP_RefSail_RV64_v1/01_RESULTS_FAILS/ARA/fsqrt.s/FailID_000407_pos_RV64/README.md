# FailID_000407 ARA pos RV64 fsqrt.s
...
_reg_f20:.byte 0x00,0x00,0x00,0x00,0x4c,0xff,0xef,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f8
    fld  f8, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f20', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f8'}})
    fsqrt.s f8, f20, rmm
```
...
STATE               REF                                             DUT                                             DIFF
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f8, f20, rmm
+========================================================================================================================+
...
Registers: f8, f20
f8                  0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f20                 0x41efff4c00000000(4294598656.0_d)              0x41efff4c00000000(4294598656.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f1b22608612ba799d08814458646485df322493f        f1b22608612ba799d08814458646485df322493f        
