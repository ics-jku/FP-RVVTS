# FailID_003142 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f14:.byte 0x00,0x00,0x00,0x28,0xfe,0xf9,0xdf,0xc1
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x7'}})
    fcvt.wu.s x7, f14, rtz
```
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x7, f14, rtz
+========================================================================================================================+
...
Registers: x7, f14
t2(x7)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f14                 0xc1dff9fe28000000(-2145908896.0_d)             0xc1dff9fe28000000(-2145908896.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            3b717c36e3c5e027e09bf38228a71370e63ea86a        3b717c36e3c5e027e09bf38228a71370e63ea86a        
