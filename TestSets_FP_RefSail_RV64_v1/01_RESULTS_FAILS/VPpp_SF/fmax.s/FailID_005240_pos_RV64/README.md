# FailID_005240 VP++ SF pos RV64 fmax.s
...
_reg_f29:.byte 0xc0,0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f7', 'fcsr.rm', 'f31'}, 'clob': {'f29'}})
    fmax.s f29, f31, f7
```
...
STATE               REF                                             DUT                                             DIFF
f29                 0xffffffffcbfffd10(-33552928.0_s)               0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            573bcd87175c826d9d029ad073930a29fe1804ef        573bcd87175c826d9d029ad073930a29fe1804ef        
