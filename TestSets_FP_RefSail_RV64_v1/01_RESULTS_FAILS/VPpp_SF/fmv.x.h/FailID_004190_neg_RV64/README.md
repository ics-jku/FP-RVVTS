# FailID_004190 VP++ SF neg RV64 fmv.x.h
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f1'}, 'clob': {'x1'}})
    fmv.x.h x1, f1
```
...
```
REG                 REF                                             DUT                                             DIFF
ra(x1)              0x0000000000000000(0)                           0x0000000000007e00(32256)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8ef25a34aa43e93d52a1b0486081e51dcef0dd2e        8ef25a34aa43e93d52a1b0486081e51dcef0dd2e        
