# FailID_002304 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f27', 'x11'}, 'clob': {'x2', 'x11'}})
...
```
+========================================================================================================================+
Instruction: fsw f27, -0x7ee(x11)
+========================================================================================================================+
Attributes:  special values ['nan']
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
+------------------------------------------------------------------------------------------------------------------------+
diffs:
...
sp(x2)              0x00000000801807ee(2149058542)                  0x00000000801807ee(2149058542)                  
...
a0(x10)             0x00000000800006ab(2147485355)                  0x00000000800006ab(2147485355)                  
a1(x11)             0x000000008027fee6(2150104806)                  0x000000008027fee6(2150104806)                  
...
s11(x27)            0x0000000000000079(121)                         0x0000000000000079(121)                         
...
STATE               REF                                             DUT                                             DIFF
xmemhash            bdaf17373e855de2fd6f97a6be2fa96656d99734        bdaf17373e855de2fd6f97a6be2fa96656d99734        
