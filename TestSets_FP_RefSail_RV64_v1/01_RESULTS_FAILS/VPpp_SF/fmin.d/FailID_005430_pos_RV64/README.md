# FailID_005430 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f24:.byte 0xf1,0xff,0xff,0x4e,0xff,0xff,0xff,0x7f
_reg_f28:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0x7f
_reg_f29:.byte 0x00,0x00,0x00,0xc0,0xfe,0xf5,0xdf,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f24
    fld  f24, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f29'}, 'clob': {'f28'}})
    fmin.d f28, f29, f24
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0x41dff5fec0000000(2144860928.0_d)              0x7fffffff4efffff1(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f28, f29, f24
+========================================================================================================================+
...
f28                 0x41dff5fec0000000(2144860928.0_d)              0x7fffffff4efffff1(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f28, f29, f24
f24                 0x7fffffff4efffff1(nan_d)                       0x7fffffff4efffff1(nan_d)
f28                 0x41dff5fec0000000(2144860928.0_d)              0x7fffffff4efffff1(nan_d)                       X
f29                 0x41dff5fec0000000(2144860928.0_d)              0x41dff5fec0000000(2144860928.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ae1313fe220426ce6e97fa14c61c325122cc0e51        ae1313fe220426ce6e97fa14c61c325122cc0e51        
