# FailID_001348 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs'}, 'clob': {'x8', 'f30', 'x25'}})
...
f30                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
a6(x16)             0x000000007ffffe34(2147483188)                  0x000000007ffffe34(2147483188)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            5019ecdcaebe93d1030758be0c4060ce1972ca46        5019ecdcaebe93d1030758be0c4060ce1972ca46        
