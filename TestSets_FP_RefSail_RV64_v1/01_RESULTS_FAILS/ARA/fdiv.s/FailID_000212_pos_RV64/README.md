# FailID_000212 ARA pos RV64 fdiv.s
...
_reg_f26:.byte 0x12,0x44,0xba,0xa7,0x9e,0xa0,0x56,0x1f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f18
    fld  f18, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f18', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f26'}, 'clob': {'f22'}})
    fdiv.s f22, f18, f26, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f22, f18, f26, rdn
+========================================================================================================================+
...
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, f18, f26
f18                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f22                 0xffffffff7fc00000(nan_s)                       0xffffffff80000000(-0.0_s)                      X
f26                 0x1f56a09ea7ba4412(1.0300476979747505e-157_d)   0x1f56a09ea7ba4412(1.0300476979747505e-157_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            9646c25da5e22d2a348ca85297832fb0f7bf2f99        9646c25da5e22d2a348ca85297832fb0f7bf2f99        
