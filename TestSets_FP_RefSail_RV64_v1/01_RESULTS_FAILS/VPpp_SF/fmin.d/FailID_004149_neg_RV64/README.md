# FailID_004149 VP++ SF neg RV64 fmin.d
...
_reg_f24:.byte 0x00,0x00,0x60,0x38,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f14
    fld  f14, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f14', 'fcsr.rm', 'f24'}, 'clob': {'f20'}})
    fmin.d f20, f24, f14
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0x41e0000038600000(2147484099.0_d)              0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f20, f24, f14
+========================================================================================================================+
...
f20                 0x41e0000038600000(2147484099.0_d)              0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f24, f14
f14                 0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f20                 0x41e0000038600000(2147484099.0_d)              0xffffffff7fc00000(nan_s)                       X
f24                 0x41e0000038600000(2147484099.0_d)              0x41e0000038600000(2147484099.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            69d3008acd82be5ba7a8694a894fb41bb2b1f020        69d3008acd82be5ba7a8694a894fb41bb2b1f020        
