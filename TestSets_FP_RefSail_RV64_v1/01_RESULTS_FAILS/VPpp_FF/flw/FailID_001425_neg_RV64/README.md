# FailID_001425 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x29, 0x80180396           // t4
    li x30, 0xf8                 // t5
    li x31, 0x8017fd88           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x26', 'mstatus.fs/vs.fs'}, 'clob': {'x26', 'x24', 'f2'}})
...
f2                  0xffffffffffc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
t1(x6)              0x00000000801806e3(2149058275)                  0x00000000801806e3(2149058275)                  
t2(x7)              0x0000000000000000(0)                           0x0000000000000000(0)                           
fp(x8)              0x000000000000007d(125)                         0x000000000000007d(125)                         
...
s8(x24)             0x000000007ffff85f(2147481695)                  0x000000007ffff85f(2147481695)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ec3e7d0200151c6dbb173d6523a56a8d7abff2c9        ec3e7d0200151c6dbb173d6523a56a8d7abff2c9        
