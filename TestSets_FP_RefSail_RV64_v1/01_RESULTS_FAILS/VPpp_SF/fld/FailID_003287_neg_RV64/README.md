# FailID_003287 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x30, 0x0                  // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x22'}, 'clob': {'x1', 'x22', 'f1'}})
...
f1                  0x4068a00000000000(197.0_d)                     0x0000000000000000(0.0_d)                       X
STATES DIFFER: True
```
...
a6(x16)             0x0400c01380000000(288441566136107008)          0x0400c01380000000(288441566136107008)          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            330d5d9a1c98de74493c6f79bb1729caade16eaa        330d5d9a1c98de74493c6f79bb1729caade16eaa        
