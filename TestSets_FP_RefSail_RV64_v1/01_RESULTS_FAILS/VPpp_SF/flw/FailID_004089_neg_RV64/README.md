# FailID_004089 VP++ SF neg RV64 flw
...
_float_data_end:
    ...
    li x18, 0x0                  // s2
    li x19, 0x7ffffdba           // s3
    li x20, 0x340191f3           // s4
    li x21, 0x1                  // s5
    li x22, 0x801801bc           // s6
    li x23, 0x68                 // s7
    li x24, 0x40                 // s8
    li x25, 0x8027fad1           // s9
    li x26, 0x8017fe4c           // s10
    li x27, 0x6000               // s11
    li x28, 0x8018073b           // t3
    li x29, 0x801fff81           // t4
    li x30, 0x6000               // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x29', 'fcsr.rm'}, 'clob': {'x28', 'x29', 'f23'}})
...
f23                 0xfff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
f23                 0xfff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f23, x2, c6, x29
sp(x2)              0x0000000080000358(2147484504)                  0x0000000080000358(2147484504)
t4(x29)             0x00000000801ffcba(2149579962)                  0x00000000801ffcba(2149579962)
f23                 0xfff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
s1(x9)              0x000000008017fbb7(2149055415)                  0x000000008017fbb7(2149055415)                  
...
a5(x15)             0x0000000000000012(18)                          0x0000000000000012(18)                          
...
s7(x23)             0x0000000000000068(104)                         0x0000000000000068(104)                         
s8(x24)             0x0000000000000040(64)                          0x0000000000000040(64)                          
s9(x25)             0x000000008027fad1(2150103761)                  0x000000008027fad1(2150103761)                  
...
t3(x28)             0x000000007ffffd3a(2147482938)                  0x000000007ffffd3a(2147482938)                  
t4(x29)             0x00000000801ffcba(2149579962)                  0x00000000801ffcba(2149579962)                  
t5(x30)             0x0000000000006000(24576)                       0x0000000000006000(24576)                       
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            e1263b02ea03ddc1d2f40d16a162421a49e57eb3        e1263b02ea03ddc1d2f40d16a162421a49e57eb3        
