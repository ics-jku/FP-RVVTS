# FailID_005263 VP++ SF pos RV64 fmax.s
...
_reg_f24:.byte 0x00,0x00,0x80,0x3f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f19
    fld  f19, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f20'}})
    fmax.s f20, f24, f19
```
...
STATE               REF                                             DUT                                             DIFF
f20                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.s f20, f24, f19
+========================================================================================================================+
...
f20                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, f24, f19
f19                 0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f20                 0xffffffff3f800000(1.0_s)                       0xffffffff7fc00000(nan_s)                       X
f24                 0xffffffff3f800000(1.0_s)                       0xffffffff3f800000(1.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            def1a90e0cb88b76722155ec21249bef184d55c9        def1a90e0cb88b76722155ec21249bef184d55c9        
