# FailID_004505 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x8, 0x0                   // fp
    li x9, 0x0                   // s1
    li x10, 0xfffffffffb9b678c   // a0
    li x11, 0x3fffff             // a1
    li x12, 0x8018022d           // a2
    li x13, 0x400002             // a3
    li x14, 0x92                 // a4
    li x15, 0x7ffff937           // a5
    li x16, 0xae                 // a6
    li x17, 0xe94e6758           // a7
    li x18, 0x0                  // s2
    li x19, 0x7ffff917           // s3
    li x20, 0x0                  // s4
    li x21, 0x8000085f           // s5
    li x22, 0x6000               // s6
    li x23, 0x1                  // s7
    ...
    li x30, 0x86                 // t5
    li x31, 0x4555c000           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'x21', 'fcsr.rm', 'f22'}, 'clob': {'x21', 'x4'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        86bdabf5007ed9c093b1ce4c9ece6957ed227d31        X
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x1, x21
ra(x1)              0xffffffffeb7fb000(18446744073365598208)        0xffffffffeb7fb000(18446744073365598208)
s5(x21)             0x0000000080180a27(2149059111)                  0x0000000080180a27(2149059111)
...
t0(x5)              0x000000001ffffe45(536870469)                   0x000000001ffffe45(536870469)                   
t1(x6)              0x000000000000004a(74)                          0x000000000000004a(74)                          
...
a0(x10)             0xfffffffffb9b678c(18446744073635850124)        0xfffffffffb9b678c(18446744073635850124)        
a1(x11)             0x00000000003fffff(4194303)                     0x00000000003fffff(4194303)                     
a2(x12)             0x000000008018022d(2149057069)                  0x000000008018022d(2149057069)                  
a3(x13)             0x0000000000400002(4194306)                     0x0000000000400002(4194306)                     
a4(x14)             0x0000000000000092(146)                         0x0000000000000092(146)                         
a5(x15)             0x000000007ffff937(2147481911)                  0x000000007ffff937(2147481911)                  
a6(x16)             0x00000000000000ae(174)                         0x00000000000000ae(174)                         
a7(x17)             0x00000000e94e6758(3914229592)                  0x00000000e94e6758(3914229592)                  
s2(x18)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s3(x19)             0x000000007ffff917(2147481879)                  0x000000007ffff917(2147481879)                  
...
s10(x26)            0x0000000000000004(4)                           0x0000000000000004(4)                           
s11(x27)            0x0000000000000020(32)                          0x0000000000000020(32)                          
...
t6(x31)             0x000000004555c000(1163247616)                  0x000000004555c000(1163247616)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            7c7a9a36936832b0a8f5fb9a2d0e235133c43124        7c7a9a36936832b0a8f5fb9a2d0e235133c43124        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        86bdabf5007ed9c093b1ce4c9ece6957ed227d31        X
