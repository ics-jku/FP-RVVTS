# FailID_000760 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x16, 0x6000               // a6
    li x17, 0x0                  // a7
    li x18, 0x80180613           // s2
    li x19, 0x8017fd0e           // s3
    li x20, 0x0                  // s4
    ...
    li x25, 0x6054               // s9
    li x26, 0xa0fc3774           // s10
    li x27, 0x6000               // s11
    li x28, 0x0                  // t3
    li x29, 0x80000667           // t4
    li x30, 0x7ffffc6f           // t5
    li x31, 0x8000063e           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x31'}, 'clob': {'f12', 'x26', 'x31'}})
...
f12                 0x43dfffffffffffff(9.223372036854775e+18_d)     0x000015371f600493(1.1524819210131e-310_d)      X
STATES DIFFER: True
```
...
f12                 0x43dfffffffffffff(9.223372036854775e+18_d)     0x000015371f600493(1.1524819210131e-310_d)      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, x743, x31
t6(x31)             0x000000007ffffef5(2147483381)                  0x000000007ffffef5(2147483381)
f12                 0x43dfffffffffffff(9.223372036854775e+18_d)     0x000015371f600493(1.1524819210131e-310_d)      X
+========================================================================================================================+
```
...
s2(x18)             0x0000000080180613(2149058067)                  0x0000000080180613(2149058067)                  
s3(x19)             0x000000008017fd0e(2149055758)                  0x000000008017fd0e(2149055758)                  
...
s10(x26)            0x000000007ffff8bd(2147481789)                  0x000000007ffff8bd(2147481789)                  
s11(x27)            0x0000000000006000(24576)                       0x0000000000006000(24576)                       
t3(x28)             0x0000000000000000(0)                           0x0000000000000000(0)                           
t4(x29)             0x0000000080000667(2147485287)                  0x0000000080000667(2147485287)                  
t5(x30)             0x000000007ffffc6f(2147482735)                  0x000000007ffffc6f(2147482735)                  
t6(x31)             0x000000007ffffef5(2147483381)                  0x000000007ffffef5(2147483381)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            bf3accb8eacf6dbb7ef8f47e3bc504bfd331f7f6        bf3accb8eacf6dbb7ef8f47e3bc504bfd331f7f6        
