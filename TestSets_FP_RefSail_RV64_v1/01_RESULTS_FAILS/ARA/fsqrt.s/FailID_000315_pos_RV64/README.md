# FailID_000315 ARA pos RV64 fsqrt.s
...
_reg_f29:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf8,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f26
    fld  f26, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f26'}})
    fsqrt.s f26, f29, rup
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f26, f29, rup
+========================================================================================================================+
...
Registers: f26, f29
f26                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f29                 0xfff8000000000000(nan_d)                       0xfff8000000000000(nan_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            81a4b7462db5f07ca7c0e448e409f5fb49b83fc6        81a4b7462db5f07ca7c0e448e409f5fb49b83fc6        
