# FailID_005459 VP++ SF pos RV64 fmin.s
...
_reg_f13:.byte 0x00,0x40,0x00,0xcf,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f2'}, 'clob': {'f11'}})
    fmin.s f11, f13, f2
```
...
STATE               REF                                             DUT                                             DIFF
f11                 0xffffffffcf004000(-2151677952.0_s)             0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f11                 0xffffffffcf004000(-2151677952.0_s)             0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f13, f2
f2                  0x7ff8000000000000(nan_d)                       0x7ff8000000000000(nan_d)
f11                 0xffffffffcf004000(-2151677952.0_s)             0xffffffff7fc00000(nan_s)                       X
f13                 0xffffffffcf004000(-2151677952.0_s)             0xffffffffcf004000(-2151677952.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            176e5a7b75dcd6136575fc3efe0acbf7815222e0        176e5a7b75dcd6136575fc3efe0acbf7815222e0        
