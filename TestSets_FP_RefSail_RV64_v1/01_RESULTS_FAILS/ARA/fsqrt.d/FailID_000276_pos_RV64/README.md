# FailID_000276 ARA pos RV64 fsqrt.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f8: .byte 0x00,0x00,0x00,0xc5,0xff,0xff,0xdf,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f8', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f25'}})
    fsqrt.d f25, f8, rdn
```
...
STATE               REF                                             DUT                                             DIFF
f25                 0x40e6a09e51a329bc(46340.947465497506_d)        0x40e6a09e51a329bd(46340.94746549751_d)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.d f25, f8, rdn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f25, f8
f8                  0x41dfffffc5000000(2147483412.0_d)              0x41dfffffc5000000(2147483412.0_d)
f25                 0x40e6a09e51a329bc(46340.947465497506_d)        0x40e6a09e51a329bd(46340.94746549751_d)         X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            771cb14a3024685e07d50fe700f0c0dc9e0213ac        771cb14a3024685e07d50fe700f0c0dc9e0213ac        
