# FailID_001331 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x28, 0x6000               // t3
    li x29, 0x1                  // t4
    li x30, 0x8017fc8b           // t5
    li x31, 0x1a652001           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x5', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'x17', 'f15'}})
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f15, x4, e9, x5
tp(x4)              0x0000000080180736(2149058358)                  0x0000000080180736(2149058358)
t0(x5)              0x00000000800004e9(2147484905)                  0x00000000800004e9(2147484905)
f15                 0xffffffff7fc00000(nan_s)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
+========================================================================================================================+
```
...
ra(x1)              0x0000001000a38420(68730192928)                 0x0000001000a38420(68730192928)                 
sp(x2)              0x0000000000000100(256)                         0x0000000000000100(256)                         
gp(x3)              0x000000008017fc91(2149055633)                  0x000000008017fc91(2149055633)                  
tp(x4)              0x0000000080180736(2149058358)                  0x0000000080180736(2149058358)                  
t0(x5)              0x00000000800004e9(2147484905)                  0x00000000800004e9(2147484905)                  
...
a7(x17)             0x00000000800004e9(2147484905)                  0x00000000800004e9(2147484905)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2c54002c8e4c7cdb1b4b580404c826a76319665a        2c54002c8e4c7cdb1b4b580404c826a76319665a        
