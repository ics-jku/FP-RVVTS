# FailID_000188 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x40,0x25,0xc4,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f1', 'fcsr.rm', 'mstatus.fs/vs.fs', 'f10'}, 'clob': {'f11'}})
    fdiv.s f11, f1, f10, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f11, f1, f10, dyn
+========================================================================================================================+
...
f11                 0xffffffff7fc00000(nan_s)                       0xffffffffff800000(-inf_s)                      X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f11, f1, f10
f1                  0xffffffffc4254000(-661.0_s)                    0xffffffffc4254000(-661.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            39c8f1ff6817a2e5f705ba8a8061d54d4fe86611        39c8f1ff6817a2e5f705ba8a8061d54d4fe86611        
