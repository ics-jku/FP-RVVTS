# FailID_002539 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x80,0xe0,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f0
    fld  f0, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f0', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x13'}})
    fcvt.wu.d x13, f0, rtz
```

### Resulting Machine State Diff
```
REG                 REF                                             DUT                                             DIFF
a3(x13)             0xffffffff80000704(18446744071562069764)        0x0000000080000704(2147485444)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.d x13, f0, rtz
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x13, f0
a3(x13)             0xffffffff80000704(18446744071562069764)        0x0000000080000704(2147485444)                  X
f0                  0x41e00000e0800000(2147485444.0_d)              0x41e00000e0800000(2147485444.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            018aa90cb5779e4d749bf76f04d1f448ef12ccb9        018aa90cb5779e4d749bf76f04d1f448ef12ccb9        
