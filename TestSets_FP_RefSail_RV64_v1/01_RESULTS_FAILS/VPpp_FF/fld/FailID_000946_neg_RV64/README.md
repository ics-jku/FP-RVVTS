# FailID_000946 VP++ FF neg RV64 fld
...
_float_data_end:
    ...
    li x26, 0xff                 // s10
    li x27, 0x8017fa7b           // s11
    li x28, 0x1                  // t3
    li x29, 0xffffffffffffffff   // t4
    li x30, 0x1                  // t5
    li x31, 0x802806a3           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x9'}, 'clob': {'x9', 'x29', 'f17'}})
...
t4(x29)             0x00000000800000f8(2147483896)                  0x00000000800000f8(2147483896)                  
t5(x30)             0x0000000000000001(1)                           0x0000000000000001(1)                           
t6(x31)             0x00000000802806a3(2150106787)                  0x00000000802806a3(2150106787)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            7953bccbb6652ef992af8312dc0a4e4853e884b1        7953bccbb6652ef992af8312dc0a4e4853e884b1        
