# FailID_005221 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0x66,0x0a,0x18,0x80,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f12'}, 'clob': {'f16'}})
    fmax.d f16, f13, f12
```
...
STATE               REF                                             DUT                                             DIFF
f16                 0x0000000000000000(0.0_d)                       0xffffffff80180a66(-2.2077821643038217e-39_s)   X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f16, f13, f12
+========================================================================================================================+
...
f16                 0x0000000000000000(0.0_d)                       0xffffffff80180a66(-2.2077821643038217e-39_s)   X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f13, f12
f12                 0xffffffff80180a66(-2.2077821643038217e-39_s)   0xffffffff80180a66(-2.2077821643038217e-39_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d8afd2607874ae9704d089b3ba34ee1c73be74cc        d8afd2607874ae9704d089b3ba34ee1c73be74cc        
