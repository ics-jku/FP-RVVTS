# FailID_005305 VP++ SF pos RV64 fmax.s
...
_reg_f10:.byte 0xf3,0x91,0x01,0x34,0xff,0xff,0xff,0xff
_reg_f19:.byte 0x00,0x00,0x4c,0x44,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f7
    fld  f7, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f19', 'mstatus.fs/vs.fs', 'f7', 'fcsr.rm'}, 'clob': {'f10'}})
    fmax.s f10, f19, f7
```
...
STATE               REF                                             DUT                                             DIFF
f10                 0xffffffff444c0000(816.0_s)                     0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
f10                 0xffffffff444c0000(816.0_s)                     0xffffffff7fc00000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f10, f19, f7
f7                  0xffffffff7fc00000(nan_s)                       0xffffffff7fc00000(nan_s)
f10                 0xffffffff444c0000(816.0_s)                     0xffffffff7fc00000(nan_s)                       X
f19                 0xffffffff444c0000(816.0_s)                     0xffffffff444c0000(816.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f704a3fc75659a28bff6ea987ed706deb69ea6cb        f704a3fc75659a28bff6ea987ed706deb69ea6cb        
