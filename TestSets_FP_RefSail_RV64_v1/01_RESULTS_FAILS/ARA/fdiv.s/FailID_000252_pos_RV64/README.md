# FailID_000252 ARA pos RV64 fdiv.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f7: .byte 0x16,0x8a,0x2e,0x41,0xff,0xff,0xff,0x7f
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f22', 'f7'}, 'clob': {'f19'}})
    fdiv.s f19, f22, f7, dyn
```
...
```
+========================================================================================================================+
Instruction: fdiv.s f19, f22, f7, dyn
+========================================================================================================================+
...
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f19, f22, f7
f7                  0x7fffffff412e8a16(nan_d)                       0x7fffffff412e8a16(nan_d)
f19                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
...
STATE               REF                                             DUT                                             DIFF
xmemhash            7ed8799d89ff7928e5348ff2ed5a3b9215eedbf6        7ed8799d89ff7928e5348ff2ed5a3b9215eedbf6        
