# FailID_003350 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x10'}, 'clob': {'f6', 'x10', 'x22'}})
...
f6                  0x7ff8000000000000(nan_d)                       0x000000132140006f(4.05935308646e-313_d)        X
STATES DIFFER: True
```
...
ra(x1)              0x0000000000000054(84)                          0x0000000000000054(84)                          
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8ec008dbe0440d7f98aeed2f93542877aef84a88        8ec008dbe0440d7f98aeed2f93542877aef84a88        
