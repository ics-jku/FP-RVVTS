# FailID_001206 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x24, 0x3a                 // s8
    li x25, 0x80000416           // s9
    li x26, 0x801ffe40           // s10
    li x27, 0x1                  // s11
    li x28, 0x37                 // t3
    li x29, 0x801806dc           // t4
    li x30, 0x8017fa84           // t5
    li x31, 0x6c59b000           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x25'}, 'clob': {'f20', 'x25', 'x15'}})
...
f20                 0x41e00300d0e00000(2149058183.0_d)              0xffffffff7ff80000(nan_s)                       X
STATES DIFFER: True
```
...
f20                 0x41e00300d0e00000(2149058183.0_d)              0xffffffff7ff80000(nan_s)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f20, xe4, x25
s9(x25)             0x0000000080000330(2147484464)                  0x0000000080000330(2147484464)
f20                 0x41e00300d0e00000(2149058183.0_d)              0xffffffff7ff80000(nan_s)                       X
+========================================================================================================================+
```
...
ra(x1)              0x00000000801801f6(2149057014)                  0x00000000801801f6(2149057014)                  
sp(x2)              0x000000007fffffff(2147483647)                  0x000000007fffffff(2147483647)                  
gp(x3)              0x0000000080180131(2149056817)                  0x0000000080180131(2149056817)                  
...
t6(x31)             0x000000006c59b000(1817817088)                  0x000000006c59b000(1817817088)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            349362433c891435aafaa6f6ac3247dfe263a7ef        349362433c891435aafaa6f6ac3247dfe263a7ef        
