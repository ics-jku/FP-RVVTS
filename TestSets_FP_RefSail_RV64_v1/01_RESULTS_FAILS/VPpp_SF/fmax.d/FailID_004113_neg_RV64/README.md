# FailID_004113 VP++ SF neg RV64 fmax.d
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f20', 'fcsr.rm', 'f23'}, 'clob': {'f30'}})
    fmax.d f30, f23, f20
```
...
STATE               REF                                             DUT                                             DIFF
f30                 0xce7b358e65ca21a3(-1.173693904724524e+70_d)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmax.d f30, f23, f20
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8c0594a44539465d07ee38fe9223a3308b143383        8c0594a44539465d07ee38fe9223a3308b143383        
