# FailID_000097 ARA neg RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f21:.byte 0x00,0x00,0xe0,0xfc,0x00,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f24'}, 'clob': {'f21'}})
    fsqrt.s f21, f24, rup
```
...
STATE               REF                                             DUT                                             DIFF
f21                 0xffffffff414ce665(12.806248664855957_s)        0xffffffff414ce664(12.80624771118164_s)         X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f21, f24, rup
+========================================================================================================================+
...
STATE               REF                                             DUT                                             DIFF
xmemhash            085f4347f814ec63cd0492ce2cca5b79cbf850e3        085f4347f814ec63cd0492ce2cca5b79cbf850e3        
