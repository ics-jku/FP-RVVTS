# FailID_005545 VP++ SF pos RV64 fmin.s
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f13', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f19'}})
    fmin.s f19, f3, f13
```
...
STATE               REF                                             DUT                                             DIFF
f19                 0xffffffff00000000(0.0_s)                       0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f8adc518702f64adc29545e31881df94c6ca0cc4        f8adc518702f64adc29545e31881df94c6ca0cc4        
