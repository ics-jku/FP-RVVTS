# FailID_001128 VP++ FF neg RV64 flh
...
_float_data_end:
    ...
    li x8, 0x0                   // fp
    li x9, 0x801ffcb8            // s1
    li x10, 0x80180045           // a0
    li x11, 0x8017f8b6           // a1
    li x12, 0x0                  // a2
    li x13, 0x1                  // a3
    ...
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x8', 'mstatus.fs/vs.fs'}, 'clob': {'x10', 'x8', 'f12'}})
...
f12                 0x000000132140006f(4.05935308646e-313_d)        0xffffffffffff006f(6.616115570068359e-06_h)     X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ad26c2eff29644cc00903b3b08a727fb463f8f21        ad26c2eff29644cc00903b3b08a727fb463f8f21        
