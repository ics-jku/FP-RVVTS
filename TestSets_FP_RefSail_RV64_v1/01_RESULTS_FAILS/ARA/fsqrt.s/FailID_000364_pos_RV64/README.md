# FailID_000364 ARA pos RV64 fsqrt.s
...
_reg_f18:.byte 0x06,0x18,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f15
    fld  f15, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f15'}, 'clob': {'f18'}})
    fsqrt.s f18, f15
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c8a7feb086be8f04bdd6a307905bcfa1ea11cf03        c8a7feb086be8f04bdd6a307905bcfa1ea11cf03        
