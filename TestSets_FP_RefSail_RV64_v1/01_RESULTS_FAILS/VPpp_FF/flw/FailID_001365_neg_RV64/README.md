# FailID_001365 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x8, 0x1                   // fp
    li x9, 0x79                  // s1
    li x10, 0xffffffff9f1ad000   // a0
    li x11, 0x80180241           // a1
    li x12, 0x8017ffe6           // a2
    li x13, 0x51b023340191f3     // a3
    li x14, 0x1                  // a4
    li x15, 0x80180241           // a5
    li x16, 0x8017f8d4           // a6
    li x17, 0x80000372           // a7
    li x18, 0xaf                 // s2
    li x19, 0x7ffff9da           // s3
    li x20, 0xffffffff7fe7fe20   // s4
    li x21, 0x8017fd75           // s5
    li x22, 0xec                 // s6
    li x23, 0x13                 // s7
    li x24, 0x18                 // s8
    li x25, 0x8000060f           // s9
    li x26, 0x8017f82c           // s10
    li x27, 0x8017fa43           // s11
    li x28, 0x1000ff8            // t3
    li x29, 0x6000               // t4
    li x30, 0xb7                 // t5
    li x31, 0x8017fcae           // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x4'}, 'clob': {'x4', 'f28', 'x1'}})
...
f28                 0x7ff8000000000000(nan_d)                       0xffffffff2140006f(6.505270420568022e-19_s)     X
STATES DIFFER: True
```
...
gp(x3)              0xfffffffffffffd0d(18446744073709550861)        0xfffffffffffffd0d(18446744073709550861)        
tp(x4)              0x000000007ffff8eb(2147481835)                  0x000000007ffff8eb(2147481835)                  
...
t2(x7)              0x000000008007fc16(2148006934)                  0x000000008007fc16(2148006934)                  
fp(x8)              0x0000000000000001(1)                           0x0000000000000001(1)                           
s1(x9)              0x0000000000000079(121)                         0x0000000000000079(121)                         
a0(x10)             0xffffffff9f1ad000(18446744072083918848)        0xffffffff9f1ad000(18446744072083918848)        
...
a5(x15)             0x0000000080180241(2149057089)                  0x0000000080180241(2149057089)                  
a6(x16)             0x000000008017f8d4(2149054676)                  0x000000008017f8d4(2149054676)                  
a7(x17)             0x0000000080000372(2147484530)                  0x0000000080000372(2147484530)                  
s2(x18)             0x00000000000000af(175)                         0x00000000000000af(175)                         
s3(x19)             0x000000007ffff9da(2147482074)                  0x000000007ffff9da(2147482074)                  
...
s9(x25)             0x000000008000060f(2147485199)                  0x000000008000060f(2147485199)                  
s10(x26)            0x000000008017f82c(2149054508)                  0x000000008017f82c(2149054508)                  
s11(x27)            0x000000008017fa43(2149055043)                  0x000000008017fa43(2149055043)                  
t3(x28)             0x0000000001000ff8(16781304)                    0x0000000001000ff8(16781304)                    
...
STATE               REF                                             DUT                                             DIFF
xmemhash            8d78c0af658f41c7f7abf8f589db0aef03bb45e5        8d78c0af658f41c7f7abf8f589db0aef03bb45e5        
