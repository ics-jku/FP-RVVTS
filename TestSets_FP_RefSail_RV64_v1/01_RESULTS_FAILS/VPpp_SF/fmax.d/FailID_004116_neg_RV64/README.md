# FailID_004116 VP++ SF neg RV64 fmax.d
...
_reg_f13:.byte 0x23,0xb0,0x61,0x06,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f25', 'f7'}, 'clob': {'f13'}})
    fmax.d f13, f25, f7
```
...
STATE               REF                                             DUT                                             DIFF
f13                 0x4190ac4000000000(69931008.0_d)                0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            befa57cd73eaa8c59e736e1f927a60acce396b8b        befa57cd73eaa8c59e736e1f927a60acce396b8b        
