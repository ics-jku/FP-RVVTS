# FailID_002258 VP++ FF neg RV64 fsw
...
_float_data_end:
    ...
    li x31, 0x57                 // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x24', 'mstatus.fs/vs.fs', 'f5'}, 'clob': {'x24', 'x20'}})
...
STATE               REF                                             DUT                                             DIFF
xmemhash            82d1a729d5c062eaf774efb46d6e7284a20f1d5a        82d1a729d5c062eaf774efb46d6e7284a20f1d5a        
