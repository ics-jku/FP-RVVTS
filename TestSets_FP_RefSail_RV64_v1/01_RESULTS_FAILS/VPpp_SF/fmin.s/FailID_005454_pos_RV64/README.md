# FailID_005454 VP++ SF pos RV64 fmin.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f0: .byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_reg_f6: .byte 0x83,0xb2,0x01,0x00,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f6', 'fcsr.rm', 'f25'}, 'clob': {'f0'}})
    fmin.s f0, f6, f25
```
...
STATE               REF                                             DUT                                             DIFF
f0                  0xffffffff0001b283(1.5587343467917103e-40_s)    0xffffffff7fc00000(nan_s)                       X
STATES DIFFER: True
```
...
Registers: f0, f6, f25
f0                  0xffffffff0001b283(1.5587343467917103e-40_s)    0xffffffff7fc00000(nan_s)                       X
f6                  0xffffffff0001b283(1.5587343467917103e-40_s)    0xffffffff0001b283(1.5587343467917103e-40_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            0b495b8e79dc53ee9f6c25119b647435b7c8e9ec        0b495b8e79dc53ee9f6c25119b647435b7c8e9ec        
