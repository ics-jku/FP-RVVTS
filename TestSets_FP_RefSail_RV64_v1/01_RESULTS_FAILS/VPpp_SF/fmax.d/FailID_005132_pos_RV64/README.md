# FailID_005132 VP++ SF pos RV64 fmax.d
...
_reg_f21:.byte 0xfd,0x17,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f5
    fld  f5, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f21', 'mstatus.fs/vs.fs', 'fcsr.rm', 'f5'}, 'clob': {'f12'}})
    fmax.d f12, f5, f21
```
...
STATE               REF                                             DUT                                             DIFF
f12                 0x0000000000000000(0.0_d)                       0xffffffff4f0017fd(2149055744.0_s)              X
STATES DIFFER: True
```
...
f12                 0x0000000000000000(0.0_d)                       0xffffffff4f0017fd(2149055744.0_s)              X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f12, f5, f21
f5                  0x0000000000000000(0.0_d)                       0x0000000000000000(0.0_d)
f12                 0x0000000000000000(0.0_d)                       0xffffffff4f0017fd(2149055744.0_s)              X
f21                 0xffffffff4f0017fd(2149055744.0_s)              0xffffffff4f0017fd(2149055744.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            d867278e847db61652d21ccc8fc290359628a0f2        d867278e847db61652d21ccc8fc290359628a0f2        
