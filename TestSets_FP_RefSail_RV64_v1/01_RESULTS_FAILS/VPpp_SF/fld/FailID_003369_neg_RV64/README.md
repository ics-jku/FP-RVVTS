# FailID_003369 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x11, 0x80180183           // a1
    li x12, 0x80180457           // a2
    li x13, 0x801ff902           // a3
    li x14, 0x8027fcc0           // a4
    li x15, 0x0                  // a5
    li x16, 0x0                  // a6
    li x17, 0x0                  // a7
    ...
    li x21, 0x8017fd8a           // s5
    li x22, 0x0                  // s6
    li x23, 0x80000000           // s7
    li x24, 0x7ffff906           // s8
    li x25, 0x200                // s9
    ...
    li x31, 0x6ed7b000           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x25'}, 'clob': {'f30', 'x8', 'x25'}})
...
f30                 0x7ff8000000000000(nan_d)                       0x0081b3030001b283(3.150573665064223e-306_d)    X
STATES DIFFER: True
```
...
f30                 0x7ff8000000000000(nan_d)                       0x0081b3030001b283(3.150573665064223e-306_d)    X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f30, x3, x25
gp(x3)              0x000000007ffffb19(2147482393)                  0x000000007ffffb19(2147482393)
s9(x25)             0x000000007ffffe21(2147483169)                  0x000000007ffffe21(2147483169)
f30                 0x7ff8000000000000(nan_d)                       0x0081b3030001b283(3.150573665064223e-306_d)    X
+========================================================================================================================+
```
...
fp(x8)              0x000000007ffffc21(2147482657)                  0x000000007ffffc21(2147482657)                  
s1(x9)              0x000000008017fc03(2149055491)                  0x000000008017fc03(2149055491)                  
a0(x10)             0xffffffffffffffff(18446744073709551615)        0xffffffffffffffff(18446744073709551615)        
a1(x11)             0x0000000080180183(2149056899)                  0x0000000080180183(2149056899)                  
...
a4(x14)             0x000000008027fcc0(2150104256)                  0x000000008027fcc0(2150104256)                  
...
s2(x18)             0x0000000080000132(2147483954)                  0x0000000080000132(2147483954)                  
s3(x19)             0x0000000000000048(72)                          0x0000000000000048(72)                          
s4(x20)             0x000000008017fba2(2149055394)                  0x000000008017fba2(2149055394)                  
s5(x21)             0x000000008017fd8a(2149055882)                  0x000000008017fd8a(2149055882)                  
s6(x22)             0x0000000000000000(0)                           0x0000000000000000(0)                           
s7(x23)             0x0000000080000000(2147483648)                  0x0000000080000000(2147483648)                  
s8(x24)             0x000000007ffff906(2147481862)                  0x000000007ffff906(2147481862)                  
s9(x25)             0x000000007ffffe21(2147483169)                  0x000000007ffffe21(2147483169)                  
...
t6(x31)             0x000000006ed7b000(1859629056)                  0x000000006ed7b000(1859629056)                  

STATE               REF                                             DUT                                             DIFF
xmemhash            15bf66b01c7366e4adeace48edc41c21a1999b16        15bf66b01c7366e4adeace48edc41c21a1999b16        
