# FailID_005412 VP++ SF pos RV64 fmin.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f26:.byte 0x24,0x05,0x4b,0x38,0xbd,0xa2,0xe6,0x40
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f27', 'mstatus.fs/vs.fs', 'f26', 'fcsr.rm'}, 'clob': {'f31'}})
    fmin.d f31, f26, f27
```
...
STATE               REF                                             DUT                                             DIFF
f31                 0x40e6a2bd384b0524(46357.91312170986_d)         0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fmin.d f31, f26, f27
+========================================================================================================================+
...
f31                 0x40e6a2bd384b0524(46357.91312170986_d)         0x7ff8000000000000(nan_d)                       X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f31, f26, f27
f26                 0x40e6a2bd384b0524(46357.91312170986_d)         0x40e6a2bd384b0524(46357.91312170986_d)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            466eea665e29ad49c7a59987bad049f36fca601d        466eea665e29ad49c7a59987bad049f36fca601d        
