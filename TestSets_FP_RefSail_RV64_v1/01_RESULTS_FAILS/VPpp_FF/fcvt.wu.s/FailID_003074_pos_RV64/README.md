# FailID_003074 VP++ FF pos RV64 fcvt.wu.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f2: .byte 0x01,0x28,0x00,0x4f,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f2
    fld  f2, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f2', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x9'}})
    fcvt.wu.s x9, f2, rmm
```
...
```
REG                 REF                                             DUT                                             DIFF
s1(x9)              0xffffffff80280100(18446744071564689664)        0x0000000080280100(2150105344)                  X
...
```
+========================================================================================================================+
Instruction: fcvt.wu.s x9, f2, rmm
+========================================================================================================================+
Attributes:  none
+------------------------------------------------------------------------------------------------------------------------+
REG                 REF                                             DUT                                             DIFF 
...
Registers: x9, f2
s1(x9)              0xffffffff80280100(18446744071564689664)        0x0000000080280100(2150105344)                  X
f2                  0xffffffff4f002801(2150105344.0_s)              0xffffffff4f002801(2150105344.0_s)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            af13153338a953f59311d1017cf5420b1fa74d3d        af13153338a953f59311d1017cf5420b1fa74d3d        
