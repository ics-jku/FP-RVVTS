# FailID_000478 ARA pos RV64 fsqrt.s
...
```
    ...
    j _float_data_end
    .align 4
_reg_f13:.byte 0x00,0x00,0x00,0x00,0xff,0xff,0xff,0x7f
_reg_f16:.byte 0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f13
    fld  f13, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'f13'}, 'clob': {'f16'}})
    fsqrt.s f16, f13, rdn
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f16, f13, rdn
+========================================================================================================================+
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f16, f13
f13                 0x7fffffff00000000(nan_d)                       0x7fffffff00000000(nan_d)
f16                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            ff6680283e78a7fa0181024675b163a5f06b2fcb        ff6680283e78a7fa0181024675b163a5f06b2fcb        
