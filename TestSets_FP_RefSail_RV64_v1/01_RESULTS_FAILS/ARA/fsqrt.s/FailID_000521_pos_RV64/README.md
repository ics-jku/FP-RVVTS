# FailID_000521 ARA pos RV64 fsqrt.s
...
_reg_f29:.byte 0x00,0x00,0x00,0x00,0x00,0x00,0xf0,0x3f
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f21
    fld  f21, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'fcsr.rm', 'f29', 'mstatus.fs/vs.fs'}, 'clob': {'f21'}})
    fsqrt.s f21, f29, rne
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f21, f29, rne
+========================================================================================================================+
...
Registers: f21, f29
f21                 0xffffffff7fc00000(nan_s)                       0xffffffff00000000(0.0_s)                       X
f29                 0x3ff0000000000000(1.0_d)                       0x3ff0000000000000(1.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            708da90f8eceff89a8efca9d9255fb033e995e8a        708da90f8eceff89a8efca9d9255fb033e995e8a        
