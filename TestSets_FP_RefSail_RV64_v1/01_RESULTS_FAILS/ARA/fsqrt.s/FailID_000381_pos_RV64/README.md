# FailID_000381 ARA pos RV64 fsqrt.s
...
_reg_f14:.byte 0x00,0x00,0x20,0x7f,0x00,0x00,0xe0,0x41
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f4
    fld  f4, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f14', 'fcsr.rm', 'mstatus.fs/vs.fs'}, 'clob': {'f4'}})
    fsqrt.s f4, f14, rne
```
...
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff5f4a62c2(1.4583431848634876e+19_s)    X
STATES DIFFER: True
```
...
```
+========================================================================================================================+
Instruction: fsqrt.s f4, f14, rne
+========================================================================================================================+
...
Registers: f4, f14
f4                  0xffffffff7fc00000(nan_s)                       0xffffffff5f4a62c2(1.4583431848634876e+19_s)    X
f14                 0x41e000007f200000(2147484665.0_d)              0x41e000007f200000(2147484665.0_d)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            a201c81bb71e77cbe4ba48814d794b3ec080bd98        a201c81bb71e77cbe4ba48814d794b3ec080bd98        
