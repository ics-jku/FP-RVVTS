# FailID_002560 VP++ FF pos RV64 fcvt.wu.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f12:.byte 0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
_float_data_end:
    // FLOATINTPOINT STATE
    la t0, _reg_f12
    fld  f12, 0(t0)
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f12', 'mstatus.fs/vs.fs', 'fcsr.rm'}, 'clob': {'x4'}})
    fcvt.wu.d x4, f12
```
...
Registers: x4, f12
tp(x4)              0xffffffffffffffff(18446744073709551615)        0x00000000ffffffff(4294967295)                  X
f12                 0xffffffffffffffff(nan_h)                       0xffffffffffffffff(nan_h)
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            725c464be6e301b8918b27b7913712a92f7f3c69        725c464be6e301b8918b27b7913712a92f7f3c69        
