# FailID_001550 VP++ FF neg RV64 flw
...
_float_data_end:
    ...
    li x12, 0xb7bc1740           // a2
    li x13, 0x80000349           // a3
    li x14, 0x89                 // a4
    li x15, 0x8017f9d7           // a5
    li x16, 0x10                 // a6
    li x17, 0xffffffff7fffa19d   // a7
    ...
    li x30, 0x70                 // t5
    li x31, 0x6000               // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'x12', 'mstatus.fs/vs.fs'}, 'clob': {'f29', 'x12', 'x7'}})
...
f29                 0x7ff8000000000000(nan_d)                       0xffffffff00000000(0.0_s)                       X
STATES DIFFER: True
```
...
t2(x7)              0x000000007ffffa47(2147482183)                  0x000000007ffffa47(2147482183)                  
...
a4(x14)             0x0000000000000089(137)                         0x0000000000000089(137)                         
a5(x15)             0x000000008017f9d7(2149054935)                  0x000000008017f9d7(2149054935)                  
a6(x16)             0x0000000000000010(16)                          0x0000000000000010(16)                          
a7(x17)             0xffffffff7fffa19d(18446744071562043805)        0xffffffff7fffa19d(18446744071562043805)        
...
STATE               REF                                             DUT                                             DIFF
xmemhash            f20a92bf3f0414abeb597cb2fcab228168c2fbdb        f20a92bf3f0414abeb597cb2fcab228168c2fbdb        
