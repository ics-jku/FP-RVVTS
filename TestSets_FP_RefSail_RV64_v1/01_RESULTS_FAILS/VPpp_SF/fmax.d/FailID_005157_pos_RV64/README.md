# FailID_005157 VP++ SF pos RV64 fmax.d
...
_reg_f4: .byte 0x00,0x00,0x80,0x6d,0x00,0x04,0xe0,0xc1
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'f4', 'f1'}, 'clob': {'f28'}})
    fmax.d f28, f4, f1
```
...
STATE               REF                                             DUT                                             DIFF
f28                 0xc1e004006d800000(-2149581676.0_d)             0x7ff8000000000000(nan_d)                       X
STATES DIFFER: True
```
...
f4                  0xc1e004006d800000(-2149581676.0_d)             0xc1e004006d800000(-2149581676.0_d)
f28                 0xc1e004006d800000(-2149581676.0_d)             0x7ff8000000000000(nan_d)                       X
+========================================================================================================================+
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            916d7544ca4887eba39bc5256b54d0c5c2e296da        916d7544ca4887eba39bc5256b54d0c5c2e296da        
