# FailID_004472 VP++ SF neg RV64 fsd
...
_float_data_end:
    ...
    li x12, 0x53                 // a2
    li x13, 0x7ffffa9f           // a3
    li x14, 0x801800fb           // a4
    li x15, 0x801b989c           // a5
    li x16, 0x7ffffb03           // a6
    li x17, 0xe4                 // a7
    li x18, 0x8000044c           // s2
    li x19, 0x801ff5cb           // s3
    li x20, 0x2000               // s4
    li x21, 0x801fffd5           // s5
    li x22, 0xffffffffc67a6000   // s6
    li x23, 0x1                  // s7
    li x24, 0xe3                 // s8
    li x25, 0x53                 // s9
    li x26, 0x0                  // s10
    li x27, 0x7ffffa6f           // s11
    li x28, 0x33c3c20c           // t3
    li x29, 0x801806cb           // t4
    li x30, 0xffffffff806d6000   // t5
    li x31, 0x0                  // t6
    // INSTRUCTION ({'dep': {'x1', 'fcsr.rm', 'f26', 'mstatus.fs/vs.fs'}, 'clob': {'x5', 'x1'}})
...
#exceptions         0x0000000000000001(1)                           0x0000000000000000(0)                           X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f26, x388, x1
ra(x1)              0x0000000080180388(2149057416)                  0x0000000080180388(2149057416)
...
a3(x13)             0x000000007ffffa9f(2147482271)                  0x000000007ffffa9f(2147482271)                  
a4(x14)             0x00000000801800fb(2149056763)                  0x00000000801800fb(2149056763)                  
...
s2(x18)             0x000000008000044c(2147484748)                  0x000000008000044c(2147484748)                  
s3(x19)             0x00000000801ff5cb(2149578187)                  0x00000000801ff5cb(2149578187)                  
s4(x20)             0x0000000000002000(8192)                        0x0000000000002000(8192)                        
s5(x21)             0x00000000801fffd5(2149580757)                  0x00000000801fffd5(2149580757)                  
s6(x22)             0xffffffffc67a6000(18446744072744493056)        0xffffffffc67a6000(18446744072744493056)        
...
s11(x27)            0x000000007ffffa6f(2147482223)                  0x000000007ffffa6f(2147482223)                  
t3(x28)             0x0000000033c3c20c(868467212)                   0x0000000033c3c20c(868467212)                   
t4(x29)             0x00000000801806cb(2149058251)                  0x00000000801806cb(2149058251)                  
t5(x30)             0xffffffff806d6000(18446744071569235968)        0xffffffff806d6000(18446744071569235968)        
t6(x31)             0x0000000000000000(0)                           0x0000000000000000(0)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            34d3a88e173cc6e6f2721c8f83dcaac23ccce451        34d3a88e173cc6e6f2721c8f83dcaac23ccce451        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        5871a0e2b5463641eb5587b9e29814822e3a2ec9        X
