# FailID_005393 VP++ SF pos RV64 fmin.d
...
_reg_f18:.byte 0x01,0xb0,0xff,0xce,0xff,0xff,0xff,0xff
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'f26', 'f18', 'fcsr.rm'}, 'clob': {'f5'}})
    fmin.d f5, f26, f18
```
...
STATE               REF                                             DUT                                             DIFF
f5                  0x0000000000000000(0.0_d)                       0xffffffffceffb001(-2144862336.0_s)             X
STATES DIFFER: True
```
...
f5                  0x0000000000000000(0.0_d)                       0xffffffffceffb001(-2144862336.0_s)             X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f5, f26, f18
f5                  0x0000000000000000(0.0_d)                       0xffffffffceffb001(-2144862336.0_s)             X
f18                 0xffffffffceffb001(-2144862336.0_s)             0xffffffffceffb001(-2144862336.0_s)
...
STATE               REF                                             DUT                                             DIFF
xmemhash            caa978db29a470f2683d112bd9131522faeda618        caa978db29a470f2683d112bd9131522faeda618        
