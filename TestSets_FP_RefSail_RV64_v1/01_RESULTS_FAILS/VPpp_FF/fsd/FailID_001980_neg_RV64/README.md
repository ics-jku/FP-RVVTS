# FailID_001980 VP++ FF neg RV64 fsd
...
_float_data_end:
    ...
    li x26, 0x80200492           // s10
    li x27, 0x80180e55           // s11
    li x28, 0x801809df           // t3
    li x29, 0x8017fd1a           // t4
    li x30, 0x200                // t5
    li x31, 0x1                  // t6
    // INSTRUCTION ({'dep': {'fcsr.rm', 'mstatus.fs/vs.fs', 'x29', 'f22'}, 'clob': {'x30', 'x29'}})
...
STATE               REF                                             DUT                                             DIFF
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4470325c586b33a9fefe50df738fe7f0dc317872        X
...
+------------------------------------------------------------------------------------------------------------------------+
Registers: f22, x29
t4(x29)             0x00000000801ffc29(2149579817)                  0x00000000801ffc29(2149579817)
...
s10(x26)            0x0000000080200492(2149581970)                  0x0000000080200492(2149581970)                  
...
t4(x29)             0x00000000801ffc29(2149579817)                  0x00000000801ffc29(2149579817)                  
t5(x30)             0x000000008017ff11(2149056273)                  0x000000008017ff11(2149056273)                  
t6(x31)             0x0000000000000001(1)                           0x0000000000000001(1)                           

STATE               REF                                             DUT                                             DIFF
xmemhash            5a7894f7b5694fbd669bc873bfabd193d0e12437        5a7894f7b5694fbd669bc873bfabd193d0e12437        
dmemhash            95823c334fce55968e8d2827ccd1cf77cee19abd        4470325c586b33a9fefe50df738fe7f0dc317872        X
