# FailID_003501 VP++ SF neg RV64 fld
...
_float_data_end:
    ...
    li x27, 0x77                 // s11
    li x28, 0x8000027a           // t3
    li x29, 0x8017fa10           // t4
    li x30, 0x80180727           // t5
    li x31, 0x80186589           // t6
    // INSTRUCTION ({'dep': {'mstatus.fs/vs.fs', 'fcsr.rm', 'x28'}, 'clob': {'x28', 'f0', 'x17'}})
...
f0                  0xffffffff7fc00000(nan_s)                       0xd20004d3d2000453(-9.95818733404522e+86_d)     X
STATES DIFFER: True
```
...
f0                  0xffffffff7fc00000(nan_s)                       0xd20004d3d2000453(-9.95818733404522e+86_d)     X
+------------------------------------------------------------------------------------------------------------------------+
Registers: f0, x1, d4, x28
ra(x1)              0x000000008017fa10(2149054992)                  0x000000008017fa10(2149054992)
...
a0(x10)             0x000000008017fe17(2149056023)                  0x000000008017fe17(2149056023)                  
...
STATE               REF                                             DUT                                             DIFF
xmemhash            2d7f1ef287f150d23d3a495a7d1420aad202477a        2d7f1ef287f150d23d3a495a7d1420aad202477a        
