# FailID_005138 VP++ SF pos RV64 fmax.d
...
```
    ...
    j _float_data_end
    .align 4
_reg_f1: .byte 0x00,0x00,0x20,0x68,0xfd,0x03,0xe0,0x41
...
_float_data_end:
    ...
    // restore registers
    // INSTRUCTION ({'dep': {'f24', 'mstatus.fs/vs.fs', 'f3', 'fcsr.rm'}, 'clob': {'f1'}})
    fmax.d f1, f3, f24
```
...
STATE               REF                                             DUT                                             DIFF
xmemhash            c1fb32c8c685922201979f1ffa52f2d9570cc4b1        c1fb32c8c685922201979f1ffa52f2d9570cc4b1        
